...
[DESCREVA A FUNCIONALIDADE AQUI - Ex: Implementar rolagem de perícias com modificadores]
...
## Saída Esperada
1. **Análise Técnica**: Quais arquivos serão criados ou modificados e por quê.
2. **Código**: A implementação completa e pronta para uso.
3. **Verificação**: Como posso validar manualmente que isso está funcionando?
