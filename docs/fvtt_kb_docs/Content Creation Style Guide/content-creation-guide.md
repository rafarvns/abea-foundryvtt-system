---
title: "Content Creation Style Guide"
url: "https://foundryvtt.com/article/content-creation-guide/"
category: "Content Creation Style Guide"
---
...
The [Media Optimization Guide](/article/media/ "Media Optimization Guide") will guide you through ideal file naming, asset organization, and preferred file formats for art and audio.

The [Content Packaging Guide](/article/packaging-guide/ "Content Packaging Guide") will guide you through the steps necessary to pack up a module with content for distribution.

The article on [Adventure Documents](/article/adventure/ "Adventure Documents") will detail how to use the adventure document and adventure packager for content distribution.

## Mapping Guidelines

For guidance on setting up and using scenes, see the [Scenes](/article/scenes/ "Scenes") article.
...
While FVTT defaults the scene background color to a neutral grey, setting the background color to `#000500` can provide a very nice 'shadow box' emphasis on the background.

Grid Color should either be left at the default `#000000`, or inverted to `#FFFFFF` depending if the scene background is very dark.

Grid Opacity defaults to `.2`, and does not necessarily need to be changed, but can be adjusted to provide the optimal visibility of the grid based on whichever aesthetic you choose. If you modify the default solely for the purposes of making the grid more visible while walling or placing lights, remember to return it to the default `.2` before you consider the map finished.
...
![Good Grid Use](https://r2.foundryvtt.com/website-uploads-public/screen/user_671/good-grid-use-2020-12-18.png)

Left: A map with art drawn at 140x140 grid scale, in a scene with 140px grid scale.   
Right: A map with art drawn at 140x140 grid scale, but in a scene with a 70px grid scale.

![Bad Grid Use](https://r2.foundryvtt.com/website-uploads-public/screen/user_671/bad-grid-use-2020-12-18.jpg)

Left: A map with art drawn at 140x140 grid scale, but in a scene with a 100px grid scale.   
Right: The same map, after attempts to align the walls to the grid, which is impossible.
...
Vision and Global Illumination
...
For guidance on setting up and using walls, see the [Walls](/article/walls/ "Walls") article.
...
1. Should it block movement or sight or both?
2. Is it tactically or logically important to block sight or movement?
3. Does it really need to prevent sight or movement at all?
4. Does it serve the map's aesthetic or is it better without?
...
![Vision - Good and Bad](https://r2.foundryvtt.com/website-uploads-public/screen/user_671/vision-good-and-bad-2020-12-18.jpg)

Left: The suggested minimalist approach, provides players as much visible space as possible to admire the art and navigate the scene.   
Center: A more complex approach to vision and movement, to tightly limit visibility for players in tactically complex scenes. This should be used only sparingly.  
Right: A scene with an excessive amount of vision and movement blocking walls, this creates a cluttered and unpleasant view for players and should be avoided.
...
![Walling - Good and Bad](https://r2.foundryvtt.com/website-uploads-public/screen/user_671/walling-good-and-bad-2020-12-16.png)

Left: Walls are inset from the art, allow for navigation, and are generally minimal.   
Right: Walls overlap the art, stop navigation, and their segments are small, and numerous.
...
![Bad Walling (microwalls)](https://r2.foundryvtt.com/website-uploads-public/screen/user_671/bad-walling-microwalls-2020-12-16.jpg)

An example of micro-walls.

## Lighting

For guidance on setting up and using lights, see the [Lighting](/article/lighting/ "Lighting") article.
...
![Lighting Example](https://r2.foundryvtt.com/website-uploads-public/screen/user_671/lighting-example-2020-12-16.jpg)

Left: A three-candle candelabra represented by a single light source.  
...
](https://r2.foundryvtt.com/website-uploads-public/videos/glittering-gold.mp4)
...
](https://r2.foundryvtt.com/website-uploads-public/videos/waterfall.mp4)
...
](https://r2.foundryvtt.com/website-uploads-public/videos/shimmering-water.mp4)
...
](https://r2.foundryvtt.com/website-uploads-public/videos/clouds.mp4)
...
](https://r2.foundryvtt.com/website-uploads-public/videos/churning-magma.mp4)
