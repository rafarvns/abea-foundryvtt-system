...
url: "https://foundryvtt.com/article/troubleshooting/"
...
This article covers a number of common issues and their solutions. If you are running into issues which are not resolved here, we strongly recommend that you [contact us](/contact-us/) or join our [Discord community](https://discord.gg/foundryvtt) for live support.

## Reset Your Administrator Password

[How to Reset Your Foundry Administrator Password](/article/reset-admin-password/ "How to Reset Your Foundry Administrator Password")
...
[How to Reset Foundry User Passwords](/article/reset-user-passwords/ "How to Reset Foundry User Passwords")
...
[How to Launch Foundry in Safe Configuration](/article/launch-safe-configuration/ "How to Launch Foundry in Safe Configuration")
...
[Managing User Data](/article/user-data-backup/ "Managing User Data")
