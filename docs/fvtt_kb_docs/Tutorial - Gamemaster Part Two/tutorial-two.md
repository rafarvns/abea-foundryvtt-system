---
title: "Tutorial - Gamemaster Part Two"
url: "https://foundryvtt.com/article/tutorial-two/"
category: "Tutorial - Gamemaster Part Two"
---
...
* **Scenes.** Areas that the players may explore and are generally composed of map images used as backgrounds, or many numerous parts if constructed from [Tiles](/article/tiles/ "Tiles"). Scenes may depict anything from world or regional maps to small buildings or dungeons. Scenes can contain [Tokens](/article/tokens/ "Tokens"), [Lighting](/article/lighting/ "Lighting"), [Walls](/article/walls/ "Walls"), and [Ambient Sounds](/article/ambient-sound/ "Ambient Sounds"). To learn more about this key document type visit the [Scenes](/article/scenes/ "Scenes") page.
...
[![Getting Started - User Management](https://r2.foundryvtt.com/website-uploads-public/screen/user_1294/getting-started-user-management-2021-01-13.jpg)](https://r2.foundryvtt.com/website-uploads-public/screen/user_1294/getting-started-user-management-2021-01-13.jpg)
...
[![Getting Started - Actor Permissions](https://r2.foundryvtt.com/website-uploads-public/screen/user_1294/getting-started-actor-permissions-2021-01-13.jpg)](https://r2.foundryvtt.com/website-uploads-public/screen/user_1294/getting-started-actor-permissions-2021-01-13.jpg "See Larger Image")

The Actor Permissions window lets you determine who has control of an actor and its data.
...
[![Getting Started - Making a Scene](https://r2.foundryvtt.com/website-uploads-public/screen/user_1294/getting-started-making-a-scene-2021-01-15.jpg)](https://r2.foundryvtt.com/website-uploads-public/screen/user_1294/getting-started-making-a-scene-2021-01-15.jpg "See Larger Image")

This is an example of the bare minimum needed to create a scene in Foundry VTT.

To create a new Scene:

1. Open the Scenes Directory (the map icon, 3rd from the left) in the Sidebar on the right-side of the screen.
2. At the top of the Sidebar click **Create New Scene**, you'll be prompted to give the scene a name, afterwards clicking create scene will open the scene configuration menu.

If you do not have a map image ready, we have provided one to you here on [DeviantArt](https://www.deviantart.com/foundryatropos/art/Foundry-Tavern-at-Night-746759206). This image has the following dimensions: 3150x2800px.
...
[![Tutorial Tavern Scene](https://r2.foundryvtt.com/website-uploads-public/screen/user_1/tutorial-tavern-scene-2020-05-24.png)](https://r2.foundryvtt.com/website-uploads-public/screen/user_1/tutorial-tavern-scene-2020-05-24.png "See Larger Image")
...
You can learn more about walls in the [Walls](/article/walls/ "Walls") article.
...
You can learn more about lights in the [Lighting](/article/lighting/ "Lighting") article.

### Placing Actors in a Scene

[![Getting Started - Placing Tokens (webp)](https://r2.foundryvtt.com/website-uploads-public/screen/user_1294/getting-started-placing-tokens-webp-2021-01-19.webp)](https://r2.foundryvtt.com/website-uploads-public/screen/user_1294/getting-started-placing-tokens-webp-2021-01-19.webp "See Larger Image")
...
You can learn more about actors in the [Actors](/article/actors/ "Actors") article, and more about tokens in the [Tokens](/article/tokens/ "Tokens") article.
...
You can learn more about Foundry VTT's control setup in the [Game Controls](/article/controls/ "Game Controls") article.

## Inviting Players

![Game Invitation Links - Closed](https://r2.foundryvtt.com/website-uploads-public/screen/user_671/game-invitation-links-closed-2021-12-15.jpg)
...
[![Getting Started - Toggle Combat State](https://r2.foundryvtt.com/website-uploads-public/screen/user_1294/getting-started-toggle-combat-state-2021-01-15.jpg)](https://r2.foundryvtt.com/website-uploads-public/screen/user_1294/getting-started-toggle-combat-state-2021-01-15.jpg "See Larger Image")
...
For more on combat encounters, refer to the article on [Combat Encounters](/article/combat/ "Combat Encounters").
...
* Return to [Tutorial - Gamemaster Part One](/article/tutorial/ "Tutorial - Gamemaster Part One") part one.
