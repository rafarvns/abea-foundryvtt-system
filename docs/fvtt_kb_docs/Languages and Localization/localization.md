...
url: "https://foundryvtt.com/article/localization/"
category: "Languages and Localization"
---
...
In JavaScript you can use the `game.i18n.localize(key)` method to obtain the translated string for a given `key`. See the  [Localization Helpers](/api/classes/foundry.helpers.Localization.html " Localization Helpers") API documentation page for more details. Example usage of this approach is the following:
...
You can reference localization string targets using either single or double quotes, but we recommend using single quotes so that you can remain consistent in using translations inside other HTML attributes, for example:
