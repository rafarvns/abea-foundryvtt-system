---
title: "TemplateLayer | Foundry Virtual Tabletop - API Documentation - Version 13"
...
#### Hierarchy ([View Summary](../hierarchy.html#foundry.canvas.layers.TemplateLayer))
...
[\_configPreview](foundry.canvas.layers.TemplateLayer.html#_configpreview)
[clipboard](foundry.canvas.layers.TemplateLayer.html#clipboard)
[eventMode](foundry.canvas.layers.TemplateLayer.html#eventmode)
[highlightObjects](foundry.canvas.layers.TemplateLayer.html#highlightobjects)
[history](foundry.canvas.layers.TemplateLayer.html#history)
[interactiveChildren](foundry.canvas.layers.TemplateLayer.html#interactivechildren)
[objects](foundry.canvas.layers.TemplateLayer.html#objects)
[options](foundry.canvas.layers.TemplateLayer.html#options)
[preview](foundry.canvas.layers.TemplateLayer.html#preview)
[quadtree](foundry.canvas.layers.TemplateLayer.html#quadtree)
[CREATION\_STATES](foundry.canvas.layers.TemplateLayer.html#creation_states)
[documentName](foundry.canvas.layers.TemplateLayer.html#documentname)
[SORT\_ORDER](foundry.canvas.layers.TemplateLayer.html#sort_order)

### Accessors

[active](foundry.canvas.layers.TemplateLayer.html#active)
[controlled](foundry.canvas.layers.TemplateLayer.html#controlled)
[controlledObjects](foundry.canvas.layers.TemplateLayer.html#controlledobjects)
[documentCollection](foundry.canvas.layers.TemplateLayer.html#documentcollection)
[hasPreview](foundry.canvas.layers.TemplateLayer.html#haspreview)
[hookName](foundry.canvas.layers.TemplateLayer.html#hookname)
[hover](foundry.canvas.layers.TemplateLayer.html#hover)
[hud](foundry.canvas.layers.TemplateLayer.html#hud)
[name](foundry.canvas.layers.TemplateLayer.html#name)
[placeables](foundry.canvas.layers.TemplateLayer.html#placeables)
[instance](foundry.canvas.layers.TemplateLayer.html#instance)
[layerOptions](foundry.canvas.layers.TemplateLayer.html#layeroptions)
[placeableClass](foundry.canvas.layers.TemplateLayer.html#placeableclass)

### Methods

[\_activate](foundry.canvas.layers.TemplateLayer.html#_activate)
[\_canDragLeftStart](foundry.canvas.layers.TemplateLayer.html#_candragleftstart)
[\_createPreview](foundry.canvas.layers.TemplateLayer.html#_createpreview)
[\_deactivate](foundry.canvas.layers.TemplateLayer.html#_deactivate)
[\_draw](foundry.canvas.layers.TemplateLayer.html#_draw)
[\_getCopyableObjects](foundry.canvas.layers.TemplateLayer.html#_getcopyableobjects)
[\_getMovableObjects](foundry.canvas.layers.TemplateLayer.html#_getmovableobjects)
[\_highlightObjects](foundry.canvas.layers.TemplateLayer.html#_highlightobjects)
[\_onClickLeft](foundry.canvas.layers.TemplateLayer.html#_onclickleft)
[\_onClickRight](foundry.canvas.layers.TemplateLayer.html#_onclickright)
[\_onCopyKey](foundry.canvas.layers.TemplateLayer.html#_oncopykey)
[\_onCutKey](foundry.canvas.layers.TemplateLayer.html#_oncutkey)
[\_onDeleteKey](foundry.canvas.layers.TemplateLayer.html#_ondeletekey)
[\_onDismissKey](foundry.canvas.layers.TemplateLayer.html#_ondismisskey)
[\_onDragLeftCancel](foundry.canvas.layers.TemplateLayer.html#_ondragleftcancel)
[\_onDragLeftDrop](foundry.canvas.layers.TemplateLayer.html#_ondragleftdrop)
[\_onDragLeftMove](foundry.canvas.layers.TemplateLayer.html#_ondragleftmove)
[\_onDragLeftStart](foundry.canvas.layers.TemplateLayer.html#_ondragleftstart)
[\_onMouseWheel](foundry.canvas.layers.TemplateLayer.html#_onmousewheel)
[\_onPasteKey](foundry.canvas.layers.TemplateLayer.html#_onpastekey)
[\_onSelectAllKey](foundry.canvas.layers.TemplateLayer.html#_onselectallkey)
[\_onUndoKey](foundry.canvas.layers.TemplateLayer.html#_onundokey)
[\_prepareKeyboardMovementUpdates](foundry.canvas.layers.TemplateLayer.html#_preparekeyboardmovementupdates)
[\_prepareKeyboardRotationUpdates](foundry.canvas.layers.TemplateLayer.html#_preparekeyboardrotationupdates)
[\_sendToBackOrBringToFront](foundry.canvas.layers.TemplateLayer.html#_sendtobackorbringtofront)
[\_tearDown](foundry.canvas.layers.TemplateLayer.html#_teardown)
[activate](foundry.canvas.layers.TemplateLayer.html#activate)
[clearPreviewContainer](foundry.canvas.layers.TemplateLayer.html#clearpreviewcontainer)
[controlAll](foundry.canvas.layers.TemplateLayer.html#controlall)
[controllableObjects](foundry.canvas.layers.TemplateLayer.html#controllableobjects)
[copyObjects](foundry.canvas.layers.TemplateLayer.html#copyobjects)
[createObject](foundry.canvas.layers.TemplateLayer.html#createobject)
[deactivate](foundry.canvas.layers.TemplateLayer.html#deactivate)
[deleteAll](foundry.canvas.layers.TemplateLayer.html#deleteall)
[draw](foundry.canvas.layers.TemplateLayer.html#draw)
[get](foundry.canvas.layers.TemplateLayer.html#get)
[getDocuments](foundry.canvas.layers.TemplateLayer.html#getdocuments)
[getMaxSort](foundry.canvas.layers.TemplateLayer.html#getmaxsort)
[getSnappedPoint](foundry.canvas.layers.TemplateLayer.html#getsnappedpoint)
[getZIndex](foundry.canvas.layers.TemplateLayer.html#getzindex)
[moveMany](foundry.canvas.layers.TemplateLayer.html#movemany)
[pasteObjects](foundry.canvas.layers.TemplateLayer.html#pasteobjects)
[releaseAll](foundry.canvas.layers.TemplateLayer.html#releaseall)
[rotateMany](foundry.canvas.layers.TemplateLayer.html#rotatemany)
[selectObjects](foundry.canvas.layers.TemplateLayer.html#selectobjects)
[setAllRenderFlags](foundry.canvas.layers.TemplateLayer.html#setallrenderflags)
[storeHistory](foundry.canvas.layers.TemplateLayer.html#storehistory)
[tearDown](foundry.canvas.layers.TemplateLayer.html#teardown)
[undoHistory](foundry.canvas.layers.TemplateLayer.html#undohistory)
[updateAll](foundry.canvas.layers.TemplateLayer.html#updateall)
[\_canvasCoordinatesFromDrop](foundry.canvas.layers.TemplateLayer.html#_canvascoordinatesfromdrop)
[\_confirmDeleteKey](foundry.canvas.layers.TemplateLayer.html#_confirmdeletekey)
[\_onClickLeft2](foundry.canvas.layers.TemplateLayer.html#_onclickleft2)
[\_onClickRight2](foundry.canvas.layers.TemplateLayer.html#_onclickright2)
[\_onCycleViewKey](foundry.canvas.layers.TemplateLayer.html#_oncycleviewkey)
[\_onUndoCreate](foundry.canvas.layers.TemplateLayer.html#_onundocreate)
[\_onUndoDelete](foundry.canvas.layers.TemplateLayer.html#_onundodelete)
[\_onUndoUpdate](foundry.canvas.layers.TemplateLayer.html#_onundoupdate)
[\_storeHistory](foundry.canvas.layers.TemplateLayer.html#_storehistory)
[prepareSceneControls](foundry.canvas.layers.TemplateLayer.html#preparescenecontrols)
[registerSettings](foundry.canvas.layers.TemplateLayer.html#registersettings)
...
documentName: string = "MeasuredTemplate"
...
* prepareSceneControls(): {  
  ...
  #### Returns { Â Â Â Â activeTool: string; Â Â Â Â icon: string; Â Â Â Â name: string; Â Â Â Â onChange: (event: any, active: any) => void; Â Â Â Â onToolChange: () => any; Â Â Â Â order: number; Â Â Â Â title: string; Â Â Â Â tools: { Â Â Â Â Â Â Â Â circle: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â clear: { Â Â Â Â Â Â Â Â Â Â Â Â button: boolean; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â onChange: () => any; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â visible: boolean; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â cone: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â ray: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â rect: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â }; Â Â Â Â visible: boolean; }
