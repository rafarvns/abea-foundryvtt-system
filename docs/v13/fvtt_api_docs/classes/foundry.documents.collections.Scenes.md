---
title: "Scenes | Foundry Virtual Tabletop - API Documentation - Version 13"
...
* [foundry.documents.Scene](foundry.documents.Scene.html): The Scene document
* [foundry.applications.sidebar.tabs.SceneDirectory](foundry.applications.sidebar.tabs.SceneDirectory.html): The SceneDirectory sidebar directory

#### Hierarchy ([View Summary](../hierarchy.html#foundry.documents.collections.Scenes))
...
[constructor](foundry.documents.collections.Scenes.html#constructor)

### Properties

[apps](foundry.documents.collections.Scenes.html#apps)
[invalidDocumentIds](foundry.documents.collections.Scenes.html#invaliddocumentids)
[documentName](foundry.documents.collections.Scenes.html#documentname)

### Accessors

[active](foundry.documents.collections.Scenes.html#active)
[contents](foundry.documents.collections.Scenes.html#contents)
[current](foundry.documents.collections.Scenes.html#current)
[directory](foundry.documents.collections.Scenes.html#directory)
[documentClass](foundry.documents.collections.Scenes.html#documentclass)
[documentName](foundry.documents.collections.Scenes.html#documentname-1)
[folders](foundry.documents.collections.Scenes.html#folders)
[name](foundry.documents.collections.Scenes.html#name)
[viewed](foundry.documents.collections.Scenes.html#viewed)
[instance](foundry.documents.collections.Scenes.html#instance)
[registeredSheets](foundry.documents.collections.Scenes.html#registeredsheets)

### Methods

[\_getVisibleTreeContents](foundry.documents.collections.Scenes.html#_getvisibletreecontents)
[\_onModifyContents](foundry.documents.collections.Scenes.html#_onmodifycontents)
[[iterator]](foundry.documents.collections.Scenes.html#iterator)
[createDocument](foundry.documents.collections.Scenes.html#createdocument)
[delete](foundry.documents.collections.Scenes.html#delete)
[filter](foundry.documents.collections.Scenes.html#filter)
[find](foundry.documents.collections.Scenes.html#find)
[forEach](foundry.documents.collections.Scenes.html#foreach)
[fromCompendium](foundry.documents.collections.Scenes.html#fromcompendium)
[get](foundry.documents.collections.Scenes.html#get)
[getInvalid](foundry.documents.collections.Scenes.html#getinvalid)
[getName](foundry.documents.collections.Scenes.html#getname)
[importFromCompendium](foundry.documents.collections.Scenes.html#importfromcompendium)
[map](foundry.documents.collections.Scenes.html#map)
[preload](foundry.documents.collections.Scenes.html#preload)
[reduce](foundry.documents.collections.Scenes.html#reduce)
[render](foundry.documents.collections.Scenes.html#render)
[search](foundry.documents.collections.Scenes.html#search)
[set](foundry.documents.collections.Scenes.html#set)
[some](foundry.documents.collections.Scenes.html#some)
[toJSON](foundry.documents.collections.Scenes.html#tojson)
[updateAll](foundry.documents.collections.Scenes.html#updateall)
[\_initialize](foundry.documents.collections.Scenes.html#_initialize)
[\_activateSocketListeners](foundry.documents.collections.Scenes.html#_activatesocketlisteners)
[getSearchableFields](foundry.documents.collections.Scenes.html#getsearchablefields)
[registerSheet](foundry.documents.collections.Scenes.html#registersheet)
[unregisterSheet](foundry.documents.collections.Scenes.html#unregistersheet)

## Constructors

### constructor

* new Scenes(data?: object[]): [Scenes](foundry.documents.collections.Scenes.html)
  ...
  #### Returns [Scenes](foundry.documents.collections.Scenes.html)
...
* get active(): [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)
...
* get current(): [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)
...
* get viewed(): [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)>,  
  Â Â Â Â ) => unknown,  
  ): undefined | [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)
  ...
  #### Returns undefined | [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)
...
* forEach(fn: (value: [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)) => void
...
* fromCompendium(  
  ...
  Â Â Â Â \_\_namedParameters?: { clearSort?: boolean },  
  ): object
  ...
  + \_\_namedParameters: { clearSort?: boolean } = {}
...
* getInvalid(id: string, options?: { strict?: boolean }): void | [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)
  ...
  #### Returns void | [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)
...
* map(  
  Â Â Â Â transformer: (  
  Â Â Â Â Â Â Â Â arg0: [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html),  
  ...
  + transformer: (arg0: [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html), arg1: number, arg2: [Collection](foundry.utils.Collection.html)) => any
...
* preload(  
  Â Â Â Â sceneId: string,  
  Â Â Â Â push?: boolean,  
  ): Promise<Socket<DefaultEventsMap, DefaultEventsMap> | (void | [Sound](foundry.audio.Sound.html))[]>
  ...
  #### Returns Promise<Socket<DefaultEventsMap, DefaultEventsMap> | (void | [Sound](foundry.audio.Sound.html))[]>
...
* reduce(  
  ...
  Â Â Â Â Â Â Â Â arg1: [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html),  
  ...
  + reducer: (arg0: any, arg1: [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html), arg2: number, arg3: [Collection](foundry.utils.Collection.html)) => any
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)[]
...
* some(  
  ...
  + condition: (arg0: [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html), arg1: number, arg2: [Collection](foundry.utils.Collection.html)) => boolean
