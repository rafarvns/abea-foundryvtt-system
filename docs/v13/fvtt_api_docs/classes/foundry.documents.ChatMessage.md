---
title: "ChatMessage | Foundry Virtual Tabletop - API Documentation - Version 13"
...
* [ChatMessage](foundry.documents.ChatMessage.html)
...
* [hookEvents.renderChatMessageHTML](../functions/hookEvents.renderChatMessageHTML.html)
...
[foundry.documents.collections.ChatMessages](foundry.documents.collections.ChatMessages.html): The world-level collection of ChatMessage
documents

#### Hierarchy ([View Summary](../hierarchy.html#foundry.documents.ChatMessage))

* [BaseChatMessage](foundry.documents.BaseChatMessage.html)<this>
  + ChatMessage
...
[constructor](foundry.documents.ChatMessage.html#constructor)

### Properties

[\_source](foundry.documents.ChatMessage.html#_source)
[logged](foundry.documents.ChatMessage.html#logged)
[parent](foundry.documents.ChatMessage.html#parent)
[\_schema](foundry.documents.ChatMessage.html#_schema)
[LOCALIZATION\_PREFIXES](foundry.documents.ChatMessage.html#localization_prefixes)
[metadata](foundry.documents.ChatMessage.html#metadata)

### Accessors

[alias](foundry.documents.ChatMessage.html#alias)
[compendium](foundry.documents.ChatMessage.html#compendium)
[id](foundry.documents.ChatMessage.html#id)
[inCompendium](foundry.documents.ChatMessage.html#incompendium)
[invalid](foundry.documents.ChatMessage.html#invalid)
[isAuthor](foundry.documents.ChatMessage.html#isauthor)
[isContentVisible](foundry.documents.ChatMessage.html#iscontentvisible)
[isEmbedded](foundry.documents.ChatMessage.html#isembedded)
[isRoll](foundry.documents.ChatMessage.html#isroll)
[schema](foundry.documents.ChatMessage.html#schema)
[speakerActor](foundry.documents.ChatMessage.html#speakeractor)
[uuid](foundry.documents.ChatMessage.html#uuid)
[validationFailures](foundry.documents.ChatMessage.html#validationfailures)
[visible](foundry.documents.ChatMessage.html#visible)
[baseDocument](foundry.documents.ChatMessage.html#basedocument)
[collectionName](foundry.documents.ChatMessage.html#collectionname)
[database](foundry.documents.ChatMessage.html#database)
[documentName](foundry.documents.ChatMessage.html#documentname)
[hasTypeData](foundry.documents.ChatMessage.html#hastypedata)
[hierarchy](foundry.documents.ChatMessage.html#hierarchy)
[implementation](foundry.documents.ChatMessage.html#implementation)
[schema](foundry.documents.ChatMessage.html#schema-2)
[TYPES](foundry.documents.ChatMessage.html#types)

### Methods

[\_configure](foundry.documents.ChatMessage.html#_configure)
[\_getParentCollection](foundry.documents.ChatMessage.html#_getparentcollection)
[\_onCreate](foundry.documents.ChatMessage.html#_oncreate)
[\_onDelete](foundry.documents.ChatMessage.html#_ondelete)
[\_onUpdate](foundry.documents.ChatMessage.html#_onupdate)
[\_preCreate](foundry.documents.ChatMessage.html#_precreate)
[applyRollMode](foundry.documents.ChatMessage.html#applyrollmode)
[canUserModify](foundry.documents.ChatMessage.html#canusermodify)
[clone](foundry.documents.ChatMessage.html#clone)
[createEmbeddedDocuments](foundry.documents.ChatMessage.html#createembeddeddocuments)
[delete](foundry.documents.ChatMessage.html#delete)
[deleteEmbeddedDocuments](foundry.documents.ChatMessage.html#deleteembeddeddocuments)
[export](foundry.documents.ChatMessage.html#export)
[getEmbeddedCollection](foundry.documents.ChatMessage.html#getembeddedcollection)
[getEmbeddedDocument](foundry.documents.ChatMessage.html#getembeddeddocument)
[getFlag](foundry.documents.ChatMessage.html#getflag)
[getRollData](foundry.documents.ChatMessage.html#getrolldata)
[getUserLevel](foundry.documents.ChatMessage.html#getuserlevel)
[migrateSystemData](foundry.documents.ChatMessage.html#migratesystemdata)
[prepareDerivedData](foundry.documents.ChatMessage.html#preparederiveddata)
[renderHTML](foundry.documents.ChatMessage.html#renderhtml)
[reset](foundry.documents.ChatMessage.html#reset)
[setFlag](foundry.documents.ChatMessage.html#setflag)
[testUserPermission](foundry.documents.ChatMessage.html#testuserpermission)
[toJSON](foundry.documents.ChatMessage.html#tojson)
[toObject](foundry.documents.ChatMessage.html#toobject)
[traverseEmbeddedDocuments](foundry.documents.ChatMessage.html#traverseembeddeddocuments)
[unsetFlag](foundry.documents.ChatMessage.html#unsetflag)
[update](foundry.documents.ChatMessage.html#update)
[updateEmbeddedDocuments](foundry.documents.ChatMessage.html#updateembeddeddocuments)
[updateSource](foundry.documents.ChatMessage.html#updatesource)
[validate](foundry.documents.ChatMessage.html#validate)
[\_initialize](foundry.documents.ChatMessage.html#_initialize)
[\_initializeSource](foundry.documents.ChatMessage.html#_initializesource)
[\_preDelete](foundry.documents.ChatMessage.html#_predelete)
[\_preUpdate](foundry.documents.ChatMessage.html#_preupdate)
[\_addDataFieldMigration](foundry.documents.ChatMessage.html#_adddatafieldmigration)
[\_addDataFieldShim](foundry.documents.ChatMessage.html#_adddatafieldshim)
[\_addDataFieldShims](foundry.documents.ChatMessage.html#_adddatafieldshims)
[\_clearFieldsRecursively](foundry.documents.ChatMessage.html#_clearfieldsrecursively)
[\_initializationOrder](foundry.documents.ChatMessage.html#_initializationorder)
[\_logDataFieldMigration](foundry.documents.ChatMessage.html#_logdatafieldmigration)
[applyRollMode](foundry.documents.ChatMessage.html#applyrollmode-2)
[canUserCreate](foundry.documents.ChatMessage.html#canusercreate)
[cleanData](foundry.documents.ChatMessage.html#cleandata)
[create](foundry.documents.ChatMessage.html#create)
[createDocuments](foundry.documents.ChatMessage.html#createdocuments)
[defineSchema](foundry.documents.ChatMessage.html#defineschema)
[deleteDocuments](foundry.documents.ChatMessage.html#deletedocuments)
[fromJSON](foundry.documents.ChatMessage.html#fromjson)
[fromSource](foundry.documents.ChatMessage.html#fromsource)
[get](foundry.documents.ChatMessage.html#get)
[getCollectionName](foundry.documents.ChatMessage.html#getcollectionname)
[getSpeaker](foundry.documents.ChatMessage.html#getspeaker)
[getSpeakerActor](foundry.documents.ChatMessage.html#getspeakeractor)
[getWhisperRecipients](foundry.documents.ChatMessage.html#getwhisperrecipients)
[migrateData](foundry.documents.ChatMessage.html#migratedata)
[migrateDataSafe](foundry.documents.ChatMessage.html#migratedatasafe)
[shimData](foundry.documents.ChatMessage.html#shimdata)
[updateDocuments](foundry.documents.ChatMessage.html#updatedocuments)
[validateJoint](foundry.documents.ChatMessage.html#validatejoint)
[\_onCreateOperation](foundry.documents.ChatMessage.html#_oncreateoperation)
[\_onDeleteOperation](foundry.documents.ChatMessage.html#_ondeleteoperation)
[\_onUpdateOperation](foundry.documents.ChatMessage.html#_onupdateoperation)
[\_preCreateOperation](foundry.documents.ChatMessage.html#_precreateoperation)
[\_preDeleteOperation](foundry.documents.ChatMessage.html#_predeleteoperation)
[\_preUpdateOperation](foundry.documents.ChatMessage.html#_preupdateoperation)
...
* new ChatMessage(  
  Â Â Â Â data?: Partial<[ChatMessageData](../interfaces/foundry.documents.types.ChatMessageData.html)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.html),  
  ): [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)

  #### Parameters

  + `Optional`data: Partial<[ChatMessageData](../interfaces/foundry.documents.types.ChatMessageData.html)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)

  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[constructor](foundry.documents.BaseChatMessage.html#constructor)

## Properties

### \_source

\_source: [ChatMessageData](../interfaces/foundry.documents.types.ChatMessageData.html)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_source](foundry.documents.BaseChatMessage.html#_source)
...
Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[parent](foundry.documents.BaseChatMessage.html#parent)
...
Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_schema](foundry.documents.BaseChatMessage.html#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[LOCALIZATION\_PREFIXES](foundry.documents.BaseChatMessage.html#localization_prefixes)
...
Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[metadata](foundry.documents.BaseChatMessage.html#metadata)
...
* get compendium(): any
  ...
  Inherited from ClientDocumentMixin(BaseChatMessage).compendium
...
* get speakerActor(): null | [documents](../modules/foundry.documents.html).[Actor](foundry.documents.Actor.html)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_configure](foundry.documents.BaseChatMessage.html#_configure)
...
* \_getParentCollection(parentCollection?: null | string): null | string
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_getParentCollection](foundry.documents.BaseChatMessage.html#_getparentcollection)
...
* \_onCreate(data: any, options: any, userId: any): void
  ...
  Overrides [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_onCreate](foundry.documents.BaseChatMessage.html#_oncreate)
...
* \_onDelete(options: any, userId: any): void
  ...
  Overrides [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_onDelete](foundry.documents.BaseChatMessage.html#_ondelete)
...
* \_onUpdate(changed: any, options: any, userId: any): void
  ...
  Overrides [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_onUpdate](foundry.documents.BaseChatMessage.html#_onupdate)
...
* \_preCreate(data: any, options: any, user: any): Promise<undefined | false>
  ...
  Modifications to the pending Document instance must be performed using [updateSource](foundry.documents.ChatMessage.html#updatesource).
  ...
  Overrides [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_preCreate](foundry.documents.BaseChatMessage.html#_precreate)

### applyRollMode

* applyRollMode(  
  Â Â Â Â rollMode: "publicroll" | "gmroll" | "blindroll" | "selfroll" | "roll",  
  ): void

  Update the data of a ChatMessage instance to apply a requested roll mode.
  This function calls [ChatMessage.applyRollMode](foundry.documents.ChatMessage.html#applyrollmode-2) and updates the source of the ChatMessage.
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.html), action: string, data?: object): boolean
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[canUserModify](foundry.documents.BaseChatMessage.html#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[clone](foundry.documents.BaseChatMessage.html#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[createEmbeddedDocuments](foundry.documents.BaseChatMessage.html#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[delete](foundry.documents.BaseChatMessage.html#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[deleteEmbeddedDocuments](foundry.documents.BaseChatMessage.html#deleteembeddeddocuments)
...
* getEmbeddedCollection(embeddedName: string): DocumentCollection
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[getEmbeddedCollection](foundry.documents.BaseChatMessage.html#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[getEmbeddedDocument](foundry.documents.BaseChatMessage.html#getembeddeddocument)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[getFlag](foundry.documents.BaseChatMessage.html#getflag)
...
* getUserLevel(user: any): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.html)
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[getUserLevel](foundry.documents.BaseChatMessage.html#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[migrateSystemData](foundry.documents.BaseChatMessage.html#migratesystemdata)
...
* renderHTML(  
  Â Â Â Â options?: { canClose?: boolean; canDelete?: boolean },  
  ): Promise<HTMLElement>
  ...
  + `Optional`options: { canClose?: boolean; canDelete?: boolean } = {}
...
* reset(): void
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[reset](foundry.documents.BaseChatMessage.html#reset)
...
* setFlag(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[setFlag](foundry.documents.BaseChatMessage.html#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[testUserPermission](foundry.documents.BaseChatMessage.html#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[toJSON](foundry.documents.BaseChatMessage.html#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[toObject](foundry.documents.BaseChatMessage.html#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[traverseEmbeddedDocuments](foundry.documents.BaseChatMessage.html#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[unsetFlag](foundry.documents.BaseChatMessage.html#unsetflag)
...
* update(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[update](foundry.documents.BaseChatMessage.html#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[updateEmbeddedDocuments](foundry.documents.BaseChatMessage.html#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.html)): object
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[updateSource](foundry.documents.BaseChatMessage.html#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.html)): boolean
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[validate](foundry.documents.BaseChatMessage.html#validate)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_initialize](foundry.documents.BaseChatMessage.html#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_initializeSource](foundry.documents.BaseChatMessage.html#_initializesource)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.html)): Promise<boolean | void>
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_preDelete](foundry.documents.BaseChatMessage.html#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_preUpdate](foundry.documents.BaseChatMessage.html#_preupdate)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_addDataFieldMigration](foundry.documents.BaseChatMessage.html#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_addDataFieldShim](foundry.documents.BaseChatMessage.html#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_addDataFieldShims](foundry.documents.BaseChatMessage.html#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_clearFieldsRecursively](foundry.documents.BaseChatMessage.html#_clearfieldsrecursively)
...
* \_initializationOrder(): Generator<any[], void, unknown>
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_initializationOrder](foundry.documents.BaseChatMessage.html#_initializationorder)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_logDataFieldMigration](foundry.documents.BaseChatMessage.html#_logdatafieldmigration)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.html)): boolean
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[canUserCreate](foundry.documents.BaseChatMessage.html#canusercreate)
...
* cleanData(source?: object, options?: object): object
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[cleanData](foundry.documents.BaseChatMessage.html#cleandata)
...
* create(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[create](foundry.documents.BaseChatMessage.html#create)
...
* createDocuments(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[createDocuments](foundry.documents.BaseChatMessage.html#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â blind: [BooleanField](foundry.data.fields.BooleanField.html);  
  Â Â Â Â content: [HTMLField](foundry.data.fields.HTMLField.html);  
  Â Â Â Â emote: [BooleanField](foundry.data.fields.BooleanField.html);  
  Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.html);  
  Â Â Â Â flavor: [HTMLField](foundry.data.fields.HTMLField.html);  
  Â Â Â Â rolls: [ArrayField](foundry.data.fields.ArrayField.html)<[JSONField](foundry.data.fields.JSONField.html)>;  
  Â Â Â Â sound: [FilePathField](foundry.data.fields.FilePathField.html);  
  Â Â Â Â speaker: [SchemaField](foundry.data.fields.SchemaField.html);  
  Â Â Â Â style: [NumberField](foundry.data.fields.NumberField.html);  
  Â Â Â Â system: [TypeDataField](foundry.data.fields.TypeDataField.html);  
  Â Â Â Â timestamp: [NumberField](foundry.data.fields.NumberField.html);  
  Â Â Â Â title: [StringField](foundry.data.fields.StringField.html);  
  Â Â Â Â type: [DocumentTypeField](foundry.data.fields.DocumentTypeField.html);  
  Â Â Â Â whisper: [ArrayField](foundry.data.fields.ArrayField.html)<[ForeignDocumentField](foundry.data.fields.ForeignDocumentField.html)>;  
  }
  ...
  [\_source](foundry.documents.ChatMessage.html#_source) values into direct properties of the data model. The schema is a static property of the model and
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.html); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.html); Â Â Â Â author: [DocumentAuthorField](foundry.data.fields.DocumentAuthorField.html); Â Â Â Â blind: [BooleanField](foundry.data.fields.BooleanField.html); Â Â Â Â content: [HTMLField](foundry.data.fields.HTMLField.html); Â Â Â Â emote: [BooleanField](foundry.data.fields.BooleanField.html); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.html); Â Â Â Â flavor: [HTMLField](foundry.data.fields.HTMLField.html); Â Â Â Â rolls: [ArrayField](foundry.data.fields.ArrayField.html)<[JSONField](foundry.data.fields.JSONField.html)>; Â Â Â Â sound: [FilePathField](foundry.data.fields.FilePathField.html); Â Â Â Â speaker: [SchemaField](foundry.data.fields.SchemaField.html); Â Â Â Â style: [NumberField](foundry.data.fields.NumberField.html); Â Â Â Â system: [TypeDataField](foundry.data.fields.TypeDataField.html); Â Â Â Â timestamp: [NumberField](foundry.data.fields.NumberField.html); Â Â Â Â title: [StringField](foundry.data.fields.StringField.html); Â Â Â Â type: [DocumentTypeField](foundry.data.fields.DocumentTypeField.html); Â Â Â Â whisper: [ArrayField](foundry.data.fields.ArrayField.html)<[ForeignDocumentField](foundry.data.fields.ForeignDocumentField.html)>; }
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[defineSchema](foundry.documents.BaseChatMessage.html#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[deleteDocuments](foundry.documents.BaseChatMessage.html#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.html)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.html)>
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[fromJSON](foundry.documents.BaseChatMessage.html#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[fromSource](foundry.documents.BaseChatMessage.html#fromsource)
...
* get(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[get](foundry.documents.BaseChatMessage.html#get)
...
* getCollectionName(name: string): null | string
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[getCollectionName](foundry.documents.BaseChatMessage.html#getcollectionname)

### `Static`getSpeaker

* getSpeaker(  
  Â Â Â Â options?: {  
  Â Â Â Â Â Â Â Â actor?: [documents](../modules/foundry.documents.html).[Actor](foundry.documents.Actor.html);  
  Â Â Â Â Â Â Â Â alias?: string;  
  Â Â Â Â Â Â Â Â scene?: [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html);  
  Â Â Â Â Â Â Â Â token?: [TokenDocument](foundry.documents.TokenDocument.html);  
  Â Â Â Â },  
  ): [ChatSpeakerData](../interfaces/foundry.documents.types.ChatSpeakerData.html)
  ...
  + `Optional`options: {  
    ...
    Â Â Â Â alias?: string;  
    Â Â Â Â scene?: [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html);  
    Â Â Â Â token?: [TokenDocument](foundry.documents.TokenDocument.html);  
    } = {}

    Options which affect speaker identification

    - ##### `Optional`actor?: [documents](../modules/foundry.documents.html).[Actor](foundry.documents.Actor.html)
    ...
    - ##### `Optional`token?: [TokenDocument](foundry.documents.TokenDocument.html)

      The Token who is speaking

  #### Returns [ChatSpeakerData](../interfaces/foundry.documents.types.ChatSpeakerData.html)

  The identified speaker data

### `Static`getSpeakerActor

* getSpeakerActor(speaker: Object): null | [documents](../modules/foundry.documents.html).[Actor](foundry.documents.Actor.html)
...
* getWhisperRecipients(name: string): [documents](../modules/foundry.documents.html).[User](foundry.documents.User.html)[]
...
* migrateData(data: any): object
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[migrateData](foundry.documents.BaseChatMessage.html#migratedata)
...
* migrateDataSafe(source: object): object
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[migrateDataSafe](foundry.documents.BaseChatMessage.html#migratedatasafe)
...
* shimData(data: any, options: any): object
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[shimData](foundry.documents.BaseChatMessage.html#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[updateDocuments](foundry.documents.BaseChatMessage.html#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[validateJoint](foundry.documents.BaseChatMessage.html#validatejoint)
...
* \_onCreateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onCreate](foundry.documents.ChatMessage.html#_oncreate) workflows.
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_onCreateOperation](foundry.documents.BaseChatMessage.html#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onDelete](foundry.documents.ChatMessage.html#_ondelete) workflows.
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_onDeleteOperation](foundry.documents.BaseChatMessage.html#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onUpdate](foundry.documents.ChatMessage.html#_onupdate) workflows.
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_onUpdateOperation](foundry.documents.BaseChatMessage.html#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preCreate](foundry.documents.ChatMessage.html#_precreate) workflows and provides a final pre-flight check
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_preCreateOperation](foundry.documents.BaseChatMessage.html#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preDelete](foundry.documents.ChatMessage.html#_predelete) workflows and provides a final pre-flight check
  before a database operation occurs.
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_preDeleteOperation](foundry.documents.BaseChatMessage.html#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preUpdate](foundry.documents.ChatMessage.html#_preupdate) workflows and provides a final pre-flight check
  before a database operation occurs.
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.html).[\_preUpdateOperation](foundry.documents.BaseChatMessage.html#_preupdateoperation)