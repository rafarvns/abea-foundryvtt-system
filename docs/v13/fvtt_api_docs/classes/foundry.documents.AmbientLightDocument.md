---
title: "AmbientLightDocument | Foundry Virtual Tabletop - API Documentation - Version 13"
...
* [foundry.documents.Scene](foundry.documents.Scene.html): The Scene document type which contains AmbientLight documents
* [foundry.applications.sheets.AmbientLightConfig](foundry.applications.sheets.AmbientLightConfig.html): The AmbientLight configuration
  application

#### Hierarchy ([View Summary](../hierarchy.html#foundry.documents.AmbientLightDocument))

* [BaseAmbientLight](foundry.documents.BaseAmbientLight.html)<this>
...
[constructor](foundry.documents.AmbientLightDocument.html#constructor)

### Properties

[\_source](foundry.documents.AmbientLightDocument.html#_source)
[parent](foundry.documents.AmbientLightDocument.html#parent)
[\_schema](foundry.documents.AmbientLightDocument.html#_schema)
[LOCALIZATION\_PREFIXES](foundry.documents.AmbientLightDocument.html#localization_prefixes)
[metadata](foundry.documents.AmbientLightDocument.html#metadata)

### Accessors

[compendium](foundry.documents.AmbientLightDocument.html#compendium)
[id](foundry.documents.AmbientLightDocument.html#id)
[inCompendium](foundry.documents.AmbientLightDocument.html#incompendium)
[invalid](foundry.documents.AmbientLightDocument.html#invalid)
[isEmbedded](foundry.documents.AmbientLightDocument.html#isembedded)
[isGlobal](foundry.documents.AmbientLightDocument.html#isglobal)
[schema](foundry.documents.AmbientLightDocument.html#schema)
[uuid](foundry.documents.AmbientLightDocument.html#uuid)
[validationFailures](foundry.documents.AmbientLightDocument.html#validationfailures)
[baseDocument](foundry.documents.AmbientLightDocument.html#basedocument)
[collectionName](foundry.documents.AmbientLightDocument.html#collectionname)
[database](foundry.documents.AmbientLightDocument.html#database)
[documentName](foundry.documents.AmbientLightDocument.html#documentname)
[hasTypeData](foundry.documents.AmbientLightDocument.html#hastypedata)
[hierarchy](foundry.documents.AmbientLightDocument.html#hierarchy)
[implementation](foundry.documents.AmbientLightDocument.html#implementation)
[schema](foundry.documents.AmbientLightDocument.html#schema-2)
[TYPES](foundry.documents.AmbientLightDocument.html#types)

### Methods

[\_configure](foundry.documents.AmbientLightDocument.html#_configure)
[\_getParentCollection](foundry.documents.AmbientLightDocument.html#_getparentcollection)
[\_onUpdate](foundry.documents.AmbientLightDocument.html#_onupdate)
[canUserModify](foundry.documents.AmbientLightDocument.html#canusermodify)
[clone](foundry.documents.AmbientLightDocument.html#clone)
[createEmbeddedDocuments](foundry.documents.AmbientLightDocument.html#createembeddeddocuments)
[delete](foundry.documents.AmbientLightDocument.html#delete)
[deleteEmbeddedDocuments](foundry.documents.AmbientLightDocument.html#deleteembeddeddocuments)
[getEmbeddedCollection](foundry.documents.AmbientLightDocument.html#getembeddedcollection)
[getEmbeddedDocument](foundry.documents.AmbientLightDocument.html#getembeddeddocument)
[getFlag](foundry.documents.AmbientLightDocument.html#getflag)
[getUserLevel](foundry.documents.AmbientLightDocument.html#getuserlevel)
[migrateSystemData](foundry.documents.AmbientLightDocument.html#migratesystemdata)
[reset](foundry.documents.AmbientLightDocument.html#reset)
[setFlag](foundry.documents.AmbientLightDocument.html#setflag)
[testUserPermission](foundry.documents.AmbientLightDocument.html#testuserpermission)
[toJSON](foundry.documents.AmbientLightDocument.html#tojson)
[toObject](foundry.documents.AmbientLightDocument.html#toobject)
[traverseEmbeddedDocuments](foundry.documents.AmbientLightDocument.html#traverseembeddeddocuments)
[unsetFlag](foundry.documents.AmbientLightDocument.html#unsetflag)
[update](foundry.documents.AmbientLightDocument.html#update)
[updateEmbeddedDocuments](foundry.documents.AmbientLightDocument.html#updateembeddeddocuments)
[updateSource](foundry.documents.AmbientLightDocument.html#updatesource)
[validate](foundry.documents.AmbientLightDocument.html#validate)
[\_initialize](foundry.documents.AmbientLightDocument.html#_initialize)
[\_initializeSource](foundry.documents.AmbientLightDocument.html#_initializesource)
[\_onCreate](foundry.documents.AmbientLightDocument.html#_oncreate)
[\_onDelete](foundry.documents.AmbientLightDocument.html#_ondelete)
[\_preCreate](foundry.documents.AmbientLightDocument.html#_precreate)
[\_preDelete](foundry.documents.AmbientLightDocument.html#_predelete)
[\_preUpdate](foundry.documents.AmbientLightDocument.html#_preupdate)
[\_addDataFieldMigration](foundry.documents.AmbientLightDocument.html#_adddatafieldmigration)
[\_addDataFieldShim](foundry.documents.AmbientLightDocument.html#_adddatafieldshim)
[\_addDataFieldShims](foundry.documents.AmbientLightDocument.html#_adddatafieldshims)
[\_clearFieldsRecursively](foundry.documents.AmbientLightDocument.html#_clearfieldsrecursively)
[\_initializationOrder](foundry.documents.AmbientLightDocument.html#_initializationorder)
[\_logDataFieldMigration](foundry.documents.AmbientLightDocument.html#_logdatafieldmigration)
[canUserCreate](foundry.documents.AmbientLightDocument.html#canusercreate)
[cleanData](foundry.documents.AmbientLightDocument.html#cleandata)
[create](foundry.documents.AmbientLightDocument.html#create)
[createDocuments](foundry.documents.AmbientLightDocument.html#createdocuments)
[defineSchema](foundry.documents.AmbientLightDocument.html#defineschema)
[deleteDocuments](foundry.documents.AmbientLightDocument.html#deletedocuments)
[fromJSON](foundry.documents.AmbientLightDocument.html#fromjson)
[fromSource](foundry.documents.AmbientLightDocument.html#fromsource)
[get](foundry.documents.AmbientLightDocument.html#get)
[getCollectionName](foundry.documents.AmbientLightDocument.html#getcollectionname)
[migrateData](foundry.documents.AmbientLightDocument.html#migratedata)
[migrateDataSafe](foundry.documents.AmbientLightDocument.html#migratedatasafe)
[shimData](foundry.documents.AmbientLightDocument.html#shimdata)
[updateDocuments](foundry.documents.AmbientLightDocument.html#updatedocuments)
[validateJoint](foundry.documents.AmbientLightDocument.html#validatejoint)
[\_onCreateOperation](foundry.documents.AmbientLightDocument.html#_oncreateoperation)
[\_onDeleteOperation](foundry.documents.AmbientLightDocument.html#_ondeleteoperation)
[\_onUpdateOperation](foundry.documents.AmbientLightDocument.html#_onupdateoperation)
[\_preCreateOperation](foundry.documents.AmbientLightDocument.html#_precreateoperation)
[\_preDeleteOperation](foundry.documents.AmbientLightDocument.html#_predeleteoperation)
[\_preUpdateOperation](foundry.documents.AmbientLightDocument.html#_preupdateoperation)

## Constructors

### constructor

* new AmbientLightDocument(  
  ...
  #### Returns [AmbientLightDocument](foundry.documents.AmbientLightDocument.html)

  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[constructor](foundry.documents.BaseAmbientLight.html#constructor)
...
Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_source](foundry.documents.BaseAmbientLight.html#_source)
...
Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[parent](foundry.documents.BaseAmbientLight.html#parent)
...
Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_schema](foundry.documents.BaseAmbientLight.html#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[LOCALIZATION\_PREFIXES](foundry.documents.BaseAmbientLight.html#localization_prefixes)
...
Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[metadata](foundry.documents.BaseAmbientLight.html#metadata)
...
* get uuid(): string
  ...
  Inherited from CanvasDocumentMixin(BaseAmbientLight).uuid
...
* get database(): [abstract](../modules/foundry.abstract.html).[DatabaseBackend](foundry.abstract.DatabaseBackend.html)
  ...
  Inherited from CanvasDocumentMixin(BaseAmbientLight).database
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_configure](foundry.documents.BaseAmbientLight.html#_configure)
...
* \_getParentCollection(parentCollection?: null | string): null | string
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_getParentCollection](foundry.documents.BaseAmbientLight.html#_getparentcollection)
...
* \_onUpdate(changed: any, options: any, userId: any): void
  ...
  Overrides [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_onUpdate](foundry.documents.BaseAmbientLight.html#_onupdate)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.html), action: string, data?: object): boolean
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[canUserModify](foundry.documents.BaseAmbientLight.html#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[clone](foundry.documents.BaseAmbientLight.html#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[createEmbeddedDocuments](foundry.documents.BaseAmbientLight.html#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[delete](foundry.documents.BaseAmbientLight.html#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[deleteEmbeddedDocuments](foundry.documents.BaseAmbientLight.html#deleteembeddeddocuments)
...
* getEmbeddedCollection(embeddedName: string): DocumentCollection
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[getEmbeddedCollection](foundry.documents.BaseAmbientLight.html#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[getEmbeddedDocument](foundry.documents.BaseAmbientLight.html#getembeddeddocument)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[getFlag](foundry.documents.BaseAmbientLight.html#getflag)
...
* getUserLevel(user?: [BaseUser](foundry.documents.BaseUser.html)): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.html)
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[getUserLevel](foundry.documents.BaseAmbientLight.html#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[migrateSystemData](foundry.documents.BaseAmbientLight.html#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[reset](foundry.documents.BaseAmbientLight.html#reset)
...
* setFlag(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[setFlag](foundry.documents.BaseAmbientLight.html#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[testUserPermission](foundry.documents.BaseAmbientLight.html#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[toJSON](foundry.documents.BaseAmbientLight.html#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[toObject](foundry.documents.BaseAmbientLight.html#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[traverseEmbeddedDocuments](foundry.documents.BaseAmbientLight.html#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[unsetFlag](foundry.documents.BaseAmbientLight.html#unsetflag)
...
* update(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[update](foundry.documents.BaseAmbientLight.html#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[updateEmbeddedDocuments](foundry.documents.BaseAmbientLight.html#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.html)): object
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[updateSource](foundry.documents.BaseAmbientLight.html#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.html)): boolean
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[validate](foundry.documents.BaseAmbientLight.html#validate)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_initialize](foundry.documents.BaseAmbientLight.html#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_initializeSource](foundry.documents.BaseAmbientLight.html#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_onCreate](foundry.documents.BaseAmbientLight.html#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_onDelete](foundry.documents.BaseAmbientLight.html#_ondelete)
...
* \_preCreate(  
  ...
  Modifications to the pending Document instance must be performed using [updateSource](foundry.documents.AmbientLightDocument.html#updatesource).
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_preCreate](foundry.documents.BaseAmbientLight.html#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.html)): Promise<boolean | void>
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_preDelete](foundry.documents.BaseAmbientLight.html#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_preUpdate](foundry.documents.BaseAmbientLight.html#_preupdate)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_addDataFieldMigration](foundry.documents.BaseAmbientLight.html#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_addDataFieldShim](foundry.documents.BaseAmbientLight.html#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_addDataFieldShims](foundry.documents.BaseAmbientLight.html#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_clearFieldsRecursively](foundry.documents.BaseAmbientLight.html#_clearfieldsrecursively)
...
* \_initializationOrder(): Generator<any[], void, unknown>
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_initializationOrder](foundry.documents.BaseAmbientLight.html#_initializationorder)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_logDataFieldMigration](foundry.documents.BaseAmbientLight.html#_logdatafieldmigration)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.html)): boolean
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[canUserCreate](foundry.documents.BaseAmbientLight.html#canusercreate)
...
* cleanData(source?: object, options?: object): object
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[cleanData](foundry.documents.BaseAmbientLight.html#cleandata)
...
* create(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[create](foundry.documents.BaseAmbientLight.html#create)
...
* createDocuments(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[createDocuments](foundry.documents.BaseAmbientLight.html#createdocuments)
...
* defineSchema(): {  
  ...
  [\_source](foundry.documents.AmbientLightDocument.html#_source) values into direct properties of the data model. The schema is a static property of the model and
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[defineSchema](foundry.documents.BaseAmbientLight.html#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[deleteDocuments](foundry.documents.BaseAmbientLight.html#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.html)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.html)>
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[fromJSON](foundry.documents.BaseAmbientLight.html#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[fromSource](foundry.documents.BaseAmbientLight.html#fromsource)
...
* get(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[get](foundry.documents.BaseAmbientLight.html#get)
...
* getCollectionName(name: string): null | string
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[getCollectionName](foundry.documents.BaseAmbientLight.html#getcollectionname)
...
* migrateData(source: object): object
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[migrateData](foundry.documents.BaseAmbientLight.html#migratedata)
...
* migrateDataSafe(source: object): object
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[migrateDataSafe](foundry.documents.BaseAmbientLight.html#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[shimData](foundry.documents.BaseAmbientLight.html#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[updateDocuments](foundry.documents.BaseAmbientLight.html#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[validateJoint](foundry.documents.BaseAmbientLight.html#validatejoint)
...
* \_onCreateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onCreate](foundry.documents.AmbientLightDocument.html#_oncreate) workflows.
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_onCreateOperation](foundry.documents.BaseAmbientLight.html#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onDelete](foundry.documents.AmbientLightDocument.html#_ondelete) workflows.
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_onDeleteOperation](foundry.documents.BaseAmbientLight.html#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onUpdate](foundry.documents.AmbientLightDocument.html#_onupdate) workflows.
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_onUpdateOperation](foundry.documents.BaseAmbientLight.html#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preCreate](foundry.documents.AmbientLightDocument.html#_precreate) workflows and provides a final pre-flight check
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_preCreateOperation](foundry.documents.BaseAmbientLight.html#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preDelete](foundry.documents.AmbientLightDocument.html#_predelete) workflows and provides a final pre-flight check
  before a database operation occurs.
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_preDeleteOperation](foundry.documents.BaseAmbientLight.html#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preUpdate](foundry.documents.AmbientLightDocument.html#_preupdate) workflows and provides a final pre-flight check
  before a database operation occurs.
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.html).[\_preUpdateOperation](foundry.documents.BaseAmbientLight.html#_preupdateoperation)