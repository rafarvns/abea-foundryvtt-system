---
title: "CombatEncounters | Foundry Virtual Tabletop - API Documentation - Version 13"
...
* [foundry.documents.Combat](foundry.documents.Combat.html): The Combat document
* [foundry.applications.sidebar.tabs.CombatTracker](foundry.applications.sidebar.tabs.CombatTracker.html): The CombatTracker sidebar directory

#### Hierarchy ([View Summary](../hierarchy.html#foundry.documents.collections.CombatEncounters))
...
[constructor](foundry.documents.collections.CombatEncounters.html#constructor)

### Properties

[apps](foundry.documents.collections.CombatEncounters.html#apps)
[invalidDocumentIds](foundry.documents.collections.CombatEncounters.html#invaliddocumentids)
[documentName](foundry.documents.collections.CombatEncounters.html#documentname)

### Accessors

[active](foundry.documents.collections.CombatEncounters.html#active)
[combats](foundry.documents.collections.CombatEncounters.html#combats)
[contents](foundry.documents.collections.CombatEncounters.html#contents)
[directory](foundry.documents.collections.CombatEncounters.html#directory)
[documentClass](foundry.documents.collections.CombatEncounters.html#documentclass)
[documentName](foundry.documents.collections.CombatEncounters.html#documentname-1)
[folders](foundry.documents.collections.CombatEncounters.html#folders)
[name](foundry.documents.collections.CombatEncounters.html#name)
[viewed](foundry.documents.collections.CombatEncounters.html#viewed)
[instance](foundry.documents.collections.CombatEncounters.html#instance)
[registeredSheets](foundry.documents.collections.CombatEncounters.html#registeredsheets)
[settings](foundry.documents.collections.CombatEncounters.html#settings)

### Methods

[\_getVisibleTreeContents](foundry.documents.collections.CombatEncounters.html#_getvisibletreecontents)
[\_onModifyContents](foundry.documents.collections.CombatEncounters.html#_onmodifycontents)
[[iterator]](foundry.documents.collections.CombatEncounters.html#iterator)
[createDocument](foundry.documents.collections.CombatEncounters.html#createdocument)
[delete](foundry.documents.collections.CombatEncounters.html#delete)
[filter](foundry.documents.collections.CombatEncounters.html#filter)
[find](foundry.documents.collections.CombatEncounters.html#find)
[forEach](foundry.documents.collections.CombatEncounters.html#foreach)
[fromCompendium](foundry.documents.collections.CombatEncounters.html#fromcompendium)
[get](foundry.documents.collections.CombatEncounters.html#get)
[getInvalid](foundry.documents.collections.CombatEncounters.html#getinvalid)
[getName](foundry.documents.collections.CombatEncounters.html#getname)
[importFromCompendium](foundry.documents.collections.CombatEncounters.html#importfromcompendium)
[map](foundry.documents.collections.CombatEncounters.html#map)
[reduce](foundry.documents.collections.CombatEncounters.html#reduce)
[render](foundry.documents.collections.CombatEncounters.html#render)
[search](foundry.documents.collections.CombatEncounters.html#search)
[set](foundry.documents.collections.CombatEncounters.html#set)
[some](foundry.documents.collections.CombatEncounters.html#some)
[toJSON](foundry.documents.collections.CombatEncounters.html#tojson)
[updateAll](foundry.documents.collections.CombatEncounters.html#updateall)
[\_initialize](foundry.documents.collections.CombatEncounters.html#_initialize)
[getSearchableFields](foundry.documents.collections.CombatEncounters.html#getsearchablefields)
[registerSheet](foundry.documents.collections.CombatEncounters.html#registersheet)
[unregisterSheet](foundry.documents.collections.CombatEncounters.html#unregistersheet)

## Constructors

### constructor

* new CombatEncounters(data?: object[]): [CombatEncounters](foundry.documents.collections.CombatEncounters.html)
  ...
  #### Returns [CombatEncounters](foundry.documents.collections.CombatEncounters.html)
...
* get active(): [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)
...
* get directory(): [CombatTracker](foundry.applications.sidebar.tabs.CombatTracker.html)
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)>,  
  Â Â Â Â ) => unknown,  
  ): undefined | [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)
  ...
  #### Returns undefined | [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)
...
* forEach(fn: (value: [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html),  
  ...
  + document: object | [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)
...
* getInvalid(id: string, options?: { strict?: boolean }): void | [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)
  ...
  #### Returns void | [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)
...
* map(  
  Â Â Â Â transformer: (  
  Â Â Â Â Â Â Â Â arg0: [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html),  
  ...
  + transformer: (arg0: [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html), arg1: number, arg2: [Collection](foundry.utils.Collection.html)) => any
...
* reduce(  
  ...
  Â Â Â Â Â Â Â Â arg1: [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html),  
  ...
  + reducer: (arg0: any, arg1: [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html), arg2: number, arg3: [Collection](foundry.utils.Collection.html)) => any
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html)[]
...
* some(  
  ...
  + condition: (arg0: [documents](../modules/foundry.documents.html).[Combat](foundry.documents.Combat.html), arg1: number, arg2: [Collection](foundry.utils.Collection.html)) => boolean
