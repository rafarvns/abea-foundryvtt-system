---
title: "RegionLayer | Foundry Virtual Tabletop - API Documentation - Version 13"
...
#### Hierarchy ([View Summary](../hierarchy.html#foundry.canvas.layers.RegionLayer))
...
[\_configPreview](foundry.canvas.layers.RegionLayer.html#_configpreview)
[clipboard](foundry.canvas.layers.RegionLayer.html#clipboard)
[eventMode](foundry.canvas.layers.RegionLayer.html#eventmode)
[highlightObjects](foundry.canvas.layers.RegionLayer.html#highlightobjects)
[history](foundry.canvas.layers.RegionLayer.html#history)
[interactiveChildren](foundry.canvas.layers.RegionLayer.html#interactivechildren)
[objects](foundry.canvas.layers.RegionLayer.html#objects)
[options](foundry.canvas.layers.RegionLayer.html#options)
[preview](foundry.canvas.layers.RegionLayer.html#preview)
[quadtree](foundry.canvas.layers.RegionLayer.html#quadtree)
[CREATION\_STATES](foundry.canvas.layers.RegionLayer.html#creation_states)
[documentName](foundry.canvas.layers.RegionLayer.html#documentname)
[SORT\_ORDER](foundry.canvas.layers.RegionLayer.html#sort_order)

### Accessors

[active](foundry.canvas.layers.RegionLayer.html#active)
[controlled](foundry.canvas.layers.RegionLayer.html#controlled)
[controlledObjects](foundry.canvas.layers.RegionLayer.html#controlledobjects)
[documentCollection](foundry.canvas.layers.RegionLayer.html#documentcollection)
[hasPreview](foundry.canvas.layers.RegionLayer.html#haspreview)
[hookName](foundry.canvas.layers.RegionLayer.html#hookname)
[hover](foundry.canvas.layers.RegionLayer.html#hover)
[hud](foundry.canvas.layers.RegionLayer.html#hud)
[legend](foundry.canvas.layers.RegionLayer.html#legend)
[name](foundry.canvas.layers.RegionLayer.html#name)
[placeables](foundry.canvas.layers.RegionLayer.html#placeables)
[instance](foundry.canvas.layers.RegionLayer.html#instance)
[layerOptions](foundry.canvas.layers.RegionLayer.html#layeroptions)
[placeableClass](foundry.canvas.layers.RegionLayer.html#placeableclass)

### Methods

[\_activate](foundry.canvas.layers.RegionLayer.html#_activate)
[\_canDragLeftStart](foundry.canvas.layers.RegionLayer.html#_candragleftstart)
[\_createPreview](foundry.canvas.layers.RegionLayer.html#_createpreview)
[\_deactivate](foundry.canvas.layers.RegionLayer.html#_deactivate)
[\_draw](foundry.canvas.layers.RegionLayer.html#_draw)
[\_getCopyableObjects](foundry.canvas.layers.RegionLayer.html#_getcopyableobjects)
[\_getMovableObjects](foundry.canvas.layers.RegionLayer.html#_getmovableobjects)
[\_highlightObjects](foundry.canvas.layers.RegionLayer.html#_highlightobjects)
[\_highlightShape](foundry.canvas.layers.RegionLayer.html#_highlightshape)
[\_onClickLeft](foundry.canvas.layers.RegionLayer.html#_onclickleft)
[\_onClickLeft2](foundry.canvas.layers.RegionLayer.html#_onclickleft2)
[\_onClickRight](foundry.canvas.layers.RegionLayer.html#_onclickright)
[\_onCopyKey](foundry.canvas.layers.RegionLayer.html#_oncopykey)
[\_onCutKey](foundry.canvas.layers.RegionLayer.html#_oncutkey)
[\_onDeleteKey](foundry.canvas.layers.RegionLayer.html#_ondeletekey)
[\_onDismissKey](foundry.canvas.layers.RegionLayer.html#_ondismisskey)
[\_onDragLeftCancel](foundry.canvas.layers.RegionLayer.html#_ondragleftcancel)
[\_onDragLeftDrop](foundry.canvas.layers.RegionLayer.html#_ondragleftdrop)
[\_onDragLeftMove](foundry.canvas.layers.RegionLayer.html#_ondragleftmove)
[\_onDragLeftStart](foundry.canvas.layers.RegionLayer.html#_ondragleftstart)
[\_onMouseWheel](foundry.canvas.layers.RegionLayer.html#_onmousewheel)
[\_onPasteKey](foundry.canvas.layers.RegionLayer.html#_onpastekey)
[\_onSelectAllKey](foundry.canvas.layers.RegionLayer.html#_onselectallkey)
[\_onUndoKey](foundry.canvas.layers.RegionLayer.html#_onundokey)
[\_prepareKeyboardMovementUpdates](foundry.canvas.layers.RegionLayer.html#_preparekeyboardmovementupdates)
[\_prepareKeyboardRotationUpdates](foundry.canvas.layers.RegionLayer.html#_preparekeyboardrotationupdates)
[\_sendToBackOrBringToFront](foundry.canvas.layers.RegionLayer.html#_sendtobackorbringtofront)
[\_tearDown](foundry.canvas.layers.RegionLayer.html#_teardown)
[activate](foundry.canvas.layers.RegionLayer.html#activate)
[clearPreviewContainer](foundry.canvas.layers.RegionLayer.html#clearpreviewcontainer)
[controlAll](foundry.canvas.layers.RegionLayer.html#controlall)
[controllableObjects](foundry.canvas.layers.RegionLayer.html#controllableobjects)
[copyObjects](foundry.canvas.layers.RegionLayer.html#copyobjects)
[createObject](foundry.canvas.layers.RegionLayer.html#createobject)
[deactivate](foundry.canvas.layers.RegionLayer.html#deactivate)
[deleteAll](foundry.canvas.layers.RegionLayer.html#deleteall)
[draw](foundry.canvas.layers.RegionLayer.html#draw)
[get](foundry.canvas.layers.RegionLayer.html#get)
[getDocuments](foundry.canvas.layers.RegionLayer.html#getdocuments)
[getMaxSort](foundry.canvas.layers.RegionLayer.html#getmaxsort)
[getSnappedPoint](foundry.canvas.layers.RegionLayer.html#getsnappedpoint)
[getZIndex](foundry.canvas.layers.RegionLayer.html#getzindex)
[moveMany](foundry.canvas.layers.RegionLayer.html#movemany)
[pasteObjects](foundry.canvas.layers.RegionLayer.html#pasteobjects)
[releaseAll](foundry.canvas.layers.RegionLayer.html#releaseall)
[rotateMany](foundry.canvas.layers.RegionLayer.html#rotatemany)
[selectObjects](foundry.canvas.layers.RegionLayer.html#selectobjects)
[setAllRenderFlags](foundry.canvas.layers.RegionLayer.html#setallrenderflags)
[storeHistory](foundry.canvas.layers.RegionLayer.html#storehistory)
[tearDown](foundry.canvas.layers.RegionLayer.html#teardown)
[undoHistory](foundry.canvas.layers.RegionLayer.html#undohistory)
[updateAll](foundry.canvas.layers.RegionLayer.html#updateall)
[\_canvasCoordinatesFromDrop](foundry.canvas.layers.RegionLayer.html#_canvascoordinatesfromdrop)
[\_confirmDeleteKey](foundry.canvas.layers.RegionLayer.html#_confirmdeletekey)
[\_onClickRight2](foundry.canvas.layers.RegionLayer.html#_onclickright2)
[\_onCycleViewKey](foundry.canvas.layers.RegionLayer.html#_oncycleviewkey)
[\_onUndoCreate](foundry.canvas.layers.RegionLayer.html#_onundocreate)
[\_onUndoDelete](foundry.canvas.layers.RegionLayer.html#_onundodelete)
[\_onUndoUpdate](foundry.canvas.layers.RegionLayer.html#_onundoupdate)
[\_storeHistory](foundry.canvas.layers.RegionLayer.html#_storehistory)
[prepareSceneControls](foundry.canvas.layers.RegionLayer.html#preparescenecontrols)
...
* get legend(): [RegionLegend](foundry.applications.ui.RegionLegend.html)

  The RegionLegend application of this RegionLayer.

  #### Returns [RegionLegend](foundry.applications.ui.RegionLegend.html)
...
* \_canDragLeftStart(user: any, event: any): boolean
  ...
  Overrides [PlaceablesLayer](foundry.canvas.layers.PlaceablesLayer.html).[\_canDragLeftStart](foundry.canvas.layers.PlaceablesLayer.html#_candragleftstart)
...
* \_highlightShape(data: null | [BaseShapeData](foundry.data.BaseShapeData.html)): void
  ...
  + data: null | [BaseShapeData](foundry.data.BaseShapeData.html)
...
* copyObjects(): never[]
  ...
  Overrides [PlaceablesLayer](foundry.canvas.layers.PlaceablesLayer.html).[copyObjects](foundry.canvas.layers.PlaceablesLayer.html#copyobjects)
...
* getZIndex(): any
  ...
  Overrides [PlaceablesLayer](foundry.canvas.layers.PlaceablesLayer.html).[getZIndex](foundry.canvas.layers.PlaceablesLayer.html#getzindex)
...
* prepareSceneControls(): {  
  ...
  #### Returns { Â Â Â Â activeTool: string; Â Â Â Â icon: string; Â Â Â Â layer: string; Â Â Â Â name: string; Â Â Â Â onChange: (event: any, active: any) => void; Â Â Â Â onToolChange: () => any; Â Â Â Â order: number; Â Â Â Â title: string; Â Â Â Â tools: { Â Â Â Â Â Â Â Â clear: { Â Â Â Â Â Â Â Â Â Â Â Â button: boolean; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â onChange: () => any; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â ellipse: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â hole: { Â Â Â Â Â Â Â Â Â Â Â Â active: boolean; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toggle: boolean; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â polygon: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â rectangle: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â select: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â snap: { Â Â Â Â Â Â Â Â Â Â Â Â active: boolean; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â onChange: (event: any, toggled: any) => any; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toggle: boolean; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â Â Â Â Â visible: boolean; Â Â Â Â Â Â Â Â }; Â Â Â Â }; Â Â Â Â visible: boolean; }
