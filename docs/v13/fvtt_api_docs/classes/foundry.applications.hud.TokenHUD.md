---
title: "TokenHUD | Foundry Virtual Tabletop - API Documentation - Version 13"
...
* [TokenHUD](foundry.applications.hud.TokenHUD.html)
...
The TokenHUD implementation can be configured and replaced via [CONFIG.Token.hudClass](../variables/CONFIG.Token.html#__typehudclass).

#### Mixes

HandlebarsApplication

#### Hierarchy ([View Summary](../hierarchy.html#foundry.applications.hud.TokenHUD))

* [BasePlaceableHUD](foundry.applications.hud.BasePlaceableHUD.html)<[canvas](../modules/foundry.canvas.html).[placeables](../modules/foundry.canvas.placeables.html).[Token](foundry.canvas.placeables.Token.html), [TokenDocument](foundry.documents.TokenDocument.html), [TokenLayer](foundry.canvas.layers.TokenLayer.html), this>
  + TokenHUD
...
[constructor](foundry.applications.hud.TokenHUD.html#constructor)

### Properties

[options](foundry.applications.hud.TokenHUD.html#options)
[position](foundry.applications.hud.TokenHUD.html#position)
[tabGroups](foundry.applications.hud.TokenHUD.html#tabgroups)
[\_appId](foundry.applications.hud.TokenHUD.html#_appid)
[\_maxZ](foundry.applications.hud.TokenHUD.html#_maxz)
[BASE\_APPLICATION](foundry.applications.hud.TokenHUD.html#base_application)
[DEFAULT\_OPTIONS](foundry.applications.hud.TokenHUD.html#default_options)
[emittedEvents](foundry.applications.hud.TokenHUD.html#emittedevents)
[PARTS](foundry.applications.hud.TokenHUD.html#parts)
[RENDER\_STATES](foundry.applications.hud.TokenHUD.html#render_states)
[TABS](foundry.applications.hud.TokenHUD.html#tabs)

### Accessors

[activePalette](foundry.applications.hud.TokenHUD.html#activepalette)
[actor](foundry.applications.hud.TokenHUD.html#actor)
[classList](foundry.applications.hud.TokenHUD.html#classlist)
[document](foundry.applications.hud.TokenHUD.html#document)
[element](foundry.applications.hud.TokenHUD.html#element)
[form](foundry.applications.hud.TokenHUD.html#form)
[hasFrame](foundry.applications.hud.TokenHUD.html#hasframe)
[id](foundry.applications.hud.TokenHUD.html#id)
[layer](foundry.applications.hud.TokenHUD.html#layer)
[minimized](foundry.applications.hud.TokenHUD.html#minimized)
[object](foundry.applications.hud.TokenHUD.html#object)
[rendered](foundry.applications.hud.TokenHUD.html#rendered)
[state](foundry.applications.hud.TokenHUD.html#state)
[title](foundry.applications.hud.TokenHUD.html#title)
[window](foundry.applications.hud.TokenHUD.html#window)

### Methods

[\_awaitTransition](foundry.applications.hud.TokenHUD.html#_awaittransition)
[\_canRender](foundry.applications.hud.TokenHUD.html#_canrender)
[\_configureRenderOptions](foundry.applications.hud.TokenHUD.html#_configurerenderoptions)
[\_doEvent](foundry.applications.hud.TokenHUD.html#_doevent)
[\_onClose](foundry.applications.hud.TokenHUD.html#_onclose)
[\_onPosition](foundry.applications.hud.TokenHUD.html#_onposition)
[\_onRender](foundry.applications.hud.TokenHUD.html#_onrender)
[\_onSubmit](foundry.applications.hud.TokenHUD.html#_onsubmit)
[\_parseAttributeInput](foundry.applications.hud.TokenHUD.html#_parseattributeinput)
[\_preClose](foundry.applications.hud.TokenHUD.html#_preclose)
[\_prepareContext](foundry.applications.hud.TokenHUD.html#_preparecontext)
[\_renderHTML](foundry.applications.hud.TokenHUD.html#_renderhtml)
[\_updatePosition](foundry.applications.hud.TokenHUD.html#_updateposition)
[addEventListener](foundry.applications.hud.TokenHUD.html#addeventlistener)
[bind](foundry.applications.hud.TokenHUD.html#bind)
[bringToFront](foundry.applications.hud.TokenHUD.html#bringtofront)
[changeTab](foundry.applications.hud.TokenHUD.html#changetab)
[close](foundry.applications.hud.TokenHUD.html#close)
[dispatchEvent](foundry.applications.hud.TokenHUD.html#dispatchevent)
[maximize](foundry.applications.hud.TokenHUD.html#maximize)
[minimize](foundry.applications.hud.TokenHUD.html#minimize)
[removeEventListener](foundry.applications.hud.TokenHUD.html#removeeventlistener)
[render](foundry.applications.hud.TokenHUD.html#render)
[setPosition](foundry.applications.hud.TokenHUD.html#setposition)
[submit](foundry.applications.hud.TokenHUD.html#submit)
[toggleControls](foundry.applications.hud.TokenHUD.html#togglecontrols)
[togglePalette](foundry.applications.hud.TokenHUD.html#togglepalette)
[\_attachFrameListeners](foundry.applications.hud.TokenHUD.html#_attachframelisteners)
[\_createContextMenu](foundry.applications.hud.TokenHUD.html#_createcontextmenu)
[\_getHeaderControls](foundry.applications.hud.TokenHUD.html#_getheadercontrols)
[\_getMovementActionChoices](foundry.applications.hud.TokenHUD.html#_getmovementactionchoices)
[\_getStatusEffectChoices](foundry.applications.hud.TokenHUD.html#_getstatuseffectchoices)
[\_getTabsConfig](foundry.applications.hud.TokenHUD.html#_gettabsconfig)
[\_headerControlButtons](foundry.applications.hud.TokenHUD.html#_headercontrolbuttons)
[\_initializeApplicationOptions](foundry.applications.hud.TokenHUD.html#_initializeapplicationoptions)
[\_insertElement](foundry.applications.hud.TokenHUD.html#_insertelement)
[\_onChangeForm](foundry.applications.hud.TokenHUD.html#_onchangeform)
[\_onClickAction](foundry.applications.hud.TokenHUD.html#_onclickaction)
[\_onClickTab](foundry.applications.hud.TokenHUD.html#_onclicktab)
[\_onFirstRender](foundry.applications.hud.TokenHUD.html#_onfirstrender)
[\_onSubmitForm](foundry.applications.hud.TokenHUD.html#_onsubmitform)
[\_postRender](foundry.applications.hud.TokenHUD.html#_postrender)
[\_preFirstRender](foundry.applications.hud.TokenHUD.html#_prefirstrender)
[\_prepareTabs](foundry.applications.hud.TokenHUD.html#_preparetabs)
[\_prePosition](foundry.applications.hud.TokenHUD.html#_preposition)
[\_preRender](foundry.applications.hud.TokenHUD.html#_prerender)
[\_removeElement](foundry.applications.hud.TokenHUD.html#_removeelement)
[\_renderFrame](foundry.applications.hud.TokenHUD.html#_renderframe)
[\_renderHeaderControl](foundry.applications.hud.TokenHUD.html#_renderheadercontrol)
[\_replaceHTML](foundry.applications.hud.TokenHUD.html#_replacehtml)
[\_tearDown](foundry.applications.hud.TokenHUD.html#_teardown)
[\_updateFrame](foundry.applications.hud.TokenHUD.html#_updateframe)
[inheritanceChain](foundry.applications.hud.TokenHUD.html#inheritancechain)
[parseCSSDimension](foundry.applications.hud.TokenHUD.html#parsecssdimension)
[waitForImages](foundry.applications.hud.TokenHUD.html#waitforimages)

## Constructors

### constructor

* new TokenHUD(options?: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.html)>): [TokenHUD](foundry.applications.hud.TokenHUD.html)
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â combat: (  
Â Â Â Â Â Â Â Â Â Â Â Â ...this: any,  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLButtonElement,  
Â Â Â Â Â Â Â Â ) => Promise<void>;  
Â Â Â Â Â Â Â Â effect: {  
Â Â Â Â Â Â Â Â Â Â Â Â buttons: number[];  
Â Â Â Â Â Â Â Â Â Â Â Â handler: (  
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ...this: any,  
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLButtonElement,  
Â Â Â Â Â Â Â Â Â Â Â Â ) => Promise<void>;  
Â Â Â Â Â Â Â Â };  
Â Â Â Â Â Â Â Â movementAction: (  
Â Â Â Â Â Â Â Â Â Â Â Â ...this: any,  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLButtonElement,  
Â Â Â Â Â Â Â Â ) => Promise<void>;  
...
* bind(object: [canvas](../modules/foundry.canvas.html).[placeables](../modules/foundry.canvas.placeables.html).[Token](foundry.canvas.placeables.Token.html)): Promise<void>

  Bind the HUD to a new PlaceableObject and display it.

  #### Parameters

  + object: [canvas](../modules/foundry.canvas.html).[placeables](../modules/foundry.canvas.placeables.html).[Token](foundry.canvas.placeables.Token.html)
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.html)>): Promise<[TokenHUD](foundry.applications.hud.TokenHUD.html)>
  ...
  #### Returns Promise<[TokenHUD](foundry.applications.hud.TokenHUD.html)>
...
* render(  
  ...
  ): Promise<[TokenHUD](foundry.applications.hud.TokenHUD.html)>
...
* \_getMovementActionChoices(): {  
  ...
  Â Â Â Â Â Â Â Â isActive: boolean;  
  ...
  #### Returns { Â Â Â Â [id: string]: { Â Â Â Â Â Â Â Â cssClass: string; Â Â Â Â Â Â Â Â id: string; Â Â Â Â Â Â Â Â isActive: boolean; Â Â Â Â Â Â Â Â label: string; Â Â Â Â }; }

### `Protected`\_getStatusEffectChoices

* \_getStatusEffectChoices(): {  
  Â Â Â Â [id: string]: {  
  Â Â Â Â Â Â Â Â \_id: string;  
  Â Â Â Â Â Â Â Â cssClass: string;  
  Â Â Â Â Â Â Â Â id: string;  
  Â Â Â Â Â Â Â Â isActive: boolean;  
  Â Â Â Â Â Â Â Â isOverlay: boolean;  
  Â Â Â Â Â Â Â Â src: string;  
  Â Â Â Â Â Â Â Â title: string;  
  Â Â Â Â };  
  }
  ...
  #### Returns { Â Â Â Â [id: string]: { Â Â Â Â Â Â Â Â \_id: string; Â Â Â Â Â Â Â Â cssClass: string; Â Â Â Â Â Â Â Â id: string; Â Â Â Â Â Â Â Â isActive: boolean; Â Â Â Â Â Â Â Â isOverlay: boolean; Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â title: string; Â Â Â Â }; }
