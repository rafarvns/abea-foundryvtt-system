---
title: "LightingLayer | Foundry Virtual Tabletop - API Documentation - Version 13"
...
#### Hierarchy ([View Summary](../hierarchy.html#foundry.canvas.layers.LightingLayer))
...
[\_configPreview](foundry.canvas.layers.LightingLayer.html#_configpreview)
[clipboard](foundry.canvas.layers.LightingLayer.html#clipboard)
[eventMode](foundry.canvas.layers.LightingLayer.html#eventmode)
[highlightObjects](foundry.canvas.layers.LightingLayer.html#highlightobjects)
[history](foundry.canvas.layers.LightingLayer.html#history)
[interactiveChildren](foundry.canvas.layers.LightingLayer.html#interactivechildren)
[objects](foundry.canvas.layers.LightingLayer.html#objects)
[options](foundry.canvas.layers.LightingLayer.html#options)
[preview](foundry.canvas.layers.LightingLayer.html#preview)
[quadtree](foundry.canvas.layers.LightingLayer.html#quadtree)
[CREATION\_STATES](foundry.canvas.layers.LightingLayer.html#creation_states)
[documentName](foundry.canvas.layers.LightingLayer.html#documentname)
[SORT\_ORDER](foundry.canvas.layers.LightingLayer.html#sort_order)

### Accessors

[active](foundry.canvas.layers.LightingLayer.html#active)
[controlled](foundry.canvas.layers.LightingLayer.html#controlled)
[controlledObjects](foundry.canvas.layers.LightingLayer.html#controlledobjects)
[documentCollection](foundry.canvas.layers.LightingLayer.html#documentcollection)
[hasPreview](foundry.canvas.layers.LightingLayer.html#haspreview)
[hookName](foundry.canvas.layers.LightingLayer.html#hookname)
[hover](foundry.canvas.layers.LightingLayer.html#hover)
[hud](foundry.canvas.layers.LightingLayer.html#hud)
[name](foundry.canvas.layers.LightingLayer.html#name)
[placeables](foundry.canvas.layers.LightingLayer.html#placeables)
[instance](foundry.canvas.layers.LightingLayer.html#instance)
[layerOptions](foundry.canvas.layers.LightingLayer.html#layeroptions)
[placeableClass](foundry.canvas.layers.LightingLayer.html#placeableclass)

### Methods

[\_activate](foundry.canvas.layers.LightingLayer.html#_activate)
[\_canDragLeftStart](foundry.canvas.layers.LightingLayer.html#_candragleftstart)
[\_createPreview](foundry.canvas.layers.LightingLayer.html#_createpreview)
[\_deactivate](foundry.canvas.layers.LightingLayer.html#_deactivate)
[\_draw](foundry.canvas.layers.LightingLayer.html#_draw)
[\_getCopyableObjects](foundry.canvas.layers.LightingLayer.html#_getcopyableobjects)
[\_getMovableObjects](foundry.canvas.layers.LightingLayer.html#_getmovableobjects)
[\_highlightObjects](foundry.canvas.layers.LightingLayer.html#_highlightobjects)
[\_onClickLeft](foundry.canvas.layers.LightingLayer.html#_onclickleft)
[\_onClickRight](foundry.canvas.layers.LightingLayer.html#_onclickright)
[\_onCopyKey](foundry.canvas.layers.LightingLayer.html#_oncopykey)
[\_onCutKey](foundry.canvas.layers.LightingLayer.html#_oncutkey)
[\_onDarknessChange](foundry.canvas.layers.LightingLayer.html#_ondarknesschange)
[\_onDeleteKey](foundry.canvas.layers.LightingLayer.html#_ondeletekey)
[\_onDismissKey](foundry.canvas.layers.LightingLayer.html#_ondismisskey)
[\_onDragLeftCancel](foundry.canvas.layers.LightingLayer.html#_ondragleftcancel)
[\_onDragLeftDrop](foundry.canvas.layers.LightingLayer.html#_ondragleftdrop)
[\_onDragLeftMove](foundry.canvas.layers.LightingLayer.html#_ondragleftmove)
[\_onDragLeftStart](foundry.canvas.layers.LightingLayer.html#_ondragleftstart)
[\_onMouseWheel](foundry.canvas.layers.LightingLayer.html#_onmousewheel)
[\_onPasteKey](foundry.canvas.layers.LightingLayer.html#_onpastekey)
[\_onSelectAllKey](foundry.canvas.layers.LightingLayer.html#_onselectallkey)
[\_onUndoKey](foundry.canvas.layers.LightingLayer.html#_onundokey)
[\_prepareKeyboardMovementUpdates](foundry.canvas.layers.LightingLayer.html#_preparekeyboardmovementupdates)
[\_prepareKeyboardRotationUpdates](foundry.canvas.layers.LightingLayer.html#_preparekeyboardrotationupdates)
[\_sendToBackOrBringToFront](foundry.canvas.layers.LightingLayer.html#_sendtobackorbringtofront)
[\_tearDown](foundry.canvas.layers.LightingLayer.html#_teardown)
[activate](foundry.canvas.layers.LightingLayer.html#activate)
[clearPreviewContainer](foundry.canvas.layers.LightingLayer.html#clearpreviewcontainer)
[controlAll](foundry.canvas.layers.LightingLayer.html#controlall)
[controllableObjects](foundry.canvas.layers.LightingLayer.html#controllableobjects)
[copyObjects](foundry.canvas.layers.LightingLayer.html#copyobjects)
[createObject](foundry.canvas.layers.LightingLayer.html#createobject)
[deactivate](foundry.canvas.layers.LightingLayer.html#deactivate)
[deleteAll](foundry.canvas.layers.LightingLayer.html#deleteall)
[draw](foundry.canvas.layers.LightingLayer.html#draw)
[get](foundry.canvas.layers.LightingLayer.html#get)
[getDocuments](foundry.canvas.layers.LightingLayer.html#getdocuments)
[getMaxSort](foundry.canvas.layers.LightingLayer.html#getmaxsort)
[getSnappedPoint](foundry.canvas.layers.LightingLayer.html#getsnappedpoint)
[getZIndex](foundry.canvas.layers.LightingLayer.html#getzindex)
[moveMany](foundry.canvas.layers.LightingLayer.html#movemany)
[pasteObjects](foundry.canvas.layers.LightingLayer.html#pasteobjects)
[refreshFields](foundry.canvas.layers.LightingLayer.html#refreshfields)
[releaseAll](foundry.canvas.layers.LightingLayer.html#releaseall)
[rotateMany](foundry.canvas.layers.LightingLayer.html#rotatemany)
[selectObjects](foundry.canvas.layers.LightingLayer.html#selectobjects)
[setAllRenderFlags](foundry.canvas.layers.LightingLayer.html#setallrenderflags)
[storeHistory](foundry.canvas.layers.LightingLayer.html#storehistory)
[tearDown](foundry.canvas.layers.LightingLayer.html#teardown)
[undoHistory](foundry.canvas.layers.LightingLayer.html#undohistory)
[updateAll](foundry.canvas.layers.LightingLayer.html#updateall)
[\_canvasCoordinatesFromDrop](foundry.canvas.layers.LightingLayer.html#_canvascoordinatesfromdrop)
[\_confirmDeleteKey](foundry.canvas.layers.LightingLayer.html#_confirmdeletekey)
[\_onClickLeft2](foundry.canvas.layers.LightingLayer.html#_onclickleft2)
[\_onClickRight2](foundry.canvas.layers.LightingLayer.html#_onclickright2)
[\_onCycleViewKey](foundry.canvas.layers.LightingLayer.html#_oncycleviewkey)
[\_onUndoCreate](foundry.canvas.layers.LightingLayer.html#_onundocreate)
[\_onUndoDelete](foundry.canvas.layers.LightingLayer.html#_onundodelete)
[\_onUndoUpdate](foundry.canvas.layers.LightingLayer.html#_onundoupdate)
[\_storeHistory](foundry.canvas.layers.LightingLayer.html#_storehistory)
[prepareSceneControls](foundry.canvas.layers.LightingLayer.html#preparescenecontrols)
...
* prepareSceneControls(): {  
  ...
  Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â | [Document](foundry.abstract.Document.html)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.html)>,  
  ...
  #### Returns { Â Â Â Â activeTool: string; Â Â Â Â icon: string; Â Â Â Â layer: string; Â Â Â Â name: string; Â Â Â Â onChange: (event: any, active: any) => void; Â Â Â Â onToolChange: () => any; Â Â Â Â order: number; Â Â Â Â title: string; Â Â Â Â tools: { Â Â Â Â Â Â Â Â clear: { Â Â Â Â Â Â Â Â Â Â Â Â button: boolean; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â onChange: () => any; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â day: { Â Â Â Â Â Â Â Â Â Â Â Â button: boolean; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â onChange: () => Promise< Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â undefined Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â | [Document](foundry.abstract.Document.html)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.html)>, Â Â Â Â Â Â Â Â Â Â Â Â >; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â Â Â Â Â visible: boolean; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â light: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â night: { Â Â Â Â Â Â Â Â Â Â Â Â button: boolean; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â onChange: () => Promise< Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â undefined Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â | [Document](foundry.abstract.Document.html)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.html)>, Â Â Â Â Â Â Â Â Â Â Â Â >; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â Â Â Â Â visible: boolean; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â reset: { Â Â Â Â Â Â Â Â Â Â Â Â button: boolean; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â onChange: () => void; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: { paragraph: string }[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â }; Â Â Â Â visible: boolean; }
