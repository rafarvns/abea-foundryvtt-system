---
title: "CardStacks | Foundry Virtual Tabletop - API Documentation - Version 13"
...
* [foundry.documents.Cards](foundry.documents.Cards.html): The Cards document
* [foundry.applications.sidebar.tabs.CardsDirectory](foundry.applications.sidebar.tabs.CardsDirectory.html): The CardsDirectory sidebar directory

#### Hierarchy ([View Summary](../hierarchy.html#foundry.documents.collections.CardStacks))
...
[constructor](foundry.documents.collections.CardStacks.html#constructor)

### Properties

[apps](foundry.documents.collections.CardStacks.html#apps)
[invalidDocumentIds](foundry.documents.collections.CardStacks.html#invaliddocumentids)
[documentName](foundry.documents.collections.CardStacks.html#documentname)

### Accessors

[contents](foundry.documents.collections.CardStacks.html#contents)
[directory](foundry.documents.collections.CardStacks.html#directory)
[documentClass](foundry.documents.collections.CardStacks.html#documentclass)
[documentName](foundry.documents.collections.CardStacks.html#documentname-1)
[folders](foundry.documents.collections.CardStacks.html#folders)
[name](foundry.documents.collections.CardStacks.html#name)
[instance](foundry.documents.collections.CardStacks.html#instance)
[registeredSheets](foundry.documents.collections.CardStacks.html#registeredsheets)

### Methods

[\_getVisibleTreeContents](foundry.documents.collections.CardStacks.html#_getvisibletreecontents)
[\_onModifyContents](foundry.documents.collections.CardStacks.html#_onmodifycontents)
[[iterator]](foundry.documents.collections.CardStacks.html#iterator)
[createDocument](foundry.documents.collections.CardStacks.html#createdocument)
[delete](foundry.documents.collections.CardStacks.html#delete)
[filter](foundry.documents.collections.CardStacks.html#filter)
[find](foundry.documents.collections.CardStacks.html#find)
[forEach](foundry.documents.collections.CardStacks.html#foreach)
[fromCompendium](foundry.documents.collections.CardStacks.html#fromcompendium)
[get](foundry.documents.collections.CardStacks.html#get)
[getInvalid](foundry.documents.collections.CardStacks.html#getinvalid)
[getName](foundry.documents.collections.CardStacks.html#getname)
[importFromCompendium](foundry.documents.collections.CardStacks.html#importfromcompendium)
[map](foundry.documents.collections.CardStacks.html#map)
[reduce](foundry.documents.collections.CardStacks.html#reduce)
[render](foundry.documents.collections.CardStacks.html#render)
[search](foundry.documents.collections.CardStacks.html#search)
[set](foundry.documents.collections.CardStacks.html#set)
[some](foundry.documents.collections.CardStacks.html#some)
[toJSON](foundry.documents.collections.CardStacks.html#tojson)
[updateAll](foundry.documents.collections.CardStacks.html#updateall)
[\_initialize](foundry.documents.collections.CardStacks.html#_initialize)
[getSearchableFields](foundry.documents.collections.CardStacks.html#getsearchablefields)
[registerSheet](foundry.documents.collections.CardStacks.html#registersheet)
[unregisterSheet](foundry.documents.collections.CardStacks.html#unregistersheet)

## Constructors

### constructor

* new CardStacks(data?: object[]): [CardStacks](foundry.documents.collections.CardStacks.html)
  ...
  #### Returns [CardStacks](foundry.documents.collections.CardStacks.html)
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)>,  
  Â Â Â Â ) => unknown,  
  ): undefined | [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)
  ...
  #### Returns undefined | [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)
...
* forEach(fn: (value: [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html),  
  ...
  + document: object | [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)
...
* getInvalid(id: string, options?: { strict?: boolean }): void | [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)
  ...
  #### Returns void | [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)
...
* map(  
  Â Â Â Â transformer: (  
  Â Â Â Â Â Â Â Â arg0: [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html),  
  ...
  + transformer: (arg0: [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html), arg1: number, arg2: [Collection](foundry.utils.Collection.html)) => any
...
* reduce(  
  ...
  Â Â Â Â Â Â Â Â arg1: [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html),  
  ...
  + reducer: (arg0: any, arg1: [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html), arg2: number, arg3: [Collection](foundry.utils.Collection.html)) => any
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html)[]
...
* some(  
  ...
  + condition: (arg0: [documents](../modules/foundry.documents.html).[Cards](foundry.documents.Cards.html), arg1: number, arg2: [Collection](foundry.utils.Collection.html)) => boolean
