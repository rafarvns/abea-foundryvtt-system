---
title: "ItemDirectory | Foundry Virtual Tabletop - API Documentation - Version 13"
...
* [ItemDirectory](foundry.applications.sidebar.tabs.ItemDirectory.html)

# Class ItemDirectory

The World Item directory listing.

#### Hierarchy ([View Summary](../hierarchy.html#foundry.applications.sidebar.tabs.ItemDirectory))
...
[options](foundry.applications.sidebar.tabs.ItemDirectory.html#options)
[position](foundry.applications.sidebar.tabs.ItemDirectory.html#position)
[tabGroups](foundry.applications.sidebar.tabs.ItemDirectory.html#tabgroups)
[\_appId](foundry.applications.sidebar.tabs.ItemDirectory.html#_appid)
[\_maxZ](foundry.applications.sidebar.tabs.ItemDirectory.html#_maxz)
[BASE\_APPLICATION](foundry.applications.sidebar.tabs.ItemDirectory.html#base_application)
[DEFAULT\_OPTIONS](foundry.applications.sidebar.tabs.ItemDirectory.html#default_options)
[emittedEvents](foundry.applications.sidebar.tabs.ItemDirectory.html#emittedevents)
[PARTS](foundry.applications.sidebar.tabs.ItemDirectory.html#parts)
[RENDER\_STATES](foundry.applications.sidebar.tabs.ItemDirectory.html#render_states)
[tabName](foundry.applications.sidebar.tabs.ItemDirectory.html#tabname)
[TABS](foundry.applications.sidebar.tabs.ItemDirectory.html#tabs)
[\_entryPartial](foundry.applications.sidebar.tabs.ItemDirectory.html#_entrypartial)
[\_folderPartial](foundry.applications.sidebar.tabs.ItemDirectory.html#_folderpartial)

### Accessors

[active](foundry.applications.sidebar.tabs.ItemDirectory.html#active)
[classList](foundry.applications.sidebar.tabs.ItemDirectory.html#classlist)
[collection](foundry.applications.sidebar.tabs.ItemDirectory.html#collection)
[documentClass](foundry.applications.sidebar.tabs.ItemDirectory.html#documentclass)
[documentName](foundry.applications.sidebar.tabs.ItemDirectory.html#documentname)
[element](foundry.applications.sidebar.tabs.ItemDirectory.html#element)
[form](foundry.applications.sidebar.tabs.ItemDirectory.html#form)
[hasFrame](foundry.applications.sidebar.tabs.ItemDirectory.html#hasframe)
[id](foundry.applications.sidebar.tabs.ItemDirectory.html#id)
[isPopout](foundry.applications.sidebar.tabs.ItemDirectory.html#ispopout)
[minimized](foundry.applications.sidebar.tabs.ItemDirectory.html#minimized)
[popout](foundry.applications.sidebar.tabs.ItemDirectory.html#popout)
[rendered](foundry.applications.sidebar.tabs.ItemDirectory.html#rendered)
[state](foundry.applications.sidebar.tabs.ItemDirectory.html#state)
[tabName](foundry.applications.sidebar.tabs.ItemDirectory.html#tabname-1)
[title](foundry.applications.sidebar.tabs.ItemDirectory.html#title)
[window](foundry.applications.sidebar.tabs.ItemDirectory.html#window)

### Methods

[\_awaitTransition](foundry.applications.sidebar.tabs.ItemDirectory.html#_awaittransition)
[\_canRender](foundry.applications.sidebar.tabs.ItemDirectory.html#_canrender)
[\_configureRenderParts](foundry.applications.sidebar.tabs.ItemDirectory.html#_configurerenderparts)
[\_doEvent](foundry.applications.sidebar.tabs.ItemDirectory.html#_doevent)
[\_getEntryContextOptions](foundry.applications.sidebar.tabs.ItemDirectory.html#_getentrycontextoptions)
[\_initializeApplicationOptions](foundry.applications.sidebar.tabs.ItemDirectory.html#_initializeapplicationoptions)
[\_onClose](foundry.applications.sidebar.tabs.ItemDirectory.html#_onclose)
[\_onDragStart](foundry.applications.sidebar.tabs.ItemDirectory.html#_ondragstart)
[\_onDrop](foundry.applications.sidebar.tabs.ItemDirectory.html#_ondrop)
[\_onFirstRender](foundry.applications.sidebar.tabs.ItemDirectory.html#_onfirstrender)
[\_onRender](foundry.applications.sidebar.tabs.ItemDirectory.html#_onrender)
[\_prepareContext](foundry.applications.sidebar.tabs.ItemDirectory.html#_preparecontext)
[\_preparePartContext](foundry.applications.sidebar.tabs.ItemDirectory.html#_preparepartcontext)
[\_preSyncPartState](foundry.applications.sidebar.tabs.ItemDirectory.html#_presyncpartstate)
[\_renderFrame](foundry.applications.sidebar.tabs.ItemDirectory.html#_renderframe)
[\_renderHTML](foundry.applications.sidebar.tabs.ItemDirectory.html#_renderhtml)
[\_syncPartState](foundry.applications.sidebar.tabs.ItemDirectory.html#_syncpartstate)
[activate](foundry.applications.sidebar.tabs.ItemDirectory.html#activate)
[addEventListener](foundry.applications.sidebar.tabs.ItemDirectory.html#addeventlistener)
[bringToFront](foundry.applications.sidebar.tabs.ItemDirectory.html#bringtofront)
[changeTab](foundry.applications.sidebar.tabs.ItemDirectory.html#changetab)
[close](foundry.applications.sidebar.tabs.ItemDirectory.html#close)
[collapseAll](foundry.applications.sidebar.tabs.ItemDirectory.html#collapseall)
[dispatchEvent](foundry.applications.sidebar.tabs.ItemDirectory.html#dispatchevent)
[maximize](foundry.applications.sidebar.tabs.ItemDirectory.html#maximize)
[minimize](foundry.applications.sidebar.tabs.ItemDirectory.html#minimize)
[removeEventListener](foundry.applications.sidebar.tabs.ItemDirectory.html#removeeventlistener)
[render](foundry.applications.sidebar.tabs.ItemDirectory.html#render)
[renderPopout](foundry.applications.sidebar.tabs.ItemDirectory.html#renderpopout)
[setPosition](foundry.applications.sidebar.tabs.ItemDirectory.html#setposition)
[submit](foundry.applications.sidebar.tabs.ItemDirectory.html#submit)
[toggleControls](foundry.applications.sidebar.tabs.ItemDirectory.html#togglecontrols)
[\_attachFrameListeners](foundry.applications.sidebar.tabs.ItemDirectory.html#_attachframelisteners)
[\_canCreateEntry](foundry.applications.sidebar.tabs.ItemDirectory.html#_cancreateentry)
[\_canCreateFolder](foundry.applications.sidebar.tabs.ItemDirectory.html#_cancreatefolder)
[\_canDragDrop](foundry.applications.sidebar.tabs.ItemDirectory.html#_candragdrop)
[\_canDragStart](foundry.applications.sidebar.tabs.ItemDirectory.html#_candragstart)
[\_configureRenderOptions](foundry.applications.sidebar.tabs.ItemDirectory.html#_configurerenderoptions)
[\_createContextMenu](foundry.applications.sidebar.tabs.ItemDirectory.html#_createcontextmenu)
[\_createContextMenus](foundry.applications.sidebar.tabs.ItemDirectory.html#_createcontextmenus)
[\_createDroppedEntry](foundry.applications.sidebar.tabs.ItemDirectory.html#_createdroppedentry)
[\_createDroppedFolderContent](foundry.applications.sidebar.tabs.ItemDirectory.html#_createdroppedfoldercontent)
[\_createDroppedFolderDocuments](foundry.applications.sidebar.tabs.ItemDirectory.html#_createdroppedfolderdocuments)
[\_entryAlreadyExists](foundry.applications.sidebar.tabs.ItemDirectory.html#_entryalreadyexists)
[\_entryBelongsToFolder](foundry.applications.sidebar.tabs.ItemDirectory.html#_entrybelongstofolder)
[\_getDroppedEntryFromData](foundry.applications.sidebar.tabs.ItemDirectory.html#_getdroppedentryfromdata)
[\_getEntryDragData](foundry.applications.sidebar.tabs.ItemDirectory.html#_getentrydragdata)
[\_getFolderContextOptions](foundry.applications.sidebar.tabs.ItemDirectory.html#_getfoldercontextoptions)
[\_getFolderDragData](foundry.applications.sidebar.tabs.ItemDirectory.html#_getfolderdragdata)
[\_getHeaderControls](foundry.applications.sidebar.tabs.ItemDirectory.html#_getheadercontrols)
[\_getTabsConfig](foundry.applications.sidebar.tabs.ItemDirectory.html#_gettabsconfig)
[\_handleDroppedEntry](foundry.applications.sidebar.tabs.ItemDirectory.html#_handledroppedentry)
[\_handleDroppedFolder](foundry.applications.sidebar.tabs.ItemDirectory.html#_handledroppedfolder)
[\_handleDroppedForeignFolder](foundry.applications.sidebar.tabs.ItemDirectory.html#_handledroppedforeignfolder)
[\_headerControlButtons](foundry.applications.sidebar.tabs.ItemDirectory.html#_headercontrolbuttons)
[\_insertElement](foundry.applications.sidebar.tabs.ItemDirectory.html#_insertelement)
[\_matchSearchEntries](foundry.applications.sidebar.tabs.ItemDirectory.html#_matchsearchentries)
[\_matchSearchFolders](foundry.applications.sidebar.tabs.ItemDirectory.html#_matchsearchfolders)
[\_onActivate](foundry.applications.sidebar.tabs.ItemDirectory.html#_onactivate)
[\_onChangeForm](foundry.applications.sidebar.tabs.ItemDirectory.html#_onchangeform)
[\_onClickAction](foundry.applications.sidebar.tabs.ItemDirectory.html#_onclickaction)
[\_onClickEntry](foundry.applications.sidebar.tabs.ItemDirectory.html#_onclickentry)
[\_onClickTab](foundry.applications.sidebar.tabs.ItemDirectory.html#_onclicktab)
[\_onCreateEntry](foundry.applications.sidebar.tabs.ItemDirectory.html#_oncreateentry)
[\_onCreateFolder](foundry.applications.sidebar.tabs.ItemDirectory.html#_oncreatefolder)
[\_onDeactivate](foundry.applications.sidebar.tabs.ItemDirectory.html#_ondeactivate)
[\_onDragHighlight](foundry.applications.sidebar.tabs.ItemDirectory.html#_ondraghighlight)
[\_onDragOver](foundry.applications.sidebar.tabs.ItemDirectory.html#_ondragover)
[\_onMatchSearchEntry](foundry.applications.sidebar.tabs.ItemDirectory.html#_onmatchsearchentry)
[\_onPosition](foundry.applications.sidebar.tabs.ItemDirectory.html#_onposition)
[\_onSearchFilter](foundry.applications.sidebar.tabs.ItemDirectory.html#_onsearchfilter)
[\_onSubmitForm](foundry.applications.sidebar.tabs.ItemDirectory.html#_onsubmitform)
[\_onToggleFolder](foundry.applications.sidebar.tabs.ItemDirectory.html#_ontogglefolder)
[\_organizeDroppedFoldersAndDocuments](foundry.applications.sidebar.tabs.ItemDirectory.html#_organizedroppedfoldersanddocuments)
[\_postRender](foundry.applications.sidebar.tabs.ItemDirectory.html#_postrender)
[\_preClose](foundry.applications.sidebar.tabs.ItemDirectory.html#_preclose)
[\_preFirstRender](foundry.applications.sidebar.tabs.ItemDirectory.html#_prefirstrender)
[\_prepareDirectoryContext](foundry.applications.sidebar.tabs.ItemDirectory.html#_preparedirectorycontext)
[\_prepareDuplicateData](foundry.applications.sidebar.tabs.ItemDirectory.html#_prepareduplicatedata)
[\_prepareFooterContext](foundry.applications.sidebar.tabs.ItemDirectory.html#_preparefootercontext)
[\_prepareHeaderContext](foundry.applications.sidebar.tabs.ItemDirectory.html#_prepareheadercontext)
[\_prepareTabs](foundry.applications.sidebar.tabs.ItemDirectory.html#_preparetabs)
[\_prePosition](foundry.applications.sidebar.tabs.ItemDirectory.html#_preposition)
[\_preRender](foundry.applications.sidebar.tabs.ItemDirectory.html#_prerender)
[\_removeElement](foundry.applications.sidebar.tabs.ItemDirectory.html#_removeelement)
[\_renderHeaderControl](foundry.applications.sidebar.tabs.ItemDirectory.html#_renderheadercontrol)
[\_replaceHTML](foundry.applications.sidebar.tabs.ItemDirectory.html#_replacehtml)
[\_tearDown](foundry.applications.sidebar.tabs.ItemDirectory.html#_teardown)
[\_updateFrame](foundry.applications.sidebar.tabs.ItemDirectory.html#_updateframe)
[\_updatePosition](foundry.applications.sidebar.tabs.ItemDirectory.html#_updateposition)
[\_getFolderContextOptions](foundry.applications.sidebar.tabs.ItemDirectory.html#_getfoldercontextoptions-2)
[\_handleDroppedFolder](foundry.applications.sidebar.tabs.ItemDirectory.html#_handledroppedfolder-2)
[inheritanceChain](foundry.applications.sidebar.tabs.ItemDirectory.html#inheritancechain)
[parseCSSDimension](foundry.applications.sidebar.tabs.ItemDirectory.html#parsecssdimension)
[waitForImages](foundry.applications.sidebar.tabs.ItemDirectory.html#waitforimages)
...
* \_getEntryContextOptions(): {  
  Â Â Â Â callback: (li: any) => void;  
  Â Â Â Â condition: (li: any) => boolean;  
  Â Â Â Â icon: string;  
  Â Â Â Â name: string;  
  }[]

  #### Returns { Â Â Â Â callback: (li: any) => void; Â Â Â Â condition: (li: any) => boolean; Â Â Â Â icon: string; Â Â Â Â name: string; }[]
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.html)>): Promise<[ItemDirectory](foundry.applications.sidebar.tabs.ItemDirectory.html)>
  ...
  #### Returns Promise<[ItemDirectory](foundry.applications.sidebar.tabs.ItemDirectory.html)>
...
* render(options: any, \_options: any): Promise<[ItemDirectory](foundry.applications.sidebar.tabs.ItemDirectory.html)>
...
* \_createDroppedEntry(  
  ...
  ): Promise<[documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)>
...
* \_createDroppedFolderDocuments(  
  Â Â Â Â folder: [documents](../modules/foundry.documents.html).[Folder](foundry.documents.Folder.html),  
  Â Â Â Â documents: object[] | [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)[],  
  ): Promise<void>
  ...
  + folder: [documents](../modules/foundry.documents.html).[Folder](foundry.documents.Folder.html)
    ...
    The dropped folder.
  + documents: object[] | [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)[]
...
* \_organizeDroppedFoldersAndDocuments(  
  ...
  Â Â Â Â Â Â Â Â | [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)[];  
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â documentsToCreate: object[] Â Â Â Â Â Â Â Â | [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)[]; Â Â Â Â Â Â Â Â foldersToCreate: [documents](../modules/foundry.documents.html).[Folder](foundry.documents.Folder.html)[]; Â Â Â Â }, >
