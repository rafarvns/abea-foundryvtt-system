---
title: "TilesLayer | Foundry Virtual Tabletop - API Documentation - Version 13"
...
#### Hierarchy ([View Summary](../hierarchy.html#foundry.canvas.layers.TilesLayer))
...
[\_configPreview](foundry.canvas.layers.TilesLayer.html#_configpreview)
[clipboard](foundry.canvas.layers.TilesLayer.html#clipboard)
[eventMode](foundry.canvas.layers.TilesLayer.html#eventmode)
[highlightObjects](foundry.canvas.layers.TilesLayer.html#highlightobjects)
[history](foundry.canvas.layers.TilesLayer.html#history)
[interactiveChildren](foundry.canvas.layers.TilesLayer.html#interactivechildren)
[objects](foundry.canvas.layers.TilesLayer.html#objects)
[options](foundry.canvas.layers.TilesLayer.html#options)
[preview](foundry.canvas.layers.TilesLayer.html#preview)
[quadtree](foundry.canvas.layers.TilesLayer.html#quadtree)
[CREATION\_STATES](foundry.canvas.layers.TilesLayer.html#creation_states)
[documentName](foundry.canvas.layers.TilesLayer.html#documentname)
[SORT\_ORDER](foundry.canvas.layers.TilesLayer.html#sort_order)

### Accessors

[active](foundry.canvas.layers.TilesLayer.html#active)
[controlled](foundry.canvas.layers.TilesLayer.html#controlled)
[controlledObjects](foundry.canvas.layers.TilesLayer.html#controlledobjects)
[documentCollection](foundry.canvas.layers.TilesLayer.html#documentcollection)
[hasPreview](foundry.canvas.layers.TilesLayer.html#haspreview)
[hookName](foundry.canvas.layers.TilesLayer.html#hookname)
[hover](foundry.canvas.layers.TilesLayer.html#hover)
[hud](foundry.canvas.layers.TilesLayer.html#hud)
[name](foundry.canvas.layers.TilesLayer.html#name)
[placeables](foundry.canvas.layers.TilesLayer.html#placeables)
[tiles](foundry.canvas.layers.TilesLayer.html#tiles)
[instance](foundry.canvas.layers.TilesLayer.html#instance)
[layerOptions](foundry.canvas.layers.TilesLayer.html#layeroptions)
[placeableClass](foundry.canvas.layers.TilesLayer.html#placeableclass)

### Methods

[\_activate](foundry.canvas.layers.TilesLayer.html#_activate)
[\_canDragLeftStart](foundry.canvas.layers.TilesLayer.html#_candragleftstart)
[\_createPreview](foundry.canvas.layers.TilesLayer.html#_createpreview)
[\_deactivate](foundry.canvas.layers.TilesLayer.html#_deactivate)
[\_draw](foundry.canvas.layers.TilesLayer.html#_draw)
[\_getCopyableObjects](foundry.canvas.layers.TilesLayer.html#_getcopyableobjects)
[\_getDropData](foundry.canvas.layers.TilesLayer.html#_getdropdata)
[\_getMovableObjects](foundry.canvas.layers.TilesLayer.html#_getmovableobjects)
[\_highlightObjects](foundry.canvas.layers.TilesLayer.html#_highlightobjects)
[\_onClickLeft](foundry.canvas.layers.TilesLayer.html#_onclickleft)
[\_onClickRight](foundry.canvas.layers.TilesLayer.html#_onclickright)
[\_onCopyKey](foundry.canvas.layers.TilesLayer.html#_oncopykey)
[\_onCutKey](foundry.canvas.layers.TilesLayer.html#_oncutkey)
[\_onDeleteKey](foundry.canvas.layers.TilesLayer.html#_ondeletekey)
[\_onDismissKey](foundry.canvas.layers.TilesLayer.html#_ondismisskey)
[\_onDragLeftCancel](foundry.canvas.layers.TilesLayer.html#_ondragleftcancel)
[\_onDragLeftDrop](foundry.canvas.layers.TilesLayer.html#_ondragleftdrop)
[\_onDragLeftMove](foundry.canvas.layers.TilesLayer.html#_ondragleftmove)
[\_onDragLeftStart](foundry.canvas.layers.TilesLayer.html#_ondragleftstart)
[\_onMouseWheel](foundry.canvas.layers.TilesLayer.html#_onmousewheel)
[\_onPasteKey](foundry.canvas.layers.TilesLayer.html#_onpastekey)
[\_onSelectAllKey](foundry.canvas.layers.TilesLayer.html#_onselectallkey)
[\_onUndoKey](foundry.canvas.layers.TilesLayer.html#_onundokey)
[\_prepareKeyboardMovementUpdates](foundry.canvas.layers.TilesLayer.html#_preparekeyboardmovementupdates)
[\_prepareKeyboardRotationUpdates](foundry.canvas.layers.TilesLayer.html#_preparekeyboardrotationupdates)
[\_sendToBackOrBringToFront](foundry.canvas.layers.TilesLayer.html#_sendtobackorbringtofront)
[\_tearDown](foundry.canvas.layers.TilesLayer.html#_teardown)
[activate](foundry.canvas.layers.TilesLayer.html#activate)
[clearPreviewContainer](foundry.canvas.layers.TilesLayer.html#clearpreviewcontainer)
[controlAll](foundry.canvas.layers.TilesLayer.html#controlall)
[controllableObjects](foundry.canvas.layers.TilesLayer.html#controllableobjects)
[copyObjects](foundry.canvas.layers.TilesLayer.html#copyobjects)
[createObject](foundry.canvas.layers.TilesLayer.html#createobject)
[deactivate](foundry.canvas.layers.TilesLayer.html#deactivate)
[deleteAll](foundry.canvas.layers.TilesLayer.html#deleteall)
[draw](foundry.canvas.layers.TilesLayer.html#draw)
[get](foundry.canvas.layers.TilesLayer.html#get)
[getDocuments](foundry.canvas.layers.TilesLayer.html#getdocuments)
[getMaxSort](foundry.canvas.layers.TilesLayer.html#getmaxsort)
[getSnappedPoint](foundry.canvas.layers.TilesLayer.html#getsnappedpoint)
[getZIndex](foundry.canvas.layers.TilesLayer.html#getzindex)
[moveMany](foundry.canvas.layers.TilesLayer.html#movemany)
[pasteObjects](foundry.canvas.layers.TilesLayer.html#pasteobjects)
[releaseAll](foundry.canvas.layers.TilesLayer.html#releaseall)
[rotateMany](foundry.canvas.layers.TilesLayer.html#rotatemany)
[selectObjects](foundry.canvas.layers.TilesLayer.html#selectobjects)
[setAllRenderFlags](foundry.canvas.layers.TilesLayer.html#setallrenderflags)
[storeHistory](foundry.canvas.layers.TilesLayer.html#storehistory)
[tearDown](foundry.canvas.layers.TilesLayer.html#teardown)
[undoHistory](foundry.canvas.layers.TilesLayer.html#undohistory)
[updateAll](foundry.canvas.layers.TilesLayer.html#updateall)
[\_canvasCoordinatesFromDrop](foundry.canvas.layers.TilesLayer.html#_canvascoordinatesfromdrop)
[\_confirmDeleteKey](foundry.canvas.layers.TilesLayer.html#_confirmdeletekey)
[\_onClickLeft2](foundry.canvas.layers.TilesLayer.html#_onclickleft2)
[\_onClickRight2](foundry.canvas.layers.TilesLayer.html#_onclickright2)
[\_onCycleViewKey](foundry.canvas.layers.TilesLayer.html#_oncycleviewkey)
[\_onDropData](foundry.canvas.layers.TilesLayer.html#_ondropdata)
[\_onUndoCreate](foundry.canvas.layers.TilesLayer.html#_onundocreate)
[\_onUndoDelete](foundry.canvas.layers.TilesLayer.html#_onundodelete)
[\_onUndoUpdate](foundry.canvas.layers.TilesLayer.html#_onundoupdate)
[\_storeHistory](foundry.canvas.layers.TilesLayer.html#_storehistory)
[prepareSceneControls](foundry.canvas.layers.TilesLayer.html#preparescenecontrols)
...
* get hud(): [TileHUD](foundry.applications.hud.TileHUD.html)

  If objects on this PlaceablesLayer have a HUD UI, provide a reference to its instance

  #### Returns [TileHUD](foundry.applications.hud.TileHUD.html)
...
* get tiles(): [canvas](../modules/foundry.canvas.html).[placeables](../modules/foundry.canvas.placeables.html).[Tile](foundry.canvas.placeables.Tile.html)[]
...
* \_draw(options: any): Promise<void>
  ...
  Inherited from [PlaceablesLayer](foundry.canvas.layers.PlaceablesLayer.html).[\_draw](foundry.canvas.layers.PlaceablesLayer.html#_draw)
...
* controllableObjects(): Generator<[PlaceableObject](foundry.canvas.placeables.PlaceableObject.html), void, unknown>

  #### Returns Generator<[PlaceableObject](foundry.canvas.placeables.PlaceableObject.html), void, unknown>

  Overrides [PlaceablesLayer](foundry.canvas.layers.PlaceablesLayer.html).[controllableObjects](foundry.canvas.layers.PlaceablesLayer.html#controllableobjects)
...
* \_onDropData(  
  ...
  #### Returns Promise< Â Â Â Â | undefined Â Â Â Â | false Â Â Â Â | [Document](foundry.abstract.Document.html)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.html)> Â Â Â Â | [Document](foundry.abstract.Document.html)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.html)>[], >
...
* prepareSceneControls(): {  
  ...
  Â Â Â Â tools: {  
  Â Â Â Â Â Â Â Â browse: {  
  Â Â Â Â Â Â Â Â Â Â Â Â button: boolean;  
  Â Â Â Â Â Â Â Â Â Â Â Â icon: string;  
  Â Â Â Â Â Â Â Â Â Â Â Â name: string;  
  Â Â Â Â Â Â Â Â Â Â Â Â onChange: () => Promise<[FilePicker](foundry.applications.apps.FilePicker.html)>;  
  ...
  Â Â Â Â Â Â Â Â };  
  Â Â Â Â Â Â Â Â foreground: {  
  Â Â Â Â Â Â Â Â Â Â Â Â active: boolean;  
  Â Â Â Â Â Â Â Â Â Â Â Â icon: string;  
  Â Â Â Â Â Â Â Â Â Â Â Â name: string;  
  Â Â Â Â Â Â Â Â Â Â Â Â onChange: (event: any, active: any) => void;  
  Â Â Â Â Â Â Â Â Â Â Â Â order: number;  
  Â Â Â Â Â Â Â Â Â Â Â Â title: string;  
  ...
  #### Returns { Â Â Â Â activeTool: string; Â Â Â Â icon: string; Â Â Â Â layer: string; Â Â Â Â name: string; Â Â Â Â onChange: (event: any, active: any) => void; Â Â Â Â onToolChange: () => any; Â Â Â Â order: number; Â Â Â Â title: string; Â Â Â Â tools: { Â Â Â Â Â Â Â Â browse: { Â Â Â Â Â Â Â Â Â Â Â Â button: boolean; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â onChange: () => Promise<[FilePicker](foundry.applications.apps.FilePicker.html)>; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â foreground: { Â Â Â Â Â Â Â Â Â Â Â Â active: boolean; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â onChange: (event: any, active: any) => void; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toggle: boolean; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â select: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â snap: { Â Â Â Â Â Â Â Â Â Â Â Â active: boolean; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â onChange: (event: any, toggled: any) => any; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toggle: boolean; Â Â Â Â Â Â Â Â Â Â Â Â visible: boolean; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â tile: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â }; Â Â Â Â visible: boolean; }
