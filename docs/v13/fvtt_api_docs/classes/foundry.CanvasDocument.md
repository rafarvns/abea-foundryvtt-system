---
title: "CanvasDocument | Foundry Virtual Tabletop - API Documentation - Version 13"
url: "https://foundryvtt.com/api/classes/foundry.CanvasDocument.html"
category: "classes"
---
...
A ClientDocument class with additional facilities for utilizing the [foundry.canvas.Canvas](foundry.canvas.Canvas.html) API

#### Hierarchy ([View Summary](../hierarchy.html#foundry.CanvasDocument))

* [ClientDocument](foundry.ClientDocument.html)<this>
  + CanvasDocument
...
[\_destroyed](foundry.CanvasDocument.html#_destroyed)
[\_object](foundry.CanvasDocument.html#_object)
[\_source](foundry.CanvasDocument.html#_source)
[parent](foundry.CanvasDocument.html#parent)
[\_schema](foundry.CanvasDocument.html#_schema)
[LOCALIZATION\_PREFIXES](foundry.CanvasDocument.html#localization_prefixes)
[metadata](foundry.CanvasDocument.html#metadata)
[name](foundry.CanvasDocument.html#name)

### Accessors

[collection](foundry.CanvasDocument.html#collection)
[compendium](foundry.CanvasDocument.html#compendium)
[hasPlayerOwner](foundry.CanvasDocument.html#hasplayerowner)
[id](foundry.CanvasDocument.html#id)
[inCompendium](foundry.CanvasDocument.html#incompendium)
[invalid](foundry.CanvasDocument.html#invalid)
[isEmbedded](foundry.CanvasDocument.html#isembedded)
[isOwner](foundry.CanvasDocument.html#isowner)
[layer](foundry.CanvasDocument.html#layer)
[limited](foundry.CanvasDocument.html#limited)
[link](foundry.CanvasDocument.html#link)
[object](foundry.CanvasDocument.html#object)
[permission](foundry.CanvasDocument.html#permission)
[rendered](foundry.CanvasDocument.html#rendered)
[schema](foundry.CanvasDocument.html#schema)
[sheet](foundry.CanvasDocument.html#sheet)
[uuid](foundry.CanvasDocument.html#uuid)
[validationFailures](foundry.CanvasDocument.html#validationfailures)
[visible](foundry.CanvasDocument.html#visible)
[baseDocument](foundry.CanvasDocument.html#basedocument)
[collectionName](foundry.CanvasDocument.html#collectionname)
[database](foundry.CanvasDocument.html#database)
[documentName](foundry.CanvasDocument.html#documentname)
[hasTypeData](foundry.CanvasDocument.html#hastypedata)
[hierarchy](foundry.CanvasDocument.html#hierarchy)
[implementation](foundry.CanvasDocument.html#implementation)
[schema](foundry.CanvasDocument.html#schema-2)
[TYPES](foundry.CanvasDocument.html#types)

### Methods

[\_configure](foundry.CanvasDocument.html#_configure)
[\_createDocumentLink](foundry.CanvasDocument.html#_createdocumentlink)
[\_dispatchDescendantDocumentEvents](foundry.CanvasDocument.html#_dispatchdescendantdocumentevents)
[\_getParentCollection](foundry.CanvasDocument.html#_getparentcollection)
[\_getSheetClass](foundry.CanvasDocument.html#_getsheetclass)
[\_initialize](foundry.CanvasDocument.html#_initialize)
[\_onCreate](foundry.CanvasDocument.html#_oncreate)
[\_onDelete](foundry.CanvasDocument.html#_ondelete)
[\_onSheetChange](foundry.CanvasDocument.html#_onsheetchange)
[\_onUpdate](foundry.CanvasDocument.html#_onupdate)
[\_preCreate](foundry.CanvasDocument.html#_precreate)
[\_preDelete](foundry.CanvasDocument.html#_predelete)
[\_preUpdate](foundry.CanvasDocument.html#_preupdate)
[\_safePrepareData](foundry.CanvasDocument.html#_safepreparedata)
[canUserModify](foundry.CanvasDocument.html#canusermodify)
[clone](foundry.CanvasDocument.html#clone)
[createEmbeddedDocuments](foundry.CanvasDocument.html#createembeddeddocuments)
[delete](foundry.CanvasDocument.html#delete)
[deleteDialog](foundry.CanvasDocument.html#deletedialog)
[deleteEmbeddedDocuments](foundry.CanvasDocument.html#deleteembeddeddocuments)
[exportToJSON](foundry.CanvasDocument.html#exporttojson)
[getEmbeddedCollection](foundry.CanvasDocument.html#getembeddedcollection)
[getEmbeddedDocument](foundry.CanvasDocument.html#getembeddeddocument)
[getFlag](foundry.CanvasDocument.html#getflag)
[getRelativeUUID](foundry.CanvasDocument.html#getrelativeuuid)
[getUserLevel](foundry.CanvasDocument.html#getuserlevel)
[importFromJSON](foundry.CanvasDocument.html#importfromjson)
[importFromJSONDialog](foundry.CanvasDocument.html#importfromjsondialog)
[migrateSystemData](foundry.CanvasDocument.html#migratesystemdata)
[onEmbed](foundry.CanvasDocument.html#onembed)
[prepareBaseData](foundry.CanvasDocument.html#preparebasedata)
[prepareData](foundry.CanvasDocument.html#preparedata)
[prepareDerivedData](foundry.CanvasDocument.html#preparederiveddata)
[prepareEmbeddedDocuments](foundry.CanvasDocument.html#prepareembeddeddocuments)
[render](foundry.CanvasDocument.html#render)
[reset](foundry.CanvasDocument.html#reset)
[setFlag](foundry.CanvasDocument.html#setflag)
[sortRelative](foundry.CanvasDocument.html#sortrelative)
[testUserPermission](foundry.CanvasDocument.html#testuserpermission)
[toAnchor](foundry.CanvasDocument.html#toanchor)
[toCompendium](foundry.CanvasDocument.html#tocompendium)
[toDragData](foundry.CanvasDocument.html#todragdata)
[toEmbed](foundry.CanvasDocument.html#toembed)
[toJSON](foundry.CanvasDocument.html#tojson)
[toObject](foundry.CanvasDocument.html#toobject)
[traverseEmbeddedDocuments](foundry.CanvasDocument.html#traverseembeddeddocuments)
[unsetFlag](foundry.CanvasDocument.html#unsetflag)
[update](foundry.CanvasDocument.html#update)
[updateEmbeddedDocuments](foundry.CanvasDocument.html#updateembeddeddocuments)
[updateSource](foundry.CanvasDocument.html#updatesource)
[validate](foundry.CanvasDocument.html#validate)
[\_buildEmbedHTML](foundry.CanvasDocument.html#_buildembedhtml)
[\_createFigureEmbed](foundry.CanvasDocument.html#_createfigureembed)
[\_createInlineEmbed](foundry.CanvasDocument.html#_createinlineembed)
[\_initializeSource](foundry.CanvasDocument.html#_initializesource)
[\_onClickDocumentLink](foundry.CanvasDocument.html#_onclickdocumentlink)
[\_onCreateDescendantDocuments](foundry.CanvasDocument.html#_oncreatedescendantdocuments)
[\_onDeleteDescendantDocuments](foundry.CanvasDocument.html#_ondeletedescendantdocuments)
[\_onUpdateDescendantDocuments](foundry.CanvasDocument.html#_onupdatedescendantdocuments)
[\_preCreateDescendantDocuments](foundry.CanvasDocument.html#_precreatedescendantdocuments)
[\_preDeleteDescendantDocuments](foundry.CanvasDocument.html#_predeletedescendantdocuments)
[\_preUpdateDescendantDocuments](foundry.CanvasDocument.html#_preupdatedescendantdocuments)
[\_addDataFieldMigration](foundry.CanvasDocument.html#_adddatafieldmigration)
[\_addDataFieldShim](foundry.CanvasDocument.html#_adddatafieldshim)
[\_addDataFieldShims](foundry.CanvasDocument.html#_adddatafieldshims)
[\_clearFieldsRecursively](foundry.CanvasDocument.html#_clearfieldsrecursively)
[\_initializationOrder](foundry.CanvasDocument.html#_initializationorder)
[\_logDataFieldMigration](foundry.CanvasDocument.html#_logdatafieldmigration)
[canUserCreate](foundry.CanvasDocument.html#canusercreate)
[cleanData](foundry.CanvasDocument.html#cleandata)
[create](foundry.CanvasDocument.html#create)
[createDialog](foundry.CanvasDocument.html#createdialog)
[createDocuments](foundry.CanvasDocument.html#createdocuments)
[defaultName](foundry.CanvasDocument.html#defaultname)
[defineSchema](foundry.CanvasDocument.html#defineschema)
[deleteDocuments](foundry.CanvasDocument.html#deletedocuments)
[fromDropData](foundry.CanvasDocument.html#fromdropdata)
[fromImport](foundry.CanvasDocument.html#fromimport)
[fromJSON](foundry.CanvasDocument.html#fromjson)
[fromSource](foundry.CanvasDocument.html#fromsource)
[get](foundry.CanvasDocument.html#get)
[getCollectionName](foundry.CanvasDocument.html#getcollectionname)
[migrateData](foundry.CanvasDocument.html#migratedata)
[migrateDataSafe](foundry.CanvasDocument.html#migratedatasafe)
[shimData](foundry.CanvasDocument.html#shimdata)
[updateDocuments](foundry.CanvasDocument.html#updatedocuments)
[validateJoint](foundry.CanvasDocument.html#validatejoint)
[\_onCreateOperation](foundry.CanvasDocument.html#_oncreateoperation)
[\_onDeleteOperation](foundry.CanvasDocument.html#_ondeleteoperation)
[\_onUpdateOperation](foundry.CanvasDocument.html#_onupdateoperation)
[\_preCreateOperation](foundry.CanvasDocument.html#_precreateoperation)
[\_preDeleteOperation](foundry.CanvasDocument.html#_predeleteoperation)
[\_preUpdateOperation](foundry.CanvasDocument.html#_preupdateoperation)
...
\_object: null | [PlaceableObject](foundry.canvas.placeables.PlaceableObject.html)
...
Inherited from ClientDocumentMixin(Base).\_source
...
Inherited from ClientDocumentMixin(Base).parent
...
Inherited from ClientDocumentMixin(Base).\_schema

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from ClientDocumentMixin(Base).LOCALIZATION\_PREFIXES
...
Inherited from ClientDocumentMixin(Base).metadata
...
Inherited from ClientDocumentMixin(Base).name
...
* get collection(...this: any): null | [Collection](foundry.utils.Collection.html)<any, any>
  ...
  Inherited from ClientDocumentMixin(Base).collection
...
* get compendium(): undefined | null | [CompendiumCollection](foundry.documents.collections.CompendiumCollection.html)<any>
  ...
  Inherited from ClientDocumentMixin(Base).compendium
...
* get hasPlayerOwner(): boolean
  ...
  Inherited from ClientDocumentMixin(Base).hasPlayerOwner
...
* get id(): null | string
  ...
  Inherited from ClientDocumentMixin(Base).id
...
* get inCompendium(): boolean
  ...
  Inherited from ClientDocumentMixin(Base).inCompendium
...
* get invalid(): boolean
  ...
  Inherited from ClientDocumentMixin(Base).invalid
...
* get isEmbedded(): boolean
  ...
  Inherited from ClientDocumentMixin(Base).isEmbedded
...
* get isOwner(): boolean
  ...
  Inherited from ClientDocumentMixin(Base).isOwner
...
* get limited(): boolean
  ...
  Inherited from ClientDocumentMixin(Base).limited
...
* get link(): string
  ...
  Inherited from ClientDocumentMixin(Base).link

### object

* get object(): null | [PlaceableObject](foundry.canvas.placeables.PlaceableObject.html)
...
* get permission(): number
  ...
  Inherited from ClientDocumentMixin(Base).permission
...
* get schema(): [SchemaField](foundry.data.fields.SchemaField.html)
  ...
  Inherited from ClientDocumentMixin(Base).schema
...
* get sheet(): | null  
  ...
  Inherited from ClientDocumentMixin(Base).sheet
...
* get uuid(): string
  ...
  Inherited from ClientDocumentMixin(Base).uuid
...
* get validationFailures(): {  
  ...
  Inherited from ClientDocumentMixin(Base).validationFailures
...
* get visible(): boolean
  ...
  Inherited from ClientDocumentMixin(Base).visible
...
* get baseDocument(): typeof [Document](foundry.abstract.Document.html)
  ...
  Inherited from ClientDocumentMixin(Base).baseDocument
...
* get collectionName(): string
  ...
  Inherited from ClientDocumentMixin(Base).collectionName
...
* get database(): [abstract](../modules/foundry.abstract.html).[DatabaseBackend](foundry.abstract.DatabaseBackend.html)
  ...
  Inherited from ClientDocumentMixin(Base).database
...
* get documentName(): string
  ...
  Inherited from ClientDocumentMixin(Base).documentName
...
* get hasTypeData(): boolean
  ...
  Inherited from ClientDocumentMixin(Base).hasTypeData
...
* get hierarchy(): Readonly<Record<string, any>>
  ...
  Inherited from ClientDocumentMixin(Base).hierarchy
...
* get implementation(): typeof [Document](foundry.abstract.Document.html)
  ...
  Inherited from ClientDocumentMixin(Base).implementation
...
* get TYPES(): string[]
  ...
  Inherited from ClientDocumentMixin(Base).TYPES
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from ClientDocumentMixin(Base).\_configure
...
* \_createDocumentLink(  
  ...
  Inherited from ClientDocumentMixin(Base).\_createDocumentLink
...
* \_dispatchDescendantDocumentEvents(  
  ...
  Inherited from ClientDocumentMixin(Base).\_dispatchDescendantDocumentEvents
...
* \_getParentCollection(parentCollection?: null | string): null | string
  ...
  Inherited from ClientDocumentMixin(Base).\_getParentCollection
...
* \_getSheetClass(): null | Function
  ...
  Inherited from ClientDocumentMixin(Base).\_getSheetClass
...
* \_initialize(...this: any, options?: {}): void
  ...
  Inherited from ClientDocumentMixin(Base).\_initialize
...
* \_onCreate(data: any, options: any, userId: any): void
  ...
  Overrides ClientDocumentMixin(Base).\_onCreate
...
* \_onDelete(options: any, userId: any): void
  ...
  Overrides ClientDocumentMixin(Base).\_onDelete
...
* \_onSheetChange(options?: { sheetOpen?: boolean }): Promise<void>
  ...
  Inherited from ClientDocumentMixin(Base).\_onSheetChange
...
* \_onUpdate(changed: any, options: any, userId: any): void
  ...
  Overrides ClientDocumentMixin(Base).\_onUpdate
...
* \_preCreate(data: any, options: any, user: any): Promise<undefined | false>
  ...
  Overrides ClientDocumentMixin(Base).\_preCreate
...
* \_preDelete(options: any, user: any): Promise<any>
  ...
  Inherited from ClientDocumentMixin(Base).\_preDelete
...
* \_preUpdate(changes: any, options: any, user: any): Promise<any>
  ...
  Inherited from ClientDocumentMixin(Base).\_preUpdate
...
* \_safePrepareData(): void
  ...
  Inherited from ClientDocumentMixin(Base).\_safePrepareData
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.html), action: string, data?: object): boolean
  ...
  Inherited from ClientDocumentMixin(Base).canUserModify
...
* clone(  
  ...
  Inherited from ClientDocumentMixin(Base).clone
...
* createEmbeddedDocuments(  
  ...
  Inherited from ClientDocumentMixin(Base).createEmbeddedDocuments
...
* delete(  
  ...
  Inherited from ClientDocumentMixin(Base).delete
...
* deleteDialog(  
  ...
  Inherited from ClientDocumentMixin(Base).deleteDialog
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from ClientDocumentMixin(Base).deleteEmbeddedDocuments
...
* exportToJSON(options?: object): void
  ...
  Inherited from ClientDocumentMixin(Base).exportToJSON
...
* getEmbeddedCollection(embeddedName: string): DocumentCollection
  ...
  Inherited from ClientDocumentMixin(Base).getEmbeddedCollection
...
* getEmbeddedDocument(  
  ...
  Inherited from ClientDocumentMixin(Base).getEmbeddedDocument
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from ClientDocumentMixin(Base).getFlag
...
* getRelativeUUID(relative: [ClientDocument](foundry.ClientDocument.html)): string
  ...
  Inherited from ClientDocumentMixin(Base).getRelativeUUID
...
* getUserLevel(user?: [BaseUser](foundry.documents.BaseUser.html)): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.html)
  ...
  Inherited from ClientDocumentMixin(Base).getUserLevel
...
* importFromJSON(...this: any, json: string): Promise<[ClientDocument](foundry.ClientDocument.html)>
  ...
  Inherited from ClientDocumentMixin(Base).importFromJSON
...
* importFromJSONDialog(): Promise<void>
  ...
  Inherited from ClientDocumentMixin(Base).importFromJSONDialog
...
* migrateSystemData(): object
  ...
  Inherited from ClientDocumentMixin(Base).migrateSystemData
...
* onEmbed(element: HTMLDocumentEmbedElement): void
  ...
  Inherited from ClientDocumentMixin(Base).onEmbed
...
* prepareBaseData(): void
  ...
  Inherited from ClientDocumentMixin(Base).prepareBaseData
...
* prepareData(): void
  ...
  Inherited from ClientDocumentMixin(Base).prepareData
...
* prepareDerivedData(): void
  ...
  Inherited from ClientDocumentMixin(Base).prepareDerivedData
...
* prepareEmbeddedDocuments(): void
  ...
  Inherited from ClientDocumentMixin(Base).prepareEmbeddedDocuments
...
* render(force?: boolean, context?: object): void
  ...
  Inherited from ClientDocumentMixin(Base).render
...
* reset(): void
  ...
  Inherited from ClientDocumentMixin(Base).reset
...
* setFlag(  
  ...
  Inherited from ClientDocumentMixin(Base).setFlag
...
* sortRelative(  
  ...
  Inherited from ClientDocumentMixin(Base).sortRelative
...
* testUserPermission(  
  ...
  Inherited from ClientDocumentMixin(Base).testUserPermission
...
* toAnchor(options?: any): HTMLAnchorElement
  ...
  Inherited from ClientDocumentMixin(Base).toAnchor
...
* toCompendium(  
  ...
  Inherited from ClientDocumentMixin(Base).toCompendium
...
* toDragData(): object
  ...
  Inherited from ClientDocumentMixin(Base).toDragData
...
* toEmbed(config: DocumentHTMLEmbedConfig, options?: any): Promise<any>
  ...
  Inherited from ClientDocumentMixin(Base).toEmbed
...
* toJSON(): object
  ...
  Inherited from ClientDocumentMixin(Base).toJSON
...
* toObject(source?: boolean): any
  ...
  Inherited from ClientDocumentMixin(Base).toObject
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from ClientDocumentMixin(Base).traverseEmbeddedDocuments
...
* unsetFlag(  
  ...
  Inherited from ClientDocumentMixin(Base).unsetFlag
...
* update(  
  ...
  Inherited from ClientDocumentMixin(Base).update
...
* updateEmbeddedDocuments(  
  ...
  Inherited from ClientDocumentMixin(Base).updateEmbeddedDocuments
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.html)): object
  ...
  Inherited from ClientDocumentMixin(Base).updateSource
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.html)): boolean
  ...
  Inherited from ClientDocumentMixin(Base).validate
...
* \_buildEmbedHTML(  
  ...
  Inherited from ClientDocumentMixin(Base).\_buildEmbedHTML
...
* \_createFigureEmbed(  
  ...
  Inherited from ClientDocumentMixin(Base).\_createFigureEmbed
...
* \_createInlineEmbed(  
  ...
  Inherited from ClientDocumentMixin(Base).\_createInlineEmbed
...
* \_initializeSource(  
  ...
  Inherited from ClientDocumentMixin(Base).\_initializeSource
...
* \_onClickDocumentLink(  
  ...
  Inherited from ClientDocumentMixin(Base).\_onClickDocumentLink
...
* \_onCreateDescendantDocuments(  
  ...
  Inherited from ClientDocumentMixin(Base).\_onCreateDescendantDocuments
...
* \_onDeleteDescendantDocuments(  
  ...
  Inherited from ClientDocumentMixin(Base).\_onDeleteDescendantDocuments
...
* \_onUpdateDescendantDocuments(  
  ...
  Inherited from ClientDocumentMixin(Base).\_onUpdateDescendantDocuments
...
* \_preCreateDescendantDocuments(  
  ...
  Inherited from ClientDocumentMixin(Base).\_preCreateDescendantDocuments
...
* \_preDeleteDescendantDocuments(  
  ...
  Inherited from ClientDocumentMixin(Base).\_preDeleteDescendantDocuments
...
* \_preUpdateDescendantDocuments(  
  ...
  Inherited from ClientDocumentMixin(Base).\_preUpdateDescendantDocuments
...
* \_addDataFieldMigration(  
  ...
  Inherited from ClientDocumentMixin(Base).\_addDataFieldMigration
...
* \_addDataFieldShim(  
  ...
  Inherited from ClientDocumentMixin(Base).\_addDataFieldShim
...
* \_addDataFieldShims(  
  ...
  Inherited from ClientDocumentMixin(Base).\_addDataFieldShims
...
* \_clearFieldsRecursively(  
  ...
  Inherited from ClientDocumentMixin(Base).\_clearFieldsRecursively
...
* \_initializationOrder(): Generator<any[], void, unknown>
  ...
  Inherited from ClientDocumentMixin(Base).\_initializationOrder
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from ClientDocumentMixin(Base).\_logDataFieldMigration
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.html)): boolean
  ...
  Inherited from ClientDocumentMixin(Base).canUserCreate
...
* cleanData(source?: object, options?: object): object
  ...
  Inherited from ClientDocumentMixin(Base).cleanData
...
* create(  
  ...
  Inherited from ClientDocumentMixin(Base).create
...
* createDialog(  
  ...
  Inherited from ClientDocumentMixin(Base).createDialog
...
* createDocuments(  
  ...
  Inherited from ClientDocumentMixin(Base).createDocuments
...
* defaultName(  
  ...
  Inherited from ClientDocumentMixin(Base).defaultName
...
* defineSchema(): [DataSchema](../types/foundry.abstract.types.DataSchema.html)
  ...
  [\_source](foundry.CanvasDocument.html#_source) values into direct properties of the data model. The schema is a static property of the model and
  ...
  Inherited from ClientDocumentMixin(Base).defineSchema
...
* deleteDocuments(  
  ...
  Inherited from ClientDocumentMixin(Base).deleteDocuments
...
* fromDropData(  
  ...
  Inherited from ClientDocumentMixin(Base).fromDropData
...
* fromImport(  
  ...
  Inherited from ClientDocumentMixin(Base).fromImport
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.html)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.html)>
  ...
  Inherited from ClientDocumentMixin(Base).fromJSON
...
* fromSource(  
  ...
  Inherited from ClientDocumentMixin(Base).fromSource
...
* get(  
  ...
  Inherited from ClientDocumentMixin(Base).get
...
* getCollectionName(name: string): null | string
  ...
  Inherited from ClientDocumentMixin(Base).getCollectionName
...
* migrateData(source: object): object
  ...
  Inherited from ClientDocumentMixin(Base).migrateData
...
* migrateDataSafe(source: object): object
  ...
  Inherited from ClientDocumentMixin(Base).migrateDataSafe
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from ClientDocumentMixin(Base).shimData
...
* updateDocuments(  
  ...
  Inherited from ClientDocumentMixin(Base).updateDocuments
...
* validateJoint(data: object): void
  ...
  Inherited from ClientDocumentMixin(Base).validateJoint
...
* \_onCreateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onCreate](foundry.CanvasDocument.html#_oncreate) workflows.
  ...
  Inherited from ClientDocumentMixin(Base).\_onCreateOperation
...
* \_onDeleteOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onDelete](foundry.CanvasDocument.html#_ondelete) workflows.
  ...
  Inherited from ClientDocumentMixin(Base).\_onDeleteOperation
...
* \_onUpdateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onUpdate](foundry.CanvasDocument.html#_onupdate) workflows.
  ...
  Inherited from ClientDocumentMixin(Base).\_onUpdateOperation
...
* \_preCreateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preCreate](foundry.CanvasDocument.html#_precreate) workflows and provides a final pre-flight check
  ...
  Inherited from ClientDocumentMixin(Base).\_preCreateOperation
...
* \_preDeleteOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preDelete](foundry.CanvasDocument.html#_predelete) workflows and provides a final pre-flight check
  before a database operation occurs.
  ...
  Inherited from ClientDocumentMixin(Base).\_preDeleteOperation
...
* \_preUpdateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preUpdate](foundry.CanvasDocument.html#_preupdate) workflows and provides a final pre-flight check
  before a database operation occurs.
  ...
  Inherited from ClientDocumentMixin(Base).\_preUpdateOperation