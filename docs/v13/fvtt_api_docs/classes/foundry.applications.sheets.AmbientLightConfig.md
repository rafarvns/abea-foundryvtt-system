---
title: "AmbientLightConfig | Foundry Virtual Tabletop - API Documentation - Version 13"
...
#### Hierarchy ([View Summary](../hierarchy.html#foundry.applications.sheets.AmbientLightConfig))
...
[constructor](foundry.applications.sheets.AmbientLightConfig.html#constructor)

### Properties

[options](foundry.applications.sheets.AmbientLightConfig.html#options)
[position](foundry.applications.sheets.AmbientLightConfig.html#position)
[preview](foundry.applications.sheets.AmbientLightConfig.html#preview)
[tabGroups](foundry.applications.sheets.AmbientLightConfig.html#tabgroups)
[\_appId](foundry.applications.sheets.AmbientLightConfig.html#_appid)
[\_maxZ](foundry.applications.sheets.AmbientLightConfig.html#_maxz)
[BASE\_APPLICATION](foundry.applications.sheets.AmbientLightConfig.html#base_application)
[DEFAULT\_OPTIONS](foundry.applications.sheets.AmbientLightConfig.html#default_options)
[emittedEvents](foundry.applications.sheets.AmbientLightConfig.html#emittedevents)
[PARTS](foundry.applications.sheets.AmbientLightConfig.html#parts)
[RENDER\_STATES](foundry.applications.sheets.AmbientLightConfig.html#render_states)
[TABS](foundry.applications.sheets.AmbientLightConfig.html#tabs)

### Accessors

[classList](foundry.applications.sheets.AmbientLightConfig.html#classlist)
[document](foundry.applications.sheets.AmbientLightConfig.html#document)
[element](foundry.applications.sheets.AmbientLightConfig.html#element)
[form](foundry.applications.sheets.AmbientLightConfig.html#form)
[hasFrame](foundry.applications.sheets.AmbientLightConfig.html#hasframe)
[id](foundry.applications.sheets.AmbientLightConfig.html#id)
[isEditable](foundry.applications.sheets.AmbientLightConfig.html#iseditable)
[isVisible](foundry.applications.sheets.AmbientLightConfig.html#isvisible)
[minimized](foundry.applications.sheets.AmbientLightConfig.html#minimized)
[rendered](foundry.applications.sheets.AmbientLightConfig.html#rendered)
[state](foundry.applications.sheets.AmbientLightConfig.html#state)
[title](foundry.applications.sheets.AmbientLightConfig.html#title)
[window](foundry.applications.sheets.AmbientLightConfig.html#window)

### Methods

[\_awaitTransition](foundry.applications.sheets.AmbientLightConfig.html#_awaittransition)
[\_canRender](foundry.applications.sheets.AmbientLightConfig.html#_canrender)
[\_configureRenderOptions](foundry.applications.sheets.AmbientLightConfig.html#_configurerenderoptions)
[\_doEvent](foundry.applications.sheets.AmbientLightConfig.html#_doevent)
[\_headerControlButtons](foundry.applications.sheets.AmbientLightConfig.html#_headercontrolbuttons)
[\_initializeApplicationOptions](foundry.applications.sheets.AmbientLightConfig.html#_initializeapplicationoptions)
[\_onChangeForm](foundry.applications.sheets.AmbientLightConfig.html#_onchangeform)
[\_onClose](foundry.applications.sheets.AmbientLightConfig.html#_onclose)
[\_onFirstRender](foundry.applications.sheets.AmbientLightConfig.html#_onfirstrender)
[\_onRender](foundry.applications.sheets.AmbientLightConfig.html#_onrender)
[\_prepareContext](foundry.applications.sheets.AmbientLightConfig.html#_preparecontext)
[\_preRender](foundry.applications.sheets.AmbientLightConfig.html#_prerender)
[\_renderFrame](foundry.applications.sheets.AmbientLightConfig.html#_renderframe)
[\_renderHTML](foundry.applications.sheets.AmbientLightConfig.html#_renderhtml)
[addEventListener](foundry.applications.sheets.AmbientLightConfig.html#addeventlistener)
[bringToFront](foundry.applications.sheets.AmbientLightConfig.html#bringtofront)
[changeTab](foundry.applications.sheets.AmbientLightConfig.html#changetab)
[close](foundry.applications.sheets.AmbientLightConfig.html#close)
[dispatchEvent](foundry.applications.sheets.AmbientLightConfig.html#dispatchevent)
[maximize](foundry.applications.sheets.AmbientLightConfig.html#maximize)
[minimize](foundry.applications.sheets.AmbientLightConfig.html#minimize)
[removeEventListener](foundry.applications.sheets.AmbientLightConfig.html#removeeventlistener)
[render](foundry.applications.sheets.AmbientLightConfig.html#render)
[setPosition](foundry.applications.sheets.AmbientLightConfig.html#setposition)
[submit](foundry.applications.sheets.AmbientLightConfig.html#submit)
[toggleControls](foundry.applications.sheets.AmbientLightConfig.html#togglecontrols)
[\_attachFrameListeners](foundry.applications.sheets.AmbientLightConfig.html#_attachframelisteners)
[\_createContextMenu](foundry.applications.sheets.AmbientLightConfig.html#_createcontextmenu)
[\_getHeaderControls](foundry.applications.sheets.AmbientLightConfig.html#_getheadercontrols)
[\_getTabsConfig](foundry.applications.sheets.AmbientLightConfig.html#_gettabsconfig)
[\_insertElement](foundry.applications.sheets.AmbientLightConfig.html#_insertelement)
[\_onClickAction](foundry.applications.sheets.AmbientLightConfig.html#_onclickaction)
[\_onClickTab](foundry.applications.sheets.AmbientLightConfig.html#_onclicktab)
[\_onPosition](foundry.applications.sheets.AmbientLightConfig.html#_onposition)
[\_onRevealSecret](foundry.applications.sheets.AmbientLightConfig.html#_onrevealsecret)
[\_onSubmitForm](foundry.applications.sheets.AmbientLightConfig.html#_onsubmitform)
[\_postRender](foundry.applications.sheets.AmbientLightConfig.html#_postrender)
[\_preClose](foundry.applications.sheets.AmbientLightConfig.html#_preclose)
[\_preFirstRender](foundry.applications.sheets.AmbientLightConfig.html#_prefirstrender)
[\_prepareSubmitData](foundry.applications.sheets.AmbientLightConfig.html#_preparesubmitdata)
[\_prepareTabs](foundry.applications.sheets.AmbientLightConfig.html#_preparetabs)
[\_prePosition](foundry.applications.sheets.AmbientLightConfig.html#_preposition)
[\_previewChanges](foundry.applications.sheets.AmbientLightConfig.html#_previewchanges)
[\_processFormData](foundry.applications.sheets.AmbientLightConfig.html#_processformdata)
[\_processSubmitData](foundry.applications.sheets.AmbientLightConfig.html#_processsubmitdata)
[\_removeElement](foundry.applications.sheets.AmbientLightConfig.html#_removeelement)
[\_renderHeaderControl](foundry.applications.sheets.AmbientLightConfig.html#_renderheadercontrol)
[\_replaceHTML](foundry.applications.sheets.AmbientLightConfig.html#_replacehtml)
[\_resetPreview](foundry.applications.sheets.AmbientLightConfig.html#_resetpreview)
[\_tearDown](foundry.applications.sheets.AmbientLightConfig.html#_teardown)
[\_toggleDisabled](foundry.applications.sheets.AmbientLightConfig.html#_toggledisabled)
[\_updateFrame](foundry.applications.sheets.AmbientLightConfig.html#_updateframe)
[\_updatePosition](foundry.applications.sheets.AmbientLightConfig.html#_updateposition)
[\_migrateConstructorParams](foundry.applications.sheets.AmbientLightConfig.html#_migrateconstructorparams)
[inheritanceChain](foundry.applications.sheets.AmbientLightConfig.html#inheritancechain)
[parseCSSDimension](foundry.applications.sheets.AmbientLightConfig.html#parsecssdimension)
[waitForImages](foundry.applications.sheets.AmbientLightConfig.html#waitforimages)

## Constructors

### constructor

* new AmbientLightConfig(options: any, ...args: any[]): [AmbientLightConfig](foundry.applications.sheets.AmbientLightConfig.html)
  ...
  #### Returns [AmbientLightConfig](foundry.applications.sheets.AmbientLightConfig.html)
...
preview: [AmbientLightDocument](foundry.documents.AmbientLightDocument.html)
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: { reset: (...this: any, event: PointerEvent) => Promise<void> };  
Â Â Â Â classes: string[];  
Â Â Â Â form: { closeOnSubmit: boolean };  
Â Â Â Â position: { width: number };  
Â Â Â Â window: { contentClasses: string[] };  
} = ...
...
PARTS: {  
Â Â Â Â advanced: { template: string };  
Â Â Â Â animation: { template: string };  
Â Â Â Â basic: { template: string };  
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â Â Â Â Â | { action: string; icon: string; label: string; type: string }  
  Â Â Â Â Â Â Â Â Â Â Â Â | { action?: undefined; icon: string; label: string; type: string }  
  Â Â Â Â Â Â Â Â )[];  
  Â Â Â Â Â Â Â Â colorationTechniques: Record<string, [ShaderTechnique](../interfaces/foundry.ShaderTechnique.html)>;  
  Â Â Â Â Â Â Â Â document: [AmbientLightDocument](foundry.documents.AmbientLightDocument.html);  
  Â Â Â Â Â Â Â Â gridUnits: any;  
  Â Â Â Â Â Â Â Â isDarkness: any;  
  Â Â Â Â Â Â Â Â light: [AmbientLightDocument](foundry.documents.AmbientLightDocument.html);  
  Â Â Â Â Â Â Â Â lightAnimations:  
  Â Â Â Â Â Â Â Â Â Â Â Â | [LightSourceAnimationConfig](../types/CONFIG.LightSourceAnimationConfig.html)  
  Â Â Â Â Â Â Â Â Â Â Â Â | [DarknessSourceAnimationConfig](../types/CONFIG.DarknessSourceAnimationConfig.html);  
  Â Â Â Â Â Â Â Â source: [AmbientLightData](../interfaces/foundry.documents.types.AmbientLightData.html);  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â [ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.html) & { Â Â Â Â Â Â Â Â document: ClientDocument; Â Â Â Â Â Â Â Â editable: boolean; Â Â Â Â Â Â Â Â fields: any; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â source: any; Â Â Â Â Â Â Â Â user: null Â Â Â Â Â Â Â Â | [documents](../modules/foundry.documents.html).[User](foundry.documents.User.html); Â Â Â Â } & { Â Â Â Â Â Â Â Â buttons: ( Â Â Â Â Â Â Â Â Â Â Â Â | { action: string; icon: string; label: string; type: string } Â Â Â Â Â Â Â Â Â Â Â Â | { action?: undefined; icon: string; label: string; type: string } Â Â Â Â Â Â Â Â )[]; Â Â Â Â Â Â Â Â colorationTechniques: Record<string, [ShaderTechnique](../interfaces/foundry.ShaderTechnique.html)>; Â Â Â Â Â Â Â Â document: [AmbientLightDocument](foundry.documents.AmbientLightDocument.html); Â Â Â Â Â Â Â Â gridUnits: any; Â Â Â Â Â Â Â Â isDarkness: any; Â Â Â Â Â Â Â Â light: [AmbientLightDocument](foundry.documents.AmbientLightDocument.html); Â Â Â Â Â Â Â Â lightAnimations: Â Â Â Â Â Â Â Â Â Â Â Â | [LightSourceAnimationConfig](../types/CONFIG.LightSourceAnimationConfig.html) Â Â Â Â Â Â Â Â Â Â Â Â | [DarknessSourceAnimationConfig](../types/CONFIG.DarknessSourceAnimationConfig.html); Â Â Â Â Â Â Â Â source: [AmbientLightData](../interfaces/foundry.documents.types.AmbientLightData.html); Â Â Â Â }, >
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.html)>): Promise<[AmbientLightConfig](foundry.applications.sheets.AmbientLightConfig.html)>
  ...
  #### Returns Promise<[AmbientLightConfig](foundry.applications.sheets.AmbientLightConfig.html)>
...
* render(  
  ...
  ): Promise<[AmbientLightConfig](foundry.applications.sheets.AmbientLightConfig.html)>
