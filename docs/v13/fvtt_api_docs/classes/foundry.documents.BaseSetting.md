---
title: "BaseSetting | Foundry Virtual Tabletop - API Documentation - Version 13"
...
#### Hierarchy ([View Summary](../hierarchy.html#foundry.documents.BaseSetting))
...
[constructor](foundry.documents.BaseSetting.html#constructor)

### Properties

[\_source](foundry.documents.BaseSetting.html#_source)
[parent](foundry.documents.BaseSetting.html#parent)
[\_schema](foundry.documents.BaseSetting.html#_schema)
[LOCALIZATION\_PREFIXES](foundry.documents.BaseSetting.html#localization_prefixes)
[metadata](foundry.documents.BaseSetting.html#metadata)

### Accessors

[compendium](foundry.documents.BaseSetting.html#compendium)
[id](foundry.documents.BaseSetting.html#id)
[inCompendium](foundry.documents.BaseSetting.html#incompendium)
[invalid](foundry.documents.BaseSetting.html#invalid)
[isEmbedded](foundry.documents.BaseSetting.html#isembedded)
[schema](foundry.documents.BaseSetting.html#schema)
[uuid](foundry.documents.BaseSetting.html#uuid)
[validationFailures](foundry.documents.BaseSetting.html#validationfailures)
[baseDocument](foundry.documents.BaseSetting.html#basedocument)
[collectionName](foundry.documents.BaseSetting.html#collectionname)
[database](foundry.documents.BaseSetting.html#database)
[documentName](foundry.documents.BaseSetting.html#documentname)
[hasTypeData](foundry.documents.BaseSetting.html#hastypedata)
[hierarchy](foundry.documents.BaseSetting.html#hierarchy)
[implementation](foundry.documents.BaseSetting.html#implementation)
[schema](foundry.documents.BaseSetting.html#schema-2)
[TYPES](foundry.documents.BaseSetting.html#types)

### Methods

[\_configure](foundry.documents.BaseSetting.html#_configure)
[\_getParentCollection](foundry.documents.BaseSetting.html#_getparentcollection)
[canUserModify](foundry.documents.BaseSetting.html#canusermodify)
[clone](foundry.documents.BaseSetting.html#clone)
[createEmbeddedDocuments](foundry.documents.BaseSetting.html#createembeddeddocuments)
[delete](foundry.documents.BaseSetting.html#delete)
[deleteEmbeddedDocuments](foundry.documents.BaseSetting.html#deleteembeddeddocuments)
[getEmbeddedCollection](foundry.documents.BaseSetting.html#getembeddedcollection)
[getEmbeddedDocument](foundry.documents.BaseSetting.html#getembeddeddocument)
[getFlag](foundry.documents.BaseSetting.html#getflag)
[getUserLevel](foundry.documents.BaseSetting.html#getuserlevel)
[migrateSystemData](foundry.documents.BaseSetting.html#migratesystemdata)
[reset](foundry.documents.BaseSetting.html#reset)
[setFlag](foundry.documents.BaseSetting.html#setflag)
[testUserPermission](foundry.documents.BaseSetting.html#testuserpermission)
[toJSON](foundry.documents.BaseSetting.html#tojson)
[toObject](foundry.documents.BaseSetting.html#toobject)
[traverseEmbeddedDocuments](foundry.documents.BaseSetting.html#traverseembeddeddocuments)
[unsetFlag](foundry.documents.BaseSetting.html#unsetflag)
[update](foundry.documents.BaseSetting.html#update)
[updateEmbeddedDocuments](foundry.documents.BaseSetting.html#updateembeddeddocuments)
[updateSource](foundry.documents.BaseSetting.html#updatesource)
[validate](foundry.documents.BaseSetting.html#validate)
[\_initialize](foundry.documents.BaseSetting.html#_initialize)
[\_initializeSource](foundry.documents.BaseSetting.html#_initializesource)
[\_onCreate](foundry.documents.BaseSetting.html#_oncreate)
[\_onDelete](foundry.documents.BaseSetting.html#_ondelete)
[\_onUpdate](foundry.documents.BaseSetting.html#_onupdate)
[\_preCreate](foundry.documents.BaseSetting.html#_precreate)
[\_preDelete](foundry.documents.BaseSetting.html#_predelete)
[\_preUpdate](foundry.documents.BaseSetting.html#_preupdate)
[\_addDataFieldMigration](foundry.documents.BaseSetting.html#_adddatafieldmigration)
[\_addDataFieldShim](foundry.documents.BaseSetting.html#_adddatafieldshim)
[\_addDataFieldShims](foundry.documents.BaseSetting.html#_adddatafieldshims)
[\_clearFieldsRecursively](foundry.documents.BaseSetting.html#_clearfieldsrecursively)
[\_initializationOrder](foundry.documents.BaseSetting.html#_initializationorder)
[\_logDataFieldMigration](foundry.documents.BaseSetting.html#_logdatafieldmigration)
[canUserCreate](foundry.documents.BaseSetting.html#canusercreate)
[cleanData](foundry.documents.BaseSetting.html#cleandata)
[create](foundry.documents.BaseSetting.html#create)
[createDocuments](foundry.documents.BaseSetting.html#createdocuments)
[defineSchema](foundry.documents.BaseSetting.html#defineschema)
[deleteDocuments](foundry.documents.BaseSetting.html#deletedocuments)
[fromJSON](foundry.documents.BaseSetting.html#fromjson)
[fromSource](foundry.documents.BaseSetting.html#fromsource)
[get](foundry.documents.BaseSetting.html#get)
[getCollectionName](foundry.documents.BaseSetting.html#getcollectionname)
[migrateData](foundry.documents.BaseSetting.html#migratedata)
[migrateDataSafe](foundry.documents.BaseSetting.html#migratedatasafe)
[shimData](foundry.documents.BaseSetting.html#shimdata)
[updateDocuments](foundry.documents.BaseSetting.html#updatedocuments)
[validateJoint](foundry.documents.BaseSetting.html#validatejoint)
[\_onCreateOperation](foundry.documents.BaseSetting.html#_oncreateoperation)
[\_onDeleteOperation](foundry.documents.BaseSetting.html#_ondeleteoperation)
[\_onUpdateOperation](foundry.documents.BaseSetting.html#_onupdateoperation)
[\_preCreateOperation](foundry.documents.BaseSetting.html#_precreateoperation)
[\_preDeleteOperation](foundry.documents.BaseSetting.html#_predeleteoperation)
[\_preUpdateOperation](foundry.documents.BaseSetting.html#_preupdateoperation)
...
* new BaseSetting(  
  ...
  #### Returns [BaseSetting](foundry.documents.BaseSetting.html)
...
* \_preCreate(  
  ...
  Modifications to the pending Document instance must be performed using [updateSource](foundry.documents.BaseSetting.html#updatesource).
...
* defineSchema(): {  
  ...
  [\_source](foundry.documents.BaseSetting.html#_source) values into direct properties of the data model. The schema is a static property of the model and
...
* \_onCreateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onCreate](foundry.documents.BaseSetting.html#_oncreate) workflows.
...
* \_onDeleteOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onDelete](foundry.documents.BaseSetting.html#_ondelete) workflows.
...
* \_onUpdateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onUpdate](foundry.documents.BaseSetting.html#_onupdate) workflows.
...
* \_preCreateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preCreate](foundry.documents.BaseSetting.html#_precreate) workflows and provides a final pre-flight check
...
* \_preDeleteOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preDelete](foundry.documents.BaseSetting.html#_predelete) workflows and provides a final pre-flight check
  before a database operation occurs.
...
* \_preUpdateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preUpdate](foundry.documents.BaseSetting.html#_preupdate) workflows and provides a final pre-flight check
  before a database operation occurs.
