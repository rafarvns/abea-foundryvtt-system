---
title: "BaseMeasuredTemplate | Foundry Virtual Tabletop - API Documentation - Version 13"
...
#### Hierarchy ([View Summary](../hierarchy.html#foundry.documents.BaseMeasuredTemplate))
...
[constructor](foundry.documents.BaseMeasuredTemplate.html#constructor)

### Properties

[\_source](foundry.documents.BaseMeasuredTemplate.html#_source)
[parent](foundry.documents.BaseMeasuredTemplate.html#parent)
[\_schema](foundry.documents.BaseMeasuredTemplate.html#_schema)
[LOCALIZATION\_PREFIXES](foundry.documents.BaseMeasuredTemplate.html#localization_prefixes)
[metadata](foundry.documents.BaseMeasuredTemplate.html#metadata)

### Accessors

[compendium](foundry.documents.BaseMeasuredTemplate.html#compendium)
[id](foundry.documents.BaseMeasuredTemplate.html#id)
[inCompendium](foundry.documents.BaseMeasuredTemplate.html#incompendium)
[invalid](foundry.documents.BaseMeasuredTemplate.html#invalid)
[isEmbedded](foundry.documents.BaseMeasuredTemplate.html#isembedded)
[schema](foundry.documents.BaseMeasuredTemplate.html#schema)
[uuid](foundry.documents.BaseMeasuredTemplate.html#uuid)
[validationFailures](foundry.documents.BaseMeasuredTemplate.html#validationfailures)
[baseDocument](foundry.documents.BaseMeasuredTemplate.html#basedocument)
[collectionName](foundry.documents.BaseMeasuredTemplate.html#collectionname)
[database](foundry.documents.BaseMeasuredTemplate.html#database)
[documentName](foundry.documents.BaseMeasuredTemplate.html#documentname)
[hasTypeData](foundry.documents.BaseMeasuredTemplate.html#hastypedata)
[hierarchy](foundry.documents.BaseMeasuredTemplate.html#hierarchy)
[implementation](foundry.documents.BaseMeasuredTemplate.html#implementation)
[schema](foundry.documents.BaseMeasuredTemplate.html#schema-2)
[TYPES](foundry.documents.BaseMeasuredTemplate.html#types)

### Methods

[\_configure](foundry.documents.BaseMeasuredTemplate.html#_configure)
[\_getParentCollection](foundry.documents.BaseMeasuredTemplate.html#_getparentcollection)
[canUserModify](foundry.documents.BaseMeasuredTemplate.html#canusermodify)
[clone](foundry.documents.BaseMeasuredTemplate.html#clone)
[createEmbeddedDocuments](foundry.documents.BaseMeasuredTemplate.html#createembeddeddocuments)
[delete](foundry.documents.BaseMeasuredTemplate.html#delete)
[deleteEmbeddedDocuments](foundry.documents.BaseMeasuredTemplate.html#deleteembeddeddocuments)
[getEmbeddedCollection](foundry.documents.BaseMeasuredTemplate.html#getembeddedcollection)
[getEmbeddedDocument](foundry.documents.BaseMeasuredTemplate.html#getembeddeddocument)
[getFlag](foundry.documents.BaseMeasuredTemplate.html#getflag)
[getUserLevel](foundry.documents.BaseMeasuredTemplate.html#getuserlevel)
[migrateSystemData](foundry.documents.BaseMeasuredTemplate.html#migratesystemdata)
[reset](foundry.documents.BaseMeasuredTemplate.html#reset)
[setFlag](foundry.documents.BaseMeasuredTemplate.html#setflag)
[testUserPermission](foundry.documents.BaseMeasuredTemplate.html#testuserpermission)
[toJSON](foundry.documents.BaseMeasuredTemplate.html#tojson)
[toObject](foundry.documents.BaseMeasuredTemplate.html#toobject)
[traverseEmbeddedDocuments](foundry.documents.BaseMeasuredTemplate.html#traverseembeddeddocuments)
[unsetFlag](foundry.documents.BaseMeasuredTemplate.html#unsetflag)
[update](foundry.documents.BaseMeasuredTemplate.html#update)
[updateEmbeddedDocuments](foundry.documents.BaseMeasuredTemplate.html#updateembeddeddocuments)
[updateSource](foundry.documents.BaseMeasuredTemplate.html#updatesource)
[validate](foundry.documents.BaseMeasuredTemplate.html#validate)
[\_initialize](foundry.documents.BaseMeasuredTemplate.html#_initialize)
[\_initializeSource](foundry.documents.BaseMeasuredTemplate.html#_initializesource)
[\_onCreate](foundry.documents.BaseMeasuredTemplate.html#_oncreate)
[\_onDelete](foundry.documents.BaseMeasuredTemplate.html#_ondelete)
[\_onUpdate](foundry.documents.BaseMeasuredTemplate.html#_onupdate)
[\_preCreate](foundry.documents.BaseMeasuredTemplate.html#_precreate)
[\_preDelete](foundry.documents.BaseMeasuredTemplate.html#_predelete)
[\_preUpdate](foundry.documents.BaseMeasuredTemplate.html#_preupdate)
[\_addDataFieldMigration](foundry.documents.BaseMeasuredTemplate.html#_adddatafieldmigration)
[\_addDataFieldShim](foundry.documents.BaseMeasuredTemplate.html#_adddatafieldshim)
[\_addDataFieldShims](foundry.documents.BaseMeasuredTemplate.html#_adddatafieldshims)
[\_clearFieldsRecursively](foundry.documents.BaseMeasuredTemplate.html#_clearfieldsrecursively)
[\_initializationOrder](foundry.documents.BaseMeasuredTemplate.html#_initializationorder)
[\_logDataFieldMigration](foundry.documents.BaseMeasuredTemplate.html#_logdatafieldmigration)
[canUserCreate](foundry.documents.BaseMeasuredTemplate.html#canusercreate)
[cleanData](foundry.documents.BaseMeasuredTemplate.html#cleandata)
[create](foundry.documents.BaseMeasuredTemplate.html#create)
[createDocuments](foundry.documents.BaseMeasuredTemplate.html#createdocuments)
[defineSchema](foundry.documents.BaseMeasuredTemplate.html#defineschema)
[deleteDocuments](foundry.documents.BaseMeasuredTemplate.html#deletedocuments)
[fromJSON](foundry.documents.BaseMeasuredTemplate.html#fromjson)
[fromSource](foundry.documents.BaseMeasuredTemplate.html#fromsource)
[get](foundry.documents.BaseMeasuredTemplate.html#get)
[getCollectionName](foundry.documents.BaseMeasuredTemplate.html#getcollectionname)
[migrateData](foundry.documents.BaseMeasuredTemplate.html#migratedata)
[migrateDataSafe](foundry.documents.BaseMeasuredTemplate.html#migratedatasafe)
[shimData](foundry.documents.BaseMeasuredTemplate.html#shimdata)
[updateDocuments](foundry.documents.BaseMeasuredTemplate.html#updatedocuments)
[validateJoint](foundry.documents.BaseMeasuredTemplate.html#validatejoint)
[\_onCreateOperation](foundry.documents.BaseMeasuredTemplate.html#_oncreateoperation)
[\_onDeleteOperation](foundry.documents.BaseMeasuredTemplate.html#_ondeleteoperation)
[\_onUpdateOperation](foundry.documents.BaseMeasuredTemplate.html#_onupdateoperation)
[\_preCreateOperation](foundry.documents.BaseMeasuredTemplate.html#_precreateoperation)
[\_preDeleteOperation](foundry.documents.BaseMeasuredTemplate.html#_predeleteoperation)
[\_preUpdateOperation](foundry.documents.BaseMeasuredTemplate.html#_preupdateoperation)
...
* new BaseMeasuredTemplate(  
  ...
  #### Returns [BaseMeasuredTemplate](foundry.documents.BaseMeasuredTemplate.html)
...
* \_preCreate(  
  ...
  Modifications to the pending Document instance must be performed using [updateSource](foundry.documents.BaseMeasuredTemplate.html#updatesource).
...
* defineSchema(): {  
  ...
  [\_source](foundry.documents.BaseMeasuredTemplate.html#_source) values into direct properties of the data model. The schema is a static property of the model and
...
* \_onCreateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onCreate](foundry.documents.BaseMeasuredTemplate.html#_oncreate) workflows.
...
* \_onDeleteOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onDelete](foundry.documents.BaseMeasuredTemplate.html#_ondelete) workflows.
...
* \_onUpdateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_onUpdate](foundry.documents.BaseMeasuredTemplate.html#_onupdate) workflows.
...
* \_preCreateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preCreate](foundry.documents.BaseMeasuredTemplate.html#_precreate) workflows and provides a final pre-flight check
...
* \_preDeleteOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preDelete](foundry.documents.BaseMeasuredTemplate.html#_predelete) workflows and provides a final pre-flight check
  before a database operation occurs.
...
* \_preUpdateOperation(  
  ...
  This batch-wise workflow occurs after individual [\_preUpdate](foundry.documents.BaseMeasuredTemplate.html#_preupdate) workflows and provides a final pre-flight check
  before a database operation occurs.
