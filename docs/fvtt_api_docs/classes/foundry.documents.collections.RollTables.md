---
title: "RollTables | Foundry Virtual Tabletop - API Documentation - Version 13"
...
* [foundry.documents.RollTable](foundry.documents.RollTable.html): The RollTable document
* [foundry.applications.sidebar.tabs.RollTableDirectory](foundry.applications.sidebar.tabs.RollTableDirectory.html): The RollTableDirectory
  sidebar directory

#### Hierarchy ([View Summary](../hierarchy.html#foundry.documents.collections.RollTables))
...
[constructor](foundry.documents.collections.RollTables.html#constructor)

### Properties

[apps](foundry.documents.collections.RollTables.html#apps)
[invalidDocumentIds](foundry.documents.collections.RollTables.html#invaliddocumentids)
[documentName](foundry.documents.collections.RollTables.html#documentname)

### Accessors

[contents](foundry.documents.collections.RollTables.html#contents)
[directory](foundry.documents.collections.RollTables.html#directory)
[documentClass](foundry.documents.collections.RollTables.html#documentclass)
[documentName](foundry.documents.collections.RollTables.html#documentname-1)
[folders](foundry.documents.collections.RollTables.html#folders)
[name](foundry.documents.collections.RollTables.html#name)
[instance](foundry.documents.collections.RollTables.html#instance)
[registeredSheets](foundry.documents.collections.RollTables.html#registeredsheets)

### Methods

[\_getVisibleTreeContents](foundry.documents.collections.RollTables.html#_getvisibletreecontents)
[\_onModifyContents](foundry.documents.collections.RollTables.html#_onmodifycontents)
[[iterator]](foundry.documents.collections.RollTables.html#iterator)
[createDocument](foundry.documents.collections.RollTables.html#createdocument)
[delete](foundry.documents.collections.RollTables.html#delete)
[filter](foundry.documents.collections.RollTables.html#filter)
[find](foundry.documents.collections.RollTables.html#find)
[forEach](foundry.documents.collections.RollTables.html#foreach)
[fromCompendium](foundry.documents.collections.RollTables.html#fromcompendium)
[get](foundry.documents.collections.RollTables.html#get)
[getInvalid](foundry.documents.collections.RollTables.html#getinvalid)
[getName](foundry.documents.collections.RollTables.html#getname)
[importFromCompendium](foundry.documents.collections.RollTables.html#importfromcompendium)
[map](foundry.documents.collections.RollTables.html#map)
[reduce](foundry.documents.collections.RollTables.html#reduce)
[render](foundry.documents.collections.RollTables.html#render)
[search](foundry.documents.collections.RollTables.html#search)
[set](foundry.documents.collections.RollTables.html#set)
[some](foundry.documents.collections.RollTables.html#some)
[toJSON](foundry.documents.collections.RollTables.html#tojson)
[updateAll](foundry.documents.collections.RollTables.html#updateall)
[\_initialize](foundry.documents.collections.RollTables.html#_initialize)
[getSearchableFields](foundry.documents.collections.RollTables.html#getsearchablefields)
[registerSettings](foundry.documents.collections.RollTables.html#registersettings)
[registerSheet](foundry.documents.collections.RollTables.html#registersheet)
[unregisterSheet](foundry.documents.collections.RollTables.html#unregistersheet)

## Constructors

### constructor

* new RollTables(data?: object[]): [RollTables](foundry.documents.collections.RollTables.html)
  ...
  #### Returns [RollTables](foundry.documents.collections.RollTables.html)
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)>,  
  Â Â Â Â ) => unknown,  
  ): undefined | [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)
  ...
  #### Returns undefined | [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)
...
* forEach(fn: (value: [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html),  
  ...
  + document: object | [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)
...
* getInvalid(  
  ...
  ): void | [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)
  ...
  #### Returns void | [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)
...
* map(  
  Â Â Â Â transformer: (  
  Â Â Â Â Â Â Â Â arg0: [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html),  
  ...
  + transformer: (arg0: [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html), arg1: number, arg2: [Collection](foundry.utils.Collection.html)) => any
...
* reduce(  
  ...
  Â Â Â Â Â Â Â Â arg1: [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html),  
  ...
  + reducer: (arg0: any, arg1: [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html), arg2: number, arg3: [Collection](foundry.utils.Collection.html)) => any
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html)[]
...
* some(  
  ...
  + condition: (arg0: [documents](../modules/foundry.documents.html).[RollTable](foundry.documents.RollTable.html), arg1: number, arg2: [Collection](foundry.utils.Collection.html)) => boolean
