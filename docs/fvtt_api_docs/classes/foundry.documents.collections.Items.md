---
title: "Items | Foundry Virtual Tabletop - API Documentation - Version 13"
...
* [foundry.documents.Item](foundry.documents.Item.html): The Item document
* [foundry.applications.sidebar.tabs.ItemDirectory](foundry.applications.sidebar.tabs.ItemDirectory.html): The ItemDirectory sidebar directory

#### Hierarchy ([View Summary](../hierarchy.html#foundry.documents.collections.Items))
...
[constructor](foundry.documents.collections.Items.html#constructor)

### Properties

[apps](foundry.documents.collections.Items.html#apps)
[invalidDocumentIds](foundry.documents.collections.Items.html#invaliddocumentids)
[documentName](foundry.documents.collections.Items.html#documentname)

### Accessors

[contents](foundry.documents.collections.Items.html#contents)
[directory](foundry.documents.collections.Items.html#directory)
[documentClass](foundry.documents.collections.Items.html#documentclass)
[documentName](foundry.documents.collections.Items.html#documentname-1)
[folders](foundry.documents.collections.Items.html#folders)
[name](foundry.documents.collections.Items.html#name)
[instance](foundry.documents.collections.Items.html#instance)
[registeredSheets](foundry.documents.collections.Items.html#registeredsheets)

### Methods

[\_getVisibleTreeContents](foundry.documents.collections.Items.html#_getvisibletreecontents)
[\_onModifyContents](foundry.documents.collections.Items.html#_onmodifycontents)
[[iterator]](foundry.documents.collections.Items.html#iterator)
[createDocument](foundry.documents.collections.Items.html#createdocument)
[delete](foundry.documents.collections.Items.html#delete)
[filter](foundry.documents.collections.Items.html#filter)
[find](foundry.documents.collections.Items.html#find)
[forEach](foundry.documents.collections.Items.html#foreach)
[fromCompendium](foundry.documents.collections.Items.html#fromcompendium)
[get](foundry.documents.collections.Items.html#get)
[getInvalid](foundry.documents.collections.Items.html#getinvalid)
[getName](foundry.documents.collections.Items.html#getname)
[importFromCompendium](foundry.documents.collections.Items.html#importfromcompendium)
[map](foundry.documents.collections.Items.html#map)
[reduce](foundry.documents.collections.Items.html#reduce)
[render](foundry.documents.collections.Items.html#render)
[search](foundry.documents.collections.Items.html#search)
[set](foundry.documents.collections.Items.html#set)
[some](foundry.documents.collections.Items.html#some)
[toJSON](foundry.documents.collections.Items.html#tojson)
[updateAll](foundry.documents.collections.Items.html#updateall)
[\_initialize](foundry.documents.collections.Items.html#_initialize)
[getSearchableFields](foundry.documents.collections.Items.html#getsearchablefields)
[registerSheet](foundry.documents.collections.Items.html#registersheet)
[unregisterSheet](foundry.documents.collections.Items.html#unregistersheet)

## Constructors

### constructor

* new Items(data?: object[]): [Items](foundry.documents.collections.Items.html)
  ...
  #### Returns [Items](foundry.documents.collections.Items.html)
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)>,  
  Â Â Â Â ) => unknown,  
  ): undefined | [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)
  ...
  #### Returns undefined | [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)
...
* forEach(fn: (value: [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html),  
  ...
  + document: object | [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)
...
* getInvalid(id: string, options?: { strict?: boolean }): void | [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)
  ...
  #### Returns void | [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)
...
* map(  
  Â Â Â Â transformer: (  
  Â Â Â Â Â Â Â Â arg0: [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html),  
  ...
  + transformer: (arg0: [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html), arg1: number, arg2: [Collection](foundry.utils.Collection.html)) => any
...
* reduce(  
  ...
  Â Â Â Â Â Â Â Â arg1: [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html),  
  ...
  + reducer: (arg0: any, arg1: [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html), arg2: number, arg3: [Collection](foundry.utils.Collection.html)) => any
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html)[]
...
* some(  
  ...
  + condition: (arg0: [documents](../modules/foundry.documents.html).[Item](foundry.documents.Item.html), arg1: number, arg2: [Collection](foundry.utils.Collection.html)) => boolean
