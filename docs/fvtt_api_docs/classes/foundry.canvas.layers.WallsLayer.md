---
title: "WallsLayer | Foundry Virtual Tabletop - API Documentation - Version 13"
...
#### Hierarchy ([View Summary](../hierarchy.html#foundry.canvas.layers.WallsLayer))
...
[\_chain](foundry.canvas.layers.WallsLayer.html#_chain)
[\_cloneType](foundry.canvas.layers.WallsLayer.html#_clonetype)
[\_configPreview](foundry.canvas.layers.WallsLayer.html#_configpreview)
[\_last](foundry.canvas.layers.WallsLayer.html#_last)
[chain](foundry.canvas.layers.WallsLayer.html#chain)
[clipboard](foundry.canvas.layers.WallsLayer.html#clipboard)
[eventMode](foundry.canvas.layers.WallsLayer.html#eventmode)
[highlightObjects](foundry.canvas.layers.WallsLayer.html#highlightobjects)
[history](foundry.canvas.layers.WallsLayer.html#history)
[interactiveChildren](foundry.canvas.layers.WallsLayer.html#interactivechildren)
[objects](foundry.canvas.layers.WallsLayer.html#objects)
[options](foundry.canvas.layers.WallsLayer.html#options)
[preview](foundry.canvas.layers.WallsLayer.html#preview)
[quadtree](foundry.canvas.layers.WallsLayer.html#quadtree)
[CREATION\_STATES](foundry.canvas.layers.WallsLayer.html#creation_states)
[documentName](foundry.canvas.layers.WallsLayer.html#documentname)
[SORT\_ORDER](foundry.canvas.layers.WallsLayer.html#sort_order)

### Accessors

[active](foundry.canvas.layers.WallsLayer.html#active)
[controlled](foundry.canvas.layers.WallsLayer.html#controlled)
[controlledObjects](foundry.canvas.layers.WallsLayer.html#controlledobjects)
[documentCollection](foundry.canvas.layers.WallsLayer.html#documentcollection)
[doors](foundry.canvas.layers.WallsLayer.html#doors)
[hasPreview](foundry.canvas.layers.WallsLayer.html#haspreview)
[hookName](foundry.canvas.layers.WallsLayer.html#hookname)
[hover](foundry.canvas.layers.WallsLayer.html#hover)
[hud](foundry.canvas.layers.WallsLayer.html#hud)
[name](foundry.canvas.layers.WallsLayer.html#name)
[placeables](foundry.canvas.layers.WallsLayer.html#placeables)
[instance](foundry.canvas.layers.WallsLayer.html#instance)
[layerOptions](foundry.canvas.layers.WallsLayer.html#layeroptions)
[placeableClass](foundry.canvas.layers.WallsLayer.html#placeableclass)

### Methods

[\_activate](foundry.canvas.layers.WallsLayer.html#_activate)
[\_canDragLeftStart](foundry.canvas.layers.WallsLayer.html#_candragleftstart)
[\_createPreview](foundry.canvas.layers.WallsLayer.html#_createpreview)
[\_deactivate](foundry.canvas.layers.WallsLayer.html#_deactivate)
[\_draw](foundry.canvas.layers.WallsLayer.html#_draw)
[\_getCopyableObjects](foundry.canvas.layers.WallsLayer.html#_getcopyableobjects)
[\_getMovableObjects](foundry.canvas.layers.WallsLayer.html#_getmovableobjects)
[\_getWallEndpointCoordinates](foundry.canvas.layers.WallsLayer.html#_getwallendpointcoordinates)
[\_highlightObjects](foundry.canvas.layers.WallsLayer.html#_highlightobjects)
[\_onClickLeft](foundry.canvas.layers.WallsLayer.html#_onclickleft)
[\_onClickRight](foundry.canvas.layers.WallsLayer.html#_onclickright)
[\_onCopyKey](foundry.canvas.layers.WallsLayer.html#_oncopykey)
[\_onCutKey](foundry.canvas.layers.WallsLayer.html#_oncutkey)
[\_onDeleteKey](foundry.canvas.layers.WallsLayer.html#_ondeletekey)
[\_onDismissKey](foundry.canvas.layers.WallsLayer.html#_ondismisskey)
[\_onDragLeftCancel](foundry.canvas.layers.WallsLayer.html#_ondragleftcancel)
[\_onDragLeftDrop](foundry.canvas.layers.WallsLayer.html#_ondragleftdrop)
[\_onDragLeftMove](foundry.canvas.layers.WallsLayer.html#_ondragleftmove)
[\_onDragLeftStart](foundry.canvas.layers.WallsLayer.html#_ondragleftstart)
[\_onMouseWheel](foundry.canvas.layers.WallsLayer.html#_onmousewheel)
[\_onPasteKey](foundry.canvas.layers.WallsLayer.html#_onpastekey)
[\_onSelectAllKey](foundry.canvas.layers.WallsLayer.html#_onselectallkey)
[\_onUndoKey](foundry.canvas.layers.WallsLayer.html#_onundokey)
[\_prepareKeyboardMovementUpdates](foundry.canvas.layers.WallsLayer.html#_preparekeyboardmovementupdates)
[\_prepareKeyboardRotationUpdates](foundry.canvas.layers.WallsLayer.html#_preparekeyboardrotationupdates)
[\_sendToBackOrBringToFront](foundry.canvas.layers.WallsLayer.html#_sendtobackorbringtofront)
[\_tearDown](foundry.canvas.layers.WallsLayer.html#_teardown)
[activate](foundry.canvas.layers.WallsLayer.html#activate)
[clearPreviewContainer](foundry.canvas.layers.WallsLayer.html#clearpreviewcontainer)
[controlAll](foundry.canvas.layers.WallsLayer.html#controlall)
[controllableObjects](foundry.canvas.layers.WallsLayer.html#controllableobjects)
[copyObjects](foundry.canvas.layers.WallsLayer.html#copyobjects)
[createObject](foundry.canvas.layers.WallsLayer.html#createobject)
[deactivate](foundry.canvas.layers.WallsLayer.html#deactivate)
[deleteAll](foundry.canvas.layers.WallsLayer.html#deleteall)
[draw](foundry.canvas.layers.WallsLayer.html#draw)
[get](foundry.canvas.layers.WallsLayer.html#get)
[getDocuments](foundry.canvas.layers.WallsLayer.html#getdocuments)
[getMaxSort](foundry.canvas.layers.WallsLayer.html#getmaxsort)
[getSnappedPoint](foundry.canvas.layers.WallsLayer.html#getsnappedpoint)
[getZIndex](foundry.canvas.layers.WallsLayer.html#getzindex)
[moveMany](foundry.canvas.layers.WallsLayer.html#movemany)
[pasteObjects](foundry.canvas.layers.WallsLayer.html#pasteobjects)
[releaseAll](foundry.canvas.layers.WallsLayer.html#releaseall)
[rotateMany](foundry.canvas.layers.WallsLayer.html#rotatemany)
[selectObjects](foundry.canvas.layers.WallsLayer.html#selectobjects)
[setAllRenderFlags](foundry.canvas.layers.WallsLayer.html#setallrenderflags)
[storeHistory](foundry.canvas.layers.WallsLayer.html#storehistory)
[tearDown](foundry.canvas.layers.WallsLayer.html#teardown)
[undoHistory](foundry.canvas.layers.WallsLayer.html#undohistory)
[updateAll](foundry.canvas.layers.WallsLayer.html#updateall)
[\_canvasCoordinatesFromDrop](foundry.canvas.layers.WallsLayer.html#_canvascoordinatesfromdrop)
[\_confirmDeleteKey](foundry.canvas.layers.WallsLayer.html#_confirmdeletekey)
[\_onClickLeft2](foundry.canvas.layers.WallsLayer.html#_onclickleft2)
[\_onClickRight2](foundry.canvas.layers.WallsLayer.html#_onclickright2)
[\_onCycleViewKey](foundry.canvas.layers.WallsLayer.html#_oncycleviewkey)
[\_onUndoCreate](foundry.canvas.layers.WallsLayer.html#_onundocreate)
[\_onUndoDelete](foundry.canvas.layers.WallsLayer.html#_onundodelete)
[\_onUndoUpdate](foundry.canvas.layers.WallsLayer.html#_onundoupdate)
[\_storeHistory](foundry.canvas.layers.WallsLayer.html#_storehistory)
[getClosestEndpoint](foundry.canvas.layers.WallsLayer.html#getclosestendpoint)
[prepareSceneControls](foundry.canvas.layers.WallsLayer.html#preparescenecontrols)
...
* get doors(): [canvas](../modules/foundry.canvas.html).[placeables](../modules/foundry.canvas.placeables.html).[Wall](foundry.canvas.placeables.Wall.html)[]
...
* releaseAll(options: any): number
  ...
  Overrides [PlaceablesLayer](foundry.canvas.layers.PlaceablesLayer.html).[releaseAll](foundry.canvas.layers.PlaceablesLayer.html#releaseall)
...
* \_onUndoCreate(event: object): Promise<Document[]>
  ...
  Overrides [PlaceablesLayer](foundry.canvas.layers.PlaceablesLayer.html).[\_onUndoCreate](foundry.canvas.layers.PlaceablesLayer.html#_onundocreate)
...
* getClosestEndpoint(point: Point, wall: [canvas](../modules/foundry.canvas.html).[placeables](../modules/foundry.canvas.placeables.html).[Wall](foundry.canvas.placeables.Wall.html)): PointArray
  ...
  + wall: [canvas](../modules/foundry.canvas.html).[placeables](../modules/foundry.canvas.placeables.html).[Wall](foundry.canvas.placeables.Wall.html)
...
* prepareSceneControls(): {  
  ...
  Â Â Â Â Â Â Â Â };  
  Â Â Â Â Â Â Â Â clone: { icon: string; name: string; order: number; title: string };  
  ...
  #### Returns { Â Â Â Â activeTool: string; Â Â Â Â icon: string; Â Â Â Â layer: string; Â Â Â Â name: string; Â Â Â Â onChange: (event: any, active: any) => void; Â Â Â Â onToolChange: () => any; Â Â Â Â order: number; Â Â Â Â title: string; Â Â Â Â tools: { Â Â Â Â Â Â Â Â clear: { Â Â Â Â Â Â Â Â Â Â Â Â button: boolean; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â onChange: () => any; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â clone: { icon: string; name: string; order: number; title: string }; Â Â Â Â Â Â Â Â closeDoors: { Â Â Â Â Â Â Â Â Â Â Â Â button: boolean; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â onChange: () => void; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â doors: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â ethereal: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â invisible: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â secret: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â select: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â snap: { Â Â Â Â Â Â Â Â Â Â Â Â active: boolean; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â onChange: (event: any, toggled: any) => any; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toggle: boolean; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: { paragraph: string }[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â Â Â Â Â visible: boolean; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â terrain: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â walls: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â window: { Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â Â Â Â Â title: string; Â Â Â Â Â Â Â Â Â Â Â Â toolclip: { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â heading: string; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â items: [ToolclipConfigurationItem](../interfaces/foundry.ToolclipConfigurationItem.html)[]; Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â }; Â Â Â Â }; Â Â Â Â visible: boolean; }
