---
title: "RegionBehaviorType | Foundry Virtual Tabletop - API Documentation - Version 13"
...
* [regionBehaviors](../modules/foundry.data.regionBehaviors.html)
* [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.html)

# Class RegionBehaviorType`Abstract`

The data model for a behavior that receives Region events.

#### Hierarchy ([View Summary](../hierarchy.html#foundry.data.regionBehaviors.RegionBehaviorType))

* [TypeDataModel](foundry.abstract.TypeDataModel.html)
  + RegionBehaviorType
    - [AdjustDarknessLevelRegionBehaviorType](foundry.data.regionBehaviors.AdjustDarknessLevelRegionBehaviorType.html)
    - [DisplayScrollingTextRegionBehaviorType](foundry.data.regionBehaviors.DisplayScrollingTextRegionBehaviorType.html)
    - [ExecuteMacroRegionBehaviorType](foundry.data.regionBehaviors.ExecuteMacroRegionBehaviorType.html)
    - [ExecuteScriptRegionBehaviorType](foundry.data.regionBehaviors.ExecuteScriptRegionBehaviorType.html)
    - [ModifyMovementCostRegionBehaviorType](foundry.data.regionBehaviors.ModifyMovementCostRegionBehaviorType.html)
    - [PauseGameRegionBehaviorType](foundry.data.regionBehaviors.PauseGameRegionBehaviorType.html)
    - [SuppressWeatherRegionBehaviorType](foundry.data.regionBehaviors.SuppressWeatherRegionBehaviorType.html)
    - [TeleportTokenRegionBehaviorType](foundry.data.regionBehaviors.TeleportTokenRegionBehaviorType.html)
    - [ToggleBehaviorRegionBehaviorType](foundry.data.regionBehaviors.ToggleBehaviorRegionBehaviorType.html)

##### Index

### Constructors

[constructor](foundry.data.regionBehaviors.RegionBehaviorType.html#constructor)

### Properties

[\_source](foundry.data.regionBehaviors.RegionBehaviorType.html#_source)
[events](foundry.data.regionBehaviors.RegionBehaviorType.html#events)
[parent](foundry.data.regionBehaviors.RegionBehaviorType.html#parent)
[\_schema](foundry.data.regionBehaviors.RegionBehaviorType.html#_schema)
[events](foundry.data.regionBehaviors.RegionBehaviorType.html#events-1)
[LOCALIZATION\_PREFIXES](foundry.data.regionBehaviors.RegionBehaviorType.html#localization_prefixes)

### Accessors

[behavior](foundry.data.regionBehaviors.RegionBehaviorType.html#behavior)
[invalid](foundry.data.regionBehaviors.RegionBehaviorType.html#invalid)
[region](foundry.data.regionBehaviors.RegionBehaviorType.html#region)
[scene](foundry.data.regionBehaviors.RegionBehaviorType.html#scene)
[schema](foundry.data.regionBehaviors.RegionBehaviorType.html#schema)
[validationFailures](foundry.data.regionBehaviors.RegionBehaviorType.html#validationfailures)
[schema](foundry.data.regionBehaviors.RegionBehaviorType.html#schema-2)

### Methods

[\_preCreate](foundry.data.regionBehaviors.RegionBehaviorType.html#_precreate)
[clone](foundry.data.regionBehaviors.RegionBehaviorType.html#clone)
[prepareBaseData](foundry.data.regionBehaviors.RegionBehaviorType.html#preparebasedata)
[prepareDerivedData](foundry.data.regionBehaviors.RegionBehaviorType.html#preparederiveddata)
[reset](foundry.data.regionBehaviors.RegionBehaviorType.html#reset)
[toEmbed](foundry.data.regionBehaviors.RegionBehaviorType.html#toembed)
[toJSON](foundry.data.regionBehaviors.RegionBehaviorType.html#tojson)
[toObject](foundry.data.regionBehaviors.RegionBehaviorType.html#toobject)
[updateSource](foundry.data.regionBehaviors.RegionBehaviorType.html#updatesource)
[validate](foundry.data.regionBehaviors.RegionBehaviorType.html#validate)
[\_configure](foundry.data.regionBehaviors.RegionBehaviorType.html#_configure)
[\_getTerrainEffects](foundry.data.regionBehaviors.RegionBehaviorType.html#_getterraineffects)
[\_handleRegionEvent](foundry.data.regionBehaviors.RegionBehaviorType.html#_handleregionevent)
[\_initialize](foundry.data.regionBehaviors.RegionBehaviorType.html#_initialize)
[\_initializeSource](foundry.data.regionBehaviors.RegionBehaviorType.html#_initializesource)
[\_onCreate](foundry.data.regionBehaviors.RegionBehaviorType.html#_oncreate)
[\_onDelete](foundry.data.regionBehaviors.RegionBehaviorType.html#_ondelete)
[\_onUpdate](foundry.data.regionBehaviors.RegionBehaviorType.html#_onupdate)
[\_preDelete](foundry.data.regionBehaviors.RegionBehaviorType.html#_predelete)
[\_preUpdate](foundry.data.regionBehaviors.RegionBehaviorType.html#_preupdate)
[cleanData](foundry.data.regionBehaviors.RegionBehaviorType.html#cleandata)
[defineSchema](foundry.data.regionBehaviors.RegionBehaviorType.html#defineschema)
[fromJSON](foundry.data.regionBehaviors.RegionBehaviorType.html#fromjson)
[fromSource](foundry.data.regionBehaviors.RegionBehaviorType.html#fromsource)
[migrateData](foundry.data.regionBehaviors.RegionBehaviorType.html#migratedata)
[migrateDataSafe](foundry.data.regionBehaviors.RegionBehaviorType.html#migratedatasafe)
[shimData](foundry.data.regionBehaviors.RegionBehaviorType.html#shimdata)
[validateJoint](foundry.data.regionBehaviors.RegionBehaviorType.html#validatejoint)
[\_createEventsField](foundry.data.regionBehaviors.RegionBehaviorType.html#_createeventsfield)
[\_initializationOrder](foundry.data.regionBehaviors.RegionBehaviorType.html#_initializationorder)

## Constructors

### constructor

* new RegionBehaviorType(data?: {}, options?: {}): [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.html)
  ...
  #### Returns [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.html)

  #### Inherit Doc

  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[constructor](foundry.abstract.TypeDataModel.html#constructor)
...
Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[\_source](foundry.abstract.TypeDataModel.html#_source)
...
Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[parent](foundry.abstract.TypeDataModel.html#parent)
...
Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[\_schema](foundry.abstract.TypeDataModel.html#_schema)

### `Static`events

events: Record<  
Â Â Â Â string,  
Â Â Â Â (this: [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.html), event: [RegionEvent](../interfaces/foundry.documents.types.RegionEvent.html)) => Promise<void>,  
> = {}
...
Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[LOCALIZATION\_PREFIXES](foundry.abstract.TypeDataModel.html#localization_prefixes)

## Accessors

### behavior

* get behavior(): null | [documents](../modules/foundry.documents.html).[RegionBehavior](foundry.documents.RegionBehavior.html)

  A convenience reference to the RegionBehavior which contains this behavior sub-type.

  #### Returns null | [documents](../modules/foundry.documents.html).[RegionBehavior](foundry.documents.RegionBehavior.html)
...
* \_preCreate(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[\_preCreate](foundry.abstract.TypeDataModel.html#_precreate)
...
* clone(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[clone](foundry.abstract.TypeDataModel.html#clone)
...
* prepareBaseData(): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[prepareBaseData](foundry.abstract.TypeDataModel.html#preparebasedata)
...
* prepareDerivedData(): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[prepareDerivedData](foundry.abstract.TypeDataModel.html#preparederiveddata)
...
* reset(): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[reset](foundry.abstract.TypeDataModel.html#reset)
...
* toEmbed(config: DocumentHTMLEmbedConfig, options?: any): Promise<any>
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[toEmbed](foundry.abstract.TypeDataModel.html#toembed)
...
* toJSON(): object
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[toJSON](foundry.abstract.TypeDataModel.html#tojson)
...
* toObject(source?: boolean): object
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[toObject](foundry.abstract.TypeDataModel.html#toobject)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.html)): object
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[updateSource](foundry.abstract.TypeDataModel.html#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.html)): boolean
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[validate](foundry.abstract.TypeDataModel.html#validate)
...
* \_configure(options?: object): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[\_configure](foundry.abstract.TypeDataModel.html#_configure)

### `Protected`\_getTerrainEffects

* \_getTerrainEffects<[TerrainEffect](foundry.data.regionBehaviors.RegionBehaviorType.html#_getterraineffectsterraineffect)>(  
  Â Â Â Â token: TokenDocument,  
  Â Â Â Â segment: Pick<  
  Â Â Â Â Â Â Â Â TokenMovementWaypoint,  
  Â Â Â Â Â Â Â Â "shape"  
  Â Â Â Â Â Â Â Â | "height"  
  Â Â Â Â Â Â Â Â | "width"  
  Â Â Â Â Â Â Â Â | "action",  
  Â Â Â Â > & { preview: boolean },  
  ): [TerrainEffect](foundry.data.regionBehaviors.RegionBehaviorType.html#_getterraineffectsterraineffect)[]
  ...
  ([CONFIG.Token.movement.TerrainData.resolveTerrainEffects](foundry.data.BaseTerrainData.html#resolveterraineffects)).
  ...
  #### Returns [TerrainEffect](foundry.data.regionBehaviors.RegionBehaviorType.html#_getterraineffectsterraineffect)[]
...
* \_initialize(options?: object): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[\_initialize](foundry.abstract.TypeDataModel.html#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[\_initializeSource](foundry.abstract.TypeDataModel.html#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[\_onCreate](foundry.abstract.TypeDataModel.html#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[\_onDelete](foundry.abstract.TypeDataModel.html#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[\_onUpdate](foundry.abstract.TypeDataModel.html#_onupdate)
...
* \_preDelete(options: object, user: BaseUser): Promise<boolean | void>
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[\_preDelete](foundry.abstract.TypeDataModel.html#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[\_preUpdate](foundry.abstract.TypeDataModel.html#_preupdate)
...
* cleanData(source?: object, options?: object): object
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[cleanData](foundry.abstract.TypeDataModel.html#cleandata)
...
* defineSchema(): [DataSchema](../types/foundry.abstract.types.DataSchema.html)
  ...
  [\_source](foundry.data.regionBehaviors.RegionBehaviorType.html#_source) values into direct properties of the data model. The schema is a static property of the model and
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[defineSchema](foundry.abstract.TypeDataModel.html#defineschema)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.html)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.html)>
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[fromJSON](foundry.abstract.TypeDataModel.html#fromjson)
...
* fromSource(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[fromSource](foundry.abstract.TypeDataModel.html#fromsource)
...
* migrateData(source: object): object
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[migrateData](foundry.abstract.TypeDataModel.html#migratedata)
...
* migrateDataSafe(source: object): object
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[migrateDataSafe](foundry.abstract.TypeDataModel.html#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[shimData](foundry.abstract.TypeDataModel.html#shimdata)
...
* validateJoint(data: object): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[validateJoint](foundry.abstract.TypeDataModel.html#validatejoint)

### `Protected` `Static`\_createEventsField

* \_createEventsField(  
  Â Â Â Â options?: { events?: string[]; initial?: string[] },  
  ): [SetField](foundry.data.fields.SetField.html)
  ...
  #### Returns [SetField](foundry.data.fields.SetField.html)
...
* \_initializationOrder(): Generator<[string, [DataField](foundry.data.fields.DataField.html)], any, any>
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.html).[\_initializationOrder](foundry.abstract.TypeDataModel.html#_initializationorder)