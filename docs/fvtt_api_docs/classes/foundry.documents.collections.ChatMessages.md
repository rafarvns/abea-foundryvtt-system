---
title: "ChatMessages | Foundry Virtual Tabletop - API Documentation - Version 13"
...
* [foundry.documents.ChatMessage](foundry.documents.ChatMessage.html): The ChatMessage document
* [foundry.applications.sidebar.tabs.ChatLog](foundry.applications.sidebar.tabs.ChatLog.html): The ChatLog sidebar directory

#### Hierarchy ([View Summary](../hierarchy.html#foundry.documents.collections.ChatMessages))
...
[constructor](foundry.documents.collections.ChatMessages.html#constructor)

### Properties

[apps](foundry.documents.collections.ChatMessages.html#apps)
[invalidDocumentIds](foundry.documents.collections.ChatMessages.html#invaliddocumentids)
[documentName](foundry.documents.collections.ChatMessages.html#documentname)

### Accessors

[contents](foundry.documents.collections.ChatMessages.html#contents)
[directory](foundry.documents.collections.ChatMessages.html#directory)
[documentClass](foundry.documents.collections.ChatMessages.html#documentclass)
[documentName](foundry.documents.collections.ChatMessages.html#documentname-1)
[folders](foundry.documents.collections.ChatMessages.html#folders)
[name](foundry.documents.collections.ChatMessages.html#name)
[instance](foundry.documents.collections.ChatMessages.html#instance)
[registeredSheets](foundry.documents.collections.ChatMessages.html#registeredsheets)

### Methods

[\_getVisibleTreeContents](foundry.documents.collections.ChatMessages.html#_getvisibletreecontents)
[\_onModifyContents](foundry.documents.collections.ChatMessages.html#_onmodifycontents)
[[iterator]](foundry.documents.collections.ChatMessages.html#iterator)
[createDocument](foundry.documents.collections.ChatMessages.html#createdocument)
[delete](foundry.documents.collections.ChatMessages.html#delete)
[export](foundry.documents.collections.ChatMessages.html#export)
[filter](foundry.documents.collections.ChatMessages.html#filter)
[find](foundry.documents.collections.ChatMessages.html#find)
[flush](foundry.documents.collections.ChatMessages.html#flush)
[forEach](foundry.documents.collections.ChatMessages.html#foreach)
[fromCompendium](foundry.documents.collections.ChatMessages.html#fromcompendium)
[get](foundry.documents.collections.ChatMessages.html#get)
[getInvalid](foundry.documents.collections.ChatMessages.html#getinvalid)
[getName](foundry.documents.collections.ChatMessages.html#getname)
[importFromCompendium](foundry.documents.collections.ChatMessages.html#importfromcompendium)
[map](foundry.documents.collections.ChatMessages.html#map)
[reduce](foundry.documents.collections.ChatMessages.html#reduce)
[render](foundry.documents.collections.ChatMessages.html#render)
[sayBubble](foundry.documents.collections.ChatMessages.html#saybubble)
[search](foundry.documents.collections.ChatMessages.html#search)
[set](foundry.documents.collections.ChatMessages.html#set)
[some](foundry.documents.collections.ChatMessages.html#some)
[toJSON](foundry.documents.collections.ChatMessages.html#tojson)
[updateAll](foundry.documents.collections.ChatMessages.html#updateall)
[\_initialize](foundry.documents.collections.ChatMessages.html#_initialize)
[getSearchableFields](foundry.documents.collections.ChatMessages.html#getsearchablefields)
[registerSheet](foundry.documents.collections.ChatMessages.html#registersheet)
[unregisterSheet](foundry.documents.collections.ChatMessages.html#unregistersheet)

## Constructors

### constructor

* new ChatMessages(data?: object[]): [ChatMessages](foundry.documents.collections.ChatMessages.html)
  ...
  #### Returns [ChatMessages](foundry.documents.collections.ChatMessages.html)
...
* get directory(): [ChatLog](foundry.applications.sidebar.tabs.ChatLog.html)
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)>,  
  Â Â Â Â ) => unknown,  
  ): undefined | [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)
  ...
  #### Returns undefined | [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)
...
* forEach(fn: (value: [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html),  
  ...
  + document: object | [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)
...
* getInvalid(  
  ...
  ): void | [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)
  ...
  #### Returns void | [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)
...
* map(  
  Â Â Â Â transformer: (  
  Â Â Â Â Â Â Â Â arg0: [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html),  
  ...
  + transformer: (arg0: [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html), arg1: number, arg2: [Collection](foundry.utils.Collection.html)) => any
...
* reduce(  
  ...
  Â Â Â Â Â Â Â Â arg1: [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html),  
  ...
  + reducer: (arg0: any, arg1: [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html), arg2: number, arg3: [Collection](foundry.utils.Collection.html)) => any
...
* sayBubble(message: [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)): void
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html)[]
...
* some(  
  ...
  + condition: (arg0: [documents](../modules/foundry.documents.html).[ChatMessage](foundry.documents.ChatMessage.html), arg1: number, arg2: [Collection](foundry.utils.Collection.html)) => boolean
