---
title: "SceneDirectory | Foundry Virtual Tabletop - API Documentation - Version 13"
...
* [SceneDirectory](foundry.applications.sidebar.tabs.SceneDirectory.html)

# Class SceneDirectory

The World Scene directory listing.

#### Hierarchy ([View Summary](../hierarchy.html#foundry.applications.sidebar.tabs.SceneDirectory))
...
[options](foundry.applications.sidebar.tabs.SceneDirectory.html#options)
[position](foundry.applications.sidebar.tabs.SceneDirectory.html#position)
[tabGroups](foundry.applications.sidebar.tabs.SceneDirectory.html#tabgroups)
[\_appId](foundry.applications.sidebar.tabs.SceneDirectory.html#_appid)
[\_entryPartial](foundry.applications.sidebar.tabs.SceneDirectory.html#_entrypartial)
[\_maxZ](foundry.applications.sidebar.tabs.SceneDirectory.html#_maxz)
[BASE\_APPLICATION](foundry.applications.sidebar.tabs.SceneDirectory.html#base_application)
[DEFAULT\_OPTIONS](foundry.applications.sidebar.tabs.SceneDirectory.html#default_options)
[emittedEvents](foundry.applications.sidebar.tabs.SceneDirectory.html#emittedevents)
[PARTS](foundry.applications.sidebar.tabs.SceneDirectory.html#parts)
[RENDER\_STATES](foundry.applications.sidebar.tabs.SceneDirectory.html#render_states)
[tabName](foundry.applications.sidebar.tabs.SceneDirectory.html#tabname)
[TABS](foundry.applications.sidebar.tabs.SceneDirectory.html#tabs)
[\_folderPartial](foundry.applications.sidebar.tabs.SceneDirectory.html#_folderpartial)

### Accessors

[active](foundry.applications.sidebar.tabs.SceneDirectory.html#active)
[classList](foundry.applications.sidebar.tabs.SceneDirectory.html#classlist)
[collection](foundry.applications.sidebar.tabs.SceneDirectory.html#collection)
[documentClass](foundry.applications.sidebar.tabs.SceneDirectory.html#documentclass)
[documentName](foundry.applications.sidebar.tabs.SceneDirectory.html#documentname)
[element](foundry.applications.sidebar.tabs.SceneDirectory.html#element)
[form](foundry.applications.sidebar.tabs.SceneDirectory.html#form)
[hasFrame](foundry.applications.sidebar.tabs.SceneDirectory.html#hasframe)
[id](foundry.applications.sidebar.tabs.SceneDirectory.html#id)
[isPopout](foundry.applications.sidebar.tabs.SceneDirectory.html#ispopout)
[minimized](foundry.applications.sidebar.tabs.SceneDirectory.html#minimized)
[popout](foundry.applications.sidebar.tabs.SceneDirectory.html#popout)
[rendered](foundry.applications.sidebar.tabs.SceneDirectory.html#rendered)
[state](foundry.applications.sidebar.tabs.SceneDirectory.html#state)
[tabName](foundry.applications.sidebar.tabs.SceneDirectory.html#tabname-1)
[title](foundry.applications.sidebar.tabs.SceneDirectory.html#title)
[window](foundry.applications.sidebar.tabs.SceneDirectory.html#window)

### Methods

[\_awaitTransition](foundry.applications.sidebar.tabs.SceneDirectory.html#_awaittransition)
[\_canRender](foundry.applications.sidebar.tabs.SceneDirectory.html#_canrender)
[\_configureRenderParts](foundry.applications.sidebar.tabs.SceneDirectory.html#_configurerenderparts)
[\_doEvent](foundry.applications.sidebar.tabs.SceneDirectory.html#_doevent)
[\_getEntryContextOptions](foundry.applications.sidebar.tabs.SceneDirectory.html#_getentrycontextoptions)
[\_getFolderContextOptions](foundry.applications.sidebar.tabs.SceneDirectory.html#_getfoldercontextoptions)
[\_initializeApplicationOptions](foundry.applications.sidebar.tabs.SceneDirectory.html#_initializeapplicationoptions)
[\_onClose](foundry.applications.sidebar.tabs.SceneDirectory.html#_onclose)
[\_onDragStart](foundry.applications.sidebar.tabs.SceneDirectory.html#_ondragstart)
[\_onDrop](foundry.applications.sidebar.tabs.SceneDirectory.html#_ondrop)
[\_onFirstRender](foundry.applications.sidebar.tabs.SceneDirectory.html#_onfirstrender)
[\_onRender](foundry.applications.sidebar.tabs.SceneDirectory.html#_onrender)
[\_prepareContext](foundry.applications.sidebar.tabs.SceneDirectory.html#_preparecontext)
[\_preparePartContext](foundry.applications.sidebar.tabs.SceneDirectory.html#_preparepartcontext)
[\_preSyncPartState](foundry.applications.sidebar.tabs.SceneDirectory.html#_presyncpartstate)
[\_renderFrame](foundry.applications.sidebar.tabs.SceneDirectory.html#_renderframe)
[\_renderHTML](foundry.applications.sidebar.tabs.SceneDirectory.html#_renderhtml)
[\_syncPartState](foundry.applications.sidebar.tabs.SceneDirectory.html#_syncpartstate)
[activate](foundry.applications.sidebar.tabs.SceneDirectory.html#activate)
[addEventListener](foundry.applications.sidebar.tabs.SceneDirectory.html#addeventlistener)
[bringToFront](foundry.applications.sidebar.tabs.SceneDirectory.html#bringtofront)
[changeTab](foundry.applications.sidebar.tabs.SceneDirectory.html#changetab)
[close](foundry.applications.sidebar.tabs.SceneDirectory.html#close)
[collapseAll](foundry.applications.sidebar.tabs.SceneDirectory.html#collapseall)
[dispatchEvent](foundry.applications.sidebar.tabs.SceneDirectory.html#dispatchevent)
[maximize](foundry.applications.sidebar.tabs.SceneDirectory.html#maximize)
[minimize](foundry.applications.sidebar.tabs.SceneDirectory.html#minimize)
[removeEventListener](foundry.applications.sidebar.tabs.SceneDirectory.html#removeeventlistener)
[render](foundry.applications.sidebar.tabs.SceneDirectory.html#render)
[renderPopout](foundry.applications.sidebar.tabs.SceneDirectory.html#renderpopout)
[setPosition](foundry.applications.sidebar.tabs.SceneDirectory.html#setposition)
[submit](foundry.applications.sidebar.tabs.SceneDirectory.html#submit)
[toggleControls](foundry.applications.sidebar.tabs.SceneDirectory.html#togglecontrols)
[\_attachFrameListeners](foundry.applications.sidebar.tabs.SceneDirectory.html#_attachframelisteners)
[\_canCreateEntry](foundry.applications.sidebar.tabs.SceneDirectory.html#_cancreateentry)
[\_canCreateFolder](foundry.applications.sidebar.tabs.SceneDirectory.html#_cancreatefolder)
[\_canDragDrop](foundry.applications.sidebar.tabs.SceneDirectory.html#_candragdrop)
[\_canDragStart](foundry.applications.sidebar.tabs.SceneDirectory.html#_candragstart)
[\_configureRenderOptions](foundry.applications.sidebar.tabs.SceneDirectory.html#_configurerenderoptions)
[\_createContextMenu](foundry.applications.sidebar.tabs.SceneDirectory.html#_createcontextmenu)
[\_createContextMenus](foundry.applications.sidebar.tabs.SceneDirectory.html#_createcontextmenus)
[\_createDroppedEntry](foundry.applications.sidebar.tabs.SceneDirectory.html#_createdroppedentry)
[\_createDroppedFolderContent](foundry.applications.sidebar.tabs.SceneDirectory.html#_createdroppedfoldercontent)
[\_createDroppedFolderDocuments](foundry.applications.sidebar.tabs.SceneDirectory.html#_createdroppedfolderdocuments)
[\_entryAlreadyExists](foundry.applications.sidebar.tabs.SceneDirectory.html#_entryalreadyexists)
[\_entryBelongsToFolder](foundry.applications.sidebar.tabs.SceneDirectory.html#_entrybelongstofolder)
[\_getDroppedEntryFromData](foundry.applications.sidebar.tabs.SceneDirectory.html#_getdroppedentryfromdata)
[\_getEntryDragData](foundry.applications.sidebar.tabs.SceneDirectory.html#_getentrydragdata)
[\_getFolderDragData](foundry.applications.sidebar.tabs.SceneDirectory.html#_getfolderdragdata)
[\_getHeaderControls](foundry.applications.sidebar.tabs.SceneDirectory.html#_getheadercontrols)
[\_getTabsConfig](foundry.applications.sidebar.tabs.SceneDirectory.html#_gettabsconfig)
[\_handleDroppedEntry](foundry.applications.sidebar.tabs.SceneDirectory.html#_handledroppedentry)
[\_handleDroppedFolder](foundry.applications.sidebar.tabs.SceneDirectory.html#_handledroppedfolder)
[\_handleDroppedForeignFolder](foundry.applications.sidebar.tabs.SceneDirectory.html#_handledroppedforeignfolder)
[\_headerControlButtons](foundry.applications.sidebar.tabs.SceneDirectory.html#_headercontrolbuttons)
[\_insertElement](foundry.applications.sidebar.tabs.SceneDirectory.html#_insertelement)
[\_matchSearchEntries](foundry.applications.sidebar.tabs.SceneDirectory.html#_matchsearchentries)
[\_matchSearchFolders](foundry.applications.sidebar.tabs.SceneDirectory.html#_matchsearchfolders)
[\_onActivate](foundry.applications.sidebar.tabs.SceneDirectory.html#_onactivate)
[\_onChangeForm](foundry.applications.sidebar.tabs.SceneDirectory.html#_onchangeform)
[\_onClickAction](foundry.applications.sidebar.tabs.SceneDirectory.html#_onclickaction)
[\_onClickEntry](foundry.applications.sidebar.tabs.SceneDirectory.html#_onclickentry)
[\_onClickTab](foundry.applications.sidebar.tabs.SceneDirectory.html#_onclicktab)
[\_onCreateEntry](foundry.applications.sidebar.tabs.SceneDirectory.html#_oncreateentry)
[\_onCreateFolder](foundry.applications.sidebar.tabs.SceneDirectory.html#_oncreatefolder)
[\_onDeactivate](foundry.applications.sidebar.tabs.SceneDirectory.html#_ondeactivate)
[\_onDragHighlight](foundry.applications.sidebar.tabs.SceneDirectory.html#_ondraghighlight)
[\_onDragOver](foundry.applications.sidebar.tabs.SceneDirectory.html#_ondragover)
[\_onMatchSearchEntry](foundry.applications.sidebar.tabs.SceneDirectory.html#_onmatchsearchentry)
[\_onPosition](foundry.applications.sidebar.tabs.SceneDirectory.html#_onposition)
[\_onSearchFilter](foundry.applications.sidebar.tabs.SceneDirectory.html#_onsearchfilter)
[\_onSubmitForm](foundry.applications.sidebar.tabs.SceneDirectory.html#_onsubmitform)
[\_onToggleFolder](foundry.applications.sidebar.tabs.SceneDirectory.html#_ontogglefolder)
[\_organizeDroppedFoldersAndDocuments](foundry.applications.sidebar.tabs.SceneDirectory.html#_organizedroppedfoldersanddocuments)
[\_postRender](foundry.applications.sidebar.tabs.SceneDirectory.html#_postrender)
[\_preClose](foundry.applications.sidebar.tabs.SceneDirectory.html#_preclose)
[\_preFirstRender](foundry.applications.sidebar.tabs.SceneDirectory.html#_prefirstrender)
[\_prepareDirectoryContext](foundry.applications.sidebar.tabs.SceneDirectory.html#_preparedirectorycontext)
[\_prepareDuplicateData](foundry.applications.sidebar.tabs.SceneDirectory.html#_prepareduplicatedata)
[\_prepareFooterContext](foundry.applications.sidebar.tabs.SceneDirectory.html#_preparefootercontext)
[\_prepareHeaderContext](foundry.applications.sidebar.tabs.SceneDirectory.html#_prepareheadercontext)
[\_prepareTabs](foundry.applications.sidebar.tabs.SceneDirectory.html#_preparetabs)
[\_prePosition](foundry.applications.sidebar.tabs.SceneDirectory.html#_preposition)
[\_preRender](foundry.applications.sidebar.tabs.SceneDirectory.html#_prerender)
[\_removeElement](foundry.applications.sidebar.tabs.SceneDirectory.html#_removeelement)
[\_renderHeaderControl](foundry.applications.sidebar.tabs.SceneDirectory.html#_renderheadercontrol)
[\_replaceHTML](foundry.applications.sidebar.tabs.SceneDirectory.html#_replacehtml)
[\_tearDown](foundry.applications.sidebar.tabs.SceneDirectory.html#_teardown)
[\_updateFrame](foundry.applications.sidebar.tabs.SceneDirectory.html#_updateframe)
[\_updatePosition](foundry.applications.sidebar.tabs.SceneDirectory.html#_updateposition)
[\_getFolderContextOptions](foundry.applications.sidebar.tabs.SceneDirectory.html#_getfoldercontextoptions-2)
[\_handleDroppedFolder](foundry.applications.sidebar.tabs.SceneDirectory.html#_handledroppedfolder-2)
[inheritanceChain](foundry.applications.sidebar.tabs.SceneDirectory.html#inheritancechain)
[parseCSSDimension](foundry.applications.sidebar.tabs.SceneDirectory.html#parsecssdimension)
[waitForImages](foundry.applications.sidebar.tabs.SceneDirectory.html#waitforimages)
...
\_entryPartial: string = "templates/sidebar/partials/scene-partial.hbs"
...
DEFAULT\_OPTIONS: { collection: string; renderUpdateKeys: string[] } = ...
...
* \_getEntryContextOptions(): (  
  Â Â Â Â | {  
  Â Â Â Â Â Â Â Â callback: (li: any) => any;  
  Â Â Â Â Â Â Â Â condition?: undefined;  
  Â Â Â Â Â Â Â Â icon: string;  
  Â Â Â Â Â Â Â Â name: string;  
  Â Â Â Â }  
  Â Â Â Â | {  
  Â Â Â Â Â Â Â Â callback: (li: any) => void;  
  Â Â Â Â Â Â Â Â condition: (li: any) => any;  
  Â Â Â Â Â Â Â Â icon: string;  
  Â Â Â Â Â Â Â Â name: string;  
  Â Â Â Â }  
  )[]

  #### Returns ( Â Â Â Â | { Â Â Â Â Â Â Â Â callback: (li: any) => any; Â Â Â Â Â Â Â Â condition?: undefined; Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â name: string; Â Â Â Â } Â Â Â Â | { Â Â Â Â Â Â Â Â callback: (li: any) => void; Â Â Â Â Â Â Â Â condition: (li: any) => any; Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â name: string; Â Â Â Â } )[]
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.html)>): Promise<[SceneDirectory](foundry.applications.sidebar.tabs.SceneDirectory.html)>
  ...
  #### Returns Promise<[SceneDirectory](foundry.applications.sidebar.tabs.SceneDirectory.html)>
...
* render(options: any, \_options: any): Promise<[SceneDirectory](foundry.applications.sidebar.tabs.SceneDirectory.html)>
...
* \_createDroppedEntry(  
  ...
  ): Promise<[documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)>
...
* \_createDroppedFolderDocuments(  
  Â Â Â Â folder: [documents](../modules/foundry.documents.html).[Folder](foundry.documents.Folder.html),  
  Â Â Â Â documents: object[] | [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)[],  
  ): Promise<void>
  ...
  + folder: [documents](../modules/foundry.documents.html).[Folder](foundry.documents.Folder.html)
    ...
    The dropped folder.
  + documents: object[] | [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)[]
...
* \_organizeDroppedFoldersAndDocuments(  
  ...
  Â Â Â Â Â Â Â Â | [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)[];  
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â documentsToCreate: object[] Â Â Â Â Â Â Â Â | [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)[]; Â Â Â Â Â Â Â Â foldersToCreate: [documents](../modules/foundry.documents.html).[Folder](foundry.documents.Folder.html)[]; Â Â Â Â }, >
