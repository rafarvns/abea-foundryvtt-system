---
title: "Playlists | Foundry Virtual Tabletop - API Documentation - Version 13"
...
* [foundry.documents.Playlist](foundry.documents.Playlist.html): The Playlist document
* [foundry.applications.sidebar.tabs.PlaylistDirectory](foundry.applications.sidebar.tabs.PlaylistDirectory.html): The PlaylistDirectory sidebar
  directory

#### Hierarchy ([View Summary](../hierarchy.html#foundry.documents.collections.Playlists))
...
[constructor](foundry.documents.collections.Playlists.html#constructor)

### Properties

[apps](foundry.documents.collections.Playlists.html#apps)
[invalidDocumentIds](foundry.documents.collections.Playlists.html#invaliddocumentids)
[documentName](foundry.documents.collections.Playlists.html#documentname)

### Accessors

[contents](foundry.documents.collections.Playlists.html#contents)
[directory](foundry.documents.collections.Playlists.html#directory)
[documentClass](foundry.documents.collections.Playlists.html#documentclass)
[documentName](foundry.documents.collections.Playlists.html#documentname-1)
[folders](foundry.documents.collections.Playlists.html#folders)
[name](foundry.documents.collections.Playlists.html#name)
[playing](foundry.documents.collections.Playlists.html#playing)
[instance](foundry.documents.collections.Playlists.html#instance)
[registeredSheets](foundry.documents.collections.Playlists.html#registeredsheets)

### Methods

[\_getVisibleTreeContents](foundry.documents.collections.Playlists.html#_getvisibletreecontents)
[\_onChangeScene](foundry.documents.collections.Playlists.html#_onchangescene)
[\_onModifyContents](foundry.documents.collections.Playlists.html#_onmodifycontents)
[[iterator]](foundry.documents.collections.Playlists.html#iterator)
[createDocument](foundry.documents.collections.Playlists.html#createdocument)
[delete](foundry.documents.collections.Playlists.html#delete)
[filter](foundry.documents.collections.Playlists.html#filter)
[find](foundry.documents.collections.Playlists.html#find)
[forEach](foundry.documents.collections.Playlists.html#foreach)
[fromCompendium](foundry.documents.collections.Playlists.html#fromcompendium)
[get](foundry.documents.collections.Playlists.html#get)
[getInvalid](foundry.documents.collections.Playlists.html#getinvalid)
[getName](foundry.documents.collections.Playlists.html#getname)
[importFromCompendium](foundry.documents.collections.Playlists.html#importfromcompendium)
[initialize](foundry.documents.collections.Playlists.html#initialize)
[map](foundry.documents.collections.Playlists.html#map)
[reduce](foundry.documents.collections.Playlists.html#reduce)
[render](foundry.documents.collections.Playlists.html#render)
[search](foundry.documents.collections.Playlists.html#search)
[set](foundry.documents.collections.Playlists.html#set)
[some](foundry.documents.collections.Playlists.html#some)
[toJSON](foundry.documents.collections.Playlists.html#tojson)
[updateAll](foundry.documents.collections.Playlists.html#updateall)
[\_initialize](foundry.documents.collections.Playlists.html#_initialize)
[getSearchableFields](foundry.documents.collections.Playlists.html#getsearchablefields)
[registerSheet](foundry.documents.collections.Playlists.html#registersheet)
[unregisterSheet](foundry.documents.collections.Playlists.html#unregistersheet)

## Constructors

### constructor

* new Playlists(data?: object[]): [Playlists](foundry.documents.collections.Playlists.html)
  ...
  #### Returns [Playlists](foundry.documents.collections.Playlists.html)
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)[]
...
* \_onChangeScene(  
  Â Â Â Â scene: null | [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html),  
  Â Â Â Â priorScene: null | [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html),  
  ): Promise<void>
  ...
  + scene: null | [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)

    The new active Scene
  + priorScene: null | [documents](../modules/foundry.documents.html).[Scene](foundry.documents.Scene.html)
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.html)<string, [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)>,  
  Â Â Â Â ) => unknown,  
  ): undefined | [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)
  ...
  #### Returns undefined | [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)
...
* forEach(fn: (value: [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html),  
  ...
  + document: object | [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)
...
* getInvalid(  
  ...
  ): void | [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)
  ...
  #### Returns void | [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)
...
* map(  
  Â Â Â Â transformer: (  
  Â Â Â Â Â Â Â Â arg0: [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html),  
  ...
  + transformer: (arg0: [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html), arg1: number, arg2: [Collection](foundry.utils.Collection.html)) => any
...
* reduce(  
  ...
  Â Â Â Â Â Â Â Â arg1: [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html),  
  ...
  + reducer: (arg0: any, arg1: [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html), arg2: number, arg3: [Collection](foundry.utils.Collection.html)) => any
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html)[]
...
* some(  
  ...
  + condition: (arg0: [documents](../modules/foundry.documents.html).[Playlist](foundry.documents.Playlist.html), arg1: number, arg2: [Collection](foundry.utils.Collection.html)) => boolean
