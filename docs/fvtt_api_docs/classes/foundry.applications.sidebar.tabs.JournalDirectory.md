---
title: "JournalDirectory | Foundry Virtual Tabletop - API Documentation - Version 13"
...
* [JournalDirectory](foundry.applications.sidebar.tabs.JournalDirectory.html)

# Class JournalDirectory

The World Journal.

#### Hierarchy ([View Summary](../hierarchy.html#foundry.applications.sidebar.tabs.JournalDirectory))
...
[options](foundry.applications.sidebar.tabs.JournalDirectory.html#options)
[position](foundry.applications.sidebar.tabs.JournalDirectory.html#position)
[tabGroups](foundry.applications.sidebar.tabs.JournalDirectory.html#tabgroups)
[\_appId](foundry.applications.sidebar.tabs.JournalDirectory.html#_appid)
[\_maxZ](foundry.applications.sidebar.tabs.JournalDirectory.html#_maxz)
[BASE\_APPLICATION](foundry.applications.sidebar.tabs.JournalDirectory.html#base_application)
[DEFAULT\_OPTIONS](foundry.applications.sidebar.tabs.JournalDirectory.html#default_options)
[emittedEvents](foundry.applications.sidebar.tabs.JournalDirectory.html#emittedevents)
[PARTS](foundry.applications.sidebar.tabs.JournalDirectory.html#parts)
[RENDER\_STATES](foundry.applications.sidebar.tabs.JournalDirectory.html#render_states)
[tabName](foundry.applications.sidebar.tabs.JournalDirectory.html#tabname)
[TABS](foundry.applications.sidebar.tabs.JournalDirectory.html#tabs)
[\_entryPartial](foundry.applications.sidebar.tabs.JournalDirectory.html#_entrypartial)
[\_folderPartial](foundry.applications.sidebar.tabs.JournalDirectory.html#_folderpartial)

### Accessors

[active](foundry.applications.sidebar.tabs.JournalDirectory.html#active)
[classList](foundry.applications.sidebar.tabs.JournalDirectory.html#classlist)
[collection](foundry.applications.sidebar.tabs.JournalDirectory.html#collection)
[documentClass](foundry.applications.sidebar.tabs.JournalDirectory.html#documentclass)
[documentName](foundry.applications.sidebar.tabs.JournalDirectory.html#documentname)
[element](foundry.applications.sidebar.tabs.JournalDirectory.html#element)
[form](foundry.applications.sidebar.tabs.JournalDirectory.html#form)
[hasFrame](foundry.applications.sidebar.tabs.JournalDirectory.html#hasframe)
[id](foundry.applications.sidebar.tabs.JournalDirectory.html#id)
[isPopout](foundry.applications.sidebar.tabs.JournalDirectory.html#ispopout)
[minimized](foundry.applications.sidebar.tabs.JournalDirectory.html#minimized)
[popout](foundry.applications.sidebar.tabs.JournalDirectory.html#popout)
[rendered](foundry.applications.sidebar.tabs.JournalDirectory.html#rendered)
[state](foundry.applications.sidebar.tabs.JournalDirectory.html#state)
[tabName](foundry.applications.sidebar.tabs.JournalDirectory.html#tabname-1)
[title](foundry.applications.sidebar.tabs.JournalDirectory.html#title)
[window](foundry.applications.sidebar.tabs.JournalDirectory.html#window)

### Methods

[\_awaitTransition](foundry.applications.sidebar.tabs.JournalDirectory.html#_awaittransition)
[\_canRender](foundry.applications.sidebar.tabs.JournalDirectory.html#_canrender)
[\_configureRenderParts](foundry.applications.sidebar.tabs.JournalDirectory.html#_configurerenderparts)
[\_doEvent](foundry.applications.sidebar.tabs.JournalDirectory.html#_doevent)
[\_getEntryContextOptions](foundry.applications.sidebar.tabs.JournalDirectory.html#_getentrycontextoptions)
[\_initializeApplicationOptions](foundry.applications.sidebar.tabs.JournalDirectory.html#_initializeapplicationoptions)
[\_onClose](foundry.applications.sidebar.tabs.JournalDirectory.html#_onclose)
[\_onDragStart](foundry.applications.sidebar.tabs.JournalDirectory.html#_ondragstart)
[\_onDrop](foundry.applications.sidebar.tabs.JournalDirectory.html#_ondrop)
[\_onFirstRender](foundry.applications.sidebar.tabs.JournalDirectory.html#_onfirstrender)
[\_onRender](foundry.applications.sidebar.tabs.JournalDirectory.html#_onrender)
[\_prepareContext](foundry.applications.sidebar.tabs.JournalDirectory.html#_preparecontext)
[\_preparePartContext](foundry.applications.sidebar.tabs.JournalDirectory.html#_preparepartcontext)
[\_preSyncPartState](foundry.applications.sidebar.tabs.JournalDirectory.html#_presyncpartstate)
[\_renderFrame](foundry.applications.sidebar.tabs.JournalDirectory.html#_renderframe)
[\_renderHTML](foundry.applications.sidebar.tabs.JournalDirectory.html#_renderhtml)
[\_syncPartState](foundry.applications.sidebar.tabs.JournalDirectory.html#_syncpartstate)
[activate](foundry.applications.sidebar.tabs.JournalDirectory.html#activate)
[addEventListener](foundry.applications.sidebar.tabs.JournalDirectory.html#addeventlistener)
[bringToFront](foundry.applications.sidebar.tabs.JournalDirectory.html#bringtofront)
[changeTab](foundry.applications.sidebar.tabs.JournalDirectory.html#changetab)
[close](foundry.applications.sidebar.tabs.JournalDirectory.html#close)
[collapseAll](foundry.applications.sidebar.tabs.JournalDirectory.html#collapseall)
[dispatchEvent](foundry.applications.sidebar.tabs.JournalDirectory.html#dispatchevent)
[maximize](foundry.applications.sidebar.tabs.JournalDirectory.html#maximize)
[minimize](foundry.applications.sidebar.tabs.JournalDirectory.html#minimize)
[removeEventListener](foundry.applications.sidebar.tabs.JournalDirectory.html#removeeventlistener)
[render](foundry.applications.sidebar.tabs.JournalDirectory.html#render)
[renderPopout](foundry.applications.sidebar.tabs.JournalDirectory.html#renderpopout)
[setPosition](foundry.applications.sidebar.tabs.JournalDirectory.html#setposition)
[submit](foundry.applications.sidebar.tabs.JournalDirectory.html#submit)
[toggleControls](foundry.applications.sidebar.tabs.JournalDirectory.html#togglecontrols)
[\_attachFrameListeners](foundry.applications.sidebar.tabs.JournalDirectory.html#_attachframelisteners)
[\_canCreateEntry](foundry.applications.sidebar.tabs.JournalDirectory.html#_cancreateentry)
[\_canCreateFolder](foundry.applications.sidebar.tabs.JournalDirectory.html#_cancreatefolder)
[\_canDragDrop](foundry.applications.sidebar.tabs.JournalDirectory.html#_candragdrop)
[\_canDragStart](foundry.applications.sidebar.tabs.JournalDirectory.html#_candragstart)
[\_configureRenderOptions](foundry.applications.sidebar.tabs.JournalDirectory.html#_configurerenderoptions)
[\_createContextMenu](foundry.applications.sidebar.tabs.JournalDirectory.html#_createcontextmenu)
[\_createContextMenus](foundry.applications.sidebar.tabs.JournalDirectory.html#_createcontextmenus)
[\_createDroppedEntry](foundry.applications.sidebar.tabs.JournalDirectory.html#_createdroppedentry)
[\_createDroppedFolderContent](foundry.applications.sidebar.tabs.JournalDirectory.html#_createdroppedfoldercontent)
[\_createDroppedFolderDocuments](foundry.applications.sidebar.tabs.JournalDirectory.html#_createdroppedfolderdocuments)
[\_entryAlreadyExists](foundry.applications.sidebar.tabs.JournalDirectory.html#_entryalreadyexists)
[\_entryBelongsToFolder](foundry.applications.sidebar.tabs.JournalDirectory.html#_entrybelongstofolder)
[\_getDroppedEntryFromData](foundry.applications.sidebar.tabs.JournalDirectory.html#_getdroppedentryfromdata)
[\_getEntryDragData](foundry.applications.sidebar.tabs.JournalDirectory.html#_getentrydragdata)
[\_getFolderContextOptions](foundry.applications.sidebar.tabs.JournalDirectory.html#_getfoldercontextoptions)
[\_getFolderDragData](foundry.applications.sidebar.tabs.JournalDirectory.html#_getfolderdragdata)
[\_getHeaderControls](foundry.applications.sidebar.tabs.JournalDirectory.html#_getheadercontrols)
[\_getTabsConfig](foundry.applications.sidebar.tabs.JournalDirectory.html#_gettabsconfig)
[\_handleDroppedEntry](foundry.applications.sidebar.tabs.JournalDirectory.html#_handledroppedentry)
[\_handleDroppedFolder](foundry.applications.sidebar.tabs.JournalDirectory.html#_handledroppedfolder)
[\_handleDroppedForeignFolder](foundry.applications.sidebar.tabs.JournalDirectory.html#_handledroppedforeignfolder)
[\_headerControlButtons](foundry.applications.sidebar.tabs.JournalDirectory.html#_headercontrolbuttons)
[\_insertElement](foundry.applications.sidebar.tabs.JournalDirectory.html#_insertelement)
[\_matchSearchEntries](foundry.applications.sidebar.tabs.JournalDirectory.html#_matchsearchentries)
[\_matchSearchFolders](foundry.applications.sidebar.tabs.JournalDirectory.html#_matchsearchfolders)
[\_onActivate](foundry.applications.sidebar.tabs.JournalDirectory.html#_onactivate)
[\_onChangeForm](foundry.applications.sidebar.tabs.JournalDirectory.html#_onchangeform)
[\_onClickAction](foundry.applications.sidebar.tabs.JournalDirectory.html#_onclickaction)
[\_onClickEntry](foundry.applications.sidebar.tabs.JournalDirectory.html#_onclickentry)
[\_onClickTab](foundry.applications.sidebar.tabs.JournalDirectory.html#_onclicktab)
[\_onCreateEntry](foundry.applications.sidebar.tabs.JournalDirectory.html#_oncreateentry)
[\_onCreateFolder](foundry.applications.sidebar.tabs.JournalDirectory.html#_oncreatefolder)
[\_onDeactivate](foundry.applications.sidebar.tabs.JournalDirectory.html#_ondeactivate)
[\_onDragHighlight](foundry.applications.sidebar.tabs.JournalDirectory.html#_ondraghighlight)
[\_onDragOver](foundry.applications.sidebar.tabs.JournalDirectory.html#_ondragover)
[\_onMatchSearchEntry](foundry.applications.sidebar.tabs.JournalDirectory.html#_onmatchsearchentry)
[\_onPosition](foundry.applications.sidebar.tabs.JournalDirectory.html#_onposition)
[\_onSearchFilter](foundry.applications.sidebar.tabs.JournalDirectory.html#_onsearchfilter)
[\_onSubmitForm](foundry.applications.sidebar.tabs.JournalDirectory.html#_onsubmitform)
[\_onToggleFolder](foundry.applications.sidebar.tabs.JournalDirectory.html#_ontogglefolder)
[\_organizeDroppedFoldersAndDocuments](foundry.applications.sidebar.tabs.JournalDirectory.html#_organizedroppedfoldersanddocuments)
[\_postRender](foundry.applications.sidebar.tabs.JournalDirectory.html#_postrender)
[\_preClose](foundry.applications.sidebar.tabs.JournalDirectory.html#_preclose)
[\_preFirstRender](foundry.applications.sidebar.tabs.JournalDirectory.html#_prefirstrender)
[\_prepareDirectoryContext](foundry.applications.sidebar.tabs.JournalDirectory.html#_preparedirectorycontext)
[\_prepareDuplicateData](foundry.applications.sidebar.tabs.JournalDirectory.html#_prepareduplicatedata)
[\_prepareFooterContext](foundry.applications.sidebar.tabs.JournalDirectory.html#_preparefootercontext)
[\_prepareHeaderContext](foundry.applications.sidebar.tabs.JournalDirectory.html#_prepareheadercontext)
[\_prepareTabs](foundry.applications.sidebar.tabs.JournalDirectory.html#_preparetabs)
[\_prePosition](foundry.applications.sidebar.tabs.JournalDirectory.html#_preposition)
[\_preRender](foundry.applications.sidebar.tabs.JournalDirectory.html#_prerender)
[\_removeElement](foundry.applications.sidebar.tabs.JournalDirectory.html#_removeelement)
[\_renderHeaderControl](foundry.applications.sidebar.tabs.JournalDirectory.html#_renderheadercontrol)
[\_replaceHTML](foundry.applications.sidebar.tabs.JournalDirectory.html#_replacehtml)
[\_tearDown](foundry.applications.sidebar.tabs.JournalDirectory.html#_teardown)
[\_updateFrame](foundry.applications.sidebar.tabs.JournalDirectory.html#_updateframe)
[\_updatePosition](foundry.applications.sidebar.tabs.JournalDirectory.html#_updateposition)
[\_getFolderContextOptions](foundry.applications.sidebar.tabs.JournalDirectory.html#_getfoldercontextoptions-2)
[\_handleDroppedFolder](foundry.applications.sidebar.tabs.JournalDirectory.html#_handledroppedfolder-2)
[inheritanceChain](foundry.applications.sidebar.tabs.JournalDirectory.html#inheritancechain)
[parseCSSDimension](foundry.applications.sidebar.tabs.JournalDirectory.html#parsecssdimension)
[waitForImages](foundry.applications.sidebar.tabs.JournalDirectory.html#waitforimages)
...
* \_getEntryContextOptions(): (  
  ...
  Â Â Â Â Â Â Â Â condition: (li: any) => boolean;  
  Â Â Â Â Â Â Â Â icon: string;  
  Â Â Â Â Â Â Â Â name: string;  
  Â Â Â Â }  
  )[]

  #### Returns ( Â Â Â Â | [ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.html) Â Â Â Â | { Â Â Â Â Â Â Â Â callback: (li: any) => any; Â Â Â Â Â Â Â Â condition: (li: any) => boolean; Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â name: string; Â Â Â Â } )[]
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.html)>): Promise<[JournalDirectory](foundry.applications.sidebar.tabs.JournalDirectory.html)>
  ...
  #### Returns Promise<[JournalDirectory](foundry.applications.sidebar.tabs.JournalDirectory.html)>
...
* render(options: any, \_options: any): Promise<[JournalDirectory](foundry.applications.sidebar.tabs.JournalDirectory.html)>
...
* \_createDroppedFolderDocuments(  
  Â Â Â Â folder: [documents](../modules/foundry.documents.html).[Folder](foundry.documents.Folder.html),  
  Â Â Â Â documents: object[] | [documents](../modules/foundry.documents.html).[JournalEntry](foundry.documents.JournalEntry.html)[],  
  ): Promise<void>
  ...
  + folder: [documents](../modules/foundry.documents.html).[Folder](foundry.documents.Folder.html)
    ...
    The dropped folder.
  + documents: object[] | [documents](../modules/foundry.documents.html).[JournalEntry](foundry.documents.JournalEntry.html)[]
...
* \_organizeDroppedFoldersAndDocuments(  
  ...
  Â Â Â Â Â Â Â Â | [documents](../modules/foundry.documents.html).[JournalEntry](foundry.documents.JournalEntry.html)[];  
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â documentsToCreate: object[] Â Â Â Â Â Â Â Â | [documents](../modules/foundry.documents.html).[JournalEntry](foundry.documents.JournalEntry.html)[]; Â Â Â Â Â Â Â Â foldersToCreate: [documents](../modules/foundry.documents.html).[Folder](foundry.documents.Folder.html)[]; Â Â Â Â }, >
