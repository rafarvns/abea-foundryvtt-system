...
url: "https://foundryvtt.com/article/faq/"
...
##### Updated March 18, 2026 (Version 13.351)
...
How do I use Foundry Virtual Tabletop?
...
If you prefer cloud-based hosting, several excellent [official hosting partners](https://foundryvtt.com/article/partnerships/ ) are available as well.
...
Is Foundry VTT a map-making software?
...
* **Pre-made Maps**
  ...
  There are many excellent maps and entire pre-made adventures available from talented creators, including many which [come free with Foundry](https://foundryvtt.com/packages/exclusive).
* **Integration with dedicated map-making software**

  You can also use excellent dedicated third party map-making software such as [DungeonDraft](https://dungeondraft.net/) and [Dungeon Alchemist](https://www.dungeonalchemist.com/). The output of these programs can then be imported directly into Foundry.
* **Image editing software**

  Using powerful image editing software such as [Clip Studio Paint](https://www.clipstudio.net/en/) or [Adobe Photoshop](https://www.adobe.com/products/photoshop.html) is a great option, particularly in combination with excellent (and often free!) libraries of map-making assets such as those created by [Forgotten Adventures](https://www.forgotten-adventures.net/). An excellent guide on how to use Clip Studio Paint with these assets is available [here](https://www.youtube.com/watch?v=JnDT3a4ydvs).

Why was Foundry Virtual Tabletop created?

Foundry VTT began as the passion project of a single person, Andrew Clayton (Atropos). As he ventured more into the world of virtual tabletop roleplaying, he became frustrated with the limitations of the existing virtual tabletop options and became increasingly certain that virtual roleplaying could be better in every way. Driven by his belief in the power of digital tools and that the virtual tabletop experience could be so much more than it was, he set to work building a new virtual tabletop from the ground up using modern web technology.

When did Foundry Virtual Tabletop release? What is the history of the company?

Atropos began Foundry development as early as August 2018. Early support and momentum quickly gathered around the project through a wonderful and vibrant [Patreon](https://www.patreon.com/foundryvtt/posts) community that grew and rallied behind it, culminating in Foundry Virtual Tabletop marking its official release on **Friday May 22, 2020**.

Since then, Foundry VTT has continued to grow, growing from the side project of a single individual into a small company. Over the following years, Foundry has regularly released improved versions of the software and forged official partnerships with industry giants including [Paizo in April 2022](https://paizo.com/community/blog/v5748dyo6si0e?Paizo-And-Foundry-Virtual-Tabletop-Content#:~:text=Paizo%20is%20proud%20to%20announce,content%20to%20Foundry%20Virtual%20Tabletop.) and [Wizards of the Coast in January of 2024](https://foundryvtt.com/article/dungeons-dragons-arrives/).
...
Foundry VTT categorizes releases according to different phases of development. Some versions are marked as Stable and are recommended for public use. Other versions more experimental and are intended to introduce and test new features or gather user feedback. These releases are marked as Prototype, Development, or Testing releases. For more information, please see our [Versioning and Releases](/article/versioning/ "Versioning and Releases") article.

A full listing of all of our historical and available releases can be found in the [Releases](/releases/ "Foundry VTT Release Notes") page.
...
Foundry Gaming LLC is a limited liability corporation registered in the State of Washington and is [required to collect sales tax](https://apps.leg.wa.gov/WAC/default.aspx?cite=458-20-15502 "Washington State Sales Tax Rules") on software sold to customers in the State of Washington or in other US states where the number of Foundry Virtual Tabletop license sales exceed a minimum threshold to require sales tax collection. We also collect sales tax (VAT) in the European Union, the United Kingdom, Norway, and Australia. If you believe you are being charged an incorrect amount of sales tax please reach out to [support@foundryvtt.com](mailto:support@foundryvtt.com) with your concerns.

How do I buy Foundry Virtual Tabletop?

To purchase the software, follow these steps:

1. [Register a user account](/auth/register) on this website. You can (optionally) link your account with Patreon at the time of registration.
2. Go to the [Purchase page](/purchase). Foundry Virtual Tabletop individual licenses cost $50 (plus tax). If you have access to a Discount Code (typically for being a [Patreon supporter of Foundry](https://www.patreon.com/foundryvtt)), you should apply it before purchasing. More details on that below.
3. Agree to the terms and conditions and provide your payment information. Payment is handled by Stripe which is a trusted platform for secure online payments. They accept all manner of credit and bank cards including most foreign cards. Depending on your region, some other payment methods such as Apple Pay or Ali Pay may be available. Unfortunately some payment methods (most notably Paypal) are not supported at this time.
...
1. The person who you are gifting Foundry VTT must register an account on our website.
2. Then, as the purchaser, follow the steps in the question above to purchase Foundry VTT as if you are buying it for yourself.
3. Once your purchase is successful, use the [License Transfer](/purchase/transfer) form to submit a license transfer request and have it processed automatically.
...
If you need to request a refund for your Foundry Virtual Tabletop purchase, you can find details of your purchased licenses and submit a refund request on the [Purchased Licenses](/me/licenses "Purchased Licenses") page of your user profile.
...
What is the refund policy for premium digital content purchased from Foundry Virtual Tabletop?

Premium digital content purchases can be refunded within 30 days of purchase if it has not been installed. Please review our [Terms & Conditions](https://foundryvtt.com/article/store-terms-conditions/) for full details.

How do I activate and install premium purchased content?

[Premium Content](https://foundryvtt.com/packages/premium "Foundry Virtual Tabletop Premium Content") will come with an accompanying content activation key. Using this key, go to your User Profile on the Foundry Virtual Tabletop website by logging in and clicking your name in the top-right corner. On your user profile, click the **Premium Content** button to go to the content management and activation page. On this page you can enter your purchased content key in the form at the top of the page. Content that you have successfully activated will be displayed below.
...
For information and general guidance about hardware requirements for Foundry Virtual Tabletop including both minimum requirements and recommendations, please see [Minimum Requirements](/article/requirements/ "Minimum Requirements"). Note that hardware requirements are approximately the same for both players and for the server host.
...
## Game System and Add-on Module Questions

I have created a Module or System that I would like to share. How can I have it added to this list?

The on-boarding process for Modules and Systems requires a manual review and approval. If you are interested in having your work featured in our official package listings please submit the [Package Submission Form](/packages/submit "Package Submission Form").

I am creating a Module or System and I want to use AI to generate art, code, text, or to assist in the process in some other way. Is this allowed?

We have an [AI Content Policy](/article/ai-policy) which governs the permitted use of generative AI on Foundry Virtual Tabletop. There are allowances in that policy for use of AI for generation of improvised content, assistance with writing code, and other supporting tasks. User-facing prepared content may not be generated using AI. Please refer to the full policy for details.

What Is the "Zero AI" tag, and how can I get it added to my Module or System?

The ["Zero AI" category](/packages/tag/zero-ai) is for Systems or Modules that were authored without any use of generative AI to create their user-facing content. The "Zero-AI" *tag* (  `No AI` ) is automatically added to anything that belongs to this category.

The definition of user-facing content and the criteria for designation as "Zero AI" are explained in our [AI Content Policy](/article/ai-policy). If you feel that your Module or System meets these criteria and would like to advertise it as 100% human-created, you can simply add the "Zero AI" category yourself.

I suspect that a Module or System isn't abiding by the AI policy or is incorrectly claiming the Zero AI tag, what should I do?

First, before submitting a report, please carefully review our current [AI Content Policy](/article/ai-policy). If you still suspect a non-compliance issue, you can use the [Contact Us](/contact-us/) form to submit a message using the "AI Content Policy" category. We will respond to your email to confirm receipt of your report and investigate, but please be aware that we may not necessarily share the outcome of our investigation with you.