---
title: "Basic Dice"
url: "https://foundryvtt.com/article/dice/"
category: "Basic Dice"
---
...
This article covers all of the basics of rolling dice, the various roll modes available to users, and some of the fundamental features that can be used to notate rolls during play. For more advanced dice rolling concepts, and API references see the [Advanced Dice](/article/dice-advanced/ "Advanced Dice") article. In addition to the basic types of rolling covered in this article, Foundry Virtual Tabletop provides a number of modifiers which can be used to change how dice work in order to support different game systems. For a comprehensive listing dice modifiers consult the [Dice Modifiers](/article/dice-modifiers/ "Dice Modifiers") article.

## Roll Modes

![Roll Modes](https://r2.foundryvtt.com/website-uploads-public/screen/user_671/roll-modes-2020-10-21.jpg)

There are multiple role modes available in Foundry.
...
The `/roll` command will always roll using the selected type of roll, but other types of rolls can be made using their specific commands, which are listed below.

Public Roll
:   This roll is visible to all players. To perform a public roll, use `/publicroll` or `/pr` as the command prefix.
...
Using Simple Math with Roll Commands
...
Roll a one hundred-sided die, multiply that number by 2, then divide it by the result of rolling a four-sided die.
...
Roll a one hundred-sided die, multiply that number by 2, then divide it by the result of a four-sided die.
...
![Inline Rolls](https://r2.foundryvtt.com/website-uploads-public/screen/user_671/inline-rolls-2020-11-22.png)

Immediate and Deferred Inline Rolls demonstrated in a Journal Entry
...
![Described Rolls](https://r2.foundryvtt.com/website-uploads-public/screen/user_671/described-rolls-2020-10-21.jpg)

Describing rolls allows users to keep track of what rolls are meant for.
...
If a deferred role is labeled, but has no flavor text in the formula otherwise, the label is included in the resulting roll as flavor text.