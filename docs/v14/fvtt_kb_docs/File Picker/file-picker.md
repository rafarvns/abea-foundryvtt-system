---
title: "File Picker"
url: "https://foundryvtt.com/article/file-picker/"
...
![File Picker Window](https://r2.foundryvtt.com/website-uploads-public/screen/user_1294/file-picker-window-2022-01-07.png)

The file picker dialog is used for selecting files stored in user data or foundry's core data folders.
...
You can find more on where user data is located by referring to the [Application Configuration](/article/configuration/ "Application Configuration") article.
...
Access to the file picker and the ability to upload files through it is governed by permissions levels, which is configured on a per-world basis. Access can be granted or revoked through the user role configuration panel accessed through the configuration panel. Details on the game settings panel and how to access user permission can be found in the [Game Settings](/article/settings/ "Game Settings") article, and details on permission roles can be found in the [Users and Permissions](/article/users/ "Users and Permissions") article.
