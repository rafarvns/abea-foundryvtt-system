---
title: "AudioHelper | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.audio.AudioHelper.html"
category: "classes"
---
...
[foundry.Game#audio](foundry.Game.md#audio)
...
[sounds](#sounds)
[unlock](#unlock)
[ANALYSIS\_TIMEOUT\_MS](#analysis_timeout_ms)
[AUDIO\_CONTEXTS](#audio_contexts)
[levelAnalyserNativeInterval](#levelanalysernativeinterval)
[THRESHOLD\_CACHE\_SIZE\_BYTES](#threshold_cache_size_bytes)
...
[getAnalyzerContext](#getanalyzercontext)
[getBandLevel](#getbandlevel)
[getMaxBandLevel](#getmaxbandlevel)
[play](#play)
[preload](#preload)
[startLevelReports](#startlevelreports)
[stopLevelReports](#stoplevelreports)
[\_activateSocketListeners](#_activatesocketlisteners)
[getDefaultSoundName](#getdefaultsoundname)
[hasAudioExtension](#hasaudioextension)
[inputToVolume](#inputtovolume)
[play](#play-2)
[preloadSound](#preloadsound)
[registerSettings](#registersettings)
[volumeToInput](#volumetoinput)
[volumeToPercentage](#volumetopercentage)

## Properties

### analyzer

analyzer: [AnalysisData](../interfaces/foundry.audio.AnalysisData.md)
...
buffers: [AudioBufferCache](foundry.audio.AudioBufferCache.md) = ...
...
[foundry.audio.Sound](foundry.audio.Sound.md)

### playing

playing: Map<number, [Sound](foundry.audio.Sound.md)> = ...

Get a map of the Sound objects which are currently playing.

### sounds

sounds: Map<string, WeakRef<[Sound](foundry.audio.Sound.md)>> = ...
...
AUDIO\_CONTEXTS: readonly [ContextName](../types/foundry.audio.ContextName.md)[] = ...
...
* create(options: [SoundCreationOptions](../interfaces/foundry.audio.SoundCreationOptions.md)): [Sound](foundry.audio.Sound.md)

  Create a Sound instance for a given audio source URL

  #### Parameters

  + options: [SoundCreationOptions](../interfaces/foundry.audio.SoundCreationOptions.md)

    Sound creation options

  #### Returns [Sound](foundry.audio.Sound.md)
...
* disableAnalyzer(contextName: [ContextName](../types/foundry.audio.ContextName.md)): void

  Disable the analyzer for a given context, disconnecting the AnalyserNode.

  #### Parameters

  + contextName: [ContextName](../types/foundry.audio.ContextName.md)
...
* enableAnalyzer(  
  Â Â Â Â contextName: [ContextName](../types/foundry.audio.ContextName.md),  
...
* getBandLevel(  
  Â Â Â Â contextName: [ContextName](../types/foundry.audio.ContextName.md),  
  Â Â Â Â bandName: [BandName](../types/foundry.audio.BandName.md),  
  ...
  + Important:
    - Local gain applied to [foundry.audio.Sound](foundry.audio.Sound.md) source can't be ignored.
  ...
  + contextName: [ContextName](../types/foundry.audio.ContextName.md)
  + bandName: [BandName](../types/foundry.audio.BandName.md)
...
* getMaxBandLevel(band?: [BandName](../types/foundry.audio.BandName.md), options?: { ignoreVolume?: boolean }): number
  ...
  + `Optional`band: [BandName](../types/foundry.audio.BandName.md) = "all"
...
* play(src: string, options?: { context?: AudioContext }): Promise<[Sound](foundry.audio.Sound.md)>
  ...
  #### Returns Promise<[Sound](foundry.audio.Sound.md)>

  The created Sound which is now playing

### preload

* preload(src: string): Promise<[Sound](foundry.audio.Sound.md)>
...
* play(  
  ...
  ): void | [Sound](foundry.audio.Sound.md)
  ...
  #### Returns void | [Sound](foundry.audio.Sound.md)
...
* preloadSound(src: string): Promise<[Sound](foundry.audio.Sound.md)>
