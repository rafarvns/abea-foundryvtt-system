---
title: "Settings | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.tabs.Settings.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.tabs.Settings))
...
* new Settings(options?: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md)>): Settings
...
Â Â Â Â Â Â Â Â openApp: (this: Settings, event: any) => Promise<void>;  
Â Â Â Â };  
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â coreUpdate: string  
  Â Â Â Â Â Â Â Â | null;  
  Â Â Â Â Â Â Â Â isDemo: any;  
  Â Â Â Â Â Â Â Â issues: number;  
  Â Â Â Â Â Â Â Â modules: number;  
  Â Â Â Â Â Â Â Â release: any;  
  Â Â Â Â Â Â Â Â system: [System](foundry.packages.System.md);  
  Â Â Â Â Â Â Â Â systemUpdate: string | null;  
  ...
  #### Returns Promise< Â Â Â Â [ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md) & { Â Â Â Â Â Â Â Â canConfigure: boolean; Â Â Â Â Â Â Â Â canEditWorld: boolean; Â Â Â Â Â Â Â Â canManagePlayers: boolean; Â Â Â Â Â Â Â Â canReturnSetup: boolean; Â Â Â Â Â Â Â Â coreUpdate: string Â Â Â Â Â Â Â Â | null; Â Â Â Â Â Â Â Â isDemo: any; Â Â Â Â Â Â Â Â issues: number; Â Â Â Â Â Â Â Â modules: number; Â Â Â Â Â Â Â Â release: any; Â Â Â Â Â Â Â Â system: [System](foundry.packages.System.md); Â Â Â Â Â Â Â Â systemUpdate: string | null; Â Â Â Â Â Â Â Â versionDisplay: string; Â Â Â Â }, >
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<Settings>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<Settings>
...
* render(options: any, \_options: any): Promise<Settings>
