---
title: "Region | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.placeables.Region.html"
category: "classes"
---
...
* [foundry.documents.RegionDocument](foundry.documents.RegionDocument.md)
* [foundry.canvas.layers.RegionLayer](foundry.canvas.layers.RegionLayer.md)
...
[\_onTokenAnimationFrame](#_ontokenanimationframe)
[\_onUpdate](#_onupdate)
...
[\_redrawShapeControls](#_redrawshapecontrols)
...
[\_getCoveredGridSpaceOffsets](#_getcoveredgridspaceoffsets)
[\_getMeasurementTextStyle](#_getmeasurementtextstyle)
[\_initializeDragRight](#_initializedragright)
[\_onAnimationStateChange](#_onanimationstatechange)
...
[\_refreshGeometry](#_refreshgeometry)
[\_refreshMeasurements](#_refreshmeasurements)
[\_refreshShapes](#_refreshshapes)
...
* new Region(document: CanvasDocument): [canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).Region
  ...
  #### Returns [canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).Region
...
Â Â Â Â refreshGeometry: { propagate: string[] };  
Â Â Â Â refreshMeasurements: {};  
Â Â Â Â refreshShapes: { propagate: string[] };  
...
* get animationState(): [DeepReadonly](../types/foundry.types.DeepReadonly.md)<[RegionAnimationState](../interfaces/foundry.canvas.placeables.types.RegionAnimationState.md)>

  The animation state of this Region.

  #### Returns [DeepReadonly](../types/foundry.types.DeepReadonly.md)<[RegionAnimationState](../interfaces/foundry.canvas.placeables.types.RegionAnimationState.md)>
...
* get geometry(): [RegionGeometry](foundry.canvas.placeables.regions.RegionGeometry.md)

  The geometry of this Region.

  The value of this property must not be mutated.

  #### Returns [RegionGeometry](foundry.canvas.placeables.regions.RegionGeometry.md)
...
* get isVisible(): any
  ...
  Overrides ShapeObjectMixin(PlaceableObject).isVisible
...
* \_hasShapeChanged(changed: object): boolean
  ...
  + changed: object
    ...
    The changes of the update operation

  #### Returns boolean

  True if the shape or a shape has changed

  Inherited from ShapeObjectMixin(PlaceableObject).\_hasShapeChanged
...
* \_onHoverIn(event: any, options?: {}): boolean | void
  ...
  Overrides ShapeObjectMixin(PlaceableObject).\_onHoverIn
...
* \_onHoverOut(event: any, options?: {}): void
  ...
  Overrides ShapeObjectMixin(PlaceableObject).\_onHoverOut
...
* \_pasteObject(offset: any, \_options: any): { levels: any[]; shapes: any[] }
  ...
  #### Returns { levels: any[]; shapes: any[] }

  Overrides ShapeObjectMixin(PlaceableObject).\_pasteObject
...
* getSnappedPosition(position: any): void
  ...
  Overrides ShapeObjectMixin(PlaceableObject).getSnappedPosition
...
### `Protected`\_getCoveredGridSpaceOffsets

* \_getCoveredGridSpaceOffsets(): [GridOffset2D](../interfaces/foundry.grid.types.GridOffset2D.md)[]
...
### `Protected`\_onAnimationStateChange

* \_onAnimationStateChange(): void
...
### `Protected`\_refreshGeometry

* \_refreshGeometry(): void
