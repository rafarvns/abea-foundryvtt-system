---
title: "FilePathField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.FilePathField.html"
category: "classes"
---

# Class FilePathField

A special [foundry.data.fields.StringField](foundry.data.fields.StringField.md) which records a file path or inline base64 data.
...
See [foundry.packages.types.ServerSanitizationFields](../interfaces/foundry.packages.types.ServerSanitizationFields.md) for information about this structure.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.FilePathField))
...
* new FilePathField(  
  Â Â Â Â options?: [FilePathFieldOptions](../types/foundry.data.types.FilePathFieldOptions.md),  
  Â Â Â Â context?: [DataFieldContext](../interfaces/foundry.data.types.DataFieldContext.md),  
  ): FilePathField

  #### Parameters

  + `Optional`options: [FilePathFieldOptions](../types/foundry.data.types.FilePathFieldOptions.md) = {}
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & {  
  ...
  Â Â Â Â base64: boolean;  
  Â Â Â Â blank: boolean;  
  Â Â Â Â categories: never[];  
  Â Â Â Â initial: null;  
  Â Â Â Â nullable: boolean;  
  Â Â Â Â virtual: boolean;  
  Â Â Â Â wildcard: boolean;  
  }

  Default parameters for this field type

  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { Â Â Â Â blank: boolean; Â Â Â Â choices: undefined; Â Â Â Â textSearch: boolean; Â Â Â Â trim: boolean; } & { Â Â Â Â base64: boolean; Â Â Â Â blank: boolean; Â Â Â Â categories: never[]; Â Â Â Â initial: null; Â Â Â Â nullable: boolean; Â Â Â Â virtual: boolean; Â Â Â Â wildcard: boolean; }
...
* \_toInput(config: any): HTMLElement
