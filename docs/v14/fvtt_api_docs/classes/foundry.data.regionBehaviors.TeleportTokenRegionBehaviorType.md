---
title: "TeleportTokenRegionBehaviorType | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.regionBehaviors.TeleportTokenRegionBehaviorType.html"
category: "classes"
---

# Class TeleportTokenRegionBehaviorType

The data model for a behavior that teleports Token that enter the Region to a preset destination Region.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.regionBehaviors.TeleportTokenRegionBehaviorType))
...
* new TeleportTokenRegionBehaviorType(  
  Â Â Â Â data?: {},  
  Â Â Â Â options?: {},  
  ): TeleportTokenRegionBehaviorType
  ...
  #### Returns TeleportTokenRegionBehaviorType
...
events: {  
Â Â Â Â tokenMoveIn: (  
Â Â Â Â Â Â Â Â this: TeleportTokenRegionBehaviorType,  
Â Â Â Â Â Â Â Â event: [RegionTokenMoveEvent](../types/foundry.documents.types.RegionTokenMoveEvent.md),  
Â Â Â Â ) => Promise<void>;  
} = ...

#### Type Declaration

* ##### tokenMoveIn: ( Â Â Â Â this: TeleportTokenRegionBehaviorType, Â Â Â Â event: [RegionTokenMoveEvent](../types/foundry.documents.types.RegionTokenMoveEvent.md), ) => Promise<void>
...
* \_handleRegionEvent(event: any): void
  ...
  Overrides [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.md).[\_handleRegionEvent](foundry.data.regionBehaviors.RegionBehaviorType.md#_handleregionevent)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.md).[\_onUpdate](foundry.data.regionBehaviors.RegionBehaviorType.md#_onupdate)
...
### `Static`\_confirmQuery

* \_confirmQuery(  
  Â Â Â Â queryData: { behaviorUuid: string; tokenUuid: string },  
  ): Promise<boolean>
...
* defineSchema(): {  
  Â Â Â Â choice: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â destinations: [SetField](foundry.data.fields.SetField.md);  
  Â Â Â Â dialog: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â placement: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â revealed: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â snap: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â transition: [SchemaField](foundry.data.fields.SchemaField.md);  
  }

  #### Returns { Â Â Â Â choice: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â destinations: [SetField](foundry.data.fields.SetField.md); Â Â Â Â dialog: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â placement: [StringField](foundry.data.fields.StringField.md); Â Â Â Â revealed: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â snap: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â transition: [SchemaField](foundry.data.fields.SchemaField.md); }
...
* migrateData(data: any, options: any): object
  ...
  Overrides [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.md).[migrateData](foundry.data.regionBehaviors.RegionBehaviorType.md#migratedata)
