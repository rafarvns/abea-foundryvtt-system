---
title: "BaseShapeData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.BaseShapeData.html"
category: "classes"
---

# Class BaseShapeData`Abstract`

A data model intended to be used as an inner EmbeddedDataField which defines a geometric shape.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.BaseShapeData))

* [DataModel](foundry.abstract.DataModel.md)
  + BaseShapeData
    - [CircleShapeData](foundry.CircleShapeData.md)
    - [ConeShapeData](foundry.ConeShapeData.md)
    - [RectangleShapeData](foundry.RectangleShapeData.md)
    - [EllipseShapeData](foundry.EllipseShapeData.md)
    - [PolygonShapeData](foundry.PolygonShapeData.md)
