---
title: "VFXScrollingTextComponent | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.vfx.components.VFXScrollingTextComponent.html"
category: "classes"
---

# Class VFXScrollingTextComponent
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.vfx.components.VFXScrollingTextComponent))
...
* new VFXScrollingTextComponent(  
  Â Â Â Â data?: Partial<[VFXScrollingTextData](../interfaces/foundry.VFXScrollingTextData.md)>,  
  Â Â Â Â options?: any,  
  ): VFXScrollingTextComponent

  #### Parameters

  + `Optional`data: Partial<[VFXScrollingTextData](../interfaces/foundry.VFXScrollingTextData.md)> = {}
  ...
  #### Returns VFXScrollingTextComponent
...
\_source: [VFXScrollingTextData](../interfaces/foundry.VFXScrollingTextData.md)
...
* \_load(): Promise<void>
  ...
  Inherited from [VFXComponent](foundry.canvas.vfx.VFXComponent.md).[\_load](foundry.canvas.vfx.VFXComponent.md#_load)
...
* \_stop(): Promise<void>
  ...
  Inherited from [VFXComponent](foundry.canvas.vfx.VFXComponent.md).[\_stop](foundry.canvas.vfx.VFXComponent.md#_stop)
...
* defineSchema(): {  
  Â Â Â Â content: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md);  
  Â Â Â Â distance: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md);  
  Â Â Â Â duration: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md);  
  Â Â Â Â jitter: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md);  
  Â Â Â Â origin: [VFXReferencePointField](foundry.canvas.vfx.fields.VFXReferencePointField.md);  
  Â Â Â Â scrollDirection: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md);  
  Â Â Â Â textAnchor: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md);  
  Â Â Â Â textStyle: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md);  
  Â Â Â Â type: [StringField](foundry.data.fields.StringField.md);  
  }

  #### Returns { Â Â Â Â content: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md); Â Â Â Â distance: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md); Â Â Â Â duration: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md); Â Â Â Â jitter: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md); Â Â Â Â origin: [VFXReferencePointField](foundry.canvas.vfx.fields.VFXReferencePointField.md); Â Â Â Â scrollDirection: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md); Â Â Â Â textAnchor: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md); Â Â Â Â textStyle: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md); Â Â Â Â type: [StringField](foundry.data.fields.StringField.md); }
