---
title: "JournalPageSheet | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.appv1.sheets.JournalPageSheet.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.appv1.sheets.JournalPageSheet))

* [DocumentSheet](foundry.appv1.api.DocumentSheet.md)
  + JournalPageSheet
    - [JournalTextPageSheet](foundry.appv1.sheets.JournalTextPageSheet.md)
...
* get template(): string
  ...
  Overrides [JournalSheet](foundry.appv1.sheets.JournalSheet.md).[template](foundry.appv1.sheets.JournalSheet.md#template)
...
* \_getHeaderButtons(): [ApplicationV1HeaderButton](../types/foundry.ApplicationV1HeaderButton.md)[]
  ...
  Inherited from [DocumentSheet](foundry.appv1.api.DocumentSheet.md).[\_getHeaderButtons](foundry.appv1.api.DocumentSheet.md#_getheaderbuttons)
...
* \_getSecretContent(secret: any): any
  ...
  Overrides [DocumentSheet](foundry.appv1.api.DocumentSheet.md).[\_getSecretContent](foundry.appv1.api.DocumentSheet.md#_getsecretcontent)
...
* \_renderInner(...args: any[]): Promise<jQuery>
  ...
  Overrides [DocumentSheet](foundry.appv1.api.DocumentSheet.md).[\_renderInner](foundry.appv1.api.DocumentSheet.md#_renderinner)
...
* \_updateSecret(secret: any, content: any): any
  ...
  Overrides [DocumentSheet](foundry.appv1.api.DocumentSheet.md).[\_updateSecret](foundry.appv1.api.DocumentSheet.md#_updatesecret)
...
* activateEditor(  
  ...
  Overrides [DocumentSheet](foundry.appv1.api.DocumentSheet.md).[activateEditor](foundry.appv1.api.DocumentSheet.md#activateeditor)
