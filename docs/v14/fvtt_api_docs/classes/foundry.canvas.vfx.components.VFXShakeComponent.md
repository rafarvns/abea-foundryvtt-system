---
title: "VFXShakeComponent | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.vfx.components.VFXShakeComponent.html"
category: "classes"
---

# Class VFXShakeComponent
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.vfx.components.VFXShakeComponent))
...
* new VFXShakeComponent(  
  Â Â Â Â data?: Partial<[VFXShakeData](../interfaces/foundry.VFXShakeData.md)>,  
  Â Â Â Â options?: any,  
  ): VFXShakeComponent

  #### Parameters

  + `Optional`data: Partial<[VFXShakeData](../interfaces/foundry.VFXShakeData.md)> = {}
...
\_source: [VFXShakeData](../interfaces/foundry.VFXShakeData.md)
...
* defineSchema(): {  
  ...
  Â Â Â Â maxDisplacement: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â returnSpeed: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â seed: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â smoothness: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â target: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md);  
  Â Â Â Â type: [StringField](foundry.data.fields.StringField.md);  
  }

  #### Returns { Â Â Â Â duration: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â maxDisplacement: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â returnSpeed: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â seed: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â smoothness: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â target: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md); Â Â Â Â type: [StringField](foundry.data.fields.StringField.md); }
