---
title: "FolderExport | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.apps.FolderExport.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.apps.FolderExport))
...
Inherited from DialogV2.\_appId
...
Inherited from DialogV2.BASE\_APPLICATION

### `Static`DEFAULT\_OPTIONS

DEFAULT\_OPTIONS: { id: string; position: { width: number } } = ...

#### Inherit Doc

Overrides DialogV2.DEFAULT\_OPTIONS
...
Inherited from DialogV2.RENDER\_STATES
...
* \_awaitTransition(element: HTMLElement, timeout: number): Promise<void>
  ...
  Inherited from DialogV2.\_awaitTransition
...
* \_canDetach(): boolean
  ...
  Inherited from DialogV2.\_canDetach
...
* \_doEvent(  
  ...
  Inherited from DialogV2.\_doEvent
...
* attachWindow(  
  ...
  Inherited from DialogV2.attachWindow
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<FolderExport>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<FolderExport>
  ...
  Inherited from DialogV2.detachWindow
...
* renderChild(  
  ...
  Inherited from DialogV2.renderChild
...
* \_canAttach(): boolean
  ...
  Inherited from DialogV2.\_canAttach
...
* \_getFrameButtons(  
  ...
  Inherited from DialogV2.\_getFrameButtons
...
* \_headerControlContextEntries(): Generator<[ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md), void, any>
  ...
  Inherited from DialogV2.\_headerControlContextEntries
...
* \_onAttach(from: Document, to: Document): void
  ...
  Inherited from DialogV2.\_onAttach
...
* \_onDetach(from: Document, to: Document): void
  ...
  Inherited from DialogV2.\_onDetach
...
* \_postRender(  
  ...
  Inherited from DialogV2.\_postRender
...
* \_refit(positionUpdate?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void
  ...
  Inherited from DialogV2.\_refit
...
* \_renderFrameButtons(options: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<void>
  ...
  Inherited from DialogV2.\_renderFrameButtons
...
* \_handleQuery(  
  ...
  Inherited from DialogV2.\_handleQuery
...
* instances(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), any, any>
  ...
  Inherited from DialogV2.instances
