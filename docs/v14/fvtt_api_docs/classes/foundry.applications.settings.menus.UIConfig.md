---
title: "UIConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.settings.menus.UIConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.settings.menus.UIConfig))
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: { reset: (this: UIConfig, event: InputEvent) => Promise<void> };  
Â Â Â Â form: {  
Â Â Â Â Â Â Â Â closeOnSubmit: boolean;  
Â Â Â Â Â Â Â Â handler: (  
Â Â Â Â Â Â Â Â Â Â Â Â this: UIConfig,  
...
* \_onChangeForm(\_formConfig: any, \_event: any): void
...
* \_onClose(options: any): void
  ...
  Overrides HandlebarsApplicationMixin(ApplicationV2).\_onClose

### \_preFirstRender

* \_preFirstRender(\_context: any, \_options: any): Promise<void>
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â setting: [GameUIConfiguration](../interfaces/foundry.GameUIConfiguration.md);  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â buttons: ( Â Â Â Â Â Â Â Â Â Â Â Â | { action: string; icon: string; label: string; type: string } Â Â Â Â Â Â Â Â Â Â Â Â | { action?: undefined; icon: string; label: string; type: string } Â Â Â Â Â Â Â Â )[]; Â Â Â Â Â Â Â Â fields: [DataSchema](../types/foundry.abstract.types.DataSchema.md); Â Â Â Â Â Â Â Â setting: [GameUIConfiguration](../interfaces/foundry.GameUIConfiguration.md); Â Â Â Â }, >
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<UIConfig>
...
* detachWindow(options?: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<UIConfig>
