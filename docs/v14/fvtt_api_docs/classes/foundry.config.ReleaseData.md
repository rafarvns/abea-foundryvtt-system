---
title: "ReleaseData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.config.ReleaseData.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.config.ReleaseData))
...
[isGenerationalChange](#isgenerationalchange)
[isNewer](#isnewer)
[reset](#reset)
[toJSON](#tojson)
[toObject](#toobject)
...
* isGenerationalChange(other: string | ReleaseData): boolean
  ...
  + other: string | ReleaseData

    Some other version to compare against
...
* defineSchema(): {  
  Â Â Â Â build: [NumberField](foundry.data.fields.NumberField.md);  
  ...
  Â Â Â Â generation: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â maxGeneration: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â maxStableGeneration: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â node\_version: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â notes: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â suffix: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â time: [NumberField](foundry.data.fields.NumberField.md);  
  }

  #### Returns { Â Â Â Â build: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â channel: [StringField](foundry.data.fields.StringField.md); Â Â Â Â download: [StringField](foundry.data.fields.StringField.md); Â Â Â Â flags: [ObjectField](foundry.data.fields.ObjectField.md); Â Â Â Â generation: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â maxGeneration: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â maxStableGeneration: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â node\_version: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â notes: [StringField](foundry.data.fields.StringField.md); Â Â Â Â suffix: [StringField](foundry.data.fields.StringField.md); Â Â Â Â time: [NumberField](foundry.data.fields.NumberField.md); }
