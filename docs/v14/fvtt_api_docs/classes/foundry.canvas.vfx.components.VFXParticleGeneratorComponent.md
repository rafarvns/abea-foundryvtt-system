---
title: "VFXParticleGeneratorComponent | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.vfx.components.VFXParticleGeneratorComponent.html"
category: "classes"
---

# Class VFXParticleGeneratorComponent

A VFX component that creates and manages a [foundry.canvas.animation.ParticleGenerator](foundry.canvas.animation.ParticleGenerator.md).
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.vfx.components.VFXParticleGeneratorComponent))
...
* new VFXParticleGeneratorComponent(  
  Â Â Â Â data?: Partial<[VFXParticleGeneratorData](../interfaces/foundry.VFXParticleGeneratorData.md)>,  
  Â Â Â Â options?: any,  
  ): VFXParticleGeneratorComponent

  #### Parameters

  + `Optional`data: Partial<[VFXParticleGeneratorData](../interfaces/foundry.VFXParticleGeneratorData.md)> = {}
  ...
  #### Returns VFXParticleGeneratorComponent
...
\_source: [VFXParticleGeneratorData](../interfaces/foundry.VFXParticleGeneratorData.md)
...
* stop(): Promise<void>
  ...
  Overrides [VFXComponent](foundry.canvas.vfx.VFXComponent.md).[stop](foundry.canvas.vfx.VFXComponent.md#stop)
...
* defineSchema(): {  
  Â Â Â Â alpha: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â area: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md);  
  Â Â Â Â blend: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â config: [ObjectField](foundry.data.fields.ObjectField.md);  
  Â Â Â Â count: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md);  
  ...
  Â Â Â Â fade: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â initial: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â lifetime: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â mode: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â pointSourceMask: [VFXPointSourcePolygonField](foundry.canvas.vfx.fields.VFXPointSourcePolygonField.md);  
  Â Â Â Â rotation: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â scale: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â sort: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â spawnRate: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â textures: [ArrayField](foundry.data.fields.ArrayField.md)<[StringField](foundry.data.fields.StringField.md)>;  
  Â Â Â Â type: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â velocity: [SchemaField](foundry.data.fields.SchemaField.md);  
  }

  #### Returns { Â Â Â Â alpha: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â area: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md); Â Â Â Â blend: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â config: [ObjectField](foundry.data.fields.ObjectField.md); Â Â Â Â count: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md); Â Â Â Â duration: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â elevation: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â fade: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â initial: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â lifetime: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â mode: [StringField](foundry.data.fields.StringField.md); Â Â Â Â pointSourceMask: [VFXPointSourcePolygonField](foundry.canvas.vfx.fields.VFXPointSourcePolygonField.md); Â Â Â Â rotation: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â scale: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â sort: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â spawnRate: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â textures: [ArrayField](foundry.data.fields.ArrayField.md)<[StringField](foundry.data.fields.StringField.md)>; Â Â Â Â type: [StringField](foundry.data.fields.StringField.md); Â Â Â Â velocity: [SchemaField](foundry.data.fields.SchemaField.md); }
...
* migrateData(data: any, options: any): object
  ...
  Overrides [VFXComponent](foundry.canvas.vfx.VFXComponent.md).[migrateData](foundry.canvas.vfx.VFXComponent.md#migratedata)
