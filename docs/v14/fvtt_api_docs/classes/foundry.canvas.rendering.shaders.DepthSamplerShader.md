---
title: "DepthSamplerShader | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.rendering.shaders.DepthSamplerShader.html"
category: "classes"
---

# Class DepthSamplerShader

The depth sampler shader.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.rendering.shaders.DepthSamplerShader))
...
classPluginName: string = "batchDepth"
...
* get defaultUniforms(): {  
  ...
  Â Â Â Â restrictsLight: boolean;  
  Â Â Â Â restrictsWeather: boolean;  
  Â Â Â Â sampler: null;  
  Â Â Â Â screenDimensions: number[];  
  Â Â Â Â surfaceOcclusion: number;  
  Â Â Â Â textureAlphaThreshold: number;  
  Â Â Â Â visionOcclusion: number;  
  }

  #### Returns { Â Â Â Â depthElevation: number; Â Â Â Â fadeOcclusion: number; Â Â Â Â occlusionElevation: number; Â Â Â Â occlusionTexture: null; Â Â Â Â radialOcclusion: number; Â Â Â Â restrictsLight: boolean; Â Â Â Â restrictsWeather: boolean; Â Â Â Â sampler: null; Â Â Â Â screenDimensions: number[]; Â Â Â Â surfaceOcclusion: number; Â Â Â Â textureAlphaThreshold: number; Â Â Â Â visionOcclusion: number; }
