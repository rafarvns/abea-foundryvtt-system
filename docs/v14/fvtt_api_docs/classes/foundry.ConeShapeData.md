...
url: "https://foundryvtt.com/api/v14/classes/foundry.ConeShapeData.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.ConeShapeData))
...
* defineSchema(): { hole: [BooleanField](foundry.data.fields.BooleanField.md); type: [StringField](foundry.data.fields.StringField.md) } & {  
  ...
  Â Â Â Â curvature: [StringField](foundry.data.fields.StringField.md);  
  ...
  #### Returns { hole: [BooleanField](foundry.data.fields.BooleanField.md); type: [StringField](foundry.data.fields.StringField.md) } & { Â Â Â Â angle: [AngleField](foundry.data.fields.AngleField.md); Â Â Â Â curvature: [StringField](foundry.data.fields.StringField.md); Â Â Â Â gridBased: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â radius: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â rotation: [AngleField](foundry.data.fields.AngleField.md); Â Â Â Â x: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â y: [NumberField](foundry.data.fields.NumberField.md); }
...
* validateJoint(data: any): void
  ...
  Overrides [BaseShapeData](foundry.data.BaseShapeData.md).[validateJoint](foundry.data.BaseShapeData.md#validatejoint)
