---
title: "RegionConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.RegionConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.RegionConfig))

* [PlaceableConfig](foundry.applications.sheets.PlaceableConfig.md)
  + RegionConfig
    - [RegionPalette](foundry.applications.sheets.palette.RegionPalette.md)
...
* new RegionConfig(options: any, ...args: any[]): RegionConfig
...
Â Â Â Â Â Â Â Â behaviorDelete: (this: RegionConfig, event: PointerEvent) => Promise<void>;  
Â Â Â Â Â Â Â Â behaviorEdit: (this: RegionConfig, event: PointerEvent) => Promise<void>;  
Â Â Â Â Â Â Â Â behaviorToggle: (this: RegionConfig, event: PointerEvent) => Promise<void>;  
Â Â Â Â Â Â Â Â shapeCreateFromWalls: (  
Â Â Â Â Â Â Â Â Â Â Â Â this: RegionConfig,  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â ) => Promise<void>;  
Â Â Â Â Â Â Â Â shapeEdit: (this: RegionConfig, event: PointerEvent) => void;  
Â Â Â Â Â Â Â Â shapeMoveDown: (this: RegionConfig, event: PointerEvent) => Promise<void>;  
Â Â Â Â Â Â Â Â shapeMoveUp: (this: RegionConfig, event: PointerEvent) => Promise<void>;  
Â Â Â Â Â Â Â Â shapeRemove: (this: RegionConfig, event: PointerEvent) => Promise<any>;  
Â Â Â Â Â Â Â Â shapeRemoveAll: (this: RegionConfig, event: PointerEvent) => Promise<void>;  
Â Â Â Â Â Â Â Â shapeToggleHole: (  
Â Â Â Â Â Â Â Â Â Â Â Â this: RegionConfig,  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â ) => Promise<void>;  
Â Â Â Â };  
...
Â Â Â Â placement: { scrollable: string[]; template: string };  
Â Â Â Â shapes: { scrollable: string[]; template: string; templates: string[] };  
...
* \_configureRenderOptions(options: any): void
  ...
  Overrides PlaceableConfig.\_configureRenderOptions
...
* \_prepareContext(  
  ...
  Inherited from PlaceableConfig.\_prepareContext
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<RegionConfig>
