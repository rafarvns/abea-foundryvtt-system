---
title: "AmbientSoundDocument | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.AmbientSoundDocument.html"
category: "classes"
---
...
* [foundry.documents.Scene](foundry.documents.Scene.md): The Scene document type which contains AmbientSound documents
* [foundry.applications.sheets.AmbientSoundConfig](foundry.applications.sheets.AmbientSoundConfig.md): The AmbientSound configuration
  application

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.AmbientSoundDocument))

* [BaseAmbientSound](foundry.documents.BaseAmbientSound.md)<this>
...
* new AmbientSoundDocument(  
  Â Â Â Â data?: Partial<[AmbientSoundData](../interfaces/foundry.documents.types.AmbientSoundData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): AmbientSoundDocument

  #### Parameters

  + `Optional`data: Partial<[AmbientSoundData](../interfaces/foundry.documents.types.AmbientSoundData.md)> = {}
  ...
  #### Returns AmbientSoundDocument

  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[constructor](foundry.documents.BaseAmbientSound.md#constructor)

## Properties

### \_source

\_source: [AmbientSoundData](../interfaces/foundry.documents.types.AmbientSoundData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_source](foundry.documents.BaseAmbientSound.md#_source)
...
Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[parent](foundry.documents.BaseAmbientSound.md#parent)

### shape

shape: [data](../modules/foundry.data.md).[CircleShapeData](foundry.data.CircleShapeData.md) = ...
...
Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_schema](foundry.documents.BaseAmbientSound.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseAmbientSound.md#localization_prefixes)
...
Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[metadata](foundry.documents.BaseAmbientSound.md#metadata)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_configure](foundry.documents.BaseAmbientSound.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_getParentCollection](foundry.documents.BaseAmbientSound.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_initializationOrder](foundry.documents.BaseAmbientSound.md#_initializationorder)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_updateDiff](foundry.documents.BaseAmbientSound.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[canUserModify](foundry.documents.BaseAmbientSound.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[clone](foundry.documents.BaseAmbientSound.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[createEmbeddedDocuments](foundry.documents.BaseAmbientSound.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[delete](foundry.documents.BaseAmbientSound.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[deleteEmbeddedDocuments](foundry.documents.BaseAmbientSound.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[getEmbeddedCollection](foundry.documents.BaseAmbientSound.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[getEmbeddedDocument](foundry.documents.BaseAmbientSound.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[getFieldForProperty](foundry.documents.BaseAmbientSound.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[getFlag](foundry.documents.BaseAmbientSound.md#getflag)
...
* getUserLevel(user: any): any
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[getUserLevel](foundry.documents.BaseAmbientSound.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[migrateSystemData](foundry.documents.BaseAmbientSound.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[reset](foundry.documents.BaseAmbientSound.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[setFlag](foundry.documents.BaseAmbientSound.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[testUserPermission](foundry.documents.BaseAmbientSound.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[toJSON](foundry.documents.BaseAmbientSound.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[toObject](foundry.documents.BaseAmbientSound.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[traverseEmbeddedDocuments](foundry.documents.BaseAmbientSound.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[unsetFlag](foundry.documents.BaseAmbientSound.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[update](foundry.documents.BaseAmbientSound.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[updateEmbeddedDocuments](foundry.documents.BaseAmbientSound.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[updateSource](foundry.documents.BaseAmbientSound.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[validate](foundry.documents.BaseAmbientSound.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_getInnerModel](foundry.documents.BaseAmbientSound.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_initialize](foundry.documents.BaseAmbientSound.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_initializeSource](foundry.documents.BaseAmbientSound.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_onCreate](foundry.documents.BaseAmbientSound.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_onDelete](foundry.documents.BaseAmbientSound.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_onUpdate](foundry.documents.BaseAmbientSound.md#_onupdate)
...
* \_preCreate(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_preCreate](foundry.documents.BaseAmbientSound.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_preDelete](foundry.documents.BaseAmbientSound.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_preUpdate](foundry.documents.BaseAmbientSound.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_preUpdateSource](foundry.documents.BaseAmbientSound.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_updateCommit](foundry.documents.BaseAmbientSound.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_addDataFieldMigration](foundry.documents.BaseAmbientSound.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_addDataFieldShim](foundry.documents.BaseAmbientSound.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_addDataFieldShims](foundry.documents.BaseAmbientSound.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_clearFieldsRecursively](foundry.documents.BaseAmbientSound.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_logDataFieldMigration](foundry.documents.BaseAmbientSound.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_preCleanData](foundry.documents.BaseAmbientSound.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[canUserCreate](foundry.documents.BaseAmbientSound.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[cleanData](foundry.documents.BaseAmbientSound.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[create](foundry.documents.BaseAmbientSound.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[createDocuments](foundry.documents.BaseAmbientSound.md#createdocuments)

### `Static`defineSchema

* defineSchema(): {  
  Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md);  
  Â Â Â Â darkness: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â easing: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â effects: [SchemaField](foundry.data.fields.SchemaField.md);  
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â darkness: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â easing: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â effects: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â elevation: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â hidden: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â levels: [SceneLevelsSetField](foundry.data.fields.SceneLevelsSetField.md); Â Â Â Â locked: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â path: [FilePathField](foundry.data.fields.FilePathField.md); Â Â Â Â radius: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â repeat: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â volume: [AlphaField](foundry.data.fields.AlphaField.md); Â Â Â Â walls: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â x: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â y: [NumberField](foundry.data.fields.NumberField.md); }
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[defineSchema](foundry.documents.BaseAmbientSound.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[deleteDocuments](foundry.documents.BaseAmbientSound.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[fromJSON](foundry.documents.BaseAmbientSound.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[fromSource](foundry.documents.BaseAmbientSound.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[get](foundry.documents.BaseAmbientSound.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[getCollectionName](foundry.documents.BaseAmbientSound.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[migrateData](foundry.documents.BaseAmbientSound.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[migrateDataSafe](foundry.documents.BaseAmbientSound.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[shimData](foundry.documents.BaseAmbientSound.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[updateDocuments](foundry.documents.BaseAmbientSound.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[validateJoint](foundry.documents.BaseAmbientSound.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_cleanData](foundry.documents.BaseAmbientSound.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_onCreateOperation](foundry.documents.BaseAmbientSound.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_onDeleteOperation](foundry.documents.BaseAmbientSound.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_onUpdateOperation](foundry.documents.BaseAmbientSound.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_preCreateOperation](foundry.documents.BaseAmbientSound.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_preDeleteOperation](foundry.documents.BaseAmbientSound.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseAmbientSound](foundry.documents.BaseAmbientSound.md).[\_preUpdateOperation](foundry.documents.BaseAmbientSound.md#_preupdateoperation)