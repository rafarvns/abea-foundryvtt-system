---
title: "BaseTerrainData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.BaseTerrainData.html"
category: "classes"
---

# Class BaseTerrainData<TerrainEffect>`Abstract`
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.BaseTerrainData))

* [DataModel](foundry.abstract.DataModel.md)
  + BaseTerrainData
    - [TerrainData](foundry.data.TerrainData.md)
...
* new BaseTerrainData<[TerrainEffect](#constructorbaseterraindataterraineffect)>(  
  Â Â Â Â data?: object,  
  Â Â Â Â options?: [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md),  
  ): BaseTerrainData<[TerrainEffect](#terraineffect)>
  ...
  #### Returns BaseTerrainData<[TerrainEffect](#terraineffect)>
...
* equals(other: any): boolean
  ...
  + other: any
    ...
    Some other terrain data

  #### Returns boolean

  Are the terrain datas equal?
...
### `Static` `Abstract`getMovementCostFunction
...
### `Static` `Abstract`resolveTerrainEffects

* resolveTerrainEffects(  
  Â Â Â Â effects: TerrainEffect[],  
  ...
  ): BaseTerrainData<TerrainEffect> | null
  ...
  #### Returns BaseTerrainData<TerrainEffect> | null

  The terrain data or null
