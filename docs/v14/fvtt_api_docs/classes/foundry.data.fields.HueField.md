---
title: "HueField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.HueField.html"
category: "classes"
---

# Class HueField

A special [foundry.data.fields.NumberField](foundry.data.fields.NumberField.md) represents a number between 0 (inclusive) and 1 (exclusive).
Its values are normalized (modulo 1) to the range [0, 1) instead of being clamped.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.HueField))
...
* new HueField(options?: [NumberFieldOptions](../interfaces/foundry.data.types.NumberFieldOptions.md), context?: [DataFieldContext](../interfaces/foundry.data.types.DataFieldContext.md)): HueField
...
* \_cast(value: any): any
  ...
  Overrides [NumberField](foundry.data.fields.NumberField.md).[\_cast](foundry.data.fields.NumberField.md#_cast)
...
* \_toInput(config: any): [HTMLHueSelectorSlider](foundry.applications.elements.HTMLHueSelectorSlider.md)

  #### Parameters

  + config: any

  #### Returns [HTMLHueSelectorSlider](foundry.applications.elements.HTMLHueSelectorSlider.md)

  Overrides [NumberField](foundry.data.fields.NumberField.md).[\_toInput](foundry.data.fields.NumberField.md#_toinput)
