---
title: "HTMLColorPickerElement | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.elements.HTMLColorPickerElement.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.elements.HTMLColorPickerElement))
...
* new HTMLColorPickerElement(  
  Â Â Â Â options?: [HTMLColorPickerOptions](../interfaces/foundry.HTMLColorPickerOptions.md),  
  ): HTMLColorPickerElement

  #### Parameters

  + `Optional`options: [HTMLColorPickerOptions](../interfaces/foundry.HTMLColorPickerOptions.md) = {}
...
* create(config: [FormInputConfig](../interfaces/foundry.data.types.FormInputConfig.md)): HTMLColorPickerElement
