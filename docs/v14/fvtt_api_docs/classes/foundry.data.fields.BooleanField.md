---
title: "BooleanField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.BooleanField.html"
category: "classes"
---

# Class BooleanField

A subclass of [foundry.data.fields.DataField](foundry.data.fields.DataField.md) which deals with boolean-typed data.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.BooleanField))
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & {  
  ...
  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { initial: boolean; nullable: boolean; required: boolean }
...
* \_applyChangeSubtract(value: any, delta: any, model: any, change: any): boolean
