---
title: "CombatEncounters | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.collections.CombatEncounters.html"
category: "classes"
---
...
* [foundry.documents.Combat](foundry.documents.Combat.md): The Combat document
* [foundry.applications.sidebar.tabs.CombatTracker](foundry.applications.sidebar.tabs.CombatTracker.md): The CombatTracker sidebar directory

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.collections.CombatEncounters))
...
* get active(): [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)
...
* get directory(): [CombatTracker](foundry.applications.sidebar.tabs.CombatTracker.md)

  Return a reference to the SidebarDirectory application for this WorldCollection.

  #### Returns [CombatTracker](foundry.applications.sidebar.tabs.CombatTracker.md)
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)
...
* every(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â element: [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)>,  
  Â Â Â Â ) => boolean,  
  ): boolean
  ...
  + condition: (  
    Â Â Â Â element: [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md),  
    Â Â Â Â index: number,  
    Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)>,  
    ) => boolean
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)>,  
  Â Â Â Â ) => unknown,  
  ): [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md) | undefined
  ...
  #### Returns [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md) | undefined
...
* forEach(fn: (value: [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md), index: number) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md), index: number) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md),  
  ...
  + document: object | [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)
...
* getInvalid(id: string, options?: { strict?: boolean }): void | [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)
  ...
  #### Returns void | [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)[]
...
* set(id: string, document: [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)): CombatEncounters

  #### Parameters

  + id: string
  + document: [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md)
