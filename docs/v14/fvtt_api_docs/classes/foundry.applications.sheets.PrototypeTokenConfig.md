---
title: "PrototypeTokenConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.PrototypeTokenConfig.html"
category: "classes"
---

# Class PrototypeTokenConfig
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.PrototypeTokenConfig))
...
* new PrototypeTokenConfig(options: any): PrototypeTokenConfig

  #### Parameters

  + options: any

  #### Returns PrototypeTokenConfig

  #### Inherit Doc

  Overrides TokenApplicationMixin(ApplicationV2).constructor
...
Inherited from TokenApplicationMixin(ApplicationV2).options
...
Inherited from TokenApplicationMixin(ApplicationV2).position
...
Inherited from TokenApplicationMixin(ApplicationV2).tabGroups

### `Protected`\_preview

\_preview: [PrototypeToken](foundry.data.PrototypeToken.md) | null = null
...
Inherited from TokenApplicationMixin(ApplicationV2).\_appId
...
Inherited from TokenApplicationMixin(ApplicationV2).\_maxZ
...
Inherited from TokenApplicationMixin(ApplicationV2).BASE\_APPLICATION

### `Static`DEFAULT\_OPTIONS

DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â assignToken: (  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLElement,  
Â Â Â Â Â Â Â Â ) => void | Promise<void>;  
Â Â Â Â Â Â Â Â cycleImage: (  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLElement,  
Â Â Â Â Â Â Â Â ) => void | Promise<void>;  
Â Â Â Â Â Â Â Â openOverridesConfig: (  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLElement,  
Â Â Â Â Â Â Â Â ) => void | Promise<void>;  
Â Â Â Â };  
...
Overrides TokenApplicationMixin(ApplicationV2).DEFAULT\_OPTIONS

### `Static`emittedEvents

emittedEvents: readonly ["prerender", "render", "close", "position"] = ...

Inherited from TokenApplicationMixin(ApplicationV2).emittedEvents
...
Inherited from TokenApplicationMixin(ApplicationV2).RENDER\_STATES
...
Inherited from TokenApplicationMixin(ApplicationV2).TABS
...
* get actor(): [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)

  #### Returns [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)
...
* get classList(): DOMTokenList
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).classList
...
* get element(): HTMLElement
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).element
...
* get form(): HTMLFormElement | null
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).form
...
* get hasFrame(): boolean
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).hasFrame
...
* get id(): string
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).id
...
* get minimized(): boolean
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).minimized
...
* get rendered(): boolean
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).rendered
...
* get state(): number
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).state
...
* get title(): string
  ...
  Overrides TokenApplicationMixin(ApplicationV2).title

### token

* get token(): [PrototypeToken](foundry.data.PrototypeToken.md)

  #### Returns [PrototypeToken](foundry.data.PrototypeToken.md)
...
* \_awaitTransition(element: HTMLElement, timeout: number): Promise<void>
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_awaitTransition
...
* \_canDetach(): boolean
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_canDetach
...
* \_canRender(options: any): false | void
  ...
  Overrides TokenApplicationMixin(ApplicationV2).\_canRender
...
* \_doEvent(  
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_doEvent
...
* \_initializeApplicationOptions(options: any): [ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md)
  ...
  Overrides TokenApplicationMixin(ApplicationV2).\_initializeApplicationOptions
...
* \_onChangeForm(formConfig: any, event: any): void
  ...
  Overrides TokenApplicationMixin(ApplicationV2).\_onChangeForm
...
* \_onClose(options: any): void
  ...
  Overrides TokenApplicationMixin(ApplicationV2).\_onClose
...
* \_onFirstRender(context: any, options: any): Promise<void>
  ...
  Overrides TokenApplicationMixin(ApplicationV2).\_onFirstRender
...
* \_onRender(context: any, options: any): Promise<void>
  ...
  Overrides TokenApplicationMixin(ApplicationV2).\_onRender
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â document: [PrototypeToken](foundry.data.PrototypeToken.md)  
  Â Â Â Â Â Â Â Â | null;  
  Â Â Â Â Â Â Â Â gridUnits: string;  
  Â Â Â Â Â Â Â Â model: [PrototypeToken](foundry.data.PrototypeToken.md) | null;  
  Â Â Â Â Â Â Â Â rootId: string;  
  Â Â Â Â Â Â Â Â source: [PrototypeTokenData](../types/foundry.documents.types.PrototypeTokenData.md);  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â [ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md) & { Â Â Â Â Â Â Â Â document: [PrototypeToken](foundry.data.PrototypeToken.md) Â Â Â Â Â Â Â Â | null; Â Â Â Â Â Â Â Â gridUnits: string; Â Â Â Â Â Â Â Â model: [PrototypeToken](foundry.data.PrototypeToken.md) | null; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â source: [PrototypeTokenData](../types/foundry.documents.types.PrototypeTokenData.md); Â Â Â Â }, >

  #### Inherit Doc

  Overrides TokenApplicationMixin(ApplicationV2).\_prepareContext
...
* \_renderHTML(  
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_renderHTML
...
* \_tearDown(options: any): void
  ...
  Overrides TokenApplicationMixin(ApplicationV2).\_tearDown
...
* addEventListener(  
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).addEventListener
...
* attachWindow(  
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).attachWindow
...
* bringToFront(): void
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).bringToFront
...
* close(  
  ...
  #### Returns Promise<PrototypeTokenConfig>

  A Promise which resolves to the closed Application instance

  Inherited from TokenApplicationMixin(ApplicationV2).close

### detachWindow

* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<PrototypeTokenConfig>
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).detachWindow
...
* dispatchEvent(event: Event): boolean
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).dispatchEvent
...
* maximize(): Promise<void>
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).maximize
...
* minimize(): Promise<void>
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).minimize
...
* removeEventListener(type: string, listener: [EmittedEventListener](../types/foundry.utils.types.EmittedEventListener.md)): void
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).removeEventListener
...
* render(  
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).render
...
* renderChild(  
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).renderChild
...
* setPosition(position?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void | [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).setPosition
...
* submit(submitOptions?: object): Promise<any>
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).submit
...
* \_attachFrameListeners(): void
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_attachFrameListeners
...
* \_canAttach(): boolean
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_canAttach
...
* \_configureRenderOptions(options: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): void
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_configureRenderOptions
...
* \_createContextMenu(  
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_createContextMenu
...
* \_getFrameButtons(  
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_getFrameButtons
...
* \_getHeaderControls(): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_getHeaderControls
...
* \_getTabsConfig(group: string): [ApplicationTabsConfiguration](../interfaces/foundry.applications.types.ApplicationTabsConfiguration.md) | null
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_getTabsConfig
...
* \_headerControlButtons(): Generator<[ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md), any, any>
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_headerControlButtons
...
* \_headerControlContextEntries(): Generator<[ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md), void, any>
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_headerControlContextEntries
...
* \_insertElement(  
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_insertElement
...
* \_onAttach(from: Document, to: Document): void
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_onAttach
...
* \_onClickAction(event: PointerEvent, target: HTMLElement): void
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_onClickAction
...
* \_onClickTab(event: PointerEvent): void
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_onClickTab
...
* \_onDetach(from: Document, to: Document): void
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_onDetach
...
* \_onPosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_onPosition
...
* \_onSubmitForm(  
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_onSubmitForm
...
* \_postRender(  
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_postRender
...
* \_preClose(options: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<void>
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_preClose
...
* \_preFirstRender(  
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_preFirstRender
...
* \_prepareTabs(group: string): Record<string, [ApplicationTab](../interfaces/foundry.applications.types.ApplicationTab.md)>
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_prepareTabs
...
* \_prePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_prePosition
...
* \_preRender(  
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_preRender
...
* \_refit(positionUpdate?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_refit
...
* \_removeElement(element: HTMLElement): void
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_removeElement
...
* \_renderFrame(options: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<HTMLElement>
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_renderFrame
...
* \_renderFrameButtons(options: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<void>
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_renderFrameButtons
...
* \_renderHeaderControl(control: [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)): HTMLLIElement
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_renderHeaderControl
...
* \_replaceHTML(  
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_replaceHTML
...
* \_updateFrame(options: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): void
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_updateFrame
...
* \_updatePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).\_updatePosition
...
* inheritanceChain(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), void, unknown>
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).inheritanceChain
...
* instances(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), any, any>
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).instances
...
* parseCSSDimension(style: string, parentDimension: number): number | void
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).parseCSSDimension
...
* waitForImages(element: HTMLElement): Promise<void>
  ...
  Inherited from TokenApplicationMixin(ApplicationV2).waitForImages