---
title: "CompendiumArtConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.apps.CompendiumArtConfig.html"
category: "classes"
---

# Class CompendiumArtConfig
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.apps.CompendiumArtConfig))
...
Â Â Â Â Â Â Â Â Â Â Â Â this: [ApplicationV2](foundry.applications.api.ApplicationV2.md)<  
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â [ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md),  
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md),  
Â Â Â Â Â Â Â Â Â Â Â Â >,  
Â Â Â Â Â Â Â Â Â Â Â Â \_event: MouseEvent,  
...
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md),  
Â Â Â Â Â Â Â Â Â Â Â Â >,  
Â Â Â Â Â Â Â Â Â Â Â Â \_event: SubmitEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â \_form: HTMLFormElement,  
...
Â Â Â Â priorities: { id: string; template: string };  
} = ...
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â config: [CompendiumArtDescriptor](../interfaces/foundry.helpers.types.CompendiumArtDescriptor.md)[];  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â buttons: { icon: string; label: string; type: string }[]; Â Â Â Â Â Â Â Â config: [CompendiumArtDescriptor](../interfaces/foundry.helpers.types.CompendiumArtDescriptor.md)[]; Â Â Â Â }, >
...
* close(  
  ...
  #### Returns Promise<CompendiumArtConfig>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<CompendiumArtConfig>
