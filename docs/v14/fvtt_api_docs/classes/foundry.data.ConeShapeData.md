---
title: "ConeShapeData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.ConeShapeData.html"
category: "classes"
---
...
Inherited from ClientShapeDataMixin(data.ConeShapeData).\_index
...
Inherited from ClientShapeDataMixin(data.ConeShapeData).\_source
...
Inherited from ClientShapeDataMixin(data.ConeShapeData).parent
...
Inherited from ClientShapeDataMixin(data.ConeShapeData).\_schema

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from ClientShapeDataMixin(data.ConeShapeData).LOCALIZATION\_PREFIXES
...
Inherited from ClientShapeDataMixin(data.ConeShapeData).TYPE
...
* get area(): number
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).area
...
* get bounds(): Rectangle
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).bounds
...
* get center(): Readonly<[Point](../interfaces/foundry.types.Point.md)>
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).center
...
* get clipperPaths(): readonly (readonly [DeepReadonly](../types/foundry.types.DeepReadonly.md)<[types](../modules/foundry.types.md).[ClipperPoint](../interfaces/foundry.types.ClipperPoint.md)>[])[]
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).clipperPaths
...
* get clipperPolyTree(): PolyTree
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).clipperPolyTree
...
* get controlHandles(): [DeepReadonly](../types/foundry.types.DeepReadonly.md)<  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).controlHandles
...
* get grid(): [BaseGrid](foundry.grid.BaseGrid.md)<[GridCoordinates2D](../types/foundry.grid.types.GridCoordinates2D.md), [GridCoordinates3D](../types/foundry.grid.types.GridCoordinates3D.md)>
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).grid
...
* get gridlessGrid(): [GridlessGrid](foundry.grid.GridlessGrid.md)
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).gridlessGrid
...
* get hasRotationalSymmetry(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).hasRotationalSymmetry
...
* get invalid(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).invalid
...
* get isAffectedByGrid(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).isAffectedByGrid
...
* get isEmpty(): boolean
  ...
  Overrides ClientShapeDataMixin(data.ConeShapeData).isEmpty
...
* get measuredSegments(): readonly [DeepReadonly](../types/foundry.types.DeepReadonly.md)<  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).measuredSegments
...
* get origin(): Readonly<[Point](../interfaces/foundry.types.Point.md)>
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).origin
...
* get polygons(): readonly Polygon[]
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).polygons
...
* get polygonTree(): [PolygonTree](foundry.data.PolygonTree.md)
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).polygonTree
...
* get scene(): [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md) | null
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).scene
...
* get schema(): [DataModelSchemaField](foundry.data.fields.DataModelSchemaField.md)
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).schema
...
* get triangulation(): Readonly<  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).triangulation
...
* get validationFailures(): {  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).validationFailures
...
* get TYPES(): Readonly<  
  ...
  Â Â Â Â Â Â Â Â cone: [data](../modules/foundry.data.md).ConeShapeData;  
  ...
  #### Returns Readonly< Â Â Â Â { Â Â Â Â Â Â Â Â circle: [data](../modules/foundry.data.md).[CircleShapeData](foundry.data.CircleShapeData.md); Â Â Â Â Â Â Â Â cone: [data](../modules/foundry.data.md).ConeShapeData; Â Â Â Â Â Â Â Â ellipse: [data](../modules/foundry.data.md).[EllipseShapeData](foundry.data.EllipseShapeData.md); Â Â Â Â Â Â Â Â emanation: [EmanationShapeData](foundry.data.EmanationShapeData.md); Â Â Â Â Â Â Â Â grid: [GridShapeData](foundry.data.GridShapeData.md); Â Â Â Â Â Â Â Â line: [LineShapeData](foundry.data.LineShapeData.md); Â Â Â Â Â Â Â Â polygon: [data](../modules/foundry.data.md).[PolygonShapeData](foundry.data.PolygonShapeData.md); Â Â Â Â Â Â Â Â rectangle: [data](../modules/foundry.data.md).[RectangleShapeData](foundry.data.RectangleShapeData.md); Â Â Â Â Â Â Â Â ring: [RingShapeData](foundry.data.RingShapeData.md); Â Â Â Â Â Â Â Â token: [TokenShapeData](foundry.data.TokenShapeData.md); Â Â Â Â }, >

  Inherited from ClientShapeDataMixin(data.ConeShapeData).TYPES
...
* \_calculateArea(): number
  ...
  Overrides ClientShapeDataMixin(data.ConeShapeData).\_calculateArea
...
* \_calculateSize(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_calculateSize
...
* \_createCenter(): any
  ...
  Overrides ClientShapeDataMixin(data.ConeShapeData).\_createCenter
...
* \_createClipperPolyTree(): any
  ...
  Overrides ClientShapeDataMixin(data.ConeShapeData).\_createClipperPolyTree

### \_createControlHandles

* \_createControlHandles(): {  
  Â Â Â Â rotate: { position: Point; rotation: number; visible: boolean };  
  Â Â Â Â scale: { position: Point; rotation: number; visible: boolean };  
  Â Â Â Â sweep: { position: Object; rotation: number; visible: boolean };  
  Â Â Â Â translate: { position: Point; rotation: number; visible: boolean };  
  }

  #### Returns { Â Â Â Â rotate: { position: Point; rotation: number; visible: boolean }; Â Â Â Â scale: { position: Point; rotation: number; visible: boolean }; Â Â Â Â sweep: { position: Object; rotation: number; visible: boolean }; Â Â Â Â translate: { position: Point; rotation: number; visible: boolean }; }

  Overrides ClientShapeDataMixin(data.ConeShapeData).\_createControlHandles
...
* \_createMeasuredSegment(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_createMeasuredSegment
...
* \_createMeasuredSegments(): {  
  ...
  Â Â Â Â winding: number;  
  }[]

  #### Returns { angle: any; distance: number; ray: [Ray](foundry.canvas.geometry.Ray.md); winding: number }[]

  Overrides ClientShapeDataMixin(data.ConeShapeData).\_createMeasuredSegments
...
* \_createRay(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_createRay

### \_getRays

* \_getRays(): { center: [Ray](foundry.canvas.geometry.Ray.md); left: [Ray](foundry.canvas.geometry.Ray.md); right: [Ray](foundry.canvas.geometry.Ray.md) }

  `Internal`

  Get the left, center, and right rays of this cone.

  #### Returns { center: [Ray](foundry.canvas.geometry.Ray.md); left: [Ray](foundry.canvas.geometry.Ray.md); right: [Ray](foundry.canvas.geometry.Ray.md) }
...
* \_getSnappedPoint(point: [Point](../interfaces/foundry.types.Point.md)): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_getSnappedPoint
...
* \_getSnappedRotation(rotation: number): number
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_getSnappedRotation
...
* \_moveRotationHandle(direction: number, destination: [Point](../interfaces/foundry.types.Point.md), snap: boolean): void
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_moveRotationHandle
...
* \_moveScaleHandle(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_moveScaleHandle
...
* \_moveSweepHandle(maxAngle: number, destination: [Point](../interfaces/foundry.types.Point.md), snap: boolean): void
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_moveSweepHandle
...
* \_onDragMove(event: any): void
  ...
  Overrides ClientShapeDataMixin(data.ConeShapeData).\_onDragMove
...
* \_onDragStart(event: FederatedEvent<UIEvent | PixiTouch>): void
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_onDragStart
...
* \_onShapeChange(): void
  ...
  Overrides ClientShapeDataMixin(data.ConeShapeData).\_onShapeChange
...
* \_updateCommit(copy: any, diff: any, options: any, state: any): void
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_updateCommit
...
* clone(  
  ...
  Overrides ClientShapeDataMixin(data.ConeShapeData).clone
...
* drawReferenceLines(graphics: Graphics): void
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).drawReferenceLines
...
* drawShape(graphics: Graphics): void
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).drawShape
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).getFieldForProperty
...
* move(origin: [Point](../interfaces/foundry.types.Point.md), options?: { snap?: boolean }): void
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).move
...
* moveControlHandle(  
  ...
  Overrides ClientShapeDataMixin(data.ConeShapeData).moveControlHandle
...
* reset(): void
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).reset
...
* rotate(angle: number, options?: { pivot?: [Point](../interfaces/foundry.types.Point.md) }): void
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).rotate
...
* sampleBoundary(out?: [Point](../interfaces/foundry.types.Point.md)): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).sampleBoundary
...
* sampleInterior(out?: [Point](../interfaces/foundry.types.Point.md)): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).sampleInterior
...
* testPoint(point: [Point](../interfaces/foundry.types.Point.md)): boolean
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).testPoint
...
* toJSON(): object
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).toJSON
...
* toObject(source?: boolean): object
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).toObject
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).updateSource
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).validate
...
* \_configure(options?: object): void
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_configure
...
* \_createOrigin(): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_createOrigin
...
* \_getInnerModel(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_getInnerModel
...
* \_initializationOrder(): Generator<[string, [DataField](foundry.data.fields.DataField.md)], any, any>
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_initializationOrder
...
* \_initialize(options?: object): void
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_initialize
...
* \_initializeSource(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_initializeSource
...
* \_onGridChange(changed: object): void
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_onGridChange
...
* \_preUpdateSource(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_preUpdateSource
...
* \_rotate(angle: number): void
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_rotate
...
* \_updateDiff(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_updateDiff
...
* \_toClipperPath(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_toClipperPath
...
* cleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).cleanData
...
* defineSchema(): { hole: [BooleanField](foundry.data.fields.BooleanField.md); type: [StringField](foundry.data.fields.StringField.md) }
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).defineSchema
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).fromJSON
...
* fromSource(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).fromSource
...
* migrateData(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).migrateData
...
* migrateDataSafe(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).migrateDataSafe
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).shimData
...
* validateJoint(data: object): void
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).validateJoint
...
* \_cleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_cleanData
...
* \_preCleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.ConeShapeData).\_preCleanData