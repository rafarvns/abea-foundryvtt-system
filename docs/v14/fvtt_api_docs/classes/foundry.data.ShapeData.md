---
title: "ShapeData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.ShapeData.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.ShapeData))
...
* new ShapeData(data?: object, options?: [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)): ShapeData
...
TYPES: { CIRCLE: string; ELLIPSE: string; POLYGON: string; RECTANGLE: string } = ...
...
* defineSchema(): {  
  ...
  #### Returns { Â Â Â Â height: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â points: [ArrayField](foundry.data.fields.ArrayField.md)<[NumberField](foundry.data.fields.NumberField.md)>; Â Â Â Â radius: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â type: [StringField](foundry.data.fields.StringField.md); Â Â Â Â width: [NumberField](foundry.data.fields.NumberField.md); }
