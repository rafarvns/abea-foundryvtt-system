---
title: "FogExploration | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.FogExploration.html"
category: "classes"
---
...
[foundry.documents.collections.FogExplorations](foundry.documents.collections.FogExplorations.md): The world-level collection of
FogExploration documents

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.FogExploration))

* [BaseFogExploration](foundry.documents.BaseFogExploration.md)<this>
  + FogExploration
...
* new FogExploration(  
  Â Â Â Â data?: Partial<[FogExplorationData](../interfaces/foundry.documents.types.FogExplorationData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).FogExploration

  #### Parameters

  + `Optional`data: Partial<[FogExplorationData](../interfaces/foundry.documents.types.FogExplorationData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).FogExploration

  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[constructor](foundry.documents.BaseFogExploration.md#constructor)

## Properties

### \_source

\_source: [FogExplorationData](../interfaces/foundry.documents.types.FogExplorationData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_source](foundry.documents.BaseFogExploration.md#_source)
...
Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[parent](foundry.documents.BaseFogExploration.md#parent)
...
Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_schema](foundry.documents.BaseFogExploration.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseFogExploration.md#localization_prefixes)
...
Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[metadata](foundry.documents.BaseFogExploration.md#metadata)
...
* get compendium(): any
  ...
  Inherited from ClientDocumentMixin(BaseFogExploration).compendium
...
* get validationFailures(): {  
  ...
  Inherited from ClientDocumentMixin(BaseFogExploration).validationFailures
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_configure](foundry.documents.BaseFogExploration.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_getParentCollection](foundry.documents.BaseFogExploration.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_initializationOrder](foundry.documents.BaseFogExploration.md#_initializationorder)
...
* \_onCreate(data: any, options: any, userId: any): void
  ...
  Overrides [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_onCreate](foundry.documents.BaseFogExploration.md#_oncreate)
...
* \_onDelete(options: any, userId: any): void
  ...
  Overrides [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_onDelete](foundry.documents.BaseFogExploration.md#_ondelete)
...
* \_onUpdate(changed: any, options: any, userId: any): void
  ...
  Overrides [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_onUpdate](foundry.documents.BaseFogExploration.md#_onupdate)
...
* \_preUpdate(changed: any, options: any, user: any): Promise<false | undefined>
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_preUpdate](foundry.documents.BaseFogExploration.md#_preupdate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_updateDiff](foundry.documents.BaseFogExploration.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[canUserModify](foundry.documents.BaseFogExploration.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[clone](foundry.documents.BaseFogExploration.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[createEmbeddedDocuments](foundry.documents.BaseFogExploration.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[delete](foundry.documents.BaseFogExploration.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[deleteEmbeddedDocuments](foundry.documents.BaseFogExploration.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[getEmbeddedCollection](foundry.documents.BaseFogExploration.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[getEmbeddedDocument](foundry.documents.BaseFogExploration.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[getFieldForProperty](foundry.documents.BaseFogExploration.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[getFlag](foundry.documents.BaseFogExploration.md#getflag)

### getTexture

* getTexture(): Texture<Resource> | null
...
* getUserLevel(user?: [BaseUser](foundry.documents.BaseUser.md)): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.md)
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[getUserLevel](foundry.documents.BaseFogExploration.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[migrateSystemData](foundry.documents.BaseFogExploration.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[reset](foundry.documents.BaseFogExploration.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[setFlag](foundry.documents.BaseFogExploration.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[testUserPermission](foundry.documents.BaseFogExploration.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[toJSON](foundry.documents.BaseFogExploration.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[toObject](foundry.documents.BaseFogExploration.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[traverseEmbeddedDocuments](foundry.documents.BaseFogExploration.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[unsetFlag](foundry.documents.BaseFogExploration.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[update](foundry.documents.BaseFogExploration.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[updateEmbeddedDocuments](foundry.documents.BaseFogExploration.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[updateSource](foundry.documents.BaseFogExploration.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[validate](foundry.documents.BaseFogExploration.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_getInnerModel](foundry.documents.BaseFogExploration.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_initialize](foundry.documents.BaseFogExploration.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_initializeSource](foundry.documents.BaseFogExploration.md#_initializesource)
...
* \_preCreate(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_preCreate](foundry.documents.BaseFogExploration.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_preDelete](foundry.documents.BaseFogExploration.md#_predelete)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_preUpdateSource](foundry.documents.BaseFogExploration.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_updateCommit](foundry.documents.BaseFogExploration.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_addDataFieldMigration](foundry.documents.BaseFogExploration.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_addDataFieldShim](foundry.documents.BaseFogExploration.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_addDataFieldShims](foundry.documents.BaseFogExploration.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_clearFieldsRecursively](foundry.documents.BaseFogExploration.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_logDataFieldMigration](foundry.documents.BaseFogExploration.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_preCleanData](foundry.documents.BaseFogExploration.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[canUserCreate](foundry.documents.BaseFogExploration.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[cleanData](foundry.documents.BaseFogExploration.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[create](foundry.documents.BaseFogExploration.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[createDocuments](foundry.documents.BaseFogExploration.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â explored: [FilePathField](foundry.data.fields.FilePathField.md);  
  Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md);  
  Â Â Â Â level: [DocumentIdField](foundry.data.fields.DocumentIdField.md);  
  Â Â Â Â positions: [ObjectField](foundry.data.fields.ObjectField.md);  
  ...
  Â Â Â Â user: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md);  
  }
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â explored: [FilePathField](foundry.data.fields.FilePathField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â level: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â positions: [ObjectField](foundry.data.fields.ObjectField.md); Â Â Â Â scene: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); Â Â Â Â timestamp: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â user: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); }
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[defineSchema](foundry.documents.BaseFogExploration.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[deleteDocuments](foundry.documents.BaseFogExploration.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[fromJSON](foundry.documents.BaseFogExploration.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[fromSource](foundry.documents.BaseFogExploration.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[get](foundry.documents.BaseFogExploration.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[getCollectionName](foundry.documents.BaseFogExploration.md#getcollectionname)

### `Static`load

* load(  
  Â Â Â Â query?: { scene?: any; user?: any },  
  Â Â Â Â options?: object,  
  ): Promise<[documents](../modules/foundry.documents.md).FogExploration | null>

  Obtain the fog of war exploration progress for a specific Scene, Level, and User.

  #### Parameters

  + `Optional`query: { scene?: any; user?: any } = {}
  + `Optional`options: object = {}

  #### Returns Promise<[documents](../modules/foundry.documents.md).FogExploration | null>
...
* migrateData(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[migrateData](foundry.documents.BaseFogExploration.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[migrateDataSafe](foundry.documents.BaseFogExploration.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[shimData](foundry.documents.BaseFogExploration.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[updateDocuments](foundry.documents.BaseFogExploration.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[validateJoint](foundry.documents.BaseFogExploration.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_cleanData](foundry.documents.BaseFogExploration.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_onCreateOperation](foundry.documents.BaseFogExploration.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_onDeleteOperation](foundry.documents.BaseFogExploration.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_onUpdateOperation](foundry.documents.BaseFogExploration.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_preCreateOperation](foundry.documents.BaseFogExploration.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_preDeleteOperation](foundry.documents.BaseFogExploration.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseFogExploration](foundry.documents.BaseFogExploration.md).[\_preUpdateOperation](foundry.documents.BaseFogExploration.md#_preupdateoperation)