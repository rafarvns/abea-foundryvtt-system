---
title: "VFXSingleImpactComponent | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.vfx.components.VFXSingleImpactComponent.html"
category: "classes"
---

# Class VFXSingleImpactComponent
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.vfx.components.VFXSingleImpactComponent))
...
* new VFXSingleImpactComponent(  
  Â Â Â Â data?: Partial<[VFXSingleImpactData](../interfaces/foundry.VFXSingleImpactData.md)>,  
  Â Â Â Â options?: any,  
  ): VFXSingleImpactComponent

  #### Parameters

  + `Optional`data: Partial<[VFXSingleImpactData](../interfaces/foundry.VFXSingleImpactData.md)> = {}
  ...
  #### Returns VFXSingleImpactComponent
...
\_source: [VFXSingleImpactData](../interfaces/foundry.VFXSingleImpactData.md)
...
* defineSchema(): {  
  Â Â Â Â animations: [ArrayField](foundry.data.fields.ArrayField.md)<[SchemaField](foundry.data.fields.SchemaField.md)>;  
  Â Â Â Â duration: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â position: [VFXReferenceObjectField](foundry.canvas.vfx.fields.VFXReferenceObjectField.md)<any>;  
  Â Â Â Â scale: [VFXReferencePointField](foundry.canvas.vfx.fields.VFXReferencePointField.md);  
  Â Â Â Â size: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md);  
  Â Â Â Â sound: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â texture: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â type: [StringField](foundry.data.fields.StringField.md);  
  }

  #### Returns { Â Â Â Â animations: [ArrayField](foundry.data.fields.ArrayField.md)<[SchemaField](foundry.data.fields.SchemaField.md)>; Â Â Â Â duration: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â position: [VFXReferenceObjectField](foundry.canvas.vfx.fields.VFXReferenceObjectField.md)<any>; Â Â Â Â scale: [VFXReferencePointField](foundry.canvas.vfx.fields.VFXReferencePointField.md); Â Â Â Â size: [VFXReferenceField](foundry.canvas.vfx.fields.VFXReferenceField.md); Â Â Â Â sound: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â texture: [StringField](foundry.data.fields.StringField.md); Â Â Â Â type: [StringField](foundry.data.fields.StringField.md); }
