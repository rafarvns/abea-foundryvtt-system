---
title: "VFXSingleAttackComponent | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.vfx.components.VFXSingleAttackComponent.html"
category: "classes"
---

# Class VFXSingleAttackComponent
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.vfx.components.VFXSingleAttackComponent))
...
[validate](#validate)
[\_animateCharge](#_animatecharge)
[\_animateImpact](#_animateimpact)
[\_animateProjectile](#_animateprojectile)
[\_attach](#_attach)
[\_configure](#_configure)
[\_getInnerModel](#_getinnermodel)
[\_getTimings](#_gettimings)
...
* new VFXSingleAttackComponent(  
  Â Â Â Â data?: Partial<[VFXSingleAttackData](../types/foundry.VFXSingleAttackData.md)>,  
  Â Â Â Â options?: any,  
  ): VFXSingleAttackComponent

  #### Parameters

  + `Optional`data: Partial<[VFXSingleAttackData](../types/foundry.VFXSingleAttackData.md)> = {}
  ...
  #### Returns VFXSingleAttackComponent
...
\_source: [VFXSingleAttackData](../types/foundry.VFXSingleAttackData.md)
...
destination: [VFXBasePathPoint](../interfaces/foundry.VFXBasePathPoint.md)
...
origin: [VFXBasePathPoint](../interfaces/foundry.VFXBasePathPoint.md)
...
STEPS: [VFXSingleAttackStepName](../types/foundry.VFXSingleAttackStepName.md)[] = ...

The steps of the single attack sequence.

### `Static`TYPE

TYPE: string = "singleAttack"
...
* \_destroy(): void
  ...
  Overrides [VFXComponent](foundry.canvas.vfx.VFXComponent.md).[\_destroy](foundry.canvas.vfx.VFXComponent.md#_destroy)
...
### `Protected`\_animateCharge

* \_animateCharge(timings: Record<string, number>): void
...
### `Protected`\_animateImpact

* \_animateImpact(timings: Record<string, number>): void
...
### `Protected`\_animateProjectile

* \_animateProjectile(timings: Record<string, number>): void
...
### `Protected`\_getTimings

* \_getTimings(): Record<string, number>
...
* defineSchema(): {  
  Â Â Â Â charge: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â impact: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â path: [ArrayField](foundry.data.fields.ArrayField.md)<[VFXReferenceObjectField](foundry.canvas.vfx.fields.VFXReferenceObjectField.md)<any>>;  
  Â Â Â Â pathType: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â projectile: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â type: [StringField](foundry.data.fields.StringField.md);  
  }

  #### Returns { Â Â Â Â charge: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â impact: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â path: [ArrayField](foundry.data.fields.ArrayField.md)<[VFXReferenceObjectField](foundry.canvas.vfx.fields.VFXReferenceObjectField.md)<any>>; Â Â Â Â pathType: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â projectile: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â type: [StringField](foundry.data.fields.StringField.md); }
