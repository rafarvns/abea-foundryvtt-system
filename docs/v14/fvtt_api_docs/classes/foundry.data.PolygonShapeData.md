...
url: "https://foundryvtt.com/api/v14/classes/foundry.data.PolygonShapeData.html"
category: "classes"
---
...
Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_index
...
Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_source
...
Inherited from ClientShapeDataMixin(data.PolygonShapeData).parent
...
Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_schema

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from ClientShapeDataMixin(data.PolygonShapeData).LOCALIZATION\_PREFIXES
...
Inherited from ClientShapeDataMixin(data.PolygonShapeData).TYPE
...
* get area(): number
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).area
...
* get bounds(): Rectangle
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).bounds
...
* get center(): Readonly<[Point](../interfaces/foundry.types.Point.md)>
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).center
...
* get clipperPaths(): readonly (readonly [DeepReadonly](../types/foundry.types.DeepReadonly.md)<[types](../modules/foundry.types.md).[ClipperPoint](../interfaces/foundry.types.ClipperPoint.md)>[])[]
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).clipperPaths
...
* get clipperPolyTree(): PolyTree
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).clipperPolyTree
...
* get controlHandles(): [DeepReadonly](../types/foundry.types.DeepReadonly.md)<  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).controlHandles
...
* get grid(): [BaseGrid](foundry.grid.BaseGrid.md)<[GridCoordinates2D](../types/foundry.grid.types.GridCoordinates2D.md), [GridCoordinates3D](../types/foundry.grid.types.GridCoordinates3D.md)>
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).grid
...
* get gridlessGrid(): [GridlessGrid](foundry.grid.GridlessGrid.md)
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).gridlessGrid
...
* get hasRotationalSymmetry(): boolean
  ...
  Overrides ClientShapeDataMixin(data.PolygonShapeData).hasRotationalSymmetry
...
* get invalid(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).invalid
...
* get isAffectedByGrid(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).isAffectedByGrid
...
* get isEmpty(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).isEmpty
...
* get measuredSegments(): readonly [DeepReadonly](../types/foundry.types.DeepReadonly.md)<  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).measuredSegments
...
* get origin(): Readonly<[Point](../interfaces/foundry.types.Point.md)>
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).origin
...
* get polygons(): readonly Polygon[]
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).polygons
...
* get polygonTree(): [PolygonTree](foundry.data.PolygonTree.md)
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).polygonTree
...
* get scene(): [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md) | null
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).scene
...
* get schema(): [DataModelSchemaField](foundry.data.fields.DataModelSchemaField.md)
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).schema
...
* get triangulation(): Readonly<  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).triangulation
...
* get validationFailures(): {  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).validationFailures
...
* get TYPES(): Readonly<  
  ...
  Â Â Â Â Â Â Â Â polygon: [data](../modules/foundry.data.md).PolygonShapeData;  
  ...
  #### Returns Readonly< Â Â Â Â { Â Â Â Â Â Â Â Â circle: [data](../modules/foundry.data.md).[CircleShapeData](foundry.data.CircleShapeData.md); Â Â Â Â Â Â Â Â cone: [data](../modules/foundry.data.md).[ConeShapeData](foundry.data.ConeShapeData.md); Â Â Â Â Â Â Â Â ellipse: [data](../modules/foundry.data.md).[EllipseShapeData](foundry.data.EllipseShapeData.md); Â Â Â Â Â Â Â Â emanation: [EmanationShapeData](foundry.data.EmanationShapeData.md); Â Â Â Â Â Â Â Â grid: [GridShapeData](foundry.data.GridShapeData.md); Â Â Â Â Â Â Â Â line: [LineShapeData](foundry.data.LineShapeData.md); Â Â Â Â Â Â Â Â polygon: [data](../modules/foundry.data.md).PolygonShapeData; Â Â Â Â Â Â Â Â rectangle: [data](../modules/foundry.data.md).[RectangleShapeData](foundry.data.RectangleShapeData.md); Â Â Â Â Â Â Â Â ring: [RingShapeData](foundry.data.RingShapeData.md); Â Â Â Â Â Â Â Â token: [TokenShapeData](foundry.data.TokenShapeData.md); Â Â Â Â }, >

  Inherited from ClientShapeDataMixin(data.PolygonShapeData).TYPES
...
* \_calculateSize(  
  ...
  Â Â Â Â Â Â Â Â allowZero?: boolean;  
  Â Â Â Â Â Â Â Â round?: boolean;  
  ...
  + length: any
  + direction: any
  + \_\_namedParameters: { allowZero?: boolean; round?: boolean; snap?: boolean } = {}

  #### Returns number

  Overrides ClientShapeDataMixin(data.PolygonShapeData).\_calculateSize
...
* \_createClipperPolyTree(): any
  ...
  Overrides ClientShapeDataMixin(data.PolygonShapeData).\_createClipperPolyTree
...
* \_createControlHandles(): {  
  ...
  #### Returns { Â Â Â Â rotate: { position: Point; rotation: number; visible: boolean }; Â Â Â Â scale: { position: Point; rotation: number; visible: boolean }; Â Â Â Â translate: { position: Point; rotation: number; visible: boolean }; }

  Overrides ClientShapeDataMixin(data.PolygonShapeData).\_createControlHandles
...
* \_createMeasuredSegment(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_createMeasuredSegment

### \_createMeasuredSegments

* \_createMeasuredSegments(): never[]

  #### Returns never[]

  Overrides ClientShapeDataMixin(data.PolygonShapeData).\_createMeasuredSegments
...
* \_createOrigin(): any
  ...
  Overrides ClientShapeDataMixin(data.PolygonShapeData).\_createOrigin
...
* \_createRay(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_createRay

### \_getSnappedPoint

* \_getSnappedPoint(point: any): [Point](../interfaces/foundry.types.Point.md)
  ...
  Overrides ClientShapeDataMixin(data.PolygonShapeData).\_getSnappedPoint
...
* \_getSnappedRotation(rotation: number): number
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_getSnappedRotation
...
* \_moveRotationHandle(direction: number, destination: [Point](../interfaces/foundry.types.Point.md), snap: boolean): void
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_moveRotationHandle
...
* \_moveScaleHandle(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_moveScaleHandle
...
* \_moveSweepHandle(maxAngle: number, destination: [Point](../interfaces/foundry.types.Point.md), snap: boolean): void
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_moveSweepHandle
...
* \_onDragMove(event: any): void
  ...
  Overrides ClientShapeDataMixin(data.PolygonShapeData).\_onDragMove
...
* \_onDragStart(event: any): void
  ...
  Overrides ClientShapeDataMixin(data.PolygonShapeData).\_onDragStart
...
* \_rotate(angle: any): void
  ...
  Overrides ClientShapeDataMixin(data.PolygonShapeData).\_rotate
...
* \_updateCommit(copy: any, diff: any, options: any, state: any): void
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_updateCommit
...
* clone(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).clone
...
* drawReferenceLines(graphics: Graphics): void
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).drawReferenceLines
...
* drawShape(graphics: Graphics): void
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).drawShape
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).getFieldForProperty

### move

* move(origin: any, \_\_namedParameters?: { snap?: boolean }): void
  ...
  Overrides ClientShapeDataMixin(data.PolygonShapeData).move
...
* moveControlHandle(  
  ...
  Overrides ClientShapeDataMixin(data.PolygonShapeData).moveControlHandle
...
* reset(): void
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).reset
...
* rotate(angle: number, options?: { pivot?: [Point](../interfaces/foundry.types.Point.md) }): void
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).rotate
...
* sampleBoundary(out?: [Point](../interfaces/foundry.types.Point.md)): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).sampleBoundary
...
* sampleInterior(out?: [Point](../interfaces/foundry.types.Point.md)): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).sampleInterior
...
* testPoint(point: [Point](../interfaces/foundry.types.Point.md)): boolean
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).testPoint
...
* toJSON(): object
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).toJSON
...
* toObject(source?: boolean): object
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).toObject
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).updateSource
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).validate
...
* \_calculateArea(): number
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_calculateArea
...
* \_configure(options?: object): void
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_configure
...
* \_createCenter(): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_createCenter
...
* \_getInnerModel(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_getInnerModel
...
* \_initializationOrder(): Generator<[string, [DataField](foundry.data.fields.DataField.md)], any, any>
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_initializationOrder
...
* \_initialize(options?: object): void
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_initialize
...
* \_initializeSource(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_initializeSource
...
* \_onGridChange(changed: object): void
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_onGridChange
...
* \_onShapeChange(): void
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_onShapeChange
...
* \_preUpdateSource(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_preUpdateSource
...
* \_updateDiff(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_updateDiff
...
* \_toClipperPath(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_toClipperPath
...
* cleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).cleanData
...
* defineSchema(): { hole: [BooleanField](foundry.data.fields.BooleanField.md); type: [StringField](foundry.data.fields.StringField.md) }
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).defineSchema
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).fromJSON
...
* fromSource(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).fromSource
...
* migrateData(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).migrateData
...
* migrateDataSafe(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).migrateDataSafe
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).shimData
...
* validateJoint(data: object): void
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).validateJoint
...
* \_cleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_cleanData
...
* \_preCleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.PolygonShapeData).\_preCleanData