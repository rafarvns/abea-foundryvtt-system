---
title: "ForeignDocumentField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.ForeignDocumentField.html"
category: "classes"
---

# Class ForeignDocumentField

A special class of [foundry.data.fields.StringField](foundry.data.fields.StringField.md) field which references another DataModel by its id.
This field may also be null to indicate that no foreign model is linked.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.ForeignDocumentField))

* [DocumentIdField](foundry.data.fields.DocumentIdField.md)
  + ForeignDocumentField
    - [DocumentAuthorField](foundry.data.fields.DocumentAuthorField.md)
...
* new ForeignDocumentField(  
  ...
  #### Returns ForeignDocumentField

  Overrides [DocumentIdField](foundry.data.fields.DocumentIdField.md).[constructor](foundry.data.fields.DocumentIdField.md#constructor)
...
Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[name](foundry.data.fields.DocumentIdField.md#name)
...
Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[options](foundry.data.fields.DocumentIdField.md#options)
...
Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[parent](foundry.data.fields.DocumentIdField.md#parent)
...
Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[persisted](foundry.data.fields.DocumentIdField.md#persisted)
...
Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[textSearch](foundry.data.fields.DocumentIdField.md#textsearch)
...
Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[trim](foundry.data.fields.DocumentIdField.md#trim)
...
Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[hierarchical](foundry.data.fields.DocumentIdField.md#hierarchical)
...
Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[recursive](foundry.data.fields.DocumentIdField.md#recursive)
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & {  
  ...
  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { Â Â Â Â blank: boolean; Â Â Â Â choices: undefined; Â Â Â Â textSearch: boolean; Â Â Â Â trim: boolean; } & { Â Â Â Â blank: boolean; Â Â Â Â nullable: boolean; Â Â Â Â readonly: boolean; Â Â Â Â required: boolean; Â Â Â Â validationError: string; } & { idOnly: boolean; nullable: boolean; readonly: boolean }
...
* \_applyChangeSubtract(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_applyChangeSubtract](foundry.data.fields.DocumentIdField.md#_applychangesubtract)
...
* \_cast(value: any): any
  ...
  Overrides [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_cast](foundry.data.fields.DocumentIdField.md#_cast)
...
* \_replaceDataRefs(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_replaceDataRefs](foundry.data.fields.DocumentIdField.md#_replacedatarefs)
...
* \_toInput(config: any): HTMLSelectElement
  ...
  Overrides [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_toInput](foundry.data.fields.DocumentIdField.md#_toinput)
...
* \_updateCommit(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_updateCommit](foundry.data.fields.DocumentIdField.md#_updatecommit)
...
* \_updateDiff(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_updateDiff](foundry.data.fields.DocumentIdField.md#_updatediff)
...
* \_validateModel(data: object, options?: object): void
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_validateModel](foundry.data.fields.DocumentIdField.md#_validatemodel)
...
* \_validateSpecial(value: any): boolean | void
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_validateSpecial](foundry.data.fields.DocumentIdField.md#_validatespecial)
...
* \_validateType(value: any, \_options: any): void
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_validateType](foundry.data.fields.DocumentIdField.md#_validatetype)
...
* apply(fn: string | Function, value: any, options?: object): object
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[apply](foundry.data.fields.DocumentIdField.md#apply)
...
* applyChange<[T](#applychanget)>(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[applyChange](foundry.data.fields.DocumentIdField.md#applychange)
...
* clean(value: any, options: any, \_state: any): any
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[clean](foundry.data.fields.DocumentIdField.md#clean)
...
* getInitialValue(source: any): any
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[getInitialValue](foundry.data.fields.DocumentIdField.md#getinitialvalue)
...
* initialize(value: any, model: any, options?: {}): any
  ...
  Overrides [DocumentIdField](foundry.data.fields.DocumentIdField.md).[initialize](foundry.data.fields.DocumentIdField.md#initialize)
...
* toFormGroup(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[toFormGroup](foundry.data.fields.DocumentIdField.md#toformgroup)
...
* toInput(config?: [FormInputConfig](../interfaces/foundry.data.types.FormInputConfig.md)): HTMLElement | HTMLCollection | HTMLElement[]
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[toInput](foundry.data.fields.DocumentIdField.md#toinput)
...
* toObject(value: any): any
  ...
  Overrides [DocumentIdField](foundry.data.fields.DocumentIdField.md).[toObject](foundry.data.fields.DocumentIdField.md#toobject)
...
* validate(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[validate](foundry.data.fields.DocumentIdField.md#validate)
...
* validators(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[validators](foundry.data.fields.DocumentIdField.md#validators)
...
* \_applyChangeAdd(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_applyChangeAdd](foundry.data.fields.DocumentIdField.md#_applychangeadd)
...
* \_applyChangeCustom(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_applyChangeCustom](foundry.data.fields.DocumentIdField.md#_applychangecustom)
...
* \_applyChangeDowngrade(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_applyChangeDowngrade](foundry.data.fields.DocumentIdField.md#_applychangedowngrade)
...
* \_applyChangeMultiply(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_applyChangeMultiply](foundry.data.fields.DocumentIdField.md#_applychangemultiply)
...
* \_applyChangeOverride(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_applyChangeOverride](foundry.data.fields.DocumentIdField.md#_applychangeoverride)
...
* \_applyChangeUpgrade(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_applyChangeUpgrade](foundry.data.fields.DocumentIdField.md#_applychangeupgrade)
...
* \_castChangeDelta(delta: any, replacementData?: object): any
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_castChangeDelta](foundry.data.fields.DocumentIdField.md#_castchangedelta)
...
* \_cleanType(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_cleanType](foundry.data.fields.DocumentIdField.md#_cleantype)
...
* \_getField(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_getField](foundry.data.fields.DocumentIdField.md#_getfield)
...
* \_isValidChoice(value: string): boolean
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_isValidChoice](foundry.data.fields.DocumentIdField.md#_isvalidchoice)
...
* \_migrate(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_migrate](foundry.data.fields.DocumentIdField.md#_migrate)
...
* \_validateRecursive(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_validateRecursive](foundry.data.fields.DocumentIdField.md#_validaterecursive)
...
* \_prepareChoiceConfig(  
  ...
  Inherited from [DocumentIdField](foundry.data.fields.DocumentIdField.md).[\_prepareChoiceConfig](foundry.data.fields.DocumentIdField.md#_preparechoiceconfig)