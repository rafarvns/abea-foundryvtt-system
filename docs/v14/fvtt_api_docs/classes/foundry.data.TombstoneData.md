---
title: "TombstoneData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.TombstoneData.html"
category: "classes"
---

# Class TombstoneData

A minimal data model used to represent a tombstone entry inside an [foundry.abstract.EmbeddedCollectionDelta](foundry.abstract.EmbeddedCollectionDelta.md).

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.TombstoneData))
...
* defineSchema(): { \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); \_tombstone: [BooleanField](foundry.data.fields.BooleanField.md) }

  #### Returns { \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); \_tombstone: [BooleanField](foundry.data.fields.BooleanField.md) }
