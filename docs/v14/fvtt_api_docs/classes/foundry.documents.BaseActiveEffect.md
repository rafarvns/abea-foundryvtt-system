---
title: "BaseActiveEffect | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.BaseActiveEffect.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.BaseActiveEffect))

* [Document](foundry.abstract.Document.md)
  + BaseActiveEffect
    - [documents](../modules/foundry.documents.md).[ActiveEffect](foundry.documents.ActiveEffect.md)
...
* \_preCreate(data: any, options: any, user: any): Promise<false | undefined>
  ...
  Overrides [Document](foundry.abstract.Document.md).[\_preCreate](foundry.abstract.Document.md#_precreate)
...
* migrateData(source: any, options: any): object
  ...
  Overrides [Document](foundry.abstract.Document.md).[migrateData](foundry.abstract.Document.md#migratedata)
...
* shimData(data: any, options: any): object
  ...
  Overrides [Document](foundry.abstract.Document.md).[shimData](foundry.abstract.Document.md#shimdata)
