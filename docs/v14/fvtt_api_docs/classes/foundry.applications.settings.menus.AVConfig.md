---
title: "AVConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.settings.menus.AVConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.settings.menus.AVConfig))
...
* new AVConfig(  
  Â Â Â Â options: [ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [AVConfigConfiguration](../interfaces/foundry.AVConfigConfiguration.md),  
  ): AVConfig

  #### Parameters

  + options: [ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [AVConfigConfiguration](../interfaces/foundry.AVConfigConfiguration.md)
...
PARTS: {  
Â Â Â Â devices: { template: string };  
Â Â Â Â footer: { template: string };  
Â Â Â Â general: { template: string };  
Â Â Â Â server: { template: string };  
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â fields: { client: [DataSchema](../types/foundry.abstract.types.DataSchema.md); world: [DataSchema](../types/foundry.abstract.types.DataSchema.md) };  
  Â Â Â Â Â Â Â Â isSSL: boolean;  
  ...
  #### Returns Promise< Â Â Â Â [ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md) & { Â Â Â Â Â Â Â Â fields: { client: [DataSchema](../types/foundry.abstract.types.DataSchema.md); world: [DataSchema](../types/foundry.abstract.types.DataSchema.md) }; Â Â Â Â Â Â Â Â isSSL: boolean; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â settings: any; Â Â Â Â Â Â Â Â tabClasses: string; Â Â Â Â }, >
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<AVConfig>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<AVConfig>
