---
title: "DisplayScrollingTextRegionBehaviorType | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.regionBehaviors.DisplayScrollingTextRegionBehaviorType.html"
category: "classes"
---

# Class DisplayScrollingTextRegionBehaviorType

The data model for a behavior that displays scrolling text above a token when one of the subscribed events occurs.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.regionBehaviors.DisplayScrollingTextRegionBehaviorType))
...
[schema](#schema-1)
[VISIBILITY\_MODES](#visibility_modes)
...
* new DisplayScrollingTextRegionBehaviorType(  
  Â Â Â Â data?: {},  
  Â Â Â Â options?: {},  
  ): DisplayScrollingTextRegionBehaviorType
  ...
  #### Returns DisplayScrollingTextRegionBehaviorType
...
events: Record<  
Â Â Â Â string,  
Â Â Â Â (this: [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.md), event: [RegionEvent](../interfaces/foundry.documents.types.RegionEvent.md)) => Promise<void>,  
> = {}
...
Inherited from [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.md).[events](foundry.data.regionBehaviors.RegionBehaviorType.md#events-1)
...
### `Static`VISIBILITY\_MODES

* get VISIBILITY\_MODES(): Readonly<{ ANYONE: 2; GAMEMASTER: 0; OBSERVER: 1 }>

  Text visibility behavior modes.

  #### Returns Readonly<{ ANYONE: 2; GAMEMASTER: 0; OBSERVER: 1 }>
...
* defineSchema(): {  
  ...
  Â Â Â Â events: [SetField](foundry.data.fields.SetField.md);  
  Â Â Â Â once: [BooleanField](foundry.data.fields.BooleanField.md);  
  ...
  #### Returns { Â Â Â Â color: [ColorField](foundry.data.fields.ColorField.md); Â Â Â Â events: [SetField](foundry.data.fields.SetField.md); Â Â Â Â once: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â text: [StringField](foundry.data.fields.StringField.md); Â Â Â Â visibility: [NumberField](foundry.data.fields.NumberField.md); }
