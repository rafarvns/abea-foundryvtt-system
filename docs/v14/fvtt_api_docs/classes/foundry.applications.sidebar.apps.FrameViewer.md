---
title: "FrameViewer | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.apps.FrameViewer.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.apps.FrameViewer))
...
options: Readonly<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [FrameViewerConfiguration](../interfaces/foundry.FrameViewerConfiguration.md)>
...
Â Â Â Â id: string;  
Â Â Â Â url: undefined;  
Â Â Â Â window: { icon: string };  
} = ...
...
* \_renderHTML(\_context: any, options: any): HTMLIFrameElement
...
* \_replaceHTML(iframe: any, content: any): void
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<FrameViewer>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<FrameViewer>
