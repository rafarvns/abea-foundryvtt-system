---
title: "AdaptiveDarknessShader | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.rendering.shaders.AdaptiveDarknessShader.html"
category: "classes"
---

# Class AdaptiveDarknessShader

The default coloration shader used by standard rendering and animations.
A fragment shader which creates a solid light source.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.rendering.shaders.AdaptiveDarknessShader))

* [AdaptiveLightingShader](foundry.canvas.rendering.shaders.AdaptiveLightingShader.md)
  + AdaptiveDarknessShader
    - [BlackHoleDarknessShader](foundry.canvas.rendering.shaders.BlackHoleDarknessShader.md)
    - [MagicalGloomDarknessShader](foundry.canvas.rendering.shaders.MagicalGloomDarknessShader.md)
    - [RoilingDarknessShader](foundry.canvas.rendering.shaders.RoilingDarknessShader.md)
    - [DenseSmokeDarknessShader](foundry.canvas.rendering.shaders.DenseSmokeDarknessShader.md)
...
* update(): void
  ...
  Overrides [AdaptiveLightingShader](foundry.canvas.rendering.shaders.AdaptiveLightingShader.md).[update](foundry.canvas.rendering.shaders.AdaptiveLightingShader.md#update)
