---
title: "DependencyResolution | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.settings.DependencyResolution.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.settings.DependencyResolution))

* [ApplicationV2](foundry.applications.api.ApplicationV2.md)<any, [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md), this>
...
[\_doEvent](#_doevent)
[\_getRootRequiredBy](#_getrootrequiredby)
...
* new DependencyResolution(options?: any): DependencyResolution

  #### Parameters

  + `Optional`options: any = {}

    Options to configure DependencyResolution
    behavior.
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â cancel: (this: DependencyResolution) => Promise<DependencyResolution>;  
Â Â Â Â };  
Â Â Â Â classes: string[];  
Â Â Â Â enabling: boolean;  
Â Â Â Â form: {  
Â Â Â Â Â Â Â Â closeOnSubmit: boolean;  
Â Â Â Â Â Â Â Â handler: (  
Â Â Â Â Â Â Â Â Â Â Â Â this: DependencyResolution,  
...
Â Â Â Â tag: string;  
Â Â Â Â window: {  
Â Â Â Â Â Â Â Â contentClasses: string[];  
Â Â Â Â Â Â Â Â contentTag: string;  
...
Â Â Â Â resolution: { classes: string[]; template: string };  
} = ...
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â )[];  
  Â Â Â Â Â Â Â Â checkbox: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â Â Â Â Â enabling: any;  
  Â Â Â Â Â Â Â Â optional: any[];  
  Â Â Â Â Â Â Â Â required: any[];  
  Â Â Â Â Â Â Â Â subtypes: string | undefined;  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â [ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md) & { Â Â Â Â Â Â Â Â buttons: ( Â Â Â Â Â Â Â Â Â Â Â Â | { action?: undefined; icon: string; label: string; type: string } Â Â Â Â Â Â Â Â Â Â Â Â | { action: string; icon: string; label: string; type: string } Â Â Â Â Â Â Â Â )[]; Â Â Â Â Â Â Â Â checkbox: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â Â Â Â Â enabling: any; Â Â Â Â Â Â Â Â optional: any[]; Â Â Â Â Â Â Â Â required: any[]; Â Â Â Â Â Â Â Â subtypes: string | undefined; Â Â Â Â }, >
...
* close(  
  ...
  #### Returns Promise<DependencyResolution>
...
* detachWindow(options?: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<DependencyResolution>
