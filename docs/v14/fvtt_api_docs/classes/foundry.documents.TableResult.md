---
title: "TableResult | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.TableResult.html"
category: "classes"
---
...
[foundry.documents.RollTable](foundry.documents.RollTable.md): The RollTable document type which contains TableResult
documents

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.TableResult))

* [BaseTableResult](foundry.documents.BaseTableResult.md)<this>
  + TableResult
...
[documentToAnchor](#documenttoanchor)
...
* new TableResult(  
  Â Â Â Â data?: Partial<[TableResultData](../interfaces/foundry.documents.types.TableResultData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).TableResult

  #### Parameters

  + `Optional`data: Partial<[TableResultData](../interfaces/foundry.documents.types.TableResultData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).TableResult

  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[constructor](foundry.documents.BaseTableResult.md#constructor)

## Properties

### \_source

\_source: [TableResultData](../interfaces/foundry.documents.types.TableResultData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_source](foundry.documents.BaseTableResult.md#_source)
...
Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[parent](foundry.documents.BaseTableResult.md#parent)
...
Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_schema](foundry.documents.BaseTableResult.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseTableResult.md#localization_prefixes)
...
Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[metadata](foundry.documents.BaseTableResult.md#metadata)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_configure](foundry.documents.BaseTableResult.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_getParentCollection](foundry.documents.BaseTableResult.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_initializationOrder](foundry.documents.BaseTableResult.md#_initializationorder)
...
* \_preUpdate(changes: any, options: any, user: any): Promise<boolean | void>
  ...
  Overrides [BaseTableResult](foundry.documents.BaseTableResult.md).[\_preUpdate](foundry.documents.BaseTableResult.md#_preupdate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_updateDiff](foundry.documents.BaseTableResult.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[canUserModify](foundry.documents.BaseTableResult.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[clone](foundry.documents.BaseTableResult.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[createEmbeddedDocuments](foundry.documents.BaseTableResult.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[delete](foundry.documents.BaseTableResult.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[deleteEmbeddedDocuments](foundry.documents.BaseTableResult.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[getEmbeddedCollection](foundry.documents.BaseTableResult.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[getEmbeddedDocument](foundry.documents.BaseTableResult.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[getFieldForProperty](foundry.documents.BaseTableResult.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[getFlag](foundry.documents.BaseTableResult.md#getflag)
...
* getUserLevel(user?: [BaseUser](foundry.documents.BaseUser.md)): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.md)
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[getUserLevel](foundry.documents.BaseTableResult.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[migrateSystemData](foundry.documents.BaseTableResult.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[reset](foundry.documents.BaseTableResult.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[setFlag](foundry.documents.BaseTableResult.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[testUserPermission](foundry.documents.BaseTableResult.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[toJSON](foundry.documents.BaseTableResult.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[toObject](foundry.documents.BaseTableResult.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[traverseEmbeddedDocuments](foundry.documents.BaseTableResult.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[unsetFlag](foundry.documents.BaseTableResult.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[update](foundry.documents.BaseTableResult.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[updateEmbeddedDocuments](foundry.documents.BaseTableResult.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[updateSource](foundry.documents.BaseTableResult.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[validate](foundry.documents.BaseTableResult.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_getInnerModel](foundry.documents.BaseTableResult.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_initialize](foundry.documents.BaseTableResult.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_initializeSource](foundry.documents.BaseTableResult.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_onCreate](foundry.documents.BaseTableResult.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_onDelete](foundry.documents.BaseTableResult.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_onUpdate](foundry.documents.BaseTableResult.md#_onupdate)
...
* \_preCreate(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_preCreate](foundry.documents.BaseTableResult.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_preDelete](foundry.documents.BaseTableResult.md#_predelete)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_preUpdateSource](foundry.documents.BaseTableResult.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_updateCommit](foundry.documents.BaseTableResult.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_addDataFieldMigration](foundry.documents.BaseTableResult.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_addDataFieldShim](foundry.documents.BaseTableResult.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_addDataFieldShims](foundry.documents.BaseTableResult.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_clearFieldsRecursively](foundry.documents.BaseTableResult.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_logDataFieldMigration](foundry.documents.BaseTableResult.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_preCleanData](foundry.documents.BaseTableResult.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[canUserCreate](foundry.documents.BaseTableResult.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[cleanData](foundry.documents.BaseTableResult.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[create](foundry.documents.BaseTableResult.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[createDocuments](foundry.documents.BaseTableResult.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â documentUuid: [DocumentUUIDField](foundry.data.fields.DocumentUUIDField.md);  
  ...
  Â Â Â Â range: [ArrayField](foundry.data.fields.ArrayField.md)<[NumberField](foundry.data.fields.NumberField.md)>;  
  Â Â Â Â type: [DocumentTypeField](foundry.data.fields.DocumentTypeField.md);  
  Â Â Â Â weight: [NumberField](foundry.data.fields.NumberField.md);  
  }
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â description: [HTMLField](foundry.data.fields.HTMLField.md); Â Â Â Â documentUuid: [DocumentUUIDField](foundry.data.fields.DocumentUUIDField.md); Â Â Â Â drawn: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â img: [FilePathField](foundry.data.fields.FilePathField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â range: [ArrayField](foundry.data.fields.ArrayField.md)<[NumberField](foundry.data.fields.NumberField.md)>; Â Â Â Â type: [DocumentTypeField](foundry.data.fields.DocumentTypeField.md); Â Â Â Â weight: [NumberField](foundry.data.fields.NumberField.md); }
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[defineSchema](foundry.documents.BaseTableResult.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[deleteDocuments](foundry.documents.BaseTableResult.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[fromJSON](foundry.documents.BaseTableResult.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[fromSource](foundry.documents.BaseTableResult.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[get](foundry.documents.BaseTableResult.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[getCollectionName](foundry.documents.BaseTableResult.md#getcollectionname)
...
* migrateData(data: any, options: any): object
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[migrateData](foundry.documents.BaseTableResult.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[migrateDataSafe](foundry.documents.BaseTableResult.md#migratedatasafe)
...
* shimData(data: any, options: any): object
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[shimData](foundry.documents.BaseTableResult.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[updateDocuments](foundry.documents.BaseTableResult.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[validateJoint](foundry.documents.BaseTableResult.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_cleanData](foundry.documents.BaseTableResult.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_onCreateOperation](foundry.documents.BaseTableResult.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_onDeleteOperation](foundry.documents.BaseTableResult.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_onUpdateOperation](foundry.documents.BaseTableResult.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_preCreateOperation](foundry.documents.BaseTableResult.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_preDeleteOperation](foundry.documents.BaseTableResult.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseTableResult](foundry.documents.BaseTableResult.md).[\_preUpdateOperation](foundry.documents.BaseTableResult.md#_preupdateoperation)