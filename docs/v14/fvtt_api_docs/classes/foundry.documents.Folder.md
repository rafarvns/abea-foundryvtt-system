---
title: "Folder | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.Folder.html"
category: "classes"
---
...
* [foundry.documents.collections.Folders](foundry.documents.collections.Folders.md): The world-level collection of Folder documents
* [foundry.applications.sheets.FolderConfig](foundry.applications.sheets.FolderConfig.md): The Folder configuration application

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.Folder))

* [BaseFolder](foundry.documents.BaseFolder.md)<this>
  + Folder
...
[exportToCompendium](#exporttocompendium)
...
* new Folder(  
  Â Â Â Â data?: Partial<[FolderData](../interfaces/foundry.documents.types.FolderData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).Folder

  #### Parameters

  + `Optional`data: Partial<[FolderData](../interfaces/foundry.documents.types.FolderData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).Folder

  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[constructor](foundry.documents.BaseFolder.md#constructor)

## Properties

### \_source

\_source: [FolderData](../interfaces/foundry.documents.types.FolderData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_source](foundry.documents.BaseFolder.md#_source)

### children

children: [FolderChildNode](../interfaces/foundry.documents.types.FolderChildNode.md)[]

An array of nodes representing the children of this one. This differs from the results of
[Folder.getSubfolders](#getsubfolders), which reports the subset of child Folders displayed to the current User in the UI.
...
Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[parent](foundry.documents.BaseFolder.md#parent)
...
Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_schema](foundry.documents.BaseFolder.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseFolder.md#localization_prefixes)
...
Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[metadata](foundry.documents.BaseFolder.md#metadata)
...
Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[SORTING\_MODES](foundry.documents.BaseFolder.md#sorting_modes)

## Accessors

### ancestors

* get ancestors(): [documents](../modules/foundry.documents.md).Folder[]
...
* get documentCollection(): | [WorldCollection](foundry.documents.abstract.WorldCollection.md)<any>  
  | [Collection](foundry.utils.Collection.md)<any, any>  
  | undefined
  ...
  #### Returns [WorldCollection](foundry.documents.abstract.WorldCollection.md)<any> | [Collection](foundry.utils.Collection.md)<any, any> | undefined
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_configure](foundry.documents.BaseFolder.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_getParentCollection](foundry.documents.BaseFolder.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_initializationOrder](foundry.documents.BaseFolder.md#_initializationorder)
...
* \_preCreate(data: any, options: any, user: any): Promise<boolean | void>
  ...
  Overrides [BaseFolder](foundry.documents.BaseFolder.md).[\_preCreate](foundry.documents.BaseFolder.md#_precreate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_updateDiff](foundry.documents.BaseFolder.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[canUserModify](foundry.documents.BaseFolder.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[clone](foundry.documents.BaseFolder.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[createEmbeddedDocuments](foundry.documents.BaseFolder.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[delete](foundry.documents.BaseFolder.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[deleteEmbeddedDocuments](foundry.documents.BaseFolder.md#deleteembeddeddocuments)

### exportDialog

* exportDialog(  
  Â Â Â Â pack?: string | [CompendiumCollection](foundry.documents.collections.CompendiumCollection.md)<any> | null,  
  ...
  + `Optional`pack: string | [CompendiumCollection](foundry.documents.collections.CompendiumCollection.md)<any> | null = null
...
* exportToCompendium(  
  ...
  Â Â Â Â },  
  ): Promise<[CompendiumCollection](foundry.documents.collections.CompendiumCollection.md)<any>>
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[getEmbeddedCollection](foundry.documents.BaseFolder.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[getEmbeddedDocument](foundry.documents.BaseFolder.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[getFieldForProperty](foundry.documents.BaseFolder.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[getFlag](foundry.documents.BaseFolder.md#getflag)

### getParentFolders

* getParentFolders(): [documents](../modules/foundry.documents.md).Folder[]
...
* getSubfolders(recursive?: boolean): [documents](../modules/foundry.documents.md).Folder[]
...
* getUserLevel(user?: [BaseUser](foundry.documents.BaseUser.md)): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.md)
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[getUserLevel](foundry.documents.BaseFolder.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[migrateSystemData](foundry.documents.BaseFolder.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[reset](foundry.documents.BaseFolder.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[setFlag](foundry.documents.BaseFolder.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[testUserPermission](foundry.documents.BaseFolder.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[toJSON](foundry.documents.BaseFolder.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[toObject](foundry.documents.BaseFolder.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[traverseEmbeddedDocuments](foundry.documents.BaseFolder.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[unsetFlag](foundry.documents.BaseFolder.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[update](foundry.documents.BaseFolder.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[updateEmbeddedDocuments](foundry.documents.BaseFolder.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[updateSource](foundry.documents.BaseFolder.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[validate](foundry.documents.BaseFolder.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_getInnerModel](foundry.documents.BaseFolder.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_initialize](foundry.documents.BaseFolder.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_initializeSource](foundry.documents.BaseFolder.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_onCreate](foundry.documents.BaseFolder.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_onDelete](foundry.documents.BaseFolder.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_onUpdate](foundry.documents.BaseFolder.md#_onupdate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_preDelete](foundry.documents.BaseFolder.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_preUpdate](foundry.documents.BaseFolder.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_preUpdateSource](foundry.documents.BaseFolder.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_updateCommit](foundry.documents.BaseFolder.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_addDataFieldMigration](foundry.documents.BaseFolder.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_addDataFieldShim](foundry.documents.BaseFolder.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_addDataFieldShims](foundry.documents.BaseFolder.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_clearFieldsRecursively](foundry.documents.BaseFolder.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_logDataFieldMigration](foundry.documents.BaseFolder.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_preCleanData](foundry.documents.BaseFolder.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[canUserCreate](foundry.documents.BaseFolder.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[cleanData](foundry.documents.BaseFolder.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[create](foundry.documents.BaseFolder.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[createDocuments](foundry.documents.BaseFolder.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â sorting: [StringField](foundry.data.fields.StringField.md);  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[defineSchema](foundry.documents.BaseFolder.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[deleteDocuments](foundry.documents.BaseFolder.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[fromJSON](foundry.documents.BaseFolder.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[fromSource](foundry.documents.BaseFolder.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[get](foundry.documents.BaseFolder.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[getCollectionName](foundry.documents.BaseFolder.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[migrateData](foundry.documents.BaseFolder.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[migrateDataSafe](foundry.documents.BaseFolder.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[shimData](foundry.documents.BaseFolder.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[updateDocuments](foundry.documents.BaseFolder.md#updatedocuments)
...
* validateJoint(data: any): void
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[validateJoint](foundry.documents.BaseFolder.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_cleanData](foundry.documents.BaseFolder.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_onCreateOperation](foundry.documents.BaseFolder.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_onDeleteOperation](foundry.documents.BaseFolder.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_onUpdateOperation](foundry.documents.BaseFolder.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_preCreateOperation](foundry.documents.BaseFolder.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_preDeleteOperation](foundry.documents.BaseFolder.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseFolder](foundry.documents.BaseFolder.md).[\_preUpdateOperation](foundry.documents.BaseFolder.md#_preupdateoperation)