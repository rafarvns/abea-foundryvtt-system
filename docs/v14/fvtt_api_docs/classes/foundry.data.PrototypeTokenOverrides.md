---
title: "PrototypeTokenOverrides | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.PrototypeTokenOverrides.html"
category: "classes"
---

# Class PrototypeTokenOverrides

The data model for the the core.prototypeTokenOverrides setting.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.PrototypeTokenOverrides))
...
* get overrides(): PrototypeTokenOverrides

  A cached copy of the currently-configured overrides

  #### Returns PrototypeTokenOverrides
* set overrides(value: PrototypeTokenOverrides | null): void

  Set or clear the cached overrides.

  #### Parameters

  + value: PrototypeTokenOverrides | null
...
* applyOverrides(source: object, actorType?: string): void
...
### `Static`localizeFields

* localizeFields(fields?: [DataField](foundry.data.fields.DataField.md)[], cache?: Record<string, string>): void

  Localize all non-recursive data fields on first load of the application.

  #### Parameters

  + `Optional`fields: [DataField](foundry.data.fields.DataField.md)[]

    Subfields of a recursive field
  + `Optional`cache: Record<string, string> = {}
