---
title: "CombatantGroup | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.CombatantGroup.html"
category: "classes"
---
...
[foundry.documents.Combat](foundry.documents.Combat.md): The Combat document which contains Combatant embedded documents

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.CombatantGroup))

* [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md)<this>
  + CombatantGroup
...
* new CombatantGroup(  
  Â Â Â Â data?: Partial<[CombatantGroupData](../interfaces/foundry.documents.types.CombatantGroupData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).CombatantGroup

  #### Parameters

  + `Optional`data: Partial<[CombatantGroupData](../interfaces/foundry.documents.types.CombatantGroupData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).CombatantGroup

  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[constructor](foundry.documents.BaseCombatantGroup.md#constructor)

## Properties

### \_source

\_source: [CombatantGroupData](../interfaces/foundry.documents.types.CombatantGroupData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_source](foundry.documents.BaseCombatantGroup.md#_source)
...
members: Set<[documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)> = ...
...
Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[parent](foundry.documents.BaseCombatantGroup.md#parent)
...
Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_schema](foundry.documents.BaseCombatantGroup.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseCombatantGroup.md#localization_prefixes)
...
Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[metadata](foundry.documents.BaseCombatantGroup.md#metadata)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_configure](foundry.documents.BaseCombatantGroup.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_getParentCollection](foundry.documents.BaseCombatantGroup.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_initializationOrder](foundry.documents.BaseCombatantGroup.md#_initializationorder)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_updateDiff](foundry.documents.BaseCombatantGroup.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[canUserModify](foundry.documents.BaseCombatantGroup.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[clone](foundry.documents.BaseCombatantGroup.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[createEmbeddedDocuments](foundry.documents.BaseCombatantGroup.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[delete](foundry.documents.BaseCombatantGroup.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[deleteEmbeddedDocuments](foundry.documents.BaseCombatantGroup.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[getEmbeddedCollection](foundry.documents.BaseCombatantGroup.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[getEmbeddedDocument](foundry.documents.BaseCombatantGroup.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[getFieldForProperty](foundry.documents.BaseCombatantGroup.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[getFlag](foundry.documents.BaseCombatantGroup.md#getflag)
...
* getUserLevel(user?: [BaseUser](foundry.documents.BaseUser.md)): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.md)
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[getUserLevel](foundry.documents.BaseCombatantGroup.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[migrateSystemData](foundry.documents.BaseCombatantGroup.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[reset](foundry.documents.BaseCombatantGroup.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[setFlag](foundry.documents.BaseCombatantGroup.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[testUserPermission](foundry.documents.BaseCombatantGroup.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[toJSON](foundry.documents.BaseCombatantGroup.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[toObject](foundry.documents.BaseCombatantGroup.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[traverseEmbeddedDocuments](foundry.documents.BaseCombatantGroup.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[unsetFlag](foundry.documents.BaseCombatantGroup.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[update](foundry.documents.BaseCombatantGroup.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[updateEmbeddedDocuments](foundry.documents.BaseCombatantGroup.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[updateSource](foundry.documents.BaseCombatantGroup.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[validate](foundry.documents.BaseCombatantGroup.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_getInnerModel](foundry.documents.BaseCombatantGroup.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_initialize](foundry.documents.BaseCombatantGroup.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_initializeSource](foundry.documents.BaseCombatantGroup.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_onCreate](foundry.documents.BaseCombatantGroup.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_onDelete](foundry.documents.BaseCombatantGroup.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_onUpdate](foundry.documents.BaseCombatantGroup.md#_onupdate)
...
* \_preCreate(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_preCreate](foundry.documents.BaseCombatantGroup.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_preDelete](foundry.documents.BaseCombatantGroup.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_preUpdate](foundry.documents.BaseCombatantGroup.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_preUpdateSource](foundry.documents.BaseCombatantGroup.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_updateCommit](foundry.documents.BaseCombatantGroup.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_addDataFieldMigration](foundry.documents.BaseCombatantGroup.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_addDataFieldShim](foundry.documents.BaseCombatantGroup.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_addDataFieldShims](foundry.documents.BaseCombatantGroup.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_clearFieldsRecursively](foundry.documents.BaseCombatantGroup.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_logDataFieldMigration](foundry.documents.BaseCombatantGroup.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_preCleanData](foundry.documents.BaseCombatantGroup.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[canUserCreate](foundry.documents.BaseCombatantGroup.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[cleanData](foundry.documents.BaseCombatantGroup.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[create](foundry.documents.BaseCombatantGroup.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[createDocuments](foundry.documents.BaseCombatantGroup.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â initiative: [NumberField](foundry.data.fields.NumberField.md);  
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â img: [FilePathField](foundry.data.fields.FilePathField.md); Â Â Â Â initiative: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â ownership: [DocumentOwnershipField](foundry.data.fields.DocumentOwnershipField.md); Â Â Â Â system: [TypeDataField](foundry.data.fields.TypeDataField.md); Â Â Â Â type: [DocumentTypeField](foundry.data.fields.DocumentTypeField.md); }
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[defineSchema](foundry.documents.BaseCombatantGroup.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[deleteDocuments](foundry.documents.BaseCombatantGroup.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[fromJSON](foundry.documents.BaseCombatantGroup.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[fromSource](foundry.documents.BaseCombatantGroup.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[get](foundry.documents.BaseCombatantGroup.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[getCollectionName](foundry.documents.BaseCombatantGroup.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[migrateData](foundry.documents.BaseCombatantGroup.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[migrateDataSafe](foundry.documents.BaseCombatantGroup.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[shimData](foundry.documents.BaseCombatantGroup.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[updateDocuments](foundry.documents.BaseCombatantGroup.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[validateJoint](foundry.documents.BaseCombatantGroup.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_cleanData](foundry.documents.BaseCombatantGroup.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_onCreateOperation](foundry.documents.BaseCombatantGroup.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_onDeleteOperation](foundry.documents.BaseCombatantGroup.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_onUpdateOperation](foundry.documents.BaseCombatantGroup.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_preCreateOperation](foundry.documents.BaseCombatantGroup.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_preDeleteOperation](foundry.documents.BaseCombatantGroup.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseCombatantGroup](foundry.documents.BaseCombatantGroup.md).[\_preUpdateOperation](foundry.documents.BaseCombatantGroup.md#_preupdateoperation)