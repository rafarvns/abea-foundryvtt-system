---
title: "AmbientSoundPalette | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.palette.AmbientSoundPalette.html"
category: "classes"
---

# Class AmbientSoundPalette
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.palette.AmbientSoundPalette))

* [AmbientSoundConfig](foundry.applications.sheets.AmbientSoundConfig.md)<this>
  + AmbientSoundPalette
...
[\_toggleDisabledFields](#_toggledisabledfields)
...
* new AmbientSoundPalette(options: any, ...args: any[]): AmbientSoundPalette
  ...
  #### Returns AmbientSoundPalette

  #### Inherit Doc

  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).constructor
...
Inherited from PlaceablePaletteMixin(AmbientSoundConfig).options
...
Inherited from PlaceablePaletteMixin(AmbientSoundConfig).position
...
Inherited from PlaceablePaletteMixin(AmbientSoundConfig).tabGroups
...
Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_preview
...
Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_appId
...
Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_maxZ
...
Inherited from PlaceablePaletteMixin(AmbientSoundConfig).BASE\_APPLICATION

### `Static`DEFAULT\_OPTIONS

DEFAULT\_OPTIONS: { id: string } = ...

Overrides PlaceablePaletteMixin(AmbientSoundConfig).DEFAULT\_OPTIONS
...
Inherited from PlaceablePaletteMixin(AmbientSoundConfig).emittedEvents
...
Inherited from PlaceablePaletteMixin(AmbientSoundConfig).RENDER\_STATES

### `Static`SETTING\_KEY

SETTING\_KEY: string = "ambientSoundPalette"
...
Overrides PlaceablePaletteMixin(AmbientSoundConfig).TABS
...
* get classList(): DOMTokenList
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).classList
...
* get document(): ClientDocument
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).document
...
* get element(): HTMLElement
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).element
...
* get form(): HTMLFormElement | null
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).form
...
* get hasFrame(): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).hasFrame
...
* get id(): string
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).id
...
* get isEditable(): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).isEditable
...
* get isVisible(): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).isVisible
...
* get minimized(): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).minimized
...
* get rendered(): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).rendered
...
* get state(): number
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).state
...
* get title(): string
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).title
...
* get schema(): any
  ...
  Overrides PlaceablePaletteMixin(AmbientSoundConfig).schema
...
* \_awaitTransition(element: HTMLElement, timeout: number): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_awaitTransition
...
* \_canDetach(): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_canDetach
...
* \_canRender(\_options: any): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_canRender
...
* \_configureRenderOptions(options: any): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_configureRenderOptions
...
* \_doEvent(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_doEvent
...
* \_getFrameButtons(options: any): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_getFrameButtons
...
* \_headerControlButtons(): Generator<  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_headerControlButtons
...
* \_initializeApplicationOptions(options: any): any
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_initializeApplicationOptions
...
* \_onChangeForm(formConfig: any, event: any): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_onChangeForm
...
* \_onClose(options: any): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_onClose
...
* \_onFirstRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_onFirstRender
...
* \_onRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_onRender
...
* \_postRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_postRender
...
* \_preClose(options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_preClose
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â soundEffects: Record<  
  Â Â Â Â Â Â Â Â Â Â Â Â string,  
  Â Â Â Â Â Â Â Â Â Â Â Â {  
  Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â effectClass: | (  
  Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â new (  
  Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â context: BaseAudioContext,  
  Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â options?: BiquadFilterOptions,  
  Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ) => BiquadFilterNode  
  Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â )  
  Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â | (  
  Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â new (  
  Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â context: BaseAudioContext,  
  Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â options?: ConvolverOptions,  
  Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ) => ConvolverNode  
  Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â );  
  Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â label: string;  
  Â Â Â Â Â Â Â Â Â Â Â Â },  
  Â Â Â Â Â Â Â Â >;  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â [ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md) & { Â Â Â Â Â Â Â Â document: ClientDocument; Â Â Â Â Â Â Â Â editable: boolean; Â Â Â Â Â Â Â Â fields: any; Â Â Â Â Â Â Â Â model: ClientDocument; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â source: any; Â Â Â Â Â Â Â Â user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) Â Â Â Â Â Â Â Â | null; Â Â Â Â } & { Â Â Â Â Â Â Â Â document: [Document](foundry.abstract.Document.md)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md)> Â Â Â Â Â Â Â Â | null; Â Â Â Â Â Â Â Â gridUnits: any; Â Â Â Â Â Â Â Â inputs: { Â Â Â Â Â Â Â Â Â Â Â Â createMultiSelectInput: ( Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â field: any, Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â config: any, Â Â Â Â Â Â Â Â Â Â Â Â ) => AbstractMultiSelectElement; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â model: [Document](foundry.abstract.Document.md)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md)> Â Â Â Â Â Â Â Â | null; Â Â Â Â Â Â Â Â selectableLevels: any; Â Â Â Â Â Â Â Â source: object; Â Â Â Â } & { Â Â Â Â Â Â Â Â buttons: { icon: string; label: string; type: string }[]; Â Â Â Â Â Â Â Â soundEffects: Record< Â Â Â Â Â Â Â Â Â Â Â Â string, Â Â Â Â Â Â Â Â Â Â Â Â { Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â effectClass: | ( Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â new ( Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â context: BaseAudioContext, Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â options?: BiquadFilterOptions, Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ) => BiquadFilterNode Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ) Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â | ( Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â new ( Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â context: BaseAudioContext, Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â options?: ConvolverOptions, Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ) => ConvolverNode Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ); Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â label: string; Â Â Â Â Â Â Â Â Â Â Â Â }, Â Â Â Â Â Â Â Â >; Â Â Â Â }, >

  #### Inherit Doc

  Overrides PlaceablePaletteMixin(AmbientSoundConfig).\_prepareContext
...
* \_previewChanges(changes: any): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_previewChanges
...
* \_renderFrame(options: any): Promise<HTMLElement>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_renderFrame
...
* \_renderHTML(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_renderHTML
...
* addEventListener(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).addEventListener
...
* attachWindow(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).attachWindow
...
* bringToFront(): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).bringToFront
...
* close(  
  ...
  #### Returns Promise<AmbientSoundPalette>

  A Promise which resolves to the closed Application instance

  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).close
...
* detachWindow(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).detachWindow
...
* dispatchEvent(event: Event): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).dispatchEvent
...
* maximize(): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).maximize
...
* minimize(): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).minimize
...
* removeEventListener(type: string, listener: [EmittedEventListener](../types/foundry.utils.types.EmittedEventListener.md)): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).removeEventListener
...
* render(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).render
...
* renderChild(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).renderChild
...
* setPosition(position?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void | [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).setPosition
...
* submit(submitOptions?: object): Promise<any>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).submit
...
* \_attachFrameListeners(): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_attachFrameListeners
...
* \_canAttach(): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_canAttach
...
* \_createContextMenu(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_createContextMenu
...
* \_createPreview(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_createPreview
...
* \_destroyPreview(): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_destroyPreview
...
* \_getHeaderControls(): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_getHeaderControls
...
* \_getTabsConfig(group: string): [ApplicationTabsConfiguration](../interfaces/foundry.applications.types.ApplicationTabsConfiguration.md) | null
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_getTabsConfig
...
* \_headerControlContextEntries(): Generator<[ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md), void, any>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_headerControlContextEntries
...
* \_initializePreview(): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_initializePreview
...
* \_insertElement(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_insertElement
...
* \_onAttach(from: Document, to: Document): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_onAttach
...
* \_onClickAction(event: PointerEvent, target: HTMLElement): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_onClickAction
...
* \_onClickTab(event: PointerEvent): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_onClickTab
...
* \_onDetach(from: Document, to: Document): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_onDetach
...
* \_onPosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_onPosition
...
* \_onRevealSecret(event: Event): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_onRevealSecret
...
* \_onSubmitForm(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_onSubmitForm
...
* \_preFirstRender(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_preFirstRender
...
* \_prepareSubmitData(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_prepareSubmitData
...
* \_prepareTabs(group: string): Record<string, [ApplicationTab](../interfaces/foundry.applications.types.ApplicationTab.md)>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_prepareTabs
...
* \_prePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_prePosition
...
* \_preRender(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_preRender
...
* \_processFormData(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_processFormData
...
* \_processSubmitData(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_processSubmitData
...
* \_refit(positionUpdate?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_refit
...
* \_removeElement(element: HTMLElement): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_removeElement
...
* \_renderFrameButtons(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_renderFrameButtons
...
* \_renderHeaderControl(control: [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)): HTMLLIElement
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_renderHeaderControl
...
* \_replaceHTML(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_replaceHTML
...
* \_resetPreview(): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_resetPreview
...
* \_tearDown(options: [ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_tearDown
...
* \_toggleDisabled(disabled: boolean): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_toggleDisabled

### `Protected`\_toggleDisabledFields

* \_toggleDisabledFields(): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_toggleDisabledFields
...
* \_updateFrame(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_updateFrame
...
* \_updatePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).\_updatePosition
...
* inheritanceChain(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), void, unknown>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).inheritanceChain
...
* instances(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), any, any>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).instances
...
* parseCSSDimension(style: string, parentDimension: number): number | void
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).parseCSSDimension
...
* waitForImages(element: HTMLElement): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientSoundConfig).waitForImages