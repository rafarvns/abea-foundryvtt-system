---
title: "TilePalette | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.palette.TilePalette.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.palette.TilePalette))

* [TileConfig](foundry.applications.sheets.TileConfig.md)<this>
  + TilePalette
...
* new TilePalette(options: any, ...args: any[]): TilePalette
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).constructor
...
Inherited from PlaceablePaletteMixin(TileConfig).options
...
Inherited from PlaceablePaletteMixin(TileConfig).position
...
Inherited from PlaceablePaletteMixin(TileConfig).tabGroups
...
Inherited from PlaceablePaletteMixin(TileConfig).\_preview
...
Inherited from PlaceablePaletteMixin(TileConfig).\_appId
...
Inherited from PlaceablePaletteMixin(TileConfig).\_maxZ
...
Inherited from PlaceablePaletteMixin(TileConfig).BASE\_APPLICATION

### `Static`DEFAULT\_OPTIONS

DEFAULT\_OPTIONS: { id: string; initialData: { height: number; width: number } } = ...

Overrides PlaceablePaletteMixin(TileConfig).DEFAULT\_OPTIONS
...
Inherited from PlaceablePaletteMixin(TileConfig).emittedEvents
...
Inherited from PlaceablePaletteMixin(TileConfig).RENDER\_STATES

### `Static`SETTING\_KEY

SETTING\_KEY: string = "tilePalette"
...
Overrides PlaceablePaletteMixin(TileConfig).TABS
...
* get classList(): DOMTokenList
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).classList
...
* get document(): ClientDocument
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).document
...
* get element(): HTMLElement
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).element
...
* get form(): HTMLFormElement | null
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).form
...
* get hasFrame(): boolean
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).hasFrame
...
* get id(): string
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).id
...
* get isEditable(): boolean
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).isEditable
...
* get isVisible(): boolean
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).isVisible
...
* get minimized(): boolean
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).minimized
...
* get rendered(): boolean
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).rendered
...
* get state(): number
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).state
...
* get title(): string
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).title
...
* get schema(): any
  ...
  Overrides PlaceablePaletteMixin(TileConfig).schema
...
* \_awaitTransition(element: HTMLElement, timeout: number): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_awaitTransition
...
* \_canDetach(): boolean
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_canDetach
...
* \_canRender(\_options: any): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_canRender
...
* \_configureRenderOptions(options: any): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_configureRenderOptions
...
* \_doEvent(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_doEvent
...
* \_getFrameButtons(options: any): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_getFrameButtons
...
* \_headerControlButtons(): Generator<  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_headerControlButtons
...
* \_initializeApplicationOptions(options: any): any
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_initializeApplicationOptions
...
* \_onChangeForm(formConfig: any, event: any): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_onChangeForm
...
* \_onClose(options: any): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_onClose
...
* \_onFirstRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_onFirstRender
...
* \_onRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_onRender
...
* \_postRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_postRender
...
* \_preClose(options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_preClose
...
* \_prepareContext(  
  ...
  #### Returns Promise< Â Â Â Â [ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md) & { Â Â Â Â Â Â Â Â document: ClientDocument; Â Â Â Â Â Â Â Â editable: boolean; Â Â Â Â Â Â Â Â fields: any; Â Â Â Â Â Â Â Â model: ClientDocument; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â source: any; Â Â Â Â Â Â Â Â user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) Â Â Â Â Â Â Â Â | null; Â Â Â Â } & { Â Â Â Â Â Â Â Â document: [Document](foundry.abstract.Document.md)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md)> Â Â Â Â Â Â Â Â | null; Â Â Â Â Â Â Â Â gridUnits: any; Â Â Â Â Â Â Â Â inputs: { Â Â Â Â Â Â Â Â Â Â Â Â createMultiSelectInput: ( Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â field: any, Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â config: any, Â Â Â Â Â Â Â Â Â Â Â Â ) => AbstractMultiSelectElement; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â model: [Document](foundry.abstract.Document.md)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md)> Â Â Â Â Â Â Â Â | null; Â Â Â Â Â Â Â Â selectableLevels: any; Â Â Â Â Â Â Â Â source: object; Â Â Â Â } & { Â Â Â Â Â Â Â Â buttons: { icon: string; label: string; type: string }[]; Â Â Â Â Â Â Â Â tabClasses: string; Â Â Â Â }, >

  #### Inherit Doc

  Overrides PlaceablePaletteMixin(TileConfig).\_prepareContext
...
* \_preparePartContext(partId: any, context: any): Promise<any>
  ...
  Overrides PlaceablePaletteMixin(TileConfig).\_preparePartContext
...
* \_previewChanges(changes: any): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_previewChanges
...
* \_renderFrame(options: any): Promise<HTMLElement>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_renderFrame
...
* \_renderHTML(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_renderHTML
...
* addEventListener(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).addEventListener
...
* attachWindow(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).attachWindow
...
* bringToFront(): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).bringToFront
...
* changeTab(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).changeTab

### close

* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<TilePalette>
  ...
  #### Returns Promise<TilePalette>

  A Promise which resolves to the closed Application instance

  Inherited from PlaceablePaletteMixin(TileConfig).close
...
* detachWindow(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).detachWindow
...
* dispatchEvent(event: Event): boolean
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).dispatchEvent
...
* maximize(): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).maximize
...
* minimize(): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).minimize
...
* removeEventListener(type: string, listener: [EmittedEventListener](../types/foundry.utils.types.EmittedEventListener.md)): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).removeEventListener
...
* render(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).render
...
* renderChild(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).renderChild
...
* setPosition(position?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void | [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).setPosition
...
* submit(submitOptions?: object): Promise<any>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).submit
...
* \_attachFrameListeners(): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_attachFrameListeners
...
* \_canAttach(): boolean
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_canAttach
...
* \_createContextMenu(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_createContextMenu
...
* \_createPreview(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_createPreview
...
* \_destroyPreview(): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_destroyPreview
...
* \_getHeaderControls(): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_getHeaderControls
...
* \_getTabsConfig(group: string): [ApplicationTabsConfiguration](../interfaces/foundry.applications.types.ApplicationTabsConfiguration.md) | null
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_getTabsConfig
...
* \_headerControlContextEntries(): Generator<[ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md), void, any>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_headerControlContextEntries
...
* \_initializePreview(): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_initializePreview
...
* \_insertElement(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_insertElement
...
* \_onAttach(from: Document, to: Document): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_onAttach
...
* \_onClickAction(event: PointerEvent, target: HTMLElement): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_onClickAction
...
* \_onClickTab(event: PointerEvent): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_onClickTab
...
* \_onDetach(from: Document, to: Document): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_onDetach
...
* \_onPosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_onPosition
...
* \_onRevealSecret(event: Event): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_onRevealSecret
...
* \_onSubmitForm(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_onSubmitForm
...
* \_preFirstRender(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_preFirstRender
...
* \_prepareSubmitData(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_prepareSubmitData
...
* \_prepareTabs(group: string): Record<string, [ApplicationTab](../interfaces/foundry.applications.types.ApplicationTab.md)>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_prepareTabs
...
* \_prePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_prePosition
...
* \_preRender(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_preRender
...
* \_processFormData(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_processFormData
...
* \_processSubmitData(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_processSubmitData
...
* \_refit(positionUpdate?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_refit
...
* \_removeElement(element: HTMLElement): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_removeElement
...
* \_renderFrameButtons(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_renderFrameButtons
...
* \_renderHeaderControl(control: [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)): HTMLLIElement
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_renderHeaderControl
...
* \_replaceHTML(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_replaceHTML
...
* \_resetPreview(): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_resetPreview
...
* \_tearDown(options: [ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_tearDown
...
* \_toggleDisabled(disabled: boolean): void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_toggleDisabled
...
* \_updateFrame(  
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_updateFrame
...
* \_updatePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).\_updatePosition
...
* inheritanceChain(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), void, unknown>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).inheritanceChain
...
* instances(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), any, any>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).instances
...
* parseCSSDimension(style: string, parentDimension: number): number | void
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).parseCSSDimension
...
* waitForImages(element: HTMLElement): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(TileConfig).waitForImages