---
title: "PlaceableFilter | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.filters.PlaceableFilter.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.filters.PlaceableFilter))

* [ApplicationV2](foundry.applications.api.ApplicationV2.md)<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md), HandlebarsRenderOptions, this>
  + PlaceableFilter
    - [AmbientLightFilter](foundry.applications.sidebar.filters.AmbientLightFilter.md)
    - [RegionFilter](foundry.applications.sidebar.filters.RegionFilter.md)
    - [TileFilter](foundry.applications.sidebar.filters.TileFilter.md)
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: { clear: (this: PlaceableFilter) => Promise<PlaceableFilter> };  
Â Â Â Â classes: string[];  
Â Â Â Â position: { scale: number; width: number };  
Â Â Â Â tag: string;  
Â Â Â Â window: {  
Â Â Â Â Â Â Â Â icon: string;  
Â Â Â Â Â Â Â Â minimizable: boolean;  
...
* \_canDetach(): boolean
  ...
  Overrides HandlebarsApplicationMixin(ApplicationV2).\_canDetach
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<PlaceableFilter>
  ...
  #### Returns Promise<PlaceableFilter>
...
* detachWindow(options?: any): Promise<PlaceableFilter>
...
* render(options?: any, \_options?: any): Promise<PlaceableFilter>
