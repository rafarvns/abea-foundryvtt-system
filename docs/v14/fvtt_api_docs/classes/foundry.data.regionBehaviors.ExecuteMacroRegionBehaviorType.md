---
title: "ExecuteMacroRegionBehaviorType | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.regionBehaviors.ExecuteMacroRegionBehaviorType.html"
category: "classes"
---

# Class ExecuteMacroRegionBehaviorType

The data model for a behavior that executes a Macro.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.regionBehaviors.ExecuteMacroRegionBehaviorType))
...
* new ExecuteMacroRegionBehaviorType(  
  Â Â Â Â data?: {},  
  Â Â Â Â options?: {},  
  ): ExecuteMacroRegionBehaviorType
  ...
  #### Returns ExecuteMacroRegionBehaviorType
...
* defineSchema(): {  
  ...
  Â Â Â Â everyone: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â uuid: [DocumentUUIDField](foundry.data.fields.DocumentUUIDField.md);  
  }

  #### Returns { events: [SetField](foundry.data.fields.SetField.md); everyone: [BooleanField](foundry.data.fields.BooleanField.md); uuid: [DocumentUUIDField](foundry.data.fields.DocumentUUIDField.md) }
