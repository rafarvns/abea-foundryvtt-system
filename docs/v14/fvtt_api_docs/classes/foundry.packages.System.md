---
title: "System | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.packages.System.html"
category: "classes"
---
...
* [foundry.packages.types.SystemManifestData](../interfaces/foundry.packages.types.SystemManifestData.md) For the system.json schema
* [foundry.ClientPackage](foundry.ClientPackage.md)

#### Hierarchy ([View Summary](../hierarchy.md#foundry.packages.System))

* [BaseSystem](foundry.packages.BaseSystem.md)<this>
  + System
...
Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_source](foundry.packages.BaseSystem.md#_source)
...
Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_unknownKeys](foundry.packages.BaseSystem.md#_unknownkeys)
...
Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[availability](foundry.packages.BaseSystem.md#availability)
...
Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[exclusive](foundry.packages.BaseSystem.md#exclusive)
...
Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[hasStorage](foundry.packages.BaseSystem.md#hasstorage)
...
Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[locked](foundry.packages.BaseSystem.md#locked)
...
Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[owned](foundry.packages.BaseSystem.md#owned)
...
Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[parent](foundry.packages.BaseSystem.md#parent)
...
Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[strictDataCleaning](foundry.packages.BaseSystem.md#strictdatacleaning)
...
Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[tags](foundry.packages.BaseSystem.md#tags)
...
Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_schema](foundry.packages.BaseSystem.md#_schema)
...
Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[icon](foundry.packages.BaseSystem.md#icon)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[LOCALIZATION\_PREFIXES](foundry.packages.BaseSystem.md#localization_prefixes)

### `Static`type

type: string = "system"

Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[type](foundry.packages.BaseSystem.md#type)
...
* get collection(): string
  ...
  Inherited from ClientPackageMixin(BaseSystem).collection
...
* \_configure(options: any): void
  ...
  Overrides [BaseSystem](foundry.packages.BaseSystem.md).[\_configure](foundry.packages.BaseSystem.md#_configure)
...
* \_initializeSource(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_initializeSource](foundry.packages.BaseSystem.md#_initializesource)
...
* \_testRequiredDependencies(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_testRequiredDependencies](foundry.packages.BaseSystem.md#_testrequireddependencies)

### \_testSupportedSystems

* \_testSupportedSystems(  
  Â Â Â Â systemCollection: [Collection](foundry.utils.Collection.md)<string, System>,  
  ): Promise<boolean>
  ...
  + systemCollection: [Collection](foundry.utils.Collection.md)<string, System>
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_testSupportedSystems](foundry.packages.BaseSystem.md#_testsupportedsystems)
...
* clone(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[clone](foundry.packages.BaseSystem.md#clone)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[getFieldForProperty](foundry.packages.BaseSystem.md#getfieldforproperty)
...
* reset(): void
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[reset](foundry.packages.BaseSystem.md#reset)
...
* toJSON(): object
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[toJSON](foundry.packages.BaseSystem.md#tojson)
...
* toObject(source?: boolean): object
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[toObject](foundry.packages.BaseSystem.md#toobject)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[updateSource](foundry.packages.BaseSystem.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[validate](foundry.packages.BaseSystem.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_getInnerModel](foundry.packages.BaseSystem.md#_getinnermodel)
...
* \_initializationOrder(): Generator<[string, [DataField](foundry.data.fields.DataField.md)], any, any>
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_initializationOrder](foundry.packages.BaseSystem.md#_initializationorder)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_initialize](foundry.packages.BaseSystem.md#_initialize)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_preUpdateSource](foundry.packages.BaseSystem.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_updateCommit](foundry.packages.BaseSystem.md#_updatecommit)
...
* \_updateDiff(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_updateDiff](foundry.packages.BaseSystem.md#_updatediff)
...
* \_cleanData(data: any, \_options: any, \_state: any): void
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_cleanData](foundry.packages.BaseSystem.md#_cleandata)
...
* \_logWarning(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_logWarning](foundry.packages.BaseSystem.md#_logwarning)
...
* \_migrateStyles(data: [PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md)): void
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_migrateStyles](foundry.packages.BaseSystem.md#_migratestyles)
...
* cleanData(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[cleanData](foundry.packages.BaseSystem.md#cleandata)
...
* defineSchema(): {  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[defineSchema](foundry.packages.BaseSystem.md#defineschema)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[fromJSON](foundry.packages.BaseSystem.md#fromjson)
...
* fromRemoteManifest(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[fromRemoteManifest](foundry.packages.BaseSystem.md#fromremotemanifest)
...
* fromSource(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[fromSource](foundry.packages.BaseSystem.md#fromsource)
...
* isIncompatibleWithCoreVersion(availability: number): boolean
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[isIncompatibleWithCoreVersion](foundry.packages.BaseSystem.md#isincompatiblewithcoreversion)
...
* migrateData(data: any, options: any): object
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[migrateData](foundry.packages.BaseSystem.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[migrateDataSafe](foundry.packages.BaseSystem.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[shimData](foundry.packages.BaseSystem.md#shimdata)
...
* testAvailability(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[testAvailability](foundry.packages.BaseSystem.md#testavailability)
...
* testDependencyCompatibility(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[testDependencyCompatibility](foundry.packages.BaseSystem.md#testdependencycompatibility)
...
* validateId(id: string): void
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[validateId](foundry.packages.BaseSystem.md#validateid)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[validateJoint](foundry.packages.BaseSystem.md#validatejoint)
...
* validateVersion(version: string): void
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[validateVersion](foundry.packages.BaseSystem.md#validateversion)
...
* \_preCleanData(  
  ...
  Inherited from [BaseSystem](foundry.packages.BaseSystem.md).[\_preCleanData](foundry.packages.BaseSystem.md#_precleandata)