---
title: "DocumentOwnershipField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.DocumentOwnershipField.html"
category: "classes"
---

# Class DocumentOwnershipField

A special [foundry.data.fields.ObjectField](foundry.data.fields.ObjectField.md) which captures a mapping of User IDs to Document permission levels.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.DocumentOwnershipField))
...
* new DocumentOwnershipField(  
  ...
  #### Returns DocumentOwnershipField

  Inherited from [ObjectField](foundry.data.fields.ObjectField.md).[constructor](foundry.data.fields.ObjectField.md#constructor)
...
Inherited from [ObjectField](foundry.data.fields.ObjectField.md).[recursive](foundry.data.fields.ObjectField.md#recursive)
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { nullable: boolean; required: boolean } & {  
  ...
  Â Â Â Â initial: { default: 0 };  
  Â Â Â Â validationError: string;  
  }

  Default parameters for this field type

  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { nullable: boolean; required: boolean } & { Â Â Â Â gmOnly: boolean; Â Â Â Â initial: { default: 0 }; Â Â Â Â validationError: string; }
...
* \_updateCommit(source: any, key: any, value: any, diff: any, options: any): void
  ...
  Inherited from [ObjectField](foundry.data.fields.ObjectField.md).[\_updateCommit](foundry.data.fields.ObjectField.md#_updatecommit)
...
* \_updateDiff(key: any, value: any, options: any, state: any): void
  ...
  Inherited from [ObjectField](foundry.data.fields.ObjectField.md).[\_updateDiff](foundry.data.fields.ObjectField.md#_updatediff)
...
* \_validateModel(data: object, options?: object): void
  ...
  Inherited from [ObjectField](foundry.data.fields.ObjectField.md).[\_validateModel](foundry.data.fields.ObjectField.md#_validatemodel)

### \_validateType

* \_validateType(value: any, \_options: any): false | undefined
  ...
  Overrides [ObjectField](foundry.data.fields.ObjectField.md).[\_validateType](foundry.data.fields.ObjectField.md#_validatetype)
...
* initialize(value: any, model: any, options?: {}): any
  ...
  Inherited from [ObjectField](foundry.data.fields.ObjectField.md).[initialize](foundry.data.fields.ObjectField.md#initialize)
...
* toObject(value: any): any
  ...
  Inherited from [ObjectField](foundry.data.fields.ObjectField.md).[toObject](foundry.data.fields.ObjectField.md#toobject)
...
* \_getField(  
  ...
  Inherited from [ObjectField](foundry.data.fields.ObjectField.md).[\_getField](foundry.data.fields.ObjectField.md#_getfield)
...
* \_validateRecursive(  
  ...
  Inherited from [ObjectField](foundry.data.fields.ObjectField.md).[\_validateRecursive](foundry.data.fields.ObjectField.md#_validaterecursive)
