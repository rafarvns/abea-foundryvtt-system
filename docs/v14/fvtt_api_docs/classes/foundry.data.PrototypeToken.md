---
title: "PrototypeToken | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.PrototypeToken.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.PrototypeToken))
...
\_source: [PrototypeTokenData](../types/foundry.documents.types.PrototypeTokenData.md)
...
* get actor(): [BaseActor](foundry.documents.BaseActor.md)

  The Actor which owns this Prototype Token

  #### Returns [BaseActor](foundry.documents.BaseActor.md)
