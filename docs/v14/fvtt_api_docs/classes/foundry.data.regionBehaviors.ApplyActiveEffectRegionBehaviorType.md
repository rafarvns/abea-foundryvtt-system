---
title: "ApplyActiveEffectRegionBehaviorType | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.regionBehaviors.ApplyActiveEffectRegionBehaviorType.html"
category: "classes"
---

# Class ApplyActiveEffectRegionBehaviorType
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.regionBehaviors.ApplyActiveEffectRegionBehaviorType))

* [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.md)
  + ApplyActiveEffectRegionBehaviorType
...
* new ApplyActiveEffectRegionBehaviorType(  
  Â Â Â Â data?: {},  
  Â Â Â Â options?: {},  
  ): ApplyActiveEffectRegionBehaviorType
  ...
  #### Returns ApplyActiveEffectRegionBehaviorType
...
events: {  
Â Â Â Â tokenEnter: (  
Â Â Â Â Â Â Â Â this: ApplyActiveEffectRegionBehaviorType,  
...
* ##### tokenEnter: ( Â Â Â Â this: ApplyActiveEffectRegionBehaviorType, Â Â Â Â event: [RegionTokenEnterExitEvent](../types/foundry.documents.types.RegionTokenEnterExitEvent.md), ) => Promise<void>
* ##### tokenExit: ( Â Â Â Â this: ApplyActiveEffectRegionBehaviorType, Â Â Â Â event: [RegionTokenEnterExitEvent](../types/foundry.documents.types.RegionTokenEnterExitEvent.md), ) => Promise<void>
...
* defineSchema(): { effects: [SetField](foundry.data.fields.SetField.md) }

  #### Returns { effects: [SetField](foundry.data.fields.SetField.md) }
