---
title: "WallTab | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.tabs.WallTab.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.tabs.WallTab))
...
[\_onFilterByCategory](#_onfilterbycategory)
...
* new WallTab(options?: Partial<[ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md)>): WallTab
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â selectGroup: (  
Â Â Â Â Â Â Â Â Â Â Â Â this: WallTab,  
...
Overrides PlaceableTab.DEFAULT\_OPTIONS

### `Static`DIRECTORY\_PARTIAL

DIRECTORY\_PARTIAL: string = "templates/sidebar/tabs/placeable/walls.hbs"

Overrides PlaceableTab.DIRECTORY\_PARTIAL
...
* \_attachFrameListeners(): void
  ...
  Overrides PlaceableTab.\_attachFrameListeners
...
* \_matchesFilter(entry: any): any
  ...
  Overrides PlaceableTab.\_matchesFilter
...
* \_prepareDirectoryContext(context: any, options: any): Promise<any>
  ...
  Overrides PlaceableTab.\_prepareDirectoryContext
...
* \_prepareSearchContext(context: any, options: any): Promise<any>
  ...
  Overrides PlaceableTab.\_prepareSearchContext
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<WallTab>
...
* detachWindow(options?: [PlaceableTabConfiguration](../types/foundry.PlaceableTabConfiguration.md)): Promise<WallTab>
...
### `Protected`\_onFilterByCategory

* \_onFilterByCategory(cat: string): void
  ...
  + cat: string
    ...
    The wall category to filter by.
