---
title: "WallConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.WallConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.WallConfig))

* [PlaceableConfig](foundry.applications.sheets.PlaceableConfig.md)
  + WallConfig
    - [WallPalette](foundry.applications.sheets.palette.WallPalette.md)
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: { previewSound: (this: WallConfig) => Promise<void> };  
...
* \_prepareSubmitData(  
  ...
  Overrides PlaceableConfig.\_prepareSubmitData
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<WallConfig>
...
* \_previewChanges(changes: object): void
  ...
  Inherited from PlaceableConfig.\_previewChanges
