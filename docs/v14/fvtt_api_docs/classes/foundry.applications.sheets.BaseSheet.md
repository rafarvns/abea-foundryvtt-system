---
title: "BaseSheet | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.BaseSheet.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.BaseSheet))
...
* new BaseSheet(options: any, ...args: any[]): BaseSheet
...
Â Â Â Â window: { contentClasses: string[]; resizable: boolean };  
} = ...
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<BaseSheet>
