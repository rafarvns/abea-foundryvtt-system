---
title: "WorldSettings | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.collections.WorldSettings.html"
category: "classes"
---
...
[foundry.documents.Setting](foundry.documents.Setting.md): The Setting document

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.collections.WorldSettings))
...
* new WorldSettings(data?: object[]): WorldSettings
...
* \_getVisibleTreeContents(entry: any): [Setting](foundry.documents.Setting.md)[]

  #### Parameters

  + entry: any

  #### Returns [Setting](foundry.documents.Setting.md)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [Setting](foundry.documents.Setting.md)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [Setting](foundry.documents.Setting.md)[]
...
* "[iterator]"(): MapIterator<[Setting](foundry.documents.Setting.md)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[Setting](foundry.documents.Setting.md)>
...
* createDocument(data: object, context?: object): [Setting](foundry.documents.Setting.md)
...
* every(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â element: [Setting](foundry.documents.Setting.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [Setting](foundry.documents.Setting.md)>,  
  Â Â Â Â ) => boolean,  
  ): boolean
  ...
  + condition: (element: [Setting](foundry.documents.Setting.md), index: number, set: [Collection](foundry.utils.Collection.md)<string, [Setting](foundry.documents.Setting.md)>) => boolean
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [Setting](foundry.documents.Setting.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [Setting](foundry.documents.Setting.md)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [Setting](foundry.documents.Setting.md),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [Setting](foundry.documents.Setting.md)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [Setting](foundry.documents.Setting.md)>,  
  Â Â Â Â ) => unknown,  
  ): [Setting](foundry.documents.Setting.md) | undefined
  ...
  #### Returns [Setting](foundry.documents.Setting.md) | undefined
...
* forEach(fn: (value: [Setting](foundry.documents.Setting.md), index: number) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [Setting](foundry.documents.Setting.md), index: number) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [Setting](foundry.documents.Setting.md),  
  ...
  + document: object | [Setting](foundry.documents.Setting.md)
...
* get(id: string, options?: { invalid?: boolean; strict?: boolean }): [Setting](foundry.documents.Setting.md)
...
* getInvalid(id: string, options?: { strict?: boolean }): void | [Setting](foundry.documents.Setting.md)
  ...
  #### Returns void | [Setting](foundry.documents.Setting.md)
...
* getName(name: string, options?: { strict?: boolean }): [Setting](foundry.documents.Setting.md) | undefined
...
* getSetting(key: string, user?: string): [Setting](foundry.documents.Setting.md)
...
* importFromCompendium(  
  ...
  Â Â Â Â options?: any,  
  ): Promise<[Setting](foundry.documents.Setting.md)>
  ...
  #### Returns Promise<[Setting](foundry.documents.Setting.md)>
...
* map<[U](#mapu)>(  
  ...
  + transformer: (element: [Setting](foundry.documents.Setting.md), index: number, collection: [Collection](foundry.utils.Collection.md)<string, [Setting](foundry.documents.Setting.md)>) => [U](foundry.abstract.EmbeddedCollection.md#mapu)
...
* search(  
  ...
  ): object[] | [Setting](foundry.documents.Setting.md)[]
  ...
  #### Returns object[] | [Setting](foundry.documents.Setting.md)[]
...
* set(id: string, document: [Setting](foundry.documents.Setting.md)): WorldSettings

  #### Parameters

  + id: string
  + document: [Setting](foundry.documents.Setting.md)
