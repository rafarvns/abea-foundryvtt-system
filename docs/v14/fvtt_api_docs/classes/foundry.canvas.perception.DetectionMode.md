---
title: "DetectionMode | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.perception.DetectionMode.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.perception.DetectionMode))

* [DataModel](foundry.abstract.DataModel.md)
  + DetectionMode
    - [DetectionModeAll](foundry.canvas.perception.DetectionModeAll.md)
    - [DetectionModeLightPerception](foundry.canvas.perception.DetectionModeLightPerception.md)
    - [DetectionModeInvisibility](foundry.canvas.perception.DetectionModeInvisibility.md)
    - [DetectionModeTremor](foundry.canvas.perception.DetectionModeTremor.md)
    - [DetectionModeDarkvision](foundry.canvas.perception.DetectionModeDarkvision.md)
...
* \_canDetect(  
  ...
  Â Â Â Â level: [documents](../modules/foundry.documents.md).[Level](foundry.documents.Level.md),  
  ): boolean
  ...
  + level: [documents](../modules/foundry.documents.md).[Level](foundry.documents.Level.md)
...
* getDetectionFilter(): Filter | undefined
