---
title: "SirenIlluminationShader | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.rendering.shaders.SirenIlluminationShader.html"
category: "classes"
---

# Class SirenIlluminationShader

Siren light animation illumination shader

#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.rendering.shaders.SirenIlluminationShader))
...
Overrides [AdaptiveIlluminationShader](foundry.canvas.rendering.shaders.AdaptiveIlluminationShader.md).[defaultUniforms](foundry.canvas.rendering.shaders.AdaptiveIlluminationShader.md#defaultuniforms)
