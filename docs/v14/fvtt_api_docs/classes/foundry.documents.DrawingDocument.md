---
title: "DrawingDocument | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.DrawingDocument.html"
category: "classes"
---
...
* [foundry.documents.Scene](foundry.documents.Scene.md): The Scene document type which contains Drawing embedded documents
* [foundry.applications.sheets.DrawingConfig](foundry.applications.sheets.DrawingConfig.md): The Drawing configuration application

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.DrawingDocument))

* [BaseDrawing](foundry.documents.BaseDrawing.md)<this>
  + DrawingDocument
...
[parent](#parent)
[\_schema](#_schema)
[defaultDrawingFields](#defaultdrawingfields)
...
[\_validateVisibleContent](#_validatevisiblecontent)
...
* new DrawingDocument(  
  Â Â Â Â data?: Partial<[DrawingData](../interfaces/foundry.documents.types.DrawingData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): DrawingDocument

  #### Parameters

  + `Optional`data: Partial<[DrawingData](../interfaces/foundry.documents.types.DrawingData.md)> = {}
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[constructor](foundry.documents.BaseDrawing.md#constructor)

## Properties

### `Internal`\_shape

\_shape: [data](../modules/foundry.data.md).[RectangleShapeData](foundry.data.RectangleShapeData.md) | [data](../modules/foundry.data.md).[EllipseShapeData](foundry.data.EllipseShapeData.md) | [data](../modules/foundry.data.md).[PolygonShapeData](foundry.data.PolygonShapeData.md) = ...

The rectangle shape of this Tile document.

### \_source

\_source: [DrawingData](../interfaces/foundry.documents.types.DrawingData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_source](foundry.documents.BaseDrawing.md#_source)
...
Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[parent](foundry.documents.BaseDrawing.md#parent)
...
Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_schema](foundry.documents.BaseDrawing.md#_schema)

### `Static`defaultDrawingFields

defaultDrawingFields: (keyof [DrawingData](../interfaces/foundry.documents.types.DrawingData.md))[] = ...
...
Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseDrawing.md#localization_prefixes)
...
Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[metadata](foundry.documents.BaseDrawing.md#metadata)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_configure](foundry.documents.BaseDrawing.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_getParentCollection](foundry.documents.BaseDrawing.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_initializationOrder](foundry.documents.BaseDrawing.md#_initializationorder)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_updateDiff](foundry.documents.BaseDrawing.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[canUserModify](foundry.documents.BaseDrawing.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[clone](foundry.documents.BaseDrawing.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[createEmbeddedDocuments](foundry.documents.BaseDrawing.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[delete](foundry.documents.BaseDrawing.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[deleteEmbeddedDocuments](foundry.documents.BaseDrawing.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[getEmbeddedCollection](foundry.documents.BaseDrawing.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[getEmbeddedDocument](foundry.documents.BaseDrawing.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[getFieldForProperty](foundry.documents.BaseDrawing.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[getFlag](foundry.documents.BaseDrawing.md#getflag)
...
* getUserLevel(user: any): any
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[getUserLevel](foundry.documents.BaseDrawing.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[migrateSystemData](foundry.documents.BaseDrawing.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[reset](foundry.documents.BaseDrawing.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[setFlag](foundry.documents.BaseDrawing.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[testUserPermission](foundry.documents.BaseDrawing.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[toJSON](foundry.documents.BaseDrawing.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[toObject](foundry.documents.BaseDrawing.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[traverseEmbeddedDocuments](foundry.documents.BaseDrawing.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[unsetFlag](foundry.documents.BaseDrawing.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[update](foundry.documents.BaseDrawing.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[updateEmbeddedDocuments](foundry.documents.BaseDrawing.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[updateSource](foundry.documents.BaseDrawing.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[validate](foundry.documents.BaseDrawing.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_getInnerModel](foundry.documents.BaseDrawing.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_initialize](foundry.documents.BaseDrawing.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_initializeSource](foundry.documents.BaseDrawing.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_onCreate](foundry.documents.BaseDrawing.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_onDelete](foundry.documents.BaseDrawing.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_onUpdate](foundry.documents.BaseDrawing.md#_onupdate)
...
* \_preCreate(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_preCreate](foundry.documents.BaseDrawing.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_preDelete](foundry.documents.BaseDrawing.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_preUpdate](foundry.documents.BaseDrawing.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_preUpdateSource](foundry.documents.BaseDrawing.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_updateCommit](foundry.documents.BaseDrawing.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_addDataFieldMigration](foundry.documents.BaseDrawing.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_addDataFieldShim](foundry.documents.BaseDrawing.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_addDataFieldShims](foundry.documents.BaseDrawing.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_clearFieldsRecursively](foundry.documents.BaseDrawing.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_logDataFieldMigration](foundry.documents.BaseDrawing.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_preCleanData](foundry.documents.BaseDrawing.md#_precleandata)

### `Static`\_validateVisibleContent

* \_validateVisibleContent(  
  Â Â Â Â data: Partial<Pick<[DrawingData](../interfaces/foundry.documents.types.DrawingData.md), "shape">> & Pick<  
  Â Â Â Â Â Â Â Â [DrawingData](../interfaces/foundry.documents.types.DrawingData.md),  
  ...
  + data: Partial<Pick<[DrawingData](../interfaces/foundry.documents.types.DrawingData.md), "shape">> & Pick<  
    Â Â Â Â [DrawingData](../interfaces/foundry.documents.types.DrawingData.md),  
    Â Â Â Â | "text"  
    Â Â Â Â | "textAlpha"  
    Â Â Â Â | "fillType"  
    Â Â Â Â | "fillAlpha"  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_validateVisibleContent](foundry.documents.BaseDrawing.md#_validatevisiblecontent)
...
* canUserCreate(user: any): any
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[canUserCreate](foundry.documents.BaseDrawing.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[cleanData](foundry.documents.BaseDrawing.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[create](foundry.documents.BaseDrawing.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[createDocuments](foundry.documents.BaseDrawing.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â bezierFactor: [AlphaField](foundry.data.fields.AlphaField.md);  
  Â Â Â Â elevation: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â fillAlpha: [AlphaField](foundry.data.fields.AlphaField.md);  
  Â Â Â Â fillColor: [ColorField](foundry.data.fields.ColorField.md);  
  Â Â Â Â fillType: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md);  
  Â Â Â Â fontFamily: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â fontSize: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â hidden: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â interface: [BooleanField](foundry.data.fields.BooleanField.md);  
  ...
  Â Â Â Â shape: [EmbeddedDataField](foundry.data.fields.EmbeddedDataField.md);  
  Â Â Â Â sort: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â strokeAlpha: [AlphaField](foundry.data.fields.AlphaField.md);  
  Â Â Â Â strokeColor: [ColorField](foundry.data.fields.ColorField.md);  
  Â Â Â Â strokeWidth: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â text: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â textAlpha: [AlphaField](foundry.data.fields.AlphaField.md);  
  Â Â Â Â textColor: [ColorField](foundry.data.fields.ColorField.md);  
  Â Â Â Â texture: [FilePathField](foundry.data.fields.FilePathField.md);  
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â author: [DocumentAuthorField](foundry.data.fields.DocumentAuthorField.md); Â Â Â Â bezierFactor: [AlphaField](foundry.data.fields.AlphaField.md); Â Â Â Â elevation: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â fillAlpha: [AlphaField](foundry.data.fields.AlphaField.md); Â Â Â Â fillColor: [ColorField](foundry.data.fields.ColorField.md); Â Â Â Â fillType: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â fontFamily: [StringField](foundry.data.fields.StringField.md); Â Â Â Â fontSize: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â hidden: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â interface: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â levels: [SceneLevelsSetField](foundry.data.fields.SceneLevelsSetField.md); Â Â Â Â locked: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â rotation: [AngleField](foundry.data.fields.AngleField.md); Â Â Â Â shape: [EmbeddedDataField](foundry.data.fields.EmbeddedDataField.md); Â Â Â Â sort: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â strokeAlpha: [AlphaField](foundry.data.fields.AlphaField.md); Â Â Â Â strokeColor: [ColorField](foundry.data.fields.ColorField.md); Â Â Â Â strokeWidth: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â text: [StringField](foundry.data.fields.StringField.md); Â Â Â Â textAlpha: [AlphaField](foundry.data.fields.AlphaField.md); Â Â Â Â textColor: [ColorField](foundry.data.fields.ColorField.md); Â Â Â Â texture: [FilePathField](foundry.data.fields.FilePathField.md); Â Â Â Â x: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â y: [NumberField](foundry.data.fields.NumberField.md); }
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[defineSchema](foundry.documents.BaseDrawing.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[deleteDocuments](foundry.documents.BaseDrawing.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[fromJSON](foundry.documents.BaseDrawing.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[fromSource](foundry.documents.BaseDrawing.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[get](foundry.documents.BaseDrawing.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[getCollectionName](foundry.documents.BaseDrawing.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[migrateData](foundry.documents.BaseDrawing.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[migrateDataSafe](foundry.documents.BaseDrawing.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[shimData](foundry.documents.BaseDrawing.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[updateDocuments](foundry.documents.BaseDrawing.md#updatedocuments)
...
* validateJoint(data: any): void
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[validateJoint](foundry.documents.BaseDrawing.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_cleanData](foundry.documents.BaseDrawing.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_onCreateOperation](foundry.documents.BaseDrawing.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_onDeleteOperation](foundry.documents.BaseDrawing.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_onUpdateOperation](foundry.documents.BaseDrawing.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_preCreateOperation](foundry.documents.BaseDrawing.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_preDeleteOperation](foundry.documents.BaseDrawing.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseDrawing](foundry.documents.BaseDrawing.md).[\_preUpdateOperation](foundry.documents.BaseDrawing.md#_preupdateoperation)