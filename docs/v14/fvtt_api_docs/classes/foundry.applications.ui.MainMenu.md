---
title: "MainMenu | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.ui.MainMenu.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.ui.MainMenu))
...
* new MainMenu(options?: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md)>): MainMenu
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: { menuItem: (this: MainMenu, event: PointerEvent) => void };  
...
ITEMS: Record<string, [MainMenuItem](../interfaces/foundry.MainMenuItem.md)> = ...

Configuration of Main Menu items.

### `Static`PARTS

PARTS: { items: { template: string } } = ...
...
* get items(): Record<string, [MainMenuItem](../interfaces/foundry.MainMenuItem.md)>

  A record of menu items which are currently enabled.

  #### Returns Record<string, [MainMenuItem](../interfaces/foundry.MainMenuItem.md)>
...
* \_insertElement(element: any): void
  ...
  Overrides HandlebarsApplicationMixin(ApplicationV2).\_insertElement
...
* \_prepareContext(\_options: any): Promise<{ items: Record<string, [MainMenuItem](../interfaces/foundry.MainMenuItem.md)> }>

  #### Parameters

  + \_options: any

  #### Returns Promise<{ items: Record<string, [MainMenuItem](../interfaces/foundry.MainMenuItem.md)> }>
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<MainMenu>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<MainMenu>
