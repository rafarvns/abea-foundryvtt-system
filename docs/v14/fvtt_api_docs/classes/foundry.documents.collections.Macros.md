---
title: "Macros | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.collections.Macros.html"
category: "classes"
---
...
* [foundry.documents.Macro](foundry.documents.Macro.md): The Macro document
* [foundry.applications.sidebar.tabs.MacroDirectory](foundry.applications.sidebar.tabs.MacroDirectory.md): The MacroDirectory sidebar directory

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.collections.Macros))
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)[]

  #### Parameters

  + entry: any

  #### Returns [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)
...
* every(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â element: [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)>,  
  Â Â Â Â ) => boolean,  
  ): boolean
  ...
  + condition: (  
    Â Â Â Â element: [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md),  
    Â Â Â Â index: number,  
    Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)>,  
    ) => boolean
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)>,  
  Â Â Â Â ) => unknown,  
  ): [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md) | undefined
  ...
  #### Returns [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md) | undefined
...
* forEach(fn: (value: [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md), index: number) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md), index: number) => void
...
* getInvalid(id: string, options?: { strict?: boolean }): void | [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)
  ...
  #### Returns void | [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)
...
* importFromCompendium(  
  ...
  Â Â Â Â options?: any,  
  ): Promise<[documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)>
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)[]
...
* set(id: string, document: [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)): Macros

  #### Parameters

  + id: string
  + document: [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)
