---
title: "TypeDataModel | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.abstract.TypeDataModel.html"
category: "classes"
---
...
[foundry.abstract.Document](foundry.abstract.Document.md)
...
**en.json** To provide the localization for methods like [ClientDocument.createDialog](foundry.ClientDocument.md#createdialog)
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.abstract.TypeDataModel))

* [DataModel](foundry.abstract.DataModel.md)
  + TypeDataModel
    - [ActiveEffectTypeDataModel](foundry.data.ActiveEffectTypeDataModel.md)
...
* new TypeDataModel<[ModelData](#constructortypedatamodelmodeldata) extends object = object>(  
  Â Â Â Â data?: {},  
  Â Â Â Â options?: {},  
  ): TypeDataModel<[ModelData](#modeldata)>
  ...
  #### Returns TypeDataModel<[ModelData](#modeldata)>
