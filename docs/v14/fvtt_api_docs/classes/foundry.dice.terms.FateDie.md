---
title: "FateDie | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.dice.terms.FateDie.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.dice.terms.FateDie))
...
MODIFIERS: {  
Â Â Â Â d: (modifier: string) => false | undefined;  
Â Â Â Â dh: (modifier: string) => false | undefined;  
Â Â Â Â dl: (modifier: string) => false | undefined;  
Â Â Â Â k: (modifier: string) => false | undefined;  
Â Â Â Â kh: (modifier: string) => false | undefined;  
Â Â Â Â kl: (modifier: string) => false | undefined;  
