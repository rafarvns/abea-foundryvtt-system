---
title: "ExecuteScriptRegionBehaviorType | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.regionBehaviors.ExecuteScriptRegionBehaviorType.html"
category: "classes"
---

# Class ExecuteScriptRegionBehaviorType

The data model for a behavior that executes a script.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.regionBehaviors.ExecuteScriptRegionBehaviorType))
...
* new ExecuteScriptRegionBehaviorType(  
  Â Â Â Â data?: {},  
  Â Â Â Â options?: {},  
  ): ExecuteScriptRegionBehaviorType
  ...
  #### Returns ExecuteScriptRegionBehaviorType
...
* defineSchema(): { events: [SetField](foundry.data.fields.SetField.md); source: [JavaScriptField](foundry.data.fields.JavaScriptField.md) }

  #### Returns { events: [SetField](foundry.data.fields.SetField.md); source: [JavaScriptField](foundry.data.fields.JavaScriptField.md) }
