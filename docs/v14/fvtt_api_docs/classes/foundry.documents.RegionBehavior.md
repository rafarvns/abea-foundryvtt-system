---
title: "RegionBehavior | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.RegionBehavior.html"
category: "classes"
---
...
* [foundry.documents.RegionDocument](foundry.documents.RegionDocument.md): The Region document type which contains
  RegionBehavior documents
* [foundry.applications.sheets.RegionBehaviorConfig](foundry.applications.sheets.RegionBehaviorConfig.md): The RegionBehaviorConfig
  configuration application

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.RegionBehavior))

* [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md)<this>
  + RegionBehavior
...
* new RegionBehavior(  
  Â Â Â Â data?: Partial<[RegionBehaviorData](../interfaces/foundry.documents.types.RegionBehaviorData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).RegionBehavior

  #### Parameters

  + `Optional`data: Partial<[RegionBehaviorData](../interfaces/foundry.documents.types.RegionBehaviorData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).RegionBehavior

  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[constructor](foundry.documents.BaseRegionBehavior.md#constructor)

## Properties

### \_source

\_source: [RegionBehaviorData](../interfaces/foundry.documents.types.RegionBehaviorData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_source](foundry.documents.BaseRegionBehavior.md#_source)
...
Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[parent](foundry.documents.BaseRegionBehavior.md#parent)
...
Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_schema](foundry.documents.BaseRegionBehavior.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseRegionBehavior.md#localization_prefixes)
...
Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[metadata](foundry.documents.BaseRegionBehavior.md#metadata)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_configure](foundry.documents.BaseRegionBehavior.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_getParentCollection](foundry.documents.BaseRegionBehavior.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_initializationOrder](foundry.documents.BaseRegionBehavior.md#_initializationorder)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_updateDiff](foundry.documents.BaseRegionBehavior.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[canUserModify](foundry.documents.BaseRegionBehavior.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[clone](foundry.documents.BaseRegionBehavior.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[createEmbeddedDocuments](foundry.documents.BaseRegionBehavior.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[delete](foundry.documents.BaseRegionBehavior.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[deleteEmbeddedDocuments](foundry.documents.BaseRegionBehavior.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[getEmbeddedCollection](foundry.documents.BaseRegionBehavior.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[getEmbeddedDocument](foundry.documents.BaseRegionBehavior.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[getFieldForProperty](foundry.documents.BaseRegionBehavior.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[getFlag](foundry.documents.BaseRegionBehavior.md#getflag)
...
* getUserLevel(user: any): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.md)
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[getUserLevel](foundry.documents.BaseRegionBehavior.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[migrateSystemData](foundry.documents.BaseRegionBehavior.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[reset](foundry.documents.BaseRegionBehavior.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[setFlag](foundry.documents.BaseRegionBehavior.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[testUserPermission](foundry.documents.BaseRegionBehavior.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[toJSON](foundry.documents.BaseRegionBehavior.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[toObject](foundry.documents.BaseRegionBehavior.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[traverseEmbeddedDocuments](foundry.documents.BaseRegionBehavior.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[unsetFlag](foundry.documents.BaseRegionBehavior.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[update](foundry.documents.BaseRegionBehavior.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[updateEmbeddedDocuments](foundry.documents.BaseRegionBehavior.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[updateSource](foundry.documents.BaseRegionBehavior.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[validate](foundry.documents.BaseRegionBehavior.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_getInnerModel](foundry.documents.BaseRegionBehavior.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_initialize](foundry.documents.BaseRegionBehavior.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_initializeSource](foundry.documents.BaseRegionBehavior.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_onCreate](foundry.documents.BaseRegionBehavior.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_onDelete](foundry.documents.BaseRegionBehavior.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_onUpdate](foundry.documents.BaseRegionBehavior.md#_onupdate)
...
* \_preCreate(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_preCreate](foundry.documents.BaseRegionBehavior.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_preDelete](foundry.documents.BaseRegionBehavior.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_preUpdate](foundry.documents.BaseRegionBehavior.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_preUpdateSource](foundry.documents.BaseRegionBehavior.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_updateCommit](foundry.documents.BaseRegionBehavior.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_addDataFieldMigration](foundry.documents.BaseRegionBehavior.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_addDataFieldShim](foundry.documents.BaseRegionBehavior.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_addDataFieldShims](foundry.documents.BaseRegionBehavior.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_clearFieldsRecursively](foundry.documents.BaseRegionBehavior.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_logDataFieldMigration](foundry.documents.BaseRegionBehavior.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_preCleanData](foundry.documents.BaseRegionBehavior.md#_precleandata)
...
* canUserCreate(user: any): any
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[canUserCreate](foundry.documents.BaseRegionBehavior.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[cleanData](foundry.documents.BaseRegionBehavior.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[create](foundry.documents.BaseRegionBehavior.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[createDocuments](foundry.documents.BaseRegionBehavior.md#createdocuments)
...
* defineSchema(): {  
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â disabled: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â system: [TypeDataField](foundry.data.fields.TypeDataField.md); Â Â Â Â type: [DocumentTypeField](foundry.data.fields.DocumentTypeField.md); }
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[defineSchema](foundry.documents.BaseRegionBehavior.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[deleteDocuments](foundry.documents.BaseRegionBehavior.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[fromJSON](foundry.documents.BaseRegionBehavior.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[fromSource](foundry.documents.BaseRegionBehavior.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[get](foundry.documents.BaseRegionBehavior.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[getCollectionName](foundry.documents.BaseRegionBehavior.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[migrateData](foundry.documents.BaseRegionBehavior.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[migrateDataSafe](foundry.documents.BaseRegionBehavior.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[shimData](foundry.documents.BaseRegionBehavior.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[updateDocuments](foundry.documents.BaseRegionBehavior.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[validateJoint](foundry.documents.BaseRegionBehavior.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_cleanData](foundry.documents.BaseRegionBehavior.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_onCreateOperation](foundry.documents.BaseRegionBehavior.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_onDeleteOperation](foundry.documents.BaseRegionBehavior.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_onUpdateOperation](foundry.documents.BaseRegionBehavior.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_preCreateOperation](foundry.documents.BaseRegionBehavior.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_preDeleteOperation](foundry.documents.BaseRegionBehavior.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseRegionBehavior](foundry.documents.BaseRegionBehavior.md).[\_preUpdateOperation](foundry.documents.BaseRegionBehavior.md#_preupdateoperation)