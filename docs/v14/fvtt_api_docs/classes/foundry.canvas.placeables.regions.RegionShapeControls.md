---
title: "RegionShapeControls | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.placeables.regions.RegionShapeControls.html"
category: "classes"
---

# Class RegionShapeControls

Controls for a Region shape.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.placeables.regions.RegionShapeControls))
...
* new RegionShapeControls(shape: [BaseShapeData](foundry.data.BaseShapeData.md)): RegionShapeControls

  #### Parameters

  + shape: [BaseShapeData](foundry.data.BaseShapeData.md)

    The shape.

  #### Returns RegionShapeControls
...
* \_onDragDrop(event: any): void
  ...
  Inherited from [ShapeControls](foundry.canvas.containers.ShapeControls.md).[\_onDragDrop](foundry.canvas.containers.ShapeControls.md#_ondragdrop)
...
* draw(): Promise<RegionShapeControls>

  Draw the visualization of these controls.

  #### Returns Promise<RegionShapeControls>
...
* \_onDragStart(event: FederatedEvent<UIEvent | PixiTouch>): void
  ...
  Inherited from [ShapeControls](foundry.canvas.containers.ShapeControls.md).[\_onDragStart](foundry.canvas.containers.ShapeControls.md#_ondragstart)
...
* \_prepareDragDropUpdate(  
  ...
  Inherited from [ShapeControls](foundry.canvas.containers.ShapeControls.md).[\_prepareDragDropUpdate](foundry.canvas.containers.ShapeControls.md#_preparedragdropupdate)
