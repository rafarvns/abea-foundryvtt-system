---
title: "LightData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.LightData.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.LightData))
...
* new LightData(data?: object, options?: [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)): LightData
...
* defineSchema(): {  
  ...
  Â Â Â Â attenuation: [AlphaField](foundry.data.fields.AlphaField.md);  
  Â Â Â Â bright: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â color: [ColorField](foundry.data.fields.ColorField.md);  
  Â Â Â Â coloration: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â contrast: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â darkness: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â dim: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â luminosity: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â negative: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â priority: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â saturation: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â shadows: [NumberField](foundry.data.fields.NumberField.md);  
  }
  ...
  #### Returns { Â Â Â Â alpha: [AlphaField](foundry.data.fields.AlphaField.md); Â Â Â Â angle: [AngleField](foundry.data.fields.AngleField.md); Â Â Â Â animation: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â attenuation: [AlphaField](foundry.data.fields.AlphaField.md); Â Â Â Â bright: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â color: [ColorField](foundry.data.fields.ColorField.md); Â Â Â Â coloration: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â contrast: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â darkness: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â dim: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â luminosity: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â negative: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â priority: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â saturation: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â shadows: [NumberField](foundry.data.fields.NumberField.md); }
