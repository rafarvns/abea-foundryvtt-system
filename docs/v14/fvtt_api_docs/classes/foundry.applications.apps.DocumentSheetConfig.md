---
title: "DocumentSheetConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.apps.DocumentSheetConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.apps.DocumentSheetConfig))

* [ApplicationV2](foundry.applications.api.ApplicationV2.md)<  
  Â Â Â Â [ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [DocumentSheetConfiguration](../interfaces/foundry.DocumentSheetConfiguration.md),  
  Â Â Â Â [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md) & [DocumentSheetRenderOptions](../interfaces/foundry.DocumentSheetRenderOptions.md),  
  Â Â Â Â this,  
  >
  + DocumentSheetConfig
...
[\_prepareFormContext](#_prepareformcontext)
...
[getSheetClassesForSubType](#getsheetclassesforsubtype)
[getSheetThemeForDocument](#getsheetthemefordocument)
...
[updateDefaultSheets](#updatedefaultsheets)
...
* new DocumentSheetConfig(  
  Â Â Â Â options?: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [DocumentSheetConfiguration](../interfaces/foundry.DocumentSheetConfiguration.md)>,  
  ): DocumentSheetConfig
  ...
  + `Optional`options: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [DocumentSheetConfiguration](../interfaces/foundry.DocumentSheetConfiguration.md)> = {}

    Options used to configure the Application instance

  #### Returns DocumentSheetConfig
...
Â Â Â Â Â Â Â Â Â Â Â Â this: DocumentSheetConfig,  
...
Â Â Â Â };  
Â Â Â Â id: string;  
Â Â Â Â ownershipConfig: boolean;  
...
Â Â Â Â form: { classes: string[]; template: string };  
} = ...
...
* \_canDetach(): boolean
  ...
  Inherited from HandlebarsApplicationMixin(DocumentSheetV2).\_canDetach
...
* attachWindow(  
  ...
  Inherited from HandlebarsApplicationMixin(DocumentSheetV2).attachWindow
...
* close(  
  ...
  #### Returns Promise<DocumentSheetConfig>
...
* detachWindow(  
  ...
  Inherited from HandlebarsApplicationMixin(DocumentSheetV2).detachWindow
...
* renderChild(  
  ...
  Inherited from HandlebarsApplicationMixin(DocumentSheetV2).renderChild
...
* \_canAttach(): boolean
  ...
  Inherited from HandlebarsApplicationMixin(DocumentSheetV2).\_canAttach
...
* \_getFrameButtons(  
  ...
  Inherited from HandlebarsApplicationMixin(DocumentSheetV2).\_getFrameButtons
...
* \_headerControlContextEntries(): Generator<[ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md), void, any>
  ...
  Inherited from HandlebarsApplicationMixin(DocumentSheetV2).\_headerControlContextEntries
...
* \_onAttach(from: Document, to: Document): void
  ...
  Inherited from HandlebarsApplicationMixin(DocumentSheetV2).\_onAttach
...
* \_onDetach(from: Document, to: Document): void
  ...
  Inherited from HandlebarsApplicationMixin(DocumentSheetV2).\_onDetach
...
* \_refit(positionUpdate?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void
  ...
  Inherited from HandlebarsApplicationMixin(DocumentSheetV2).\_refit
...
* \_renderFrameButtons(  
  ...
  Inherited from HandlebarsApplicationMixin(DocumentSheetV2).\_renderFrameButtons
...
* getSheetClassesForSubType(  
  ...
  Â Â Â Â subType?: string,  
  ): {  
  Â Â Â Â defaultClass: string;  
  Â Â Â Â defaultClasses: Record<string, string>;  
  Â Â Â Â sheetClasses: Record<string, string>;  
  }
  ...
  + `Optional`subType: string
    ...
    The Document sub-type, if applicable.

  #### Returns { Â Â Â Â defaultClass: string; Â Â Â Â defaultClasses: Record<string, string>; Â Â Â Â sheetClasses: Record<string, string>; }

### `Static`getSheetThemeForDocument

* getSheetThemeForDocument(document: ClientDocument): string
  ...
  The theme identifier, or a blank string if the user has no preference.
...
* registerSheet(  
  Â Â Â Â documentClass: any,  
  Â Â Â Â scope: string,  
  Â Â Â Â sheetClass: typeof [Application](foundry.appv1.api.Application.md) | typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md),  
  Â Â Â Â options?: [SheetRegistrationOptions](../types/foundry.SheetRegistrationOptions.md),  
  ): void
  ...
  + documentClass: any
    ...
    The Document class to register a new sheet for.
  + scope: string

    A unique namespace scope for this sheet.
  + sheetClass: typeof [Application](foundry.appv1.api.Application.md) | typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md)

    An Application class used to render the sheet.
  + options: [SheetRegistrationOptions](../types/foundry.SheetRegistrationOptions.md) = {}

    Sheet registration configuration options.
...
* unregisterSheet(  
  ...
  + sheetClass: typeof [Application](foundry.appv1.api.Application.md) | typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md)
    ...
    An Application class used to render the sheet.
  + `Optional`options: { types?: string[] } = {}
    - ##### `Optional`types?: string[]

      The sub-types this sheet should be removed for,
...
* updateDefaultSheets(setting?: Record<string, string>): void
  ...
  + setting: Record<string, string> = {}
    ...
    The stored default sheet settings.
