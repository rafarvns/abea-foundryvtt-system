---
title: "AmbientLight | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.placeables.AmbientLight.html"
category: "classes"
---
...
* [foundry.documents.AmbientLightDocument](foundry.documents.AmbientLightDocument.md)
* [foundry.canvas.layers.LightingLayer](foundry.canvas.layers.LightingLayer.md)
...
[\_isLightSourceDisabled](#_islightsourcedisabled)
...
* new AmbientLight(document: CanvasDocument): [canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).AmbientLight
  ...
  #### Returns [canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).AmbientLight
...
controls: [AmbientLightShapeControls](foundry.canvas.placeables.lights.AmbientLightShapeControls.md)
...
* get sourceId(): string
  ...
  Overrides ShapeObjectMixin(PlaceableObject).sourceId
...
* \_getMeasuredShapes(): ([CircleShapeData](foundry.CircleShapeData.md) | [ConeShapeData](foundry.ConeShapeData.md))[]

  #### Returns ([CircleShapeData](foundry.CircleShapeData.md) | [ConeShapeData](foundry.ConeShapeData.md))[]
...
* \_clear(): void
  ...
  Inherited from ShapeObjectMixin(PlaceableObject).\_clear
