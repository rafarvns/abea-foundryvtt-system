---
title: "WallDocument | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.WallDocument.html"
category: "classes"
---
...
* [foundry.documents.Scene](foundry.documents.Scene.md): The Scene document type which contains Wall documents
* [foundry.applications.sheets.WallConfig](foundry.applications.sheets.WallConfig.md): The Wall configuration application

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.WallDocument))

* [BaseWall](foundry.documents.BaseWall.md)<this>
  + WallDocument
...
[parent](#parent)
[\_schema](#_schema)
[CATEGORY\_COLORS](#category_colors)
...
[getWallCategory](#getwallcategory)
...
* new WallDocument(  
  Â Â Â Â data?: Partial<[WallData](../interfaces/foundry.documents.types.WallData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): WallDocument

  #### Parameters

  + `Optional`data: Partial<[WallData](../interfaces/foundry.documents.types.WallData.md)> = {}
  ...
  #### Returns WallDocument

  Inherited from [BaseWall](foundry.documents.BaseWall.md).[constructor](foundry.documents.BaseWall.md#constructor)

## Properties

### \_source

\_source: [WallData](../interfaces/foundry.documents.types.WallData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_source](foundry.documents.BaseWall.md#_source)
...
Inherited from [BaseWall](foundry.documents.BaseWall.md).[parent](foundry.documents.BaseWall.md#parent)
...
Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_schema](foundry.documents.BaseWall.md#_schema)

### `Static`CATEGORY\_COLORS

CATEGORY\_COLORS: Record<string, [Color](foundry.utils.Color.md)> = ...

Colors for each category of wall.

Inherited from [BaseWall](foundry.documents.BaseWall.md).[CATEGORY\_COLORS](foundry.documents.BaseWall.md#category_colors)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseWall](foundry.documents.BaseWall.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseWall.md#localization_prefixes)
...
Inherited from [BaseWall](foundry.documents.BaseWall.md).[metadata](foundry.documents.BaseWall.md#metadata)
...
* get darkness(): [EdgeSenseType](../types/CONST.EdgeSenseType.md)

  The darkness edge sense type, which is the same value as [WallData#light](../interfaces/foundry.documents.types.WallData.md#light).

  #### Returns [EdgeSenseType](../types/CONST.EdgeSenseType.md)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_configure](foundry.documents.BaseWall.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_getParentCollection](foundry.documents.BaseWall.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_initializationOrder](foundry.documents.BaseWall.md#_initializationorder)
...
* \_onCreate(data: any, options: any, userId: any): void
  ...
  Overrides [BaseWall](foundry.documents.BaseWall.md).[\_onCreate](foundry.documents.BaseWall.md#_oncreate)
...
* \_onDelete(options: any, userId: any): void
  ...
  Overrides [BaseWall](foundry.documents.BaseWall.md).[\_onDelete](foundry.documents.BaseWall.md#_ondelete)
...
* \_onUpdate(changed: any, options: any, userId: any): void
  ...
  Overrides [BaseWall](foundry.documents.BaseWall.md).[\_onUpdate](foundry.documents.BaseWall.md#_onupdate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_updateDiff](foundry.documents.BaseWall.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[canUserModify](foundry.documents.BaseWall.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[clone](foundry.documents.BaseWall.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[createEmbeddedDocuments](foundry.documents.BaseWall.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[delete](foundry.documents.BaseWall.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[deleteEmbeddedDocuments](foundry.documents.BaseWall.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[getEmbeddedCollection](foundry.documents.BaseWall.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[getEmbeddedDocument](foundry.documents.BaseWall.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[getFieldForProperty](foundry.documents.BaseWall.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[getFlag](foundry.documents.BaseWall.md#getflag)
...
* getUserLevel(user: any): any
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[getUserLevel](foundry.documents.BaseWall.md#getuserlevel)

### getWallCategory

* getWallCategory(): [WallCategory](../types/foundry.documents.types.WallCategory.md)

  Broadly classify a wall into one of several categories, based on its properties.

  #### Returns [WallCategory](../types/foundry.documents.types.WallCategory.md)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[migrateSystemData](foundry.documents.BaseWall.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[reset](foundry.documents.BaseWall.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[setFlag](foundry.documents.BaseWall.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[testUserPermission](foundry.documents.BaseWall.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[toJSON](foundry.documents.BaseWall.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[toObject](foundry.documents.BaseWall.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[traverseEmbeddedDocuments](foundry.documents.BaseWall.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[unsetFlag](foundry.documents.BaseWall.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[update](foundry.documents.BaseWall.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[updateEmbeddedDocuments](foundry.documents.BaseWall.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[updateSource](foundry.documents.BaseWall.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[validate](foundry.documents.BaseWall.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_getInnerModel](foundry.documents.BaseWall.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_initialize](foundry.documents.BaseWall.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_initializeSource](foundry.documents.BaseWall.md#_initializesource)

### `Protected`\_onEdgeChange

* \_onEdgeChange(  
  Â Â Â Â level: Level,  
  Â Â Â Â newEdge: [Edge](foundry.canvas.geometry.edges.Edge.md) | null,  
  Â Â Â Â priorEdge: [Edge](foundry.canvas.geometry.edges.Edge.md) | null,  
  Â Â Â Â changedTypes: ReadonlySet<  
  ...
  + level: Level
    ...
    The level the edge is changed in
  + newEdge: [Edge](foundry.canvas.geometry.edges.Edge.md) | null

    The new edge in the level, unless removed from level
  + priorEdge: [Edge](foundry.canvas.geometry.edges.Edge.md) | null

    The prior edge in the level, unless added to level
  + changedTypes: ReadonlySet<"darkness" | "light" | "sight" | "sound" | "move">

    The affected edge restriction types
...
* \_preCreate(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_preCreate](foundry.documents.BaseWall.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_preDelete](foundry.documents.BaseWall.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_preUpdate](foundry.documents.BaseWall.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_preUpdateSource](foundry.documents.BaseWall.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_updateCommit](foundry.documents.BaseWall.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_addDataFieldMigration](foundry.documents.BaseWall.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_addDataFieldShim](foundry.documents.BaseWall.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_addDataFieldShims](foundry.documents.BaseWall.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_clearFieldsRecursively](foundry.documents.BaseWall.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_logDataFieldMigration](foundry.documents.BaseWall.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_preCleanData](foundry.documents.BaseWall.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[canUserCreate](foundry.documents.BaseWall.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[cleanData](foundry.documents.BaseWall.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[create](foundry.documents.BaseWall.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[createDocuments](foundry.documents.BaseWall.md#createdocuments)

### `Static`defineSchema

* defineSchema(): {  
  Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md);  
  Â Â Â Â animation: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â c: [ArrayField](foundry.data.fields.ArrayField.md)<[NumberField](foundry.data.fields.NumberField.md)>;  
  Â Â Â Â dir: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â door: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â doorSound: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â ds: [NumberField](foundry.data.fields.NumberField.md);  
  ...
  Â Â Â Â light: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â move: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â sight: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â sound: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â threshold: [SchemaField](foundry.data.fields.SchemaField.md);  
  }
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â animation: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â c: [ArrayField](foundry.data.fields.ArrayField.md)<[NumberField](foundry.data.fields.NumberField.md)>; Â Â Â Â dir: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â door: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â doorSound: [StringField](foundry.data.fields.StringField.md); Â Â Â Â ds: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â levels: [SceneLevelsSetField](foundry.data.fields.SceneLevelsSetField.md); Â Â Â Â light: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â move: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â sight: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â sound: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â threshold: [SchemaField](foundry.data.fields.SchemaField.md); }
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[defineSchema](foundry.documents.BaseWall.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[deleteDocuments](foundry.documents.BaseWall.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[fromJSON](foundry.documents.BaseWall.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[fromSource](foundry.documents.BaseWall.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[get](foundry.documents.BaseWall.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[getCollectionName](foundry.documents.BaseWall.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[migrateData](foundry.documents.BaseWall.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[migrateDataSafe](foundry.documents.BaseWall.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[shimData](foundry.documents.BaseWall.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[updateDocuments](foundry.documents.BaseWall.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[validateJoint](foundry.documents.BaseWall.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_cleanData](foundry.documents.BaseWall.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_onCreateOperation](foundry.documents.BaseWall.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_onDeleteOperation](foundry.documents.BaseWall.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_onUpdateOperation](foundry.documents.BaseWall.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_preCreateOperation](foundry.documents.BaseWall.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_preDeleteOperation](foundry.documents.BaseWall.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseWall](foundry.documents.BaseWall.md).[\_preUpdateOperation](foundry.documents.BaseWall.md#_preupdateoperation)