---
title: "PermissionConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.apps.PermissionConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.apps.PermissionConfig))
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â reset: (this: PermissionConfig, event: PointerEvent) => Promise<void>;  
Â Â Â Â };  
Â Â Â Â form: {  
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â )[];  
  Â Â Â Â Â Â Â Â permissions: object[];  
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â buttons: ( Â Â Â Â Â Â Â Â Â Â Â Â | { action: string; icon: string; label: string; type: string } Â Â Â Â Â Â Â Â Â Â Â Â | { action?: undefined; icon: string; label: string; type: string } Â Â Â Â Â Â Â Â )[]; Â Â Â Â Â Â Â Â permissions: object[]; Â Â Â Â Â Â Â Â roles: {}; Â Â Â Â }, >
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<PermissionConfig>
  ...
  #### Returns Promise<PermissionConfig>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<PermissionConfig>
