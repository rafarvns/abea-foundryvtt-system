...
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.ActiveEffect.html"
category: "classes"
---
...
* [hookEvents.applyActiveEffect](../functions/hookEvents.applyActiveEffect.md)
...
* [Actor](foundry.documents.Actor.md): The Actor document which contains ActiveEffect embedded documents
* [Item](foundry.documents.Item.md): The Item document which contains ActiveEffect embedded documents

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.ActiveEffect))

* [BaseActiveEffect](foundry.documents.BaseActiveEffect.md)<this>
  + ActiveEffect
...
[isExpiryTrackable](#isexpirytrackable)
[isSuppressed](#issuppressed)
[isTemporary](#istemporary)
[item](#item)
[modifiesActor](#modifiesactor)
[schema](#schema)
...
[CHANGE\_PHASES](#change_phases)
[CHANGE\_TYPES](#change_types)
[collectionName](#collectionname)
[database](#database)
[documentName](#documentname)
[EXPIRY\_EVENTS](#expiry_events)
...
[reset](#reset)
[setFlag](#setflag)
[shouldApplyChange](#shouldapplychange)
...
[validate](#validate)
[\_displayScrollingStatus](#_displayscrollingstatus)
[\_getInnerModel](#_getinnermodel)
[\_initializeSource](#_initializesource)
[\_preDelete](#_predelete)
[\_prepareCombatBasedDuration](#_preparecombatbasedduration)
[\_prepareDuration](#_prepareduration)
[\_prepareTimeBasedDuration](#_preparetimebasedduration)
...
[\_shimChanges](#_shimchanges)
[applyChange](#applychange)
[applyChangeField](#applychangefield)
...
[fromStatusEffect](#fromstatuseffect)
[get](#get)
...
[\_applyChangeUnguided](#_applychangeunguided)
[\_applyChangeUpgrade](#_applychangeupgrade)
[\_cleanData](#_cleandata)
[\_fromStatusEffect](#_fromstatuseffect)
...
* new ActiveEffect(  
  Â Â Â Â data?: Partial<[ActiveEffectData](../interfaces/foundry.documents.types.ActiveEffectData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).ActiveEffect

  #### Parameters

  + `Optional`data: Partial<[ActiveEffectData](../interfaces/foundry.documents.types.ActiveEffectData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).ActiveEffect

  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[constructor](foundry.documents.BaseActiveEffect.md#constructor)

## Properties

### \_source

\_source: [ActiveEffectData](../interfaces/foundry.documents.types.ActiveEffectData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_source](foundry.documents.BaseActiveEffect.md#_source)
...
Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[parent](foundry.documents.BaseActiveEffect.md#parent)
...
Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_schema](foundry.documents.BaseActiveEffect.md#_schema)

### `Static`DEFAULT\_ICON

DEFAULT\_ICON: string = "icons/svg/aura.svg"

The default icon used for newly created ActiveEffect documents

Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[DEFAULT\_ICON](foundry.documents.BaseActiveEffect.md#default_icon)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseActiveEffect.md#localization_prefixes)
...
Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[metadata](foundry.documents.BaseActiveEffect.md#metadata)

### `Static`registry

registry: [ActiveEffectRegistry](foundry.helpers.ActiveEffectRegistry.md) = ...
...
* get isExpiryTrackable(): any
  ...
  Whether this Active Effect is eligible to be registered with the [ActiveEffectRegistry](foundry.helpers.ActiveEffectRegistry.md)
...
* get item(): [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md) | null

  The Item in which this ActiveEffect is embedded

  #### Returns [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md) | null
...
* get target(): [Document](foundry.abstract.Document.md)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md)> | null
...
### `Static`CHANGE\_PHASES

* get CHANGE\_PHASES(): Record<string, { hint: string; label: string }>

  A cached compilation of core and registered application phases, along with their labels

  #### Returns Record<string, { hint: string; label: string }>

### `Static`CHANGE\_TYPES

* get CHANGE\_TYPES(): Record<string, [ActiveEffectChangeTypeConfig](../interfaces/CONFIG.ActiveEffectChangeTypeConfig.md)>

  A cached compilation of core and registered change types, along with their labels and default priorities

  #### Returns Record<string, [ActiveEffectChangeTypeConfig](../interfaces/CONFIG.ActiveEffectChangeTypeConfig.md)>
...
### `Static`EXPIRY\_EVENTS

* get EXPIRY\_EVENTS(): Record<string, string>
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_configure](foundry.documents.BaseActiveEffect.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_getParentCollection](foundry.documents.BaseActiveEffect.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_initializationOrder](foundry.documents.BaseActiveEffect.md#_initializationorder)
...
* \_initialize(options?: {}): void
  ...
  Overrides [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_initialize](foundry.documents.BaseActiveEffect.md#_initialize)
...
* \_onCreate(data: any, options: any, userId: any): void
  ...
  Overrides [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_onCreate](foundry.documents.BaseActiveEffect.md#_oncreate)
...
* \_onDelete(options: any, userId: any): void
  ...
  Overrides [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_onDelete](foundry.documents.BaseActiveEffect.md#_ondelete)
...
* \_onUpdate(changed: any, options: any, userId: any): void
  ...
  Overrides [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_onUpdate](foundry.documents.BaseActiveEffect.md#_onupdate)
...
* \_preCreate(data: any, options: any, user: any): Promise<false | undefined>
  ...
  Overrides [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_preCreate](foundry.documents.BaseActiveEffect.md#_precreate)
...
* \_preUpdate(data: any, options: any, user: any): Promise<false | undefined>
  ...
  Overrides [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_preUpdate](foundry.documents.BaseActiveEffect.md#_preupdate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_updateDiff](foundry.documents.BaseActiveEffect.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[canUserModify](foundry.documents.BaseActiveEffect.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[clone](foundry.documents.BaseActiveEffect.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[createEmbeddedDocuments](foundry.documents.BaseActiveEffect.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[delete](foundry.documents.BaseActiveEffect.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[deleteEmbeddedDocuments](foundry.documents.BaseActiveEffect.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[getEmbeddedCollection](foundry.documents.BaseActiveEffect.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[getEmbeddedDocument](foundry.documents.BaseActiveEffect.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[getFieldForProperty](foundry.documents.BaseActiveEffect.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[getFlag](foundry.documents.BaseActiveEffect.md#getflag)
...
* getUserLevel(user?: [BaseUser](foundry.documents.BaseUser.md)): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.md)
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[getUserLevel](foundry.documents.BaseActiveEffect.md#getuserlevel)
...
* isExpiryEvent(event: string, context?: object): boolean
  ...
  + `Optional`context: object
    ...
    Contextual information for use in the determination
...
* migrateSystemData(): object
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[migrateSystemData](foundry.documents.BaseActiveEffect.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[reset](foundry.documents.BaseActiveEffect.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[setFlag](foundry.documents.BaseActiveEffect.md#setflag)

### shouldApplyChange

* shouldApplyChange(  
  Â Â Â Â change: [ActiveEffectChangeData](../interfaces/foundry.documents.types.ActiveEffectChangeData.md),  
  Â Â Â Â options?: { phase?: string },  
  ): boolean
  ...
  + `Optional`options: { phase?: string } = {}

    Options which affect whether the change is applied.
  ...
  Whether the change should be applied during this phase.
...
* testUserPermission(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[testUserPermission](foundry.documents.BaseActiveEffect.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[toJSON](foundry.documents.BaseActiveEffect.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[toObject](foundry.documents.BaseActiveEffect.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[traverseEmbeddedDocuments](foundry.documents.BaseActiveEffect.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[unsetFlag](foundry.documents.BaseActiveEffect.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[update](foundry.documents.BaseActiveEffect.md#update)

### updateDuration

* updateDuration(context?: object): [ActiveEffectDuration](../interfaces/foundry.documents.types.ActiveEffectDuration.md)
  ...
  + `Optional`context: object
    ...
    Contextual information indicating what lead to this call

  #### Returns [ActiveEffectDuration](../interfaces/foundry.documents.types.ActiveEffectDuration.md)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[updateEmbeddedDocuments](foundry.documents.BaseActiveEffect.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[updateSource](foundry.documents.BaseActiveEffect.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[validate](foundry.documents.BaseActiveEffect.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_getInnerModel](foundry.documents.BaseActiveEffect.md#_getinnermodel)
...
* \_initializeSource(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_initializeSource](foundry.documents.BaseActiveEffect.md#_initializesource)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_preDelete](foundry.documents.BaseActiveEffect.md#_predelete)

### `Protected`\_prepareCombatBasedDuration

* \_prepareCombatBasedDuration(  
  Â Â Â Â duration: [EffectDurationData](../interfaces/foundry.documents.types.EffectDurationData.md),  
  Â Â Â Â context?: object,  
  ): [ActiveEffectDuration](../interfaces/foundry.documents.types.ActiveEffectDuration.md)
  ...
  + duration: [EffectDurationData](../interfaces/foundry.documents.types.EffectDurationData.md)

    Unprepared duration data
  + `Optional`context: object
...
* \_prepareDuration(  
  ...
  + `Optional`duration: [EffectDurationData](../interfaces/foundry.documents.types.EffectDurationData.md)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_preUpdateSource](foundry.documents.BaseActiveEffect.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_updateCommit](foundry.documents.BaseActiveEffect.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_addDataFieldMigration](foundry.documents.BaseActiveEffect.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_addDataFieldShim](foundry.documents.BaseActiveEffect.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_addDataFieldShims](foundry.documents.BaseActiveEffect.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_clearFieldsRecursively](foundry.documents.BaseActiveEffect.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_logDataFieldMigration](foundry.documents.BaseActiveEffect.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_preCleanData](foundry.documents.BaseActiveEffect.md#_precleandata)

### `Static`\_shimChanges

* \_shimChanges(changes: EffectChangeData[]): void
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_shimChanges](foundry.documents.BaseActiveEffect.md#_shimchanges)

### `Static`applyChange

* applyChange(  
  Â Â Â Â targetDoc: any,  
  Â Â Â Â change: [ActiveEffectChangeData](../interfaces/foundry.documents.types.ActiveEffectChangeData.md),  
  Â Â Â Â options?: { modifyTarget?: boolean; replacementData?: object },  
  ...
  + targetDoc: any
    ...
    The Document to which this effect should be applied
  + change: [ActiveEffectChangeData](../interfaces/foundry.documents.types.ActiveEffectChangeData.md)

    The change data being applied
  + `Optional`options: { modifyTarget?: boolean; replacementData?: object } = {}

    Options affecting the change application

    - ##### `Optional`modifyTarget?: boolean

      Modify the target Document with the updated value.
    - ##### `Optional`replacementData?: object

      Data used to resolve "@" expressions in a string value

  #### Returns Record<string, unknown>

  An object of property keys and their updated values

### `Static`applyChangeField

* applyChangeField(  
  Â Â Â Â targetDoc: any,  
  Â Â Â Â change: EffectChangeData,  
  Â Â Â Â options?: {  
  Â Â Â Â Â Â Â Â field?: [DataField](foundry.data.fields.DataField.md);  
  Â Â Â Â Â Â Â Â modifyTarget?: boolean;  
  Â Â Â Â Â Â Â Â replacementData?: Record<string, unknown>;  
  Â Â Â Â },  
  ): unknown
  ...
  + `Optional`options: {  
    Â Â Â Â field?: [DataField](foundry.data.fields.DataField.md);  
    Â Â Â Â modifyTarget?: boolean;  
    Â Â Â Â replacementData?: Record<string, unknown>;  
    } = {}

    Additional options to configure the change application.

    - ##### `Optional`field?: [DataField](foundry.data.fields.DataField.md)

      The field: if not supplied, it will be retrieved from the supplied
      Document.
    - ##### `Optional`modifyTarget?: boolean
...
* canUserCreate(user: any): any
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[canUserCreate](foundry.documents.BaseActiveEffect.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[cleanData](foundry.documents.BaseActiveEffect.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[create](foundry.documents.BaseActiveEffect.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[createDocuments](foundry.documents.BaseActiveEffect.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â disabled: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â duration: [SchemaField](foundry.data.fields.SchemaField.md);  
  ...
  Â Â Â Â origin: [DocumentUUIDField](foundry.data.fields.DocumentUUIDField.md);  
  Â Â Â Â showIcon: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â sort: [IntegerSortField](foundry.data.fields.IntegerSortField.md);  
  Â Â Â Â start: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â statuses: [SetField](foundry.data.fields.SetField.md);  
  Â Â Â Â system: [TypeDataField](foundry.data.fields.TypeDataField.md);  
  Â Â Â Â tint: [ColorField](foundry.data.fields.ColorField.md);  
  Â Â Â Â transfer: [BooleanField](foundry.data.fields.BooleanField.md);  
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â description: [HTMLField](foundry.data.fields.HTMLField.md); Â Â Â Â disabled: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â duration: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â folder: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); Â Â Â Â img: [FilePathField](foundry.data.fields.FilePathField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â origin: [DocumentUUIDField](foundry.data.fields.DocumentUUIDField.md); Â Â Â Â showIcon: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â sort: [IntegerSortField](foundry.data.fields.IntegerSortField.md); Â Â Â Â start: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â statuses: [SetField](foundry.data.fields.SetField.md); Â Â Â Â system: [TypeDataField](foundry.data.fields.TypeDataField.md); Â Â Â Â tint: [ColorField](foundry.data.fields.ColorField.md); Â Â Â Â transfer: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â type: [DocumentTypeField](foundry.data.fields.DocumentTypeField.md); }
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[defineSchema](foundry.documents.BaseActiveEffect.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[deleteDocuments](foundry.documents.BaseActiveEffect.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[fromJSON](foundry.documents.BaseActiveEffect.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[fromSource](foundry.documents.BaseActiveEffect.md#fromsource)
...
* fromStatusEffect(  
  ...
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): Promise<[documents](../modules/foundry.documents.md).ActiveEffect>

  Create an ActiveEffect instance from some status effect ID.
  Delegates to [ActiveEffect.\_fromStatusEffect](#_fromstatuseffect) to create the ActiveEffect instance
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).ActiveEffect>
...
* get(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[get](foundry.documents.BaseActiveEffect.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[getCollectionName](foundry.documents.BaseActiveEffect.md#getcollectionname)

### `Static`getEffectStart

* getEffectStart(combat?: [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md) | null): EffectStartData

  Retrieve the initial duration configuration.

  #### Parameters

  + `Optional`combat: [documents](../modules/foundry.documents.md).[Combat](foundry.documents.Combat.md) | null = game.combat
...
* migrateData(source: any, options: any): object
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[migrateData](foundry.documents.BaseActiveEffect.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[migrateDataSafe](foundry.documents.BaseActiveEffect.md#migratedatasafe)
...
* shimData(data: any, options: any): object
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[shimData](foundry.documents.BaseActiveEffect.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[updateDocuments](foundry.documents.BaseActiveEffect.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[validateJoint](foundry.documents.BaseActiveEffect.md#validatejoint)
...
* \_applyChangeUnguided(  
  Â Â Â Â targetDoc: any,  
  Â Â Â Â change: [ActiveEffectChangeData](../interfaces/foundry.documents.types.ActiveEffectChangeData.md),  
  Â Â Â Â changes: Record<string, unknown>,  
  Â Â Â Â options?: {  
  Â Â Â Â Â Â Â Â modifyTarget?: boolean;  
  Â Â Â Â Â Â Â Â replacementData?: Record<string, unknown>;  
  Â Â Â Â },  
  ...
  + targetDoc: any
    ...
    The Document or DataModel to which this effect should be
    applied
  + change: [ActiveEffectChangeData](../interfaces/foundry.documents.types.ActiveEffectChangeData.md)
  ...
  + `Optional`options: { modifyTarget?: boolean; replacementData?: Record<string, unknown> } = {}
    - ##### `Optional`modifyTarget?: boolean
...
* \_cleanData(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_cleanData](foundry.documents.BaseActiveEffect.md#_cleandata)

### `Protected` `Static`\_fromStatusEffect

* \_fromStatusEffect(  
  Â Â Â Â statusId: string,  
  Â Â Â Â effectData: [ActiveEffectData](../interfaces/foundry.documents.types.ActiveEffectData.md),  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): Promise<[documents](../modules/foundry.documents.md).ActiveEffect>
  ...
  Called by [ActiveEffect.fromStatusEffect](#fromstatuseffect).
  ...
  + statusId: string
    ...
    The status effect ID.
  + effectData: [ActiveEffectData](../interfaces/foundry.documents.types.ActiveEffectData.md)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_onCreateOperation](foundry.documents.BaseActiveEffect.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_onDeleteOperation](foundry.documents.BaseActiveEffect.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_onUpdateOperation](foundry.documents.BaseActiveEffect.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_preCreateOperation](foundry.documents.BaseActiveEffect.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_preDeleteOperation](foundry.documents.BaseActiveEffect.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseActiveEffect](foundry.documents.BaseActiveEffect.md).[\_preUpdateOperation](foundry.documents.BaseActiveEffect.md#_preupdateoperation)

### `Protected` `Static`\_replaceDataRefs

* \_replaceDataRefs(raw: string, data: Record<string, unknown>): string | null
  ...
  The string with all data references resolved

  #### Throws

  An Error if data replacement failed