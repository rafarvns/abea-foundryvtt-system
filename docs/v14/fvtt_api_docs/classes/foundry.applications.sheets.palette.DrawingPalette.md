---
title: "DrawingPalette | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.palette.DrawingPalette.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.palette.DrawingPalette))

* [DrawingConfig](foundry.applications.sheets.DrawingConfig.md)<this>
  + DrawingPalette
...
[\_migrateDefaultDrawingConfig](#_migratedefaultdrawingconfig)
...
* new DrawingPalette(options: any, ...args: any[]): DrawingPalette
  ...
  #### Returns DrawingPalette

  #### Inherit Doc

  Inherited from PlaceablePaletteMixin(DrawingConfig).constructor
...
Inherited from PlaceablePaletteMixin(DrawingConfig).options
...
Inherited from PlaceablePaletteMixin(DrawingConfig).position
...
Inherited from PlaceablePaletteMixin(DrawingConfig).tabGroups
...
Inherited from PlaceablePaletteMixin(DrawingConfig).\_preview
...
Inherited from PlaceablePaletteMixin(DrawingConfig).\_appId
...
Inherited from PlaceablePaletteMixin(DrawingConfig).\_maxZ
...
Inherited from PlaceablePaletteMixin(DrawingConfig).BASE\_APPLICATION
...
Â Â Â Â Â Â Â Â Â Â Â Â height: number;  
Â Â Â Â Â Â Â Â Â Â Â Â points: number[];  
Â Â Â Â Â Â Â Â Â Â Â Â type: string;  
Â Â Â Â Â Â Â Â Â Â Â Â width: number;  
Â Â Â Â Â Â Â Â };  
Â Â Â Â };  
} = ...

Overrides PlaceablePaletteMixin(DrawingConfig).DEFAULT\_OPTIONS
...
Inherited from PlaceablePaletteMixin(DrawingConfig).emittedEvents
...
Inherited from PlaceablePaletteMixin(DrawingConfig).RENDER\_STATES

### `Static`SETTING\_KEY

SETTING\_KEY: string = "drawingPalette"
...
Overrides PlaceablePaletteMixin(DrawingConfig).TABS
...
* get classList(): DOMTokenList
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).classList
...
* get document(): ClientDocument
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).document
...
* get element(): HTMLElement
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).element
...
* get form(): HTMLFormElement | null
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).form
...
* get hasFrame(): boolean
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).hasFrame
...
* get id(): string
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).id
...
* get isEditable(): boolean
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).isEditable
...
* get isVisible(): boolean
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).isVisible
...
* get minimized(): boolean
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).minimized
...
* get rendered(): boolean
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).rendered
...
* get state(): number
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).state
...
* get title(): string
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).title
...
* get schema(): [SchemaField](foundry.data.fields.SchemaField.md)
  ...
  Overrides PlaceablePaletteMixin(DrawingConfig).schema
...
* \_awaitTransition(element: HTMLElement, timeout: number): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_awaitTransition
...
* \_canDetach(): boolean
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_canDetach
...
* \_canRender(\_options: any): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_canRender
...
* \_configureRenderOptions(options: any): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_configureRenderOptions
...
* \_doEvent(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_doEvent
...
* \_getFrameButtons(options: any): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_getFrameButtons
...
* \_headerControlButtons(): Generator<  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_headerControlButtons
...
* \_initializeApplicationOptions(options: any): any
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_initializeApplicationOptions
...
* \_onChangeForm(formConfig: any, event: any): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_onChangeForm
...
* \_onClose(options: any): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_onClose
...
* \_onFirstRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_onFirstRender
...
* \_onRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_onRender
...
* \_postRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_postRender
...
* \_preClose(options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_preClose
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â units: { degrees: string; pixels: string };  
  ...
  #### Returns Promise< Â Â Â Â [ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md) & { Â Â Â Â Â Â Â Â document: ClientDocument; Â Â Â Â Â Â Â Â editable: boolean; Â Â Â Â Â Â Â Â fields: any; Â Â Â Â Â Â Â Â model: ClientDocument; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â source: any; Â Â Â Â Â Â Â Â user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) Â Â Â Â Â Â Â Â | null; Â Â Â Â } & { Â Â Â Â Â Â Â Â document: [Document](foundry.abstract.Document.md)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md)> Â Â Â Â Â Â Â Â | null; Â Â Â Â Â Â Â Â gridUnits: any; Â Â Â Â Â Â Â Â inputs: { Â Â Â Â Â Â Â Â Â Â Â Â createMultiSelectInput: ( Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â field: any, Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â config: any, Â Â Â Â Â Â Â Â Â Â Â Â ) => AbstractMultiSelectElement; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â model: [Document](foundry.abstract.Document.md)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md)> Â Â Â Â Â Â Â Â | null; Â Â Â Â Â Â Â Â selectableLevels: any; Â Â Â Â Â Â Â Â source: object; Â Â Â Â } & { Â Â Â Â Â Â Â Â tabClasses: string; Â Â Â Â Â Â Â Â units: { degrees: string; pixels: string }; Â Â Â Â Â Â Â Â userColor: any; Â Â Â Â }, >

  #### Inherit Doc

  Overrides PlaceablePaletteMixin(DrawingConfig).\_prepareContext
...
* \_preparePartContext(partId: any, context: any, options: any): Promise<any>
  ...
  Overrides PlaceablePaletteMixin(DrawingConfig).\_preparePartContext
...
* \_previewChanges(changes: any): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_previewChanges
...
* \_processFormData(event: any, form: any, formData: any): object
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_processFormData
...
* \_processSubmitData(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_processSubmitData
...
* \_renderFrame(options: any): Promise<HTMLElement>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_renderFrame
...
* \_renderHTML(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_renderHTML
...
* addEventListener(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).addEventListener
...
* attachWindow(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).attachWindow
...
* bringToFront(): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).bringToFront
...
* changeTab(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).changeTab

### close

* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<DrawingPalette>
  ...
  #### Returns Promise<DrawingPalette>

  A Promise which resolves to the closed Application instance

  Inherited from PlaceablePaletteMixin(DrawingConfig).close

### detachWindow

* detachWindow(  
  Â Â Â Â options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md) & [DocumentSheetRenderOptions](../interfaces/foundry.DocumentSheetRenderOptions.md),  
  ): Promise<DrawingPalette>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).detachWindow
...
* dispatchEvent(event: Event): boolean
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).dispatchEvent
...
* maximize(): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).maximize
...
* minimize(): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).minimize
...
* removeEventListener(type: string, listener: [EmittedEventListener](../types/foundry.utils.types.EmittedEventListener.md)): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).removeEventListener
...
* render(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).render
...
* renderChild(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).renderChild
...
* setPosition(position?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void | [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).setPosition
...
* submit(submitOptions?: object): Promise<any>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).submit
...
* \_attachFrameListeners(): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_attachFrameListeners
...
* \_canAttach(): boolean
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_canAttach
...
* \_createContextMenu(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_createContextMenu
...
* \_createPreview(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_createPreview
...
* \_destroyPreview(): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_destroyPreview
...
* \_getHeaderControls(): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_getHeaderControls
...
* \_getTabsConfig(group: string): [ApplicationTabsConfiguration](../interfaces/foundry.applications.types.ApplicationTabsConfiguration.md) | null
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_getTabsConfig
...
* \_headerControlContextEntries(): Generator<[ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md), void, any>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_headerControlContextEntries
...
* \_initializePreview(): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_initializePreview
...
* \_insertElement(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_insertElement
...
* \_onAttach(from: Document, to: Document): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_onAttach
...
* \_onClickAction(event: PointerEvent, target: HTMLElement): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_onClickAction
...
* \_onClickTab(event: PointerEvent): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_onClickTab
...
* \_onDetach(from: Document, to: Document): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_onDetach
...
* \_onPosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_onPosition
...
* \_onRevealSecret(event: Event): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_onRevealSecret
...
* \_onSubmitForm(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_onSubmitForm
...
* \_preFirstRender(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_preFirstRender
...
* \_prepareSubmitData(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_prepareSubmitData
...
* \_prepareTabs(group: string): Record<string, [ApplicationTab](../interfaces/foundry.applications.types.ApplicationTab.md)>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_prepareTabs
...
* \_prePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_prePosition
...
* \_preRender(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_preRender
...
* \_refit(positionUpdate?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_refit
...
* \_removeElement(element: HTMLElement): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_removeElement
...
* \_renderFrameButtons(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_renderFrameButtons
...
* \_renderHeaderControl(control: [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)): HTMLLIElement
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_renderHeaderControl
...
* \_replaceHTML(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_replaceHTML
...
* \_resetPreview(): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_resetPreview
...
* \_tearDown(options: [ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_tearDown
...
* \_toggleDisabled(disabled: boolean): void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_toggleDisabled
...
* \_updateFrame(  
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_updateFrame
...
* \_updatePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).\_updatePosition
...
### `Static`\_migrateDefaultDrawingConfig

* \_migrateDefaultDrawingConfig(): void
...
* inheritanceChain(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), void, unknown>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).inheritanceChain
...
* instances(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), any, any>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).instances
...
* parseCSSDimension(style: string, parentDimension: number): number | void
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).parseCSSDimension
...
* waitForImages(element: HTMLElement): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(DrawingConfig).waitForImages