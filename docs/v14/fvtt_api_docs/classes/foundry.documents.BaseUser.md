---
title: "BaseUser | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.BaseUser.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.BaseUser))

* [Document](foundry.abstract.Document.md)
  + BaseUser
    - [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)
...
* new BaseUser(  
  Â Â Â Â data?: Partial<[UserData](../interfaces/foundry.documents.types.UserData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): BaseUser

  #### Parameters

  + `Optional`data: Partial<[UserData](../interfaces/foundry.documents.types.UserData.md)> = {}
