---
title: "RollTableSheet | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.RollTableSheet.html"
category: "classes"
---

# Class RollTableSheet

The Application responsible for editing, displaying, and using a single [RollTable](foundry.documents.RollTable.md) document.

#### Mixes

HandlebarsApplication

#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.RollTableSheet))
...
[submit](#submit)
[\_animateRoll](#_animateroll)
[\_animateRoulette](#_animateroulette)
...
* \_prepareTabs(group: any): Record<string, [ApplicationTab](../interfaces/foundry.applications.types.ApplicationTab.md)> | { tabs: {} }

  #### Parameters

  + group: any

  #### Returns Record<string, [ApplicationTab](../interfaces/foundry.applications.types.ApplicationTab.md)> | { tabs: {} }
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<RollTableSheet>
