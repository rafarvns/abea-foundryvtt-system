---
title: "Compendium | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.apps.Compendium.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.apps.Compendium))
...
\_entryPartial: string = "templates/sidebar/apps/compendium/index-partial.hbs"
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â copyId: (this: Compendium<any>, event: PointerEvent) => void;  
Â Â Â Â };  
Â Â Â Â classes: string[];  
Â Â Â Â id: string;  
Â Â Â Â position: { height: number; left: number; top: number; width: number };  
...
* get isPopout(): boolean
  ...
  Overrides DocumentDirectory.isPopout
...
* get title(): string
  ...
  Overrides DocumentDirectory.title
...
* \_canCreateEntry(): any
  ...
  Overrides DocumentDirectory.\_canCreateEntry
...
* \_canCreateFolder(): any
  ...
  Overrides DocumentDirectory.\_canCreateFolder
...
* \_canDragDrop(selector: any): any
  ...
  Overrides DocumentDirectory.\_canDragDrop
...
* \_configureRenderOptions(options: any): void
  ...
  Overrides DocumentDirectory.\_configureRenderOptions
...
* \_entryAlreadyExists(entry: any): any
  ...
  Overrides DocumentDirectory.\_entryAlreadyExists
...
* \_getEntryContextOptions(): {  
  ...
  Â Â Â Â onClick: (event: any, li: any) => Promise<any>;  
  Â Â Â Â visible: () => any;  
  }[]

  #### Returns { Â Â Â Â icon: string; Â Â Â Â label: string; Â Â Â Â onClick: (event: any, li: any) => Promise<any>; Â Â Â Â visible: () => any; }[]
...
* \_getEntryDragData(entryId: any): { type: string; uuid: any }
  ...
  #### Returns { type: string; uuid: any }

  Overrides DocumentDirectory.\_getEntryDragData
...
* \_getFrameButtons(options: any): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Overrides DocumentDirectory.\_getFrameButtons
...
* \_onCreateEntry(event: any, target: any): any
  ...
  Overrides DocumentDirectory.\_onCreateEntry
...
* \_prepareHeaderContext(context: any, options: any): Promise<void>
  ...
  Overrides DocumentDirectory.\_prepareHeaderContext
...
* close(  
  ...
  ): Promise<Compendium<[TDocument](#tdocument)>>
  ...
  #### Returns Promise<Compendium<[TDocument](#tdocument)>>
...
* detachWindow(options?: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<Compendium<[TDocument](#tdocument)>>
...
* render(options: any, \_options: any): Promise<Compendium<[TDocument](#tdocument)>>
