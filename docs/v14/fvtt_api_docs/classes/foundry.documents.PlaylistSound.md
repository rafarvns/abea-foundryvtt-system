---
title: "PlaylistSound | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.PlaylistSound.html"
category: "classes"
---
...
* [foundry.documents.Playlist](foundry.documents.Playlist.md): The Playlist document which contains PlaylistSound embedded
  documents
* [foundry.applications.sheets.PlaylistSoundConfig](foundry.applications.sheets.PlaylistSoundConfig.md): The PlaylistSound configuration
  application
* [foundry.audio.Sound](foundry.audio.Sound.md) The Sound API which manages web audio playback

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.PlaylistSound))

* [BasePlaylistSound](foundry.documents.BasePlaylistSound.md)<this>
  + PlaylistSound
...
[metadata](#metadata)
[VOLUME\_DEBOUNCE\_MS](#volume_debounce_ms)
...
* new PlaylistSound(  
  Â Â Â Â data?: Partial<[PlaylistSoundData](../interfaces/foundry.documents.types.PlaylistSoundData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).PlaylistSound

  #### Parameters

  + `Optional`data: Partial<[PlaylistSoundData](../interfaces/foundry.documents.types.PlaylistSoundData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).PlaylistSound

  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[constructor](foundry.documents.BasePlaylistSound.md#constructor)

## Properties

### \_source

\_source: [PlaylistSoundData](../interfaces/foundry.documents.types.PlaylistSoundData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_source](foundry.documents.BasePlaylistSound.md#_source)
...
Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[parent](foundry.documents.BasePlaylistSound.md#parent)
...
Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_schema](foundry.documents.BasePlaylistSound.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[LOCALIZATION\_PREFIXES](foundry.documents.BasePlaylistSound.md#localization_prefixes)
...
Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[metadata](foundry.documents.BasePlaylistSound.md#metadata)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_configure](foundry.documents.BasePlaylistSound.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_getParentCollection](foundry.documents.BasePlaylistSound.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_initializationOrder](foundry.documents.BasePlaylistSound.md#_initializationorder)
...
* \_onDelete(options: any, userId: any): void
  ...
  Overrides [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_onDelete](foundry.documents.BasePlaylistSound.md#_ondelete)
...
* \_onUpdate(changed: any, options: any, userId: any): void
  ...
  Overrides [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_onUpdate](foundry.documents.BasePlaylistSound.md#_onupdate)
...
* \_preUpdate(changed: any, options: any, user: any): Promise<boolean | void>
  ...
  Overrides [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_preUpdate](foundry.documents.BasePlaylistSound.md#_preupdate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_updateDiff](foundry.documents.BasePlaylistSound.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[canUserModify](foundry.documents.BasePlaylistSound.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[clone](foundry.documents.BasePlaylistSound.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[createEmbeddedDocuments](foundry.documents.BasePlaylistSound.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[delete](foundry.documents.BasePlaylistSound.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[deleteEmbeddedDocuments](foundry.documents.BasePlaylistSound.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[getEmbeddedCollection](foundry.documents.BasePlaylistSound.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[getEmbeddedDocument](foundry.documents.BasePlaylistSound.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[getFieldForProperty](foundry.documents.BasePlaylistSound.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[getFlag](foundry.documents.BasePlaylistSound.md#getflag)
...
* getUserLevel(user?: [BaseUser](foundry.documents.BaseUser.md)): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.md)
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[getUserLevel](foundry.documents.BasePlaylistSound.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[migrateSystemData](foundry.documents.BasePlaylistSound.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[reset](foundry.documents.BasePlaylistSound.md#reset)
...
* setFlag(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[setFlag](foundry.documents.BasePlaylistSound.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[testUserPermission](foundry.documents.BasePlaylistSound.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[toJSON](foundry.documents.BasePlaylistSound.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[toObject](foundry.documents.BasePlaylistSound.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[traverseEmbeddedDocuments](foundry.documents.BasePlaylistSound.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[unsetFlag](foundry.documents.BasePlaylistSound.md#unsetflag)
...
* update(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[update](foundry.documents.BasePlaylistSound.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[updateEmbeddedDocuments](foundry.documents.BasePlaylistSound.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[updateSource](foundry.documents.BasePlaylistSound.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[validate](foundry.documents.BasePlaylistSound.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_getInnerModel](foundry.documents.BasePlaylistSound.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_initialize](foundry.documents.BasePlaylistSound.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_initializeSource](foundry.documents.BasePlaylistSound.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_onCreate](foundry.documents.BasePlaylistSound.md#_oncreate)
...
* \_preCreate(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_preCreate](foundry.documents.BasePlaylistSound.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_preDelete](foundry.documents.BasePlaylistSound.md#_predelete)
...
* \_preUpdateSource(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_preUpdateSource](foundry.documents.BasePlaylistSound.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_updateCommit](foundry.documents.BasePlaylistSound.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_addDataFieldMigration](foundry.documents.BasePlaylistSound.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_addDataFieldShim](foundry.documents.BasePlaylistSound.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_addDataFieldShims](foundry.documents.BasePlaylistSound.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_clearFieldsRecursively](foundry.documents.BasePlaylistSound.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_logDataFieldMigration](foundry.documents.BasePlaylistSound.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_preCleanData](foundry.documents.BasePlaylistSound.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[canUserCreate](foundry.documents.BasePlaylistSound.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[cleanData](foundry.documents.BasePlaylistSound.md#cleandata)
...
* create(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[create](foundry.documents.BasePlaylistSound.md#create)
...
* createDocuments(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[createDocuments](foundry.documents.BasePlaylistSound.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â description: [StringField](foundry.data.fields.StringField.md);  
  ...
  Â Â Â Â path: [FilePathField](foundry.data.fields.FilePathField.md);  
  Â Â Â Â pausedTime: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â playing: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â repeat: [BooleanField](foundry.data.fields.BooleanField.md);  
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â channel: [StringField](foundry.data.fields.StringField.md); Â Â Â Â description: [StringField](foundry.data.fields.StringField.md); Â Â Â Â fade: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â path: [FilePathField](foundry.data.fields.FilePathField.md); Â Â Â Â pausedTime: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â playing: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â repeat: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â sort: [IntegerSortField](foundry.data.fields.IntegerSortField.md); Â Â Â Â volume: [AlphaField](foundry.data.fields.AlphaField.md); }
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[defineSchema](foundry.documents.BasePlaylistSound.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[deleteDocuments](foundry.documents.BasePlaylistSound.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[fromJSON](foundry.documents.BasePlaylistSound.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[fromSource](foundry.documents.BasePlaylistSound.md#fromsource)
...
* get(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[get](foundry.documents.BasePlaylistSound.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[getCollectionName](foundry.documents.BasePlaylistSound.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[migrateData](foundry.documents.BasePlaylistSound.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[migrateDataSafe](foundry.documents.BasePlaylistSound.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[shimData](foundry.documents.BasePlaylistSound.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[updateDocuments](foundry.documents.BasePlaylistSound.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[validateJoint](foundry.documents.BasePlaylistSound.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_cleanData](foundry.documents.BasePlaylistSound.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_onCreateOperation](foundry.documents.BasePlaylistSound.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_onDeleteOperation](foundry.documents.BasePlaylistSound.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_onUpdateOperation](foundry.documents.BasePlaylistSound.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_preCreateOperation](foundry.documents.BasePlaylistSound.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_preDeleteOperation](foundry.documents.BasePlaylistSound.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BasePlaylistSound](foundry.documents.BasePlaylistSound.md).[\_preUpdateOperation](foundry.documents.BasePlaylistSound.md#_preupdateoperation)