---
title: "Items | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.collections.Items.html"
category: "classes"
---
...
* [foundry.documents.Item](foundry.documents.Item.md): The Item document
* [foundry.applications.sidebar.tabs.ItemDirectory](foundry.applications.sidebar.tabs.ItemDirectory.md): The ItemDirectory sidebar directory

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.collections.Items))
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)[]

  #### Parameters

  + entry: any

  #### Returns [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)
...
* every(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â element: [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)>,  
  Â Â Â Â ) => boolean,  
  ): boolean
  ...
  + condition: (  
    Â Â Â Â element: [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md),  
    Â Â Â Â index: number,  
    Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)>,  
    ) => boolean
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)>,  
  Â Â Â Â ) => unknown,  
  ): [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md) | undefined
  ...
  #### Returns [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md) | undefined
...
* forEach(fn: (value: [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md), index: number) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md), index: number) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md),  
  ...
  + document: object | [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)
...
* getInvalid(id: string, options?: { strict?: boolean }): void | [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)
  ...
  #### Returns void | [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)
...
* importFromCompendium(  
  ...
  Â Â Â Â options?: any,  
  ): Promise<[documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)>
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)[]
...
* set(id: string, document: [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)): Items

  #### Parameters

  + id: string
  + document: [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)
