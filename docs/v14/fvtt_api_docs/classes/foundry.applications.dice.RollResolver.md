---
title: "RollResolver | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.dice.RollResolver.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.dice.RollResolver))

* [ApplicationV2](foundry.applications.api.ApplicationV2.md)<ApplicationConfiguration, ApplicationRenderOptions, this>
  + RollResolver
...
[awaitFulfillment](#awaitfulfillment)
...
[\_tearDown](#_teardown)
[\_toggleSubmission](#_togglesubmission)
...
Â Â Â Â Â Â Â Â Â Â Â Â this: RollResolver,  
...
PARTS: { form: { id: string; template: string } } = ...
...
* get fulfillable(): Map<string, [DiceTermFulfillmentDescriptor](../interfaces/foundry.DiceTermFulfillmentDescriptor.md)>

  A collection of fulfillable dice terms.

  #### Returns Map<string, [DiceTermFulfillmentDescriptor](../interfaces/foundry.DiceTermFulfillmentDescriptor.md)>
...
* get roll(): [Roll](foundry.dice.Roll.md)
...
* addTerm(term: [DiceTerm](foundry.dice.terms.DiceTerm.md)): Promise<void>

  Add a new term to the resolver.

  #### Parameters

  + term: [DiceTerm](foundry.dice.terms.DiceTerm.md)
...
* detachWindow(options?: any): Promise<RollResolver>
...
* resolveResult(  
  Â Â Â Â term: [DiceTerm](foundry.dice.terms.DiceTerm.md),  
  Â Â Â Â method: string,  
  Â Â Â Â options?: { explode?: boolean; reroll?: boolean },  
  ): Promise<number | void>
  ...
  + `Optional`options: { explode?: boolean; reroll?: boolean } = {}
