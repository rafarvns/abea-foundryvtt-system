---
title: "NoteTab | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.tabs.NoteTab.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.tabs.NoteTab))
...
* new NoteTab(options?: Partial<[ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md)>): NoteTab
...
ENTRY\_PARTIAL: string = "templates/sidebar/tabs/placeable/note.hbs"

Overrides PlaceableTab.ENTRY\_PARTIAL
...
* \_getEntryLabel(entry: any): any
  ...
  Overrides PlaceableTab.\_getEntryLabel
...
* \_prepareEntry(entry: any, context: any): Promise<any>
  ...
  Overrides PlaceableTab.\_prepareEntry
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<NoteTab>
...
* detachWindow(options?: [PlaceableTabConfiguration](../types/foundry.PlaceableTabConfiguration.md)): Promise<NoteTab>
...
* \_applyFilters(): void
  ...
  Inherited from PlaceableTab.\_applyFilters
