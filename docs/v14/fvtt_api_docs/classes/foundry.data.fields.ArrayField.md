---
title: "ArrayField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.ArrayField.html"
category: "classes"
---

# Class ArrayField<ElementType>

A subclass of [foundry.data.fields.DataField](foundry.data.fields.DataField.md) which deals with array-typed data.

#### Template: ElementType

#### Type Parameters

* ElementType = [DataField](foundry.data.fields.DataField.md)

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.ArrayField))

* [DataField](foundry.data.fields.DataField.md)
  + ArrayField
    - [EmbeddedCollectionField](foundry.data.fields.EmbeddedCollectionField.md)
    - [GridOffsetsField](foundry.data.fields.GridOffsetsField.md)
    - [SetField](foundry.data.fields.SetField.md)
    - [ShapesField](foundry.data.fields.ShapesField.md)
...
* new ArrayField<[ElementType](#constructorarrayfieldelementtype) = [DataField](foundry.data.fields.DataField.md)>(  
  Â Â Â Â element: [ElementType](#elementtype),  
  ...
  ): ArrayField<[ElementType](#elementtype)>
  ...
  #### Returns ArrayField<[ElementType](#elementtype)>
