---
title: "TokenTab | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.tabs.TokenTab.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.tabs.TokenTab))
...
* new TokenTab(options?: Partial<[ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md)>): TokenTab
...
Â Â Â Â Â Â Â Â Â Â Â Â this: TokenTab,  
...
DIRECTORY\_PARTIAL: string = "templates/sidebar/tabs/placeable/tokens.hbs"
...
ENTRY\_PARTIAL: string = "templates/sidebar/tabs/placeable/token.hbs"
...
* \_getEntryContextOptions(): ContextMenuEntry[]
  ...
  Overrides PlaceableTab.\_getEntryContextOptions
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<TokenTab>
...
* detachWindow(options?: [PlaceableTabConfiguration](../types/foundry.PlaceableTabConfiguration.md)): Promise<TokenTab>
