---
title: "FormulaEditor | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.apps.FormulaEditor.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.apps.FormulaEditor))
...
options: Readonly<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [FormulaEditorConfiguration](../interfaces/foundry.FormulaEditorConfiguration.md)>
...
* \_canAttach(): boolean
  ...
  Overrides ApplicationV2.\_canAttach
...
* \_canDetach(): boolean
  ...
  Overrides ApplicationV2.\_canDetach

### \_canRender

* \_canRender(options: any): false | undefined
...
* \_renderHTML(context: any, options: any): Promise<HTMLDivElement>
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<FormulaEditor>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<FormulaEditor>
...
### `Protected`\_replaceTerms

* \_replaceTerms(tr: Transaction, schema: Schema): Transaction
  ...
  + schema: Schema
    ...
    The ProseMirror document schema.
...
* toFormula(state: EditorState): string
  ...
  + state: EditorState
    ...
    The ProseMirror document state.
