---
title: "PlaylistDirectory | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.tabs.PlaylistDirectory.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.tabs.PlaylistDirectory))

* [DocumentDirectory](foundry.applications.sidebar.DocumentDirectory.md)
  + PlaylistDirectory
...
[PARTS](#parts)
[PLAYLIST\_MODES](#playlist_modes)
...
[currentlyPlayingLocation](#currentlyplayinglocation)
...
[\_getSoundContextOptions](#_getsoundcontextoptions)
...
[\_onGlobalVolume](#_onglobalvolume)
[\_onPosition](#_onposition)
[\_onSearchFilter](#_onsearchfilter)
[\_onSoundVolume](#_onsoundvolume)
...
[\_preparePlayingContext](#_prepareplayingcontext)
[\_preparePlaylistContext](#_prepareplaylistcontext)
[\_prepareTabs](#_preparetabs)
[\_prepareTreeContext](#_preparetreecontext)
...
[\_registerSettings](#_registersettings)
...
\_playing: {  
Â Â Â Â context: [PlaylistSoundRenderContext](../interfaces/foundry.PlaylistSoundRenderContext.md)[];  
Â Â Â Â playlists: [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)[];  
Â Â Â Â sounds: [documents](../modules/foundry.documents.md).[PlaylistSound](foundry.documents.PlaylistSound.md)[];  
} = ...
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â pinCurrentlyPlaying: (this: PlaylistDirectory) => void;  
Â Â Â Â Â Â Â Â playlistBackward: (  
Â Â Â Â Â Â Â Â Â Â Â Â this: PlaylistDirectory,  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLElement,  
Â Â Â Â Â Â Â Â ) => Promise<[documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md) | null | undefined>;  
...
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLElement,  
Â Â Â Â Â Â Â Â ) => Promise<[documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)>;  
...
Â Â Â Â [PlaylistDirectoryControlContext](../interfaces/foundry.PlaylistDirectoryControlContext.md),  
> = ...
...
* get documentClass(): [Constructor](../types/foundry.types.Constructor.md)<[TDocument](foundry.applications.sidebar.DocumentDirectory.md#tdocument)>

  The implementation of the Document type that this directory represents.

  #### Returns [Constructor](../types/foundry.types.Constructor.md)<[TDocument](foundry.applications.sidebar.DocumentDirectory.md#tdocument)>

  Inherited from [foundry](../modules/foundry.md).[documentClass](../modules/foundry.md#documentclass-1)
...
* get playing(): [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)[]

  The Playlist documents that are currently playing.

  #### Returns [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)[]
...
* \_canDetach(): boolean
  ...
  Inherited from DocumentDirectory.\_canDetach
...
* attachWindow(  
  ...
  Inherited from DocumentDirectory.attachWindow
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<PlaylistDirectory>
...
* detachWindow(options?: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<PlaylistDirectory>
  ...
  Inherited from DocumentDirectory.detachWindow
...
* renderChild(  
  ...
  Inherited from DocumentDirectory.renderChild
...
* \_canAttach(): boolean
  ...
  Inherited from DocumentDirectory.\_canAttach
...
* \_createDroppedEntry(  
  ...
  ): Promise<[documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)>
...
* \_createDroppedFolderDocuments(  
  Â Â Â Â folder: [documents](../modules/foundry.documents.md).[Folder](foundry.documents.Folder.md),  
  Â Â Â Â documents: object[] | [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)[],  
  ): Promise<void>
  ...
  + folder: [documents](../modules/foundry.documents.md).[Folder](foundry.documents.Folder.md)
    ...
    The dropped folder.
  + documents: object[] | [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)[]
...
* \_getFrameButtons(  
  ...
  Inherited from DocumentDirectory.\_getFrameButtons
...
* \_getSoundContextOptions(): [ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md)[]
...
* \_headerControlContextEntries(): Generator<[ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md), void, any>
  ...
  Inherited from DocumentDirectory.\_headerControlContextEntries
...
* \_onAttach(from: Document, to: Document): void
  ...
  Inherited from DocumentDirectory.\_onAttach
...
* \_onDetach(from: Document, to: Document): void
  ...
  Inherited from DocumentDirectory.\_onDetach
...
* \_organizeDroppedFoldersAndDocuments(  
  ...
  Â Â Â Â Â Â Â Â | [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)[];  
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â documentsToCreate: object[] Â Â Â Â Â Â Â Â | [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)[]; Â Â Â Â Â Â Â Â foldersToCreate: [documents](../modules/foundry.documents.md).[Folder](foundry.documents.Folder.md)[]; Â Â Â Â }, >
...
* \_prepareControlsContext(  
  Â Â Â Â context: [PlaylistDirectoryRenderContext](../types/foundry.PlaylistDirectoryRenderContext.md),  
  Â Â Â Â options: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md),  
  ): Promise<void>
  ...
  + context: [PlaylistDirectoryRenderContext](../types/foundry.PlaylistDirectoryRenderContext.md)
  + options: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)
...
* \_preparePlaylistContext(  
  Â Â Â Â root: [PlaylistDirectoryRenderContext](../types/foundry.PlaylistDirectoryRenderContext.md),  
  Â Â Â Â playlist: [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md),  
  ): [PlaylistRenderContext](../interfaces/foundry.PlaylistRenderContext.md)
  ...
  + root: [PlaylistDirectoryRenderContext](../types/foundry.PlaylistDirectoryRenderContext.md)

    The root render context.
  + playlist: [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)

    The Playlist document.

  #### Returns [PlaylistRenderContext](../interfaces/foundry.PlaylistRenderContext.md)
...
* \_prepareTreeContext(  
  Â Â Â Â root: [PlaylistDirectoryRenderContext](../types/foundry.PlaylistDirectoryRenderContext.md),  
  Â Â Â Â node: object,  
  ): [PlaylistDirectoryTreeContext](../interfaces/foundry.PlaylistDirectoryTreeContext.md)
  ...
  #### Returns [PlaylistDirectoryTreeContext](../interfaces/foundry.PlaylistDirectoryTreeContext.md)
...
* \_refit(positionUpdate?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void
  ...
  Inherited from DocumentDirectory.\_refit
...
* \_renderFrameButtons(options: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<void>
  ...
  Inherited from DocumentDirectory.\_renderFrameButtons
...
* instances(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), any, any>
  ...
  Inherited from DocumentDirectory.instances
