---
title: "VFXComponent | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.vfx.VFXComponent.html"
category: "classes"
---

# Class VFXComponent<ModelData>
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.vfx.VFXComponent))

* [DataModel](foundry.abstract.DataModel.md)
  + VFXComponent
    - [VFXParticleGeneratorComponent](foundry.canvas.vfx.components.VFXParticleGeneratorComponent.md)
    - [VFXPositionalSoundComponent](foundry.canvas.vfx.components.VFXPositionalSoundComponent.md)
    - [VFXScrollingTextComponent](foundry.canvas.vfx.components.VFXScrollingTextComponent.md)
    - [VFXShakeComponent](foundry.canvas.vfx.components.VFXShakeComponent.md)
    - [VFXSingleAttackComponent](foundry.canvas.vfx.components.VFXSingleAttackComponent.md)
    - [VFXSingleImpactComponent](foundry.canvas.vfx.components.VFXSingleImpactComponent.md)
...
* new VFXComponent<[ModelData](#constructorvfxcomponentmodeldata) extends object>(  
  Â Â Â Â data?: Partial<[ModelData](#modeldata)>,  
  Â Â Â Â options?: any,  
  ): VFXComponent<[ModelData](#modeldata)>
  ...
  #### Returns VFXComponent<[ModelData](#modeldata)>
...
* addManagedDisplayObject<[DisplayObject](#addmanageddisplayobjectdisplayobject) extends DisplayObject>(  
  Â Â Â Â object: [DisplayObject](#addmanageddisplayobjectdisplayobject),  
  Â Â Â Â group?: string,  
  ): [DisplayObject](#addmanageddisplayobjectdisplayobject)
  ...
  + object: [DisplayObject](#addmanageddisplayobjectdisplayobject)
  ...
  #### Returns [DisplayObject](#addmanageddisplayobjectdisplayobject)
...
* defineSchema(): { type: [StringField](foundry.data.fields.StringField.md) }

  #### Returns { type: [StringField](foundry.data.fields.StringField.md) }
