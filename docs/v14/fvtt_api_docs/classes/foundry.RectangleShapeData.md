...
url: "https://foundryvtt.com/api/v14/classes/foundry.RectangleShapeData.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.RectangleShapeData))
...
* defineSchema(): { hole: [BooleanField](foundry.data.fields.BooleanField.md); type: [StringField](foundry.data.fields.StringField.md) } & {  
  Â Â Â Â anchorX: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â anchorY: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â gridBased: [BooleanField](foundry.data.fields.BooleanField.md);  
  ...
  #### Returns { hole: [BooleanField](foundry.data.fields.BooleanField.md); type: [StringField](foundry.data.fields.StringField.md) } & { Â Â Â Â anchorX: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â anchorY: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â gridBased: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â height: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â rotation: [AngleField](foundry.data.fields.AngleField.md); Â Â Â Â width: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â x: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â y: [NumberField](foundry.data.fields.NumberField.md); }
