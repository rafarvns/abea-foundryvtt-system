---
title: "World | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.packages.World.html"
category: "classes"
---
...
[ClientPackageMixin](../functions/foundry.packages.ClientPackageMixin.md)

#### See

* [foundry.packages.types.WorldManifestData](../interfaces/foundry.packages.types.WorldManifestData.md) For the world.json schema
* [foundry.ClientPackage](foundry.ClientPackage.md)

#### Hierarchy ([View Summary](../hierarchy.md#foundry.packages.World))

* [BaseWorld](foundry.packages.BaseWorld.md)<this>
  + World
...
[\_formatBadDependenciesTooltip](#_formatbaddependenciestooltip)
...
* new World(data: [PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md), options?: object): World
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[constructor](foundry.packages.BaseWorld.md#constructor)

## Properties

### \_source

\_source: [WorldManifestData](../interfaces/foundry.packages.types.WorldManifestData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_source](foundry.packages.BaseWorld.md#_source)
...
Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_unknownKeys](foundry.packages.BaseWorld.md#_unknownkeys)
...
Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[availability](foundry.packages.BaseWorld.md#availability)
...
Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[exclusive](foundry.packages.BaseWorld.md#exclusive)
...
Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[hasStorage](foundry.packages.BaseWorld.md#hasstorage)
...
Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[locked](foundry.packages.BaseWorld.md#locked)
...
Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[owned](foundry.packages.BaseWorld.md#owned)
...
Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[parent](foundry.packages.BaseWorld.md#parent)
...
Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[tags](foundry.packages.BaseWorld.md#tags)
...
Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_schema](foundry.packages.BaseWorld.md#_schema)
...
Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[icon](foundry.packages.BaseWorld.md#icon)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[LOCALIZATION\_PREFIXES](foundry.packages.BaseWorld.md#localization_prefixes)

### `Static`type

type: string = "world"

Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[type](foundry.packages.BaseWorld.md#type)
...
* get collection(): string
  ...
  Inherited from ClientPackageMixin(BaseWorld).collection
...
* \_initializeSource(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_initializeSource](foundry.packages.BaseWorld.md#_initializesource)
...
* \_testRequiredDependencies(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_testRequiredDependencies](foundry.packages.BaseWorld.md#_testrequireddependencies)
...
* \_testSupportedSystems(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_testSupportedSystems](foundry.packages.BaseWorld.md#_testsupportedsystems)
...
* clone(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[clone](foundry.packages.BaseWorld.md#clone)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[getFieldForProperty](foundry.packages.BaseWorld.md#getfieldforproperty)
...
* reset(): void
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[reset](foundry.packages.BaseWorld.md#reset)
...
* toJSON(): object
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[toJSON](foundry.packages.BaseWorld.md#tojson)
...
* toObject(source?: boolean): object
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[toObject](foundry.packages.BaseWorld.md#toobject)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[updateSource](foundry.packages.BaseWorld.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[validate](foundry.packages.BaseWorld.md#validate)
...
* \_configure(options?: object): void
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_configure](foundry.packages.BaseWorld.md#_configure)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_getInnerModel](foundry.packages.BaseWorld.md#_getinnermodel)
...
* \_initializationOrder(): Generator<[string, [DataField](foundry.data.fields.DataField.md)], any, any>
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_initializationOrder](foundry.packages.BaseWorld.md#_initializationorder)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_initialize](foundry.packages.BaseWorld.md#_initialize)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_preUpdateSource](foundry.packages.BaseWorld.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_updateCommit](foundry.packages.BaseWorld.md#_updatecommit)
...
* \_updateDiff(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_updateDiff](foundry.packages.BaseWorld.md#_updatediff)
...
* \_cleanData(data: any, \_options: any, \_state: any): void
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_cleanData](foundry.packages.BaseWorld.md#_cleandata)

### `Static`\_formatBadDependenciesTooltip

* \_formatBadDependenciesTooltip(availability: any, data: any, deps: any): any
  ...
  Overrides ClientPackageMixin(BaseWorld).\_formatBadDependenciesTooltip
...
* \_logWarning(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_logWarning](foundry.packages.BaseWorld.md#_logwarning)
...
* \_migrateStyles(data: [PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md)): void
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_migrateStyles](foundry.packages.BaseWorld.md#_migratestyles)
...
* cleanData(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[cleanData](foundry.packages.BaseWorld.md#cleandata)
...
* defineSchema(): {  
  ...
  Â Â Â Â background: [FilePathField](foundry.data.fields.FilePathField.md);  
  Â Â Â Â coreVersion: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â demo: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â description: [HTMLField](foundry.data.fields.HTMLField.md);  
  Â Â Â Â joinTheme: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â lastPlayed: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â nextSession: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â playtime: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â resetKeys: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â safeMode: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â system: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â systemVersion: [StringField](foundry.data.fields.StringField.md);  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[defineSchema](foundry.packages.BaseWorld.md#defineschema)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[fromJSON](foundry.packages.BaseWorld.md#fromjson)
...
* fromRemoteManifest(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[fromRemoteManifest](foundry.packages.BaseWorld.md#fromremotemanifest)
...
* fromSource(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[fromSource](foundry.packages.BaseWorld.md#fromsource)

### `Static`getVersionBadge

* getVersionBadge(availability: any, data: any, \_\_namedParameters?: {}): any
  ...
  Overrides ClientPackageMixin(BaseWorld).getVersionBadge
...
* isIncompatibleWithCoreVersion(availability: number): boolean
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[isIncompatibleWithCoreVersion](foundry.packages.BaseWorld.md#isincompatiblewithcoreversion)

### `Static`migrateData

* migrateData(data: any, options: any): any
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[migrateData](foundry.packages.BaseWorld.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[migrateDataSafe](foundry.packages.BaseWorld.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[shimData](foundry.packages.BaseWorld.md#shimdata)

### `Static`testAvailability

* testAvailability(  
  Â Â Â Â data: Partial<[WorldManifestData](../interfaces/foundry.packages.types.WorldManifestData.md)>,  
  Â Â Â Â options?: {  
  Â Â Â Â Â Â Â Â modules?: any;  
  Â Â Â Â Â Â Â Â release?: any;  
  Â Â Â Â Â Â Â Â systemAvailabilityThreshold?: number;  
  Â Â Â Â Â Â Â Â systems?: any;  
  Â Â Â Â },  
  ): number
  ...
  + data: Partial<[WorldManifestData](../interfaces/foundry.packages.types.WorldManifestData.md)>

    The compatibility data to test.
  + `Optional`options: {  
    Â Â Â Â modules?: any;  
    Â Â Â Â release?: any;  
    Â Â Â Â systemAvailabilityThreshold?: number;  
    Â Â Â Â systems?: any;  
    } = {}
    ...
    - ##### `Optional`systemAvailabilityThreshold?: number
      ...
      this.
    - ##### `Optional`systems?: any

      A specific collection of systems to test availability
      against. Tests against the currently installed systems by
      default.

  #### Returns number

  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[testAvailability](foundry.packages.BaseWorld.md#testavailability)
...
* testDependencyCompatibility(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[testDependencyCompatibility](foundry.packages.BaseWorld.md#testdependencycompatibility)
...
* validateId(id: string): void
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[validateId](foundry.packages.BaseWorld.md#validateid)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[validateJoint](foundry.packages.BaseWorld.md#validatejoint)
...
* validateVersion(version: string): void
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[validateVersion](foundry.packages.BaseWorld.md#validateversion)
...
* \_preCleanData(  
  ...
  Inherited from [BaseWorld](foundry.packages.BaseWorld.md).[\_preCleanData](foundry.packages.BaseWorld.md#_precleandata)