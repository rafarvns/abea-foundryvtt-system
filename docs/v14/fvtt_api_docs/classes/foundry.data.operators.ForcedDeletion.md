---
title: "ForcedDeletion | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.operators.ForcedDeletion.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.operators.ForcedDeletion))
...
* create(value: any): [DataFieldOperator](foundry.data.operators.DataFieldOperator.md)
  ...
  #### Returns [DataFieldOperator](foundry.data.operators.DataFieldOperator.md)

  Inherited from [DataFieldOperator](foundry.data.operators.DataFieldOperator.md).[create](foundry.data.operators.DataFieldOperator.md#create)
