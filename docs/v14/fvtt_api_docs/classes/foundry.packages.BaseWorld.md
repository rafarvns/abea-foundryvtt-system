---
title: "BaseWorld | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.packages.BaseWorld.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.packages.BaseWorld))

* [BasePackage](foundry.packages.BasePackage.md)
  + BaseWorld
    - [World](foundry.packages.World.md)
...
* new BaseWorld(data: [PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md), options?: object): BaseWorld
...
Overrides [BasePackage](foundry.packages.BasePackage.md).[LOCALIZATION\_PREFIXES](foundry.packages.BasePackage.md#localization_prefixes)
...
* migrateData(data: any, options: any): any
  ...
  Overrides [BasePackage](foundry.packages.BasePackage.md).[migrateData](foundry.packages.BasePackage.md#migratedata)
...
* testAvailability(  
  ...
  Overrides [BasePackage](foundry.packages.BasePackage.md).[testAvailability](foundry.packages.BasePackage.md#testavailability)
