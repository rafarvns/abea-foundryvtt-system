---
title: "ActorSheetV2 | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.ActorSheetV2.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.ActorSheetV2))
...
[\_onDropActor](#_ondropactor)
[\_onDropDocument](#_ondropdocument)
[\_onDropFolder](#_ondropfolder)
[\_onDropItem](#_ondropitem)
[\_onPosition](#_onposition)
[\_onRevealSecret](#_onrevealsecret)
[\_onSortItem](#_onsortitem)
...
* new ActorSheetV2(options: any, ...args: any[]): ActorSheetV2
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â configurePrototypeToken: (  
Â Â Â Â Â Â Â Â Â Â Â Â this: ActorSheetV2,  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â ) => void;  
Â Â Â Â Â Â Â Â configureToken: (this: ActorSheetV2) => void;  
Â Â Â Â Â Â Â Â showPortraitArtwork: (this: ActorSheetV2, event: PointerEvent) => void;  
Â Â Â Â Â Â Â Â showTokenArtwork: (this: ActorSheetV2, event: PointerEvent) => void;  
Â Â Â Â };  
...
* get \_dragDrop(): [DragDrop](foundry.applications.ux.DragDrop.md)
...
* \_canDetach(): boolean
  ...
  Inherited from DocumentSheetV2.\_canDetach
...
* \_getFrameButtons(options: any): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Inherited from DocumentSheetV2.\_getFrameButtons
...
* attachWindow(  
  ...
  Inherited from DocumentSheetV2.attachWindow
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<ActorSheetV2>
...
* detachWindow(  
  ...
  Inherited from DocumentSheetV2.detachWindow
...
* renderChild(  
  ...
  Inherited from DocumentSheetV2.renderChild
...
* \_canAttach(): boolean
  ...
  Inherited from DocumentSheetV2.\_canAttach
...
* \_headerControlContextEntries(): Generator<[ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md), void, any>
  ...
  Inherited from DocumentSheetV2.\_headerControlContextEntries
...
* \_onAttach(from: Document, to: Document): void
  ...
  Inherited from DocumentSheetV2.\_onAttach
...
* \_onDetach(from: Document, to: Document): void
  ...
  Inherited from DocumentSheetV2.\_onDetach
...
* \_onDropActiveEffect(  
  ...
  Â Â Â Â effect: [documents](../modules/foundry.documents.md).[ActiveEffect](foundry.documents.ActiveEffect.md),  
  ): Promise<[documents](../modules/foundry.documents.md).[ActiveEffect](foundry.documents.ActiveEffect.md) | null | undefined>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).[ActiveEffect](foundry.documents.ActiveEffect.md) | null | undefined>
...
* \_onDropActor(  
  ...
  ): Promise<[documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md) | null | undefined>
  ...
  + event: DragEvent
    ...
    The initiating drop event
  + actor: [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)

    The dropped Actor document

  #### Returns Promise<[documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md) | null | undefined>
...
* \_onDropDocument<[TDocument](#_ondropdocumenttdocument) extends Document>(  
  Â Â Â Â event: DragEvent,  
  Â Â Â Â document: [TDocument](#_ondropdocumenttdocument),  
  ): Promise<[TDocument](#_ondropdocumenttdocument) | null>
  ...
  + event: DragEvent
    ...
    The initiating drop event
  + document: [TDocument](#_ondropdocumenttdocument)

    The resolved Document class

  #### Returns Promise<[TDocument](#_ondropdocumenttdocument) | null>
...
* \_onDropFolder(  
  ...
  ): Promise<[documents](../modules/foundry.documents.md).[Folder](foundry.documents.Folder.md) | null | undefined>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).[Folder](foundry.documents.Folder.md) | null | undefined>
...
* \_onDropItem(  
  Â Â Â Â event: DragEvent,  
  Â Â Â Â item: [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md),  
  ): Promise<[documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md) | null | undefined>
  ...
  + event: DragEvent
    ...
    The initiating drop event
  + item: [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)

    The dropped Item document

  #### Returns Promise<[documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md) | null | undefined>
...
* \_onSortItem(  
  Â Â Â Â event: DragEvent,  
  Â Â Â Â item: [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md),  
  ): void | Promise<[documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)[]>
  ...
  #### Returns void | Promise<[documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)[]>
...
* \_refit(positionUpdate?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void
  ...
  Inherited from DocumentSheetV2.\_refit
...
* \_renderFrameButtons(  
  ...
  Inherited from DocumentSheetV2.\_renderFrameButtons
