---
title: "DiceConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.settings.menus.DiceConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.settings.menus.DiceConfig))
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â defaultMethod: any;  
  Â Â Â Â Â Â Â Â dice: { denomination: string; icon: string; label: string; method: any }[];  
  Â Â Â Â Â Â Â Â methods: { label: string; value: string }[];  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â buttons: { icon: string; label: string; type: string }[]; Â Â Â Â Â Â Â Â defaultMethod: any; Â Â Â Â Â Â Â Â dice: { denomination: string; icon: string; label: string; method: any }[]; Â Â Â Â Â Â Â Â methods: { label: string; value: string }[]; Â Â Â Â }, >
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<DiceConfig>
...
* detachWindow(options?: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<DiceConfig>
