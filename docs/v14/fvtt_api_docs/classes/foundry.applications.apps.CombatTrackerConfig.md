---
title: "CombatTrackerConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.apps.CombatTrackerConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.apps.CombatTrackerConfig))
...
* \_prepareContext(): Promise<  
  ...
  Â Â Â Â Â Â Â Â combatTheme: [SettingConfig](../interfaces/foundry.types.SettingConfig.md) | undefined;  
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â animationChoices: { label: string; value: string }[]; Â Â Â Â Â Â Â Â attributeChoices: any; Â Â Â Â Â Â Â Â buttons: { icon: string; label: string; type: string }[]; Â Â Â Â Â Â Â Â canConfigure: boolean; Â Â Â Â Â Â Â Â combatTheme: [SettingConfig](../interfaces/foundry.types.SettingConfig.md) | undefined; Â Â Â Â Â Â Â Â fields: any; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â selectedTheme: any; Â Â Â Â Â Â Â Â settings: any; Â Â Â Â }, >
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<CombatTrackerConfig>
