---
title: "AbstractSidebarTab | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.AbstractSidebarTab.html"
category: "classes"
---

# Class AbstractSidebarTab<Configuration, RenderOptions>
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.AbstractSidebarTab))
...
* [ApplicationV2](foundry.applications.api.ApplicationV2.md)
  + AbstractSidebarTab
    ...
    - [ChatLog](foundry.applications.sidebar.tabs.ChatLog.md)
    - [CombatTracker](foundry.applications.sidebar.tabs.CombatTracker.md)
    - [CompendiumDirectory](foundry.applications.sidebar.tabs.CompendiumDirectory.md)
    - [PlaceableDirectory](foundry.applications.sidebar.tabs.PlaceableDirectory.md)
    - [Settings](foundry.applications.sidebar.tabs.Settings.md)
...
* new AbstractSidebarTab<  
  Â Â Â Â [Configuration](#constructorabstractsidebartabconfiguration) extends  
  ...
  Â Â Â Â [RenderOptions](#constructorabstractsidebartabrenderoptions) extends [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md) = [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md),  
  >(  
  Â Â Â Â options?: Partial<[Configuration](#configuration)>,  
  ): AbstractSidebarTab<[Configuration](#configuration), [RenderOptions](#renderoptions)>
  ...
  #### Returns AbstractSidebarTab<[Configuration](#configuration), [RenderOptions](#renderoptions)>
...
* get popout(): | void  
  | AbstractSidebarTab<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md), [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)>

  A reference to the popped-out version of this tab, if one exists.

  #### Returns void | AbstractSidebarTab<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md), [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)>
...
* close(  
  ...
  ): Promise<AbstractSidebarTab<[Configuration](#configuration), [RenderOptions](#renderoptions)>>
  ...
  #### Returns Promise<AbstractSidebarTab<[Configuration](#configuration), [RenderOptions](#renderoptions)>>
...
* renderPopout(): Promise<  
  Â Â Â Â AbstractSidebarTab<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md), [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)>,  
  >

  Pop-out this sidebar tab as a new application.

  #### Returns Promise<AbstractSidebarTab<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md), [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)>>
