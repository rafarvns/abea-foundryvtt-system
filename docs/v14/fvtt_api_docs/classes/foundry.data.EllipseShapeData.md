---
title: "EllipseShapeData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.EllipseShapeData.html"
category: "classes"
---
...
Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_index
...
Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_source
...
Inherited from ClientShapeDataMixin(data.EllipseShapeData).parent
...
Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_schema

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from ClientShapeDataMixin(data.EllipseShapeData).LOCALIZATION\_PREFIXES
...
Inherited from ClientShapeDataMixin(data.EllipseShapeData).TYPE
...
* get area(): number
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).area
...
* get bounds(): Rectangle
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).bounds
...
* get center(): Readonly<[Point](../interfaces/foundry.types.Point.md)>
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).center
...
* get clipperPaths(): readonly (readonly [DeepReadonly](../types/foundry.types.DeepReadonly.md)<[types](../modules/foundry.types.md).[ClipperPoint](../interfaces/foundry.types.ClipperPoint.md)>[])[]
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).clipperPaths
...
* get clipperPolyTree(): PolyTree
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).clipperPolyTree
...
* get controlHandles(): [DeepReadonly](../types/foundry.types.DeepReadonly.md)<  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).controlHandles
...
* get grid(): [BaseGrid](foundry.grid.BaseGrid.md)<[GridCoordinates2D](../types/foundry.grid.types.GridCoordinates2D.md), [GridCoordinates3D](../types/foundry.grid.types.GridCoordinates3D.md)>
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).grid
...
* get gridlessGrid(): [GridlessGrid](foundry.grid.GridlessGrid.md)
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).gridlessGrid
...
* get hasRotationalSymmetry(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).hasRotationalSymmetry
...
* get invalid(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).invalid
...
* get isAffectedByGrid(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).isAffectedByGrid
...
* get isEmpty(): boolean
  ...
  Overrides ClientShapeDataMixin(data.EllipseShapeData).isEmpty
...
* get measuredSegments(): readonly [DeepReadonly](../types/foundry.types.DeepReadonly.md)<  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).measuredSegments
...
* get origin(): Readonly<[Point](../interfaces/foundry.types.Point.md)>
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).origin
...
* get polygons(): readonly Polygon[]
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).polygons
...
* get polygonTree(): [PolygonTree](foundry.data.PolygonTree.md)
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).polygonTree
...
* get scene(): [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md) | null
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).scene
...
* get schema(): [DataModelSchemaField](foundry.data.fields.DataModelSchemaField.md)
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).schema
...
* get triangulation(): Readonly<  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).triangulation
...
* get validationFailures(): {  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).validationFailures
...
* get TYPES(): Readonly<  
  ...
  Â Â Â Â Â Â Â Â ellipse: [data](../modules/foundry.data.md).EllipseShapeData;  
  ...
  #### Returns Readonly< Â Â Â Â { Â Â Â Â Â Â Â Â circle: [data](../modules/foundry.data.md).[CircleShapeData](foundry.data.CircleShapeData.md); Â Â Â Â Â Â Â Â cone: [data](../modules/foundry.data.md).[ConeShapeData](foundry.data.ConeShapeData.md); Â Â Â Â Â Â Â Â ellipse: [data](../modules/foundry.data.md).EllipseShapeData; Â Â Â Â Â Â Â Â emanation: [EmanationShapeData](foundry.data.EmanationShapeData.md); Â Â Â Â Â Â Â Â grid: [GridShapeData](foundry.data.GridShapeData.md); Â Â Â Â Â Â Â Â line: [LineShapeData](foundry.data.LineShapeData.md); Â Â Â Â Â Â Â Â polygon: [data](../modules/foundry.data.md).[PolygonShapeData](foundry.data.PolygonShapeData.md); Â Â Â Â Â Â Â Â rectangle: [data](../modules/foundry.data.md).[RectangleShapeData](foundry.data.RectangleShapeData.md); Â Â Â Â Â Â Â Â ring: [RingShapeData](foundry.data.RingShapeData.md); Â Â Â Â Â Â Â Â token: [TokenShapeData](foundry.data.TokenShapeData.md); Â Â Â Â }, >

  Inherited from ClientShapeDataMixin(data.EllipseShapeData).TYPES
...
* \_calculateArea(): number
  ...
  Overrides ClientShapeDataMixin(data.EllipseShapeData).\_calculateArea
...
* \_calculateSize(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_calculateSize
...
* \_createClipperPolyTree(): any[]
  ...
  Overrides ClientShapeDataMixin(data.EllipseShapeData).\_createClipperPolyTree

### \_createControlHandles

* \_createControlHandles(): {  
  Â Â Â Â rotate: { position: Point; rotation: number; visible: boolean };  
  Â Â Â Â scaleX: { position: Point; rotation: number; visible: boolean };  
  Â Â Â Â scaleY: { position: Point; rotation: number; visible: boolean };  
  Â Â Â Â translate: { position: Point; rotation: number; visible: boolean };  
  }

  #### Returns { Â Â Â Â rotate: { position: Point; rotation: number; visible: boolean }; Â Â Â Â scaleX: { position: Point; rotation: number; visible: boolean }; Â Â Â Â scaleY: { position: Point; rotation: number; visible: boolean }; Â Â Â Â translate: { position: Point; rotation: number; visible: boolean }; }

  Overrides ClientShapeDataMixin(data.EllipseShapeData).\_createControlHandles
...
* \_createMeasuredSegment(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_createMeasuredSegment
...
* \_createMeasuredSegments(): { distance: number; ray: [Ray](foundry.canvas.geometry.Ray.md); winding: number }[]
  ...
  Overrides ClientShapeDataMixin(data.EllipseShapeData).\_createMeasuredSegments
...
* \_createRay(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_createRay
...
* \_getSnappedPoint(point: [Point](../interfaces/foundry.types.Point.md)): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_getSnappedPoint
...
* \_getSnappedRotation(rotation: number): number
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_getSnappedRotation
...
* \_moveRotationHandle(direction: number, destination: [Point](../interfaces/foundry.types.Point.md), snap: boolean): void
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_moveRotationHandle
...
* \_moveScaleHandle(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_moveScaleHandle
...
* \_moveSweepHandle(maxAngle: number, destination: [Point](../interfaces/foundry.types.Point.md), snap: boolean): void
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_moveSweepHandle
...
* \_onDragMove(event: any): void
  ...
  Overrides ClientShapeDataMixin(data.EllipseShapeData).\_onDragMove
...
* \_onDragStart(event: FederatedEvent<UIEvent | PixiTouch>): void
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_onDragStart
...
* \_onShapeChange(): void
  ...
  Overrides ClientShapeDataMixin(data.EllipseShapeData).\_onShapeChange
...
* \_updateCommit(copy: any, diff: any, options: any, state: any): void
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_updateCommit
...
* clone(  
  ...
  Overrides ClientShapeDataMixin(data.EllipseShapeData).clone
...
* drawReferenceLines(graphics: Graphics): void
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).drawReferenceLines
...
* drawShape(graphics: any): void
  ...
  Overrides ClientShapeDataMixin(data.EllipseShapeData).drawShape
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).getFieldForProperty
...
* move(origin: [Point](../interfaces/foundry.types.Point.md), options?: { snap?: boolean }): void
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).move
...
* moveControlHandle(  
  ...
  Â Â Â Â \_\_namedParameters?: { snap?: boolean },  
  ): void
  ...
  + name: any
  + destination: any
  + \_\_namedParameters: { snap?: boolean } = {}

  #### Returns void

  Overrides ClientShapeDataMixin(data.EllipseShapeData).moveControlHandle
...
* reset(): void
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).reset
...
* rotate(angle: number, options?: { pivot?: [Point](../interfaces/foundry.types.Point.md) }): void
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).rotate
...
* sampleBoundary(out?: [Point](../interfaces/foundry.types.Point.md)): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).sampleBoundary
...
* sampleInterior(out: any): any
  ...
  Overrides ClientShapeDataMixin(data.EllipseShapeData).sampleInterior
...
* testPoint(point: [Point](../interfaces/foundry.types.Point.md)): boolean
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).testPoint
...
* toJSON(): object
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).toJSON
...
* toObject(source?: boolean): object
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).toObject
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).updateSource
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).validate
...
* \_configure(options?: object): void
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_configure
...
* \_createCenter(): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_createCenter
...
* \_createOrigin(): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_createOrigin
...
* \_getInnerModel(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_getInnerModel
...
* \_initializationOrder(): Generator<[string, [DataField](foundry.data.fields.DataField.md)], any, any>
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_initializationOrder
...
* \_initialize(options?: object): void
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_initialize
...
* \_initializeSource(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_initializeSource
...
* \_onGridChange(changed: object): void
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_onGridChange
...
* \_preUpdateSource(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_preUpdateSource
...
* \_rotate(angle: number): void
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_rotate
...
* \_updateDiff(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_updateDiff
...
* \_toClipperPath(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_toClipperPath
...
* cleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).cleanData
...
* defineSchema(): { hole: [BooleanField](foundry.data.fields.BooleanField.md); type: [StringField](foundry.data.fields.StringField.md) }
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).defineSchema
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).fromJSON
...
* fromSource(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).fromSource
...
* migrateData(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).migrateData
...
* migrateDataSafe(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).migrateDataSafe
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).shimData
...
* validateJoint(data: object): void
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).validateJoint
...
* \_cleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_cleanData
...
* \_preCleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.EllipseShapeData).\_preCleanData