---
title: "ColorAdjustmentsSamplerShader | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.rendering.shaders.ColorAdjustmentsSamplerShader.html"
category: "classes"
---

# Class ColorAdjustmentsSamplerShader

A color adjustment shader.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.rendering.shaders.ColorAdjustmentsSamplerShader))

* [BaseSamplerShader](foundry.canvas.rendering.shaders.BaseSamplerShader.md)
  + ColorAdjustmentsSamplerShader
    - [AmplificationSamplerShader](foundry.canvas.rendering.shaders.AmplificationSamplerShader.md)
...
* get defaultUniforms(): {  
  ...
  #### Returns { Â Â Â Â contrast: number; Â Â Â Â darknessLevelTexture: null; Â Â Â Â exposure: number; Â Â Â Â linkedToDarknessLevel: boolean; Â Â Â Â sampler: null; Â Â Â Â saturation: number; Â Â Â Â screenDimensions: number[]; Â Â Â Â tint: number[]; Â Â Â Â tintAlpha: number[]; }
