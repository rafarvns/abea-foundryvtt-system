---
title: "ClientPackage | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.ClientPackage.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.ClientPackage))
...
[get](#get)
[getVersionBadge](#getversionbadge-2)
...
[\_formatIncompatibleSystemsTooltip](#_formatincompatiblesystemstooltip)
...
* new ClientPackage(data: [PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md), options?: object): ClientPackage
...
\_source: [PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md)
...
Inherited from Base.\_unknownKeys
...
Inherited from Base.availability
...
Inherited from Base.hasStorage
...
Define the package type in CONST.PACKAGE\_TYPES that this class represents.
...
* get incompatibleWithCoreVersion(): boolean
  ...
  Inherited from Base.incompatibleWithCoreVersion
...
* get unavailable(): boolean
  ...
  Inherited from Base.unavailable
...
* \_testRequiredDependencies(  
  ...
  Inherited from Base.\_testRequiredDependencies
...
* \_testSupportedSystems(  
  ...
  Inherited from Base.\_testSupportedSystems
...
* getVersionBadge(): [PackageCompatibilityBadge](../interfaces/foundry.packages.types.PackageCompatibilityBadge.md) | null

  Associate package availability with certain badge for client-side display.

  #### Returns [PackageCompatibilityBadge](../interfaces/foundry.packages.types.PackageCompatibilityBadge.md) | null
...
* \_initialize(options?: object): void
  ...
  Inherited from Base.\_initialize
...
* fromRemoteManifest(  
  ...
  #### Returns Promise<ClientPackage | null>
...
* getVersionBadge(  
  Â Â Â Â availability: number,  
  Â Â Â Â data: Partial<[PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md)>,  
  Â Â Â Â options?: { modules?: any; systems?: any },  
  ): [PackageCompatibilityBadge](../interfaces/foundry.packages.types.PackageCompatibilityBadge.md) | null
  ...
  + `Optional`options: { modules?: any; systems?: any } = {}
...
* \_formatBadDependenciesTooltip(  
  Â Â Â Â availability: number,  
  Â Â Â Â data: Partial<[PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md)>,  
  Â Â Â Â deps: Iterable<RelatedPackage, any, any>,  
  Â Â Â Â options?: { modules?: any; systems?: any },  
  ): string
  ...
  + data: Partial<[PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md)>
    ...
    The compatibility data.
  + deps: Iterable<RelatedPackage, any, any>
...
* \_formatIncompatibleSystemsTooltip(  
  Â Â Â Â data: Partial<[PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md)>,  
  Â Â Â Â relationships: Iterable<RelatedPackage, any, any>,  
  Â Â Â Â options?: { systems?: any },  
  ): string
  ...
  + data: Partial<[PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md)>
    ...
    The compatibility data.
  + relationships: Iterable<RelatedPackage, any, any>

    The system relationships.
  + `Optional`options: { systems?: any } = {}
    - ##### `Optional`systems?: any

      A specific collection of systems to test against. Tests
