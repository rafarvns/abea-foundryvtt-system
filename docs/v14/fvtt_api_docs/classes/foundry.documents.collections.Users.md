---
title: "Users | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.collections.Users.html"
category: "classes"
---
...
* [hookEvents.userConnected](../functions/hookEvents.userConnected.md)

#### See

[foundry.documents.User](foundry.documents.User.md): The User document

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.collections.Users))
...
current: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) | null
...
* get activeGM(): [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) | null
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)[]
...
* \_initialize(): void
  ...
  Overrides [WorldCollection](foundry.documents.abstract.WorldCollection.md).[\_initialize](foundry.documents.abstract.WorldCollection.md#_initialize)

### \_onModifyContents

* \_onModifyContents(  
  Â Â Â Â action: [DatabaseAction](../types/foundry.abstract.types.DatabaseAction.md),  
  Â Â Â Â documents: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)
...
* every(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â element: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)>,  
  Â Â Â Â ) => boolean,  
  ): boolean
  ...
  + condition: (  
    Â Â Â Â element: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md),  
    Â Â Â Â index: number,  
    Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)>,  
    ) => boolean
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)>,  
  Â Â Â Â ) => unknown,  
  ): [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) | undefined
  ...
  #### Returns [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) | undefined
...
* forEach(fn: (value: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md), index: number) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md), index: number) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md),  
  ...
  + document: object | [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)
...
* getDesignatedUser(  
  Â Â Â Â condition: (user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)) => boolean,  
  ): [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) | null
  ...
  + condition: (user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)) => boolean
...
* getInvalid(id: string, options?: { strict?: boolean }): void | [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)
  ...
  #### Returns void | [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)
...
* importFromCompendium(  
  ...
  Â Â Â Â options?: any,  
  ): Promise<[documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)>
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)[]
...
* set(id: string, document: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)): Users

  #### Parameters

  + id: string
  + document: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)
