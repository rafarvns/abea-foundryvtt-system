---
title: "SetupTour | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.nue.tours.SetupTour.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.nue.tours.SetupTour))
...
focusedApp: [ApplicationV2](foundry.applications.api.ApplicationV2.md)<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md), [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)>
...
* start(): Promise<any>
  ...
  Inherited from [Tour](foundry.nue.Tour.md).[start](foundry.nue.Tour.md#start)
