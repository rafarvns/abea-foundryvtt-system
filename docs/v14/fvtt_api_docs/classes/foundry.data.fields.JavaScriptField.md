---
title: "JavaScriptField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.JavaScriptField.html"
category: "classes"
---

# Class JavaScriptField

A subclass of [foundry.data.fields.StringField](foundry.data.fields.StringField.md) which contains JavaScript code.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.JavaScriptField))
...
* new JavaScriptField(  
  Â Â Â Â options?: [JavaScriptFieldOptions](../types/foundry.data.types.JavaScriptFieldOptions.md),  
  Â Â Â Â context?: [DataFieldContext](../interfaces/foundry.data.types.DataFieldContext.md),  
  ): JavaScriptField

  #### Parameters

  + `Optional`options: [JavaScriptFieldOptions](../types/foundry.data.types.JavaScriptFieldOptions.md)
  ...
  #### Returns JavaScriptField

  Overrides [StringField](foundry.data.fields.StringField.md).[constructor](foundry.data.fields.StringField.md#constructor)
...
Inherited from [StringField](foundry.data.fields.StringField.md).[blank](foundry.data.fields.StringField.md#blank)
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & {  
  ...
  } & { async: boolean; blank: boolean; nullable: boolean; required: boolean }

  Default parameters for this field type

  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { Â Â Â Â blank: boolean; Â Â Â Â choices: undefined; Â Â Â Â textSearch: boolean; Â Â Â Â trim: boolean; } & { async: boolean; blank: boolean; nullable: boolean; required: boolean }
...
* \_cast(value: any): string
  ...
  Inherited from [StringField](foundry.data.fields.StringField.md).[\_cast](foundry.data.fields.StringField.md#_cast)
...
* \_toInput(config: [FormInputConfig](../interfaces/foundry.data.types.FormInputConfig.md) & [CodeMirrorInputConfig](../interfaces/foundry.data.types.CodeMirrorInputConfig.md)): [HTMLCodeMirrorElement](foundry.applications.elements.HTMLCodeMirrorElement.md)

  #### Parameters

  + config: [FormInputConfig](../interfaces/foundry.data.types.FormInputConfig.md) & [CodeMirrorInputConfig](../interfaces/foundry.data.types.CodeMirrorInputConfig.md)

  #### Returns [HTMLCodeMirrorElement](foundry.applications.elements.HTMLCodeMirrorElement.md)
...
* initialize(value: unknown, model: object, options?: object): unknown
  ...
  Inherited from [StringField](foundry.data.fields.StringField.md).[initialize](foundry.data.fields.StringField.md#initialize)
...
* toFormGroup(groupConfig?: {}, inputConfig?: {}): HTMLDivElement
  ...
  Overrides [StringField](foundry.data.fields.StringField.md).[toFormGroup](foundry.data.fields.StringField.md#toformgroup)
