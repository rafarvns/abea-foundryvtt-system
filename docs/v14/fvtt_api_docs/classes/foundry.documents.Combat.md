...
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.Combat.html"
category: "classes"
---
...
* [hookEvents.combatRound](../functions/hookEvents.combatRound.md)
* [hookEvents.combatStart](../functions/hookEvents.combatStart.md)
* [hookEvents.combatTurn](../functions/hookEvents.combatTurn.md)
* [hookEvents.combatTurnChange](../functions/hookEvents.combatTurnChange.md)
...
* [foundry.documents.collections.CombatEncounters](foundry.documents.collections.CombatEncounters.md): The world-level collection of Combat
  documents
* [Combatant](foundry.documents.Combatant.md): The Combatant embedded document which exists within a Combat
  document
* [foundry.applications.sidebar.tabs.CombatTracker](foundry.applications.sidebar.tabs.CombatTracker.md): The CombatTracker application
* [foundry.applications.apps.CombatTrackerConfig](foundry.applications.apps.CombatTrackerConfig.md): The CombatTracker configuration
  application

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.Combat))

* [BaseCombat](foundry.documents.BaseCombat.md)<this>
  + Combat
...
[endCombat](#endcombat)
[getCombatantsByActor](#getcombatantsbyactor)
[getCombatantsByToken](#getcombatantsbytoken)
...
[toggleSceneLink](#togglescenelink)
[toJSON](#tojson)
[toObject](#toobject)
[traverseEmbeddedDocuments](#traverseembeddeddocuments)
[unsetFlag](#unsetflag)
[update](#update)
[updateCombatantActors](#updatecombatantactors)
[updateEmbeddedDocuments](#updateembeddeddocuments)
[updateSource](#updatesource)
[validate](#validate)
[\_canChangeRound](#_canchangeround)
[\_canChangeTurn](#_canchangeturn)
[\_clearMovementHistoryOnExit](#_clearmovementhistoryonexit)
[\_clearMovementHistoryOnStartTurn](#_clearmovementhistoryonstartturn)
[\_getCurrentState](#_getcurrentstate)
[\_getInnerModel](#_getinnermodel)
[\_initialize](#_initialize)
[\_initializeSource](#_initializesource)
[\_manageTurnEvents](#_manageturnevents)
[\_onEndRound](#_onendround)
[\_onEndTurn](#_onendturn)
[\_onEnter](#_onenter)
[\_onExit](#_onexit)
[\_onStartRound](#_onstartround)
[\_onStartTurn](#_onstartturn)
[\_playCombatSound](#_playcombatsound)
[\_preCreate](#_precreate)
[\_preDelete](#_predelete)
[\_preUpdateSource](#_preupdatesource)
[\_refreshTokenHUD](#_refreshtokenhud)
[\_sortCombatants](#_sortcombatants)
[\_updateCommit](#_updatecommit)
[\_updateTurnMarkers](#_updateturnmarkers)
...
[\_onDeleteTokens](#_ondeletetokens)
...
* new Combat(  
  Â Â Â Â data?: Partial<[CombatData](../interfaces/foundry.documents.types.CombatData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).Combat

  #### Parameters

  + `Optional`data: Partial<[CombatData](../interfaces/foundry.documents.types.CombatData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).Combat

  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[constructor](foundry.documents.BaseCombat.md#constructor)

## Properties

### \_source

\_source: [CombatData](../interfaces/foundry.documents.types.CombatData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_source](foundry.documents.BaseCombat.md#_source)
...
Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[parent](foundry.documents.BaseCombat.md#parent)

### previous

previous: [CombatHistoryData](../interfaces/foundry.documents.types.CombatHistoryData.md) = undefined

Track the previous round, turn, and tokenId to understand changes in the encounter state

### turns

turns: [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)[] = ...
...
Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_schema](foundry.documents.BaseCombat.md#_schema)
...
Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseCombat.md#localization_prefixes)
...
Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[metadata](foundry.documents.BaseCombat.md#metadata)
...
* get nextCombatant(): [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)

  Get the Combatant who has the next turn.

  #### Returns [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_configure](foundry.documents.BaseCombat.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_getParentCollection](foundry.documents.BaseCombat.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_initializationOrder](foundry.documents.BaseCombat.md#_initializationorder)
...
* \_onCreate(data: any, options: any, userId: any): void
  ...
  Overrides [BaseCombat](foundry.documents.BaseCombat.md).[\_onCreate](foundry.documents.BaseCombat.md#_oncreate)
...
* \_onDelete(options: any, userId: any): void
  ...
  Overrides [BaseCombat](foundry.documents.BaseCombat.md).[\_onDelete](foundry.documents.BaseCombat.md#_ondelete)
...
* \_onUpdate(changed: any, options: any, userId: any): void
  ...
  Overrides [BaseCombat](foundry.documents.BaseCombat.md).[\_onUpdate](foundry.documents.BaseCombat.md#_onupdate)
...
* \_preUpdate(changed: any, options: any, user: any): Promise<false | undefined>
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_preUpdate](foundry.documents.BaseCombat.md#_preupdate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_updateDiff](foundry.documents.BaseCombat.md#_updatediff)

### activate

* activate(options?: Partial<[DatabaseUpdateOperation](../interfaces/foundry.abstract.types.DatabaseUpdateOperation.md)>): Promise<[documents](../modules/foundry.documents.md).Combat>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).Combat>
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[canUserModify](foundry.documents.BaseCombat.md#canusermodify)
...
* clearMovementHistories(combatants: Iterable<[documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)>): Promise<void>

  Clear the movement history of the Combatants' Tokens.

  #### Parameters

  + combatants: Iterable<[documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)>
...
* clone(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[clone](foundry.documents.BaseCombat.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[createEmbeddedDocuments](foundry.documents.BaseCombat.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[delete](foundry.documents.BaseCombat.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[deleteEmbeddedDocuments](foundry.documents.BaseCombat.md#deleteembeddeddocuments)

### endCombat

* endCombat(): Promise<[documents](../modules/foundry.documents.md).Combat>
...
* getCombatantsByActor(actor: string | [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)): [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)[]

  Get a Combatant that represents the given Actor or Actor ID.

  #### Parameters

  + actor: string | [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)
...
* getCombatantsByToken(token: string | [TokenDocument](foundry.documents.TokenDocument.md)): [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)[]

  Get a Combatant using its Token id

  #### Parameters

  + token: string | [TokenDocument](foundry.documents.TokenDocument.md)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[getEmbeddedCollection](foundry.documents.BaseCombat.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[getEmbeddedDocument](foundry.documents.BaseCombat.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[getFieldForProperty](foundry.documents.BaseCombat.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[getFlag](foundry.documents.BaseCombat.md#getflag)

### getTimeDelta

* getTimeDelta(  
  Â Â Â Â fromRound: number,  
  Â Â Â Â fromTurn: number | null,  
  Â Â Â Â toRound: number,  
  Â Â Â Â toTurn: number | null,  
  ): number
...
* getUserLevel(user?: [BaseUser](foundry.documents.BaseUser.md)): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.md)
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[getUserLevel](foundry.documents.BaseCombat.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[migrateSystemData](foundry.documents.BaseCombat.md#migratesystemdata)

### nextRound

* nextRound(): Promise<[documents](../modules/foundry.documents.md).Combat>
...
* nextTurn(): Promise<[documents](../modules/foundry.documents.md).Combat>
...
* previousRound(): Promise<[documents](../modules/foundry.documents.md).Combat>
...
* previousTurn(): Promise<[documents](../modules/foundry.documents.md).Combat>
...
* reset(): void
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[reset](foundry.documents.BaseCombat.md#reset)

### resetAll

* resetAll(options?: { updateTurn?: boolean }): Promise<[documents](../modules/foundry.documents.md).Combat>
...
* rollAll(options?: object): Promise<[documents](../modules/foundry.documents.md).Combat>
...
* rollInitiative(  
  ...
  + `Optional`options: {  
    Â Â Â Â formula?: string | null;  
    Â Â Â Â messageMode?: string;  
    Â Â Â Â messageOptions?: object;  
    Â Â Â Â updateTurn?: boolean;  
    } = {}
    ...
    - ##### `Optional`messageMode?: string
      ...
      A message visibility mode to apply to the resulting chat message,
      a key of [CONFIG.ChatMessage.modes](../variables/CONFIG.ChatMessage.md#modes)
...
* rollNPC(options?: object): Promise<[documents](../modules/foundry.documents.md).Combat>
...
* setFlag(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[setFlag](foundry.documents.BaseCombat.md#setflag)
...
* setupTurns(): [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)[]
...
* startCombat(): Promise<[documents](../modules/foundry.documents.md).Combat>
...
* testUserPermission(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[testUserPermission](foundry.documents.BaseCombat.md#testuserpermission)

### toggleSceneLink

* toggleSceneLink(): Promise<[documents](../modules/foundry.documents.md).Combat>
...
* toJSON(): object
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[toJSON](foundry.documents.BaseCombat.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[toObject](foundry.documents.BaseCombat.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[traverseEmbeddedDocuments](foundry.documents.BaseCombat.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[unsetFlag](foundry.documents.BaseCombat.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[update](foundry.documents.BaseCombat.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[updateEmbeddedDocuments](foundry.documents.BaseCombat.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[updateSource](foundry.documents.BaseCombat.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[validate](foundry.documents.BaseCombat.md#validate)
...
* \_canChangeRound(user: User): boolean
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_canChangeRound](foundry.documents.BaseCombat.md#_canchangeround)
...
* \_canChangeTurn(user: User): boolean
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_canChangeTurn](foundry.documents.BaseCombat.md#_canchangeturn)

### `Protected`\_clearMovementHistoryOnExit

* \_clearMovementHistoryOnExit(combatant: [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)): Promise<void>

  `Protected`

  Called after [Combat#\_onExit](#_onexit) and takes care of clearing the movement history of the
  Combatant's Token.
  ...
  + combatant: [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)
...
* \_clearMovementHistoryOnStartTurn(  
  Â Â Â Â combatant: [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md),  
  Â Â Â Â context: [CombatTurnEventContext](../interfaces/foundry.documents.types.CombatTurnEventContext.md),  
  ): Promise<void>

  `Protected`

  Called after [Combat#\_onStartTurn](#_onstartturn) and takes care of clearing the movement history of the
  Combatant's Token.
  ...
  + context: [CombatTurnEventContext](../interfaces/foundry.documents.types.CombatTurnEventContext.md)
...
* \_getCurrentState(combatant?: [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)): [CombatHistoryData](../interfaces/foundry.documents.types.CombatHistoryData.md)
  ...
  + `Optional`combatant: [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)

    The new active combatant

  #### Returns [CombatHistoryData](../interfaces/foundry.documents.types.CombatHistoryData.md)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_getInnerModel](foundry.documents.BaseCombat.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_initialize](foundry.documents.BaseCombat.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_initializeSource](foundry.documents.BaseCombat.md#_initializesource)
...
* \_onEndRound(context: [CombatRoundEventContext](../types/foundry.documents.types.CombatRoundEventContext.md)): Promise<void>
  ...
  + context: [CombatRoundEventContext](../types/foundry.documents.types.CombatRoundEventContext.md)
...
* \_onEnter(combatant: [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)): Promise<void>
...
* \_onExit(combatant: [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)): Promise<void>
...
* \_onStartRound(context: [CombatRoundEventContext](../types/foundry.documents.types.CombatRoundEventContext.md)): Promise<void>
...
* \_preCreate(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_preCreate](foundry.documents.BaseCombat.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_preDelete](foundry.documents.BaseCombat.md#_predelete)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_preUpdateSource](foundry.documents.BaseCombat.md#_preupdatesource)

### `Protected`\_refreshTokenHUD

* \_refreshTokenHUD(documents: [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)[]): void
  ...
  + documents: [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)[]
...
* \_sortCombatants(a: [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md), b: [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)): number
  ...
  + a: [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)

    Some combatant
  + b: [documents](../modules/foundry.documents.md).[Combatant](foundry.documents.Combatant.md)
...
* \_updateCommit(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_updateCommit](foundry.documents.BaseCombat.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_addDataFieldMigration](foundry.documents.BaseCombat.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_addDataFieldShim](foundry.documents.BaseCombat.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_addDataFieldShims](foundry.documents.BaseCombat.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_clearFieldsRecursively](foundry.documents.BaseCombat.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_logDataFieldMigration](foundry.documents.BaseCombat.md#_logdatafieldmigration)

### `Static`\_onDeleteTokens

* \_onDeleteTokens(  
  Â Â Â Â tokens: [TokenDocument](foundry.documents.TokenDocument.md)[],  
  Â Â Â Â operation: [DatabaseDeleteOperation](../interfaces/foundry.abstract.types.DatabaseDeleteOperation.md),  
  ...
  + tokens: [TokenDocument](foundry.documents.TokenDocument.md)[]
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_preCleanData](foundry.documents.BaseCombat.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[canUserCreate](foundry.documents.BaseCombat.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[cleanData](foundry.documents.BaseCombat.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[create](foundry.documents.BaseCombat.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[createDocuments](foundry.documents.BaseCombat.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â combatants: [EmbeddedCollectionField](foundry.data.fields.EmbeddedCollectionField.md);  
  Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md);  
  Â Â Â Â groups: [EmbeddedCollectionField](foundry.data.fields.EmbeddedCollectionField.md);  
  Â Â Â Â name: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â round: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â scene: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md);  
  ...
  Â Â Â Â turn: [NumberField](foundry.data.fields.NumberField.md);  
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â active: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â combatants: [EmbeddedCollectionField](foundry.data.fields.EmbeddedCollectionField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â groups: [EmbeddedCollectionField](foundry.data.fields.EmbeddedCollectionField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â round: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â scene: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); Â Â Â Â sort: [IntegerSortField](foundry.data.fields.IntegerSortField.md); Â Â Â Â system: [TypeDataField](foundry.data.fields.TypeDataField.md); Â Â Â Â turn: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â type: [DocumentTypeField](foundry.data.fields.DocumentTypeField.md); }
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[defineSchema](foundry.documents.BaseCombat.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[deleteDocuments](foundry.documents.BaseCombat.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[fromJSON](foundry.documents.BaseCombat.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[fromSource](foundry.documents.BaseCombat.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[get](foundry.documents.BaseCombat.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[getCollectionName](foundry.documents.BaseCombat.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[migrateData](foundry.documents.BaseCombat.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[migrateDataSafe](foundry.documents.BaseCombat.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[shimData](foundry.documents.BaseCombat.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[updateDocuments](foundry.documents.BaseCombat.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[validateJoint](foundry.documents.BaseCombat.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_cleanData](foundry.documents.BaseCombat.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_onCreateOperation](foundry.documents.BaseCombat.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_onDeleteOperation](foundry.documents.BaseCombat.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_onUpdateOperation](foundry.documents.BaseCombat.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_preCreateOperation](foundry.documents.BaseCombat.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_preDeleteOperation](foundry.documents.BaseCombat.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseCombat](foundry.documents.BaseCombat.md).[\_preUpdateOperation](foundry.documents.BaseCombat.md#_preupdateoperation)