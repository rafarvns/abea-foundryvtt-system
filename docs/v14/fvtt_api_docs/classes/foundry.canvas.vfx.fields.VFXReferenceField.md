---
title: "VFXReferenceField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.vfx.fields.VFXReferenceField.html"
category: "classes"
---

# Class VFXReferenceField
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.vfx.fields.VFXReferenceField))

* [DataField](foundry.data.fields.DataField.md)
  + VFXReferenceField
    - [VFXPointSourcePolygonField](foundry.canvas.vfx.fields.VFXPointSourcePolygonField.md)
...
* new VFXReferenceField(  
  Â Â Â Â valueField: [DataField](foundry.data.fields.DataField.md),  
  ...
  + context: [DataFieldContext](../interfaces/foundry.data.types.DataFieldContext.md)

  #### Returns VFXReferenceField
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md)
  ...
  Inherited from DataField.\_defaults
...
* initialize(value: any, model: any, options: any): unknown
...
* resolve(value: any, references: Record<string, any>): any
  ...
  + value: any
    ...
    The initial value of the field which may contain a reference
  ...
  The resulting resolved value with references applied, if possible
