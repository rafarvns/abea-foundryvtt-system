---
title: "ClientSettings | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.helpers.ClientSettings.html"
category: "classes"
---
...
* [foundry.Game#settings](foundry.Game.md#settings)
* [foundry.applications.sidebar.tabs.Settings](foundry.applications.sidebar.tabs.Settings.md)
* [foundry.applications.settings.SettingsConfig](foundry.applications.settings.SettingsConfig.md)
...
settings: Map<string, [SettingConfig](../interfaces/foundry.types.SettingConfig.md)>

A object of registered game settings for this scope

### storage

storage: Map<"client" | "world", Storage>
...
* get sheet(): [SettingsConfig](foundry.applications.settings.SettingsConfig.md)

  Return a singleton instance of the Game Settings Configuration app

  #### Returns [SettingsConfig](foundry.applications.settings.SettingsConfig.md)
...
* register(namespace: string, key: string, data: [SettingConfig](../interfaces/foundry.types.SettingConfig.md)): void
  ...
  + data: [SettingConfig](../interfaces/foundry.types.SettingConfig.md)
...
* registerMenu(namespace: string, key: string, data: [SettingSubmenuConfig](../interfaces/foundry.types.SettingSubmenuConfig.md)): void
  ...
  + key: string
    ...
    The key name for the setting under the namespace
  + data: [SettingSubmenuConfig](../interfaces/foundry.types.SettingSubmenuConfig.md)
