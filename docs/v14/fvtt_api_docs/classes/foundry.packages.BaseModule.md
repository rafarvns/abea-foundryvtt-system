---
title: "BaseModule | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.packages.BaseModule.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.packages.BaseModule))

* [BasePackage](foundry.packages.BasePackage.md)
  + BaseModule
    - [Module](foundry.packages.Module.md)
...
* new BaseModule(data: [PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md), options?: object): BaseModule
