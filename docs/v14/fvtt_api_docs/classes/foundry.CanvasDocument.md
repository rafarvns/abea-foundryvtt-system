---
title: "CanvasDocument | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.CanvasDocument.html"
category: "classes"
---

# Class CanvasDocument

A ClientDocument class with additional facilities for utilizing the [foundry.canvas.Canvas](foundry.canvas.Canvas.md) API

#### Hierarchy ([View Summary](../hierarchy.md#foundry.CanvasDocument))

* [ClientDocument](foundry.ClientDocument.md)<this>
  + CanvasDocument
...
\_object: [PlaceableObject](foundry.canvas.placeables.PlaceableObject.md) | null
...
* get collection(this: [ClientDocument](foundry.ClientDocument.md)): any

  Return a reference to the parent Collection/Document instance that contains/is this Document.

  #### Parameters

  + this: [ClientDocument](foundry.ClientDocument.md)
...
* get object(): [PlaceableObject](foundry.canvas.placeables.PlaceableObject.md) | null
...
* get persisted(): boolean
  ...
  Inherited from ClientDocumentMixin(Base).persisted
...
* get sheet(): | [ApplicationV2](foundry.applications.api.ApplicationV2.md)<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md), [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)>  
  ...
  Inherited from [foundry](../modules/foundry.md).[sheet](../modules/foundry.md#sheet)
...
* get visible(): boolean
  ...
  Overrides [foundry](../modules/foundry.md).[visible](../modules/foundry.md#visible)
...
* \_createDocumentLink(  
  ...
  Â Â Â Â options?: { label?: string; relativeTo?: [ClientDocument](foundry.ClientDocument.md) },  
  ): string
  ...
  + `Optional`options: { label?: string; relativeTo?: [ClientDocument](foundry.ClientDocument.md) } = {}
    ...
    - ##### `Optional`relativeTo?: [ClientDocument](foundry.ClientDocument.md)
...
* \_dispatchDescendantDocumentEvents(  
  ...
  Â Â Â Â args: any[],  
  Â Â Â Â \_parent?: [ClientDocument](foundry.ClientDocument.md),  
  ): void
  ...
  + `Optional`\_parent: [ClientDocument](foundry.ClientDocument.md)
...
* \_initialize(this: [ClientDocument](foundry.ClientDocument.md), options?: {}): void
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from ClientDocumentMixin(Base).\_updateDiff
...
* exportToJSON(options?: object): void
  ...
  + `Optional`options: object = {}
    ...
    Additional options passed to the [ClientDocument#toCompendium](foundry.ClientDocument.md#tocompendium) method
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from ClientDocumentMixin(Base).getFieldForProperty
...
* importFromJSON(this: [ClientDocument](foundry.ClientDocument.md), json: string): Promise<[ClientDocument](foundry.ClientDocument.md)>
  ...
  #### Returns Promise<[ClientDocument](foundry.ClientDocument.md)>
...
* includedInLevel(level: string | [documents](../modules/foundry.documents.md).[Level](foundry.documents.Level.md)): boolean
...
* locatedInLevel(level: string | [documents](../modules/foundry.documents.md).[Level](foundry.documents.Level.md)): boolean
...
* prepareData(): void
  ...
  1. [reset](foundry.ClientDocument.md#reset) (Inherited from DataModel)
  2. [\_initialize](foundry.ClientDocument.md#_initialize) (Inherited from DataModel)
  3. [prepareData](foundry.ClientDocument.md#preparedata)
  4. [TypeDataModel#prepareBaseData](foundry.abstract.TypeDataModel.md#preparebasedata)
  5. [prepareBaseData](foundry.ClientDocument.md#preparebasedata)
  6. [prepareEmbeddedDocuments](foundry.ClientDocument.md#prepareembeddeddocuments)
  7. [TypeDataModel#prepareBaseData](foundry.abstract.TypeDataModel.md#preparederiveddata)
  8. [prepareDerivedData](foundry.ClientDocument.md#preparederiveddata)

  Do NOT invoke database operations like [update](foundry.ClientDocument.md#update) or [setFlag](foundry.ClientDocument.md#setflag) within data prep, as that can cause an
  infinite loop by re-triggering the data initialization process.

  If possible you should extend [prepareBaseData](foundry.ClientDocument.md#preparebasedata) and [prepareDerivedData](foundry.ClientDocument.md#preparederiveddata) instead of this function
...
* \_getInnerModel(  
  ...
  Inherited from ClientDocumentMixin(Base).\_getInnerModel
...
* \_preUpdateSource(  
  ...
  Inherited from ClientDocumentMixin(Base).\_preUpdateSource
...
* \_updateCommit(  
  ...
  Inherited from ClientDocumentMixin(Base).\_updateCommit
...
* \_onCreateOperation(documents: any, operation: any, user: any): Promise<void>
  ...
  Overrides ClientDocumentMixin(Base).\_onCreateOperation
...
* \_onDeleteOperation(documents: any, operation: any, user: any): Promise<void>
  ...
  Overrides ClientDocumentMixin(Base).\_onDeleteOperation
...
* \_onUpdateOperation(documents: any, operation: any, user: any): Promise<void>
  ...
  Overrides ClientDocumentMixin(Base).\_onUpdateOperation
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from ClientDocumentMixin(Base).\_preCleanData
...
* \_cleanData(  
  ...
  Inherited from ClientDocumentMixin(Base).\_cleanData
