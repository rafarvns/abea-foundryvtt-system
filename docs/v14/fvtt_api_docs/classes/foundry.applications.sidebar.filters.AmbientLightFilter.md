---
title: "AmbientLightFilter | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.filters.AmbientLightFilter.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.filters.AmbientLightFilter))
...
* new AmbientLightFilter(  
  Â Â Â Â tab: [PlaceableTab](foundry.applications.sidebar.tabs.PlaceableTab.md),  
  Â Â Â Â options?: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md)>,  
  ): AmbientLightFilter

  #### Parameters

  + tab: [PlaceableTab](foundry.applications.sidebar.tabs.PlaceableTab.md)
  ...
  #### Returns AmbientLightFilter

  Inherited from PlaceableFilter.constructor
...
Inherited from PlaceableFilter.options
...
Inherited from PlaceableFilter.position
...
Inherited from PlaceableFilter.tabGroups
...
Inherited from PlaceableFilter.\_appId
...
Inherited from PlaceableFilter.\_maxZ
...
Inherited from PlaceableFilter.BASE\_APPLICATION

### `Static`DEFAULT\_OPTIONS

DEFAULT\_OPTIONS: { id: string } = ...

Overrides PlaceableFilter.DEFAULT\_OPTIONS

### `Static`emittedEvents

emittedEvents: readonly ["prerender", "render", "close", "position"] = ...

Inherited from PlaceableFilter.emittedEvents

### `Static`PARTS

PARTS: { body: { classes: string[]; root: boolean; template: string } } = ...

Overrides PlaceableFilter.PARTS
...
Inherited from PlaceableFilter.RENDER\_STATES
...
Inherited from PlaceableFilter.TABS
...
* get classList(): DOMTokenList
  ...
  Inherited from PlaceableFilter.classList
...
* get element(): HTMLElement
  ...
  Inherited from PlaceableFilter.element
...
* get form(): HTMLFormElement | null
  ...
  Inherited from PlaceableFilter.form
...
* get hasFrame(): boolean
  ...
  Inherited from PlaceableFilter.hasFrame
...
* get id(): string
  ...
  Inherited from PlaceableFilter.id
...
* get minimized(): boolean
  ...
  Inherited from PlaceableFilter.minimized
...
* get rendered(): boolean
  ...
  Inherited from PlaceableFilter.rendered
...
* get state(): number
  ...
  Inherited from PlaceableFilter.state

### tab

* get tab(): [PlaceableTab](foundry.applications.sidebar.tabs.PlaceableTab.md)

  The tab this dialog belongs to.

  #### Returns [PlaceableTab](foundry.applications.sidebar.tabs.PlaceableTab.md)

  Inherited from PlaceableFilter.tab
...
* get title(): string
  ...
  Inherited from PlaceableFilter.title
...
* \_attachFrameListeners(): void
  ...
  Overrides PlaceableFilter.\_attachFrameListeners
...
* \_awaitTransition(element: HTMLElement, timeout: number): Promise<void>
  ...
  Inherited from PlaceableFilter.\_awaitTransition
...
* \_canDetach(): boolean
  ...
  Inherited from PlaceableFilter.\_canDetach
...
* \_doEvent(  
  ...
  Inherited from PlaceableFilter.\_doEvent
...
* \_onChangeForm(formConfig: any, event: any): void
  ...
  Overrides PlaceableFilter.\_onChangeForm
...
* \_prepareContext(options: any): Promise<[ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md)>
  ...
  Overrides PlaceableFilter.\_prepareContext
...
* \_renderHTML(  
  ...
  Â Â Â Â options: HandlebarsRenderOptions,  
  ): Promise<any>
  ...
  Inherited from PlaceableFilter.\_renderHTML
...
* addEventListener(  
  ...
  Inherited from PlaceableFilter.addEventListener
...
* attachWindow(  
  ...
  Inherited from PlaceableFilter.attachWindow
...
* bringToFront(): void
  ...
  Inherited from PlaceableFilter.bringToFront
...
* changeTab(  
  ...
  Inherited from PlaceableFilter.changeTab

### close

* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<AmbientLightFilter>
  ...
  #### Returns Promise<AmbientLightFilter>

  A Promise which resolves to the closed Application instance

  Inherited from PlaceableFilter.close

### detachWindow

* detachWindow(options?: any): Promise<AmbientLightFilter>
  ...
  Inherited from PlaceableFilter.detachWindow
...
* dispatchEvent(event: Event): boolean
  ...
  Inherited from PlaceableFilter.dispatchEvent
...
* maximize(): Promise<void>
  ...
  Inherited from PlaceableFilter.maximize
...
* minimize(): Promise<void>
  ...
  Inherited from PlaceableFilter.minimize
...
* removeEventListener(type: string, listener: [EmittedEventListener](../types/foundry.utils.types.EmittedEventListener.md)): void
  ...
  Inherited from PlaceableFilter.removeEventListener

### render

* render(options?: any, \_options?: any): Promise<AmbientLightFilter>
  ...
  Inherited from PlaceableFilter.render
...
* renderChild(  
  ...
  Inherited from PlaceableFilter.renderChild
...
* setPosition(position?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void | [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from PlaceableFilter.setPosition
...
* submit(submitOptions?: object): Promise<any>
  ...
  Inherited from PlaceableFilter.submit
...
* \_canAttach(): boolean
  ...
  Inherited from PlaceableFilter.\_canAttach
...
* \_canRender(options: HandlebarsRenderOptions): false | void
  ...
  Inherited from PlaceableFilter.\_canRender
...
* \_configureRenderOptions(options: HandlebarsRenderOptions): void
  ...
  Inherited from PlaceableFilter.\_configureRenderOptions
...
* \_createContextMenu(  
  ...
  Inherited from PlaceableFilter.\_createContextMenu
...
* \_getFrameButtons(  
  ...
  Inherited from PlaceableFilter.\_getFrameButtons
...
* \_getHeaderControls(): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Inherited from PlaceableFilter.\_getHeaderControls
...
* \_getTabsConfig(group: string): [ApplicationTabsConfiguration](../interfaces/foundry.applications.types.ApplicationTabsConfiguration.md) | null
  ...
  Inherited from PlaceableFilter.\_getTabsConfig
...
* \_headerControlButtons(): Generator<[ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md), any, any>
  ...
  Inherited from PlaceableFilter.\_headerControlButtons
...
* \_headerControlContextEntries(): Generator<[ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md), void, any>
  ...
  Inherited from PlaceableFilter.\_headerControlContextEntries
...
* \_initializeApplicationOptions(  
  ...
  Inherited from PlaceableFilter.\_initializeApplicationOptions
...
* \_insertElement(element: HTMLElement, options?: any): Promise<void>
  ...
  Inherited from PlaceableFilter.\_insertElement
...
* \_onAttach(from: Document, to: Document): void
  ...
  Inherited from PlaceableFilter.\_onAttach
...
* \_onClickAction(event: PointerEvent, target: HTMLElement): void
  ...
  Inherited from PlaceableFilter.\_onClickAction
...
* \_onClickTab(event: PointerEvent): void
  ...
  Inherited from PlaceableFilter.\_onClickTab
...
* \_onClose(options: HandlebarsRenderOptions): void
  ...
  Inherited from PlaceableFilter.\_onClose
...
* \_onDetach(from: Document, to: Document): void
  ...
  Inherited from PlaceableFilter.\_onDetach
...
* \_onFirstRender(  
  ...
  Inherited from PlaceableFilter.\_onFirstRender
...
* \_onPosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from PlaceableFilter.\_onPosition
...
* \_onRender(  
  ...
  Inherited from PlaceableFilter.\_onRender
...
* \_onSubmitForm(  
  ...
  Inherited from PlaceableFilter.\_onSubmitForm
...
* \_postRender(  
  ...
  Inherited from PlaceableFilter.\_postRender
...
* \_preClose(options: HandlebarsRenderOptions): Promise<void>
  ...
  Inherited from PlaceableFilter.\_preClose
...
* \_preFirstRender(  
  ...
  Inherited from PlaceableFilter.\_preFirstRender
...
* \_prepareTabs(group: string): Record<string, [ApplicationTab](../interfaces/foundry.applications.types.ApplicationTab.md)>
  ...
  Inherited from PlaceableFilter.\_prepareTabs
...
* \_prePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from PlaceableFilter.\_prePosition
...
* \_preRender(  
  ...
  Inherited from PlaceableFilter.\_preRender
...
* \_refit(positionUpdate?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void
  ...
  Inherited from PlaceableFilter.\_refit
...
* \_removeElement(element: HTMLElement): void
  ...
  Inherited from PlaceableFilter.\_removeElement
...
* \_renderFrame(options: HandlebarsRenderOptions): Promise<HTMLElement>
  ...
  Inherited from PlaceableFilter.\_renderFrame
...
* \_renderFrameButtons(options: HandlebarsRenderOptions): Promise<void>
  ...
  Inherited from PlaceableFilter.\_renderFrameButtons
...
* \_renderHeaderControl(control: [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)): HTMLLIElement
  ...
  Inherited from PlaceableFilter.\_renderHeaderControl
...
* \_replaceHTML(  
  ...
  Inherited from PlaceableFilter.\_replaceHTML
...
* \_tearDown(options: [ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)): void
  ...
  Inherited from PlaceableFilter.\_tearDown
...
* \_updateFrame(options: HandlebarsRenderOptions): void
  ...
  Inherited from PlaceableFilter.\_updateFrame
...
* \_updatePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from PlaceableFilter.\_updatePosition
...
* inheritanceChain(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), void, unknown>
  ...
  Inherited from PlaceableFilter.inheritanceChain
...
* instances(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), any, any>
  ...
  Inherited from PlaceableFilter.instances
...
* parseCSSDimension(style: string, parentDimension: number): number | void
  ...
  Inherited from PlaceableFilter.parseCSSDimension
...
* waitForImages(element: HTMLElement): Promise<void>
  ...
  Inherited from PlaceableFilter.waitForImages