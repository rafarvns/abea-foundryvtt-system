---
title: "AdaptiveIlluminationShader | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.rendering.shaders.AdaptiveIlluminationShader.html"
category: "classes"
---

# Class AdaptiveIlluminationShader

The default coloration shader used by standard rendering and animations.
A fragment shader which creates a solid light source.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.rendering.shaders.AdaptiveIlluminationShader))

* [AdaptiveLightingShader](foundry.canvas.rendering.shaders.AdaptiveLightingShader.md)
  + AdaptiveIlluminationShader
    - [BewitchingWaveIlluminationShader](foundry.canvas.rendering.shaders.BewitchingWaveIlluminationShader.md)
    - [FairyLightIlluminationShader](foundry.canvas.rendering.shaders.FairyLightIlluminationShader.md)
    - [FlameIlluminationShader](foundry.canvas.rendering.shaders.FlameIlluminationShader.md)
    - [GhostLightIlluminationShader](foundry.canvas.rendering.shaders.GhostLightIlluminationShader.md)
    - [PulseIlluminationShader](foundry.canvas.rendering.shaders.PulseIlluminationShader.md)
    - [SirenIlluminationShader](foundry.canvas.rendering.shaders.SirenIlluminationShader.md)
    - [SmokePatchIlluminationShader](foundry.canvas.rendering.shaders.SmokePatchIlluminationShader.md)
    - [SunburstIlluminationShader](foundry.canvas.rendering.shaders.SunburstIlluminationShader.md)
    - [TorchIlluminationShader](foundry.canvas.rendering.shaders.TorchIlluminationShader.md)
    - [VortexIlluminationShader](foundry.canvas.rendering.shaders.VortexIlluminationShader.md)
    - [WaveIlluminationShader](foundry.canvas.rendering.shaders.WaveIlluminationShader.md)
...
Inherited from [AdaptiveLightingShader](foundry.canvas.rendering.shaders.AdaptiveLightingShader.md).[SHADOW](foundry.canvas.rendering.shaders.AdaptiveLightingShader.md#shadow)
