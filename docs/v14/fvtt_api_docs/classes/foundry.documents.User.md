---
title: "User | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.User.html"
category: "classes"
---
...
* [foundry.documents.collections.Users](foundry.documents.collections.Users.md): The world-level collection of User documents
* [foundry.applications.sheets.UserConfig](foundry.applications.sheets.UserConfig.md): The User configuration application

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.User))

* [BaseUser](foundry.documents.BaseUser.md)<this>
  + User
...
[\_onDelete](#_ondelete)
[\_onUpdate](#_onupdate)
[\_onUpdateTokenTargets](#_onupdatetokentargets)
[\_updateDiff](#_updatediff)
[assignHotbarMacro](#assignhotbarmacro)
...
[getFlag](#getflag)
[getHotbarMacros](#gethotbarmacros)
...
* new User(data: any, options: any): [documents](../modules/foundry.documents.md).User
  ...
  #### Returns [documents](../modules/foundry.documents.md).User

  #### Inherit Doc

  Overrides [BaseUser](foundry.documents.BaseUser.md).[constructor](foundry.documents.BaseUser.md#constructor)

## Properties

### \_source

\_source: [UserData](../interfaces/foundry.documents.types.UserData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_source](foundry.documents.BaseUser.md#_source)
...
movingTokens: ReadonlySet<[TokenDocument](foundry.documents.TokenDocument.md)> = ...
...
Inherited from [BaseUser](foundry.documents.BaseUser.md).[parent](foundry.documents.BaseUser.md#parent)
...
Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_schema](foundry.documents.BaseUser.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseUser](foundry.documents.BaseUser.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseUser.md#localization_prefixes)
...
Inherited from [BaseUser](foundry.documents.BaseUser.md).[metadata](foundry.documents.BaseUser.md#metadata)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_configure](foundry.documents.BaseUser.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_getParentCollection](foundry.documents.BaseUser.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_initializationOrder](foundry.documents.BaseUser.md#_initializationorder)
...
* \_onDelete(options: any, userId: any): void
  ...
  Overrides [BaseUser](foundry.documents.BaseUser.md).[\_onDelete](foundry.documents.BaseUser.md#_ondelete)
...
* \_onUpdate(changed: any, options: any, userId: any): any
  ...
  Overrides [BaseUser](foundry.documents.BaseUser.md).[\_onUpdate](foundry.documents.BaseUser.md#_onupdate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_updateDiff](foundry.documents.BaseUser.md#_updatediff)

### assignHotbarMacro

* assignHotbarMacro(  
  Â Â Â Â macro: [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md) | null,  
  Â Â Â Â slot?: string | number | null,  
  Â Â Â Â fromSlot?: number,  
  ): Promise<[documents](../modules/foundry.documents.md).User>

  Assign a Macro to a numbered hotbar slot between 1 and 50

  #### Parameters

  + macro: [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md) | null

    The Macro document to assign
  + `Optional`slot: string | number | null
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).User>
...
* broadcastActivity(  
  Â Â Â Â activityData?: [ActivityData](../interfaces/foundry.types.ActivityData.md),  
  ...
  + activityData: [ActivityData](../interfaces/foundry.types.ActivityData.md) = {}
...
* can(action: string): boolean
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[can](foundry.documents.BaseUser.md#can)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[canUserModify](foundry.documents.BaseUser.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[clone](foundry.documents.BaseUser.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[createEmbeddedDocuments](foundry.documents.BaseUser.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[delete](foundry.documents.BaseUser.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[deleteEmbeddedDocuments](foundry.documents.BaseUser.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[getEmbeddedCollection](foundry.documents.BaseUser.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[getEmbeddedDocument](foundry.documents.BaseUser.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[getFieldForProperty](foundry.documents.BaseUser.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[getFlag](foundry.documents.BaseUser.md#getflag)

### getHotbarMacros

* getHotbarMacros(  
  Â Â Â Â page?: number,  
  ): { macro: [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md) | null; slot: number }[]
  ...
  #### Returns { macro: [documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md) | null; slot: number }[]
...
* getUserLevel(user: any): 0 | 3
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[getUserLevel](foundry.documents.BaseUser.md#getuserlevel)
...
* hasPermission(permission: string): boolean
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[hasPermission](foundry.documents.BaseUser.md#haspermission)
...
* hasRole(role: string | number, exact?: boolean): boolean
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[hasRole](foundry.documents.BaseUser.md#hasrole)

### isDesignated

* isDesignated(condition: (user: [documents](../modules/foundry.documents.md).User) => boolean): boolean

  Is this User the designated User among the Users that satisfy the given condition?
  This function calls [foundry.documents.collections.Users#getDesignatedUser](foundry.documents.collections.Users.md#getdesignateduser) and compares the designated User
  to this User.

  #### Parameters

  + condition: (user: [documents](../modules/foundry.documents.md).User) => boolean
...
* migrateSystemData(): object
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[migrateSystemData](foundry.documents.BaseUser.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[reset](foundry.documents.BaseUser.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[setFlag](foundry.documents.BaseUser.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[testUserPermission](foundry.documents.BaseUser.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[toJSON](foundry.documents.BaseUser.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[toObject](foundry.documents.BaseUser.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[traverseEmbeddedDocuments](foundry.documents.BaseUser.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[unsetFlag](foundry.documents.BaseUser.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[update](foundry.documents.BaseUser.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[updateEmbeddedDocuments](foundry.documents.BaseUser.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[updateSource](foundry.documents.BaseUser.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[validate](foundry.documents.BaseUser.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_getInnerModel](foundry.documents.BaseUser.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_initialize](foundry.documents.BaseUser.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_initializeSource](foundry.documents.BaseUser.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_onCreate](foundry.documents.BaseUser.md#_oncreate)
...
* \_preCreate(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_preCreate](foundry.documents.BaseUser.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_preDelete](foundry.documents.BaseUser.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_preUpdate](foundry.documents.BaseUser.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_preUpdateSource](foundry.documents.BaseUser.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_updateCommit](foundry.documents.BaseUser.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_addDataFieldMigration](foundry.documents.BaseUser.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_addDataFieldShim](foundry.documents.BaseUser.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_addDataFieldShims](foundry.documents.BaseUser.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_clearFieldsRecursively](foundry.documents.BaseUser.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_logDataFieldMigration](foundry.documents.BaseUser.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_preCleanData](foundry.documents.BaseUser.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[canUserCreate](foundry.documents.BaseUser.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[cleanData](foundry.documents.BaseUser.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[create](foundry.documents.BaseUser.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[createDocuments](foundry.documents.BaseUser.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â avatar: [FilePathField](foundry.data.fields.FilePathField.md);  
  Â Â Â Â character: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md);  
  ...
  Â Â Â Â hotbar: [ObjectField](foundry.data.fields.ObjectField.md);  
  Â Â Â Â name: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â password: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â passwordSalt: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â permissions: [ObjectField](foundry.data.fields.ObjectField.md);  
  Â Â Â Â pronouns: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â role: [NumberField](foundry.data.fields.NumberField.md);  
  }
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â avatar: [FilePathField](foundry.data.fields.FilePathField.md); Â Â Â Â character: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); Â Â Â Â color: [ColorField](foundry.data.fields.ColorField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â hotbar: [ObjectField](foundry.data.fields.ObjectField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â password: [StringField](foundry.data.fields.StringField.md); Â Â Â Â passwordSalt: [StringField](foundry.data.fields.StringField.md); Â Â Â Â permissions: [ObjectField](foundry.data.fields.ObjectField.md); Â Â Â Â pronouns: [StringField](foundry.data.fields.StringField.md); Â Â Â Â role: [NumberField](foundry.data.fields.NumberField.md); }
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[defineSchema](foundry.documents.BaseUser.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[deleteDocuments](foundry.documents.BaseUser.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[fromJSON](foundry.documents.BaseUser.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[fromSource](foundry.documents.BaseUser.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[get](foundry.documents.BaseUser.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[getCollectionName](foundry.documents.BaseUser.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[migrateData](foundry.documents.BaseUser.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[migrateDataSafe](foundry.documents.BaseUser.md#migratedatasafe)

### `Static`queryMany

* queryMany(  
  Â Â Â Â users: Iterable<[documents](../modules/foundry.documents.md).User, any, any>,  
  Â Â Â Â queryName: string,  
  Â Â Â Â queryData: object,  
  Â Â Â Â queryOptions?: { timeout?: number },  
  ): Promise<Map<[documents](../modules/foundry.documents.md).User, PromiseSettledResult<any>>>

  Query many Users.

  #### Parameters

  + users: Iterable<[documents](../modules/foundry.documents.md).User, any, any>

    The users that are queried.
  + queryName: string
  ...
  #### Returns Promise<Map<[documents](../modules/foundry.documents.md).User, PromiseSettledResult<any>>>
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[shimData](foundry.documents.BaseUser.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[updateDocuments](foundry.documents.BaseUser.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[validateJoint](foundry.documents.BaseUser.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_cleanData](foundry.documents.BaseUser.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_onCreateOperation](foundry.documents.BaseUser.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_onDeleteOperation](foundry.documents.BaseUser.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_onUpdateOperation](foundry.documents.BaseUser.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_preCreateOperation](foundry.documents.BaseUser.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_preDeleteOperation](foundry.documents.BaseUser.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseUser](foundry.documents.BaseUser.md).[\_preUpdateOperation](foundry.documents.BaseUser.md#_preupdateoperation)