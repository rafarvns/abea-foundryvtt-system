---
title: "DocumentSheetV2 | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.api.DocumentSheetV2.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.api.DocumentSheetV2))

* [ApplicationV2](foundry.applications.api.ApplicationV2.md)
  + DocumentSheetV2
    - [DocumentOwnershipConfig](foundry.applications.apps.DocumentOwnershipConfig.md)
    - [GridConfig](foundry.applications.apps.GridConfig.md)
    - [ActiveEffectConfig](foundry.applications.sheets.ActiveEffectConfig.md)
    - [ActorSheetV2](foundry.applications.sheets.ActorSheetV2.md)
    - [AdventureImporterV2](foundry.applications.sheets.AdventureImporterV2.md)
    - [CardConfig](foundry.applications.sheets.CardConfig.md)
    - [CardsConfig](foundry.applications.sheets.CardsConfig.md)
    - [CombatantConfig](foundry.applications.sheets.CombatantConfig.md)
    - [FolderConfig](foundry.applications.sheets.FolderConfig.md)
    - [ItemSheetV2](foundry.applications.sheets.ItemSheetV2.md)
    - [LevelConfig](foundry.applications.sheets.LevelConfig.md)
    - [MacroConfig](foundry.applications.sheets.MacroConfig.md)
    - [PlaceableConfig](foundry.applications.sheets.PlaceableConfig.md)
    - [PlaylistConfig](foundry.applications.sheets.PlaylistConfig.md)
    - [PlaylistSoundConfig](foundry.applications.sheets.PlaylistSoundConfig.md)
    - [RegionBehaviorConfig](foundry.applications.sheets.RegionBehaviorConfig.md)
    - [RollTableSheet](foundry.applications.sheets.RollTableSheet.md)
    - [SceneConfig](foundry.applications.sheets.SceneConfig.md)
    - [TableResultConfig](foundry.applications.sheets.TableResultConfig.md)
    - [UserConfig](foundry.applications.sheets.UserConfig.md)
    - [AdventureExporter](foundry.applications.sheets.AdventureExporter.md)
    - [BaseSheet](foundry.applications.sheets.BaseSheet.md)
    - [JournalEntryCategoryConfig](foundry.applications.sheets.journal.JournalEntryCategoryConfig.md)
    - [JournalEntryPageSheet](foundry.applications.sheets.journal.JournalEntryPageSheet.md)
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â configureOwnership: (  
Â Â Â Â Â Â Â Â Â Â Â Â this: DocumentSheetV2,  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â ) => void;  
Â Â Â Â Â Â Â Â configureSheet: (this: DocumentSheetV2, event: PointerEvent) => void;  
Â Â Â Â Â Â Â Â copyUuid: {  
Â Â Â Â Â Â Â Â Â Â Â Â buttons: number[];  
Â Â Â Â Â Â Â Â Â Â Â Â handler: (this: DocumentSheetV2, event: PointerEvent) => void;  
Â Â Â Â Â Â Â Â };  
Â Â Â Â Â Â Â Â editImage: (  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLElement,  
Â Â Â Â Â Â Â Â ) => void | Promise<void>;  
Â Â Â Â Â Â Â Â importDocument: (this: DocumentSheetV2) => Promise<any>;  
Â Â Â Â };  
Â Â Â Â canCreate: boolean;  
Â Â Â Â canImport: boolean;  
...
Â Â Â Â Â Â Â Â Â Â Â Â visible: (this: DocumentSheetV2) => boolean;  
Â Â Â Â Â Â Â Â }[];  
Â Â Â Â };  
} = ...
...
* \_getFrameButtons(options: any): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Overrides ApplicationV2.\_getFrameButtons
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<DocumentSheetV2>
