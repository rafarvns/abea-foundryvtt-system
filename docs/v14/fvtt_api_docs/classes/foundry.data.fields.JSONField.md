---
title: "JSONField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.JSONField.html"
category: "classes"
---

# Class JSONField

A special [foundry.data.fields.StringField](foundry.data.fields.StringField.md) which contains serialized JSON data.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.JSONField))
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & {  
  ...
  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { Â Â Â Â blank: boolean; Â Â Â Â choices: undefined; Â Â Â Â textSearch: boolean; Â Â Â Â trim: boolean; } & { Â Â Â Â blank: boolean; Â Â Â Â initial: undefined; Â Â Â Â trim: boolean; Â Â Â Â validationError: string; }
...
* clean(value: any, options: any, \_state: any): any
  ...
  Overrides [StringField](foundry.data.fields.StringField.md).[clean](foundry.data.fields.StringField.md#clean)
...
* toObject(value: any): any
  ...
  Overrides [StringField](foundry.data.fields.StringField.md).[toObject](foundry.data.fields.StringField.md#toobject)
