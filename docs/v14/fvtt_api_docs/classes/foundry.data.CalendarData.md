---
title: "CalendarData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.CalendarData.html"
category: "classes"
---

# Class CalendarData<Components>
...
* Components extends [TimeComponents](../interfaces/foundry.data.types.TimeComponents.md) = [TimeComponents](../interfaces/foundry.data.types.TimeComponents.md)

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.CalendarData))
...
[\_source](#_source)
[parent](#parent)
[\_DURATION\_FORMAT\_UNITS](#_duration_format_units)
[\_schema](#_schema)
...
[add](#add)
[clone](#clone)
[componentsToTime](#componentstotime)
[componentsToUnit](#componentstounit)
...
[reset](#reset)
[timeToComponents](#timetocomponents)
[toJSON](#tojson)
[toObject](#toobject)
[updateSource](#updatesource)
[validate](#validate)
[\_configure](#_configure)
[\_decomposeTimeYears](#_decomposetimeyears)
...
* new CalendarData<[Components](#constructorcalendardatacomponents) extends [TimeComponents](../interfaces/foundry.data.types.TimeComponents.md) = [TimeComponents](../interfaces/foundry.data.types.TimeComponents.md)>(  
  Â Â Â Â data?: object,  
  Â Â Â Â options?: [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md),  
  ): CalendarData<[Components](#components)>
  ...
  #### Returns CalendarData<[Components](#components)>
...
### `Static` `Internal`\_DURATION\_FORMAT\_UNITS

\_DURATION\_FORMAT\_UNITS: Set<  
Â Â Â Â "day"  
Â Â Â Â | "year"  
Â Â Â Â | "month"  
Â Â Â Â | "hour"  
...
[TimeComponents](../interfaces/foundry.data.types.TimeComponents.md) units usable in [CalendarData.formatDuration](#formatduration), sorted descendingly by order of
magnitude
...
Inherited from [DataModel](foundry.abstract.DataModel.md).[LOCALIZATION\_PREFIXES](foundry.abstract.DataModel.md#localization_prefixes)
...
* \_initialize(options?: {}): void
  ...
  Overrides [DataModel](foundry.abstract.DataModel.md).[\_initialize](foundry.abstract.DataModel.md#_initialize)

### add

* add(startTime: number | [Components](#components), deltaTime: number | [Components](#components)): [Components](#components)

  Modify some start time by adding a number of seconds or components to it. The delta components may be negative.

  #### Parameters

  + startTime: number | [Components](#components)

    The initial time
  + deltaTime: number | [Components](#components)
...
* componentsToTime(components: Partial<[Components](#components)>): number

  Convert a set of [TimeComponents](../interfaces/foundry.data.types.TimeComponents.md) into seconds.
...
* componentsToUnit(  
  Â Â Â Â components: Partial<[Components](#components)>,  
  Â Â Â Â unit: "day" | "year" | "month" | "hour" | "minute" | "second",  
  Â Â Â Â options?: { roundFn?: "round" | "ceil" | "floor" | "trunc" },  
  ): number

  Convert a partial set [TimeComponents](../interfaces/foundry.data.types.TimeComponents.md) into an integer of a provided unit.
  ...
  + components: Partial<[Components](#components)>
    ...
    An amount of time expressed as components
  + unit: "day" | "year" | "month" | "hour" | "minute" | "second"

    The unit to convert into
  + `Optional`options: { roundFn?: "round" | "ceil" | "floor" | "trunc" } = {}
    - ##### `Optional`roundFn?: "round" | "ceil" | "floor" | "trunc"

      The Math function to use in rounding a remainder

  #### Returns number

  The cumulative time in the requested units
...
* difference(  
  Â Â Â Â endTime: number | [Components](#components),  
  Â Â Â Â startTime?: number | [Components](#components),  
  ...
  + endTime: number | [Components](#components)

    A time to difference relative to the start time.
  + `Optional`startTime: number | [Components](#components)
...
* format(  
  Â Â Â Â time?: number | [Components](#components),  
  Â Â Â Â formatter?: string | [TimeFormatter](../types/foundry.data.types.TimeFormatter.md),  
  ...
  + `Optional`time: number | [Components](#components) = game.time.worldTime

    The time components to format, by default the current world time.
  + `Optional`formatter: string | [TimeFormatter](../types/foundry.data.types.TimeFormatter.md) = "timestamp"

    The formatter function applied to the time.
...
* onUpdateWorldTime(  
  ...
  + `Optional`options: object
    ...
    Options passed through the world time update operation
  + userId: string
...
* timeToComponents(time?: number): [Components](#components)
...
### `Protected`\_decomposeTimeYears

* \_decomposeTimeYears(time: number): number
...
* defineSchema(): {  
  Â Â Â Â days: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â description: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â months: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â name: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â seasons: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â years: [SchemaField](foundry.data.fields.SchemaField.md);  
  }
  ...
  #### Returns { Â Â Â Â days: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â description: [StringField](foundry.data.fields.StringField.md); Â Â Â Â months: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â seasons: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â years: [SchemaField](foundry.data.fields.SchemaField.md); }
