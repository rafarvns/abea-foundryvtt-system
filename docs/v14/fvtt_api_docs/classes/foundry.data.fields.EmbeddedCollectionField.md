---
title: "EmbeddedCollectionField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.EmbeddedCollectionField.html"
category: "classes"
---

# Class EmbeddedCollectionField

A subclass of [foundry.data.fields.ArrayField](foundry.data.fields.ArrayField.md) which supports an embedded Document collection.
Invalid elements will be dropped from the collection during validation rather than failing for the field entirely.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.EmbeddedCollectionField))

* [ArrayField](foundry.data.fields.ArrayField.md)
  + EmbeddedCollectionField
    - [EmbeddedCollectionDeltaField](foundry.data.fields.EmbeddedCollectionDeltaField.md)
...
* new EmbeddedCollectionField(  
  ...
  #### Returns EmbeddedCollectionField
...
Overrides [ArrayField](foundry.data.fields.ArrayField.md).[hierarchical](foundry.data.fields.ArrayField.md#hierarchical)
...
* get implementation(): typeof [EmbeddedCollection](foundry.abstract.EmbeddedCollection.md)

  The Collection implementation to use when initializing the collection.

  #### Returns typeof [EmbeddedCollection](foundry.abstract.EmbeddedCollection.md)
...
* \_cast(value: any): any[]
  ...
  Overrides [ArrayField](foundry.data.fields.ArrayField.md).[\_cast](foundry.data.fields.ArrayField.md#_cast)
...
* \_cleanElement(value: any, options: any, \_state: any): object
  ...
  Overrides [ArrayField](foundry.data.fields.ArrayField.md).[\_cleanElement](foundry.data.fields.ArrayField.md#_cleanelement)
...
* \_cleanType(value: any, options: any, \_state: any): any
  ...
  Overrides [ArrayField](foundry.data.fields.ArrayField.md).[\_cleanType](foundry.data.fields.ArrayField.md#_cleantype)
...
* \_updateCommit(source: any, key: any, value: any, diff: any, options: any): void
  ...
  Overrides [ArrayField](foundry.data.fields.ArrayField.md).[\_updateCommit](foundry.data.fields.ArrayField.md#_updatecommit)
...
* \_updateDiff(key: any, value: any, options: any, state: any): void
  ...
  Overrides [ArrayField](foundry.data.fields.ArrayField.md).[\_updateDiff](foundry.data.fields.ArrayField.md#_updatediff)
...
* \_validateRecursive(value: any, options: any): void
  ...
  Overrides [ArrayField](foundry.data.fields.ArrayField.md).[\_validateRecursive](foundry.data.fields.ArrayField.md#_validaterecursive)
...
* apply(fn: any, value?: any[], options?: {}): {}[]
  ...
  Overrides [ArrayField](foundry.data.fields.ArrayField.md).[apply](foundry.data.fields.ArrayField.md#apply)
...
* toObject(value: any): any
  ...
  Overrides [ArrayField](foundry.data.fields.ArrayField.md).[toObject](foundry.data.fields.ArrayField.md#toobject)
...
* \_commitElement(  
  Â Â Â Â obj: object,  
  Â Â Â Â src: object[],  
  Â Â Â Â existing: Record<string, object>,  
  Â Â Â Â changed: Record<string, object>,  
...
* \_updateElement(  
  Â Â Â Â v: object,  
  Â Â Â Â existingSource: object | undefined,  
  Â Â Â Â ctx: [EmbeddedCollectionUpdateContext](../interfaces/foundry.data.types.EmbeddedCollectionUpdateContext.md),  
  ): void
  ...
  [EmbeddedCollectionDeltaField](foundry.data.fields.EmbeddedCollectionDeltaField.md)) a tombstone marking a deletion. Subclasses may override this method to
  ...
  + existingSource: object | undefined

    The existing source record matched by `_id`, if any.
  + ctx: [EmbeddedCollectionUpdateContext](../interfaces/foundry.data.types.EmbeddedCollectionUpdateContext.md)
...
* \_handleValidationFailure(  
  ...
  Overrides [ArrayField](foundry.data.fields.ArrayField.md).[\_handleValidationFailure](foundry.data.fields.ArrayField.md#_handlevalidationfailure)
...
* \_validateElementType(element: any): any
  ...
  Overrides [ArrayField](foundry.data.fields.ArrayField.md).[\_validateElementType](foundry.data.fields.ArrayField.md#_validateelementtype)