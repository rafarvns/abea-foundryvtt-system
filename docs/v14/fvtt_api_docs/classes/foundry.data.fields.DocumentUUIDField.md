---
title: "DocumentUUIDField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.DocumentUUIDField.html"
category: "classes"
---

# Class DocumentUUIDField

A subclass of [foundry.data.fields.StringField](foundry.data.fields.StringField.md) which supports referencing some other Document by its UUID.
This field may not be blank, but may be null to indicate that no UUID is referenced.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.DocumentUUIDField))
...
* new DocumentUUIDField(  
  Â Â Â Â options?: [DocumentUUIDFieldOptions](../types/foundry.data.types.DocumentUUIDFieldOptions.md),  
  Â Â Â Â context?: [DataFieldContext](../interfaces/foundry.data.types.DataFieldContext.md),  
  ): DocumentUUIDField

  #### Parameters

  + `Optional`options: [DocumentUUIDFieldOptions](../types/foundry.data.types.DocumentUUIDFieldOptions.md)
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & {  
  ...
  Â Â Â Â blank: boolean;  
  Â Â Â Â embedded: undefined;  
  Â Â Â Â initial: null;  
  Â Â Â Â nullable: boolean;  
  Â Â Â Â relative: boolean;  
  Â Â Â Â required: boolean;  
  Â Â Â Â type: undefined;  
  }

  Default parameters for this field type

  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { Â Â Â Â blank: boolean; Â Â Â Â choices: undefined; Â Â Â Â textSearch: boolean; Â Â Â Â trim: boolean; } & { Â Â Â Â blank: boolean; Â Â Â Â embedded: undefined; Â Â Â Â initial: null; Â Â Â Â nullable: boolean; Â Â Â Â relative: boolean; Â Â Â Â required: boolean; Â Â Â Â type: undefined; }
...
* \_cleanType(value: any, options: any, state: any): any
  ...
  Overrides [StringField](foundry.data.fields.StringField.md).[\_cleanType](foundry.data.fields.StringField.md#_cleantype)
...
* \_toInput(config: any): [HTMLDocumentTagsElement](foundry.applications.elements.HTMLDocumentTagsElement.md)

  #### Parameters

  + config: any

  #### Returns [HTMLDocumentTagsElement](foundry.applications.elements.HTMLDocumentTagsElement.md)
