---
title: "PointSoundSource | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.sources.PointSoundSource.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.sources.PointSoundSource))
...
* new PointSoundSource(options?: [BaseEffectSourceOptions](../interfaces/foundry.canvas.sources.types.BaseEffectSourceOptions.md)): PointSoundSource
...
* getVolumeMultiplier(  
  Â Â Â Â listener: [ElevatedPoint](../interfaces/foundry.types.ElevatedPoint.md),  
  Â Â Â Â options?: { easing?: boolean },  
  ): number
  ...
  + listener: [ElevatedPoint](../interfaces/foundry.types.ElevatedPoint.md)
  + `Optional`options: { easing?: boolean } = {}
