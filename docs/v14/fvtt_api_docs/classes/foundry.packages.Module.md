---
title: "Module | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.packages.Module.html"
category: "classes"
---
...
* [foundry.packages.types.ModuleManifestData](../interfaces/foundry.packages.types.ModuleManifestData.md) For the module.json schema
* [foundry.ClientPackage](foundry.ClientPackage.md)

#### Hierarchy ([View Summary](../hierarchy.md#foundry.packages.Module))

* [BaseModule](foundry.packages.BaseModule.md)<this>
  + Module
...
\_source: [ModuleManifestData](../interfaces/foundry.packages.types.ModuleManifestData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_source](foundry.packages.BaseModule.md#_source)
...
Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_unknownKeys](foundry.packages.BaseModule.md#_unknownkeys)
...
Inherited from [BaseModule](foundry.packages.BaseModule.md).[availability](foundry.packages.BaseModule.md#availability)
...
Inherited from [BaseModule](foundry.packages.BaseModule.md).[exclusive](foundry.packages.BaseModule.md#exclusive)
...
Inherited from [BaseModule](foundry.packages.BaseModule.md).[hasStorage](foundry.packages.BaseModule.md#hasstorage)
...
Inherited from [BaseModule](foundry.packages.BaseModule.md).[locked](foundry.packages.BaseModule.md#locked)
...
Inherited from [BaseModule](foundry.packages.BaseModule.md).[owned](foundry.packages.BaseModule.md#owned)
...
Inherited from [BaseModule](foundry.packages.BaseModule.md).[parent](foundry.packages.BaseModule.md#parent)
...
Inherited from [BaseModule](foundry.packages.BaseModule.md).[tags](foundry.packages.BaseModule.md#tags)
...
Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_schema](foundry.packages.BaseModule.md#_schema)
...
Inherited from [BaseModule](foundry.packages.BaseModule.md).[icon](foundry.packages.BaseModule.md#icon)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseModule](foundry.packages.BaseModule.md).[LOCALIZATION\_PREFIXES](foundry.packages.BaseModule.md#localization_prefixes)

### `Static`type

type: string = "module"

Inherited from [BaseModule](foundry.packages.BaseModule.md).[type](foundry.packages.BaseModule.md#type)
...
* get collection(): string
  ...
  Inherited from ClientPackageMixin(BaseModule).collection
...
* \_initializeSource(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_initializeSource](foundry.packages.BaseModule.md#_initializesource)

### \_testRequiredDependencies

* \_testRequiredDependencies(  
  Â Â Â Â modulesCollection: [Collection](foundry.utils.Collection.md)<string, Module>,  
  ): Promise<boolean>
  ...
  + modulesCollection: [Collection](foundry.utils.Collection.md)<string, Module>
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_testRequiredDependencies](foundry.packages.BaseModule.md#_testrequireddependencies)
...
* \_testSupportedSystems(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_testSupportedSystems](foundry.packages.BaseModule.md#_testsupportedsystems)
...
* clone(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[clone](foundry.packages.BaseModule.md#clone)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[getFieldForProperty](foundry.packages.BaseModule.md#getfieldforproperty)
...
* reset(): void
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[reset](foundry.packages.BaseModule.md#reset)
...
* toJSON(): object
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[toJSON](foundry.packages.BaseModule.md#tojson)
...
* toObject(source?: boolean): object
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[toObject](foundry.packages.BaseModule.md#toobject)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[updateSource](foundry.packages.BaseModule.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[validate](foundry.packages.BaseModule.md#validate)
...
* \_configure(options?: object): void
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_configure](foundry.packages.BaseModule.md#_configure)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_getInnerModel](foundry.packages.BaseModule.md#_getinnermodel)
...
* \_initializationOrder(): Generator<[string, [DataField](foundry.data.fields.DataField.md)], any, any>
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_initializationOrder](foundry.packages.BaseModule.md#_initializationorder)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_initialize](foundry.packages.BaseModule.md#_initialize)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_preUpdateSource](foundry.packages.BaseModule.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_updateCommit](foundry.packages.BaseModule.md#_updatecommit)
...
* \_updateDiff(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_updateDiff](foundry.packages.BaseModule.md#_updatediff)
...
* \_cleanData(data: any, \_options: any, \_state: any): void
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_cleanData](foundry.packages.BaseModule.md#_cleandata)
...
* \_logWarning(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_logWarning](foundry.packages.BaseModule.md#_logwarning)
...
* \_migrateStyles(data: [PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md)): void
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_migrateStyles](foundry.packages.BaseModule.md#_migratestyles)
...
* cleanData(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[cleanData](foundry.packages.BaseModule.md#cleandata)
...
* defineSchema(): {  
  ...
  Â Â Â Â coreTranslation: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â documentTypes: [AdditionalTypesField](foundry.packages.AdditionalTypesField.md);  
  Â Â Â Â library: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â quickstart: [SchemaField](foundry.data.fields.SchemaField.md);  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[defineSchema](foundry.packages.BaseModule.md#defineschema)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[fromJSON](foundry.packages.BaseModule.md#fromjson)
...
* fromRemoteManifest(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[fromRemoteManifest](foundry.packages.BaseModule.md#fromremotemanifest)
...
* fromSource(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[fromSource](foundry.packages.BaseModule.md#fromsource)
...
* isIncompatibleWithCoreVersion(availability: number): boolean
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[isIncompatibleWithCoreVersion](foundry.packages.BaseModule.md#isincompatiblewithcoreversion)
...
* migrateData(data: any, options: any): object
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[migrateData](foundry.packages.BaseModule.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[migrateDataSafe](foundry.packages.BaseModule.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[shimData](foundry.packages.BaseModule.md#shimdata)
...
* testAvailability(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[testAvailability](foundry.packages.BaseModule.md#testavailability)
...
* testDependencyCompatibility(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[testDependencyCompatibility](foundry.packages.BaseModule.md#testdependencycompatibility)
...
* validateId(id: string): void
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[validateId](foundry.packages.BaseModule.md#validateid)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[validateJoint](foundry.packages.BaseModule.md#validatejoint)
...
* validateVersion(version: string): void
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[validateVersion](foundry.packages.BaseModule.md#validateversion)
...
* \_preCleanData(  
  ...
  Inherited from [BaseModule](foundry.packages.BaseModule.md).[\_preCleanData](foundry.packages.BaseModule.md#_precleandata)