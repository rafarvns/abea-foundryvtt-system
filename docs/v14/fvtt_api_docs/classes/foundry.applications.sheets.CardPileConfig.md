---
title: "CardPileConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.CardPileConfig.html"
category: "classes"
---

# Class CardPileConfig

A subclass of CardsConfig providing a sheet representation for Cards documents with the "pile" type.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.CardPileConfig))
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<CardPileConfig>
  ...
  #### Returns Promise<CardPileConfig>
