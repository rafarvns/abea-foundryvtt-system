---
title: "AdventureImporterV2 | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.AdventureImporterV2.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.AdventureImporterV2))

* [DocumentSheetV2](foundry.applications.api.DocumentSheetV2.md)<this>
  + AdventureImporterV2
...
[\_configureImport](#_configureimport)
...
[\_prepareImportOptionsSchema](#_prepareimportoptionsschema)
...
* get adventure(): [documents](../modules/foundry.documents.md).[Adventure](foundry.documents.Adventure.md)

  A convenience alias for AdventureImporter#document

  #### Returns [documents](../modules/foundry.documents.md).[Adventure](foundry.documents.Adventure.md)
...
* \_configureImport(importOptions: [AdventureImportOptions](../interfaces/foundry.documents.types.AdventureImportOptions.md)): Promise<void>
  ...
  + importOptions: [AdventureImportOptions](../interfaces/foundry.documents.types.AdventureImportOptions.md)
...
* \_onImport(  
  Â Â Â Â importResult: [AdventureImportResult](../interfaces/foundry.documents.types.AdventureImportResult.md),  
  Â Â Â Â importOptions: [AdventureImportOptions](../interfaces/foundry.documents.types.AdventureImportOptions.md),  
  ): Promise<void>
  ...
  + importResult: [AdventureImportResult](../interfaces/foundry.documents.types.AdventureImportResult.md)
  + importOptions: [AdventureImportOptions](../interfaces/foundry.documents.types.AdventureImportOptions.md)
...
* \_preImport(  
  Â Â Â Â importData: [AdventureImportData](../interfaces/foundry.documents.types.AdventureImportData.md),  
  Â Â Â Â importOptions: [AdventureImportOptions](../interfaces/foundry.documents.types.AdventureImportOptions.md),  
  ): Promise<void>
  ...
  + importData: [AdventureImportData](../interfaces/foundry.documents.types.AdventureImportData.md)
  + importOptions: [AdventureImportOptions](../interfaces/foundry.documents.types.AdventureImportOptions.md)
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â buttons: { disabled: boolean; icon: string; label: string; type: string }[];  
  ...
  Â Â Â Â Â Â Â Â loading: boolean;  
  Â Â Â Â Â Â Â Â optionsSchema: [SchemaField](foundry.data.fields.SchemaField.md) | undefined;  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â [ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md) & { Â Â Â Â Â Â Â Â document: ClientDocument; Â Â Â Â Â Â Â Â editable: boolean; Â Â Â Â Â Â Â Â fields: any; Â Â Â Â Â Â Â Â model: ClientDocument; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â source: any; Â Â Â Â Â Â Â Â user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) Â Â Â Â Â Â Â Â | null; Â Â Â Â } & { Â Â Â Â Â Â Â Â adventure: [documents](../modules/foundry.documents.md).[Adventure](foundry.documents.Adventure.md); Â Â Â Â Â Â Â Â buttons: { disabled: boolean; icon: string; label: string; type: string }[]; Â Â Â Â Â Â Â Â contents: { count: number; icon: string; label: string }[]; Â Â Â Â Â Â Â Â description: string; Â Â Â Â Â Â Â Â imported: boolean; Â Â Â Â Â Â Â Â loading: boolean; Â Â Â Â Â Â Â Â optionsSchema: [SchemaField](foundry.data.fields.SchemaField.md) | undefined; Â Â Â Â }, >
...
* close(  
  ...
  #### Returns Promise<AdventureImporterV2>
...
* \_prepareImportOptionsSchema(  
  ...
  ): [SchemaField](foundry.data.fields.SchemaField.md) | undefined
  ...
  #### Returns [SchemaField](foundry.data.fields.SchemaField.md) | undefined
