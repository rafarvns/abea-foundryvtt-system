---
title: "BaselineIlluminationSamplerShader | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.rendering.shaders.BaselineIlluminationSamplerShader.html"
category: "classes"
---

# Class BaselineIlluminationSamplerShader

Compute baseline illumination according to darkness level encoded texture.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.rendering.shaders.BaselineIlluminationSamplerShader))
...
* get defaultUniforms(): {  
  ...
  #### Returns { Â Â Â Â ambientDarkness: number[]; Â Â Â Â ambientDaylight: number[]; Â Â Â Â sampler: null; Â Â Â Â tintAlpha: number[]; }
