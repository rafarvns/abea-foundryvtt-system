---
title: "ShowToPlayersDialog | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.journal.ShowToPlayersDialog.html"
category: "classes"
---

# Class ShowToPlayersDialog
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.journal.ShowToPlayersDialog))

* [DialogV2](foundry.applications.api.DialogV2.md)<this>
  + ShowToPlayersDialog
...
* new ShowToPlayersDialog(  
  Â Â Â Â options?: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [DialogV2Configuration](../interfaces/foundry.DialogV2Configuration.md)>,  
  ): ShowToPlayersDialog
  ...
  + `Optional`options: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [DialogV2Configuration](../interfaces/foundry.DialogV2Configuration.md)> = {}

    Options used to configure the Application instance

  #### Returns ShowToPlayersDialog
...
options: Readonly<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [DialogV2Configuration](../interfaces/foundry.DialogV2Configuration.md)>
...
Inherited from HandlebarsApplicationMixin(DialogV2).\_appId
...
Inherited from HandlebarsApplicationMixin(DialogV2).\_maxZ
...
Inherited from HandlebarsApplicationMixin(DialogV2).BASE\_APPLICATION

### `Static`DEFAULT\_OPTIONS

DEFAULT\_OPTIONS: {  
Â Â Â Â buttons: { default: boolean; icon: string; label: string; type: string }[];  
Â Â Â Â classes: string[];  
Â Â Â Â form: {  
Â Â Â Â Â Â Â Â closeOnSubmit: boolean;  
Â Â Â Â Â Â Â Â handler: (  
Â Â Â Â Â Â Â Â Â Â Â Â this: ShowToPlayersDialog,  
Â Â Â Â Â Â Â Â Â Â Â Â event: SubmitEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â form: HTMLFormElement,  
Â Â Â Â Â Â Â Â Â Â Â Â formData: FormDataExtended,  
Â Â Â Â Â Â Â Â ) => Promise<void>;  
Â Â Â Â };  
Â Â Â Â modal: boolean;  
Â Â Â Â position: { width: number };  
Â Â Â Â window: { contentClasses: string[]; contentTag: string };  
} = ...

Overrides HandlebarsApplicationMixin(DialogV2).DEFAULT\_OPTIONS

### `Static`emittedEvents

emittedEvents: readonly ["prerender", "render", "close", "position"] = ...

Inherited from HandlebarsApplicationMixin(DialogV2).emittedEvents

### `Static`PARTS

PARTS: {  
Â Â Â Â body: { classes: string[]; template: string };  
Â Â Â Â footer: { template: string };  
} = ...

Overrides HandlebarsApplicationMixin(DialogV2).PARTS
...
Inherited from HandlebarsApplicationMixin(DialogV2).RENDER\_STATES
...
Inherited from HandlebarsApplicationMixin(DialogV2).TABS
...
* \_awaitTransition(element: HTMLElement, timeout: number): Promise<void>
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).\_awaitTransition
...
* \_canDetach(): boolean
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).\_canDetach
...
* \_doEvent(  
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).\_doEvent
...
* attachWindow(  
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).attachWindow
...
* close(  
  ...
  #### Returns Promise<ShowToPlayersDialog>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<ShowToPlayersDialog>
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).detachWindow
...
* renderChild(  
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).renderChild
...
* \_canAttach(): boolean
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).\_canAttach
...
* \_getFrameButtons(  
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).\_getFrameButtons
...
* \_headerControlContextEntries(): Generator<[ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md), void, any>
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).\_headerControlContextEntries
...
* \_onAttach(from: Document, to: Document): void
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).\_onAttach
...
* \_onDetach(from: Document, to: Document): void
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).\_onDetach
...
* \_onSubmit(  
  ...
  ): Promise<[DialogV2](foundry.applications.api.DialogV2.md)>
  ...
  #### Returns Promise<[DialogV2](foundry.applications.api.DialogV2.md)>
...
* \_postRender(  
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).\_postRender
...
* \_refit(positionUpdate?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).\_refit
...
* \_renderFrameButtons(options: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<void>
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).\_renderFrameButtons
...
* \_handleQuery(  
  ...
  Â Â Â Â Â Â Â Â type: "input" | "prompt" | "confirm" | "wait";  
  Â Â Â Â },  
  ): Promise<any>
  ...
  + \_\_namedParameters: { config: object; type: "input" | "prompt" | "confirm" | "wait" }
...
* confirm(  
  ...
  Â Â Â Â Â Â Â Â [ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [DialogV2Configuration](../interfaces/foundry.DialogV2Configuration.md) & [DialogV2WaitOptions](../interfaces/foundry.DialogV2WaitOptions.md),  
  Â Â Â Â >,  
  ): Promise<any>
  ...
  + `Optional`config: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [DialogV2Configuration](../interfaces/foundry.DialogV2Configuration.md) & [DialogV2WaitOptions](../interfaces/foundry.DialogV2WaitOptions.md)> = {}
    - ##### yes
...
* inheritanceChain(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), void, unknown>
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).inheritanceChain
...
* instances(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), any, any>
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).instances
...
* parseCSSDimension(style: string, parentDimension: number): number | void
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).parseCSSDimension
...
* query(  
  Â Â Â Â user: any,  
  Â Â Â Â type: "input" | "prompt" | "confirm" | "wait",  
  ...
  + [DialogV2.prompt](foundry.applications.api.DialogV2.md#prompt)
  + [DialogV2.confirm](foundry.applications.api.DialogV2.md#confirm)
  + [DialogV2.input](foundry.applications.api.DialogV2.md#input)
  + [DialogV2.wait](foundry.applications.api.DialogV2.md#wait)
...
* waitForImages(element: HTMLElement): Promise<void>
  ...
  Inherited from HandlebarsApplicationMixin(DialogV2).waitForImages

### `Protected` `Static`\_onClickButton

* \_onClickButton(  
  Â Â Â Â this: [DialogV2](foundry.applications.api.DialogV2.md),  
  ...
  + this: [DialogV2](foundry.applications.api.DialogV2.md)
  + event: PointerEvent
