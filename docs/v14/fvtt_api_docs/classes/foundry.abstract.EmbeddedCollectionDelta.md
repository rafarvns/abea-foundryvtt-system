---
title: "EmbeddedCollectionDelta | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.abstract.EmbeddedCollectionDelta.html"
category: "classes"
---

# Class EmbeddedCollectionDelta<TDocument>
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.abstract.EmbeddedCollectionDelta))
...
* new EmbeddedCollectionDelta<[TDocument](#constructorembeddedcollectiondeltatdocument) extends Document>(  
  Â Â Â Â name: string,  
  ...
  ): EmbeddedCollectionDelta<[TDocument](#tdocument)>
  ...
  #### Returns EmbeddedCollectionDelta<[TDocument](#tdocument)>
...
* get baseCollection(): [EmbeddedCollection](foundry.abstract.EmbeddedCollection.md)<any>

  A convenience getter to return the corresponding base collection.

  #### Returns [EmbeddedCollection](foundry.abstract.EmbeddedCollection.md)<any>
...
* get documentName(): string | void
  ...
  Inherited from [EmbeddedCollection](foundry.abstract.EmbeddedCollection.md).[documentName](foundry.abstract.EmbeddedCollection.md#documentname)
...
* get syntheticCollection(): [EmbeddedCollection](foundry.abstract.EmbeddedCollection.md)<any>
...
* \_delete(key: any, \_\_namedParameters?: { restoreDelta?: boolean }): void

  #### Parameters

  + key: any
  + \_\_namedParameters: { restoreDelta?: boolean } = {}
...
* \_set(key: any, value: any, \_\_namedParameters?: { restoreDelta?: boolean }): void
...
* createDocument(  
  Â Â Â Â data: any,  
  Â Â Â Â context?: {},  
  ): [Document](foundry.abstract.Document.md)<object, { pack: any; parent: any; parentCollection: string }>
  ...
  #### Returns [Document](foundry.abstract.Document.md)<object, { pack: any; parent: any; parentCollection: string }>

  Overrides [EmbeddedCollection](foundry.abstract.EmbeddedCollection.md).[createDocument](foundry.abstract.EmbeddedCollection.md#createdocument)

### delete

* delete(key: any, options?: {}): boolean
  ...
  Overrides [EmbeddedCollection](foundry.abstract.EmbeddedCollection.md).[delete](foundry.abstract.EmbeddedCollection.md#delete)
...
* every(  
  ...
  Â Â Â Â Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, string>,  
  Â Â Â Â ) => boolean,  
  ): boolean
  ...
  + condition: (element: string, index: number, set: [Collection](foundry.utils.Collection.md)<string, string>) => boolean
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: string,  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, string>,  
  Â Â Â Â ) => unknown,  
  ): string[]
  ...
  + condition: (  
    ...
    Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, string>,  
    ) => unknown
...
* forEach(fn: (value: string, index: number) => void): void
...
* get(id: string, options?: { invalid?: boolean; strict?: boolean }): string
...
* getInvalid(id: string, options?: { strict?: boolean }): string | void
...
* getName(name: string, options?: { strict?: boolean }): string | undefined
...
* initialize(\_\_namedParameters?: { full?: boolean }): void

  #### Parameters

  + \_\_namedParameters: { full?: boolean } = {}

  #### Returns void

  Overrides [EmbeddedCollection](foundry.abstract.EmbeddedCollection.md).[initialize](foundry.abstract.EmbeddedCollection.md#initialize)
...
* map<[U](#mapu)>(  
  ...
  + transformer: (element: string, index: number, collection: [Collection](foundry.utils.Collection.md)<string, string>) => [U](foundry.abstract.EmbeddedCollection.md#mapu)
...
* restoreDocument(id: string): Promise<[TDocument](#tdocument)>
...
* restoreDocuments(ids: string[]): Promise<[TDocument](#tdocument)[]>
...
* set(key: any, value: any, options?: {}): EmbeddedCollectionDelta<[TDocument](#tdocument)>
