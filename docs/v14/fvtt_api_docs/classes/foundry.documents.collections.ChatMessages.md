---
title: "ChatMessages | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.collections.ChatMessages.html"
category: "classes"
---
...
* [foundry.documents.ChatMessage](foundry.documents.ChatMessage.md): The ChatMessage document
* [foundry.applications.sidebar.tabs.ChatLog](foundry.applications.sidebar.tabs.ChatLog.md): The ChatLog sidebar directory

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.collections.ChatMessages))
...
* get directory(): [ChatLog](foundry.applications.sidebar.tabs.ChatLog.md)

  #### Returns [ChatLog](foundry.applications.sidebar.tabs.ChatLog.md)
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)
...
* every(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â element: [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)>,  
  Â Â Â Â ) => boolean,  
  ): boolean
  ...
  + condition: (  
    Â Â Â Â element: [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md),  
    Â Â Â Â index: number,  
    Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)>,  
    ) => boolean
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)>,  
  Â Â Â Â ) => unknown,  
  ): [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md) | undefined
  ...
  #### Returns [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md) | undefined
...
* forEach(fn: (value: [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md), index: number) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md), index: number) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md),  
  ...
  + document: object | [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)
...
* getInvalid(  
  ...
  ): void | [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)
  ...
  #### Returns void | [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)
...
* render(force?: boolean): void
  ...
  Overrides [WorldCollection](foundry.documents.abstract.WorldCollection.md).[render](foundry.documents.abstract.WorldCollection.md#render)

### sayBubble

* sayBubble(message: [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)): void
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)[]
...
* set(id: string, document: [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)): ChatMessages

  #### Parameters

  + id: string
  + document: [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)
