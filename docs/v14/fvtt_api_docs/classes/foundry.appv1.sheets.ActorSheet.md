---
title: "ActorSheet | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.appv1.sheets.ActorSheet.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.appv1.sheets.ActorSheet))
...
[\_onConfigureToken](#_onconfiguretoken)
[\_onDragStart](#_ondragstart)
[\_onDrop](#_ondrop)
[\_onDropItemCreate](#_ondropitemcreate)
[\_onResize](#_onresize)
...
* \_getSubmitData(updateData?: {}): object
  ...
  Overrides [DocumentSheet](foundry.appv1.api.DocumentSheet.md).[\_getSubmitData](foundry.appv1.api.DocumentSheet.md#_getsubmitdata)
...
* \_onDropItemCreate(  
  Â Â Â Â itemData: object | object[],  
...
* \_updateObject(\_event: any, formData: any): Promise<any>
  ...
  Inherited from [DocumentSheet](foundry.appv1.api.DocumentSheet.md).[\_updateObject](foundry.appv1.api.DocumentSheet.md#_updateobject)
...
* activateListeners(html: any): void
  ...
  Inherited from [DocumentSheet](foundry.appv1.api.DocumentSheet.md).[activateListeners](foundry.appv1.api.DocumentSheet.md#activatelisteners)
...
* \_onDropActiveEffect(  
  Â Â Â Â event: DragEvent,  
  Â Â Â Â data: object,  
  ): Promise<boolean | [documents](../modules/foundry.documents.md).[ActiveEffect](foundry.documents.ActiveEffect.md)>
  ...
  #### Returns Promise<boolean | [documents](../modules/foundry.documents.md).[ActiveEffect](foundry.documents.ActiveEffect.md)>
...
* \_onDropActor(event: DragEvent, data: object): Promise<boolean | object>
  ...
  A data object which describes the result of the drop, or false if the drop was
  not permitted.

### `Protected`\_onDropFolder

* \_onDropFolder(event: DragEvent, data: object): Promise<[documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)[]>
...
* \_onDropItem(event: DragEvent, data: object): Promise<boolean | [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)[]>
  ...
  #### Returns Promise<boolean | [documents](../modules/foundry.documents.md).[Item](foundry.documents.Item.md)[]>
