---
title: "WorldConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.apps.WorldConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.apps.WorldConfig))
...
* new WorldConfig(  
  Â Â Â Â options: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md)> & [WorldConfigOptions](../interfaces/foundry.WorldConfigOptions.md),  
  ): WorldConfig

  #### Parameters

  + options: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md)> & [WorldConfigOptions](../interfaces/foundry.WorldConfigOptions.md)
...
PARTS: {  
Â Â Â Â config: { scrollable: string[]; template: string };  
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â inWorld: boolean;  
  Â Â Â Â Â Â Â Â nextSession: string;  
  Â Â Â Â Â Â Â Â rootId: string;  
  Â Â Â Â Â Â Â Â source: [WorldManifestData](../interfaces/foundry.packages.types.WorldManifestData.md);  
  Â Â Â Â Â Â Â Â themes: {};  
  Â Â Â Â Â Â Â Â worldId: string;  
  Â Â Â Â Â Â Â Â worldKbUrl: string;  
  Â Â Â Â Â Â Â Â worldTitle: string;  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â buttons: { Â Â Â Â Â Â Â Â Â Â Â Â cssClass: string; Â Â Â Â Â Â Â Â Â Â Â Â icon: string; Â Â Â Â Â Â Â Â Â Â Â Â label: string; Â Â Â Â Â Â Â Â Â Â Â Â type: string; Â Â Â Â Â Â Â Â }[]; Â Â Â Â Â Â Â Â fields: [DataSchema](../types/foundry.abstract.types.DataSchema.md); Â Â Â Â Â Â Â Â inWorld: boolean; Â Â Â Â Â Â Â Â nextSession: string; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â source: [WorldManifestData](../interfaces/foundry.packages.types.WorldManifestData.md); Â Â Â Â Â Â Â Â themes: {}; Â Â Â Â Â Â Â Â worldId: string; Â Â Â Â Â Â Â Â worldKbUrl: string; Â Â Â Â Â Â Â Â worldTitle: string; Â Â Â Â }, >
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<WorldConfig>
...
* detachWindow(options?: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<WorldConfig>
