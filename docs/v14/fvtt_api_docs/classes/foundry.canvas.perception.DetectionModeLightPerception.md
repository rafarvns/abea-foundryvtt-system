---
title: "DetectionModeLightPerception | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.perception.DetectionModeLightPerception.html"
category: "classes"
---

# Class DetectionModeLightPerception
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.perception.DetectionModeLightPerception))
...
* new DetectionModeLightPerception(  
  ...
  #### Returns DetectionModeLightPerception
...
* \_testPoint(visionSource: any, mode: any, target: any, test: any): boolean
  ...
  Overrides [DetectionMode](foundry.canvas.perception.DetectionMode.md).[\_testPoint](foundry.canvas.perception.DetectionMode.md#_testpoint)
...
* getDetectionFilter(): Filter | undefined
  ...
  Inherited from [DetectionMode](foundry.canvas.perception.DetectionMode.md).[getDetectionFilter](foundry.canvas.perception.DetectionMode.md#getdetectionfilter)
