---
title: "DocumentIdField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.DocumentIdField.html"
category: "classes"
---

# Class DocumentIdField

A subclass of [foundry.data.fields.StringField](foundry.data.fields.StringField.md) which provides the primary \_id for a Document.
The field may be initially null, but it must be non-null when it is saved to the database.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.DocumentIdField))
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & {  
  ...
  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { Â Â Â Â blank: boolean; Â Â Â Â choices: undefined; Â Â Â Â textSearch: boolean; Â Â Â Â trim: boolean; } & { Â Â Â Â blank: boolean; Â Â Â Â nullable: boolean; Â Â Â Â readonly: boolean; Â Â Â Â required: boolean; Â Â Â Â validationError: string; }
