---
title: "Players | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.ui.Players.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.ui.Players))
...
[\_doEvent](#_doevent)
[\_onChangeIdleStatus](#_onchangeidlestatus)
...
[\_formatName](#_formatname)
[\_getContextMenuOptions](#_getcontextmenuoptions)
...
* new Players(options?: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md)>): Players
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: { expand: (this: Players) => void };  
...
* \_onChangeIdleStatus(user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md), row?: HTMLLIElement): void
  ...
  + `Optional`row: HTMLLIElement

    The User's row in the application DOM
...
* \_prepareContext(  
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â active: { Â Â Â Â Â Â Â Â Â Â Â Â border: any; Â Â Â Â Â Â Â Â Â Â Â Â color: any; Â Â Â Â Â Â Â Â Â Â Â Â cssClass: string; Â Â Â Â Â Â Â Â Â Â Â Â id: string Â Â Â Â Â Â Â Â Â Â Â Â | null; Â Â Â Â Â Â Â Â Â Â Â Â isSelf: boolean; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â role: any; Â Â Â Â Â Â Â Â Â Â Â Â tooltip: string; Â Â Â Â Â Â Â Â }[]; Â Â Â Â Â Â Â Â inactive: { Â Â Â Â Â Â Â Â Â Â Â Â border: any; Â Â Â Â Â Â Â Â Â Â Â Â color: any; Â Â Â Â Â Â Â Â Â Â Â Â cssClass: string; Â Â Â Â Â Â Â Â Â Â Â Â id: string Â Â Â Â Â Â Â Â Â Â Â Â | null; Â Â Â Â Â Â Â Â Â Â Â Â isSelf: boolean; Â Â Â Â Â Â Â Â Â Â Â Â name: string; Â Â Â Â Â Â Â Â Â Â Â Â role: any; Â Â Â Â Â Â Â Â Â Â Â Â tooltip: string; Â Â Â Â Â Â Â Â }[]; Â Â Â Â }, >
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<Players>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<Players>
...
* \_formatName(user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)): string
...
* \_getContextMenuOptions(): [ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md)[]
