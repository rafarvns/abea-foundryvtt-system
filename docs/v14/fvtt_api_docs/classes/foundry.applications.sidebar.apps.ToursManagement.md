---
title: "ToursManagement | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.apps.ToursManagement.html"
category: "classes"
---

# Class ToursManagement

A management app for configuring which Tours are available or have been completed.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.apps.ToursManagement))
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<ToursManagement>
  ...
  #### Returns Promise<ToursManagement>
...
* detachWindow(options?: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<ToursManagement>
...
* render(options: any): Promise<ToursManagement>
