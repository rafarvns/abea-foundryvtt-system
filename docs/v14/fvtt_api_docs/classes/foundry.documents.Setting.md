---
title: "Setting | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.Setting.html"
category: "classes"
---
...
[foundry.documents.collections.WorldSettings](foundry.documents.collections.WorldSettings.md): The world-level collection of Setting
documents

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.Setting))

* [BaseSetting](foundry.documents.BaseSetting.md)<this>
  + Setting
...
[\_source](#_source)
[parent](#parent)
[\_ALLOWED\_ASSISTANT\_KEYS](#_allowed_assistant_keys)
[\_GAMEMASTER\_ONLY\_KEYS](#_gamemaster_only_keys)
[\_schema](#_schema)
...
* new Setting(  
  Â Â Â Â data?: Partial<[SettingData](../interfaces/foundry.documents.types.SettingData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): Setting

  #### Parameters

  + `Optional`data: Partial<[SettingData](../interfaces/foundry.documents.types.SettingData.md)> = {}
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[constructor](foundry.documents.BaseSetting.md#constructor)

## Properties

### \_source

\_source: [SettingData](../interfaces/foundry.documents.types.SettingData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_source](foundry.documents.BaseSetting.md#_source)
...
Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[parent](foundry.documents.BaseSetting.md#parent)

### `Static` `Internal`\_ALLOWED\_ASSISTANT\_KEYS

\_ALLOWED\_ASSISTANT\_KEYS: string[] = ...

The settings that assistant GMs can modify regardless of their permission.

Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_ALLOWED\_ASSISTANT\_KEYS](foundry.documents.BaseSetting.md#_allowed_assistant_keys)

### `Static` `Internal`\_GAMEMASTER\_ONLY\_KEYS

\_GAMEMASTER\_ONLY\_KEYS: string[] = ...

The settings that only full GMs can modify.

Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_GAMEMASTER\_ONLY\_KEYS](foundry.documents.BaseSetting.md#_gamemaster_only_keys)
...
Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_schema](foundry.documents.BaseSetting.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseSetting.md#localization_prefixes)
...
Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[metadata](foundry.documents.BaseSetting.md#metadata)
...
* get config(): [SettingsConfig](foundry.applications.settings.SettingsConfig.md) | undefined

  The setting configuration for this setting document.

  #### Returns [SettingsConfig](foundry.applications.settings.SettingsConfig.md) | undefined
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_configure](foundry.documents.BaseSetting.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_getParentCollection](foundry.documents.BaseSetting.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_initializationOrder](foundry.documents.BaseSetting.md#_initializationorder)
...
* \_initialize(options?: {}): void
  ...
  Overrides [BaseSetting](foundry.documents.BaseSetting.md).[\_initialize](foundry.documents.BaseSetting.md#_initialize)
...
* \_onCreate(data: any, options: any, userId: any): void
  ...
  Overrides [BaseSetting](foundry.documents.BaseSetting.md).[\_onCreate](foundry.documents.BaseSetting.md#_oncreate)
...
* \_onUpdate(changed: any, options: any, userId: any): void
  ...
  Overrides [BaseSetting](foundry.documents.BaseSetting.md).[\_onUpdate](foundry.documents.BaseSetting.md#_onupdate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_updateDiff](foundry.documents.BaseSetting.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[canUserModify](foundry.documents.BaseSetting.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[clone](foundry.documents.BaseSetting.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[createEmbeddedDocuments](foundry.documents.BaseSetting.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[delete](foundry.documents.BaseSetting.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[deleteEmbeddedDocuments](foundry.documents.BaseSetting.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[getEmbeddedCollection](foundry.documents.BaseSetting.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[getEmbeddedDocument](foundry.documents.BaseSetting.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[getFieldForProperty](foundry.documents.BaseSetting.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[getFlag](foundry.documents.BaseSetting.md#getflag)
...
* getUserLevel(user?: [BaseUser](foundry.documents.BaseUser.md)): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.md)
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[getUserLevel](foundry.documents.BaseSetting.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[migrateSystemData](foundry.documents.BaseSetting.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[reset](foundry.documents.BaseSetting.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[setFlag](foundry.documents.BaseSetting.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[testUserPermission](foundry.documents.BaseSetting.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[toJSON](foundry.documents.BaseSetting.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[toObject](foundry.documents.BaseSetting.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[traverseEmbeddedDocuments](foundry.documents.BaseSetting.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[unsetFlag](foundry.documents.BaseSetting.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[update](foundry.documents.BaseSetting.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[updateEmbeddedDocuments](foundry.documents.BaseSetting.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[updateSource](foundry.documents.BaseSetting.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[validate](foundry.documents.BaseSetting.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_getInnerModel](foundry.documents.BaseSetting.md#_getinnermodel)
...
* \_initializeSource(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_initializeSource](foundry.documents.BaseSetting.md#_initializesource)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_onDelete](foundry.documents.BaseSetting.md#_ondelete)
...
* \_preCreate(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_preCreate](foundry.documents.BaseSetting.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_preDelete](foundry.documents.BaseSetting.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_preUpdate](foundry.documents.BaseSetting.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_preUpdateSource](foundry.documents.BaseSetting.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_updateCommit](foundry.documents.BaseSetting.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_addDataFieldMigration](foundry.documents.BaseSetting.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_addDataFieldShim](foundry.documents.BaseSetting.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_addDataFieldShims](foundry.documents.BaseSetting.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_clearFieldsRecursively](foundry.documents.BaseSetting.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_logDataFieldMigration](foundry.documents.BaseSetting.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_preCleanData](foundry.documents.BaseSetting.md#_precleandata)
...
* canUserCreate(user: any): any
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[canUserCreate](foundry.documents.BaseSetting.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[cleanData](foundry.documents.BaseSetting.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[create](foundry.documents.BaseSetting.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[createDocuments](foundry.documents.BaseSetting.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â key: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â user: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md);  
  Â Â Â Â value: [JSONField](foundry.data.fields.JSONField.md);  
  }
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â key: [StringField](foundry.data.fields.StringField.md); Â Â Â Â user: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); Â Â Â Â value: [JSONField](foundry.data.fields.JSONField.md); }
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[defineSchema](foundry.documents.BaseSetting.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[deleteDocuments](foundry.documents.BaseSetting.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[fromJSON](foundry.documents.BaseSetting.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[fromSource](foundry.documents.BaseSetting.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[get](foundry.documents.BaseSetting.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[getCollectionName](foundry.documents.BaseSetting.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[migrateData](foundry.documents.BaseSetting.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[migrateDataSafe](foundry.documents.BaseSetting.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[shimData](foundry.documents.BaseSetting.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[updateDocuments](foundry.documents.BaseSetting.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[validateJoint](foundry.documents.BaseSetting.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_cleanData](foundry.documents.BaseSetting.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_onCreateOperation](foundry.documents.BaseSetting.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_onDeleteOperation](foundry.documents.BaseSetting.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_onUpdateOperation](foundry.documents.BaseSetting.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_preCreateOperation](foundry.documents.BaseSetting.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_preDeleteOperation](foundry.documents.BaseSetting.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseSetting](foundry.documents.BaseSetting.md).[\_preUpdateOperation](foundry.documents.BaseSetting.md#_preupdateoperation)