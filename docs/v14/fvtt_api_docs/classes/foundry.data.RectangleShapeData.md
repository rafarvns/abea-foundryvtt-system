---
title: "RectangleShapeData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.RectangleShapeData.html"
category: "classes"
---
...
Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_index
...
Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_source
...
Inherited from ClientShapeDataMixin(data.RectangleShapeData).parent
...
Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_schema

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from ClientShapeDataMixin(data.RectangleShapeData).LOCALIZATION\_PREFIXES
...
Inherited from ClientShapeDataMixin(data.RectangleShapeData).TYPE
...
* get area(): number
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).area
...
* get bounds(): Rectangle
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).bounds
...
* get center(): Readonly<[Point](../interfaces/foundry.types.Point.md)>
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).center
...
* get clipperPaths(): readonly (readonly [DeepReadonly](../types/foundry.types.DeepReadonly.md)<[types](../modules/foundry.types.md).[ClipperPoint](../interfaces/foundry.types.ClipperPoint.md)>[])[]
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).clipperPaths
...
* get clipperPolyTree(): PolyTree
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).clipperPolyTree
...
* get controlHandles(): [DeepReadonly](../types/foundry.types.DeepReadonly.md)<  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).controlHandles
...
* get grid(): [BaseGrid](foundry.grid.BaseGrid.md)<[GridCoordinates2D](../types/foundry.grid.types.GridCoordinates2D.md), [GridCoordinates3D](../types/foundry.grid.types.GridCoordinates3D.md)>
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).grid
...
* get gridlessGrid(): [GridlessGrid](foundry.grid.GridlessGrid.md)
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).gridlessGrid
...
* get hasRotationalSymmetry(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).hasRotationalSymmetry
...
* get invalid(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).invalid
...
* get isAffectedByGrid(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).isAffectedByGrid
...
* get isEmpty(): boolean
  ...
  Overrides ClientShapeDataMixin(data.RectangleShapeData).isEmpty
...
* get measuredSegments(): readonly [DeepReadonly](../types/foundry.types.DeepReadonly.md)<  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).measuredSegments
...
* get origin(): Readonly<[Point](../interfaces/foundry.types.Point.md)>
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).origin
...
* get polygons(): readonly Polygon[]
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).polygons
...
* get polygonTree(): [PolygonTree](foundry.data.PolygonTree.md)
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).polygonTree
...
* get scene(): [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md) | null
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).scene
...
* get schema(): [DataModelSchemaField](foundry.data.fields.DataModelSchemaField.md)
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).schema
...
* get triangulation(): Readonly<  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).triangulation
...
* get validationFailures(): {  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).validationFailures
...
* get TYPES(): Readonly<  
  ...
  Â Â Â Â Â Â Â Â rectangle: [data](../modules/foundry.data.md).RectangleShapeData;  
  ...
  #### Returns Readonly< Â Â Â Â { Â Â Â Â Â Â Â Â circle: [data](../modules/foundry.data.md).[CircleShapeData](foundry.data.CircleShapeData.md); Â Â Â Â Â Â Â Â cone: [data](../modules/foundry.data.md).[ConeShapeData](foundry.data.ConeShapeData.md); Â Â Â Â Â Â Â Â ellipse: [data](../modules/foundry.data.md).[EllipseShapeData](foundry.data.EllipseShapeData.md); Â Â Â Â Â Â Â Â emanation: [EmanationShapeData](foundry.data.EmanationShapeData.md); Â Â Â Â Â Â Â Â grid: [GridShapeData](foundry.data.GridShapeData.md); Â Â Â Â Â Â Â Â line: [LineShapeData](foundry.data.LineShapeData.md); Â Â Â Â Â Â Â Â polygon: [data](../modules/foundry.data.md).[PolygonShapeData](foundry.data.PolygonShapeData.md); Â Â Â Â Â Â Â Â rectangle: [data](../modules/foundry.data.md).RectangleShapeData; Â Â Â Â Â Â Â Â ring: [RingShapeData](foundry.data.RingShapeData.md); Â Â Â Â Â Â Â Â token: [TokenShapeData](foundry.data.TokenShapeData.md); Â Â Â Â }, >

  Inherited from ClientShapeDataMixin(data.RectangleShapeData).TYPES
...
* \_calculateArea(): number
  ...
  Overrides ClientShapeDataMixin(data.RectangleShapeData).\_calculateArea
...
* \_calculateSize(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_calculateSize

### \_createCenter

* \_createCenter(): { x: any; y: any }

  #### Returns { x: any; y: any }

  Overrides ClientShapeDataMixin(data.RectangleShapeData).\_createCenter

### \_createClipperPolyTree

* \_createClipperPolyTree(): [Point](../interfaces/foundry.types.Point.md)[]

  #### Returns [Point](../interfaces/foundry.types.Point.md)[]

  Overrides ClientShapeDataMixin(data.RectangleShapeData).\_createClipperPolyTree

### \_createControlHandles

* \_createControlHandles(): {  
  Â Â Â Â rotate: { position: any; rotation: number; visible: boolean };  
  Â Â Â Â scale: { position: { x: any; y: any }; rotation: number; visible: boolean };  
  Â Â Â Â translate: {  
  Â Â Â Â Â Â Â Â position: { x: any; y: any };  
  Â Â Â Â Â Â Â Â rotation: number;  
  Â Â Â Â Â Â Â Â visible: boolean;  
  Â Â Â Â };  
  }

  #### Returns { Â Â Â Â rotate: { position: any; rotation: number; visible: boolean }; Â Â Â Â scale: { position: { x: any; y: any }; rotation: number; visible: boolean }; Â Â Â Â translate: { Â Â Â Â Â Â Â Â position: { x: any; y: any }; Â Â Â Â Â Â Â Â rotation: number; Â Â Â Â Â Â Â Â visible: boolean; Â Â Â Â }; }

  Overrides ClientShapeDataMixin(data.RectangleShapeData).\_createControlHandles
...
* \_createMeasuredSegment(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_createMeasuredSegment

### \_createMeasuredSegments

* \_createMeasuredSegments(): { distance: number; ray: [Ray](foundry.canvas.geometry.Ray.md); winding: number }[]

  #### Returns { distance: number; ray: [Ray](foundry.canvas.geometry.Ray.md); winding: number }[]

  Overrides ClientShapeDataMixin(data.RectangleShapeData).\_createMeasuredSegments
...
* \_createRay(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_createRay

### \_getRays

* \_getRays(): { axisX: [Ray](foundry.canvas.geometry.Ray.md); axisY: [Ray](foundry.canvas.geometry.Ray.md) }

  `Internal`

  Get the rays for both axes.

  #### Returns { axisX: [Ray](foundry.canvas.geometry.Ray.md); axisY: [Ray](foundry.canvas.geometry.Ray.md) }
...
* \_getSnappedPoint(point: [Point](../interfaces/foundry.types.Point.md)): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_getSnappedPoint
...
* \_getSnappedRotation(rotation: number): number
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_getSnappedRotation
...
* \_moveRotationHandle(direction: number, destination: [Point](../interfaces/foundry.types.Point.md), snap: boolean): void
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_moveRotationHandle
...
* \_moveScaleHandle(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_moveScaleHandle
...
* \_moveSweepHandle(maxAngle: number, destination: [Point](../interfaces/foundry.types.Point.md), snap: boolean): void
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_moveSweepHandle
...
* \_onDragMove(event: any): void
  ...
  Overrides ClientShapeDataMixin(data.RectangleShapeData).\_onDragMove
...
* \_onDragStart(event: FederatedEvent<UIEvent | PixiTouch>): void
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_onDragStart
...
* \_onShapeChange(): void
  ...
  Overrides ClientShapeDataMixin(data.RectangleShapeData).\_onShapeChange
...
* \_updateCommit(copy: any, diff: any, options: any, state: any): void
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_updateCommit
...
* clone(  
  ...
  Overrides ClientShapeDataMixin(data.RectangleShapeData).clone

### drawReferenceLines

* drawReferenceLines(graphics: Graphics): void
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).drawReferenceLines
...
* drawShape(graphics: any): void
  ...
  Overrides ClientShapeDataMixin(data.RectangleShapeData).drawShape
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).getFieldForProperty

### move

* move(origin: [Point](../interfaces/foundry.types.Point.md), options?: { snap?: boolean }): void
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).move

### moveControlHandle

* moveControlHandle(  
  Â Â Â Â name: any,  
  Â Â Â Â destination: any,  
  Â Â Â Â \_\_namedParameters?: { snap?: boolean; unlinked?: boolean },  
  ): void
  ...
  + name: any
  + destination: any
  + \_\_namedParameters: { snap?: boolean; unlinked?: boolean } = {}

  #### Returns void

  Overrides ClientShapeDataMixin(data.RectangleShapeData).moveControlHandle
...
* reset(): void
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).reset
...
* rotate(angle: number, options?: { pivot?: [Point](../interfaces/foundry.types.Point.md) }): void
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).rotate

### sampleBoundary

* sampleBoundary(out: any): [Point](../interfaces/foundry.types.Point.md)
  ...
  Overrides ClientShapeDataMixin(data.RectangleShapeData).sampleBoundary

### sampleInterior

* sampleInterior(out: any): [Point](../interfaces/foundry.types.Point.md)
  ...
  Overrides ClientShapeDataMixin(data.RectangleShapeData).sampleInterior
...
* testPoint(point: [Point](../interfaces/foundry.types.Point.md)): boolean
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).testPoint
...
* toJSON(): object
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).toJSON
...
* toObject(source?: boolean): object
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).toObject
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).updateSource
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).validate
...
* \_configure(options?: object): void
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_configure

### `Protected`\_createOrigin

* \_createOrigin(): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_createOrigin
...
* \_getInnerModel(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_getInnerModel
...
* \_initializationOrder(): Generator<[string, [DataField](foundry.data.fields.DataField.md)], any, any>
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_initializationOrder
...
* \_initialize(options?: object): void
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_initialize
...
* \_initializeSource(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_initializeSource
...
* \_onGridChange(changed: object): void
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_onGridChange
...
* \_preUpdateSource(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_preUpdateSource
...
* \_rotate(angle: number): void
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_rotate
...
* \_updateDiff(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_updateDiff
...
* \_toClipperPath(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_toClipperPath
...
* cleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).cleanData
...
* defineSchema(): { hole: [BooleanField](foundry.data.fields.BooleanField.md); type: [StringField](foundry.data.fields.StringField.md) }
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).defineSchema
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).fromJSON
...
* fromSource(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).fromSource
...
* migrateData(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).migrateData
...
* migrateDataSafe(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).migrateDataSafe
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).shimData
...
* validateJoint(data: object): void
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).validateJoint
...
* \_cleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_cleanData
...
* \_preCleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.RectangleShapeData).\_preCleanData