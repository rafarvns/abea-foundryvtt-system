---
title: "RollTables | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.collections.RollTables.html"
category: "classes"
---
...
* [foundry.documents.RollTable](foundry.documents.RollTable.md): The RollTable document
* [foundry.applications.sidebar.tabs.RollTableDirectory](foundry.applications.sidebar.tabs.RollTableDirectory.md): The RollTableDirectory
  sidebar directory

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.collections.RollTables))
...
* new RollTables(data?: object[]): RollTables
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)[]

  #### Parameters

  + entry: any

  #### Returns [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)
...
* every(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â element: [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)>,  
  Â Â Â Â ) => boolean,  
  ): boolean
  ...
  + condition: (  
    Â Â Â Â element: [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md),  
    Â Â Â Â index: number,  
    Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)>,  
    ) => boolean
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)>,  
  Â Â Â Â ) => unknown,  
  ): [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md) | undefined
  ...
  #### Returns [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md) | undefined
...
* forEach(fn: (value: [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md), index: number) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md), index: number) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md),  
  ...
  + document: object | [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)
...
* getInvalid(  
  ...
  ): void | [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)
  ...
  #### Returns void | [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)
...
* importFromCompendium(  
  ...
  Â Â Â Â options?: any,  
  ): Promise<[documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)>
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)[]
...
* set(id: string, document: [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)): RollTables

  #### Parameters

  + id: string
  + document: [documents](../modules/foundry.documents.md).[RollTable](foundry.documents.RollTable.md)
