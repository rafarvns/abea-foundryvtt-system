---
title: "HTMLField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.HTMLField.html"
category: "classes"
---

# Class HTMLField

A subclass of [foundry.data.fields.StringField](foundry.data.fields.StringField.md) which contains a sanitized HTML string.
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.HTMLField))
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & {  
  ...
  } & { blank: boolean; required: boolean }

  Default parameters for this field type

  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { Â Â Â Â blank: boolean; Â Â Â Â choices: undefined; Â Â Â Â textSearch: boolean; Â Â Â Â trim: boolean; } & { blank: boolean; required: boolean }
...
* \_toInput(config: any): HTMLElement | [HTMLCodeMirrorElement](foundry.applications.elements.HTMLCodeMirrorElement.md)
...
* \_validateType(value: any, \_options: any): true | undefined
  ...
  Inherited from [StringField](foundry.data.fields.StringField.md).[\_validateType](foundry.data.fields.StringField.md#_validatetype)
