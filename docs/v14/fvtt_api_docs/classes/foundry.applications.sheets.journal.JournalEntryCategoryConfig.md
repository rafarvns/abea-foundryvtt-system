---
title: "JournalEntryCategoryConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.journal.JournalEntryCategoryConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.journal.JournalEntryCategoryConfig))
...
* new JournalEntryCategoryConfig(  
  ...
  #### Returns JournalEntryCategoryConfig
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â addCategory: (  
Â Â Â Â Â Â Â Â Â Â Â Â this: JournalEntryCategoryConfig,  
Â Â Â Â Â Â Â Â ) => Promise<[documents](../modules/foundry.documents.md).[JournalEntryCategory](foundry.documents.JournalEntryCategory.md)>;  
...
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLElement,  
Â Â Â Â Â Â Â Â ) => Promise<[documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)>;  
...
* \_processSubmitData(  
  ...
  Â Â Â Â options: any,  
  ): Promise<{ updated: any } | { updated?: undefined }>
  ...
  #### Returns Promise<{ updated: any } | { updated?: undefined }>
...
* close(  
  ...
  ): Promise<JournalEntryCategoryConfig>
  ...
  #### Returns Promise<JournalEntryCategoryConfig>
