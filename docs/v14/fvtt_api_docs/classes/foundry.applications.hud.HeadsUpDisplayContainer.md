---
title: "HeadsUpDisplayContainer | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.hud.HeadsUpDisplayContainer.html"
category: "classes"
---

# Class HeadsUpDisplayContainer

The Heads-Up Display Container is a canvas-sized Application which renders HTML overtop of the game canvas.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.hud.HeadsUpDisplayContainer))
...
* new HeadsUpDisplayContainer(  
  ...
  #### Returns HeadsUpDisplayContainer
...
drawing: [DrawingHUD](foundry.applications.hud.DrawingHUD.md) = ...
...
tile: [TileHUD](foundry.applications.hud.TileHUD.md) = ...

Tile HUD

### token

token: [TokenHUD](foundry.applications.hud.TokenHUD.md) = ...
...
DEFAULT\_OPTIONS: {  
Â Â Â Â id: string;  
Â Â Â Â position: { zIndex: number };  
...
* close(  
  ...
  #### Returns Promise<HeadsUpDisplayContainer>
