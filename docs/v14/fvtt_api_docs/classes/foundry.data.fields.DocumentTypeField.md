---
title: "DocumentTypeField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.DocumentTypeField.html"
category: "classes"
---

# Class DocumentTypeField

A subclass of [foundry.data.fields.StringField](foundry.data.fields.StringField.md) that is used specifically for the Document "type" field.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.DocumentTypeField))
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & {  
  ...
  } & { blank: boolean; nullable: boolean; required: boolean }

  Default parameters for this field type

  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { Â Â Â Â blank: boolean; Â Â Â Â choices: undefined; Â Â Â Â textSearch: boolean; Â Â Â Â trim: boolean; } & { blank: boolean; nullable: boolean; required: boolean }
...
* \_toInput(  
  ...
  Inherited from [StringField](foundry.data.fields.StringField.md).[\_toInput](foundry.data.fields.StringField.md#_toinput)
