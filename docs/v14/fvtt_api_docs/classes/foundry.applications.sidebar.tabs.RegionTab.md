---
title: "RegionTab | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.tabs.RegionTab.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.tabs.RegionTab))
...
ENTRY\_PARTIAL: string = "templates/sidebar/tabs/placeable/region.hbs"

Overrides PlaceableTab.ENTRY\_PARTIAL

### `Static`FILTER\_CLASS

FILTER\_CLASS: typeof [RegionFilter](foundry.applications.sidebar.filters.RegionFilter.md) = RegionFilter
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<RegionTab>
...
* detachWindow(options?: [PlaceableTabConfiguration](../types/foundry.PlaceableTabConfiguration.md)): Promise<RegionTab>
