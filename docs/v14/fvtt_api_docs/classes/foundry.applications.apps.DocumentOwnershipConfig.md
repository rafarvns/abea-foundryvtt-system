---
title: "DocumentOwnershipConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.apps.DocumentOwnershipConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.apps.DocumentOwnershipConfig))
...
Â Â Â Â ownership: { root: boolean; scrollable: string[]; template: string };  
} = ...
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â currentDefault: any;  
  Â Â Â Â Â Â Â Â defaultLevels: { label: string; level: -20 | -10 }[];  
  Â Â Â Â Â Â Â Â instructions: string;  
  Â Â Â Â Â Â Â Â isFolder: boolean;  
  Â Â Â Â Â Â Â Â playerLevels: { label: string; level: -20 | -10 }[];  
  Â Â Â Â Â Â Â Â showGM: boolean;  
  Â Â Â Â Â Â Â Â users: { isAuthor: boolean; level: any; user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) }[];  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â [ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md) & { Â Â Â Â Â Â Â Â document: ClientDocument; Â Â Â Â Â Â Â Â editable: boolean; Â Â Â Â Â Â Â Â fields: any; Â Â Â Â Â Â Â Â model: ClientDocument; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â source: any; Â Â Â Â Â Â Â Â user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) Â Â Â Â Â Â Â Â | null; Â Â Â Â } & { Â Â Â Â Â Â Â Â buttons: { icon: string; label: string; type: string }[]; Â Â Â Â Â Â Â Â currentDefault: any; Â Â Â Â Â Â Â Â defaultLevels: { label: string; level: -20 | -10 }[]; Â Â Â Â Â Â Â Â instructions: string; Â Â Â Â Â Â Â Â isFolder: boolean; Â Â Â Â Â Â Â Â playerLevels: { label: string; level: -20 | -10 }[]; Â Â Â Â Â Â Â Â showGM: boolean; Â Â Â Â Â Â Â Â users: { isAuthor: boolean; level: any; user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) }[]; Â Â Â Â }, >
