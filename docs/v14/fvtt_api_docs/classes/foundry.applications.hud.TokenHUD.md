---
title: "TokenHUD | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.hud.TokenHUD.html"
category: "classes"
---
...
The TokenHUD implementation can be configured and replaced via [CONFIG.Token.hudClass](../variables/CONFIG.Token.md#hudclass).

#### Mixes

HandlebarsApplication

#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.hud.TokenHUD))

* [BasePlaceableHUD](foundry.applications.hud.BasePlaceableHUD.md)<[canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).[Token](foundry.canvas.placeables.Token.md), [TokenDocument](foundry.documents.TokenDocument.md), [TokenLayer](foundry.canvas.layers.TokenLayer.md), this>
  + TokenHUD
...
[\_getLevelChoices](#_getlevelchoices)
[\_getMovementActionChoices](#_getmovementactionchoices)
...
* new TokenHUD(options?: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md)>): TokenHUD
...
Â Â Â Â Â Â Â Â Â Â Â Â this: TokenHUD,  
...
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â this: TokenHUD,  
...
* \_onSubmitElevation(event: any, form: any, formData: any): Promise<void>
  ...
  Overrides HandlebarsApplicationMixin(BasePlaceableHUD).\_onSubmitElevation
...
* bind(object: [canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).[Token](foundry.canvas.placeables.Token.md)): Promise<void>

  Bind the HUD to a new PlaceableObject and display it.

  #### Parameters

  + object: [canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).[Token](foundry.canvas.placeables.Token.md)
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<TokenHUD>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<TokenHUD>
...
* \_getLevelChoices(): {  
  Â Â Â Â [id: string]: { cssClass: string; id: string; name: string };  
  }
  ...
  #### Returns { [id: string]: { cssClass: string; id: string; name: string } }
...
* \_getStatusEffectChoices(): {  
  ...
  #### Returns { Â Â Â Â [id: string]: { Â Â Â Â Â Â Â Â \_id: string; Â Â Â Â Â Â Â Â cssClass: string; Â Â Â Â Â Â Â Â id: string; Â Â Â Â Â Â Â Â isActive: boolean; Â Â Â Â Â Â Â Â isOverlay: boolean; Â Â Â Â Â Â Â Â order: number; Â Â Â Â Â Â Â Â src: string; Â Â Â Â Â Â Â Â title: string; Â Â Â Â }; }
