---
title: "PlaceableConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.PlaceableConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.PlaceableConfig))

* [DocumentSheetV2](foundry.applications.api.DocumentSheetV2.md)<this>
  + PlaceableConfig
    - [AmbientLightConfig](foundry.applications.sheets.AmbientLightConfig.md)
    - [AmbientSoundConfig](foundry.applications.sheets.AmbientSoundConfig.md)
    - [DrawingConfig](foundry.applications.sheets.DrawingConfig.md)
    - [NoteConfig](foundry.applications.sheets.NoteConfig.md)
    - [RegionConfig](foundry.applications.sheets.RegionConfig.md)
    - [TileConfig](foundry.applications.sheets.TileConfig.md)
    - [TokenConfig](foundry.applications.sheets.TokenConfig.md)
    - [WallConfig](foundry.applications.sheets.WallConfig.md)
...
* new PlaceableConfig(options: any, ...args: any[]): PlaceableConfig
...
* \_postRender(context: any, options: any): Promise<void>
  ...
  Overrides HandlebarsApplicationMixin(DocumentSheetV2).\_postRender
...
* \_preClose(options: any): Promise<void>
  ...
  Overrides HandlebarsApplicationMixin(DocumentSheetV2).\_preClose
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<PlaceableConfig>
  ...
  #### Returns Promise<PlaceableConfig>
