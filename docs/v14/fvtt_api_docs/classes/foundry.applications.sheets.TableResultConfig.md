---
title: "TableResultConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.TableResultConfig.html"
category: "classes"
---

# Class TableResultConfig
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.TableResultConfig))
...
[prepareResultUpdateData](#prepareresultupdatedata)
...
### `Static`RESULT\_TYPES

* get RESULT\_TYPES(): { label: string; value: string }[]
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<TableResultConfig>
  ...
  #### Returns Promise<TableResultConfig>
...
### `Static`prepareResultUpdateData

* prepareResultUpdateData(data: DeepPartial<[TableResultData](../interfaces/foundry.documents.types.TableResultData.md)>): void

  Prepare the update data of a single TableResult document to ensure joint validation.

  #### Parameters

  + data: DeepPartial<[TableResultData](../interfaces/foundry.documents.types.TableResultData.md)>
