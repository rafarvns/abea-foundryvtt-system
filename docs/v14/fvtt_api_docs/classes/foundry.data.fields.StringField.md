---
title: "StringField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.StringField.html"
category: "classes"
---

# Class StringField

A subclass of [foundry.data.fields.DataField](foundry.data.fields.DataField.md) which deals with string-typed data.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.StringField))

* [DataField](foundry.data.fields.DataField.md)
  + StringField
    - [ColorField](foundry.data.fields.ColorField.md)
    - [DocumentIdField](foundry.data.fields.DocumentIdField.md)
    - [DocumentTypeField](foundry.data.fields.DocumentTypeField.md)
    - [DocumentUUIDField](foundry.data.fields.DocumentUUIDField.md)
    - [FilePathField](foundry.data.fields.FilePathField.md)
    - [HTMLField](foundry.data.fields.HTMLField.md)
    - [JSONField](foundry.data.fields.JSONField.md)
    - [JavaScriptField](foundry.data.fields.JavaScriptField.md)
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & {  
  ...
  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { Â Â Â Â blank: boolean; Â Â Â Â choices: undefined; Â Â Â Â textSearch: boolean; Â Â Â Â trim: boolean; }
...
* \_applyChangeSubtract(  
  ...
  Overrides [DataField](foundry.data.fields.DataField.md).[\_applyChangeSubtract](foundry.data.fields.DataField.md#_applychangesubtract)
...
* \_replaceDataRefs(  
  ...
  Overrides [DataField](foundry.data.fields.DataField.md).[\_replaceDataRefs](foundry.data.fields.DataField.md#_replacedatarefs)

### \_toInput

* \_toInput(  
  Â Â Â Â config: [FormInputConfig](../interfaces/foundry.data.types.FormInputConfig.md) & [StringFieldInputConfig](../interfaces/foundry.data.types.StringFieldInputConfig.md),  
  ): HTMLElement | [HTMLCodeMirrorElement](foundry.applications.elements.HTMLCodeMirrorElement.md)

  #### Parameters

  + config: [FormInputConfig](../interfaces/foundry.data.types.FormInputConfig.md) & [StringFieldInputConfig](../interfaces/foundry.data.types.StringFieldInputConfig.md)

  #### Returns HTMLElement | [HTMLCodeMirrorElement](foundry.applications.elements.HTMLCodeMirrorElement.md)

  Overrides [DataField](foundry.data.fields.DataField.md).[\_toInput](foundry.data.fields.DataField.md#_toinput)
...
* \_validateSpecial(value: any): boolean | void
  ...
  Overrides [DataField](foundry.data.fields.DataField.md).[\_validateSpecial](foundry.data.fields.DataField.md#_validatespecial)

### \_validateType

* \_validateType(value: any, \_options: any): true | undefined
...
* clean(value: any, options: any, \_state: any): any
  ...
  Overrides [DataField](foundry.data.fields.DataField.md).[clean](foundry.data.fields.DataField.md#clean)
