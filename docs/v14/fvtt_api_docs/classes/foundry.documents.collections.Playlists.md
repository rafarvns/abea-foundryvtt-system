---
title: "Playlists | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.collections.Playlists.html"
category: "classes"
---
...
* [foundry.documents.Playlist](foundry.documents.Playlist.md): The Playlist document
* [foundry.applications.sidebar.tabs.PlaylistDirectory](foundry.applications.sidebar.tabs.PlaylistDirectory.md): The PlaylistDirectory sidebar
  directory

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.collections.Playlists))
...
* new Playlists(data?: object[]): Playlists
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)[]
...
* \_onChangeScene(scene: [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md) | null): Promise<void>
  ...
  + scene: [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md) | null
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)
...
* every(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â element: [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)>,  
  Â Â Â Â ) => boolean,  
  ): boolean
  ...
  + condition: (  
    Â Â Â Â element: [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md),  
    Â Â Â Â index: number,  
    Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)>,  
    ) => boolean
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)>,  
  Â Â Â Â ) => unknown,  
  ): [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md) | undefined
  ...
  #### Returns [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md) | undefined
...
* forEach(fn: (value: [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md), index: number) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md), index: number) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md),  
  ...
  + document: object | [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)
...
* getInvalid(  
  ...
  ): void | [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)
  ...
  #### Returns void | [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)[]
...
* set(id: string, document: [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)): Playlists

  #### Parameters

  + id: string
  + document: [documents](../modules/foundry.documents.md).[Playlist](foundry.documents.Playlist.md)
