---
title: "ColorizeBrightnessShader | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.rendering.shaders.ColorizeBrightnessShader.html"
category: "classes"
---

# Class ColorizeBrightnessShader

A colorization shader which keeps brightness contrary to "normal tinting"

#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.rendering.shaders.ColorizeBrightnessShader))
...
* get defaultUniforms(): {  
  Â Â Â Â grey: boolean;  
  Â Â Â Â intensity: number;  
  Â Â Â Â sampler: null;  
  Â Â Â Â screenDimensions: number[];  
  Â Â Â Â tintAlpha: number[];  
  Â Â Â Â tintLinear: number[];  
  }

  #### Returns { Â Â Â Â grey: boolean; Â Â Â Â intensity: number; Â Â Â Â sampler: null; Â Â Â Â screenDimensions: number[]; Â Â Â Â tintAlpha: number[]; Â Â Â Â tintLinear: number[]; }
