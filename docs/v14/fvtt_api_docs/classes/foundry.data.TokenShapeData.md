---
title: "TokenShapeData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.TokenShapeData.html"
category: "classes"
---

# Class TokenShapeData
...
Inherited from ClientShapeDataMixin(data.TokenShapeData).\_index
...
Inherited from ClientShapeDataMixin(data.TokenShapeData).\_source
...
Inherited from ClientShapeDataMixin(data.TokenShapeData).parent
...
Inherited from ClientShapeDataMixin(data.TokenShapeData).\_schema

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from ClientShapeDataMixin(data.TokenShapeData).LOCALIZATION\_PREFIXES
...
Inherited from ClientShapeDataMixin(data.TokenShapeData).TYPE
...
* get area(): number
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).area
...
* get bounds(): Rectangle
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).bounds
...
* get center(): Readonly<[Point](../interfaces/foundry.types.Point.md)>
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).center
...
* get clipperPaths(): readonly (readonly [DeepReadonly](../types/foundry.types.DeepReadonly.md)<[types](../modules/foundry.types.md).[ClipperPoint](../interfaces/foundry.types.ClipperPoint.md)>[])[]
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).clipperPaths
...
* get clipperPolyTree(): PolyTree
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).clipperPolyTree
...
* get controlHandles(): [DeepReadonly](../types/foundry.types.DeepReadonly.md)<  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).controlHandles
...
* get grid(): [BaseGrid](foundry.grid.BaseGrid.md)<[GridCoordinates2D](../types/foundry.grid.types.GridCoordinates2D.md), [GridCoordinates3D](../types/foundry.grid.types.GridCoordinates3D.md)>
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).grid
...
* get gridlessGrid(): [GridlessGrid](foundry.grid.GridlessGrid.md)
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).gridlessGrid
...
* get hasRotationalSymmetry(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).hasRotationalSymmetry
...
* get invalid(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).invalid
...
* get isAffectedByGrid(): boolean
  ...
  Overrides ClientShapeDataMixin(data.TokenShapeData).isAffectedByGrid
...
* get isEmpty(): boolean
  ...
  Overrides ClientShapeDataMixin(data.TokenShapeData).isEmpty
...
* get measuredSegments(): readonly [DeepReadonly](../types/foundry.types.DeepReadonly.md)<  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).measuredSegments
...
* get origin(): Readonly<[Point](../interfaces/foundry.types.Point.md)>
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).origin
...
* get polygons(): readonly Polygon[]
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).polygons
...
* get polygonTree(): [PolygonTree](foundry.data.PolygonTree.md)
  ...
  Overrides ClientShapeDataMixin(data.TokenShapeData).polygonTree
...
* get scene(): [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md) | null
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).scene
...
* get schema(): [DataModelSchemaField](foundry.data.fields.DataModelSchemaField.md)
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).schema
...
* get triangulation(): Readonly<  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).triangulation
...
* get validationFailures(): {  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).validationFailures
...
* get TYPES(): Readonly<  
  ...
  Â Â Â Â Â Â Â Â token: TokenShapeData;  
  Â Â Â Â },  
  >
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).TYPES
...
* \_calculateSize(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_calculateSize

### \_createClipperPolyTree

* \_createClipperPolyTree(): PolyTree

  #### Returns PolyTree

  Overrides ClientShapeDataMixin(data.TokenShapeData).\_createClipperPolyTree
...
* \_createControlHandles(): {  
  ...
  #### Returns { translate: { position: Readonly<[Point](../interfaces/foundry.types.Point.md)>; rotation: number; visible: boolean } }

  Overrides ClientShapeDataMixin(data.TokenShapeData).\_createControlHandles
...
* \_createMeasuredSegment(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_createMeasuredSegment
...
* \_createMeasuredSegments(): never[]
  ...
  Overrides ClientShapeDataMixin(data.TokenShapeData).\_createMeasuredSegments

### \_createOrigin

* \_createOrigin(): { x: number; y: number }

  #### Returns { x: number; y: number }

  Overrides ClientShapeDataMixin(data.TokenShapeData).\_createOrigin
...
* \_createRay(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_createRay
...
* \_getSnappedPoint(point: [Point](../interfaces/foundry.types.Point.md)): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_getSnappedPoint
...
* \_getSnappedRotation(rotation: number): number
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_getSnappedRotation

### \_getTokenShape

* \_getTokenShape(): | [data](../modules/foundry.data.md).[CircleShapeData](foundry.data.CircleShapeData.md)  
  | [data](../modules/foundry.data.md).[EllipseShapeData](foundry.data.EllipseShapeData.md)  
  | [data](../modules/foundry.data.md).[PolygonShapeData](foundry.data.PolygonShapeData.md)

  `Internal`

  Get the token shape.

  #### Returns [data](../modules/foundry.data.md).[CircleShapeData](foundry.data.CircleShapeData.md) | [data](../modules/foundry.data.md).[EllipseShapeData](foundry.data.EllipseShapeData.md) | [data](../modules/foundry.data.md).[PolygonShapeData](foundry.data.PolygonShapeData.md)
...
* \_moveRotationHandle(direction: number, destination: [Point](../interfaces/foundry.types.Point.md), snap: boolean): void
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_moveRotationHandle
...
* \_moveScaleHandle(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_moveScaleHandle
...
* \_moveSweepHandle(maxAngle: number, destination: [Point](../interfaces/foundry.types.Point.md), snap: boolean): void
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_moveSweepHandle
...
* \_onDragMove(event: any): void
  ...
  Overrides ClientShapeDataMixin(data.TokenShapeData).\_onDragMove
...
* \_onDragStart(event: FederatedEvent<UIEvent | PixiTouch>): void
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_onDragStart
...
* \_onShapeChange(): void
  ...
  Overrides ClientShapeDataMixin(data.TokenShapeData).\_onShapeChange
...
* \_rotate(angle: any): void
  ...
  Overrides ClientShapeDataMixin(data.TokenShapeData).\_rotate
...
* \_updateCommit(copy: any, diff: any, options: any, state: any): void
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_updateCommit
...
* clone(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).clone
...
* drawReferenceLines(graphics: Graphics): void
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).drawReferenceLines
...
* drawShape(graphics: Graphics): void
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).drawShape
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).getFieldForProperty
...
* move(origin: any, \_\_namedParameters?: { snap?: boolean }): void
  ...
  Overrides ClientShapeDataMixin(data.TokenShapeData).move
...
* moveControlHandle(  
  ...
  Overrides ClientShapeDataMixin(data.TokenShapeData).moveControlHandle
...
* reset(): void
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).reset
...
* rotate(angle: number, options?: { pivot?: [Point](../interfaces/foundry.types.Point.md) }): void
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).rotate
...
* sampleBoundary(out: any): any
  ...
  Overrides ClientShapeDataMixin(data.TokenShapeData).sampleBoundary
...
* sampleInterior(out: any): any
  ...
  Overrides ClientShapeDataMixin(data.TokenShapeData).sampleInterior
...
* testPoint(point: [Point](../interfaces/foundry.types.Point.md)): boolean
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).testPoint
...
* toJSON(): object
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).toJSON
...
* toObject(source?: boolean): object
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).toObject
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).updateSource
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).validate
...
* \_calculateArea(): number
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_calculateArea
...
* \_configure(options?: object): void
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_configure
...
* \_createCenter(): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_createCenter
...
* \_getInnerModel(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_getInnerModel
...
* \_initializationOrder(): Generator<[string, [DataField](foundry.data.fields.DataField.md)], any, any>
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_initializationOrder
...
* \_initialize(options?: object): void
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_initialize
...
* \_initializeSource(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_initializeSource
...
* \_onGridChange(changed: object): void
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_onGridChange
...
* \_preUpdateSource(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_preUpdateSource
...
* \_updateDiff(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_updateDiff
...
* \_toClipperPath(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_toClipperPath
...
* cleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).cleanData
...
* defineSchema(): { hole: [BooleanField](foundry.data.fields.BooleanField.md); type: [StringField](foundry.data.fields.StringField.md) }
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).defineSchema
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).fromJSON
...
* fromSource(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).fromSource
...
* migrateData(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).migrateData
...
* migrateDataSafe(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).migrateDataSafe
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).shimData
...
* validateJoint(data: object): void
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).validateJoint
...
* \_cleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_cleanData
...
* \_preCleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.TokenShapeData).\_preCleanData