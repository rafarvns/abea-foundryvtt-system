---
title: "AmbientSoundShapeControls | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.placeables.sounds.AmbientSoundShapeControls.html"
category: "classes"
---

# Class AmbientSoundShapeControls

Controls for a AmbientSound shape.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.placeables.sounds.AmbientSoundShapeControls))

* [ShapeControls](foundry.canvas.containers.ShapeControls.md)
  + AmbientSoundShapeControls
...
* new AmbientSoundShapeControls(shape: [CircleShapeData](foundry.CircleShapeData.md)): AmbientSoundShapeControls

  #### Parameters

  + shape: [CircleShapeData](foundry.CircleShapeData.md)

    The shape.

  #### Returns AmbientSoundShapeControls
...
* \_prepareDragDropUpdate(event: any): { radius: any; x: any; y: any }

  #### Parameters

  + event: any

  #### Returns { radius: any; x: any; y: any }
...
* draw(): Promise<AmbientSoundShapeControls>

  Draw the visualization of these controls.

  #### Returns Promise<AmbientSoundShapeControls>
