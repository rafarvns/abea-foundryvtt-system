---
title: "RingShapeData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.RingShapeData.html"
category: "classes"
---
...
Inherited from ClientShapeDataMixin(data.RingShapeData).\_index
...
Inherited from ClientShapeDataMixin(data.RingShapeData).\_source
...
Inherited from ClientShapeDataMixin(data.RingShapeData).parent
...
Inherited from ClientShapeDataMixin(data.RingShapeData).\_schema

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from ClientShapeDataMixin(data.RingShapeData).LOCALIZATION\_PREFIXES
...
Inherited from ClientShapeDataMixin(data.RingShapeData).TYPE
...
* get area(): number
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).area
...
* get bounds(): Rectangle
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).bounds
...
* get center(): Readonly<[Point](../interfaces/foundry.types.Point.md)>
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).center
...
* get clipperPaths(): readonly (readonly [DeepReadonly](../types/foundry.types.DeepReadonly.md)<[types](../modules/foundry.types.md).[ClipperPoint](../interfaces/foundry.types.ClipperPoint.md)>[])[]
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).clipperPaths
...
* get clipperPolyTree(): PolyTree
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).clipperPolyTree
...
* get controlHandles(): [DeepReadonly](../types/foundry.types.DeepReadonly.md)<  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).controlHandles
...
* get grid(): [BaseGrid](foundry.grid.BaseGrid.md)<[GridCoordinates2D](../types/foundry.grid.types.GridCoordinates2D.md), [GridCoordinates3D](../types/foundry.grid.types.GridCoordinates3D.md)>
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).grid
...
* get gridlessGrid(): [GridlessGrid](foundry.grid.GridlessGrid.md)
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).gridlessGrid
...
* get hasRotationalSymmetry(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).hasRotationalSymmetry
...
* get invalid(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).invalid
...
* get isAffectedByGrid(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).isAffectedByGrid
...
* get isEmpty(): boolean
  ...
  Overrides ClientShapeDataMixin(data.RingShapeData).isEmpty
...
* get measuredSegments(): readonly [DeepReadonly](../types/foundry.types.DeepReadonly.md)<  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).measuredSegments
...
* get origin(): Readonly<[Point](../interfaces/foundry.types.Point.md)>
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).origin
...
* get polygons(): readonly Polygon[]
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).polygons
...
* get polygonTree(): [PolygonTree](foundry.data.PolygonTree.md)
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).polygonTree
...
* get scene(): [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md) | null
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).scene
...
* get schema(): [DataModelSchemaField](foundry.data.fields.DataModelSchemaField.md)
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).schema
...
* get triangulation(): Readonly<  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).triangulation
...
* get validationFailures(): {  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).validationFailures
...
* get TYPES(): Readonly<  
  ...
  Â Â Â Â Â Â Â Â ring: RingShapeData;  
  ...
  #### Returns Readonly< Â Â Â Â { Â Â Â Â Â Â Â Â circle: [data](../modules/foundry.data.md).[CircleShapeData](foundry.data.CircleShapeData.md); Â Â Â Â Â Â Â Â cone: [data](../modules/foundry.data.md).[ConeShapeData](foundry.data.ConeShapeData.md); Â Â Â Â Â Â Â Â ellipse: [data](../modules/foundry.data.md).[EllipseShapeData](foundry.data.EllipseShapeData.md); Â Â Â Â Â Â Â Â emanation: [EmanationShapeData](foundry.data.EmanationShapeData.md); Â Â Â Â Â Â Â Â grid: [GridShapeData](foundry.data.GridShapeData.md); Â Â Â Â Â Â Â Â line: [LineShapeData](foundry.data.LineShapeData.md); Â Â Â Â Â Â Â Â polygon: [data](../modules/foundry.data.md).[PolygonShapeData](foundry.data.PolygonShapeData.md); Â Â Â Â Â Â Â Â rectangle: [data](../modules/foundry.data.md).[RectangleShapeData](foundry.data.RectangleShapeData.md); Â Â Â Â Â Â Â Â ring: RingShapeData; Â Â Â Â Â Â Â Â token: [TokenShapeData](foundry.data.TokenShapeData.md); Â Â Â Â }, >

  Inherited from ClientShapeDataMixin(data.RingShapeData).TYPES
...
* \_calculateArea(): number
  ...
  Overrides ClientShapeDataMixin(data.RingShapeData).\_calculateArea
...
* \_calculateSize(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_calculateSize
...
* \_createClipperPolyTree(): any
  ...
  Overrides ClientShapeDataMixin(data.RingShapeData).\_createClipperPolyTree

### \_createControlHandles

* \_createControlHandles(): {  
  Â Â Â Â inset: { position: Point; rotation: number; visible: boolean };  
  Â Â Â Â offset: { position: Point; rotation: number; visible: boolean };  
  ...
  #### Returns { Â Â Â Â inset: { position: Point; rotation: number; visible: boolean }; Â Â Â Â offset: { position: Point; rotation: number; visible: boolean }; Â Â Â Â scale: { position: Point; rotation: number; visible: boolean }; Â Â Â Â translate: { position: Point; rotation: number; visible: boolean }; }

  Overrides ClientShapeDataMixin(data.RingShapeData).\_createControlHandles
...
* \_createMeasuredSegment(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_createMeasuredSegment
...
* \_createMeasuredSegments(): (  
  ...
  Â Â Â Â | 0  
  Â Â Â Â | 1 }  
  Â Â Â Â | { distance: number; ray: [Ray](foundry.canvas.geometry.Ray.md); winding: number }  
  )[]

  #### Returns ( Â Â Â Â | { angle?: number; distance: number; ray: [Ray](foundry.canvas.geometry.Ray.md); winding: -1 Â Â Â Â | 0 Â Â Â Â | 1 } Â Â Â Â | { distance: number; ray: [Ray](foundry.canvas.geometry.Ray.md); winding: number } )[]

  Overrides ClientShapeDataMixin(data.RingShapeData).\_createMeasuredSegments
...
* \_createRay(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_createRay
...
* \_getSnappedPoint(point: [Point](../interfaces/foundry.types.Point.md)): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_getSnappedPoint
...
* \_getSnappedRotation(rotation: number): number
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_getSnappedRotation
...
* \_moveRotationHandle(direction: number, destination: [Point](../interfaces/foundry.types.Point.md), snap: boolean): void
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_moveRotationHandle
...
* \_moveScaleHandle(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_moveScaleHandle
...
* \_moveSweepHandle(maxAngle: number, destination: [Point](../interfaces/foundry.types.Point.md), snap: boolean): void
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_moveSweepHandle
...
* \_onDragMove(event: any): void
  ...
  Overrides ClientShapeDataMixin(data.RingShapeData).\_onDragMove
...
* \_onDragStart(event: FederatedEvent<UIEvent | PixiTouch>): void
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_onDragStart
...
* \_onShapeChange(): void
  ...
  Overrides ClientShapeDataMixin(data.RingShapeData).\_onShapeChange
...
* \_rotate(angle: any): void
  ...
  Overrides ClientShapeDataMixin(data.RingShapeData).\_rotate
...
* \_updateCommit(copy: any, diff: any, options: any, state: any): void
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_updateCommit
...
* clone(  
  ...
  Overrides ClientShapeDataMixin(data.RingShapeData).clone
...
* drawReferenceLines(graphics: any): void
  ...
  Overrides ClientShapeDataMixin(data.RingShapeData).drawReferenceLines
...
* drawShape(graphics: any): void
  ...
  Overrides ClientShapeDataMixin(data.RingShapeData).drawShape
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).getFieldForProperty
...
* move(origin: [Point](../interfaces/foundry.types.Point.md), options?: { snap?: boolean }): void
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).move
...
* moveControlHandle(  
  ...
  Overrides ClientShapeDataMixin(data.RingShapeData).moveControlHandle
...
* reset(): void
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).reset
...
* rotate(angle: number, options?: { pivot?: [Point](../interfaces/foundry.types.Point.md) }): void
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).rotate
...
* sampleBoundary(out: any): any
  ...
  Overrides ClientShapeDataMixin(data.RingShapeData).sampleBoundary
...
* sampleInterior(out: any): any
  ...
  Overrides ClientShapeDataMixin(data.RingShapeData).sampleInterior
...
* testPoint(point: [Point](../interfaces/foundry.types.Point.md)): boolean
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).testPoint
...
* toJSON(): object
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).toJSON
...
* toObject(source?: boolean): object
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).toObject
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).updateSource
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).validate
...
* \_configure(options?: object): void
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_configure
...
* \_createCenter(): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_createCenter
...
* \_createOrigin(): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_createOrigin
...
* \_getInnerModel(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_getInnerModel
...
* \_initializationOrder(): Generator<[string, [DataField](foundry.data.fields.DataField.md)], any, any>
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_initializationOrder
...
* \_initialize(options?: object): void
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_initialize
...
* \_initializeSource(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_initializeSource
...
* \_onGridChange(changed: object): void
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_onGridChange
...
* \_preUpdateSource(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_preUpdateSource
...
* \_updateDiff(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_updateDiff
...
* \_toClipperPath(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_toClipperPath
...
* cleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).cleanData
...
* defineSchema(): { hole: [BooleanField](foundry.data.fields.BooleanField.md); type: [StringField](foundry.data.fields.StringField.md) }
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).defineSchema
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).fromJSON
...
* fromSource(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).fromSource
...
* migrateData(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).migrateData
...
* migrateDataSafe(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).migrateDataSafe
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).shimData
...
* validateJoint(data: object): void
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).validateJoint
...
* \_cleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_cleanData
...
* \_preCleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.RingShapeData).\_preCleanData