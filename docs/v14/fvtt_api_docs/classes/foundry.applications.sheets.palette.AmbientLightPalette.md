---
title: "AmbientLightPalette | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.palette.AmbientLightPalette.html"
category: "classes"
---

# Class AmbientLightPalette
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.palette.AmbientLightPalette))

* [AmbientLightConfig](foundry.applications.sheets.AmbientLightConfig.md)<this>
  + AmbientLightPalette
...
* new AmbientLightPalette(options: any, ...args: any[]): AmbientLightPalette
  ...
  #### Returns AmbientLightPalette

  #### Inherit Doc

  Inherited from PlaceablePaletteMixin(AmbientLightConfig).constructor
...
Inherited from PlaceablePaletteMixin(AmbientLightConfig).options
...
Inherited from PlaceablePaletteMixin(AmbientLightConfig).position
...
Inherited from PlaceablePaletteMixin(AmbientLightConfig).tabGroups
...
Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_preview
...
Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_appId
...
Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_maxZ
...
Inherited from PlaceablePaletteMixin(AmbientLightConfig).BASE\_APPLICATION

### `Static`DEFAULT\_OPTIONS

DEFAULT\_OPTIONS: { id: string } = ...

Overrides PlaceablePaletteMixin(AmbientLightConfig).DEFAULT\_OPTIONS
...
Inherited from PlaceablePaletteMixin(AmbientLightConfig).emittedEvents
...
Inherited from PlaceablePaletteMixin(AmbientLightConfig).RENDER\_STATES

### `Static`SETTING\_KEY

SETTING\_KEY: string = "ambientLightPalette"
...
Overrides PlaceablePaletteMixin(AmbientLightConfig).TABS
...
* get classList(): DOMTokenList
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).classList
...
* get document(): ClientDocument
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).document
...
* get element(): HTMLElement
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).element
...
* get form(): HTMLFormElement | null
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).form
...
* get hasFrame(): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).hasFrame
...
* get id(): string
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).id
...
* get isEditable(): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).isEditable
...
* get isVisible(): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).isVisible
...
* get minimized(): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).minimized
...
* get rendered(): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).rendered
...
* get state(): number
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).state
...
* get title(): string
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).title
...
* get schema(): any
  ...
  Overrides PlaceablePaletteMixin(AmbientLightConfig).schema
...
* \_awaitTransition(element: HTMLElement, timeout: number): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_awaitTransition
...
* \_canDetach(): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_canDetach
...
* \_canRender(\_options: any): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_canRender
...
* \_configureRenderOptions(options: any): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_configureRenderOptions
...
* \_doEvent(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_doEvent
...
* \_getFrameButtons(options: any): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_getFrameButtons
...
* \_headerControlButtons(): Generator<  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_headerControlButtons
...
* \_initializeApplicationOptions(options: any): any
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_initializeApplicationOptions
...
* \_onChangeForm(formConfig: any, event: any): void
  ...
  Overrides PlaceablePaletteMixin(AmbientLightConfig).\_onChangeForm
...
* \_onClose(options: any): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_onClose
...
* \_onFirstRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_onFirstRender
...
* \_onRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_onRender
...
* \_postRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_postRender
...
* \_preClose(options: any): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_preClose
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â )[];  
  Â Â Â Â Â Â Â Â colorationTechniques: Record<string, [ShaderTechnique](../interfaces/foundry.ShaderTechnique.md)>;  
  Â Â Â Â Â Â Â Â isDarkness: any;  
  Â Â Â Â Â Â Â Â light: any;  
  Â Â Â Â Â Â Â Â lightAnimations:  
  Â Â Â Â Â Â Â Â Â Â Â Â | [LightSourceAnimationConfig](../types/CONFIG.LightSourceAnimationConfig.md)  
  Â Â Â Â Â Â Â Â Â Â Â Â | [DarknessSourceAnimationConfig](../types/CONFIG.DarknessSourceAnimationConfig.md);  
  Â Â Â Â Â Â Â Â tabClasses: string;  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â [ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md) & { Â Â Â Â Â Â Â Â document: ClientDocument; Â Â Â Â Â Â Â Â editable: boolean; Â Â Â Â Â Â Â Â fields: any; Â Â Â Â Â Â Â Â model: ClientDocument; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â source: any; Â Â Â Â Â Â Â Â user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) Â Â Â Â Â Â Â Â | null; Â Â Â Â } & { Â Â Â Â Â Â Â Â document: [Document](foundry.abstract.Document.md)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md)> Â Â Â Â Â Â Â Â | null; Â Â Â Â Â Â Â Â gridUnits: any; Â Â Â Â Â Â Â Â inputs: { Â Â Â Â Â Â Â Â Â Â Â Â createMultiSelectInput: ( Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â field: any, Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â config: any, Â Â Â Â Â Â Â Â Â Â Â Â ) => AbstractMultiSelectElement; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â model: [Document](foundry.abstract.Document.md)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md)> Â Â Â Â Â Â Â Â | null; Â Â Â Â Â Â Â Â selectableLevels: any; Â Â Â Â Â Â Â Â source: object; Â Â Â Â } & { Â Â Â Â Â Â Â Â buttons: ( Â Â Â Â Â Â Â Â Â Â Â Â | { action: string; icon: string; label: string; type: string } Â Â Â Â Â Â Â Â Â Â Â Â | { action?: undefined; icon: string; label: string; type: string } Â Â Â Â Â Â Â Â )[]; Â Â Â Â Â Â Â Â colorationTechniques: Record<string, [ShaderTechnique](../interfaces/foundry.ShaderTechnique.md)>; Â Â Â Â Â Â Â Â isDarkness: any; Â Â Â Â Â Â Â Â light: any; Â Â Â Â Â Â Â Â lightAnimations: Â Â Â Â Â Â Â Â Â Â Â Â | [LightSourceAnimationConfig](../types/CONFIG.LightSourceAnimationConfig.md) Â Â Â Â Â Â Â Â Â Â Â Â | [DarknessSourceAnimationConfig](../types/CONFIG.DarknessSourceAnimationConfig.md); Â Â Â Â Â Â Â Â tabClasses: string; Â Â Â Â }, >

  #### Inherit Doc

  Overrides PlaceablePaletteMixin(AmbientLightConfig).\_prepareContext
...
* \_previewChanges(changes: any): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_previewChanges
...
* \_renderFrame(options: any): Promise<HTMLElement>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_renderFrame
...
* \_renderHTML(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_renderHTML
...
* addEventListener(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).addEventListener
...
* attachWindow(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).attachWindow
...
* bringToFront(): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).bringToFront
...
* close(  
  ...
  #### Returns Promise<AmbientLightPalette>

  A Promise which resolves to the closed Application instance

  Inherited from PlaceablePaletteMixin(AmbientLightConfig).close
...
* detachWindow(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).detachWindow
...
* dispatchEvent(event: Event): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).dispatchEvent
...
* maximize(): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).maximize
...
* minimize(): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).minimize
...
* removeEventListener(type: string, listener: [EmittedEventListener](../types/foundry.utils.types.EmittedEventListener.md)): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).removeEventListener
...
* render(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).render
...
* renderChild(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).renderChild
...
* setPosition(position?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void | [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).setPosition
...
* submit(submitOptions?: object): Promise<any>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).submit
...
* \_attachFrameListeners(): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_attachFrameListeners
...
* \_canAttach(): boolean
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_canAttach
...
* \_createContextMenu(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_createContextMenu
...
* \_createPreview(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_createPreview
...
* \_destroyPreview(): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_destroyPreview
...
* \_getHeaderControls(): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_getHeaderControls
...
* \_getTabsConfig(group: string): [ApplicationTabsConfiguration](../interfaces/foundry.applications.types.ApplicationTabsConfiguration.md) | null
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_getTabsConfig
...
* \_headerControlContextEntries(): Generator<[ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md), void, any>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_headerControlContextEntries
...
* \_initializePreview(): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_initializePreview
...
* \_insertElement(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_insertElement
...
* \_onAttach(from: Document, to: Document): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_onAttach
...
* \_onClickAction(event: PointerEvent, target: HTMLElement): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_onClickAction
...
* \_onClickTab(event: PointerEvent): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_onClickTab
...
* \_onDetach(from: Document, to: Document): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_onDetach
...
* \_onPosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_onPosition
...
* \_onRevealSecret(event: Event): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_onRevealSecret
...
* \_onSubmitForm(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_onSubmitForm
...
* \_preFirstRender(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_preFirstRender
...
* \_prepareSubmitData(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_prepareSubmitData
...
* \_prepareTabs(group: string): Record<string, [ApplicationTab](../interfaces/foundry.applications.types.ApplicationTab.md)>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_prepareTabs
...
* \_prePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_prePosition
...
* \_preRender(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_preRender
...
* \_processFormData(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_processFormData
...
* \_processSubmitData(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_processSubmitData
...
* \_refit(positionUpdate?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_refit
...
* \_removeElement(element: HTMLElement): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_removeElement
...
* \_renderFrameButtons(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_renderFrameButtons
...
* \_renderHeaderControl(control: [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)): HTMLLIElement
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_renderHeaderControl
...
* \_replaceHTML(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_replaceHTML
...
* \_resetPreview(): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_resetPreview
...
* \_tearDown(options: [ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_tearDown
...
* \_toggleDisabled(disabled: boolean): void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_toggleDisabled
...
* \_updateFrame(  
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_updateFrame
...
* \_updatePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).\_updatePosition
...
* inheritanceChain(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), void, unknown>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).inheritanceChain
...
* instances(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), any, any>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).instances
...
* parseCSSDimension(style: string, parentDimension: number): number | void
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).parseCSSDimension
...
* waitForImages(element: HTMLElement): Promise<void>
  ...
  Inherited from PlaceablePaletteMixin(AmbientLightConfig).waitForImages