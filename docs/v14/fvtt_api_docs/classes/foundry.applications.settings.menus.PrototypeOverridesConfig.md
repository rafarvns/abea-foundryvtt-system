---
title: "PrototypeOverridesConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.settings.menus.PrototypeOverridesConfig.html"
category: "classes"
---

# Class PrototypeOverridesConfig

A submenu for managing user overrides of PrototypeTokens

#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.settings.menus.PrototypeOverridesConfig))

* [HandlebarsApplication](foundry.HandlebarsApplication.md)<this>
  + PrototypeOverridesConfig
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â onResetDefaults: (  
...
* \_prepareContext(  
  ...
  Â Â Â Â {  
  Â Â Â Â Â Â Â Â booleanOptions: { false: string; true: string };  
  Â Â Â Â Â Â Â Â buttons: [FormFooterButton](../interfaces/foundry.applications.types.FormFooterButton.md)[];  
  Â Â Â Â Â Â Â Â displayModes: any;  
  Â Â Â Â Â Â Â Â dispositions: any;  
  Â Â Â Â Â Â Â Â rootId: string;  
  Â Â Â Â Â Â Â Â tabClasses: string;  
  Â Â Â Â Â Â Â Â tabs: Record<string, [ApplicationTab](../interfaces/foundry.applications.types.ApplicationTab.md)>;  
  Â Â Â Â Â Â Â Â turnMarkerAnimations: { label: string; value: string }[];  
  Â Â Â Â Â Â Â Â turnMarkerModes: any;  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â booleanOptions: { false: string; true: string }; Â Â Â Â Â Â Â Â buttons: [FormFooterButton](../interfaces/foundry.applications.types.FormFooterButton.md)[]; Â Â Â Â Â Â Â Â displayModes: any; Â Â Â Â Â Â Â Â dispositions: any; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â tabClasses: string; Â Â Â Â Â Â Â Â tabs: Record<string, [ApplicationTab](../interfaces/foundry.applications.types.ApplicationTab.md)>; Â Â Â Â Â Â Â Â turnMarkerAnimations: { label: string; value: string }[]; Â Â Â Â Â Â Â Â turnMarkerModes: any; Â Â Â Â }, >
...
* close(  
  ...
  ): Promise<PrototypeOverridesConfig>
  ...
  #### Returns Promise<PrototypeOverridesConfig>
