---
title: "TileDocument | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.TileDocument.html"
category: "classes"
---
...
* [foundry.documents.Scene](foundry.documents.Scene.md): The Scene document type which contains Tile documents
* [foundry.applications.sheets.TileConfig](foundry.applications.sheets.TileConfig.md): The Tile configuration application

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.TileDocument))

* [BaseTile](foundry.documents.BaseTile.md)<this>
  + TileDocument
...
* new TileDocument(  
  Â Â Â Â data?: Partial<[TileData](../interfaces/foundry.documents.types.TileData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): TileDocument

  #### Parameters

  + `Optional`data: Partial<[TileData](../interfaces/foundry.documents.types.TileData.md)> = {}
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[constructor](foundry.documents.BaseTile.md#constructor)

## Properties

### \_source

\_source: [TileData](../interfaces/foundry.documents.types.TileData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_source](foundry.documents.BaseTile.md#_source)
...
Inherited from [BaseTile](foundry.documents.BaseTile.md).[parent](foundry.documents.BaseTile.md#parent)

### shape

shape: [data](../modules/foundry.data.md).[RectangleShapeData](foundry.data.RectangleShapeData.md) = ...
...
Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_schema](foundry.documents.BaseTile.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseTile](foundry.documents.BaseTile.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseTile.md#localization_prefixes)
...
Inherited from [BaseTile](foundry.documents.BaseTile.md).[metadata](foundry.documents.BaseTile.md#metadata)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_configure](foundry.documents.BaseTile.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_getParentCollection](foundry.documents.BaseTile.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_initializationOrder](foundry.documents.BaseTile.md#_initializationorder)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_updateDiff](foundry.documents.BaseTile.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[canUserModify](foundry.documents.BaseTile.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[clone](foundry.documents.BaseTile.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[createEmbeddedDocuments](foundry.documents.BaseTile.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[delete](foundry.documents.BaseTile.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[deleteEmbeddedDocuments](foundry.documents.BaseTile.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[getEmbeddedCollection](foundry.documents.BaseTile.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[getEmbeddedDocument](foundry.documents.BaseTile.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[getFieldForProperty](foundry.documents.BaseTile.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[getFlag](foundry.documents.BaseTile.md#getflag)
...
* getUserLevel(user: any): any
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[getUserLevel](foundry.documents.BaseTile.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[migrateSystemData](foundry.documents.BaseTile.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[reset](foundry.documents.BaseTile.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[setFlag](foundry.documents.BaseTile.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[testUserPermission](foundry.documents.BaseTile.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[toJSON](foundry.documents.BaseTile.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[toObject](foundry.documents.BaseTile.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[traverseEmbeddedDocuments](foundry.documents.BaseTile.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[unsetFlag](foundry.documents.BaseTile.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[update](foundry.documents.BaseTile.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[updateEmbeddedDocuments](foundry.documents.BaseTile.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[updateSource](foundry.documents.BaseTile.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[validate](foundry.documents.BaseTile.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_getInnerModel](foundry.documents.BaseTile.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_initialize](foundry.documents.BaseTile.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_initializeSource](foundry.documents.BaseTile.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_onCreate](foundry.documents.BaseTile.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_onDelete](foundry.documents.BaseTile.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_onUpdate](foundry.documents.BaseTile.md#_onupdate)
...
* \_preCreate(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_preCreate](foundry.documents.BaseTile.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_preDelete](foundry.documents.BaseTile.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_preUpdate](foundry.documents.BaseTile.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_preUpdateSource](foundry.documents.BaseTile.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_updateCommit](foundry.documents.BaseTile.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_addDataFieldMigration](foundry.documents.BaseTile.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_addDataFieldShim](foundry.documents.BaseTile.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_addDataFieldShims](foundry.documents.BaseTile.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_clearFieldsRecursively](foundry.documents.BaseTile.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_logDataFieldMigration](foundry.documents.BaseTile.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_preCleanData](foundry.documents.BaseTile.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[canUserCreate](foundry.documents.BaseTile.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[cleanData](foundry.documents.BaseTile.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[create](foundry.documents.BaseTile.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[createDocuments](foundry.documents.BaseTile.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â occlusion: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â restrictions: [SchemaField](foundry.data.fields.SchemaField.md);  
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â alpha: [AlphaField](foundry.data.fields.AlphaField.md); Â Â Â Â elevation: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â height: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â hidden: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â levels: [SceneLevelsSetField](foundry.data.fields.SceneLevelsSetField.md); Â Â Â Â locked: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â occlusion: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â restrictions: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â rotation: [AngleField](foundry.data.fields.AngleField.md); Â Â Â Â sort: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â texture: [TextureData](foundry.data.TextureData.md); Â Â Â Â video: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â width: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â x: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â y: [NumberField](foundry.data.fields.NumberField.md); }
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[defineSchema](foundry.documents.BaseTile.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[deleteDocuments](foundry.documents.BaseTile.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[fromJSON](foundry.documents.BaseTile.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[fromSource](foundry.documents.BaseTile.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[get](foundry.documents.BaseTile.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[getCollectionName](foundry.documents.BaseTile.md#getcollectionname)
...
* migrateData(data: any, options: any): object
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[migrateData](foundry.documents.BaseTile.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[migrateDataSafe](foundry.documents.BaseTile.md#migratedatasafe)
...
* shimData(data: any, options: any): object
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[shimData](foundry.documents.BaseTile.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[updateDocuments](foundry.documents.BaseTile.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[validateJoint](foundry.documents.BaseTile.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_cleanData](foundry.documents.BaseTile.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_onCreateOperation](foundry.documents.BaseTile.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_onDeleteOperation](foundry.documents.BaseTile.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_onUpdateOperation](foundry.documents.BaseTile.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_preCreateOperation](foundry.documents.BaseTile.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_preDeleteOperation](foundry.documents.BaseTile.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseTile](foundry.documents.BaseTile.md).[\_preUpdateOperation](foundry.documents.BaseTile.md#_preupdateoperation)