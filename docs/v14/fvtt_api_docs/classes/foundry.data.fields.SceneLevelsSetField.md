---
title: "SceneLevelsSetField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.SceneLevelsSetField.html"
category: "classes"
---

# Class SceneLevelsSetField

A nullable set field used to reference a set of specific Scene Level documents.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.SceneLevelsSetField))
...
* new SceneLevelsSetField(  
  ...
  #### Returns SceneLevelsSetField

  Overrides [SetField](foundry.data.fields.SetField.md).[constructor](foundry.data.fields.SetField.md#constructor)
...
* get fieldPath(): string
  ...
  Inherited from SetField.fieldPath
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & {  
  ...
  } & { initial: never[]; required: boolean }

  Default parameters for this field type

  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { Â Â Â Â empty: boolean; Â Â Â Â exact: undefined; Â Â Â Â max: number; Â Â Â Â min: number; Â Â Â Â nullable: boolean; Â Â Â Â required: boolean; } & { initial: never[]; required: boolean }

  Overrides SetField.\_defaults
...
* get hasFormSupport(): boolean
  ...
  Inherited from SetField.hasFormSupport
...
* \_validateModel(changes: any, options: any): void
  ...
  Inherited from [SetField](foundry.data.fields.SetField.md).[\_validateModel](foundry.data.fields.SetField.md#_validatemodel)
...
* initialize(value: any, model: any, options?: {}): any
  ...
  Inherited from [SetField](foundry.data.fields.SetField.md).[initialize](foundry.data.fields.SetField.md#initialize)
...
* \_cleanElement(  
  ...
  Inherited from [SetField](foundry.data.fields.SetField.md).[\_cleanElement](foundry.data.fields.SetField.md#_cleanelement)
