---
title: "Macro | Foundry Virtual Tabletop - API Documentation - Version 14"
...
* [foundry.documents.collections.Macros](foundry.documents.collections.Macros.md): The world-level collection of Macro documents
* [foundry.applications.sheets.MacroConfig](foundry.applications.sheets.MacroConfig.md): The Macro configuration application

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.Macro))

* [BaseMacro](foundry.documents.BaseMacro.md)<this>
  + Macro
...
* new Macro(  
  Â Â Â Â data?: Partial<[MacroData](../interfaces/foundry.documents.types.MacroData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).Macro

  #### Parameters

  + `Optional`data: Partial<[MacroData](../interfaces/foundry.documents.types.MacroData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).Macro

  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[constructor](foundry.documents.BaseMacro.md#constructor)

## Properties

### \_source

\_source: [MacroData](../interfaces/foundry.documents.types.MacroData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_source](foundry.documents.BaseMacro.md#_source)
...
Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[parent](foundry.documents.BaseMacro.md#parent)
...
Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_schema](foundry.documents.BaseMacro.md#_schema)
...
Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[DEFAULT\_ICON](foundry.documents.BaseMacro.md#default_icon)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseMacro.md#localization_prefixes)
...
Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[metadata](foundry.documents.BaseMacro.md#metadata)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_configure](foundry.documents.BaseMacro.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_getParentCollection](foundry.documents.BaseMacro.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_initializationOrder](foundry.documents.BaseMacro.md#_initializationorder)
...
* \_initialize(options: any): void
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_initialize](foundry.documents.BaseMacro.md#_initialize)
...
* \_onCreate(data: any, options: any, userId: any): void
  ...
  Overrides [BaseMacro](foundry.documents.BaseMacro.md).[\_onCreate](foundry.documents.BaseMacro.md#_oncreate)
...
* \_preCreate(data: any, options: any, user: any): Promise<false | undefined>
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_preCreate](foundry.documents.BaseMacro.md#_precreate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_updateDiff](foundry.documents.BaseMacro.md#_updatediff)

### canUserExecute

* canUserExecute(user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)): boolean
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[canUserModify](foundry.documents.BaseMacro.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[clone](foundry.documents.BaseMacro.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[createEmbeddedDocuments](foundry.documents.BaseMacro.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[delete](foundry.documents.BaseMacro.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[deleteEmbeddedDocuments](foundry.documents.BaseMacro.md#deleteembeddeddocuments)
...
* execute(  
  ...
  Â Â Â Â Â Â Â Â event?: Event | [RegionEvent](../interfaces/foundry.documents.types.RegionEvent.md);  
  ...
  + `Optional`scope: { actor?: any; event?: Event | [RegionEvent](../interfaces/foundry.documents.types.RegionEvent.md); speaker?: any; token?: any } = {}
    ...
    - ##### `Optional`event?: Event | [RegionEvent](../interfaces/foundry.documents.types.RegionEvent.md)
  ...
  A promise containing a created [foundry.documents.ChatMessage](foundry.documents.ChatMessage.md)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[getEmbeddedCollection](foundry.documents.BaseMacro.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[getEmbeddedDocument](foundry.documents.BaseMacro.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[getFieldForProperty](foundry.documents.BaseMacro.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[getFlag](foundry.documents.BaseMacro.md#getflag)
...
* getUserLevel(user: any): any
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[getUserLevel](foundry.documents.BaseMacro.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[migrateSystemData](foundry.documents.BaseMacro.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[reset](foundry.documents.BaseMacro.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[setFlag](foundry.documents.BaseMacro.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[testUserPermission](foundry.documents.BaseMacro.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[toJSON](foundry.documents.BaseMacro.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[toObject](foundry.documents.BaseMacro.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[traverseEmbeddedDocuments](foundry.documents.BaseMacro.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[unsetFlag](foundry.documents.BaseMacro.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[update](foundry.documents.BaseMacro.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[updateEmbeddedDocuments](foundry.documents.BaseMacro.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[updateSource](foundry.documents.BaseMacro.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[validate](foundry.documents.BaseMacro.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_getInnerModel](foundry.documents.BaseMacro.md#_getinnermodel)
...
* \_initializeSource(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_initializeSource](foundry.documents.BaseMacro.md#_initializesource)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_onDelete](foundry.documents.BaseMacro.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_onUpdate](foundry.documents.BaseMacro.md#_onupdate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_preDelete](foundry.documents.BaseMacro.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_preUpdate](foundry.documents.BaseMacro.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_preUpdateSource](foundry.documents.BaseMacro.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_updateCommit](foundry.documents.BaseMacro.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_addDataFieldMigration](foundry.documents.BaseMacro.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_addDataFieldShim](foundry.documents.BaseMacro.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_addDataFieldShims](foundry.documents.BaseMacro.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_clearFieldsRecursively](foundry.documents.BaseMacro.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_logDataFieldMigration](foundry.documents.BaseMacro.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_preCleanData](foundry.documents.BaseMacro.md#_precleandata)
...
* canUserCreate(user: any): any
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[canUserCreate](foundry.documents.BaseMacro.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[cleanData](foundry.documents.BaseMacro.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[create](foundry.documents.BaseMacro.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[createDocuments](foundry.documents.BaseMacro.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â command: [StringField](foundry.data.fields.StringField.md);  
  ...
  Â Â Â Â scope: [StringField](foundry.data.fields.StringField.md);  
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â author: [DocumentAuthorField](foundry.data.fields.DocumentAuthorField.md); Â Â Â Â command: [StringField](foundry.data.fields.StringField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â folder: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); Â Â Â Â img: [FilePathField](foundry.data.fields.FilePathField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â ownership: [DocumentOwnershipField](foundry.data.fields.DocumentOwnershipField.md); Â Â Â Â scope: [StringField](foundry.data.fields.StringField.md); Â Â Â Â sort: [IntegerSortField](foundry.data.fields.IntegerSortField.md); Â Â Â Â type: [DocumentTypeField](foundry.data.fields.DocumentTypeField.md); }
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[defineSchema](foundry.documents.BaseMacro.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[deleteDocuments](foundry.documents.BaseMacro.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[fromJSON](foundry.documents.BaseMacro.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[fromSource](foundry.documents.BaseMacro.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[get](foundry.documents.BaseMacro.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[getCollectionName](foundry.documents.BaseMacro.md#getcollectionname)
...
* migrateData(source: any, options: any): object
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[migrateData](foundry.documents.BaseMacro.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[migrateDataSafe](foundry.documents.BaseMacro.md#migratedatasafe)
...
* shimData(source: any, options: any): object
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[shimData](foundry.documents.BaseMacro.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[updateDocuments](foundry.documents.BaseMacro.md#updatedocuments)
...
* validateJoint(data: any): void
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[validateJoint](foundry.documents.BaseMacro.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_cleanData](foundry.documents.BaseMacro.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_onCreateOperation](foundry.documents.BaseMacro.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_onDeleteOperation](foundry.documents.BaseMacro.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_onUpdateOperation](foundry.documents.BaseMacro.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_preCreateOperation](foundry.documents.BaseMacro.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_preDeleteOperation](foundry.documents.BaseMacro.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseMacro](foundry.documents.BaseMacro.md).[\_preUpdateOperation](foundry.documents.BaseMacro.md#_preupdateoperation)