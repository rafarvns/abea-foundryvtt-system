---
title: "Combatant | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.Combatant.html"
category: "classes"
---
...
* [foundry.applications.sheets.CombatantConfig](foundry.applications.sheets.CombatantConfig.md): The application which configures a
  Combatant

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.Combatant))

* [BaseCombatant](foundry.documents.BaseCombatant.md)<this>
  + Combatant
...
* new Combatant(  
  Â Â Â Â data?: Partial<[CombatantData](../interfaces/foundry.documents.types.CombatantData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).Combatant

  #### Parameters

  + `Optional`data: Partial<[CombatantData](../interfaces/foundry.documents.types.CombatantData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).Combatant

  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[constructor](foundry.documents.BaseCombatant.md#constructor)

## Properties

### \_source

\_source: [CombatantData](../interfaces/foundry.documents.types.CombatantData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_source](foundry.documents.BaseCombatant.md#_source)
...
Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[parent](foundry.documents.BaseCombatant.md#parent)
...
Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_schema](foundry.documents.BaseCombatant.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseCombatant.md#localization_prefixes)
...
Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[metadata](foundry.documents.BaseCombatant.md#metadata)
...
* get players(): [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)[]
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_configure](foundry.documents.BaseCombatant.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_getParentCollection](foundry.documents.BaseCombatant.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_initializationOrder](foundry.documents.BaseCombatant.md#_initializationorder)
...
* \_preCreate(data: any, options: any, user: any): Promise<void>
  ...
  Overrides [BaseCombatant](foundry.documents.BaseCombatant.md).[\_preCreate](foundry.documents.BaseCombatant.md#_precreate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_updateDiff](foundry.documents.BaseCombatant.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[canUserModify](foundry.documents.BaseCombatant.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[clone](foundry.documents.BaseCombatant.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[createEmbeddedDocuments](foundry.documents.BaseCombatant.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[delete](foundry.documents.BaseCombatant.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[deleteEmbeddedDocuments](foundry.documents.BaseCombatant.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[getEmbeddedCollection](foundry.documents.BaseCombatant.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[getEmbeddedDocument](foundry.documents.BaseCombatant.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[getFieldForProperty](foundry.documents.BaseCombatant.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[getFlag](foundry.documents.BaseCombatant.md#getflag)

### getInitiativeRoll

* getInitiativeRoll(formula: string): [Roll](foundry.dice.Roll.md)
  ...
  #### Returns [Roll](foundry.dice.Roll.md)
...
* getUserLevel(user: any): any
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[getUserLevel](foundry.documents.BaseCombatant.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[migrateSystemData](foundry.documents.BaseCombatant.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[reset](foundry.documents.BaseCombatant.md#reset)

### rollInitiative

* rollInitiative(formula?: string): Promise<[documents](../modules/foundry.documents.md).Combatant>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).Combatant>
...
* setFlag(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[setFlag](foundry.documents.BaseCombatant.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[testUserPermission](foundry.documents.BaseCombatant.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[toJSON](foundry.documents.BaseCombatant.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[toObject](foundry.documents.BaseCombatant.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[traverseEmbeddedDocuments](foundry.documents.BaseCombatant.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[unsetFlag](foundry.documents.BaseCombatant.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[update](foundry.documents.BaseCombatant.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[updateEmbeddedDocuments](foundry.documents.BaseCombatant.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[updateSource](foundry.documents.BaseCombatant.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[validate](foundry.documents.BaseCombatant.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_getInnerModel](foundry.documents.BaseCombatant.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_initialize](foundry.documents.BaseCombatant.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_initializeSource](foundry.documents.BaseCombatant.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_onCreate](foundry.documents.BaseCombatant.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_onDelete](foundry.documents.BaseCombatant.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_onUpdate](foundry.documents.BaseCombatant.md#_onupdate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_preDelete](foundry.documents.BaseCombatant.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_preUpdate](foundry.documents.BaseCombatant.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_preUpdateSource](foundry.documents.BaseCombatant.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_updateCommit](foundry.documents.BaseCombatant.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_addDataFieldMigration](foundry.documents.BaseCombatant.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_addDataFieldShim](foundry.documents.BaseCombatant.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_addDataFieldShims](foundry.documents.BaseCombatant.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_clearFieldsRecursively](foundry.documents.BaseCombatant.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_logDataFieldMigration](foundry.documents.BaseCombatant.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_preCleanData](foundry.documents.BaseCombatant.md#_precleandata)
...
* \_preCreateOperation(documents: any, operation: any, \_user: any): Promise<void>
  ...
  Overrides [BaseCombatant](foundry.documents.BaseCombatant.md).[\_preCreateOperation](foundry.documents.BaseCombatant.md#_precreateoperation)
...
* \_preDeleteOperation(\_documents: any, operation: any, \_user: any): Promise<void>
  ...
  Overrides [BaseCombatant](foundry.documents.BaseCombatant.md).[\_preDeleteOperation](foundry.documents.BaseCombatant.md#_predeleteoperation)
...
* \_preUpdateOperation(\_documents: any, operation: any, \_user: any): Promise<void>
  ...
  Overrides [BaseCombatant](foundry.documents.BaseCombatant.md).[\_preUpdateOperation](foundry.documents.BaseCombatant.md#_preupdateoperation)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[canUserCreate](foundry.documents.BaseCombatant.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[cleanData](foundry.documents.BaseCombatant.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[create](foundry.documents.BaseCombatant.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[createDocuments](foundry.documents.BaseCombatant.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â defeated: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md);  
  Â Â Â Â group: [DocumentIdField](foundry.data.fields.DocumentIdField.md);  
  ...
  Â Â Â Â roundJoined: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â sceneId: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md);  
  Â Â Â Â system: [TypeDataField](foundry.data.fields.TypeDataField.md);  
  Â Â Â Â tokenId: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md);  
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â actorId: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); Â Â Â Â defeated: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â group: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â hidden: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â img: [FilePathField](foundry.data.fields.FilePathField.md); Â Â Â Â initiative: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â roundJoined: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â sceneId: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); Â Â Â Â system: [TypeDataField](foundry.data.fields.TypeDataField.md); Â Â Â Â tokenId: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); Â Â Â Â type: [DocumentTypeField](foundry.data.fields.DocumentTypeField.md); }
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[defineSchema](foundry.documents.BaseCombatant.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[deleteDocuments](foundry.documents.BaseCombatant.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[fromJSON](foundry.documents.BaseCombatant.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[fromSource](foundry.documents.BaseCombatant.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[get](foundry.documents.BaseCombatant.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[getCollectionName](foundry.documents.BaseCombatant.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[migrateData](foundry.documents.BaseCombatant.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[migrateDataSafe](foundry.documents.BaseCombatant.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[shimData](foundry.documents.BaseCombatant.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[updateDocuments](foundry.documents.BaseCombatant.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[validateJoint](foundry.documents.BaseCombatant.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_cleanData](foundry.documents.BaseCombatant.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_onCreateOperation](foundry.documents.BaseCombatant.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_onDeleteOperation](foundry.documents.BaseCombatant.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseCombatant](foundry.documents.BaseCombatant.md).[\_onUpdateOperation](foundry.documents.BaseCombatant.md#_onupdateoperation)