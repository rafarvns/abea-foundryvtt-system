---
title: "DefineSurfaceRegionBehaviorType | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.regionBehaviors.DefineSurfaceRegionBehaviorType.html"
category: "classes"
---

# Class DefineSurfaceRegionBehaviorType

The data model for a behavior that defines surface(s) that can restrict light, movement, sight, and sound.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.regionBehaviors.DefineSurfaceRegionBehaviorType))

* [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.md)
  + DefineSurfaceRegionBehaviorType
...
* new DefineSurfaceRegionBehaviorType(  
  Â Â Â Â data?: {},  
  Â Â Â Â options?: {},  
  ): DefineSurfaceRegionBehaviorType
  ...
  #### Returns DefineSurfaceRegionBehaviorType
...
events: {  
Â Â Â Â behaviorActivated: (  
Â Â Â Â Â Â Â Â this: DefineSurfaceRegionBehaviorType,  
Â Â Â Â Â Â Â Â event: [RegionBehaviorActivatedEvent](../types/foundry.documents.types.RegionBehaviorActivatedEvent.md),  
Â Â Â Â ) => Promise<void>;  
Â Â Â Â behaviorDeactivated: (  
Â Â Â Â Â Â Â Â this: DefineSurfaceRegionBehaviorType,  
Â Â Â Â Â Â Â Â event: [RegionBehaviorDeactivatedEvent](../types/foundry.documents.types.RegionBehaviorDeactivatedEvent.md),  
Â Â Â Â ) => Promise<void>;  
...
* ##### behaviorActivated: ( Â Â Â Â this: DefineSurfaceRegionBehaviorType, Â Â Â Â event: [RegionBehaviorActivatedEvent](../types/foundry.documents.types.RegionBehaviorActivatedEvent.md), ) => Promise<void>
* ##### behaviorDeactivated: ( Â Â Â Â this: DefineSurfaceRegionBehaviorType, Â Â Â Â event: [RegionBehaviorDeactivatedEvent](../types/foundry.documents.types.RegionBehaviorDeactivatedEvent.md), ) => Promise<void>
* ##### behaviorUnviewed: ( Â Â Â Â this: DefineSurfaceRegionBehaviorType, Â Â Â Â event: [RegionBehaviorUnviewedEvent](../types/foundry.documents.types.RegionBehaviorUnviewedEvent.md), ) => Promise<void>
* ##### behaviorViewed: ( Â Â Â Â this: DefineSurfaceRegionBehaviorType, Â Â Â Â event: [RegionBehaviorViewedEvent](../types/foundry.documents.types.RegionBehaviorViewedEvent.md), ) => Promise<void>
* ##### regionBoundary: ( Â Â Â Â this: DefineSurfaceRegionBehaviorType, Â Â Â Â event: RegionRegionBoundryEvent, ) => Promise<void>
...
* prepareBaseData(): void
  ...
  Inherited from [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.md).[prepareBaseData](foundry.data.regionBehaviors.RegionBehaviorType.md#preparebasedata)
...
* \_getTerrainEffects<[TerrainEffect](#_getterraineffectsterraineffect)>(  
  ...
  ): [TerrainEffect](foundry.data.regionBehaviors.RegionBehaviorType.md#_getterraineffectsterraineffect)[]
  ...
  #### Returns [TerrainEffect](foundry.data.regionBehaviors.RegionBehaviorType.md#_getterraineffectsterraineffect)[]

  The terrain effects that apply to this token's movement

  Inherited from [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.md).[\_getTerrainEffects](foundry.data.regionBehaviors.RegionBehaviorType.md#_getterraineffects)
...
* defineSchema(): {  
  Â Â Â Â culling: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â exposure: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â light: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â move: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â occlusion: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â placement: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â sight: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â sound: [BooleanField](foundry.data.fields.BooleanField.md);  
  }

  #### Returns { Â Â Â Â culling: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â exposure: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â light: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â move: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â occlusion: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â placement: [StringField](foundry.data.fields.StringField.md); Â Â Â Â sight: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â sound: [BooleanField](foundry.data.fields.BooleanField.md); }
