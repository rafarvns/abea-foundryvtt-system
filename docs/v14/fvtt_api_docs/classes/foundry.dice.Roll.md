---
title: "Roll | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.dice.Roll.html"
category: "classes"
---
...
[options](#options)
[terms](#terms)
[CHAT\_TEMPLATE](#chat_template)
[DICE\_CONFIGURATION\_SETTING](#dice_configuration_setting)
[MATH\_PROXY](#math_proxy)
[RESOLVERS](#resolvers)
[TOOLTIP\_TEMPLATE](#tooltip_template)
...
[resolverImplementation](#resolverimplementation)
...
[propagateFlavor](#propagateflavor)
[render](#render)
[reroll](#reroll)
...
[toString](#tostring)
[\_evaluate](#_evaluate)
[\_evaluateASTAsync](#_evaluateastasync)
[\_evaluateASTSync](#_evaluateastsync)
[\_evaluateSync](#_evaluatesync)
[\_evaluateTotal](#_evaluatetotal)
[\_prepareChatRenderContext](#_preparechatrendercontext)
[\_prepareData](#_preparedata)
[\_classifyStringTerm](#_classifystringterm)
[\_mapLegacyRollMode](#_maplegacyrollmode)
[collapseInlineResult](#collapseinlineresult)
[create](#create)
[expandInlineResult](#expandinlineresult)
[fromData](#fromdata)
[fromJSON](#fromjson)
[fromTerms](#fromterms)
[getFormula](#getformula)
[identifyFulfillableTerms](#identifyfulfillableterms)
[instantiateAST](#instantiateast)
[parse](#parse)
...
* new Roll(formula?: string, data?: object, options?: [RollOptions](../types/foundry.dice.RollOptions.md)): Roll
  ...
  + `Optional`options: [RollOptions](../types/foundry.dice.RollOptions.md) = {}
...
\_dice: [DiceTerm](foundry.dice.terms.DiceTerm.md)[] = []
...
\_resolver: [RollResolver](foundry.applications.dice.RollResolver.md)
...
RESOLVERS: Map<Roll, [RollResolver](foundry.applications.dice.RollResolver.md)> = ...
...
* get resolverImplementation(): typeof [RollResolver](foundry.applications.dice.RollResolver.md)

  Retrieve the appropriate resolver implementation based on the user's configuration.

  #### Returns typeof [RollResolver](foundry.applications.dice.RollResolver.md)
...
* toMessage(  
  ...
  Â Â Â Â options?: { create?: boolean; messageMode?: string },  
  ): Promise<any>
  ...
  + `Optional`options: { create?: boolean; messageMode?: string } = {}
...
* \_evaluateASTAsync(  
  Â Â Â Â node: [RollParseNode](../interfaces/foundry.dice.RollParseNode.md) | [RollTerm](foundry.dice.terms.RollTerm.md),  
  Â Â Â Â options?: {  
  Â Â Â Â Â Â Â Â allowStrings?: boolean;  
  Â Â Â Â Â Â Â Â maximize?: boolean;  
  Â Â Â Â Â Â Â Â minimize?: boolean;  
  ...
  + node: [RollParseNode](../interfaces/foundry.dice.RollParseNode.md) | [RollTerm](foundry.dice.terms.RollTerm.md)
...
* \_classifyStringTerm(  
  ...
  Â Â Â Â Â Â Â Â next?: string | [RollTerm](foundry.dice.terms.RollTerm.md);  
  Â Â Â Â Â Â Â Â prior?: string | [RollTerm](foundry.dice.terms.RollTerm.md);  
  Â Â Â Â },  
  ...
  + `Optional`options: { intermediate?: boolean; next?: string | [RollTerm](foundry.dice.terms.RollTerm.md); prior?: string | [RollTerm](foundry.dice.terms.RollTerm.md) } = {}
    ...
    - ##### `Optional`next?: string | [RollTerm](foundry.dice.terms.RollTerm.md)

      The next term to classify
    - ##### `Optional`prior?: string | [RollTerm](foundry.dice.terms.RollTerm.md)
...
* create(formula: string, data?: object, options?: object): Roll
...
* fromTerms(terms: [RollTerm](foundry.dice.terms.RollTerm.md)[], options?: object): Roll
...
* getFormula(terms: [RollTerm](foundry.dice.terms.RollTerm.md)[]): string
...
* identifyFulfillableTerms(terms: [RollTerm](foundry.dice.terms.RollTerm.md)[]): [DiceTerm](foundry.dice.terms.DiceTerm.md)[]
...
* instantiateAST(ast: [RollParseNode](../interfaces/foundry.dice.RollParseNode.md)): [RollTerm](foundry.dice.terms.RollTerm.md)[]

  Instantiate the nodes in an AST sub-tree into RollTerm instances.

  #### Parameters

  + ast: [RollParseNode](../interfaces/foundry.dice.RollParseNode.md)
...
* parse(formula?: string, data?: object): [RollTerm](foundry.dice.terms.RollTerm.md)[]
...
* replaceFormulaData(  
  ...
  Â Â Â Â data: object,  
  Â Â Â Â options?: [ReplaceFormulaDataOptions](../interfaces/foundry.dice.ReplaceFormulaDataOptions.md),  
  Â Â Â Â \_r?: number,  
  ): string
  ...
  + `Optional`options: [ReplaceFormulaDataOptions](../interfaces/foundry.dice.ReplaceFormulaDataOptions.md) = {}
...
* simplifyTerms(terms: [RollTerm](foundry.dice.terms.RollTerm.md)[]): [RollTerm](foundry.dice.terms.RollTerm.md)[]
