---
title: "Item | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.Item.html"
category: "classes"
---
...
* [foundry.documents.collections.Items](foundry.documents.collections.Items.md): The world-level collection of Item documents
* [foundry.applications.sheets.ItemSheet](foundry.applications.sheets.ItemSheetV2.md): The Item configuration application

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.Item))

* [BaseItem](foundry.documents.BaseItem.md)<this>
  + Item
...
* new Item(  
  Â Â Â Â data?: Partial<[ItemData](../interfaces/foundry.documents.types.ItemData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).Item

  #### Parameters

  + `Optional`data: Partial<[ItemData](../interfaces/foundry.documents.types.ItemData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).Item

  Inherited from [BaseItem](foundry.documents.BaseItem.md).[constructor](foundry.documents.BaseItem.md#constructor)

## Properties

### \_source

\_source: [ItemData](../interfaces/foundry.documents.types.ItemData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_source](foundry.documents.BaseItem.md#_source)
...
Inherited from [BaseItem](foundry.documents.BaseItem.md).[parent](foundry.documents.BaseItem.md#parent)
...
Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_schema](foundry.documents.BaseItem.md#_schema)
...
Inherited from [BaseItem](foundry.documents.BaseItem.md).[DEFAULT\_ICON](foundry.documents.BaseItem.md#default_icon)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseItem](foundry.documents.BaseItem.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseItem.md#localization_prefixes)
...
Inherited from [BaseItem](foundry.documents.BaseItem.md).[metadata](foundry.documents.BaseItem.md#metadata)
...
* get transferredEffects(): [documents](../modules/foundry.documents.md).[ActiveEffect](foundry.documents.ActiveEffect.md)[]
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_configure](foundry.documents.BaseItem.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_getParentCollection](foundry.documents.BaseItem.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_initializationOrder](foundry.documents.BaseItem.md#_initializationorder)
...
* \_initialize(options: any): void
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_initialize](foundry.documents.BaseItem.md#_initialize)
...
* \_initializeSource(source: any, options?: {}): object
  ...
  Overrides [BaseItem](foundry.documents.BaseItem.md).[\_initializeSource](foundry.documents.BaseItem.md#_initializesource)
...
* \_onDelete(options: any, userId: any): void
  ...
  Overrides [BaseItem](foundry.documents.BaseItem.md).[\_onDelete](foundry.documents.BaseItem.md#_ondelete)
...
* \_preCreate(data: any, options: any, user: any): Promise<boolean | void>
  ...
  Overrides [BaseItem](foundry.documents.BaseItem.md).[\_preCreate](foundry.documents.BaseItem.md#_precreate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_updateDiff](foundry.documents.BaseItem.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[canUserModify](foundry.documents.BaseItem.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[clone](foundry.documents.BaseItem.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[createEmbeddedDocuments](foundry.documents.BaseItem.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[delete](foundry.documents.BaseItem.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[deleteEmbeddedDocuments](foundry.documents.BaseItem.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[getEmbeddedCollection](foundry.documents.BaseItem.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[getEmbeddedDocument](foundry.documents.BaseItem.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[getFieldForProperty](foundry.documents.BaseItem.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[getFlag](foundry.documents.BaseItem.md#getflag)
...
* getUserLevel(user: any): any
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[getUserLevel](foundry.documents.BaseItem.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[migrateSystemData](foundry.documents.BaseItem.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[reset](foundry.documents.BaseItem.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[setFlag](foundry.documents.BaseItem.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[testUserPermission](foundry.documents.BaseItem.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[toJSON](foundry.documents.BaseItem.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[toObject](foundry.documents.BaseItem.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[traverseEmbeddedDocuments](foundry.documents.BaseItem.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[unsetFlag](foundry.documents.BaseItem.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[update](foundry.documents.BaseItem.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[updateEmbeddedDocuments](foundry.documents.BaseItem.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[updateSource](foundry.documents.BaseItem.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[validate](foundry.documents.BaseItem.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_getInnerModel](foundry.documents.BaseItem.md#_getinnermodel)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_onCreate](foundry.documents.BaseItem.md#_oncreate)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_onUpdate](foundry.documents.BaseItem.md#_onupdate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_preDelete](foundry.documents.BaseItem.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_preUpdate](foundry.documents.BaseItem.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_preUpdateSource](foundry.documents.BaseItem.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_updateCommit](foundry.documents.BaseItem.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_addDataFieldMigration](foundry.documents.BaseItem.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_addDataFieldShim](foundry.documents.BaseItem.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_addDataFieldShims](foundry.documents.BaseItem.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_clearFieldsRecursively](foundry.documents.BaseItem.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_logDataFieldMigration](foundry.documents.BaseItem.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_preCleanData](foundry.documents.BaseItem.md#_precleandata)
...
* canUserCreate(user: any): any
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[canUserCreate](foundry.documents.BaseItem.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[cleanData](foundry.documents.BaseItem.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[create](foundry.documents.BaseItem.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[createDocuments](foundry.documents.BaseItem.md#createdocuments)
...
* defineSchema(): {  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[defineSchema](foundry.documents.BaseItem.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[deleteDocuments](foundry.documents.BaseItem.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[fromJSON](foundry.documents.BaseItem.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[fromSource](foundry.documents.BaseItem.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[get](foundry.documents.BaseItem.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[getCollectionName](foundry.documents.BaseItem.md#getcollectionname)

### `Static`getDefaultArtwork

* getDefaultArtwork(itemData: [ItemData](../interfaces/foundry.documents.types.ItemData.md)): { img: string }

  Determine default artwork based on the provided item data.

  #### Parameters

  + itemData: [ItemData](../interfaces/foundry.documents.types.ItemData.md)
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[getDefaultArtwork](foundry.documents.BaseItem.md#getdefaultartwork)
...
* migrateData(source: any, options: any): object
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[migrateData](foundry.documents.BaseItem.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[migrateDataSafe](foundry.documents.BaseItem.md#migratedatasafe)
...
* shimData(source: any, options: any): object
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[shimData](foundry.documents.BaseItem.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[updateDocuments](foundry.documents.BaseItem.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[validateJoint](foundry.documents.BaseItem.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_cleanData](foundry.documents.BaseItem.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_onCreateOperation](foundry.documents.BaseItem.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_onDeleteOperation](foundry.documents.BaseItem.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_onUpdateOperation](foundry.documents.BaseItem.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_preCreateOperation](foundry.documents.BaseItem.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_preDeleteOperation](foundry.documents.BaseItem.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseItem](foundry.documents.BaseItem.md).[\_preUpdateOperation](foundry.documents.BaseItem.md#_preupdateoperation)