---
title: "VFXEffect | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.vfx.VFXEffect.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.vfx.VFXEffect))
...
* new VFXEffect(  
  Â Â Â Â data?: Partial<[VFXEffectData](../interfaces/foundry.VFXEffectData.md)>,  
  Â Â Â Â options?: [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md),  
  ): VFXEffect

  #### Parameters

  + `Optional`data: Partial<[VFXEffectData](../interfaces/foundry.VFXEffectData.md)> = {}
...
\_source: [VFXEffectData](../interfaces/foundry.VFXEffectData.md)
...
components: Record<string, [VFXComponent](foundry.canvas.vfx.VFXComponent.md)<any>> = ...
...
* play(references?: Record<string, any>): Promise<boolean>

  Begin playback of a VFXEffect using provided reference data.

  #### Parameters

  + `Optional`references: Record<string, any> = {}

    A record of references used to resolve model data

  #### Returns Promise<boolean>

  A Promise which resolves to signal whether playback fully completed

  #### Throws

  An error if playback from this VFXEffect has already started or if
...
* resolveReferences(references?: Record<string, any>): void
  ...
  This is invoked automatically as part of [VFXEffect#play](#play), after which point all references must be final.
  It can be called manually before [VFXEffect#play](#play) to assume direct control over reference resolution before
  ...
  An error if references were unable to resolve
...
* defineSchema(): {  
  Â Â Â Â components: [TypedObjectField](foundry.data.fields.TypedObjectField.md);  
  Â Â Â Â name: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â timeline: [ArrayField](foundry.data.fields.ArrayField.md)<[SchemaField](foundry.data.fields.SchemaField.md)>;  
  }

  #### Returns { Â Â Â Â components: [TypedObjectField](foundry.data.fields.TypedObjectField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â timeline: [ArrayField](foundry.data.fields.ArrayField.md)<[SchemaField](foundry.data.fields.SchemaField.md)>; }
