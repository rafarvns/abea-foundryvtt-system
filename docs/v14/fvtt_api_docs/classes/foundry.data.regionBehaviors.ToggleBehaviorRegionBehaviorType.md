---
title: "ToggleBehaviorRegionBehaviorType | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.regionBehaviors.ToggleBehaviorRegionBehaviorType.html"
category: "classes"
---

# Class ToggleBehaviorRegionBehaviorType

The data model for a behavior that toggles Region Behaviors when one of the subscribed events occurs.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.regionBehaviors.ToggleBehaviorRegionBehaviorType))
...
* new ToggleBehaviorRegionBehaviorType(  
  ...
  #### Returns ToggleBehaviorRegionBehaviorType
...
* defineSchema(): { disable: [SetField](foundry.data.fields.SetField.md); enable: [SetField](foundry.data.fields.SetField.md); events: [SetField](foundry.data.fields.SetField.md) }

  #### Returns { disable: [SetField](foundry.data.fields.SetField.md); enable: [SetField](foundry.data.fields.SetField.md); events: [SetField](foundry.data.fields.SetField.md) }
...
* validateJoint(data: any): void
  ...
  Overrides [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.md).[validateJoint](foundry.data.regionBehaviors.RegionBehaviorType.md#validatejoint)
