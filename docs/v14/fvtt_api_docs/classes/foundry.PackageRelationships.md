---
title: "PackageRelationships | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.PackageRelationships.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.PackageRelationships))
...
* new PackageRelationships(options: any): PackageRelationships

  #### Parameters

  + options: any

  #### Returns PackageRelationships
...
* \_getField(  
  ...
  ): [DataField](foundry.data.fields.DataField.md) | PackageRelationships | undefined
  ...
  #### Returns [DataField](foundry.data.fields.DataField.md) | PackageRelationships | undefined
