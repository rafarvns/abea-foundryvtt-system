---
title: "FontConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.settings.menus.FontConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.settings.menus.FontConfig))

* [HandlebarsApplication](foundry.HandlebarsApplication.md)<this>
  + FontConfig
...
[\_getDataForDefinition](#_getdatafordefinition)
...
[\_onAddFont](#_onaddfont)
[\_onAttach](#_onattach)
[\_onClickTab](#_onclicktab)
[\_onClose](#_onclose)
[\_onDeleteFont](#_ondeletefont)
[\_onDetach](#_ondetach)
[\_onFirstRender](#_onfirstrender)
[\_onPosition](#_onposition)
[\_onSelectFont](#_onselectfont)
...
[getAvailableFontChoices](#getavailablefontchoices)
...
[\_collectDefinitions](#_collectdefinitions)
[\_createFontFace](#_createfontface)
[\_formatFont](#_formatfont)
...
object: [NewFontDefinition](../interfaces/foundry.NewFontDefinition.md)
...
### `Static` `Readonly`FONT\_TYPES

FONT\_TYPES: [FontTypes](../interfaces/foundry.FontTypes.md) = ...
...
* get parts(): Record<string, HTMLElement>
  ...
  Inherited from HandlebarsApplicationMixin(ApplicationV2).parts
...
* \_prepareContext(  
  ...
  Â Â Â Â {  
  Â Â Â Â Â Â Â Â buttons: { action: string; icon: string; label: string; type: string }[];  
  Â Â Â Â Â Â Â Â font: [NewFontDefinition](../interfaces/foundry.NewFontDefinition.md);  
  Â Â Â Â Â Â Â Â fonts: { family: string; font: string; index: number; selected: boolean }[];  
  Â Â Â Â Â Â Â Â fontStyles: { label: string; value: string }[];  
  Â Â Â Â Â Â Â Â fontWeights: { label: string; value: number }[];  
  Â Â Â Â Â Â Â Â isFileFont: boolean;  
  Â Â Â Â Â Â Â Â isSystemFont: boolean;  
  Â Â Â Â Â Â Â Â preview: {  
  Â Â Â Â Â Â Â Â Â Â Â Â family: any;  
  Â Â Â Â Â Â Â Â Â Â Â Â style: any;  
  Â Â Â Â Â Â Â Â Â Â Â Â text: string | undefined;  
  Â Â Â Â Â Â Â Â Â Â Â Â weight: any;  
  Â Â Â Â Â Â Â Â };  
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â buttons: { action: string; icon: string; label: string; type: string }[]; Â Â Â Â Â Â Â Â font: [NewFontDefinition](../interfaces/foundry.NewFontDefinition.md); Â Â Â Â Â Â Â Â fonts: { family: string; font: string; index: number; selected: boolean }[]; Â Â Â Â Â Â Â Â fontStyles: { label: string; value: string }[]; Â Â Â Â Â Â Â Â fontWeights: { label: string; value: number }[]; Â Â Â Â Â Â Â Â isFileFont: boolean; Â Â Â Â Â Â Â Â isSystemFont: boolean; Â Â Â Â Â Â Â Â preview: { Â Â Â Â Â Â Â Â Â Â Â Â family: any; Â Â Â Â Â Â Â Â Â Â Â Â style: any; Â Â Â Â Â Â Â Â Â Â Â Â text: string | undefined; Â Â Â Â Â Â Â Â Â Â Â Â weight: any; Â Â Â Â Â Â Â Â }; Â Â Â Â Â Â Â Â selected: any; Â Â Â Â }, >
...
* detachWindow(options?: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<FontConfig>
...
* \_attachPartListeners(  
  ...
  Inherited from HandlebarsApplicationMixin(ApplicationV2).\_attachPartListeners
...
* \_configureRenderParts(  
  ...
  Inherited from HandlebarsApplicationMixin(ApplicationV2).\_configureRenderParts
...
* \_getDataForDefinition(  
  Â Â Â Â family: string,  
  Â Â Â Â definition: [FontFamilyDefinition](../interfaces/CONFIG.FontFamilyDefinition.md),  
  ...
  + definition: [FontFamilyDefinition](../interfaces/CONFIG.FontFamilyDefinition.md)

    The font family definition, expected to have a `fonts` array.

  #### Returns { family: string; font: string; index: number; selected: boolean }[]

  An array of font data objects.
...
* \_preSyncPartState(  
  ...
  Inherited from HandlebarsApplicationMixin(ApplicationV2).\_preSyncPartState
...
* \_syncPartState(  
  ...
  Inherited from HandlebarsApplicationMixin(ApplicationV2).\_syncPartState
...
* \_loadFonts(options?: { document?: Document; timeout?: number }): Promise<void>
  ...
  + `Optional`options: { document?: Document; timeout?: number } = {}
...
* getAvailableFontChoices(): Record<string, string>
...
* loadFont(  
  Â Â Â Â family: string,  
  Â Â Â Â definition: [FontFamilyDefinition](../interfaces/CONFIG.FontFamilyDefinition.md),  
  Â Â Â Â options?: { document?: Document },  
  ): Promise<boolean>
  ...
  + `Optional`options: { document?: Document } = {}
    - ##### `Optional`document?: Document
...
### `Protected` `Static`\_collectDefinitions

* \_collectDefinitions(): Record<string, [FontFamilyDefinition](../interfaces/CONFIG.FontFamilyDefinition.md)>[]

  `Protected`

  Collect font definitions from both config and user settings.

  #### Returns Record<string, [FontFamilyDefinition](../interfaces/CONFIG.FontFamilyDefinition.md)>[]

### `Protected` `Static`\_createFontFace

* \_createFontFace(family: string, definition: [FontDefinition](../types/CONFIG.FontDefinition.md)): FontFace
  ...
  + definition: [FontDefinition](../types/CONFIG.FontDefinition.md)
...
* \_formatFont(family: string, definition: [FontDefinition](../types/CONFIG.FontDefinition.md)): string
