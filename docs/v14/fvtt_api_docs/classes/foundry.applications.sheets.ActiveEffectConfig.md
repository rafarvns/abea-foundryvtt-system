---
title: "ActiveEffectConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.ActiveEffectConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.ActiveEffectConfig))
...
PARTS: {  
Â Â Â Â changes: { scrollable: string[]; template: string; templates: string[] };  
...
* \_attachFrameListeners(): void
  ...
  Overrides HandlebarsApplicationMixin(DocumentSheetV2).\_attachFrameListeners
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<ActiveEffectConfig>
  ...
  #### Returns Promise<ActiveEffectConfig>
...
### `Protected`\_prepareStartContext

* \_prepareStartContext(): object

  `Protected`

  Prepare display context for [EffectStartData](../interfaces/foundry.documents.types.EffectStartData.md).
...
### `Protected`\_processChangeSubmission

* \_processChangeSubmission(change: [EffectChangeData](../interfaces/foundry.documents.types.EffectChangeData.md), index: number): void
  ...
  + change: [EffectChangeData](../interfaces/foundry.documents.types.EffectChangeData.md)
    ...
    The submitted change object with the value deserialized
  + index: number

    The object's index in the submitted array
...
### `Protected`\_renderChange

* \_renderChange(  
  Â Â Â Â context: {  
  Â Â Â Â Â Â Â Â change: [EffectChangeData](../interfaces/foundry.documents.types.EffectChangeData.md);  
  Â Â Â Â Â Â Â Â changeTypes: Record<string, string>;  
  Â Â Â Â Â Â Â Â defaultPriority: number;  
  Â Â Â Â Â Â Â Â fields: [DataSchema](../types/foundry.abstract.types.DataSchema.md);  
  ...
  + context: {  
    ...
    Â Â Â Â changeTypes: Record<string, string>;  
    Â Â Â Â defaultPriority: number;  
    Â Â Â Â fields: [DataSchema](../types/foundry.abstract.types.DataSchema.md);  
    Â Â Â Â index: number;  
    }

    Data for rendering the change row
