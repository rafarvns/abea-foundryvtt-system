---
title: "ModuleManagement | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.apps.ModuleManagement.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.apps.ModuleManagement))
...
[\_doEvent](#_doevent)
[\_formatDocumentSummary](#_formatdocumentsummary)
[\_isModuleChecked](#_ismodulechecked)
[\_onRender](#_onrender)
[\_onSelectDependencies](#_onselectdependencies)
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â changeFilter: (  
Â Â Â Â Â Â Â Â Â Â Â Â this: ModuleManagement,  
Â Â Â Â Â Â Â Â Â Â Â Â \_event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLButtonElement,  
Â Â Â Â Â Â Â Â ) => void;  
Â Â Â Â Â Â Â Â deactivateAll: (this: ModuleManagement, event: PointerEvent) => void;  
Â Â Â Â Â Â Â Â toggleExpanded: (this: ModuleManagement) => void;  
Â Â Â Â };  
Â Â Â Â form: {  
...
PARTS: {  
Â Â Â Â body: { root: boolean; template: string; templates: string[] };  
...
SETTING: string = "moduleConfiguration"
...
* \_formatDocumentSummary(  
  Â Â Â Â counts: ModuleSubTypeCounts,  
  Â Â Â Â verbose: boolean,  
  Â Â Â Â module?: any,  
  ): string
  ...
  + counts: ModuleSubTypeCounts

    An object of sub-type counts.
  + verbose: boolean

    Detailed breakdown of by sub-type?
  + `Optional`module: any

    Are sub-types relative to a module?

  #### Returns string

  The formatted document count
...
* \_onSelectDependencies(  
  Â Â Â Â formData: Record<string, boolean>,  
  ...
  + enabling: boolean
    ...
    Whether the user was performing an enabling or disabling workflow.
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<ModuleManagement>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<ModuleManagement>
