---
title: "TerrainData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.TerrainData.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.TerrainData))

* [BaseTerrainData](foundry.data.BaseTerrainData.md)
  + TerrainData
...
[getMovementCostFunction](#getmovementcostfunction)
[migrateData](#migratedata)
[migrateDataSafe](#migratedatasafe)
[resolveTerrainEffects](#resolveterraineffects)
[shimData](#shimdata)
...
* new TerrainData(  
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[constructor](foundry.data.BaseTerrainData.md#constructor)
...
Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[\_source](foundry.data.BaseTerrainData.md#_source)
...
Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[parent](foundry.data.BaseTerrainData.md#parent)
...
Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[\_schema](foundry.data.BaseTerrainData.md#_schema)
...
Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[LOCALIZATION\_PREFIXES](foundry.data.BaseTerrainData.md#localization_prefixes)
...
* get invalid(): boolean
  ...
  Inherited from BaseTerrainData.invalid
...
* get schema(): [DataModelSchemaField](foundry.data.fields.DataModelSchemaField.md)
  ...
  Inherited from BaseTerrainData.schema
...
* get validationFailures(): {  
  ...
  Inherited from BaseTerrainData.validationFailures
...
* \_initialize(options: any): void
  ...
  Overrides [BaseTerrainData](foundry.data.BaseTerrainData.md).[\_initialize](foundry.data.BaseTerrainData.md#_initialize)
...
* clone(  
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[clone](foundry.data.BaseTerrainData.md#clone)
...
* equals(other: any): boolean
  ...
  Overrides [BaseTerrainData](foundry.data.BaseTerrainData.md).[equals](foundry.data.BaseTerrainData.md#equals)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[getFieldForProperty](foundry.data.BaseTerrainData.md#getfieldforproperty)
...
* reset(): void
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[reset](foundry.data.BaseTerrainData.md#reset)
...
* toJSON(): object
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[toJSON](foundry.data.BaseTerrainData.md#tojson)
...
* toObject(source?: boolean): object
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[toObject](foundry.data.BaseTerrainData.md#toobject)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[updateSource](foundry.data.BaseTerrainData.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[validate](foundry.data.BaseTerrainData.md#validate)
...
* \_configure(options?: object): void
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[\_configure](foundry.data.BaseTerrainData.md#_configure)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[\_getInnerModel](foundry.data.BaseTerrainData.md#_getinnermodel)
...
* \_initializationOrder(): Generator<[string, [DataField](foundry.data.fields.DataField.md)], any, any>
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[\_initializationOrder](foundry.data.BaseTerrainData.md#_initializationorder)
...
* \_initializeSource(  
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[\_initializeSource](foundry.data.BaseTerrainData.md#_initializesource)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[\_preUpdateSource](foundry.data.BaseTerrainData.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[\_updateCommit](foundry.data.BaseTerrainData.md#_updatecommit)
...
* \_updateDiff(  
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[\_updateDiff](foundry.data.BaseTerrainData.md#_updatediff)
...
* cleanData(  
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[cleanData](foundry.data.BaseTerrainData.md#cleandata)

### `Static`defineSchema

* defineSchema(): { difficulty: [NumberField](foundry.data.fields.NumberField.md) }

  #### Returns { difficulty: [NumberField](foundry.data.fields.NumberField.md) }

  Overrides [BaseTerrainData](foundry.data.BaseTerrainData.md).[defineSchema](foundry.data.BaseTerrainData.md#defineschema)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[fromJSON](foundry.data.BaseTerrainData.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[fromSource](foundry.data.BaseTerrainData.md#fromsource)

### `Static`getMovementCostFunction

* getMovementCostFunction(  
  Â Â Â Â token: any,  
  Â Â Â Â options: any,  
  ...
  #### Returns (from: any, to: any, distance: any, segment: any) => number

  Overrides [BaseTerrainData](foundry.data.BaseTerrainData.md).[getMovementCostFunction](foundry.data.BaseTerrainData.md#getmovementcostfunction)
...
* migrateData(  
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[migrateData](foundry.data.BaseTerrainData.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[migrateDataSafe](foundry.data.BaseTerrainData.md#migratedatasafe)

### `Static`resolveTerrainEffects

* resolveTerrainEffects(effects: any, options: any): TerrainData | null
  ...
  #### Returns TerrainData | null

  Overrides [BaseTerrainData](foundry.data.BaseTerrainData.md).[resolveTerrainEffects](foundry.data.BaseTerrainData.md#resolveterraineffects)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[shimData](foundry.data.BaseTerrainData.md#shimdata)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[validateJoint](foundry.data.BaseTerrainData.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[\_cleanData](foundry.data.BaseTerrainData.md#_cleandata)
...
* \_preCleanData(  
  ...
  Inherited from [BaseTerrainData](foundry.data.BaseTerrainData.md).[\_preCleanData](foundry.data.BaseTerrainData.md#_precleandata)