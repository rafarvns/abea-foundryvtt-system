---
title: "AmbientLightConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.AmbientLightConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.AmbientLightConfig))

* [PlaceableConfig](foundry.applications.sheets.PlaceableConfig.md)
  + AmbientLightConfig
    - [AmbientLightPalette](foundry.applications.sheets.palette.AmbientLightPalette.md)
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â reset: (this: AmbientLightConfig, event: PointerEvent) => Promise<void>;  
Â Â Â Â };  
...
Overrides PlaceableConfig.TABS
...
* get title(): string
  ...
  Inherited from PlaceableConfig.title
...
* changeTab(...args: any[]): void
  ...
  Overrides PlaceableConfig.changeTab

### close

* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<AmbientLightConfig>
  ...
  #### Returns Promise<AmbientLightConfig>
