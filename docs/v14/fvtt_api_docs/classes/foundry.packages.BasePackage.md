---
title: "BasePackage | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.packages.BasePackage.html"
category: "classes"
---

# Class BasePackage<PackageSchema>

The data schema used to define a Package manifest.
Specific types of packages extend this schema with additional fields.

#### Template: PackageSchema

The source data from the package manifest

#### Type Parameters

* PackageSchema extends [PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md)

  The source data from the package manifest

#### Hierarchy ([View Summary](../hierarchy.md#foundry.packages.BasePackage))

* [DataModel](foundry.abstract.DataModel.md)
  + BasePackage
    - [BaseWorld](foundry.packages.BaseWorld.md)
    - [BaseSystem](foundry.packages.BaseSystem.md)
    - [BaseModule](foundry.packages.BaseModule.md)
...
* new BasePackage<[PackageSchema](#constructorbasepackagepackageschema) extends [PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md)>(  
  Â Â Â Â data: [PackageManifestData](../interfaces/foundry.packages.types.PackageManifestData.md),  
  Â Â Â Â options?: object,  
  ): BasePackage<[PackageSchema](#packageschema)>
  ...
  #### Returns BasePackage<[PackageSchema](#packageschema)>
...
\_source: [PackageSchema](#packageschema)
...
* \_initializeSource(  
  ...
  Overrides [DataModel](foundry.abstract.DataModel.md).[\_initializeSource](foundry.abstract.DataModel.md#_initializesource)
...
* \_cleanData(data: any, \_options: any, \_state: any): void
  ...
  Overrides [DataModel](foundry.abstract.DataModel.md).[\_cleanData](foundry.abstract.DataModel.md#_cleandata)
...
* testDependencyCompatibility(  
  Â Â Â Â compatibility: [PackageCompatibility](foundry.packages.PackageCompatibility.md),  
  Â Â Â Â dependency: BasePackage<any>,  
  ): boolean
