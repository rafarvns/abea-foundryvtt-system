---
title: "RegionBehaviorConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.RegionBehaviorConfig.html"
category: "classes"
---

# Class RegionBehaviorConfig
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.RegionBehaviorConfig))
...
Â Â Â Â window: { contentClasses: string[]; icon: undefined };  
} = ...
...
Â Â Â Â form: { scrollable: string[]; template: string };  
} = ...
...
* \_prepareContext(  
  ...
  Â Â Â Â } & {  
  Â Â Â Â Â Â Â Â buttons: [FormFooterButton](../interfaces/foundry.applications.types.FormFooterButton.md)[];  
  Â Â Â Â Â Â Â Â fields: [FormNode](../interfaces/foundry.applications.types.FormNode.md)[];  
  Â Â Â Â Â Â Â Â hint: string;  
  Â Â Â Â Â Â Â Â region: ClientDocument;  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â [ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md) & { Â Â Â Â Â Â Â Â document: ClientDocument; Â Â Â Â Â Â Â Â editable: boolean; Â Â Â Â Â Â Â Â fields: any; Â Â Â Â Â Â Â Â model: ClientDocument; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â source: any; Â Â Â Â Â Â Â Â user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) Â Â Â Â Â Â Â Â | null; Â Â Â Â } & { Â Â Â Â Â Â Â Â buttons: [FormFooterButton](../interfaces/foundry.applications.types.FormFooterButton.md)[]; Â Â Â Â Â Â Â Â fields: [FormNode](../interfaces/foundry.applications.types.FormNode.md)[]; Â Â Â Â Â Â Â Â hint: string; Â Â Â Â Â Â Â Â region: ClientDocument; Â Â Â Â }, >
...
* close(  
  ...
  #### Returns Promise<RegionBehaviorConfig>
...
### `Protected`\_getButtons

* \_getButtons(): [FormFooterButton](../interfaces/foundry.applications.types.FormFooterButton.md)[]
...
* \_getFields(): [FormNode](../interfaces/foundry.applications.types.FormNode.md)[]

  `Protected`

  Prepare form field structure for rendering.

  #### Returns [FormNode](../interfaces/foundry.applications.types.FormNode.md)[]
