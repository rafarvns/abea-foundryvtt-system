---
title: "Level | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.Level.html"
category: "classes"
---
...
[foundry.documents.Scene](foundry.documents.Scene.md): The Scene document type which contains Level documents

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.Level))

* [BaseLevel](foundry.documents.BaseLevel.md)<this>
  + Level
...
* new Level(  
  Â Â Â Â data?: Partial<[LevelData](../interfaces/foundry.documents.types.LevelData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).Level

  #### Parameters

  + `Optional`data: Partial<[LevelData](../interfaces/foundry.documents.types.LevelData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).Level

  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[constructor](foundry.documents.BaseLevel.md#constructor)

## Properties

### \_source

\_source: [LevelData](../interfaces/foundry.documents.types.LevelData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_source](foundry.documents.BaseLevel.md#_source)
...
Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[parent](foundry.documents.BaseLevel.md#parent)
...
Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_schema](foundry.documents.BaseLevel.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseLevel.md#localization_prefixes)
...
Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[metadata](foundry.documents.BaseLevel.md#metadata)
...
* get compendium(): any
  ...
  Inherited from ClientDocumentMixin(BaseLevel).compendium

### edges

* get edges(): [CanvasEdges](foundry.canvas.geometry.edges.CanvasEdges.md)

  The edges of this Level.

  #### Returns [CanvasEdges](foundry.canvas.geometry.edges.CanvasEdges.md)
...
* get id(): string | null
  ...
  Inherited from ClientDocumentMixin(BaseLevel).id
...
* get inCompendium(): boolean
  ...
  Inherited from ClientDocumentMixin(BaseLevel).inCompendium
...
* get invalid(): boolean
  ...
  Inherited from ClientDocumentMixin(BaseLevel).invalid
...
* get isEmbedded(): boolean
  ...
  Inherited from ClientDocumentMixin(BaseLevel).isEmbedded
...
* get schema(): [DataModelSchemaField](foundry.data.fields.DataModelSchemaField.md)
  ...
  Inherited from ClientDocumentMixin(BaseLevel).schema
...
* get uuid(): string | null
  ...
  Inherited from ClientDocumentMixin(BaseLevel).uuid
...
* get validationFailures(): {  
  ...
  Inherited from ClientDocumentMixin(BaseLevel).validationFailures
...
* get baseDocument(): typeof [Document](foundry.abstract.Document.md)
  ...
  Inherited from ClientDocumentMixin(BaseLevel).baseDocument
...
* get collectionName(): string
  ...
  Inherited from ClientDocumentMixin(BaseLevel).collectionName
...
* get database(): [abstract](../modules/foundry.abstract.md).[DatabaseBackend](foundry.abstract.DatabaseBackend.md)
  ...
  Inherited from ClientDocumentMixin(BaseLevel).database
...
* get documentName(): string
  ...
  Inherited from ClientDocumentMixin(BaseLevel).documentName
...
* get hasTypeData(): boolean
  ...
  Inherited from ClientDocumentMixin(BaseLevel).hasTypeData
...
* get hierarchy(): Readonly<Record<string, any>>
  ...
  Inherited from ClientDocumentMixin(BaseLevel).hierarchy
...
* get implementation(): typeof [Document](foundry.abstract.Document.md)
  ...
  Inherited from ClientDocumentMixin(BaseLevel).implementation
...
* get TYPES(): string[]
  ...
  Inherited from ClientDocumentMixin(BaseLevel).TYPES
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_configure](foundry.documents.BaseLevel.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_getParentCollection](foundry.documents.BaseLevel.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_initializationOrder](foundry.documents.BaseLevel.md#_initializationorder)
...
* \_preCreate(data: any, options: any, user: any): Promise<boolean | void>
  ...
  Overrides [BaseLevel](foundry.documents.BaseLevel.md).[\_preCreate](foundry.documents.BaseLevel.md#_precreate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_updateDiff](foundry.documents.BaseLevel.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[canUserModify](foundry.documents.BaseLevel.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[clone](foundry.documents.BaseLevel.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[createEmbeddedDocuments](foundry.documents.BaseLevel.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[delete](foundry.documents.BaseLevel.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[deleteEmbeddedDocuments](foundry.documents.BaseLevel.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[getEmbeddedCollection](foundry.documents.BaseLevel.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[getEmbeddedDocument](foundry.documents.BaseLevel.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[getFieldForProperty](foundry.documents.BaseLevel.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[getFlag](foundry.documents.BaseLevel.md#getflag)
...
* getUserLevel(user?: [BaseUser](foundry.documents.BaseUser.md)): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.md)
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[getUserLevel](foundry.documents.BaseLevel.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[migrateSystemData](foundry.documents.BaseLevel.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[reset](foundry.documents.BaseLevel.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[setFlag](foundry.documents.BaseLevel.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[testUserPermission](foundry.documents.BaseLevel.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[toJSON](foundry.documents.BaseLevel.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[toObject](foundry.documents.BaseLevel.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[traverseEmbeddedDocuments](foundry.documents.BaseLevel.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[unsetFlag](foundry.documents.BaseLevel.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[update](foundry.documents.BaseLevel.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[updateEmbeddedDocuments](foundry.documents.BaseLevel.md#updateembeddeddocuments)

### updateRegionShapeConstraints

* updateRegionShapeConstraints(  
  Â Â Â Â types?: Iterable<EdgeRestrictionType, any, any>,  
  ): void
  ...
  + `Optional`types: Iterable<EdgeRestrictionType, any, any> = CONST.EDGE\_RESTRICTION\_TYPES
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[updateSource](foundry.documents.BaseLevel.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[validate](foundry.documents.BaseLevel.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_getInnerModel](foundry.documents.BaseLevel.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_initialize](foundry.documents.BaseLevel.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_initializeSource](foundry.documents.BaseLevel.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_onCreate](foundry.documents.BaseLevel.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_onDelete](foundry.documents.BaseLevel.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_onUpdate](foundry.documents.BaseLevel.md#_onupdate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_preDelete](foundry.documents.BaseLevel.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_preUpdate](foundry.documents.BaseLevel.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_preUpdateSource](foundry.documents.BaseLevel.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_updateCommit](foundry.documents.BaseLevel.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_addDataFieldMigration](foundry.documents.BaseLevel.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_addDataFieldShim](foundry.documents.BaseLevel.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_addDataFieldShims](foundry.documents.BaseLevel.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_clearFieldsRecursively](foundry.documents.BaseLevel.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_logDataFieldMigration](foundry.documents.BaseLevel.md#_logdatafieldmigration)
...
* \_onCreateOperation(documents: any, operation: any, user: any): Promise<void>
  ...
  Overrides [BaseLevel](foundry.documents.BaseLevel.md).[\_onCreateOperation](foundry.documents.BaseLevel.md#_oncreateoperation)
...
* \_onDeleteOperation(documents: any, operation: any, user: any): Promise<void>
  ...
  Overrides [BaseLevel](foundry.documents.BaseLevel.md).[\_onDeleteOperation](foundry.documents.BaseLevel.md#_ondeleteoperation)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_preCleanData](foundry.documents.BaseLevel.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[canUserCreate](foundry.documents.BaseLevel.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[cleanData](foundry.documents.BaseLevel.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[create](foundry.documents.BaseLevel.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[createDocuments](foundry.documents.BaseLevel.md#createdocuments)

### `Static`defineSchema

* defineSchema(): {  
  Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md);  
  Â Â Â Â background: [SchemaField](foundry.data.fields.SchemaField.md);  
  ...
  Â Â Â Â foreground: [SchemaField](foundry.data.fields.SchemaField.md);  
  ...
  Â Â Â Â textures: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â visibility: [SchemaField](foundry.data.fields.SchemaField.md);  
  }
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â background: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â elevation: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â fog: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â foreground: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â sort: [IntegerSortField](foundry.data.fields.IntegerSortField.md); Â Â Â Â textures: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â visibility: [SchemaField](foundry.data.fields.SchemaField.md); }
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[defineSchema](foundry.documents.BaseLevel.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[deleteDocuments](foundry.documents.BaseLevel.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[fromJSON](foundry.documents.BaseLevel.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[fromSource](foundry.documents.BaseLevel.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[get](foundry.documents.BaseLevel.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[getCollectionName](foundry.documents.BaseLevel.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[migrateData](foundry.documents.BaseLevel.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[migrateDataSafe](foundry.documents.BaseLevel.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[shimData](foundry.documents.BaseLevel.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[updateDocuments](foundry.documents.BaseLevel.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[validateJoint](foundry.documents.BaseLevel.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_cleanData](foundry.documents.BaseLevel.md#_cleandata)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_onUpdateOperation](foundry.documents.BaseLevel.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_preCreateOperation](foundry.documents.BaseLevel.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_preDeleteOperation](foundry.documents.BaseLevel.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseLevel](foundry.documents.BaseLevel.md).[\_preUpdateOperation](foundry.documents.BaseLevel.md#_preupdateoperation)