---
title: "Journal | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.collections.Journal.html"
category: "classes"
---
...
* [foundry.documents.JournalEntry](foundry.documents.JournalEntry.md): The JournalEntry document
* [foundry.applications.sidebar.tabs.JournalDirectory](foundry.applications.sidebar.tabs.JournalDirectory.md): The JournalDirectory sidebar
  directory

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.collections.Journal))
...
* new Journal(data?: object[]): Journal
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)
...
* every(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â element: [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)>,  
  Â Â Â Â ) => boolean,  
  ): boolean
  ...
  + condition: (  
    Â Â Â Â element: [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md),  
    Â Â Â Â index: number,  
    Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)>,  
    ) => boolean
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)>,  
  Â Â Â Â ) => unknown,  
  ): [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)[]
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)>,  
  Â Â Â Â ) => unknown,  
  ): [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md) | undefined
  ...
  #### Returns [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md) | undefined
...
* forEach(fn: (value: [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md), index: number) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md), index: number) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md),  
  ...
  + document: object | [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)
...
* getInvalid(  
  ...
  ): void | [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)
  ...
  #### Returns void | [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)
...
* importFromCompendium(  
  ...
  Â Â Â Â options?: any,  
  ): Promise<[documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)>
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)[]
...
* set(id: string, document: [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)): Journal

  #### Parameters

  + id: string
  + document: [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md)
...
* show(  
  Â Â Â Â doc: [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md) | [documents](../modules/foundry.documents.md).[JournalEntryPage](foundry.documents.JournalEntryPage.md),  
  Â Â Â Â options?: { force?: boolean; users?: string[] },  
  ): Promise<void | [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md) | [documents](../modules/foundry.documents.md).[JournalEntryPage](foundry.documents.JournalEntryPage.md)>
  ...
  + doc: [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md) | [documents](../modules/foundry.documents.md).[JournalEntryPage](foundry.documents.JournalEntryPage.md)
  ...
  #### Returns Promise<void | [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md) | [documents](../modules/foundry.documents.md).[JournalEntryPage](foundry.documents.JournalEntryPage.md)>
...
* showDialog(  
  Â Â Â Â doc: [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md) | [documents](../modules/foundry.documents.md).[JournalEntryPage](foundry.documents.JournalEntryPage.md),  
  Â Â Â Â options?: { parent?: any; renderOptions?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md) },  
  ): Promise<void>
  ...
  + doc: [documents](../modules/foundry.documents.md).[JournalEntry](foundry.documents.JournalEntry.md) | [documents](../modules/foundry.documents.md).[JournalEntryPage](foundry.documents.JournalEntryPage.md)
    ...
    The JournalEntry or JournalEntryPage to show.
  + `Optional`options: { parent?: any; renderOptions?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md) } = {}
    - ##### `Optional`parent?: any

      A parent Application to register the dialog as a child
      of.
...
* showImage(src: string, config?: [ShareImageConfig](../interfaces/foundry.ShareImageConfig.md)): void
  ...
  + `Optional`config: [ShareImageConfig](../interfaces/foundry.ShareImageConfig.md) = {}
