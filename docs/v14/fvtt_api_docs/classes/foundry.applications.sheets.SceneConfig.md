---
title: "SceneConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.SceneConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.SceneConfig))
...
[\_getLevelContextOptions](#_getlevelcontextoptions)
...
[\_getFogExplorationModes](#_getfogexplorationmodes)
[\_getGridTypes](#_getgridtypes)
...
* new SceneConfig(options: any, ...args: any[]): SceneConfig
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â addLevel: (this: SceneConfig) => void;  
...
Â Â Â Â Â Â Â Â editLevel: (  
Â Â Â Â Â Â Â Â Â Â Â Â this: SceneConfig,  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
...
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLElement,  
Â Â Â Â Â Â Â Â ) => void | Promise<void>;  
Â Â Â Â Â Â Â Â transitionPlay: (  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLElement,  
Â Â Â Â Â Â Â Â ) => void | Promise<void>;  
Â Â Â Â };  
...
PARTS: {  
Â Â Â Â basics: { scrollable: string[]; template: string };  
Â Â Â Â environment: { scrollable: string[]; template: string };  
Â Â Â Â footer: { template: string };  
Â Â Â Â grid: { template: string };  
Â Â Â Â levels: { scrollable: string[]; template: string };  
Â Â Â Â misc: { scrollable: string[]; template: string };  
Â Â Â Â tabs: { template: string };  
Â Â Â Â visibility: { scrollable: string[]; template: string };  
} = ...
...
* \_processSubmitData(  
  ...
  Â Â Â Â options: any,  
  ): Promise<{ updated?: undefined } | { updated: any }>
  ...
  #### Returns Promise<{ updated?: undefined } | { updated: any }>
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<SceneConfig>
...
### `Protected`\_getLevelContextOptions

* \_getLevelContextOptions(): ContextMenuEntry[]
...
* \_onDrop(event: DragEvent): Promise<void | Level[]>
...
### `Protected`\_onSortLevel

* \_onSortLevel(event: DragEvent, level: Level): void | Promise<Level[]>
...
### `Static`\_getFogExplorationModes

* \_getFogExplorationModes(): Record<FOG\_EXPLORATION\_MODES, string>

  `Internal`

  Get an enumeration of the available fog exploration modes for this Scene.

  #### Returns Record<FOG\_EXPLORATION\_MODES, string>
