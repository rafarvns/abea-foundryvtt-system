---
title: "Actors | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.collections.Actors.html"
category: "classes"
---
...
* [foundry.documents.Actor](foundry.documents.Actor.md): The Actor document
* [foundry.applications.sidebar.tabs.ActorDirectory](foundry.applications.sidebar.tabs.ActorDirectory.md): The ActorDirectory sidebar directory
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.collections.Actors))
...
* get tokens(): Record<string, [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)>

  A mapping of synthetic Token Actors which are currently active within the viewed Scene.
  Each Actor is referenced by the [Token.id](http://Token.id).

  #### Returns Record<string, [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)>
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)
...
* every(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â element: [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)>,  
  Â Â Â Â ) => boolean,  
  ): boolean
  ...
  + condition: (  
    Â Â Â Â element: [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md),  
    Â Â Â Â index: number,  
    Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)>,  
    ) => boolean
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)>,  
  Â Â Â Â ) => unknown,  
  ): [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md) | undefined
  ...
  #### Returns [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md) | undefined
...
* forEach(fn: (value: [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md), index: number) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md), index: number) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md),  
  ...
  + document: object | [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)
...
* getInvalid(id: string, options?: { strict?: boolean }): void | [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)
  ...
  #### Returns void | [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)
...
* importFromCompendium(  
  ...
  Â Â Â Â options?: any,  
  ): Promise<[documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)>
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)[]
...
* set(id: string, document: [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)): Actors

  #### Parameters

  + id: string
  + document: [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)
