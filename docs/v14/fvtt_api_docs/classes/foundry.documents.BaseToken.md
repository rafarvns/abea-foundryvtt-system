---
title: "BaseToken | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.BaseToken.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.BaseToken))
...
* \_initializeSource(data: any, options: any): object
  ...
  Overrides [Document](foundry.abstract.Document.md).[\_initializeSource](foundry.abstract.Document.md#_initializesource)
...
* clone(  
  ...
  Overrides [Document](foundry.abstract.Document.md).[clone](foundry.abstract.Document.md#clone)
