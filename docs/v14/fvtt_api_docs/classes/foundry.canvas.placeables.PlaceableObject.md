---
title: "PlaceableObject | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.placeables.PlaceableObject.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.placeables.PlaceableObject))

* PlaceableObject
  + [canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).[Note](foundry.canvas.placeables.Note.md)
  + [canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).[Token](foundry.canvas.placeables.Token.md)
  + [canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).[Wall](foundry.canvas.placeables.Wall.md)
...
* \_clear(): void
  ...
  This function is called in [PlaceableObject#draw](#draw) before the [PlaceableObject#\_draw](#_draw) call.
