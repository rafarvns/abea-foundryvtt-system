---
title: "VisionMode | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.perception.VisionMode.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.perception.VisionMode))
...
[parent](#parent)
[\_schema](#_schema)
[LIGHTING\_LEVELS](#lighting_levels)
[LIGHTING\_VISIBILITY](#lighting_visibility)
[LOCALIZATION\_PREFIXES](#localization_prefixes)

### Accessors

[invalid](#invalid)
[perceivesLight](#perceiveslight)
[schema](#schema)
...
* new VisionMode(data?: object, options?: object): VisionMode
  ...
  Overrides [DataModel](foundry.abstract.DataModel.md).[constructor](foundry.abstract.DataModel.md#constructor)
...
### `Static`LIGHTING\_LEVELS

LIGHTING\_LEVELS: Readonly<  
Â Â Â Â {  
Â Â Â Â Â Â Â Â BRIGHT: 2;  
Â Â Â Â Â Â Â Â BRIGHTEST: 3;  
Â Â Â Â Â Â Â Â DARKNESS: -2;  
Â Â Â Â Â Â Â Â DIM: 1;  
Â Â Â Â Â Â Â Â HALFDARK: -1;  
Â Â Â Â Â Â Â Â UNLIT: 0;  
Â Â Â Â },  
> = LIGHTING\_LEVELS

The lighting illumination levels which are supported.

### `Static`LIGHTING\_VISIBILITY

LIGHTING\_VISIBILITY: { DISABLED: 0; ENABLED: 1; REQUIRED: 2 } = ...
...
* \_activate(source: [PointVisionSource](foundry.canvas.sources.PointVisionSource.md)): void

  Special activation handling that could be implemented by VisionMode subclasses

  #### Parameters

  + source: [PointVisionSource](foundry.canvas.sources.PointVisionSource.md)

    Activate this VisionMode for a specific source

  #### Returns void

### `Abstract`\_deactivate

* \_deactivate(source: [PointVisionSource](foundry.canvas.sources.PointVisionSource.md)): void
...
* activate(source: [PointVisionSource](foundry.canvas.sources.PointVisionSource.md)): void
...
* deactivate(source: [PointVisionSource](foundry.canvas.sources.PointVisionSource.md)): void
...
* defineSchema(): {  
  Â Â Â Â canvas: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â id: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â label: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â lighting: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â tokenConfig: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â vision: [SchemaField](foundry.data.fields.SchemaField.md);  
  }
  ...
  #### Returns { Â Â Â Â canvas: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â id: [StringField](foundry.data.fields.StringField.md); Â Â Â Â label: [StringField](foundry.data.fields.StringField.md); Â Â Â Â lighting: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â tokenConfig: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â vision: [SchemaField](foundry.data.fields.SchemaField.md); }
