---
title: "PauseGameRegionBehaviorType | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.regionBehaviors.PauseGameRegionBehaviorType.html"
category: "classes"
---

# Class PauseGameRegionBehaviorType

The data model for a behavior that pauses the game when a player-controlled Token enters the Region.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.regionBehaviors.PauseGameRegionBehaviorType))
...
* new PauseGameRegionBehaviorType(  
  Â Â Â Â data?: {},  
  Â Â Â Â options?: {},  
  ): PauseGameRegionBehaviorType
  ...
  #### Returns PauseGameRegionBehaviorType
...
events: {  
Â Â Â Â tokenMoveIn: (  
Â Â Â Â Â Â Â Â this: PauseGameRegionBehaviorType,  
...
* ##### tokenMoveIn: ( Â Â Â Â this: PauseGameRegionBehaviorType, Â Â Â Â event: [RegionTokenMoveEvent](../types/foundry.documents.types.RegionTokenMoveEvent.md), ) => Promise<void>
...
* defineSchema(): { once: [BooleanField](foundry.data.fields.BooleanField.md) }

  #### Returns { once: [BooleanField](foundry.data.fields.BooleanField.md) }
