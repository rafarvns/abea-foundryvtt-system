...
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.ChatMessage.html"
category: "classes"
---
...
* [hookEvents.renderChatMessageHTML](../functions/hookEvents.renderChatMessageHTML.md)
...
[foundry.documents.collections.ChatMessages](foundry.documents.collections.ChatMessages.md): The world-level collection of ChatMessage
documents

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.ChatMessage))

* [BaseChatMessage](foundry.documents.BaseChatMessage.md)<this>
  + ChatMessage
...
[validate](#validate)
[\_getHiddenContent](#_gethiddencontent)
...
[getSpeakerActor](#getspeakeractor)
[getWhisperRecipients](#getwhisperrecipients)
...
* new ChatMessage(  
  Â Â Â Â data?: Partial<[ChatMessageData](../interfaces/foundry.documents.types.ChatMessageData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).ChatMessage

  #### Parameters

  + `Optional`data: Partial<[ChatMessageData](../interfaces/foundry.documents.types.ChatMessageData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).ChatMessage

  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[constructor](foundry.documents.BaseChatMessage.md#constructor)

## Properties

### \_source

\_source: [ChatMessageData](../interfaces/foundry.documents.types.ChatMessageData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_source](foundry.documents.BaseChatMessage.md#_source)
...
Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[parent](foundry.documents.BaseChatMessage.md#parent)
...
Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_schema](foundry.documents.BaseChatMessage.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseChatMessage.md#localization_prefixes)
...
Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[metadata](foundry.documents.BaseChatMessage.md#metadata)
...
* get speakerActor(): [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md) | null
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_configure](foundry.documents.BaseChatMessage.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_getParentCollection](foundry.documents.BaseChatMessage.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_initializationOrder](foundry.documents.BaseChatMessage.md#_initializationorder)
...
* \_onCreate(data: any, options: any, userId: any): void
  ...
  Overrides [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_onCreate](foundry.documents.BaseChatMessage.md#_oncreate)
...
* \_onDelete(options: any, userId: any): void
  ...
  Overrides [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_onDelete](foundry.documents.BaseChatMessage.md#_ondelete)
...
* \_onUpdate(changed: any, options: any, userId: any): void
  ...
  Overrides [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_onUpdate](foundry.documents.BaseChatMessage.md#_onupdate)
...
* \_preCreate(data: any, options: any, user: any): Promise<false | undefined>
  ...
  Overrides [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_preCreate](foundry.documents.BaseChatMessage.md#_precreate)
...
* \_preUpdate(changed: any, options: any, user: any): Promise<false | undefined>
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_preUpdate](foundry.documents.BaseChatMessage.md#_preupdate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_updateDiff](foundry.documents.BaseChatMessage.md#_updatediff)
...
* applyMode(mode: string): void
  ...
  This function calls [ChatMessage.applyMode](#applymode-2) and updates the source of the ChatMessage.

  #### Parameters

  + mode: string

    The message visibility mode to apply to this message
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[canUserModify](foundry.documents.BaseChatMessage.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[clone](foundry.documents.BaseChatMessage.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[createEmbeddedDocuments](foundry.documents.BaseChatMessage.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[delete](foundry.documents.BaseChatMessage.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[deleteEmbeddedDocuments](foundry.documents.BaseChatMessage.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[getEmbeddedCollection](foundry.documents.BaseChatMessage.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[getEmbeddedDocument](foundry.documents.BaseChatMessage.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[getFieldForProperty](foundry.documents.BaseChatMessage.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[getFlag](foundry.documents.BaseChatMessage.md#getflag)
...
* getUserLevel(user: any): any
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[getUserLevel](foundry.documents.BaseChatMessage.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[migrateSystemData](foundry.documents.BaseChatMessage.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[reset](foundry.documents.BaseChatMessage.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[setFlag](foundry.documents.BaseChatMessage.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[testUserPermission](foundry.documents.BaseChatMessage.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[toJSON](foundry.documents.BaseChatMessage.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[toObject](foundry.documents.BaseChatMessage.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[traverseEmbeddedDocuments](foundry.documents.BaseChatMessage.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[unsetFlag](foundry.documents.BaseChatMessage.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[update](foundry.documents.BaseChatMessage.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[updateEmbeddedDocuments](foundry.documents.BaseChatMessage.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[updateSource](foundry.documents.BaseChatMessage.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[validate](foundry.documents.BaseChatMessage.md#validate)

### `Protected`\_getHiddenContent

* \_getHiddenContent(): string
...
* \_getInnerModel(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_getInnerModel](foundry.documents.BaseChatMessage.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_initialize](foundry.documents.BaseChatMessage.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_initializeSource](foundry.documents.BaseChatMessage.md#_initializesource)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_preDelete](foundry.documents.BaseChatMessage.md#_predelete)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_preUpdateSource](foundry.documents.BaseChatMessage.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_updateCommit](foundry.documents.BaseChatMessage.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_addDataFieldMigration](foundry.documents.BaseChatMessage.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_addDataFieldShim](foundry.documents.BaseChatMessage.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_addDataFieldShims](foundry.documents.BaseChatMessage.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_clearFieldsRecursively](foundry.documents.BaseChatMessage.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_logDataFieldMigration](foundry.documents.BaseChatMessage.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_preCleanData](foundry.documents.BaseChatMessage.md#_precleandata)

### `Static`applyMode

* applyMode(chatData: object, mode?: string): object
  ...
  + chatData: object
    ...
    Candidate ChatMessage data which should be customized
  + `Optional`mode: string

    The message visibility mode to apply, otherwise apply the
    default mode stored in client settings.

  #### Returns object

  Modified ChatMessage data with the message visibility mode applied
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[canUserCreate](foundry.documents.BaseChatMessage.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[cleanData](foundry.documents.BaseChatMessage.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[create](foundry.documents.BaseChatMessage.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[createDocuments](foundry.documents.BaseChatMessage.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â author: [DocumentAuthorField](foundry.data.fields.DocumentAuthorField.md);  
  Â Â Â Â blind: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â content: [HTMLField](foundry.data.fields.HTMLField.md);  
  Â Â Â Â emote: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md);  
  Â Â Â Â flavor: [HTMLField](foundry.data.fields.HTMLField.md);  
  Â Â Â Â rolls: [ArrayField](foundry.data.fields.ArrayField.md)<[JSONField](foundry.data.fields.JSONField.md)>;  
  Â Â Â Â sound: [FilePathField](foundry.data.fields.FilePathField.md);  
  Â Â Â Â speaker: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â style: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â system: [TypeDataField](foundry.data.fields.TypeDataField.md);  
  Â Â Â Â timestamp: [NumberField](foundry.data.fields.NumberField.md);  
  ...
  Â Â Â Â whisper: [ArrayField](foundry.data.fields.ArrayField.md)<[ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md)>;  
  }
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â author: [DocumentAuthorField](foundry.data.fields.DocumentAuthorField.md); Â Â Â Â blind: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â content: [HTMLField](foundry.data.fields.HTMLField.md); Â Â Â Â emote: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â flavor: [HTMLField](foundry.data.fields.HTMLField.md); Â Â Â Â rolls: [ArrayField](foundry.data.fields.ArrayField.md)<[JSONField](foundry.data.fields.JSONField.md)>; Â Â Â Â sound: [FilePathField](foundry.data.fields.FilePathField.md); Â Â Â Â speaker: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â style: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â system: [TypeDataField](foundry.data.fields.TypeDataField.md); Â Â Â Â timestamp: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â title: [StringField](foundry.data.fields.StringField.md); Â Â Â Â type: [DocumentTypeField](foundry.data.fields.DocumentTypeField.md); Â Â Â Â whisper: [ArrayField](foundry.data.fields.ArrayField.md)<[ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md)>; }
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[defineSchema](foundry.documents.BaseChatMessage.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[deleteDocuments](foundry.documents.BaseChatMessage.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[fromJSON](foundry.documents.BaseChatMessage.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[fromSource](foundry.documents.BaseChatMessage.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[get](foundry.documents.BaseChatMessage.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[getCollectionName](foundry.documents.BaseChatMessage.md#getcollectionname)

### `Static`getSpeaker

* getSpeaker(  
  Â Â Â Â options?: {  
  Â Â Â Â Â Â Â Â actor?: [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md);  
  Â Â Â Â Â Â Â Â alias?: string;  
  Â Â Â Â Â Â Â Â scene?: [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md);  
  Â Â Â Â Â Â Â Â token?: [TokenDocument](foundry.documents.TokenDocument.md);  
  Â Â Â Â },  
  ): [ChatSpeakerData](../interfaces/foundry.documents.types.ChatSpeakerData.md)
  ...
  + `Optional`options: {  
    Â Â Â Â actor?: [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md);  
    ...
    - ##### `Optional`actor?: [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md)
    ...
    - ##### `Optional`token?: [TokenDocument](foundry.documents.TokenDocument.md)

      The Token who is speaking

  #### Returns [ChatSpeakerData](../interfaces/foundry.documents.types.ChatSpeakerData.md)

  The identified speaker data

### `Static`getSpeakerActor

* getSpeakerActor(speaker: Object): [documents](../modules/foundry.documents.md).[Actor](foundry.documents.Actor.md) | null
...
* getWhisperRecipients(name: string): [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md)[]
...
* migrateData(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[migrateData](foundry.documents.BaseChatMessage.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[migrateDataSafe](foundry.documents.BaseChatMessage.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[shimData](foundry.documents.BaseChatMessage.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[updateDocuments](foundry.documents.BaseChatMessage.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[validateJoint](foundry.documents.BaseChatMessage.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_cleanData](foundry.documents.BaseChatMessage.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_onCreateOperation](foundry.documents.BaseChatMessage.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_onDeleteOperation](foundry.documents.BaseChatMessage.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_onUpdateOperation](foundry.documents.BaseChatMessage.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_preCreateOperation](foundry.documents.BaseChatMessage.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_preDeleteOperation](foundry.documents.BaseChatMessage.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseChatMessage](foundry.documents.BaseChatMessage.md).[\_preUpdateOperation](foundry.documents.BaseChatMessage.md#_preupdateoperation)