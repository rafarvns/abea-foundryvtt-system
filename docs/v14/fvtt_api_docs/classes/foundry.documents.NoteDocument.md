---
title: "NoteDocument | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.NoteDocument.html"
category: "classes"
---
...
* [foundry.documents.Scene](foundry.documents.Scene.md): The Scene document type which contains Note documents
* [foundry.applications.sheets.NoteConfig](foundry.applications.sheets.NoteConfig.md): The Note configuration application

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.NoteDocument))

* [BaseNote](foundry.documents.BaseNote.md)<this>
  + NoteDocument
...
* new NoteDocument(  
  Â Â Â Â data?: Partial<[NoteData](../interfaces/foundry.documents.types.NoteData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): NoteDocument

  #### Parameters

  + `Optional`data: Partial<[NoteData](../interfaces/foundry.documents.types.NoteData.md)> = {}
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[constructor](foundry.documents.BaseNote.md#constructor)

## Properties

### \_source

\_source: [NoteData](../interfaces/foundry.documents.types.NoteData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_source](foundry.documents.BaseNote.md#_source)
...
Inherited from [BaseNote](foundry.documents.BaseNote.md).[parent](foundry.documents.BaseNote.md#parent)
...
Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_schema](foundry.documents.BaseNote.md#_schema)
...
Inherited from [BaseNote](foundry.documents.BaseNote.md).[DEFAULT\_ICON](foundry.documents.BaseNote.md#default_icon)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseNote](foundry.documents.BaseNote.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseNote.md#localization_prefixes)
...
Inherited from [BaseNote](foundry.documents.BaseNote.md).[metadata](foundry.documents.BaseNote.md#metadata)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_configure](foundry.documents.BaseNote.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_getParentCollection](foundry.documents.BaseNote.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_initializationOrder](foundry.documents.BaseNote.md#_initializationorder)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_updateDiff](foundry.documents.BaseNote.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[canUserModify](foundry.documents.BaseNote.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[clone](foundry.documents.BaseNote.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[createEmbeddedDocuments](foundry.documents.BaseNote.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[delete](foundry.documents.BaseNote.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[deleteEmbeddedDocuments](foundry.documents.BaseNote.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[getEmbeddedCollection](foundry.documents.BaseNote.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[getEmbeddedDocument](foundry.documents.BaseNote.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[getFieldForProperty](foundry.documents.BaseNote.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[getFlag](foundry.documents.BaseNote.md#getflag)
...
* getUserLevel(user: any): any
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[getUserLevel](foundry.documents.BaseNote.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[migrateSystemData](foundry.documents.BaseNote.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[reset](foundry.documents.BaseNote.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[setFlag](foundry.documents.BaseNote.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[testUserPermission](foundry.documents.BaseNote.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[toJSON](foundry.documents.BaseNote.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[toObject](foundry.documents.BaseNote.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[traverseEmbeddedDocuments](foundry.documents.BaseNote.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[unsetFlag](foundry.documents.BaseNote.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[update](foundry.documents.BaseNote.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[updateEmbeddedDocuments](foundry.documents.BaseNote.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[updateSource](foundry.documents.BaseNote.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[validate](foundry.documents.BaseNote.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_getInnerModel](foundry.documents.BaseNote.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_initialize](foundry.documents.BaseNote.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_initializeSource](foundry.documents.BaseNote.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_onCreate](foundry.documents.BaseNote.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_onDelete](foundry.documents.BaseNote.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_onUpdate](foundry.documents.BaseNote.md#_onupdate)
...
* \_preCreate(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_preCreate](foundry.documents.BaseNote.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_preDelete](foundry.documents.BaseNote.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_preUpdate](foundry.documents.BaseNote.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_preUpdateSource](foundry.documents.BaseNote.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_updateCommit](foundry.documents.BaseNote.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_addDataFieldMigration](foundry.documents.BaseNote.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_addDataFieldShim](foundry.documents.BaseNote.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_addDataFieldShims](foundry.documents.BaseNote.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_clearFieldsRecursively](foundry.documents.BaseNote.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_logDataFieldMigration](foundry.documents.BaseNote.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_preCleanData](foundry.documents.BaseNote.md#_precleandata)
...
* canUserCreate(user: any): any
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[canUserCreate](foundry.documents.BaseNote.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[cleanData](foundry.documents.BaseNote.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[create](foundry.documents.BaseNote.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[createDocuments](foundry.documents.BaseNote.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â entryId: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md);  
  ...
  Â Â Â Â global: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â iconSize: [NumberField](foundry.data.fields.NumberField.md);  
  ...
  Â Â Â Â pageId: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md);  
  Â Â Â Â sort: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â text: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â textAnchor: [NumberField](foundry.data.fields.NumberField.md);  
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â author: [DocumentAuthorField](foundry.data.fields.DocumentAuthorField.md); Â Â Â Â elevation: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â entryId: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â fontFamily: [StringField](foundry.data.fields.StringField.md); Â Â Â Â fontSize: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â global: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â iconSize: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â levels: [SceneLevelsSetField](foundry.data.fields.SceneLevelsSetField.md); Â Â Â Â locked: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â pageId: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); Â Â Â Â sort: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â text: [StringField](foundry.data.fields.StringField.md); Â Â Â Â textAnchor: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â textColor: [ColorField](foundry.data.fields.ColorField.md); Â Â Â Â texture: [TextureData](foundry.data.TextureData.md); Â Â Â Â x: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â y: [NumberField](foundry.data.fields.NumberField.md); }
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[defineSchema](foundry.documents.BaseNote.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[deleteDocuments](foundry.documents.BaseNote.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[fromJSON](foundry.documents.BaseNote.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[fromSource](foundry.documents.BaseNote.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[get](foundry.documents.BaseNote.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[getCollectionName](foundry.documents.BaseNote.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[migrateData](foundry.documents.BaseNote.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[migrateDataSafe](foundry.documents.BaseNote.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[shimData](foundry.documents.BaseNote.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[updateDocuments](foundry.documents.BaseNote.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[validateJoint](foundry.documents.BaseNote.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_cleanData](foundry.documents.BaseNote.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_onCreateOperation](foundry.documents.BaseNote.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_onDeleteOperation](foundry.documents.BaseNote.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_onUpdateOperation](foundry.documents.BaseNote.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_preCreateOperation](foundry.documents.BaseNote.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_preDeleteOperation](foundry.documents.BaseNote.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseNote](foundry.documents.BaseNote.md).[\_preUpdateOperation](foundry.documents.BaseNote.md#_preupdateoperation)