---
title: "ImagePopout | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.apps.ImagePopout.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.apps.ImagePopout))

* [ApplicationV2](foundry.applications.api.ApplicationV2.md)<  
  Â Â Â Â [ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [ImagePopoutConfiguration](../interfaces/foundry.ImagePopoutConfiguration.md),  
...
[\_handleShareImage](#_handleshareimage)
...
* new ImagePopout(  
  Â Â Â Â options: [ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [ImagePopoutConfiguration](../interfaces/foundry.ImagePopoutConfiguration.md),  
  Â Â Â Â \_options?: {},  
  ): ImagePopout

  #### Parameters

  + options: [ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [ImagePopoutConfiguration](../interfaces/foundry.ImagePopoutConfiguration.md)
...
options: Readonly<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [ImagePopoutConfiguration](../interfaces/foundry.ImagePopoutConfiguration.md)>
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: { shareImage: () => void };  
Â Â Â Â caption: string;  
...
Â Â Â Â Â Â Â Â resizable: boolean;  
Â Â Â Â };  
} = ...
...
* \_prepareContext(  
  ...
  Â Â Â Â {  
  Â Â Â Â Â Â Â Â altText: string;  
  Â Â Â Â Â Â Â Â caption: string  
  Â Â Â Â Â Â Â Â | undefined;  
  Â Â Â Â Â Â Â Â image: string;  
  Â Â Â Â Â Â Â Â isVideo: boolean;  
  Â Â Â Â Â Â Â Â title: string | undefined;  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â altText: string; Â Â Â Â Â Â Â Â caption: string Â Â Â Â Â Â Â Â | undefined; Â Â Â Â Â Â Â Â image: string; Â Â Â Â Â Â Â Â isVideo: boolean; Â Â Â Â Â Â Â Â title: string | undefined; Â Â Â Â }, >
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<ImagePopout>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<ImagePopout>
...
* shareImage(options?: [ShareImageConfig](../interfaces/foundry.ShareImageConfig.md)): void

  Share the displayed image with other connected Users

  #### Parameters

  + `Optional`options: [ShareImageConfig](../interfaces/foundry.ShareImageConfig.md) = {}
...
* \_handleShareImage(config?: [ShareImageConfig](../interfaces/foundry.ShareImageConfig.md)): ImagePopout
  ...
  + config: [ShareImageConfig](../interfaces/foundry.ShareImageConfig.md) = {}

    The image configuration data.
