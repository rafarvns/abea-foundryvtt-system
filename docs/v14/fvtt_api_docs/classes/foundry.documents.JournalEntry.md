---
title: "JournalEntry | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.JournalEntry.html"
category: "classes"
---
...
* [foundry.documents.collections.Journal](foundry.documents.collections.Journal.md): The world-level collection of JournalEntry documents
* [foundry.applications.sheets.journal.JournalEntrySheet](foundry.applications.sheets.journal.JournalEntrySheet.md): The JournalEntry sheet
  application

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.JournalEntry))

* [BaseJournalEntry](foundry.documents.BaseJournalEntry.md)<this>
  + JournalEntry
...
* new JournalEntry(  
  Â Â Â Â data?: Partial<[JournalEntryData](../interfaces/foundry.documents.types.JournalEntryData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).JournalEntry

  #### Parameters

  + `Optional`data: Partial<[JournalEntryData](../interfaces/foundry.documents.types.JournalEntryData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).JournalEntry

  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[constructor](foundry.documents.BaseJournalEntry.md#constructor)

## Properties

### \_source

\_source: [JournalEntryData](../interfaces/foundry.documents.types.JournalEntryData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_source](foundry.documents.BaseJournalEntry.md#_source)
...
Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[parent](foundry.documents.BaseJournalEntry.md#parent)
...
Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_schema](foundry.documents.BaseJournalEntry.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseJournalEntry.md#localization_prefixes)
...
Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[metadata](foundry.documents.BaseJournalEntry.md#metadata)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_configure](foundry.documents.BaseJournalEntry.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_getParentCollection](foundry.documents.BaseJournalEntry.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_initializationOrder](foundry.documents.BaseJournalEntry.md#_initializationorder)
...
* \_initialize(options: any): void
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_initialize](foundry.documents.BaseJournalEntry.md#_initialize)
...
* \_onDelete(options: any, userId: any): void
  ...
  Overrides [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_onDelete](foundry.documents.BaseJournalEntry.md#_ondelete)
...
* \_onUpdate(changed: any, options: any, userId: any): void
  ...
  Overrides [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_onUpdate](foundry.documents.BaseJournalEntry.md#_onupdate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_updateDiff](foundry.documents.BaseJournalEntry.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[canUserModify](foundry.documents.BaseJournalEntry.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[clone](foundry.documents.BaseJournalEntry.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[createEmbeddedDocuments](foundry.documents.BaseJournalEntry.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[delete](foundry.documents.BaseJournalEntry.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[deleteEmbeddedDocuments](foundry.documents.BaseJournalEntry.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[getEmbeddedCollection](foundry.documents.BaseJournalEntry.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[getEmbeddedDocument](foundry.documents.BaseJournalEntry.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[getFieldForProperty](foundry.documents.BaseJournalEntry.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[getFlag](foundry.documents.BaseJournalEntry.md#getflag)

### getUserLevel

* getUserLevel(user: any): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.md)
  ...
  Overrides [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[getUserLevel](foundry.documents.BaseJournalEntry.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[migrateSystemData](foundry.documents.BaseJournalEntry.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[reset](foundry.documents.BaseJournalEntry.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[setFlag](foundry.documents.BaseJournalEntry.md#setflag)

### show

* show(force?: boolean): Promise<[documents](../modules/foundry.documents.md).JournalEntry>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).JournalEntry>
...
* testUserPermission(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[testUserPermission](foundry.documents.BaseJournalEntry.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[toJSON](foundry.documents.BaseJournalEntry.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[toObject](foundry.documents.BaseJournalEntry.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[traverseEmbeddedDocuments](foundry.documents.BaseJournalEntry.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[unsetFlag](foundry.documents.BaseJournalEntry.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[update](foundry.documents.BaseJournalEntry.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[updateEmbeddedDocuments](foundry.documents.BaseJournalEntry.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[updateSource](foundry.documents.BaseJournalEntry.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[validate](foundry.documents.BaseJournalEntry.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_getInnerModel](foundry.documents.BaseJournalEntry.md#_getinnermodel)
...
* \_initializeSource(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_initializeSource](foundry.documents.BaseJournalEntry.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_onCreate](foundry.documents.BaseJournalEntry.md#_oncreate)
...
* \_preCreate(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_preCreate](foundry.documents.BaseJournalEntry.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_preDelete](foundry.documents.BaseJournalEntry.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_preUpdate](foundry.documents.BaseJournalEntry.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_preUpdateSource](foundry.documents.BaseJournalEntry.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_updateCommit](foundry.documents.BaseJournalEntry.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_addDataFieldMigration](foundry.documents.BaseJournalEntry.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_addDataFieldShim](foundry.documents.BaseJournalEntry.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_addDataFieldShims](foundry.documents.BaseJournalEntry.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_clearFieldsRecursively](foundry.documents.BaseJournalEntry.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_logDataFieldMigration](foundry.documents.BaseJournalEntry.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_preCleanData](foundry.documents.BaseJournalEntry.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[canUserCreate](foundry.documents.BaseJournalEntry.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[cleanData](foundry.documents.BaseJournalEntry.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[create](foundry.documents.BaseJournalEntry.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[createDocuments](foundry.documents.BaseJournalEntry.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â categories: [EmbeddedCollectionField](foundry.data.fields.EmbeddedCollectionField.md);  
  ...
  Â Â Â Â pages: [EmbeddedCollectionField](foundry.data.fields.EmbeddedCollectionField.md);  
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â categories: [EmbeddedCollectionField](foundry.data.fields.EmbeddedCollectionField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â folder: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â ownership: [DocumentOwnershipField](foundry.data.fields.DocumentOwnershipField.md); Â Â Â Â pages: [EmbeddedCollectionField](foundry.data.fields.EmbeddedCollectionField.md); Â Â Â Â sort: [IntegerSortField](foundry.data.fields.IntegerSortField.md); }
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[defineSchema](foundry.documents.BaseJournalEntry.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[deleteDocuments](foundry.documents.BaseJournalEntry.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[fromJSON](foundry.documents.BaseJournalEntry.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[fromSource](foundry.documents.BaseJournalEntry.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[get](foundry.documents.BaseJournalEntry.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[getCollectionName](foundry.documents.BaseJournalEntry.md#getcollectionname)
...
* migrateData(source: any, options: any): object
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[migrateData](foundry.documents.BaseJournalEntry.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[migrateDataSafe](foundry.documents.BaseJournalEntry.md#migratedatasafe)
...
* shimData(source: any, options: any): object
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[shimData](foundry.documents.BaseJournalEntry.md#shimdata)

### `Static`sortCategories

* sortCategories(  
  Â Â Â Â a: [documents](../modules/foundry.documents.md).[JournalEntryCategory](foundry.documents.JournalEntryCategory.md),  
  Â Â Â Â b: [documents](../modules/foundry.documents.md).[JournalEntryCategory](foundry.documents.JournalEntryCategory.md),  
  ): number
  ...
  + a: [documents](../modules/foundry.documents.md).[JournalEntryCategory](foundry.documents.JournalEntryCategory.md)
  + b: [documents](../modules/foundry.documents.md).[JournalEntryCategory](foundry.documents.JournalEntryCategory.md)
...
* updateDocuments(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[updateDocuments](foundry.documents.BaseJournalEntry.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[validateJoint](foundry.documents.BaseJournalEntry.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_cleanData](foundry.documents.BaseJournalEntry.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_onCreateOperation](foundry.documents.BaseJournalEntry.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_onDeleteOperation](foundry.documents.BaseJournalEntry.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_onUpdateOperation](foundry.documents.BaseJournalEntry.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_preCreateOperation](foundry.documents.BaseJournalEntry.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_preDeleteOperation](foundry.documents.BaseJournalEntry.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseJournalEntry](foundry.documents.BaseJournalEntry.md).[\_preUpdateOperation](foundry.documents.BaseJournalEntry.md#_preupdateoperation)