---
title: "Scenes | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.collections.Scenes.html"
category: "classes"
---
...
* [foundry.documents.Scene](foundry.documents.Scene.md): The Scene document
* [foundry.applications.sidebar.tabs.SceneDirectory](foundry.applications.sidebar.tabs.SceneDirectory.md): The SceneDirectory sidebar directory

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.collections.Scenes))
...
* get active(): [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)
...
* get current(): [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)
...
* get viewed(): [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)
...
* every(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â element: [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)>,  
  Â Â Â Â ) => boolean,  
  ): boolean
  ...
  + condition: (  
    Â Â Â Â element: [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md),  
    Â Â Â Â index: number,  
    Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)>,  
    ) => boolean
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)>,  
  Â Â Â Â ) => unknown,  
  ): [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md) | undefined
  ...
  #### Returns [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md) | undefined
...
* forEach(fn: (value: [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md), index: number) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md), index: number) => void
...
* fromCompendium(  
  ...
  Overrides [WorldCollection](foundry.documents.abstract.WorldCollection.md).[fromCompendium](foundry.documents.abstract.WorldCollection.md#fromcompendium)
...
* getInvalid(id: string, options?: { strict?: boolean }): void | [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)
  ...
  #### Returns void | [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)
...
* importFromCompendium(  
  ...
  Â Â Â Â options?: any,  
  ): Promise<[documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)>
...
* preload(  
  ...
  Â Â Â Â options?: { broadcast?: boolean; level?: string },  
  ): Promise<(void | [Sound](foundry.audio.Sound.md))[] | undefined>
  ...
  + `Optional`options: { broadcast?: boolean; level?: string } = {}
  ...
  #### Returns Promise<(void | [Sound](foundry.audio.Sound.md))[] | undefined>
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)[]
...
* set(id: string, document: [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)): Scenes

  #### Parameters

  + id: string
  + document: [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md)
