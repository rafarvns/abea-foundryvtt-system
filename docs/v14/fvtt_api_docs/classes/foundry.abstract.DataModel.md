---
title: "DataModel | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.abstract.DataModel.html"
category: "classes"
---
...
objects like `Scene` documents. Data models are often nested; see the [DataModel.parent](#parent) property for more.
...
* ModelContext extends [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md) = [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)

#### Hierarchy ([View Summary](../hierarchy.md#foundry.abstract.DataModel))

* DataModel
  + [BaseTerrainData](foundry.data.BaseTerrainData.md)
  + [CalendarData](foundry.data.CalendarData.md)
  + [LightData](foundry.data.LightData.md)
  + [PrototypeToken](foundry.data.PrototypeToken.md)
  + [PrototypeTokenOverrides](foundry.data.PrototypeTokenOverrides.md)
  + [ShapeData](foundry.data.ShapeData.md)
  + [BaseShapeData](foundry.data.BaseShapeData.md)
  + [TombstoneData](foundry.data.TombstoneData.md)
  ...
  + [ReleaseData](foundry.config.ReleaseData.md)
  + [ServerSettings](foundry.config.ServerSettings.md)
  + [VisionMode](foundry.canvas.perception.VisionMode.md)
  + [DetectionMode](foundry.canvas.perception.DetectionMode.md)
  + [VFXComponent](foundry.canvas.vfx.VFXComponent.md)
  + [VFXEffect](foundry.canvas.vfx.VFXEffect.md)
  + [DynamicRingData](foundry.canvas.placeables.tokens.DynamicRingData.md)
  + [TurnMarkerData](foundry.canvas.placeables.tokens.TurnMarkerData.md)
...
* new DataModel<  
  Â Â Â Â [ModelData](#constructordatamodelmodeldata) extends object = object,  
  Â Â Â Â [ModelContext](#constructordatamodelmodelcontext) extends  
  Â Â Â Â Â Â Â Â [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md) = [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md),  
  >(  
  Â Â Â Â data?: Partial<[ModelData](#modeldata)>,  
  Â Â Â Â options?: [ModelContext](#modelcontext),  
  ): DataModel<[ModelData](#modeldata), [ModelContext](#modelcontext)>
  ...
  + `Optional`data: Partial<[ModelData](#modeldata)> = {}
  ...
  + `Optional`options: [ModelContext](#modelcontext) = {}

    Context and data validation options which affects initial model construction.

  #### Returns DataModel<[ModelData](#modeldata), [ModelContext](#modelcontext)>

## Properties

### \_source

\_source: [ModelData](#modeldata)
...
parent: DataModel<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)> | null
...
* clone(  
  ...
  Â Â Â Â | DataModel<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>  
  Â Â Â Â | Promise<DataModel<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>>
  ...
  #### Returns Â Â Â Â | DataModel<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)> Â Â Â Â | Promise<DataModel<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>>
...
* \_getInnerModel(  
  ...
  ): DataModel<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)> | null
  ...
  #### Returns DataModel<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)> | null
...
* \_initializeSource(  
  Â Â Â Â data: object | DataModel<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>,  
  Â Â Â Â options?: [ModelContext](#modelcontext),  
  ): object
  ...
  + data: object | DataModel<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
...
* fromJSON(json: string): DataModel<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  #### Returns DataModel<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
...
* fromSource(  
  ...
  ): DataModel<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
