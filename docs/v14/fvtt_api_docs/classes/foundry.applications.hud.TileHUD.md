---
title: "TileHUD | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.hud.TileHUD.html"
category: "classes"
---
...
The TileHUD implementation can be configured and replaced via [CONFIG.Tile.hudClass](../variables/CONFIG.Tile.md#hudclass).

#### Mixes

HandlebarsApplication

#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.hud.TileHUD))

* [BasePlaceableHUD](foundry.applications.hud.BasePlaceableHUD.md)<[canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).[Tile](foundry.canvas.placeables.Tile.md), [TileDocument](foundry.documents.TileDocument.md), [TilesLayer](foundry.canvas.layers.TilesLayer.md), this>
  + TileHUD
...
* new TileHUD(options?: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md)>): TileHUD
...
Â Â Â Â Â Â Â Â Â Â Â Â this: TileHUD,  
...
* bind(object: [canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).[Tile](foundry.canvas.placeables.Tile.md)): Promise<void>

  Bind the HUD to a new PlaceableObject and display it.

  #### Parameters

  + object: [canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).[Tile](foundry.canvas.placeables.Tile.md)
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<TileHUD>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<TileHUD>
