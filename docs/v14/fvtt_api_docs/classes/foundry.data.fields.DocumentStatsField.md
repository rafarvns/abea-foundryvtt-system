---
title: "DocumentStatsField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.DocumentStatsField.html"
category: "classes"
---

# Class DocumentStatsField

A subclass of [foundry.data.fields.SchemaField](foundry.data.fields.SchemaField.md) which stores document metadata in the \_stats field.

#### Mixes

DocumentStats

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.DocumentStatsField))
...
[\_migrateData](#_migratedata)
[\_shimData](#_shimdata)
[\_shimDocument](#_shimdocument)
...
* \_getField(  
  ...
  ): [DataField](foundry.data.fields.DataField.md) | DocumentStatsField | undefined
  ...
  #### Returns [DataField](foundry.data.fields.DataField.md) | DocumentStatsField | undefined
...
* \_migrateData(document: any, source: object): void
...
* \_shimData(document: typeof [Document](foundry.abstract.Document.md), source: object, options?: object): void
...
### `Static`\_shimDocument

* \_shimDocument(document: typeof [Document](foundry.abstract.Document.md)): void
