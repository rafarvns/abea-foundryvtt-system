---
title: "Card | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.Card.html"
category: "classes"
---
...
* [foundry.documents.Cards](foundry.documents.Cards.md): The Cards document type which contains Card embedded documents
* [foundry.applications.sheets.CardConfig](foundry.applications.sheets.CardConfig.md): The Card configuration application

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.Card))

* [BaseCard](foundry.documents.BaseCard.md)<this>
  + Card
...
[hasNextFace](#hasnextface)
[hasPreviousFace](#haspreviousface)
[id](#id)
[img](#img)
...
* new Card(  
  Â Â Â Â data?: Partial<[CardData](../interfaces/foundry.documents.types.CardData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).Card

  #### Parameters

  + `Optional`data: Partial<[CardData](../interfaces/foundry.documents.types.CardData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).Card

  Inherited from [BaseCard](foundry.documents.BaseCard.md).[constructor](foundry.documents.BaseCard.md#constructor)

## Properties

### \_source

\_source: [CardData](../interfaces/foundry.documents.types.CardData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_source](foundry.documents.BaseCard.md#_source)
...
Inherited from [BaseCard](foundry.documents.BaseCard.md).[parent](foundry.documents.BaseCard.md#parent)
...
Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_schema](foundry.documents.BaseCard.md#_schema)
...
Inherited from [BaseCard](foundry.documents.BaseCard.md).[DEFAULT\_ICON](foundry.documents.BaseCard.md#default_icon)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseCard](foundry.documents.BaseCard.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseCard.md#localization_prefixes)
...
Inherited from [BaseCard](foundry.documents.BaseCard.md).[metadata](foundry.documents.BaseCard.md#metadata)
...
* get currentFace(): [CardFaceData](../interfaces/foundry.documents.types.CardFaceData.md) | null

  The current card face

  #### Returns [CardFaceData](../interfaces/foundry.documents.types.CardFaceData.md) | null
...
* get source(): [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md) | null

  A reference to the source Cards document which defines this Card.

  #### Returns [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md) | null
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_configure](foundry.documents.BaseCard.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_getParentCollection](foundry.documents.BaseCard.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_initializationOrder](foundry.documents.BaseCard.md#_initializationorder)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_updateDiff](foundry.documents.BaseCard.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[canUserModify](foundry.documents.BaseCard.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[clone](foundry.documents.BaseCard.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[createEmbeddedDocuments](foundry.documents.BaseCard.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[delete](foundry.documents.BaseCard.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[deleteEmbeddedDocuments](foundry.documents.BaseCard.md#deleteembeddeddocuments)
...
* flip(face?: number | null): Promise<[documents](../modules/foundry.documents.md).Card>
  ...
  + `Optional`face: number | null

    A specific face to flip the card to

  #### Returns Promise<[documents](../modules/foundry.documents.md).Card>
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[getEmbeddedCollection](foundry.documents.BaseCard.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[getEmbeddedDocument](foundry.documents.BaseCard.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[getFieldForProperty](foundry.documents.BaseCard.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[getFlag](foundry.documents.BaseCard.md#getflag)
...
* getUserLevel(user?: [BaseUser](foundry.documents.BaseUser.md)): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.md)
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[getUserLevel](foundry.documents.BaseCard.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[migrateSystemData](foundry.documents.BaseCard.md#migratesystemdata)

### pass

* pass(  
  Â Â Â Â to: [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md),  
  Â Â Â Â options?: { updateData?: object },  
  ): Promise<[documents](../modules/foundry.documents.md).Card>

  Pass this Card to some other Cards document.

  #### Parameters

  + to: [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)
...
* recall(options?: object): Promise<[documents](../modules/foundry.documents.md).Card>
...
* reset(): void
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[reset](foundry.documents.BaseCard.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[setFlag](foundry.documents.BaseCard.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[testUserPermission](foundry.documents.BaseCard.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[toJSON](foundry.documents.BaseCard.md#tojson)
...
* toMessage(  
  ...
  ): Promise<[documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)>
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[toObject](foundry.documents.BaseCard.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[traverseEmbeddedDocuments](foundry.documents.BaseCard.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[unsetFlag](foundry.documents.BaseCard.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[update](foundry.documents.BaseCard.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[updateEmbeddedDocuments](foundry.documents.BaseCard.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[updateSource](foundry.documents.BaseCard.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[validate](foundry.documents.BaseCard.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_getInnerModel](foundry.documents.BaseCard.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_initialize](foundry.documents.BaseCard.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_initializeSource](foundry.documents.BaseCard.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_onCreate](foundry.documents.BaseCard.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_onDelete](foundry.documents.BaseCard.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_onUpdate](foundry.documents.BaseCard.md#_onupdate)
...
* \_preCreate(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_preCreate](foundry.documents.BaseCard.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_preDelete](foundry.documents.BaseCard.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_preUpdate](foundry.documents.BaseCard.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_preUpdateSource](foundry.documents.BaseCard.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_updateCommit](foundry.documents.BaseCard.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_addDataFieldMigration](foundry.documents.BaseCard.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_addDataFieldShim](foundry.documents.BaseCard.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_addDataFieldShims](foundry.documents.BaseCard.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_clearFieldsRecursively](foundry.documents.BaseCard.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_logDataFieldMigration](foundry.documents.BaseCard.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_preCleanData](foundry.documents.BaseCard.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[canUserCreate](foundry.documents.BaseCard.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[cleanData](foundry.documents.BaseCard.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[create](foundry.documents.BaseCard.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[createDocuments](foundry.documents.BaseCard.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â back: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â description: [HTMLField](foundry.data.fields.HTMLField.md);  
  Â Â Â Â drawn: [BooleanField](foundry.data.fields.BooleanField.md);  
  Â Â Â Â face: [NumberField](foundry.data.fields.NumberField.md);  
  Â Â Â Â faces: [ArrayField](foundry.data.fields.ArrayField.md)<[SchemaField](foundry.data.fields.SchemaField.md)>;  
  ...
  Â Â Â Â origin: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md);  
  ...
  Â Â Â Â suit: [StringField](foundry.data.fields.StringField.md);  
  ...
  Â Â Â Â value: [NumberField](foundry.data.fields.NumberField.md);  
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â back: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â description: [HTMLField](foundry.data.fields.HTMLField.md); Â Â Â Â drawn: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â face: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â faces: [ArrayField](foundry.data.fields.ArrayField.md)<[SchemaField](foundry.data.fields.SchemaField.md)>; Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â height: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â origin: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); Â Â Â Â rotation: [AngleField](foundry.data.fields.AngleField.md); Â Â Â Â sort: [IntegerSortField](foundry.data.fields.IntegerSortField.md); Â Â Â Â suit: [StringField](foundry.data.fields.StringField.md); Â Â Â Â system: [TypeDataField](foundry.data.fields.TypeDataField.md); Â Â Â Â type: [DocumentTypeField](foundry.data.fields.DocumentTypeField.md); Â Â Â Â value: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â width: [NumberField](foundry.data.fields.NumberField.md); }
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[defineSchema](foundry.documents.BaseCard.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[deleteDocuments](foundry.documents.BaseCard.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[fromJSON](foundry.documents.BaseCard.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[fromSource](foundry.documents.BaseCard.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[get](foundry.documents.BaseCard.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[getCollectionName](foundry.documents.BaseCard.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[migrateData](foundry.documents.BaseCard.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[migrateDataSafe](foundry.documents.BaseCard.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[shimData](foundry.documents.BaseCard.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[updateDocuments](foundry.documents.BaseCard.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[validateJoint](foundry.documents.BaseCard.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_cleanData](foundry.documents.BaseCard.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_onCreateOperation](foundry.documents.BaseCard.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_onDeleteOperation](foundry.documents.BaseCard.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_onUpdateOperation](foundry.documents.BaseCard.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_preCreateOperation](foundry.documents.BaseCard.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_preDeleteOperation](foundry.documents.BaseCard.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseCard](foundry.documents.BaseCard.md).[\_preUpdateOperation](foundry.documents.BaseCard.md#_preupdateoperation)