---
title: "CardDeckConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.CardDeckConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.CardDeckConfig))
...
* new CardDeckConfig(options: any, ...args: any[]): CardDeckConfig
...
PARTS: {  
Â Â Â Â cards: { scrollable: string[]; template: string };  
...
* \_preparePartContext(partId: any, context: any, options: any): Promise<any>
  ...
  Overrides CardsConfig.\_preparePartContext
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<CardDeckConfig>
  ...
  #### Returns Promise<CardDeckConfig>
