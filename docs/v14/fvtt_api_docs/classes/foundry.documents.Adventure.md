---
title: "Adventure | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.Adventure.html"
category: "classes"
---

# Class Adventure

The client-side Adventure document which extends the common [foundry.documents.BaseAdventure](foundry.documents.BaseAdventure.md) model.

### Hook Events

* [hookEvents.preImportAdventure](../functions/hookEvents.preImportAdventure.md) (emitted by [Adventure#import](#import))
* [hookEvents.importAdventure](../functions/hookEvents.importAdventure.md) (emitted by [Adventure#import](#import))

#### Mixes

ClientDocumentMixin

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.Adventure))

* [BaseAdventure](foundry.documents.BaseAdventure.md)<this>
  + Adventure
...
* new Adventure(  
  Â Â Â Â data?: Partial<[AdventureData](../interfaces/foundry.documents.types.AdventureData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).Adventure

  #### Parameters

  + `Optional`data: Partial<[AdventureData](../interfaces/foundry.documents.types.AdventureData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).Adventure

  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[constructor](foundry.documents.BaseAdventure.md#constructor)

## Properties

### \_source

\_source: [AdventureData](../interfaces/foundry.documents.types.AdventureData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_source](foundry.documents.BaseAdventure.md#_source)
...
Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[parent](foundry.documents.BaseAdventure.md#parent)
...
Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_schema](foundry.documents.BaseAdventure.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseAdventure.md#localization_prefixes)
...
Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[metadata](foundry.documents.BaseAdventure.md#metadata)
...
* get contentFields(): Record<string, typeof [Document](foundry.abstract.Document.md)>

  An array of the fields which provide imported content from the Adventure.

  #### Returns Record<string, typeof [Document](foundry.abstract.Document.md)>
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_configure](foundry.documents.BaseAdventure.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_getParentCollection](foundry.documents.BaseAdventure.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_initializationOrder](foundry.documents.BaseAdventure.md#_initializationorder)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_updateDiff](foundry.documents.BaseAdventure.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[canUserModify](foundry.documents.BaseAdventure.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[clone](foundry.documents.BaseAdventure.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[createEmbeddedDocuments](foundry.documents.BaseAdventure.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[delete](foundry.documents.BaseAdventure.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[deleteEmbeddedDocuments](foundry.documents.BaseAdventure.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[getEmbeddedCollection](foundry.documents.BaseAdventure.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[getEmbeddedDocument](foundry.documents.BaseAdventure.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[getFieldForProperty](foundry.documents.BaseAdventure.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[getFlag](foundry.documents.BaseAdventure.md#getflag)
...
* getUserLevel(user?: [BaseUser](foundry.documents.BaseUser.md)): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.md)
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[getUserLevel](foundry.documents.BaseAdventure.md#getuserlevel)

### import

* import(importOptions?: [AdventureImportOptions](../interfaces/foundry.documents.types.AdventureImportOptions.md)): Promise<[AdventureImportResult](../interfaces/foundry.documents.types.AdventureImportResult.md)>
  ...
  + `Optional`importOptions: [AdventureImportOptions](../interfaces/foundry.documents.types.AdventureImportOptions.md) = {}

    Options which configure and customize the import process

  #### Returns Promise<[AdventureImportResult](../interfaces/foundry.documents.types.AdventureImportResult.md)>

  The import result

### importContent

* importContent(data?: [AdventureImportData](../interfaces/foundry.documents.types.AdventureImportData.md)): Promise<[AdventureImportResult](../interfaces/foundry.documents.types.AdventureImportResult.md)>
...
* migrateSystemData(): object
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[migrateSystemData](foundry.documents.BaseAdventure.md#migratesystemdata)

### prepareImport

* prepareImport(options?: [AdventureImportOptions](../interfaces/foundry.documents.types.AdventureImportOptions.md)): Promise<[AdventureImportData](../interfaces/foundry.documents.types.AdventureImportData.md)>

  Prepare Adventure data for import into the World.

  #### Parameters

  + `Optional`options: [AdventureImportOptions](../interfaces/foundry.documents.types.AdventureImportOptions.md)

    Options which configure import behavior

  #### Returns Promise<[AdventureImportData](../interfaces/foundry.documents.types.AdventureImportData.md)>
...
* reset(): void
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[reset](foundry.documents.BaseAdventure.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[setFlag](foundry.documents.BaseAdventure.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[testUserPermission](foundry.documents.BaseAdventure.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[toJSON](foundry.documents.BaseAdventure.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[toObject](foundry.documents.BaseAdventure.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[traverseEmbeddedDocuments](foundry.documents.BaseAdventure.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[unsetFlag](foundry.documents.BaseAdventure.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[update](foundry.documents.BaseAdventure.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[updateEmbeddedDocuments](foundry.documents.BaseAdventure.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[updateSource](foundry.documents.BaseAdventure.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[validate](foundry.documents.BaseAdventure.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_getInnerModel](foundry.documents.BaseAdventure.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_initialize](foundry.documents.BaseAdventure.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_initializeSource](foundry.documents.BaseAdventure.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_onCreate](foundry.documents.BaseAdventure.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_onDelete](foundry.documents.BaseAdventure.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_onUpdate](foundry.documents.BaseAdventure.md#_onupdate)
...
* \_preCreate(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_preCreate](foundry.documents.BaseAdventure.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_preDelete](foundry.documents.BaseAdventure.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_preUpdate](foundry.documents.BaseAdventure.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_preUpdateSource](foundry.documents.BaseAdventure.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_updateCommit](foundry.documents.BaseAdventure.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_addDataFieldMigration](foundry.documents.BaseAdventure.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_addDataFieldShim](foundry.documents.BaseAdventure.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_addDataFieldShims](foundry.documents.BaseAdventure.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_clearFieldsRecursively](foundry.documents.BaseAdventure.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_logDataFieldMigration](foundry.documents.BaseAdventure.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_preCleanData](foundry.documents.BaseAdventure.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[canUserCreate](foundry.documents.BaseAdventure.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[cleanData](foundry.documents.BaseAdventure.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[create](foundry.documents.BaseAdventure.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[createDocuments](foundry.documents.BaseAdventure.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â actors: [SetField](foundry.data.fields.SetField.md);  
  Â Â Â Â caption: [HTMLField](foundry.data.fields.HTMLField.md);  
  Â Â Â Â cards: [SetField](foundry.data.fields.SetField.md);  
  Â Â Â Â combats: [SetField](foundry.data.fields.SetField.md);  
  ...
  Â Â Â Â folders: [SetField](foundry.data.fields.SetField.md);  
  Â Â Â Â img: [FilePathField](foundry.data.fields.FilePathField.md);  
  Â Â Â Â items: [SetField](foundry.data.fields.SetField.md);  
  Â Â Â Â journal: [SetField](foundry.data.fields.SetField.md);  
  Â Â Â Â macros: [SetField](foundry.data.fields.SetField.md);  
  Â Â Â Â name: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â playlists: [SetField](foundry.data.fields.SetField.md);  
  Â Â Â Â scenes: [SetField](foundry.data.fields.SetField.md);  
  Â Â Â Â sort: [IntegerSortField](foundry.data.fields.IntegerSortField.md);  
  Â Â Â Â tables: [SetField](foundry.data.fields.SetField.md);  
  }
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â actors: [SetField](foundry.data.fields.SetField.md); Â Â Â Â caption: [HTMLField](foundry.data.fields.HTMLField.md); Â Â Â Â cards: [SetField](foundry.data.fields.SetField.md); Â Â Â Â combats: [SetField](foundry.data.fields.SetField.md); Â Â Â Â description: [HTMLField](foundry.data.fields.HTMLField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â folder: [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md); Â Â Â Â folders: [SetField](foundry.data.fields.SetField.md); Â Â Â Â img: [FilePathField](foundry.data.fields.FilePathField.md); Â Â Â Â items: [SetField](foundry.data.fields.SetField.md); Â Â Â Â journal: [SetField](foundry.data.fields.SetField.md); Â Â Â Â macros: [SetField](foundry.data.fields.SetField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â playlists: [SetField](foundry.data.fields.SetField.md); Â Â Â Â scenes: [SetField](foundry.data.fields.SetField.md); Â Â Â Â sort: [IntegerSortField](foundry.data.fields.IntegerSortField.md); Â Â Â Â tables: [SetField](foundry.data.fields.SetField.md); }
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[defineSchema](foundry.documents.BaseAdventure.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[deleteDocuments](foundry.documents.BaseAdventure.md#deletedocuments)

### `Static`fromIndex

* fromIndex(id: string, pack: CompendiumCollection): [documents](../modules/foundry.documents.md).Adventure
  ...
  + id: string
    ...
    The adventure's document ID.
  + pack: CompendiumCollection

    The compendium pack containing the adventure.
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[fromJSON](foundry.documents.BaseAdventure.md#fromjson)
...
* fromSource(  
  ...
  Overrides [BaseAdventure](foundry.documents.BaseAdventure.md).[fromSource](foundry.documents.BaseAdventure.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[get](foundry.documents.BaseAdventure.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[getCollectionName](foundry.documents.BaseAdventure.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[migrateData](foundry.documents.BaseAdventure.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[migrateDataSafe](foundry.documents.BaseAdventure.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[shimData](foundry.documents.BaseAdventure.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[updateDocuments](foundry.documents.BaseAdventure.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[validateJoint](foundry.documents.BaseAdventure.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_cleanData](foundry.documents.BaseAdventure.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_onCreateOperation](foundry.documents.BaseAdventure.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_onDeleteOperation](foundry.documents.BaseAdventure.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_onUpdateOperation](foundry.documents.BaseAdventure.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_preCreateOperation](foundry.documents.BaseAdventure.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_preDeleteOperation](foundry.documents.BaseAdventure.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseAdventure](foundry.documents.BaseAdventure.md).[\_preUpdateOperation](foundry.documents.BaseAdventure.md#_preupdateoperation)