---
title: "GridOffsetsField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.GridOffsetsField.html"
category: "classes"
---

# Class GridOffsetsField

The field of an array/set of grid offsets.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.GridOffsetsField))
...
* new GridOffsetsField(  
  Â Â Â Â options?: [GridOffsetsFieldOptions](../interfaces/foundry.data.types.GridOffsetsFieldOptions.md),  
  Â Â Â Â context?: [DataFieldContext](../interfaces/foundry.data.types.DataFieldContext.md),  
  ): GridOffsetsField

  #### Parameters

  + `Optional`options: [GridOffsetsFieldOptions](../interfaces/foundry.data.types.GridOffsetsFieldOptions.md)
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & {  
  ...
  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { Â Â Â Â empty: boolean; Â Â Â Â exact: undefined; Â Â Â Â max: number; Â Â Â Â min: number; Â Â Â Â nullable: boolean; Â Â Â Â required: boolean; } & { dimensions: number }

  Overrides ArrayField.\_defaults
...
* \_toInput(config: any): [HTMLStringTagsElement](foundry.applications.elements.HTMLStringTagsElement.md)
...
* initialize(value: any, model: any, options?: {}): any
  ...
  Inherited from [ArrayField](foundry.data.fields.ArrayField.md).[initialize](foundry.data.fields.ArrayField.md#initialize)
