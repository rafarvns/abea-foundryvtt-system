---
title: "ActorDelta | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.ActorDelta.html"
category: "classes"
---
...
[foundry.documents.TokenDocument](foundry.documents.TokenDocument.md): The TokenDocument document type which contains ActorDelta embedded
documents.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.ActorDelta))

* [BaseActorDelta](foundry.documents.BaseActorDelta.md)<this>
  + ActorDelta
...
[updateSyntheticActor](#updatesyntheticactor)
[validate](#validate)
...
* new ActorDelta(  
  Â Â Â Â data?: Partial<[ActorDeltaData](../interfaces/foundry.documents.types.ActorDeltaData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).ActorDelta

  #### Parameters

  + `Optional`data: Partial<[ActorDeltaData](../interfaces/foundry.documents.types.ActorDeltaData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).ActorDelta

  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[constructor](foundry.documents.BaseActorDelta.md#constructor)

## Properties

### \_source

\_source: [ActorDeltaData](../interfaces/foundry.documents.types.ActorDeltaData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_source](foundry.documents.BaseActorDelta.md#_source)
...
Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[parent](foundry.documents.BaseActorDelta.md#parent)
...
Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_schema](foundry.documents.BaseActorDelta.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseActorDelta.md#localization_prefixes)
...
Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[metadata](foundry.documents.BaseActorDelta.md#metadata)
...
* get compendium(): any
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).compendium
...
* get id(): any
  ...
  Overrides ClientDocumentMixin(BaseActorDelta).id
...
* get inCompendium(): boolean
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).inCompendium
...
* get invalid(): boolean
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).invalid
...
* get isEmbedded(): boolean
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).isEmbedded
...
* get schema(): [DataModelSchemaField](foundry.data.fields.DataModelSchemaField.md)
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).schema
...
* get uuid(): string | null
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).uuid
...
* get validationFailures(): {  
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).validationFailures
...
* get baseDocument(): typeof [Document](foundry.abstract.Document.md)
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).baseDocument
...
* get collectionName(): string
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).collectionName
...
* get database(): [abstract](../modules/foundry.abstract.md).[DatabaseBackend](foundry.abstract.DatabaseBackend.md)
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).database
...
* get documentName(): string
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).documentName
...
* get hasTypeData(): boolean
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).hasTypeData
...
* get hierarchy(): Readonly<Record<string, any>>
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).hierarchy
...
* get implementation(): typeof [Document](foundry.abstract.Document.md)
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).implementation
...
* get TYPES(): string[]
  ...
  Inherited from ClientDocumentMixin(BaseActorDelta).TYPES
...
* \_configure(options?: {}): void
  ...
  Overrides [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_configure](foundry.documents.BaseActorDelta.md#_configure)

### \_createSyntheticActor
...
* \_createSyntheticActor(options?: { reinitializeCollections?: boolean }): void
  ...
  + `Optional`options: { reinitializeCollections?: boolean } = {}
    - ##### `Optional`reinitializeCollections?: boolean
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_getParentCollection](foundry.documents.BaseActorDelta.md#_getparentcollection)

### \_handleDeltaCollectionUpdates
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_initializationOrder](foundry.documents.BaseActorDelta.md#_initializationorder)

### \_initialize

* \_initialize(\_\_namedParameters?: { sceneReset?: boolean }): void
  ...
  + \_\_namedParameters: { sceneReset?: boolean } = {}

    Options provided to the model constructor

  #### Returns void

  Overrides [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_initialize](foundry.documents.BaseActorDelta.md#_initialize)
...
* \_onDelete(options: any, userId: any): void
  ...
  Overrides [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_onDelete](foundry.documents.BaseActorDelta.md#_ondelete)
...
* \_onUpdate(changed: any, options: any, userId: any): void
  ...
  Overrides [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_onUpdate](foundry.documents.BaseActorDelta.md#_onupdate)
...
* \_preDelete(options: any, user: any): Promise<boolean | void>
  ...
  Overrides [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_preDelete](foundry.documents.BaseActorDelta.md#_predelete)
...
* \_prepareDeltaUpdate(changes?: {}, options?: {}): void
  ...
  Overrides [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_prepareDeltaUpdate](foundry.documents.BaseActorDelta.md#_preparedeltaupdate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_updateDiff](foundry.documents.BaseActorDelta.md#_updatediff)
...
* apply(context?: object): any
  ...
  + `Optional`context: object = {}
    ...
    Context to supply to synthetic Actor instantiation.
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[canUserModify](foundry.documents.BaseActorDelta.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[clone](foundry.documents.BaseActorDelta.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[createEmbeddedDocuments](foundry.documents.BaseActorDelta.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[delete](foundry.documents.BaseActorDelta.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[deleteEmbeddedDocuments](foundry.documents.BaseActorDelta.md#deleteembeddeddocuments)
...
* getBaseCollection(collectionName: string): Collection
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[getBaseCollection](foundry.documents.BaseActorDelta.md#getbasecollection)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[getEmbeddedCollection](foundry.documents.BaseActorDelta.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[getEmbeddedDocument](foundry.documents.BaseActorDelta.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[getFieldForProperty](foundry.documents.BaseActorDelta.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[getFlag](foundry.documents.BaseActorDelta.md#getflag)
...
* getUserLevel(user: any): any
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[getUserLevel](foundry.documents.BaseActorDelta.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[migrateSystemData](foundry.documents.BaseActorDelta.md#migratesystemdata)
...
* reset(): void
  ...
  Overrides [BaseActorDelta](foundry.documents.BaseActorDelta.md).[reset](foundry.documents.BaseActorDelta.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[setFlag](foundry.documents.BaseActorDelta.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[testUserPermission](foundry.documents.BaseActorDelta.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[toJSON](foundry.documents.BaseActorDelta.md#tojson)
...
* toObject(source?: boolean): {}
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[toObject](foundry.documents.BaseActorDelta.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[traverseEmbeddedDocuments](foundry.documents.BaseActorDelta.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[unsetFlag](foundry.documents.BaseActorDelta.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[update](foundry.documents.BaseActorDelta.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[updateEmbeddedDocuments](foundry.documents.BaseActorDelta.md#updateembeddeddocuments)
...
* updateSource(changes?: {}, options?: {}): object
  ...
  Overrides [BaseActorDelta](foundry.documents.BaseActorDelta.md).[updateSource](foundry.documents.BaseActorDelta.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[validate](foundry.documents.BaseActorDelta.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_getInnerModel](foundry.documents.BaseActorDelta.md#_getinnermodel)
...
* \_initializeSource(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_initializeSource](foundry.documents.BaseActorDelta.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_onCreate](foundry.documents.BaseActorDelta.md#_oncreate)
...
* \_preCreate(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_preCreate](foundry.documents.BaseActorDelta.md#_precreate)
...
* \_preUpdate(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_preUpdate](foundry.documents.BaseActorDelta.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_preUpdateSource](foundry.documents.BaseActorDelta.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_updateCommit](foundry.documents.BaseActorDelta.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_addDataFieldMigration](foundry.documents.BaseActorDelta.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_addDataFieldShim](foundry.documents.BaseActorDelta.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_addDataFieldShims](foundry.documents.BaseActorDelta.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_clearFieldsRecursively](foundry.documents.BaseActorDelta.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_logDataFieldMigration](foundry.documents.BaseActorDelta.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_preCleanData](foundry.documents.BaseActorDelta.md#_precleandata)

### `Static`applyDelta

* applyDelta(  
  Â Â Â Â delta: ActorDelta,  
  Â Â Â Â baseActor: [BaseActor](foundry.documents.BaseActor.md),  
  Â Â Â Â context?: object,  
  ): [BaseActor](foundry.documents.BaseActor.md) | null
  ...
  + delta: ActorDelta
    ...
    The ActorDelta.
  + baseActor: [BaseActor](foundry.documents.BaseActor.md)
  ...
  #### Returns [BaseActor](foundry.documents.BaseActor.md) | null

  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[applyDelta](foundry.documents.BaseActorDelta.md#applydelta)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[canUserCreate](foundry.documents.BaseActorDelta.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[cleanData](foundry.documents.BaseActorDelta.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[create](foundry.documents.BaseActorDelta.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[createDocuments](foundry.documents.BaseActorDelta.md#createdocuments)

### `Static`defineSchema

* defineSchema(): {  
  Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md);  
  Â Â Â Â effects: [EmbeddedCollectionDeltaField](foundry.data.fields.EmbeddedCollectionDeltaField.md);  
  ...
  Â Â Â Â items: [EmbeddedCollectionDeltaField](foundry.data.fields.EmbeddedCollectionDeltaField.md);  
  ...
  Â Â Â Â system: [ObjectField](foundry.data.fields.ObjectField.md);  
  Â Â Â Â type: [StringField](foundry.data.fields.StringField.md);  
  }

  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â effects: [EmbeddedCollectionDeltaField](foundry.data.fields.EmbeddedCollectionDeltaField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â img: [FilePathField](foundry.data.fields.FilePathField.md); Â Â Â Â items: [EmbeddedCollectionDeltaField](foundry.data.fields.EmbeddedCollectionDeltaField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â ownership: [DocumentOwnershipField](foundry.data.fields.DocumentOwnershipField.md); Â Â Â Â system: [ObjectField](foundry.data.fields.ObjectField.md); Â Â Â Â type: [StringField](foundry.data.fields.StringField.md); }

  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[defineSchema](foundry.documents.BaseActorDelta.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[deleteDocuments](foundry.documents.BaseActorDelta.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[fromJSON](foundry.documents.BaseActorDelta.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[fromSource](foundry.documents.BaseActorDelta.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[get](foundry.documents.BaseActorDelta.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[getCollectionName](foundry.documents.BaseActorDelta.md#getcollectionname)
...
* migrateData(source: any, options: any): object
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[migrateData](foundry.documents.BaseActorDelta.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[migrateDataSafe](foundry.documents.BaseActorDelta.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[shimData](foundry.documents.BaseActorDelta.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[updateDocuments](foundry.documents.BaseActorDelta.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[validateJoint](foundry.documents.BaseActorDelta.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_cleanData](foundry.documents.BaseActorDelta.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_onCreateOperation](foundry.documents.BaseActorDelta.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_onDeleteOperation](foundry.documents.BaseActorDelta.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_onUpdateOperation](foundry.documents.BaseActorDelta.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_preCreateOperation](foundry.documents.BaseActorDelta.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_preDeleteOperation](foundry.documents.BaseActorDelta.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseActorDelta](foundry.documents.BaseActorDelta.md).[\_preUpdateOperation](foundry.documents.BaseActorDelta.md#_preupdateoperation)