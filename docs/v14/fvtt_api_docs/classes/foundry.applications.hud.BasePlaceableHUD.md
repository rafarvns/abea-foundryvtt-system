---
title: "BasePlaceableHUD | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.hud.BasePlaceableHUD.html"
category: "classes"
---

# Class BasePlaceableHUD<ActiveHUDObject, ActiveHUDDocument, ActiveHUDLayer>

An abstract base class for displaying a heads-up-display interface bound to a Placeable Object on the Canvas.

#### Template: ActiveHUDObject

#### Template: ActiveHUDDocument

#### Template: ActiveHUDLayer

#### Type Parameters

* ActiveHUDObject extends [PlaceableObject](foundry.canvas.placeables.PlaceableObject.md)
* ActiveHUDDocument extends CanvasDocument
* ActiveHUDLayer extends [PlaceablesLayer](foundry.canvas.layers.PlaceablesLayer.md)

#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.hud.BasePlaceableHUD))

* [ApplicationV2](foundry.applications.api.ApplicationV2.md)
  + BasePlaceableHUD
    - [TileHUD](foundry.applications.hud.TileHUD.md)
    - [TokenHUD](foundry.applications.hud.TokenHUD.md)
    - [DrawingHUD](foundry.applications.hud.DrawingHUD.md)
...
* new BasePlaceableHUD<  
  Â Â Â Â [ActiveHUDObject](#constructorbaseplaceablehudactivehudobject) extends [PlaceableObject](foundry.canvas.placeables.PlaceableObject.md),  
  Â Â Â Â [ActiveHUDDocument](#constructorbaseplaceablehudactivehuddocument) extends CanvasDocument,  
  Â Â Â Â [ActiveHUDLayer](#constructorbaseplaceablehudactivehudlayer) extends [PlaceablesLayer](foundry.canvas.layers.PlaceablesLayer.md),  
  >(  
  Â Â Â Â options?: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md)>,  
  ): BasePlaceableHUD<[ActiveHUDObject](#activehudobject), [ActiveHUDDocument](#activehuddocument), [ActiveHUDLayer](#activehudlayer)>
  ...
  #### Returns BasePlaceableHUD<[ActiveHUDObject](#activehudobject), [ActiveHUDDocument](#activehuddocument), [ActiveHUDLayer](#activehudlayer)>
...
BASE\_APPLICATION: typeof BasePlaceableHUD = BasePlaceableHUD

Overrides ApplicationV2.BASE\_APPLICATION
...
Â Â Â Â Â Â Â Â Â Â Â Â this: BasePlaceableHUD<any, any, any>,  
...
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLButtonElement,  
Â Â Â Â Â Â Â Â ) => Promise<[Document](foundry.abstract.Document.md)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md)>[]>;  
...
* get document(): [ActiveHUDDocument](#activehuddocument)

  Convenience access to the Document which this HUD modifies.

  #### Returns [ActiveHUDDocument](#activehuddocument)
...
* get layer(): [ActiveHUDLayer](#activehudlayer)

  Convenience access for the canvas layer which this HUD modifies

  #### Returns [ActiveHUDLayer](#activehudlayer)
...
* get object(): [ActiveHUDObject](#activehudobject)

  Reference a PlaceableObject this HUD is currently bound to.

  #### Returns [ActiveHUDObject](#activehudobject)
...
* \_postRender(context: any, options: any): Promise<void>
  ...
  Overrides ApplicationV2.\_postRender
...
* bind(object: [ActiveHUDObject](#activehudobject)): Promise<void>

  Bind the HUD to a new PlaceableObject and display it.

  #### Parameters

  + object: [ActiveHUDObject](#activehudobject)
...
* close(  
  ...
  Â Â Â Â BasePlaceableHUD<[ActiveHUDObject](#activehudobject), [ActiveHUDDocument](#activehuddocument), [ActiveHUDLayer](#activehudlayer)>,  
  >
  ...
  #### Returns Promise<BasePlaceableHUD<[ActiveHUDObject](#activehudobject), [ActiveHUDDocument](#activehuddocument), [ActiveHUDLayer](#activehudlayer)>>
