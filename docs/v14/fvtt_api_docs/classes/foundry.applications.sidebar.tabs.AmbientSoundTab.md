---
title: "AmbientSoundTab | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.tabs.AmbientSoundTab.html"
category: "classes"
---

# Class AmbientSoundTab

The AmbientSound-specific placeables tab.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.tabs.AmbientSoundTab))
...
* new AmbientSoundTab(  
  Â Â Â Â options?: Partial<[ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md)>,  
  ): AmbientSoundTab
  ...
  #### Returns AmbientSoundTab

  Inherited from PlaceableTab.constructor
...
Inherited from PlaceableTab.options
...
Inherited from PlaceableTab.position
...
Inherited from PlaceableTab.tabGroups
...
Inherited from PlaceableTab.\_filterState
...
Inherited from PlaceableTab.\_searchFilter
...
Inherited from PlaceableTab.\_appId
...
Inherited from PlaceableTab.\_maxZ
...
Inherited from PlaceableTab.BASE\_APPLICATION
...
Â Â Â Â Â Â Â Â Â Â Â Â this: [PlaceableTab](foundry.applications.sidebar.tabs.PlaceableTab.md),  
...
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â this: [PlaceableTab](foundry.applications.sidebar.tabs.PlaceableTab.md),  
...
Inherited from PlaceableTab.DEFAULT\_OPTIONS
...
Inherited from PlaceableTab.DIRECTORY\_PARTIAL

### `Static`emittedEvents

emittedEvents: readonly ["prerender", "render", "close", "position"] = ...

Inherited from PlaceableTab.emittedEvents
...
Inherited from PlaceableTab.ENTRY\_PARTIAL
...
Inherited from PlaceableTab.FILTER\_CLASS
...
Inherited from PlaceableTab.PARTS
...
Inherited from PlaceableTab.RENDER\_STATES
...
Inherited from PlaceableTab.TABS
...
* get classList(): DOMTokenList
  ...
  Inherited from PlaceableTab.classList
...
* get collectionName(): string
  ...
  Inherited from PlaceableTab.collectionName
...
* get documentClass(): typeof [Document](foundry.abstract.Document.md)
  ...
  Inherited from [foundry](../modules/foundry.md).[documentClass](../modules/foundry.md#documentclass-2)
...
* get element(): HTMLElement
  ...
  Inherited from PlaceableTab.element
...
* get form(): HTMLFormElement | null
  ...
  Inherited from PlaceableTab.form
...
* get hasFrame(): boolean
  ...
  Inherited from PlaceableTab.hasFrame
...
* get id(): string
  ...
  Inherited from PlaceableTab.id
...
* get layer(): PlaceablesLayer
  ...
  Inherited from PlaceableTab.layer
...
* get minimized(): boolean
  ...
  Inherited from PlaceableTab.minimized
...
* get rendered(): boolean
  ...
  Inherited from PlaceableTab.rendered
...
* get schema(): DataModelSchemaField
  ...
  Inherited from PlaceableTab.schema
...
* get state(): number
  ...
  Inherited from PlaceableTab.state
...
* get title(): string
  ...
  Inherited from PlaceableTab.title
...
* \_applyFilters(): void
  ...
  Overrides PlaceableTab.\_applyFilters
...
* \_attachFrameListeners(): void
  ...
  Inherited from PlaceableTab.\_attachFrameListeners
...
* \_awaitTransition(element: HTMLElement, timeout: number): Promise<void>
  ...
  Inherited from PlaceableTab.\_awaitTransition
...
* \_canDetach(): boolean
  ...
  Inherited from PlaceableTab.\_canDetach
...
* \_configureRenderParts(options: any): any
  ...
  Inherited from PlaceableTab.\_configureRenderParts
...
* \_doEvent(  
  ...
  Inherited from PlaceableTab.\_doEvent
...
* \_initializeApplicationOptions(options: any): [ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md)
  ...
  Inherited from PlaceableTab.\_initializeApplicationOptions
...
* \_onDeactivateDirectory(): void
  ...
  Inherited from PlaceableTab.\_onDeactivateDirectory
...
* \_onDeactivateTab(): void
  ...
  Inherited from PlaceableTab.\_onDeactivateTab
...
* \_onFirstRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceableTab.\_onFirstRender
...
* \_onRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceableTab.\_onRender
...
* \_preparePartContext(partId: any, context: any, options: any): Promise<any>
  ...
  Inherited from PlaceableTab.\_preparePartContext
...
* \_renderHTML(  
  ...
  Inherited from PlaceableTab.\_renderHTML
...
* addEventListener(  
  ...
  Inherited from PlaceableTab.addEventListener
...
* attachWindow(  
  ...
  Inherited from PlaceableTab.attachWindow
...
* bringToFront(): void
  ...
  Inherited from PlaceableTab.bringToFront
...
* changeTab(  
  ...
  Inherited from PlaceableTab.changeTab

### close

* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<AmbientSoundTab>
  ...
  #### Returns Promise<AmbientSoundTab>

  A Promise which resolves to the closed Application instance

  Inherited from PlaceableTab.close

### detachWindow

* detachWindow(options?: [PlaceableTabConfiguration](../types/foundry.PlaceableTabConfiguration.md)): Promise<AmbientSoundTab>
  ...
  Inherited from PlaceableTab.detachWindow
...
* dispatchEvent(event: Event): boolean
  ...
  Inherited from PlaceableTab.dispatchEvent
...
* hoverEntry(object: PlaceableObject, hover: boolean): void
  ...
  Inherited from PlaceableTab.hoverEntry
...
* isEntryVisible(object: PlaceableObject): boolean
  ...
  Inherited from PlaceableTab.isEntryVisible
...
* maximize(): Promise<void>
  ...
  Inherited from PlaceableTab.maximize
...
* minimize(): Promise<void>
  ...
  Inherited from PlaceableTab.minimize
...
* removeEventListener(type: string, listener: [EmittedEventListener](../types/foundry.utils.types.EmittedEventListener.md)): void
  ...
  Inherited from PlaceableTab.removeEventListener
...
* render(  
  ...
  Inherited from PlaceableTab.render
...
* renderChild(  
  ...
  Inherited from PlaceableTab.renderChild
...
* setPosition(position?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void | [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from PlaceableTab.setPosition
...
* submit(submitOptions?: object): Promise<any>
  ...
  Inherited from PlaceableTab.submit
...
* \_canAttach(): boolean
  ...
  Inherited from PlaceableTab.\_canAttach
...
* \_canRender(options: [PlaceableTabConfiguration](../types/foundry.PlaceableTabConfiguration.md)): false | void
  ...
  Inherited from PlaceableTab.\_canRender
...
* \_clearFilters(): void
  ...
  Inherited from PlaceableTab.\_clearFilters
...
* \_configureRenderOptions(options: [PlaceableTabConfiguration](../types/foundry.PlaceableTabConfiguration.md)): void
  ...
  Inherited from PlaceableTab.\_configureRenderOptions
...
* \_createContextMenu(  
  ...
  Inherited from PlaceableTab.\_createContextMenu
...
* \_getEntryContextOptions(): ContextMenuEntry[]
  ...
  Inherited from PlaceableTab.\_getEntryContextOptions
...
* \_getEntryLabel(entry: [Document](foundry.abstract.Document.md)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md)>): string
  ...
  Inherited from PlaceableTab.\_getEntryLabel
...
* \_getFrameButtons(  
  ...
  Inherited from PlaceableTab.\_getFrameButtons
...
* \_getHeaderControls(): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Inherited from PlaceableTab.\_getHeaderControls
...
* \_getPlaceableFromElement(  
  ...
  Inherited from PlaceableTab.\_getPlaceableFromElement
...
* \_getTabsConfig(group: string): [ApplicationTabsConfiguration](../interfaces/foundry.applications.types.ApplicationTabsConfiguration.md) | null
  ...
  Inherited from PlaceableTab.\_getTabsConfig
...
* \_hasAdvancedFilters(): boolean
  ...
  Inherited from PlaceableTab.\_hasAdvancedFilters
...
* \_headerControlButtons(): Generator<[ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md), any, any>
  ...
  Inherited from PlaceableTab.\_headerControlButtons
...
* \_headerControlContextEntries(): Generator<[ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md), void, any>
  ...
  Inherited from PlaceableTab.\_headerControlContextEntries
...
* \_insertElement(  
  ...
  Inherited from PlaceableTab.\_insertElement
...
* \_isFiltered(): boolean
  ...
  Inherited from PlaceableTab.\_isFiltered
...
* \_matchesFilter(entry: [Document](foundry.abstract.Document.md)<object, [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md)>): boolean
  ...
  Inherited from PlaceableTab.\_matchesFilter
...
* \_onAttach(from: Document, to: Document): void
  ...
  Inherited from PlaceableTab.\_onAttach
...
* \_onChangeForm(formConfig: ApplicationFormConfiguration, event: Event): void
  ...
  Inherited from PlaceableTab.\_onChangeForm
...
* \_onClickAction(event: PointerEvent, target: HTMLElement): void
  ...
  Inherited from PlaceableTab.\_onClickAction
...
* \_onClickEntry(event: PointerEvent): void
  ...
  Inherited from PlaceableTab.\_onClickEntry
...
* \_onClickTab(event: PointerEvent): void
  ...
  Inherited from PlaceableTab.\_onClickTab
...
* \_onClose(options: [PlaceableTabConfiguration](../types/foundry.PlaceableTabConfiguration.md)): void
  ...
  Inherited from PlaceableTab.\_onClose
...
* \_onConfigureEntry(event: PointerEvent, target: HTMLElement): any
  ...
  Inherited from PlaceableTab.\_onConfigureEntry
...
* \_onCreateEntry(  
  ...
  Inherited from PlaceableTab.\_onCreateEntry
...
* \_onDeleteEntry(event: PointerEvent, target: HTMLElement): Promise<void>
  ...
  Inherited from PlaceableTab.\_onDeleteEntry
...
* \_onDetach(from: Document, to: Document): void
  ...
  Inherited from PlaceableTab.\_onDetach
...
* \_onDragStart(event: DragEvent): void
  ...
  Inherited from PlaceableTab.\_onDragStart
...
* \_onDuplicateEntry(  
  ...
  Inherited from PlaceableTab.\_onDuplicateEntry
...
* \_onFilterByLevel(id: string | null): void
  ...
  Inherited from PlaceableTab.\_onFilterByLevel
...
* \_onHoverInEntry(event: PointerEvent): void
  ...
  Inherited from PlaceableTab.\_onHoverInEntry
...
* \_onHoverOutEntry(event: PointerEvent): void
  ...
  Inherited from PlaceableTab.\_onHoverOutEntry
...
* \_onPosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from PlaceableTab.\_onPosition
...
* \_onSearchFilter(  
  ...
  Inherited from PlaceableTab.\_onSearchFilter
...
* \_onSubmitForm(  
  ...
  Inherited from PlaceableTab.\_onSubmitForm
...
* \_onToggleHidden(event: PointerEvent, target: HTMLElement): Promise<void>
  ...
  Inherited from PlaceableTab.\_onToggleHidden
...
* \_onToggleLocked(event: PointerEvent, target: HTMLElement): Promise<void>
  ...
  Inherited from PlaceableTab.\_onToggleLocked
...
* \_postRender(  
  ...
  Inherited from PlaceableTab.\_postRender
...
* \_preClose(options: [PlaceableTabConfiguration](../types/foundry.PlaceableTabConfiguration.md)): Promise<void>
  ...
  Inherited from PlaceableTab.\_preClose
...
* \_preFirstRender(  
  ...
  Inherited from PlaceableTab.\_preFirstRender
...
* \_prepareContext(  
  ...
  Inherited from PlaceableTab.\_prepareContext
...
* \_prepareDirectoryContext(  
  ...
  Inherited from PlaceableTab.\_prepareDirectoryContext
...
* \_prepareDuplicateData(  
  ...
  Inherited from PlaceableTab.\_prepareDuplicateData
...
* \_prepareEntry(  
  ...
  Inherited from PlaceableTab.\_prepareEntry
...
* \_prepareSearchContext(  
  ...
  Inherited from PlaceableTab.\_prepareSearchContext
...
* \_prepareTabs(group: string): Record<string, [ApplicationTab](../interfaces/foundry.applications.types.ApplicationTab.md)>
  ...
  Inherited from PlaceableTab.\_prepareTabs
...
* \_prePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from PlaceableTab.\_prePosition
...
* \_preRender(  
  ...
  Inherited from PlaceableTab.\_preRender
...
* \_refit(positionUpdate?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void
  ...
  Inherited from PlaceableTab.\_refit
...
* \_removeElement(element: HTMLElement): void
  ...
  Inherited from PlaceableTab.\_removeElement
...
* \_renderFrame(options: [PlaceableTabConfiguration](../types/foundry.PlaceableTabConfiguration.md)): Promise<HTMLElement>
  ...
  Inherited from PlaceableTab.\_renderFrame
...
* \_renderFrameButtons(options: [PlaceableTabConfiguration](../types/foundry.PlaceableTabConfiguration.md)): Promise<void>
  ...
  Inherited from PlaceableTab.\_renderFrameButtons
...
* \_renderHeaderControl(control: [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)): HTMLLIElement
  ...
  Inherited from PlaceableTab.\_renderHeaderControl
...
* \_replaceHTML(  
  ...
  Inherited from PlaceableTab.\_replaceHTML
...
* \_tearDown(options: [ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)): void
  ...
  Inherited from PlaceableTab.\_tearDown
...
* \_updateFrame(options: [PlaceableTabConfiguration](../types/foundry.PlaceableTabConfiguration.md)): void
  ...
  Inherited from PlaceableTab.\_updateFrame
...
* \_updatePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from PlaceableTab.\_updatePosition
...
* inheritanceChain(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), void, unknown>
  ...
  Inherited from PlaceableTab.inheritanceChain
...
* instances(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), any, any>
  ...
  Inherited from PlaceableTab.instances
...
* parseCSSDimension(style: string, parentDimension: number): number | void
  ...
  Inherited from PlaceableTab.parseCSSDimension
...
* waitForImages(element: HTMLElement): Promise<void>
  ...
  Inherited from PlaceableTab.waitForImages