---
title: "GridOffsetField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.GridOffsetField.html"
category: "classes"
---

# Class GridOffsetField

The field for a grid offset.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.GridOffsetField))
...
* new GridOffsetField(  
  Â Â Â Â options?: [GridOffsetFieldOptions](../interfaces/foundry.data.types.GridOffsetFieldOptions.md),  
  Â Â Â Â context?: [DataFieldContext](../interfaces/foundry.data.types.DataFieldContext.md),  
  ): GridOffsetField

  #### Parameters

  + `Optional`options: [GridOffsetFieldOptions](../interfaces/foundry.data.types.GridOffsetFieldOptions.md) = {}
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { nullable: boolean; required: boolean } & {  
  Â Â Â Â dimensions: number;  
  }

  Default parameters for this field type

  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { nullable: boolean; required: boolean } & { Â Â Â Â dimensions: number; }

  Overrides SchemaField.\_defaults
...
* \_getField(  
  ...
  ): [DataField](foundry.data.fields.DataField.md) | GridOffsetField | undefined
  ...
  #### Returns [DataField](foundry.data.fields.DataField.md) | GridOffsetField | undefined
