---
title: "ControlsConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.apps.ControlsConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.apps.ControlsConfig))
...
[PARTS](#parts)
[POINTER\_CONTROLS](#pointer_controls)
...
[\_prepareCategoryData](#_preparecategorydata)
...
[humanizeBinding](#humanizebinding)
...
* new ControlsConfig(  
  ...
  Â Â Â Â Â Â Â Â [ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [CategoryBrowserConfiguration](../interfaces/foundry.CategoryBrowserConfiguration.md),  
  Â Â Â Â >,  
  ): ControlsConfig
  ...
  + `Optional`options: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [CategoryBrowserConfiguration](../interfaces/foundry.CategoryBrowserConfiguration.md)> = {}
...
options: Readonly<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [CategoryBrowserConfiguration](../interfaces/foundry.CategoryBrowserConfiguration.md)>
...
PARTS: {  
Â Â Â Â bindingInput: { template: string };  
Â Â Â Â main: { scrollable: string[]; template: string };  
...
### `Static`POINTER\_CONTROLS

POINTER\_CONTROLS: readonly [  
Â Â Â Â id: string,  
Â Â Â Â name: string,  
...
* \_canDetach(): boolean
  ...
  Inherited from CategoryBrowser.\_canDetach
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â Â Â Â Â filters: string  
  Â Â Â Â Â Â Â Â Â Â Â Â | null;  
  Â Â Â Â Â Â Â Â Â Â Â Â sidebarFooter: string | null;  
  Â Â Â Â Â Â Â Â };  
  Â Â Â Â },  
  >
  ...
  #### Returns Promise< Â Â Â Â { Â Â Â Â Â Â Â Â categories: object; Â Â Â Â Â Â Â Â loading: null; Â Â Â Â Â Â Â Â packageList: boolean; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â submitButton: boolean; Â Â Â Â Â Â Â Â subtemplates: { Â Â Â Â Â Â Â Â Â Â Â Â category: string; Â Â Â Â Â Â Â Â Â Â Â Â filters: string Â Â Â Â Â Â Â Â Â Â Â Â | null; Â Â Â Â Â Â Â Â Â Â Â Â sidebarFooter: string | null; Â Â Â Â Â Â Â Â }; Â Â Â Â }, >
...
* attachWindow(  
  ...
  Inherited from CategoryBrowser.attachWindow
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<ControlsConfig>
...
* detachWindow(options?: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<ControlsConfig>
  ...
  Inherited from CategoryBrowser.detachWindow
...
* renderChild(  
  ...
  Inherited from CategoryBrowser.renderChild
...
* \_canAttach(): boolean
  ...
  Inherited from CategoryBrowser.\_canAttach
...
* \_getFrameButtons(  
  ...
  Inherited from CategoryBrowser.\_getFrameButtons
...
* \_headerControlContextEntries(): Generator<[ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md), void, any>
  ...
  Inherited from CategoryBrowser.\_headerControlContextEntries
...
* \_onAttach(from: Document, to: Document): void
  ...
  Inherited from CategoryBrowser.\_onAttach
...
* \_onDetach(from: Document, to: Document): void
  ...
  Inherited from CategoryBrowser.\_onDetach
...
* \_prepareCategoryData(): Record<  
  Â Â Â Â string,  
  Â Â Â Â { entries: object[]; id: string; label: string },  
  >
...
* \_refit(positionUpdate?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void
  ...
  Inherited from CategoryBrowser.\_refit
...
* \_renderFrameButtons(options: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<void>
  ...
  Inherited from CategoryBrowser.\_renderFrameButtons
...
### `Static`humanizeBinding

* humanizeBinding(binding: [KeybindingActionBinding](../interfaces/foundry.types.KeybindingActionBinding.md)): string

  Transform an action binding into a human-readable string representation.

  #### Parameters

  + binding: [KeybindingActionBinding](../interfaces/foundry.types.KeybindingActionBinding.md)
...
* instances(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), any, any>
  ...
  Inherited from CategoryBrowser.instances
