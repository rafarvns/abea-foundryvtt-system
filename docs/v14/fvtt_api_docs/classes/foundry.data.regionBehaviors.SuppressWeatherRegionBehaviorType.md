---
title: "SuppressWeatherRegionBehaviorType | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.regionBehaviors.SuppressWeatherRegionBehaviorType.html"
category: "classes"
---

# Class SuppressWeatherRegionBehaviorType

The data model for a behavior that allows to suppress weather effects within the Region

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.regionBehaviors.SuppressWeatherRegionBehaviorType))
...
* new SuppressWeatherRegionBehaviorType(  
  Â Â Â Â data?: {},  
  Â Â Â Â options?: {},  
  ): SuppressWeatherRegionBehaviorType
  ...
  #### Returns SuppressWeatherRegionBehaviorType
...
Â Â Â Â Â Â Â Â this: SuppressWeatherRegionBehaviorType,  
...
* ##### behaviorUnviewed: ( Â Â Â Â this: SuppressWeatherRegionBehaviorType, Â Â Â Â event: [RegionBehaviorUnviewedEvent](../types/foundry.documents.types.RegionBehaviorUnviewedEvent.md), ) => Promise<void>
* ##### behaviorViewed: ( Â Â Â Â this: SuppressWeatherRegionBehaviorType, Â Â Â Â event: [RegionBehaviorViewedEvent](../types/foundry.documents.types.RegionBehaviorViewedEvent.md), ) => Promise<void>
