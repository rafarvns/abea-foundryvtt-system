---
title: "CardStacks | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.collections.CardStacks.html"
category: "classes"
---
...
* [foundry.documents.Cards](foundry.documents.Cards.md): The Cards document
* [foundry.applications.sidebar.tabs.CardsDirectory](foundry.applications.sidebar.tabs.CardsDirectory.md): The CardsDirectory sidebar directory

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.collections.CardStacks))
...
* \_getVisibleTreeContents(entry: any): [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)[]

  #### Parameters

  + entry: any

  #### Returns [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)[]
...
* \_onModifyContents(  
  ...
  Â Â Â Â documents: [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)[],  
  Â Â Â Â result: any[],  
  ...
  + documents: [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)[]
...
* "[iterator]"(): MapIterator<[documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)>

  Then iterating over a Collection, we should iterate over its values instead of over its entries

  #### Returns MapIterator<[documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)>
...
* createDocument(data: object, context?: object): [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)
...
* every(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â element: [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)>,  
  Â Â Â Â ) => boolean,  
  ): boolean
  ...
  + condition: (  
    Â Â Â Â element: [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md),  
    Â Â Â Â index: number,  
    Â Â Â Â set: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)>,  
    ) => boolean
...
* filter(  
  Â Â Â Â condition: (  
  Â Â Â Â Â Â Â Â value: [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md),  
  Â Â Â Â Â Â Â Â index: number,  
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)>,  
  Â Â Â Â ) => unknown,  
  ...
  + condition: (  
    Â Â Â Â value: [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md),  
    Â Â Â Â index: number,  
    Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)>,  
    ) => unknown
...
* find(  
  ...
  Â Â Â Â Â Â Â Â collection: [Collection](foundry.utils.Collection.md)<string, [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)>,  
  Â Â Â Â ) => unknown,  
  ): [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md) | undefined
  ...
  #### Returns [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md) | undefined
...
* forEach(fn: (value: [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md), index: number) => void): void

  Apply a function to each element of the collection

  #### Parameters

  + fn: (value: [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md), index: number) => void
...
* fromCompendium(  
  Â Â Â Â document: object | [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md),  
  ...
  + document: object | [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)
...
* getInvalid(id: string, options?: { strict?: boolean }): void | [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)
  ...
  #### Returns void | [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)
...
* importFromCompendium(  
  ...
  Â Â Â Â options?: any,  
  ): Promise<[documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)>
  ...
  #### Returns Promise<[documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)>
...
* search(  
  ...
  ): object[] | [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)[]
  ...
  #### Returns object[] | [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)[]
...
* set(id: string, document: [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)): CardStacks

  #### Parameters

  + id: string
  + document: [documents](../modules/foundry.documents.md).[Cards](foundry.documents.Cards.md)
