---
title: "AmbientLightTab | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.tabs.AmbientLightTab.html"
category: "classes"
---

# Class AmbientLightTab

The AmbientLight-specific placeables tab.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.tabs.AmbientLightTab))
...
FILTER\_CLASS: typeof [AmbientLightFilter](foundry.applications.sidebar.filters.AmbientLightFilter.md) = AmbientLightFilter

Overrides PlaceableTab.FILTER\_CLASS
...
* \_clearFilters(): void
  ...
  Overrides PlaceableTab.\_clearFilters
...
* \_hasAdvancedFilters(): any
  ...
  Overrides PlaceableTab.\_hasAdvancedFilters
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<AmbientLightTab>
  ...
  #### Returns Promise<AmbientLightTab>
...
* detachWindow(options?: [PlaceableTabConfiguration](../types/foundry.PlaceableTabConfiguration.md)): Promise<AmbientLightTab>
