---
title: "Sidebar | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.Sidebar.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.Sidebar))
...
[\_prepareTabContext](#_preparetabcontext)
...
* new Sidebar(options?: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md)>): Sidebar
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: { toggleState: (this: Sidebar) => void };  
Â Â Â Â id: string;  
Â Â Â Â tag: string;  
...
TABS: Record<string, [SidebarTabDescriptor](../interfaces/foundry.SidebarTabDescriptor.md)> = ...
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<Sidebar>
...
* detachWindow(options?: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<Sidebar>
