---
title: "BaseChatMessage | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.BaseChatMessage.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.BaseChatMessage))

* [Document](foundry.abstract.Document.md)
  + BaseChatMessage
    - [documents](../modules/foundry.documents.md).[ChatMessage](foundry.documents.ChatMessage.md)
...
Inherited from [Document](foundry.abstract.Document.md).[LOCALIZATION\_PREFIXES](foundry.abstract.Document.md#localization_prefixes)
...
* \_preUpdate(changed: any, options: any, user: any): Promise<false | undefined>
  ...
  Overrides [Document](foundry.abstract.Document.md).[\_preUpdate](foundry.abstract.Document.md#_preupdate)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [Document](foundry.abstract.Document.md).[canUserCreate](foundry.abstract.Document.md#canusercreate)
...
* validateJoint(data: object): void
  ...
  Inherited from [Document](foundry.abstract.Document.md).[validateJoint](foundry.abstract.Document.md#validatejoint)
