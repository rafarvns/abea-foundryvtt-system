---
title: "AdjustDarknessLevelRegionBehaviorType | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.regionBehaviors.AdjustDarknessLevelRegionBehaviorType.html"
category: "classes"
---

# Class AdjustDarknessLevelRegionBehaviorType

The data model for a behavior that allows to adjust the darkness level within the Region.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.regionBehaviors.AdjustDarknessLevelRegionBehaviorType))
...
* new AdjustDarknessLevelRegionBehaviorType(  
  ...
  #### Returns AdjustDarknessLevelRegionBehaviorType
...
Â Â Â Â Â Â Â Â this: AdjustDarknessLevelRegionBehaviorType,  
...
Â Â Â Â ) => Promise<void>;  
Â Â Â Â regionAnimation: (  
Â Â Â Â Â Â Â Â this: AdjustDarknessLevelRegionBehaviorType,  
Â Â Â Â Â Â Â Â event: [RegionRegionBoundaryEvent](../types/foundry.documents.types.RegionRegionBoundaryEvent.md) | [RegionRegionAnimationEvent](../types/foundry.documents.types.RegionRegionAnimationEvent.md),  
Â Â Â Â ) => Promise<void>;  
...
* ##### behaviorUnviewed: ( Â Â Â Â this: AdjustDarknessLevelRegionBehaviorType, Â Â Â Â event: [RegionBehaviorUnviewedEvent](../types/foundry.documents.types.RegionBehaviorUnviewedEvent.md), ) => Promise<void>
* ##### behaviorViewed: ( Â Â Â Â this: AdjustDarknessLevelRegionBehaviorType, Â Â Â Â event: [RegionBehaviorViewedEvent](../types/foundry.documents.types.RegionBehaviorViewedEvent.md), ) => Promise<void>
* ##### regionAnimation: ( Â Â Â Â this: AdjustDarknessLevelRegionBehaviorType, Â Â Â Â event: [RegionRegionBoundaryEvent](../types/foundry.documents.types.RegionRegionBoundaryEvent.md) | [RegionRegionAnimationEvent](../types/foundry.documents.types.RegionRegionAnimationEvent.md), ) => Promise<void>
* ##### regionBoundary: ( Â Â Â Â this: AdjustDarknessLevelRegionBehaviorType, Â Â Â Â event: [RegionRegionBoundaryEvent](../types/foundry.documents.types.RegionRegionBoundaryEvent.md) | [RegionRegionAnimationEvent](../types/foundry.documents.types.RegionRegionAnimationEvent.md), ) => Promise<void>
...
* get MODES(): Readonly<{ BRIGHTEN: 1; DARKEN: 2; OVERRIDE: 0 }>

  Darkness level behavior modes.

  #### Returns Readonly<{ BRIGHTEN: 1; DARKEN: 2; OVERRIDE: 0 }>
...
* defineSchema(): { mode: [NumberField](foundry.data.fields.NumberField.md); modifier: [AlphaField](foundry.data.fields.AlphaField.md) }

  #### Returns { mode: [NumberField](foundry.data.fields.NumberField.md); modifier: [AlphaField](foundry.data.fields.AlphaField.md) }
