---
title: "Hotbar | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.ui.Hotbar.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.ui.Hotbar))
...
[\_createDocumentSheetToggle](#_createdocumentsheettoggle)
[\_createRollTableRollMacro](#_createrolltablerollmacro)
...
[toggleDocumentSheet](#toggledocumentsheet)
...
* new Hotbar(options?: Partial<[ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md)>): Hotbar
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â clear: (this: Hotbar) => Promise<void>;  
Â Â Â Â Â Â Â Â execute: (this: Hotbar, event: PointerEvent) => Promise<void>;  
Â Â Â Â Â Â Â Â lock: (this: Hotbar) => Promise<void>;  
Â Â Â Â Â Â Â Â menu: (this: Hotbar) => Promise<void>;  
Â Â Â Â Â Â Â Â mute: (this: Hotbar) => Promise<void>;  
Â Â Â Â Â Â Â Â page: (this: Hotbar, event: PointerEvent) => Promise<void>;  
Â Â Â Â };  
...
PARTS: { hotbar: { root: boolean; template: string } } = ...
...
* get slots(): [HotbarSlotData](../interfaces/foundry.HotbarSlotData.md)[]

  The currently rendered macro data.

  #### Returns [HotbarSlotData](../interfaces/foundry.HotbarSlotData.md)[]
...
* \_prepareContext(\_options: any): Promise<{ page: number; slots: any }>
  ...
  #### Returns Promise<{ page: number; slots: any }>
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<Hotbar>
...
* detachWindow(options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md)): Promise<Hotbar>
...
* \_createDocumentSheetToggle(doc: Document): Promise<[documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)>
...
* \_createRollTableRollMacro(table: Document): Promise<[documents](../modules/foundry.documents.md).[Macro](foundry.documents.Macro.md)>
...
### `Static`toggleDocumentSheet

* toggleDocumentSheet(uuid: string): Promise<void>
