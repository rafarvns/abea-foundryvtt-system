---
title: "DrawingTab | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.tabs.DrawingTab.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.tabs.DrawingTab))
...
* new DrawingTab(options?: Partial<[ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md)>): DrawingTab
...
Â Â Â Â Â Â Â Â Â Â Â Â this: DrawingTab,  
...
DIRECTORY\_PARTIAL: string = "templates/sidebar/tabs/placeable/drawings.hbs"
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<DrawingTab>
...
* detachWindow(options?: [PlaceableTabConfiguration](../types/foundry.PlaceableTabConfiguration.md)): Promise<DrawingTab>
