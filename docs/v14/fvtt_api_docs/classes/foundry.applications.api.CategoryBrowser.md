---
title: "CategoryBrowser | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.api.CategoryBrowser.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.api.CategoryBrowser))

* [ApplicationV2](foundry.applications.api.ApplicationV2.md)<  
  Â Â Â Â [ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [CategoryBrowserConfiguration](../interfaces/foundry.CategoryBrowserConfiguration.md),  
  Â Â Â Â [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md),  
  Â Â Â Â this,  
  >
  + CategoryBrowser
    - [SettingsConfig](foundry.applications.settings.SettingsConfig.md)
    - [ControlsConfig](foundry.applications.sidebar.apps.ControlsConfig.md)
    - [ToursManagement](foundry.applications.sidebar.apps.ToursManagement.md)
...
Â Â Â Â initialCategory: null;  
Â Â Â Â packageList: boolean;  
Â Â Â Â subtemplates: { category: undefined; filters: null; sidebarFooter: null };  
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<CategoryBrowser>
  ...
  #### Returns Promise<CategoryBrowser>
...
* detachWindow(options?: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<CategoryBrowser>
...
### `Protected` `Abstract`\_prepareCategoryData

* \_prepareCategoryData(): Promise<  
  Â Â Â Â Record<string, { entries: object[]; id: string; label: string }>,  
  >
  ...
  #### Returns Promise<Record<string, { entries: object[]; id: string; label: string }>>
...
* \_sortCategories(  
  Â Â Â Â a: { label: string; [key: string]: unknown },  
  Â Â Â Â b: { label: string; [key: string]: unknown },  
  ): number
