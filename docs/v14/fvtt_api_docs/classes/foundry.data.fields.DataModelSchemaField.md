---
title: "DataModelSchemaField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.DataModelSchemaField.html"
category: "classes"
---

# Class DataModelSchemaField

A subclass of [foundry.data.fields.SchemaField](foundry.data.fields.SchemaField.md) that represents the root schema node of a DataModel.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.DataModelSchemaField))
...
* \_cast(value: any): any
  ...
  Overrides [SchemaField](foundry.data.fields.SchemaField.md).[\_cast](foundry.data.fields.SchemaField.md#_cast)
...
* \_getField(  
  ...
  ): [DataField](foundry.data.fields.DataField.md) | DataModelSchemaField | undefined
  ...
  #### Returns [DataField](foundry.data.fields.DataField.md) | DataModelSchemaField | undefined

  Overrides [SchemaField](foundry.data.fields.SchemaField.md).[\_getField](foundry.data.fields.SchemaField.md#_getfield)
...
* \_migrate(value: any, options: any, \_state: any): any
  ...
  Overrides [SchemaField](foundry.data.fields.SchemaField.md).[\_migrate](foundry.data.fields.SchemaField.md#_migrate)
...
* clean(value: any, options?: {}, \_state?: {}): any
  ...
  Overrides [SchemaField](foundry.data.fields.SchemaField.md).[clean](foundry.data.fields.SchemaField.md#clean)
