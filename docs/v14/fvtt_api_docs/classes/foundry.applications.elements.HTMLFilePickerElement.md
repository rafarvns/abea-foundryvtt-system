---
title: "HTMLFilePickerElement | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.elements.HTMLFilePickerElement.html"
category: "classes"
---

# Class HTMLFilePickerElement

A custom HTML element responsible for rendering a file input field and associated FilePicker button.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.elements.HTMLFilePickerElement))
...
picker: [FilePicker](foundry.applications.apps.FilePicker.md)
...
* get type(): type
  ...
  [foundry.applications.apps.FilePicker.FILE\_TYPES](foundry.applications.apps.FilePicker.md#file_types)
...
* create(config: [FormInputConfig](../interfaces/foundry.data.types.FormInputConfig.md)<string> & [FilePickerInputConfig](../interfaces/foundry.FilePickerInputConfig.md)): HTMLElement

  Create a HTMLFilePickerElement using provided configuration data.

  #### Parameters

  + config: [FormInputConfig](../interfaces/foundry.data.types.FormInputConfig.md)<string> & [FilePickerInputConfig](../interfaces/foundry.FilePickerInputConfig.md)
