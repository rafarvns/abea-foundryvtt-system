---
title: "GridConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.apps.GridConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.apps.GridConfig))
...
* new GridConfig(  
  Â Â Â Â options: [ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [DocumentSheetConfiguration](../interfaces/foundry.DocumentSheetConfiguration.md),  
  ): GridConfig

  #### Parameters

  + options: [ApplicationConfiguration](../interfaces/foundry.applications.types.ApplicationConfiguration.md) & [DocumentSheetConfiguration](../interfaces/foundry.DocumentSheetConfiguration.md)

  #### Returns GridConfig

  Overrides HandlebarsApplicationMixin(DocumentSheetV2).constructor
...
sheet: [SceneConfig](foundry.applications.sheets.SceneConfig.md)
...
Â Â Â Â form: { root: boolean; template: string };  
} = ...
...
* \_prepareContext(  
  ...
  Â Â Â Â Â Â Â Â )[];  
  Â Â Â Â Â Â Â Â gridTypes: Record<GRID\_TYPES, string>;  
  Â Â Â Â Â Â Â Â pixelsLabel: string;  
  Â Â Â Â Â Â Â Â scale: number;  
  Â Â Â Â Â Â Â Â scene: any;  
  ...
  #### Returns Promise< Â Â Â Â [ApplicationRenderContext](../interfaces/foundry.applications.types.ApplicationRenderContext.md) & { Â Â Â Â Â Â Â Â document: ClientDocument; Â Â Â Â Â Â Â Â editable: boolean; Â Â Â Â Â Â Â Â fields: any; Â Â Â Â Â Â Â Â model: ClientDocument; Â Â Â Â Â Â Â Â rootId: string; Â Â Â Â Â Â Â Â source: any; Â Â Â Â Â Â Â Â user: [documents](../modules/foundry.documents.md).[User](foundry.documents.User.md) Â Â Â Â Â Â Â Â | null; Â Â Â Â } & { Â Â Â Â Â Â Â Â buttons: ( Â Â Â Â Â Â Â Â Â Â Â Â | { action: string; icon: string; label: string; type: string } Â Â Â Â Â Â Â Â Â Â Â Â | { action?: undefined; icon: string; label: string; type: string } Â Â Â Â Â Â Â Â )[]; Â Â Â Â Â Â Â Â gridTypes: Record<GRID\_TYPES, string>; Â Â Â Â Â Â Â Â pixelsLabel: string; Â Â Â Â Â Â Â Â scale: number; Â Â Â Â Â Â Â Â scene: any; Â Â Â Â Â Â Â Â src: string; Â Â Â Â }, >
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<GridConfig>
