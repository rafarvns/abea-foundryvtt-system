---
title: "AnyField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.AnyField.html"
category: "classes"
---

# Class AnyField

A special subclass of [foundry.data.fields.DataField](foundry.data.fields.DataField.md) which can contain any value of any type.
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.AnyField))
...
* new AnyField(options?: [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md), context?: [DataFieldContext](../interfaces/foundry.data.types.DataFieldContext.md)): AnyField
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { nullable: boolean; serializable: boolean }

  Default parameters for this field type

  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { nullable: boolean; serializable: boolean }
...
* \_toInput(config: any): HTMLInputElement | [HTMLCodeMirrorElement](foundry.applications.elements.HTMLCodeMirrorElement.md)

  #### Parameters

  + config: any

  #### Returns HTMLInputElement | [HTMLCodeMirrorElement](foundry.applications.elements.HTMLCodeMirrorElement.md)
...
* \_cast(value: any): any
  ...
  Inherited from [DataField](foundry.data.fields.DataField.md).[\_cast](foundry.data.fields.DataField.md#_cast)
