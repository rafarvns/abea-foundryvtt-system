...
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.ux.TextEditor.html"
category: "classes"
---
...
[getDragEventData](#getdrageventdata)
[previewHTML](#previewhtml)
[truncateHTML](#truncatehtml)
[truncateText](#truncatetext)
[\_applyCustomEnrichers](#_applycustomenrichers)
[\_createContentLink](#_createcontentlink)
[\_createHyperlink](#_createhyperlink)
[\_createInlineRoll](#_createinlineroll)
[\_embedContent](#_embedcontent)
[\_enrichContentLinks](#_enrichcontentlinks)
[\_enrichEmbeds](#_enrichembeds)
[\_enrichHyperlinks](#_enrichhyperlinks)
[\_enrichInlineRolls](#_enrichinlinerolls)
[\_finalizeEnrichedHTML](#_finalizeenrichedhtml)
[\_onClickInlineRoll](#_onclickinlineroll)
[\_parseEmbedConfig](#_parseembedconfig)
[\_primeCompendiums](#_primecompendiums)
[\_replaceTextContent](#_replacetextcontent)

## Accessors

### `Static`implementation

* get implementation(): typeof [applications](../modules/foundry.applications.md).[ux](../modules/foundry.applications.ux.md).TextEditor

  Retrieve the configured TextEditor implementation.

  #### Returns typeof [applications](../modules/foundry.applications.md).[ux](../modules/foundry.applications.ux.md).TextEditor
...
* create(options?: { engine?: string }, content?: string): [ProseMirrorEditor](foundry.applications.ux.ProseMirrorEditor.md)
  ...
  #### Returns [ProseMirrorEditor](foundry.applications.ux.ProseMirrorEditor.md)

  The editor instance.

### `Static`createAnchor

* createAnchor(options?: Partial<[EnrichmentAnchorOptions](../interfaces/foundry.EnrichmentAnchorOptions.md)>): HTMLAnchorElement

  Helper method to create an anchor element.

  #### Parameters

  + `Optional`options: Partial<[EnrichmentAnchorOptions](../interfaces/foundry.EnrichmentAnchorOptions.md)> = {}
...
* enrichHTML(content: string, options?: [EnrichmentOptions](../interfaces/foundry.EnrichmentOptions.md)): Promise<string>
...
* truncateText(  
  ...
  Â Â Â Â Â Â Â Â suffix?: string | null;  
  Â Â Â Â },  
  ): string
  ...
  + `Optional`options: { maxLength?: number; splitWords?: boolean; suffix?: string | null } = {}
...
* \_enrichContentLinks(text: Text[], options?: [EnrichmentOptions](../interfaces/foundry.EnrichmentOptions.md)): Promise<boolean>
...
* \_enrichEmbeds(text: Text[], options?: [EnrichmentOptions](../interfaces/foundry.EnrichmentOptions.md)): Promise<boolean>
...
* \_enrichHyperlinks(text: Text[], options?: [EnrichmentOptions](../interfaces/foundry.EnrichmentOptions.md)): Promise<boolean>
...
* \_finalizeEnrichedHTML(  
  ...
  + options: [EnrichmentOptions](../interfaces/foundry.EnrichmentOptions.md)
...
* \_parseEmbedConfig(raw: string, options?: object): [DocumentHTMLEmbedConfig](../interfaces/foundry.DocumentHTMLEmbedConfig.md)
  ...
  #### Returns [DocumentHTMLEmbedConfig](../interfaces/foundry.DocumentHTMLEmbedConfig.md)
...
* \_primeCompendiums(text: Text[], options?: [EnrichmentOptions](../interfaces/foundry.EnrichmentOptions.md)): Promise<void>
...
* \_replaceTextContent(  
  Â Â Â Â text: Text[],  
  Â Â Â Â rgx: RegExp,  
  Â Â Â Â func: [TextContentReplacer](../types/foundry.TextContentReplacer.md),  
  Â Â Â Â options?: [TextReplacementOptions](../interfaces/foundry.TextReplacementOptions.md),  
  ): boolean
  ...
  + func: [TextContentReplacer](../types/foundry.TextContentReplacer.md)

    The replacement function
  + `Optional`options: [TextReplacementOptions](../interfaces/foundry.TextReplacementOptions.md) = {}
