---
title: "RegionBehaviorType | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.regionBehaviors.RegionBehaviorType.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.regionBehaviors.RegionBehaviorType))

* [TypeDataModel](foundry.abstract.TypeDataModel.md)
  + RegionBehaviorType
    - [AdjustDarknessLevelRegionBehaviorType](foundry.data.regionBehaviors.AdjustDarknessLevelRegionBehaviorType.md)
    - [ApplyActiveEffectRegionBehaviorType](foundry.data.regionBehaviors.ApplyActiveEffectRegionBehaviorType.md)
    - [ChangeLevelRegionBehaviorType](foundry.data.regionBehaviors.ChangeLevelRegionBehaviorType.md)
    - [DefineSurfaceRegionBehaviorType](foundry.data.regionBehaviors.DefineSurfaceRegionBehaviorType.md)
    - [DisplayScrollingTextRegionBehaviorType](foundry.data.regionBehaviors.DisplayScrollingTextRegionBehaviorType.md)
    - [ExecuteMacroRegionBehaviorType](foundry.data.regionBehaviors.ExecuteMacroRegionBehaviorType.md)
    - [ExecuteScriptRegionBehaviorType](foundry.data.regionBehaviors.ExecuteScriptRegionBehaviorType.md)
    - [ModifyMovementCostRegionBehaviorType](foundry.data.regionBehaviors.ModifyMovementCostRegionBehaviorType.md)
    - [PauseGameRegionBehaviorType](foundry.data.regionBehaviors.PauseGameRegionBehaviorType.md)
    - [SuppressWeatherRegionBehaviorType](foundry.data.regionBehaviors.SuppressWeatherRegionBehaviorType.md)
    - [TeleportTokenRegionBehaviorType](foundry.data.regionBehaviors.TeleportTokenRegionBehaviorType.md)
    - [ToggleBehaviorRegionBehaviorType](foundry.data.regionBehaviors.ToggleBehaviorRegionBehaviorType.md)
...
* new RegionBehaviorType(data?: {}, options?: {}): RegionBehaviorType
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[constructor](foundry.abstract.TypeDataModel.md#constructor)
...
Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_source](foundry.abstract.TypeDataModel.md#_source)
...
Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[parent](foundry.abstract.TypeDataModel.md#parent)
...
Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_schema](foundry.abstract.TypeDataModel.md#_schema)

### `Static`events

events: Record<  
Â Â Â Â string,  
Â Â Â Â (this: RegionBehaviorType, event: [RegionEvent](../interfaces/foundry.documents.types.RegionEvent.md)) => Promise<void>,  
> = {}
...
Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[LOCALIZATION\_PREFIXES](foundry.abstract.TypeDataModel.md#localization_prefixes)
...
* clone(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[clone](foundry.abstract.TypeDataModel.md#clone)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[getFieldForProperty](foundry.abstract.TypeDataModel.md#getfieldforproperty)
...
* onEmbed(element: HTMLDocumentEmbedElement): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[onEmbed](foundry.abstract.TypeDataModel.md#onembed)
...
* prepareBaseData(): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[prepareBaseData](foundry.abstract.TypeDataModel.md#preparebasedata)
...
* prepareDerivedData(): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[prepareDerivedData](foundry.abstract.TypeDataModel.md#preparederiveddata)
...
* reset(): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[reset](foundry.abstract.TypeDataModel.md#reset)
...
* toEmbed(config: DocumentHTMLEmbedConfig, options?: any): Promise<any>
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[toEmbed](foundry.abstract.TypeDataModel.md#toembed)
...
* toJSON(): object
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[toJSON](foundry.abstract.TypeDataModel.md#tojson)
...
* toObject(source?: boolean): object
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[toObject](foundry.abstract.TypeDataModel.md#toobject)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[updateSource](foundry.abstract.TypeDataModel.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[validate](foundry.abstract.TypeDataModel.md#validate)
...
* \_configure(options?: object): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_configure](foundry.abstract.TypeDataModel.md#_configure)
...
* \_getInnerModel(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_getInnerModel](foundry.abstract.TypeDataModel.md#_getinnermodel)

### `Protected`\_getTerrainEffects

* \_getTerrainEffects<[TerrainEffect](#_getterraineffectsterraineffect)>(  
  ...
  Â Â Â Â options?: Omit<[TokenCreateTerrainMovementPathOptions](../interfaces/foundry.types.TokenCreateTerrainMovementPathOptions.md), "preview">,  
  ): [TerrainEffect](#_getterraineffectsterraineffect)[]
  ...
  ([CONFIG.Token.movement.TerrainData.resolveTerrainEffects](foundry.data.BaseTerrainData.md#resolveterraineffects)).
  ...
  + segment: Pick<TokenMovementWaypoint, "width" | "height" | "shape" | "action" | "level"> & {  
    Â Â Â Â preview: boolean;  
    }

    The segment data of the token's movement
  + `Optional`options: Omit<[TokenCreateTerrainMovementPathOptions](../interfaces/foundry.types.TokenCreateTerrainMovementPathOptions.md), "preview">

    Additional options

  #### Returns [TerrainEffect](#_getterraineffectsterraineffect)[]
...
* \_initializationOrder(): Generator<[string, [DataField](foundry.data.fields.DataField.md)], any, any>
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_initializationOrder](foundry.abstract.TypeDataModel.md#_initializationorder)
...
* \_initialize(options?: object): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_initialize](foundry.abstract.TypeDataModel.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_initializeSource](foundry.abstract.TypeDataModel.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_onCreate](foundry.abstract.TypeDataModel.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_onDelete](foundry.abstract.TypeDataModel.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_onUpdate](foundry.abstract.TypeDataModel.md#_onupdate)
...
* \_preCreate(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_preCreate](foundry.abstract.TypeDataModel.md#_precreate)
...
* \_preDelete(options: object, user: BaseUser): Promise<boolean | void>
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_preDelete](foundry.abstract.TypeDataModel.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_preUpdate](foundry.abstract.TypeDataModel.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_preUpdateSource](foundry.abstract.TypeDataModel.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_updateCommit](foundry.abstract.TypeDataModel.md#_updatecommit)
...
* \_updateDiff(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_updateDiff](foundry.abstract.TypeDataModel.md#_updatediff)
...
* cleanData(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[cleanData](foundry.abstract.TypeDataModel.md#cleandata)
...
* defineSchema(): [DataSchema](../types/foundry.abstract.types.DataSchema.md)
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[defineSchema](foundry.abstract.TypeDataModel.md#defineschema)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[fromJSON](foundry.abstract.TypeDataModel.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[fromSource](foundry.abstract.TypeDataModel.md#fromsource)
...
* migrateData(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[migrateData](foundry.abstract.TypeDataModel.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[migrateDataSafe](foundry.abstract.TypeDataModel.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[shimData](foundry.abstract.TypeDataModel.md#shimdata)
...
* validateJoint(data: object): void
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[validateJoint](foundry.abstract.TypeDataModel.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_cleanData](foundry.abstract.TypeDataModel.md#_cleandata)
...
* \_preCleanData(  
  ...
  Inherited from [TypeDataModel](foundry.abstract.TypeDataModel.md).[\_preCleanData](foundry.abstract.TypeDataModel.md#_precleandata)