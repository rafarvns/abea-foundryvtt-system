---
title: "DynamicRingData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.placeables.tokens.DynamicRingData.html"
category: "classes"
---

# Class DynamicRingData

Dynamic Ring configuration data model.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.placeables.tokens.DynamicRingData))
...
* defineSchema(): {  
  Â Â Â Â effects: [ObjectField](foundry.data.fields.ObjectField.md);  
  Â Â Â Â framework: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â id: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â label: [StringField](foundry.data.fields.StringField.md);  
  Â Â Â Â spritesheet: [FilePathField](foundry.data.fields.FilePathField.md);  
  }
  ...
  #### Returns { Â Â Â Â effects: [ObjectField](foundry.data.fields.ObjectField.md); Â Â Â Â framework: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â id: [StringField](foundry.data.fields.StringField.md); Â Â Â Â label: [StringField](foundry.data.fields.StringField.md); Â Â Â Â spritesheet: [FilePathField](foundry.data.fields.FilePathField.md); }
