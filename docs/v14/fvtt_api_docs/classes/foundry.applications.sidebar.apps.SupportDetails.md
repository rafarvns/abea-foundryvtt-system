---
title: "SupportDetails | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sidebar.apps.SupportDetails.html"
category: "classes"
---

# Class SupportDetails

#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sidebar.apps.SupportDetails))
...
[\_getDocumentValidationErrors](#_getdocumentvalidationerrors)
[\_getFrameButtons](#_getframebuttons)
[\_getHeaderControls](#_getheadercontrols)
[\_getModuleIssues](#_getmoduleissues)
...
[generateSupportReport](#generatesupportreport)
[getWebGLRendererInfo](#getwebglrendererinfo)
...
DEFAULT\_OPTIONS: {  
Â Â Â Â actions: {  
Â Â Â Â Â Â Â Â copyReport: (  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLElement,  
Â Â Â Â Â Â Â Â ) => void | Promise<void>;  
Â Â Â Â Â Â Â Â copyUuid: (this: SupportDetails, event: PointerEvent) => void;  
Â Â Â Â Â Â Â Â deleteDocument: (  
Â Â Â Â Â Â Â Â Â Â Â Â this: SupportDetails,  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â ) => Promise<void>;  
Â Â Â Â Â Â Â Â fullReport: (  
Â Â Â Â Â Â Â Â Â Â Â Â event: PointerEvent,  
Â Â Â Â Â Â Â Â Â Â Â Â target: HTMLElement,  
Â Â Â Â Â Â Â Â ) => void | Promise<void>;  
Â Â Â Â };  
...
PARTS: {  
Â Â Â Â client: { template: string };  
Â Â Â Â documents: { template: string };  
Â Â Â Â modules: { template: string };  
Â Â Â Â support: { template: string; templates: string[] };  
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<SupportDetails>
  ...
  #### Returns Promise<SupportDetails>
...
* detachWindow(options?: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<SupportDetails>
...
* \_getDocumentValidationErrors(): object[]
...
* generateSupportReport(): Promise<[SupportReportData](../interfaces/foundry.SupportReportData.md)>

  Collects a number of metrics that is useful for Support

  #### Returns Promise<[SupportReportData](../interfaces/foundry.SupportReportData.md)>

### `Static`getWebGLRendererInfo

* getWebGLRendererInfo(gl: WebGLRenderingContext): string
