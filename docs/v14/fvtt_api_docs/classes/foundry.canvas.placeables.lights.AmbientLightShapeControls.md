---
title: "AmbientLightShapeControls | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.placeables.lights.AmbientLightShapeControls.html"
category: "classes"
---

# Class AmbientLightShapeControls

Controls for a AmbientLight shape.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.placeables.lights.AmbientLightShapeControls))

* [ShapeControls](foundry.canvas.containers.ShapeControls.md)
  + AmbientLightShapeControls
...
* new AmbientLightShapeControls(  
  Â Â Â Â shape: [CircleShapeData](foundry.CircleShapeData.md) | [ConeShapeData](foundry.ConeShapeData.md),  
  ): AmbientLightShapeControls

  #### Parameters

  + shape: [CircleShapeData](foundry.CircleShapeData.md) | [ConeShapeData](foundry.ConeShapeData.md)

    The shape.

  #### Returns AmbientLightShapeControls
...
* \_prepareDragDropUpdate(  
  ...
  Â Â Â Â config: { angle: any; bright: any; dim: any };  
  ...
  #### Returns { config: { angle: any; bright: any; dim: any }; rotation: any; x: any; y: any }
...
* draw(): Promise<AmbientLightShapeControls>

  Draw the visualization of these controls.

  #### Returns Promise<AmbientLightShapeControls>
...
* \_onClick2(event: FederatedEvent<UIEvent | PixiTouch>): void
  ...
  Inherited from [ShapeControls](foundry.canvas.containers.ShapeControls.md).[\_onClick2](foundry.canvas.containers.ShapeControls.md#_onclick2)
