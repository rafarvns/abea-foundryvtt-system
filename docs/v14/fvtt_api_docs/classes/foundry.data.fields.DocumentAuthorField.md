---
title: "DocumentAuthorField | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.fields.DocumentAuthorField.html"
category: "classes"
---

# Class DocumentAuthorField

A special [foundry.data.fields.ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md) which defines the original author of a document.
This can only be changed later by GM users.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.fields.DocumentAuthorField))

* [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md)
  + DocumentAuthorField
...
* new DocumentAuthorField(  
  ...
  #### Returns DocumentAuthorField

  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[constructor](foundry.data.fields.ForeignDocumentField.md#constructor)
...
Inherited from DocumentAuthorField.[blank](#blank)
...
Inherited from DocumentAuthorField.[choices](#choices)
...
Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[model](foundry.data.fields.ForeignDocumentField.md#model)
...
Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[name](foundry.data.fields.ForeignDocumentField.md#name)
...
Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[options](foundry.data.fields.ForeignDocumentField.md#options)
...
Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[parent](foundry.data.fields.ForeignDocumentField.md#parent)
...
Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[persisted](foundry.data.fields.ForeignDocumentField.md#persisted)
...
Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[textSearch](foundry.data.fields.ForeignDocumentField.md#textsearch)
...
Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[trim](foundry.data.fields.ForeignDocumentField.md#trim)
...
Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[hierarchical](foundry.data.fields.ForeignDocumentField.md#hierarchical)
...
Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[recursive](foundry.data.fields.ForeignDocumentField.md#recursive)
...
* get fieldPath(): string
  ...
  Inherited from ForeignDocumentField.fieldPath
...
* get \_defaults(): [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & {  
  ...
  Â Â Â Â validationError: string;  
  } & { idOnly: boolean; nullable: boolean; readonly: boolean } & {  
  Â Â Â Â gmOnly: boolean;  
  Â Â Â Â initial: () => string | null;  
  Â Â Â Â nullable: boolean;  
  }

  Default parameters for this field type

  #### Returns [DataFieldOptions](../interfaces/foundry.data.types.DataFieldOptions.md) & { Â Â Â Â blank: boolean; Â Â Â Â choices: undefined; Â Â Â Â textSearch: boolean; Â Â Â Â trim: boolean; } & { Â Â Â Â blank: boolean; Â Â Â Â nullable: boolean; Â Â Â Â readonly: boolean; Â Â Â Â required: boolean; Â Â Â Â validationError: string; } & { idOnly: boolean; nullable: boolean; readonly: boolean } & { Â Â Â Â gmOnly: boolean; Â Â Â Â initial: () => string | null; Â Â Â Â nullable: boolean; }

  Overrides ForeignDocumentField.\_defaults
...
* get hasFormSupport(): boolean
  ...
  Inherited from ForeignDocumentField.hasFormSupport
...
* \_applyChangeSubtract(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_applyChangeSubtract](foundry.data.fields.ForeignDocumentField.md#_applychangesubtract)
...
* \_cast(value: any): any
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_cast](foundry.data.fields.ForeignDocumentField.md#_cast)
...
* \_replaceDataRefs(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_replaceDataRefs](foundry.data.fields.ForeignDocumentField.md#_replacedatarefs)
...
* \_toInput(config: any): HTMLSelectElement
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_toInput](foundry.data.fields.ForeignDocumentField.md#_toinput)
...
* \_updateCommit(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_updateCommit](foundry.data.fields.ForeignDocumentField.md#_updatecommit)
...
* \_updateDiff(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_updateDiff](foundry.data.fields.ForeignDocumentField.md#_updatediff)
...
* \_validateModel(data: object, options?: object): void
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_validateModel](foundry.data.fields.ForeignDocumentField.md#_validatemodel)
...
* \_validateSpecial(value: any): boolean | void
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_validateSpecial](foundry.data.fields.ForeignDocumentField.md#_validatespecial)
...
* \_validateType(value: any, \_options: any): void
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_validateType](foundry.data.fields.ForeignDocumentField.md#_validatetype)
...
* apply(fn: string | Function, value: any, options?: object): object
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[apply](foundry.data.fields.ForeignDocumentField.md#apply)
...
* applyChange<[T](#applychanget)>(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[applyChange](foundry.data.fields.ForeignDocumentField.md#applychange)
...
* clean(value: any, options: any, \_state: any): any
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[clean](foundry.data.fields.ForeignDocumentField.md#clean)
...
* getInitialValue(source: any): any
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[getInitialValue](foundry.data.fields.ForeignDocumentField.md#getinitialvalue)
...
* initialize(value: any, model: any, options?: {}): any
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[initialize](foundry.data.fields.ForeignDocumentField.md#initialize)
...
* toFormGroup(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[toFormGroup](foundry.data.fields.ForeignDocumentField.md#toformgroup)
...
* toInput(config?: [FormInputConfig](../interfaces/foundry.data.types.FormInputConfig.md)): HTMLElement | HTMLCollection | HTMLElement[]
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[toInput](foundry.data.fields.ForeignDocumentField.md#toinput)
...
* toObject(value: any): any
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[toObject](foundry.data.fields.ForeignDocumentField.md#toobject)
...
* validate(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[validate](foundry.data.fields.ForeignDocumentField.md#validate)
...
* validators(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[validators](foundry.data.fields.ForeignDocumentField.md#validators)
...
* \_applyChangeAdd(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_applyChangeAdd](foundry.data.fields.ForeignDocumentField.md#_applychangeadd)
...
* \_applyChangeCustom(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_applyChangeCustom](foundry.data.fields.ForeignDocumentField.md#_applychangecustom)
...
* \_applyChangeDowngrade(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_applyChangeDowngrade](foundry.data.fields.ForeignDocumentField.md#_applychangedowngrade)
...
* \_applyChangeMultiply(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_applyChangeMultiply](foundry.data.fields.ForeignDocumentField.md#_applychangemultiply)
...
* \_applyChangeOverride(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_applyChangeOverride](foundry.data.fields.ForeignDocumentField.md#_applychangeoverride)
...
* \_applyChangeUpgrade(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_applyChangeUpgrade](foundry.data.fields.ForeignDocumentField.md#_applychangeupgrade)
...
* \_castChangeDelta(delta: any, replacementData?: object): any
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_castChangeDelta](foundry.data.fields.ForeignDocumentField.md#_castchangedelta)
...
* \_cleanType(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_cleanType](foundry.data.fields.ForeignDocumentField.md#_cleantype)
...
* \_getField(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_getField](foundry.data.fields.ForeignDocumentField.md#_getfield)
...
* \_isValidChoice(value: string): boolean
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_isValidChoice](foundry.data.fields.ForeignDocumentField.md#_isvalidchoice)
...
* \_migrate(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_migrate](foundry.data.fields.ForeignDocumentField.md#_migrate)
...
* \_validateRecursive(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_validateRecursive](foundry.data.fields.ForeignDocumentField.md#_validaterecursive)
...
* \_prepareChoiceConfig(  
  ...
  Inherited from [ForeignDocumentField](foundry.data.fields.ForeignDocumentField.md).[\_prepareChoiceConfig](foundry.data.fields.ForeignDocumentField.md#_preparechoiceconfig)