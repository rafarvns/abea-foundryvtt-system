---
title: "PointLightSource | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.canvas.sources.PointLightSource.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.canvas.sources.PointLightSource))
...
[\_canDetectObject](#_candetectobject)
...
* new PointLightSource(options?: [BaseEffectSourceOptions](../interfaces/foundry.canvas.sources.types.BaseEffectSourceOptions.md)): PointLightSource
...
Inherited from [BaseLightSource](foundry.canvas.sources.BaseLightSource.md).[sourceType](foundry.canvas.sources.BaseLightSource.md#sourcetype)
...
* \_configure(changes: any): void
  ...
  Overrides [BaseLightSource](foundry.canvas.sources.BaseLightSource.md).[\_configure](foundry.canvas.sources.BaseLightSource.md#_configure)
...
* \_getEdgeCreationOptions(): {  
  ...
  #### Returns { Â Â Â Â darkness: 20; Â Â Â Â direction: 1; Â Â Â Â object: object | null; Â Â Â Â priority: number; Â Â Â Â type: string; }
...
* initialize(data?: any, options?: { reset?: boolean }): PointLightSource
...
* testVisibility(config: [CanvasVisibilityTestConfiguration](../interfaces/foundry.types.CanvasVisibilityTestConfiguration.md)): boolean
...
### `Protected`\_canDetectObject

* \_canDetectObject(target: PlaceableObject, level: Level): boolean
...
* \_updateGeometry(): void
  ...
  Inherited from [BaseLightSource](foundry.canvas.sources.BaseLightSource.md).[\_updateGeometry](foundry.canvas.sources.BaseLightSource.md#_updategeometry)
