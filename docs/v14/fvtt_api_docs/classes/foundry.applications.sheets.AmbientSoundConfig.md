---
title: "AmbientSoundConfig | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.sheets.AmbientSoundConfig.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.sheets.AmbientSoundConfig))

* [PlaceableConfig](foundry.applications.sheets.PlaceableConfig.md)
  + AmbientSoundConfig
    - [AmbientSoundPalette](foundry.applications.sheets.palette.AmbientSoundPalette.md)
...
* new AmbientSoundConfig(options: any, ...args: any[]): AmbientSoundConfig
  ...
  Inherited from PlaceableConfig.constructor
...
Inherited from PlaceableConfig.options
...
Inherited from PlaceableConfig.position
...
Inherited from PlaceableConfig.tabGroups
...
Inherited from PlaceableConfig.\_preview
...
Inherited from PlaceableConfig.\_appId
...
Inherited from PlaceableConfig.\_maxZ
...
Inherited from PlaceableConfig.BASE\_APPLICATION
...
Overrides PlaceableConfig.DEFAULT\_OPTIONS

### `Static`emittedEvents

emittedEvents: readonly ["prerender", "render", "close", "position"] = ...

Inherited from PlaceableConfig.emittedEvents
...
Inherited from PlaceableConfig.RENDER\_STATES
...
Inherited from PlaceableConfig.TABS
...
* get classList(): DOMTokenList
  ...
  Inherited from PlaceableConfig.classList
...
* get document(): ClientDocument
  ...
  Inherited from PlaceableConfig.document
...
* get element(): HTMLElement
  ...
  Inherited from PlaceableConfig.element
...
* get form(): HTMLFormElement | null
  ...
  Inherited from PlaceableConfig.form
...
* get hasFrame(): boolean
  ...
  Inherited from PlaceableConfig.hasFrame
...
* get id(): string
  ...
  Inherited from PlaceableConfig.id
...
* get isEditable(): boolean
  ...
  Inherited from PlaceableConfig.isEditable
...
* get isVisible(): boolean
  ...
  Inherited from PlaceableConfig.isVisible
...
* get minimized(): boolean
  ...
  Inherited from PlaceableConfig.minimized
...
* get rendered(): boolean
  ...
  Inherited from PlaceableConfig.rendered
...
* get state(): number
  ...
  Inherited from PlaceableConfig.state
...
* get title(): string
  ...
  Overrides PlaceableConfig.title
...
* \_awaitTransition(element: HTMLElement, timeout: number): Promise<void>
  ...
  Inherited from PlaceableConfig.\_awaitTransition
...
* \_canDetach(): boolean
  ...
  Inherited from PlaceableConfig.\_canDetach
...
* \_canRender(\_options: any): void
  ...
  Inherited from PlaceableConfig.\_canRender
...
* \_configureRenderOptions(options: any): void
  ...
  Inherited from PlaceableConfig.\_configureRenderOptions
...
* \_doEvent(  
  ...
  Inherited from PlaceableConfig.\_doEvent
...
* \_getFrameButtons(options: any): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Inherited from PlaceableConfig.\_getFrameButtons
...
* \_headerControlButtons(): Generator<  
  ...
  Inherited from PlaceableConfig.\_headerControlButtons
...
* \_initializeApplicationOptions(options: any): any
  ...
  Inherited from PlaceableConfig.\_initializeApplicationOptions
...
* \_onChangeForm(formConfig: any, event: any): void
  ...
  Overrides PlaceableConfig.\_onChangeForm
...
* \_onClose(options: any): void
  ...
  Inherited from PlaceableConfig.\_onClose
...
* \_onFirstRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceableConfig.\_onFirstRender
...
* \_onRender(context: any, options: any): Promise<void>
  ...
  Overrides PlaceableConfig.\_onRender
...
* \_postRender(context: any, options: any): Promise<void>
  ...
  Inherited from PlaceableConfig.\_postRender
...
* \_preClose(options: any): Promise<void>
  ...
  Inherited from PlaceableConfig.\_preClose
...
* \_prepareContext(  
  ...
  Overrides PlaceableConfig.\_prepareContext
...
* \_previewChanges(changes: any): void
  ...
  Overrides PlaceableConfig.\_previewChanges
...
* \_renderFrame(options: any): Promise<HTMLElement>
  ...
  Inherited from PlaceableConfig.\_renderFrame
...
* \_renderHTML(  
  ...
  Inherited from PlaceableConfig.\_renderHTML
...
* addEventListener(  
  ...
  Inherited from PlaceableConfig.addEventListener
...
* attachWindow(  
  ...
  Inherited from PlaceableConfig.attachWindow
...
* bringToFront(): void
  ...
  Inherited from PlaceableConfig.bringToFront
...
* changeTab(  
  ...
  Inherited from PlaceableConfig.changeTab

### close

* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<AmbientSoundConfig>
  ...
  #### Returns Promise<AmbientSoundConfig>

  A Promise which resolves to the closed Application instance

  Inherited from PlaceableConfig.close

### detachWindow

* detachWindow(  
  Â Â Â Â options?: [ApplicationRenderOptions](../interfaces/foundry.applications.types.ApplicationRenderOptions.md) & [DocumentSheetRenderOptions](../interfaces/foundry.DocumentSheetRenderOptions.md),  
  ): Promise<AmbientSoundConfig>
  ...
  Inherited from PlaceableConfig.detachWindow
...
* dispatchEvent(event: Event): boolean
  ...
  Inherited from PlaceableConfig.dispatchEvent
...
* maximize(): Promise<void>
  ...
  Inherited from PlaceableConfig.maximize
...
* minimize(): Promise<void>
  ...
  Inherited from PlaceableConfig.minimize
...
* removeEventListener(type: string, listener: [EmittedEventListener](../types/foundry.utils.types.EmittedEventListener.md)): void
  ...
  Inherited from PlaceableConfig.removeEventListener
...
* render(  
  ...
  Inherited from PlaceableConfig.render
...
* renderChild(  
  ...
  Inherited from PlaceableConfig.renderChild
...
* setPosition(position?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void | [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from PlaceableConfig.setPosition
...
* submit(submitOptions?: object): Promise<any>
  ...
  Inherited from PlaceableConfig.submit
...
* \_attachFrameListeners(): void
  ...
  Inherited from PlaceableConfig.\_attachFrameListeners
...
* \_canAttach(): boolean
  ...
  Inherited from PlaceableConfig.\_canAttach
...
* \_createContextMenu(  
  ...
  Inherited from PlaceableConfig.\_createContextMenu
...
* \_createPreview(  
  ...
  Inherited from PlaceableConfig.\_createPreview
...
* \_destroyPreview(): void
  ...
  Inherited from PlaceableConfig.\_destroyPreview
...
* \_getHeaderControls(): [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)[]
  ...
  Inherited from PlaceableConfig.\_getHeaderControls
...
* \_getTabsConfig(group: string): [ApplicationTabsConfiguration](../interfaces/foundry.applications.types.ApplicationTabsConfiguration.md) | null
  ...
  Inherited from PlaceableConfig.\_getTabsConfig
...
* \_headerControlContextEntries(): Generator<[ContextMenuEntry](../interfaces/foundry.ContextMenuEntry.md), void, any>
  ...
  Inherited from PlaceableConfig.\_headerControlContextEntries
...
* \_initializePreview(): Promise<void>
  ...
  Inherited from PlaceableConfig.\_initializePreview
...
* \_insertElement(  
  ...
  Inherited from PlaceableConfig.\_insertElement
...
* \_onAttach(from: Document, to: Document): void
  ...
  Inherited from PlaceableConfig.\_onAttach
...
* \_onClickAction(event: PointerEvent, target: HTMLElement): void
  ...
  Inherited from PlaceableConfig.\_onClickAction
...
* \_onClickTab(event: PointerEvent): void
  ...
  Inherited from PlaceableConfig.\_onClickTab
...
* \_onDetach(from: Document, to: Document): void
  ...
  Inherited from PlaceableConfig.\_onDetach
...
* \_onPosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from PlaceableConfig.\_onPosition
...
* \_onRevealSecret(event: Event): void
  ...
  Inherited from PlaceableConfig.\_onRevealSecret
...
* \_onSubmitForm(  
  ...
  Inherited from PlaceableConfig.\_onSubmitForm
...
* \_preFirstRender(  
  ...
  Inherited from PlaceableConfig.\_preFirstRender
...
* \_prepareSubmitData(  
  ...
  Inherited from PlaceableConfig.\_prepareSubmitData
...
* \_prepareTabs(group: string): Record<string, [ApplicationTab](../interfaces/foundry.applications.types.ApplicationTab.md)>
  ...
  Inherited from PlaceableConfig.\_prepareTabs
...
* \_prePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): void
  ...
  Inherited from PlaceableConfig.\_prePosition
...
* \_preRender(  
  ...
  Inherited from PlaceableConfig.\_preRender
...
* \_processFormData(  
  ...
  Inherited from PlaceableConfig.\_processFormData
...
* \_processSubmitData(  
  ...
  Inherited from PlaceableConfig.\_processSubmitData
...
* \_refit(positionUpdate?: Partial<[ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)>): void
  ...
  Inherited from PlaceableConfig.\_refit
...
* \_removeElement(element: HTMLElement): void
  ...
  Inherited from PlaceableConfig.\_removeElement
...
* \_renderFrameButtons(  
  ...
  Inherited from PlaceableConfig.\_renderFrameButtons
...
* \_renderHeaderControl(control: [ApplicationHeaderControlsEntry](../types/foundry.applications.types.ApplicationHeaderControlsEntry.md)): HTMLLIElement
  ...
  Inherited from PlaceableConfig.\_renderHeaderControl
...
* \_replaceHTML(  
  ...
  Inherited from PlaceableConfig.\_replaceHTML
...
* \_resetPreview(): void
  ...
  Inherited from PlaceableConfig.\_resetPreview
...
* \_tearDown(options: [ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)): void
  ...
  Inherited from PlaceableConfig.\_tearDown
...
* \_toggleDisabled(disabled: boolean): void
  ...
  Inherited from PlaceableConfig.\_toggleDisabled
...
* \_updateFrame(  
  ...
  Inherited from PlaceableConfig.\_updateFrame
...
* \_updatePosition(position: [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)): [ApplicationPosition](../interfaces/foundry.applications.types.ApplicationPosition.md)
  ...
  Inherited from PlaceableConfig.\_updatePosition
...
* \_migrateConstructorParams(  
  ...
  Inherited from PlaceableConfig.\_migrateConstructorParams
...
* inheritanceChain(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), void, unknown>
  ...
  Inherited from PlaceableConfig.inheritanceChain
...
* instances(): Generator<typeof [ApplicationV2](foundry.applications.api.ApplicationV2.md), any, any>
  ...
  Inherited from PlaceableConfig.instances
...
* parseCSSDimension(style: string, parentDimension: number): number | void
  ...
  Inherited from PlaceableConfig.parseCSSDimension
...
* waitForImages(element: HTMLElement): Promise<void>
  ...
  Inherited from PlaceableConfig.waitForImages