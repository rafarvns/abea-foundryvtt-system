---
title: "JournalEntryPage | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.JournalEntryPage.html"
category: "classes"
---
...
[foundry.documents.JournalEntry](foundry.documents.JournalEntry.md): The JournalEntry document type which contains
JournalEntryPage embedded documents.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.JournalEntryPage))

* [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md)<this>
  + JournalEntryPage
...
[validate](#validate)
[\_embedImagePage](#_embedimagepage)
[\_embedTextPage](#_embedtextpage)
...
[\_flattenTOC](#_flattentoc)
[\_makeHeadingNode](#_makeheadingnode)
...
* new JournalEntryPage(  
  Â Â Â Â data?: Partial<[JournalEntryPageData](../interfaces/foundry.documents.types.JournalEntryPageData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): [documents](../modules/foundry.documents.md).JournalEntryPage

  #### Parameters

  + `Optional`data: Partial<[JournalEntryPageData](../interfaces/foundry.documents.types.JournalEntryPageData.md)> = {}
  ...
  #### Returns [documents](../modules/foundry.documents.md).JournalEntryPage

  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[constructor](foundry.documents.BaseJournalEntryPage.md#constructor)

## Properties

### \_source

\_source: [JournalEntryPageData](../interfaces/foundry.documents.types.JournalEntryPageData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_source](foundry.documents.BaseJournalEntryPage.md#_source)
...
Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[parent](foundry.documents.BaseJournalEntryPage.md#parent)

### `Protected`\_toc

\_toc: Record<string, [JournalEntryPageHeading](../interfaces/foundry.types.JournalEntryPageHeading.md)>
...
Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_schema](foundry.documents.BaseJournalEntryPage.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseJournalEntryPage.md#localization_prefixes)
...
Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[metadata](foundry.documents.BaseJournalEntryPage.md#metadata)
...
* get sceneNote(): [canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).[Note](foundry.canvas.placeables.Note.md) | null

  Return a reference to the Note instance for this Journal Entry Page in the current Scene, if any.
  If multiple notes are placed for this Journal Entry, only the first will be returned.

  #### Returns [canvas](../modules/foundry.canvas.md).[placeables](../modules/foundry.canvas.placeables.md).[Note](foundry.canvas.placeables.Note.md) | null
...
* get toc(): Record<string, [JournalEntryPageHeading](../interfaces/foundry.types.JournalEntryPageHeading.md)>

  The table of contents for this JournalEntryPage.

  #### Returns Record<string, [JournalEntryPageHeading](../interfaces/foundry.types.JournalEntryPageHeading.md)>
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_configure](foundry.documents.BaseJournalEntryPage.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_getParentCollection](foundry.documents.BaseJournalEntryPage.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_initializationOrder](foundry.documents.BaseJournalEntryPage.md#_initializationorder)
...
* \_onUpdate(changed: any, options: any, userId: any): void
  ...
  Overrides [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_onUpdate](foundry.documents.BaseJournalEntryPage.md#_onupdate)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_updateDiff](foundry.documents.BaseJournalEntryPage.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[canUserModify](foundry.documents.BaseJournalEntryPage.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[clone](foundry.documents.BaseJournalEntryPage.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[createEmbeddedDocuments](foundry.documents.BaseJournalEntryPage.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[delete](foundry.documents.BaseJournalEntryPage.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[deleteEmbeddedDocuments](foundry.documents.BaseJournalEntryPage.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[getEmbeddedCollection](foundry.documents.BaseJournalEntryPage.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[getEmbeddedDocument](foundry.documents.BaseJournalEntryPage.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[getFieldForProperty](foundry.documents.BaseJournalEntryPage.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[getFlag](foundry.documents.BaseJournalEntryPage.md#getflag)
...
* getUserLevel(user?: [BaseUser](foundry.documents.BaseUser.md)): [DocumentOwnershipNumber](../types/CONST.DocumentOwnershipNumber.md)
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[getUserLevel](foundry.documents.BaseJournalEntryPage.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[migrateSystemData](foundry.documents.BaseJournalEntryPage.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[reset](foundry.documents.BaseJournalEntryPage.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[setFlag](foundry.documents.BaseJournalEntryPage.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[testUserPermission](foundry.documents.BaseJournalEntryPage.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[toJSON](foundry.documents.BaseJournalEntryPage.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[toObject](foundry.documents.BaseJournalEntryPage.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[traverseEmbeddedDocuments](foundry.documents.BaseJournalEntryPage.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[unsetFlag](foundry.documents.BaseJournalEntryPage.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[update](foundry.documents.BaseJournalEntryPage.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[updateEmbeddedDocuments](foundry.documents.BaseJournalEntryPage.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[updateSource](foundry.documents.BaseJournalEntryPage.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[validate](foundry.documents.BaseJournalEntryPage.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_getInnerModel](foundry.documents.BaseJournalEntryPage.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_initialize](foundry.documents.BaseJournalEntryPage.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_initializeSource](foundry.documents.BaseJournalEntryPage.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_onCreate](foundry.documents.BaseJournalEntryPage.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_onDelete](foundry.documents.BaseJournalEntryPage.md#_ondelete)
...
* \_preCreate(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_preCreate](foundry.documents.BaseJournalEntryPage.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_preDelete](foundry.documents.BaseJournalEntryPage.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_preUpdate](foundry.documents.BaseJournalEntryPage.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_preUpdateSource](foundry.documents.BaseJournalEntryPage.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_updateCommit](foundry.documents.BaseJournalEntryPage.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_addDataFieldMigration](foundry.documents.BaseJournalEntryPage.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_addDataFieldShim](foundry.documents.BaseJournalEntryPage.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_addDataFieldShims](foundry.documents.BaseJournalEntryPage.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_clearFieldsRecursively](foundry.documents.BaseJournalEntryPage.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_logDataFieldMigration](foundry.documents.BaseJournalEntryPage.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_preCleanData](foundry.documents.BaseJournalEntryPage.md#_precleandata)
...
* buildTOC(  
  ...
  ): Record<string, [JournalEntryPageHeading](../interfaces/foundry.types.JournalEntryPageHeading.md)>
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[canUserCreate](foundry.documents.BaseJournalEntryPage.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[cleanData](foundry.documents.BaseJournalEntryPage.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[create](foundry.documents.BaseJournalEntryPage.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[createDocuments](foundry.documents.BaseJournalEntryPage.md#createdocuments)
...
* defineSchema(): {  
  ...
  Â Â Â Â category: [DocumentIdField](foundry.data.fields.DocumentIdField.md);  
  Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md);  
  Â Â Â Â image: [SchemaField](foundry.data.fields.SchemaField.md);  
  ...
  Â Â Â Â text: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â title: [SchemaField](foundry.data.fields.SchemaField.md);  
  Â Â Â Â type: [DocumentTypeField](foundry.data.fields.DocumentTypeField.md);  
  Â Â Â Â video: [SchemaField](foundry.data.fields.SchemaField.md);  
  }
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â \_stats: [DocumentStatsField](foundry.data.fields.DocumentStatsField.md); Â Â Â Â category: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â image: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â ownership: [DocumentOwnershipField](foundry.data.fields.DocumentOwnershipField.md); Â Â Â Â sort: [IntegerSortField](foundry.data.fields.IntegerSortField.md); Â Â Â Â src: [StringField](foundry.data.fields.StringField.md); Â Â Â Â system: [TypeDataField](foundry.data.fields.TypeDataField.md); Â Â Â Â text: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â title: [SchemaField](foundry.data.fields.SchemaField.md); Â Â Â Â type: [DocumentTypeField](foundry.data.fields.DocumentTypeField.md); Â Â Â Â video: [SchemaField](foundry.data.fields.SchemaField.md); }
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[defineSchema](foundry.documents.BaseJournalEntryPage.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[deleteDocuments](foundry.documents.BaseJournalEntryPage.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[fromJSON](foundry.documents.BaseJournalEntryPage.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[fromSource](foundry.documents.BaseJournalEntryPage.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[get](foundry.documents.BaseJournalEntryPage.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[getCollectionName](foundry.documents.BaseJournalEntryPage.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[migrateData](foundry.documents.BaseJournalEntryPage.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[migrateDataSafe](foundry.documents.BaseJournalEntryPage.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[shimData](foundry.documents.BaseJournalEntryPage.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[updateDocuments](foundry.documents.BaseJournalEntryPage.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[validateJoint](foundry.documents.BaseJournalEntryPage.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_cleanData](foundry.documents.BaseJournalEntryPage.md#_cleandata)

### `Protected` `Static`\_flattenTOC

* \_flattenTOC(  
  Â Â Â Â nodes: [JournalEntryPageHeading](../interfaces/foundry.types.JournalEntryPageHeading.md)[],  
  ): Record<string, [JournalEntryPageHeading](../interfaces/foundry.types.JournalEntryPageHeading.md)>
  ...
  + nodes: [JournalEntryPageHeading](../interfaces/foundry.types.JournalEntryPageHeading.md)[]
...
* \_makeHeadingNode(  
  ...
  Â Â Â Â options?: { includeElement?: boolean },  
  ): [JournalEntryPageHeading](../interfaces/foundry.types.JournalEntryPageHeading.md)
  ...
  #### Returns [JournalEntryPageHeading](../interfaces/foundry.types.JournalEntryPageHeading.md)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_onCreateOperation](foundry.documents.BaseJournalEntryPage.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_onDeleteOperation](foundry.documents.BaseJournalEntryPage.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_onUpdateOperation](foundry.documents.BaseJournalEntryPage.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_preCreateOperation](foundry.documents.BaseJournalEntryPage.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_preDeleteOperation](foundry.documents.BaseJournalEntryPage.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseJournalEntryPage](foundry.documents.BaseJournalEntryPage.md).[\_preUpdateOperation](foundry.documents.BaseJournalEntryPage.md#_preupdateoperation)