---
title: "LineShapeData | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.LineShapeData.html"
category: "classes"
---
...
Inherited from ClientShapeDataMixin(data.LineShapeData).\_index
...
Inherited from ClientShapeDataMixin(data.LineShapeData).\_source
...
Inherited from ClientShapeDataMixin(data.LineShapeData).parent
...
Inherited from ClientShapeDataMixin(data.LineShapeData).\_schema

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from ClientShapeDataMixin(data.LineShapeData).LOCALIZATION\_PREFIXES
...
Inherited from ClientShapeDataMixin(data.LineShapeData).TYPE
...
* get area(): number
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).area
...
* get bounds(): Rectangle
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).bounds
...
* get center(): Readonly<[Point](../interfaces/foundry.types.Point.md)>
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).center
...
* get clipperPaths(): readonly (readonly [DeepReadonly](../types/foundry.types.DeepReadonly.md)<[types](../modules/foundry.types.md).[ClipperPoint](../interfaces/foundry.types.ClipperPoint.md)>[])[]
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).clipperPaths
...
* get clipperPolyTree(): PolyTree
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).clipperPolyTree
...
* get controlHandles(): [DeepReadonly](../types/foundry.types.DeepReadonly.md)<  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).controlHandles
...
* get grid(): [BaseGrid](foundry.grid.BaseGrid.md)<[GridCoordinates2D](../types/foundry.grid.types.GridCoordinates2D.md), [GridCoordinates3D](../types/foundry.grid.types.GridCoordinates3D.md)>
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).grid
...
* get gridlessGrid(): [GridlessGrid](foundry.grid.GridlessGrid.md)
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).gridlessGrid
...
* get hasRotationalSymmetry(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).hasRotationalSymmetry
...
* get invalid(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).invalid
...
* get isAffectedByGrid(): boolean
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).isAffectedByGrid
...
* get isEmpty(): boolean
  ...
  Overrides ClientShapeDataMixin(data.LineShapeData).isEmpty
...
* get measuredSegments(): readonly [DeepReadonly](../types/foundry.types.DeepReadonly.md)<  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).measuredSegments
...
* get origin(): Readonly<[Point](../interfaces/foundry.types.Point.md)>
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).origin
...
* get polygons(): readonly Polygon[]
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).polygons
...
* get polygonTree(): [PolygonTree](foundry.data.PolygonTree.md)
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).polygonTree
...
* get scene(): [documents](../modules/foundry.documents.md).[Scene](foundry.documents.Scene.md) | null
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).scene
...
* get schema(): [DataModelSchemaField](foundry.data.fields.DataModelSchemaField.md)
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).schema
...
* get triangulation(): Readonly<  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).triangulation
...
* get validationFailures(): {  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).validationFailures
...
* get TYPES(): Readonly<  
  ...
  Â Â Â Â Â Â Â Â line: LineShapeData;  
  ...
  #### Returns Readonly< Â Â Â Â { Â Â Â Â Â Â Â Â circle: [data](../modules/foundry.data.md).[CircleShapeData](foundry.data.CircleShapeData.md); Â Â Â Â Â Â Â Â cone: [data](../modules/foundry.data.md).[ConeShapeData](foundry.data.ConeShapeData.md); Â Â Â Â Â Â Â Â ellipse: [data](../modules/foundry.data.md).[EllipseShapeData](foundry.data.EllipseShapeData.md); Â Â Â Â Â Â Â Â emanation: [EmanationShapeData](foundry.data.EmanationShapeData.md); Â Â Â Â Â Â Â Â grid: [GridShapeData](foundry.data.GridShapeData.md); Â Â Â Â Â Â Â Â line: LineShapeData; Â Â Â Â Â Â Â Â polygon: [data](../modules/foundry.data.md).[PolygonShapeData](foundry.data.PolygonShapeData.md); Â Â Â Â Â Â Â Â rectangle: [data](../modules/foundry.data.md).[RectangleShapeData](foundry.data.RectangleShapeData.md); Â Â Â Â Â Â Â Â ring: [RingShapeData](foundry.data.RingShapeData.md); Â Â Â Â Â Â Â Â token: [TokenShapeData](foundry.data.TokenShapeData.md); Â Â Â Â }, >

  Inherited from ClientShapeDataMixin(data.LineShapeData).TYPES
...
* \_calculateArea(): number
  ...
  Overrides ClientShapeDataMixin(data.LineShapeData).\_calculateArea
...
* \_calculateSize(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_calculateSize

### \_createCenter

* \_createCenter(): Object

  #### Returns Object

  Overrides ClientShapeDataMixin(data.LineShapeData).\_createCenter
...
* \_createClipperPolyTree(): [Point](../interfaces/foundry.types.Point.md)[]
  ...
  Overrides ClientShapeDataMixin(data.LineShapeData).\_createClipperPolyTree
...
* \_createControlHandles(): {  
  ...
  #### Returns { Â Â Â Â rotate: { position: Point; rotation: number; visible: boolean }; Â Â Â Â scaleX: { position: Point; rotation: number; visible: boolean }; Â Â Â Â scaleY: { Â Â Â Â Â Â Â Â position: { x: any; y: any }; Â Â Â Â Â Â Â Â rotation: number; Â Â Â Â Â Â Â Â visible: boolean; Â Â Â Â }; Â Â Â Â translate: { position: Point; rotation: number; visible: boolean }; }

  Overrides ClientShapeDataMixin(data.LineShapeData).\_createControlHandles
...
* \_createMeasuredSegment(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_createMeasuredSegment
...
* \_createMeasuredSegments(): { distance: number; ray: [Ray](foundry.canvas.geometry.Ray.md); winding: number }[]
  ...
  Overrides ClientShapeDataMixin(data.LineShapeData).\_createMeasuredSegments
...
* \_createRay(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_createRay
...
* \_getSnappedPoint(point: [Point](../interfaces/foundry.types.Point.md)): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_getSnappedPoint
...
* \_getSnappedRotation(rotation: number): number
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_getSnappedRotation
...
* \_moveRotationHandle(direction: number, destination: [Point](../interfaces/foundry.types.Point.md), snap: boolean): void
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_moveRotationHandle
...
* \_moveScaleHandle(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_moveScaleHandle
...
* \_moveSweepHandle(maxAngle: number, destination: [Point](../interfaces/foundry.types.Point.md), snap: boolean): void
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_moveSweepHandle
...
* \_onDragMove(event: any): void
  ...
  Overrides ClientShapeDataMixin(data.LineShapeData).\_onDragMove
...
* \_onDragStart(event: FederatedEvent<UIEvent | PixiTouch>): void
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_onDragStart
...
* \_onShapeChange(): void
  ...
  Overrides ClientShapeDataMixin(data.LineShapeData).\_onShapeChange
...
* \_updateCommit(copy: any, diff: any, options: any, state: any): void
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_updateCommit
...
* clone(  
  ...
  Overrides ClientShapeDataMixin(data.LineShapeData).clone
...
* drawReferenceLines(graphics: Graphics): void
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).drawReferenceLines
...
* drawShape(graphics: Graphics): void
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).drawShape
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).getFieldForProperty
...
* move(origin: [Point](../interfaces/foundry.types.Point.md), options?: { snap?: boolean }): void
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).move
...
* moveControlHandle(  
  ...
  Overrides ClientShapeDataMixin(data.LineShapeData).moveControlHandle
...
* reset(): void
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).reset
...
* rotate(angle: number, options?: { pivot?: [Point](../interfaces/foundry.types.Point.md) }): void
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).rotate
...
* sampleBoundary(out: any): [Point](../interfaces/foundry.types.Point.md)
  ...
  Overrides ClientShapeDataMixin(data.LineShapeData).sampleBoundary
...
* sampleInterior(out: any): [Point](../interfaces/foundry.types.Point.md)
  ...
  Overrides ClientShapeDataMixin(data.LineShapeData).sampleInterior
...
* testPoint(point: [Point](../interfaces/foundry.types.Point.md)): boolean
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).testPoint
...
* toJSON(): object
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).toJSON
...
* toObject(source?: boolean): object
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).toObject
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).updateSource
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).validate
...
* \_configure(options?: object): void
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_configure
...
* \_createOrigin(): [Point](../interfaces/foundry.types.Point.md)
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_createOrigin
...
* \_getInnerModel(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_getInnerModel
...
* \_initializationOrder(): Generator<[string, [DataField](foundry.data.fields.DataField.md)], any, any>
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_initializationOrder
...
* \_initialize(options?: object): void
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_initialize
...
* \_initializeSource(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_initializeSource
...
* \_onGridChange(changed: object): void
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_onGridChange
...
* \_preUpdateSource(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_preUpdateSource
...
* \_rotate(angle: number): void
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_rotate
...
* \_updateDiff(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_updateDiff
...
* \_toClipperPath(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_toClipperPath
...
* cleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).cleanData
...
* defineSchema(): { hole: [BooleanField](foundry.data.fields.BooleanField.md); type: [StringField](foundry.data.fields.StringField.md) }
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).defineSchema
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).fromJSON
...
* fromSource(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).fromSource
...
* migrateData(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).migrateData
...
* migrateDataSafe(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).migrateDataSafe
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).shimData
...
* validateJoint(data: object): void
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).validateJoint
...
* \_cleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_cleanData
...
* \_preCleanData(  
  ...
  Inherited from ClientShapeDataMixin(data.LineShapeData).\_preCleanData