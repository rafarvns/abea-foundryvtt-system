---
title: "CameraPopout | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.applications.apps.av.CameraPopout.html"
category: "classes"
---
...
#### Hierarchy ([View Summary](../hierarchy.md#foundry.applications.apps.av.CameraPopout))

* [ApplicationV2](foundry.applications.api.ApplicationV2.md)<[CameraPopoutConfiguration](../types/foundry.CameraPopoutConfiguration.md), [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md), this>
  + CameraPopout
...
options: Readonly<[CameraPopoutConfiguration](../types/foundry.CameraPopoutConfiguration.md)>
...
Â Â Â Â Â Â Â Â Â Â Â Â this: CameraPopout,  
...
Â Â Â Â id: string;  
Â Â Â Â position: { height: string };  
Â Â Â Â window: { minimizable: boolean; resizable: boolean };  
} = ...
...
PARTS: { camera: { root: boolean; template: string; templates: string[] } } = ...
...
* \_prePosition(position: any): void
  ...
  Overrides HandlebarsApplicationMixin(ApplicationV2).\_prePosition
...
* close(options?: Partial<[ApplicationClosingOptions](../interfaces/foundry.applications.types.ApplicationClosingOptions.md)>): Promise<CameraPopout>
...
* detachWindow(options?: [HandlebarsRenderOptions](../interfaces/foundry.HandlebarsRenderOptions.md)): Promise<CameraPopout>
