---
title: "AmbientLightDocument | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.documents.AmbientLightDocument.html"
category: "classes"
---
...
* [foundry.documents.Scene](foundry.documents.Scene.md): The Scene document type which contains AmbientLight documents
* [foundry.applications.sheets.AmbientLightConfig](foundry.applications.sheets.AmbientLightConfig.md): The AmbientLight configuration
  application

#### Hierarchy ([View Summary](../hierarchy.md#foundry.documents.AmbientLightDocument))

* [BaseAmbientLight](foundry.documents.BaseAmbientLight.md)<this>
...
* new AmbientLightDocument(  
  Â Â Â Â data?: Partial<[AmbientLightData](../interfaces/foundry.documents.types.AmbientLightData.md)>,  
  Â Â Â Â options?: [DocumentConstructionContext](../types/foundry.abstract.types.DocumentConstructionContext.md),  
  ): AmbientLightDocument

  #### Parameters

  + `Optional`data: Partial<[AmbientLightData](../interfaces/foundry.documents.types.AmbientLightData.md)> = {}
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[constructor](foundry.documents.BaseAmbientLight.md#constructor)

## Properties

### \_source

\_source: [AmbientLightData](../interfaces/foundry.documents.types.AmbientLightData.md)

The source data object for this DataModel instance.
Once constructed, the source object is sealed such that no keys may be added nor removed.

Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_source](foundry.documents.BaseAmbientLight.md#_source)
...
Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[parent](foundry.documents.BaseAmbientLight.md#parent)

### shape

shape: [data](../modules/foundry.data.md).[CircleShapeData](foundry.data.CircleShapeData.md) | [data](../modules/foundry.data.md).[ConeShapeData](foundry.data.ConeShapeData.md) = ...
...
Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_schema](foundry.documents.BaseAmbientLight.md#_schema)

### `Static`LOCALIZATION\_PREFIXES

LOCALIZATION\_PREFIXES: string[] = ...

Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[LOCALIZATION\_PREFIXES](foundry.documents.BaseAmbientLight.md#localization_prefixes)
...
Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[metadata](foundry.documents.BaseAmbientLight.md#metadata)
...
* \_configure(\_\_namedParameters?: { pack?: null; parentCollection?: null }): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_configure](foundry.documents.BaseAmbientLight.md#_configure)
...
* \_getParentCollection(parentCollection?: string | null): string | null
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_getParentCollection](foundry.documents.BaseAmbientLight.md#_getparentcollection)
...
* \_initializationOrder(): Generator<  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_initializationOrder](foundry.documents.BaseAmbientLight.md#_initializationorder)
...
* \_updateDiff(copy: any, changes: any, options: any, \_state: any): object
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_updateDiff](foundry.documents.BaseAmbientLight.md#_updatediff)
...
* canUserModify(user: [BaseUser](foundry.documents.BaseUser.md), action: string, data?: object): boolean
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[canUserModify](foundry.documents.BaseAmbientLight.md#canusermodify)
...
* clone(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[clone](foundry.documents.BaseAmbientLight.md#clone)
...
* createEmbeddedDocuments(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[createEmbeddedDocuments](foundry.documents.BaseAmbientLight.md#createembeddeddocuments)
...
* delete(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[delete](foundry.documents.BaseAmbientLight.md#delete)
...
* deleteEmbeddedDocuments(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[deleteEmbeddedDocuments](foundry.documents.BaseAmbientLight.md#deleteembeddeddocuments)
...
* getEmbeddedCollection(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[getEmbeddedCollection](foundry.documents.BaseAmbientLight.md#getembeddedcollection)
...
* getEmbeddedDocument(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[getEmbeddedDocument](foundry.documents.BaseAmbientLight.md#getembeddeddocument)
...
* getFieldForProperty(key: string | string[]): [DataField](foundry.data.fields.DataField.md) | undefined
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[getFieldForProperty](foundry.documents.BaseAmbientLight.md#getfieldforproperty)
...
* getFlag(scope: string, key: string): any
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[getFlag](foundry.documents.BaseAmbientLight.md#getflag)
...
* getUserLevel(user: any): any
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[getUserLevel](foundry.documents.BaseAmbientLight.md#getuserlevel)
...
* migrateSystemData(): object
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[migrateSystemData](foundry.documents.BaseAmbientLight.md#migratesystemdata)
...
* reset(): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[reset](foundry.documents.BaseAmbientLight.md#reset)
...
* setFlag(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[setFlag](foundry.documents.BaseAmbientLight.md#setflag)
...
* testUserPermission(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[testUserPermission](foundry.documents.BaseAmbientLight.md#testuserpermission)
...
* toJSON(): object
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[toJSON](foundry.documents.BaseAmbientLight.md#tojson)
...
* toObject(source?: boolean): any
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[toObject](foundry.documents.BaseAmbientLight.md#toobject)
...
* traverseEmbeddedDocuments(\_parentPath?: string): Generator<any, void, any>
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[traverseEmbeddedDocuments](foundry.documents.BaseAmbientLight.md#traverseembeddeddocuments)
...
* unsetFlag(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[unsetFlag](foundry.documents.BaseAmbientLight.md#unsetflag)
...
* update(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[update](foundry.documents.BaseAmbientLight.md#update)
...
* updateEmbeddedDocuments(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[updateEmbeddedDocuments](foundry.documents.BaseAmbientLight.md#updateembeddeddocuments)
...
* updateSource(changes?: object, options?: [DataModelUpdateOptions](../interfaces/foundry.abstract.types.DataModelUpdateOptions.md)): object
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[updateSource](foundry.documents.BaseAmbientLight.md#updatesource)
...
* validate(options?: [DataModelValidationOptions](../interfaces/foundry.abstract.types.DataModelValidationOptions.md)): boolean
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[validate](foundry.documents.BaseAmbientLight.md#validate)
...
* \_getInnerModel(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_getInnerModel](foundry.documents.BaseAmbientLight.md#_getinnermodel)
...
* \_initialize(options?: object): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_initialize](foundry.documents.BaseAmbientLight.md#_initialize)
...
* \_initializeSource(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_initializeSource](foundry.documents.BaseAmbientLight.md#_initializesource)
...
* \_onCreate(data: object, options: object, userId: string): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_onCreate](foundry.documents.BaseAmbientLight.md#_oncreate)
...
* \_onDelete(options: object, userId: string): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_onDelete](foundry.documents.BaseAmbientLight.md#_ondelete)
...
* \_onUpdate(changed: object, options: object, userId: string): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_onUpdate](foundry.documents.BaseAmbientLight.md#_onupdate)
...
* \_preCreate(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_preCreate](foundry.documents.BaseAmbientLight.md#_precreate)
...
* \_preDelete(options: object, user: [BaseUser](foundry.documents.BaseUser.md)): Promise<boolean | void>
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_preDelete](foundry.documents.BaseAmbientLight.md#_predelete)
...
* \_preUpdate(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_preUpdate](foundry.documents.BaseAmbientLight.md#_preupdate)
...
* \_preUpdateSource(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_preUpdateSource](foundry.documents.BaseAmbientLight.md#_preupdatesource)
...
* \_updateCommit(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_updateCommit](foundry.documents.BaseAmbientLight.md#_updatecommit)
...
* \_addDataFieldMigration(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_addDataFieldMigration](foundry.documents.BaseAmbientLight.md#_adddatafieldmigration)
...
* \_addDataFieldShim(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_addDataFieldShim](foundry.documents.BaseAmbientLight.md#_adddatafieldshim)
...
* \_addDataFieldShims(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_addDataFieldShims](foundry.documents.BaseAmbientLight.md#_adddatafieldshims)
...
* \_clearFieldsRecursively(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_clearFieldsRecursively](foundry.documents.BaseAmbientLight.md#_clearfieldsrecursively)
...
* \_logDataFieldMigration(oldKey: string, newKey: string, options?: object): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_logDataFieldMigration](foundry.documents.BaseAmbientLight.md#_logdatafieldmigration)
...
* \_preCleanData(data: any, options: any, \_state: any): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_preCleanData](foundry.documents.BaseAmbientLight.md#_precleandata)
...
* canUserCreate(user: [BaseUser](foundry.documents.BaseUser.md)): boolean
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[canUserCreate](foundry.documents.BaseAmbientLight.md#canusercreate)
...
* cleanData(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[cleanData](foundry.documents.BaseAmbientLight.md#cleandata)
...
* create(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[create](foundry.documents.BaseAmbientLight.md#create)
...
* createDocuments(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[createDocuments](foundry.documents.BaseAmbientLight.md#createdocuments)

### `Static`defineSchema

* defineSchema(): {  
  Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md);  
  Â Â Â Â config: [EmbeddedDataField](foundry.data.fields.EmbeddedDataField.md);  
  ...
  Â Â Â Â vision: [BooleanField](foundry.data.fields.BooleanField.md);  
  ...
  #### Returns { Â Â Â Â \_id: [DocumentIdField](foundry.data.fields.DocumentIdField.md); Â Â Â Â config: [EmbeddedDataField](foundry.data.fields.EmbeddedDataField.md); Â Â Â Â elevation: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â flags: [DocumentFlagsField](foundry.data.fields.DocumentFlagsField.md); Â Â Â Â hidden: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â levels: [SceneLevelsSetField](foundry.data.fields.SceneLevelsSetField.md); Â Â Â Â locked: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â name: [StringField](foundry.data.fields.StringField.md); Â Â Â Â rotation: [AngleField](foundry.data.fields.AngleField.md); Â Â Â Â vision: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â walls: [BooleanField](foundry.data.fields.BooleanField.md); Â Â Â Â x: [NumberField](foundry.data.fields.NumberField.md); Â Â Â Â y: [NumberField](foundry.data.fields.NumberField.md); }
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[defineSchema](foundry.documents.BaseAmbientLight.md#defineschema)
...
* deleteDocuments(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[deleteDocuments](foundry.documents.BaseAmbientLight.md#deletedocuments)
...
* fromJSON(json: string): [DataModel](foundry.abstract.DataModel.md)<object, [DataModelConstructionContext](../types/foundry.abstract.types.DataModelConstructionContext.md)>
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[fromJSON](foundry.documents.BaseAmbientLight.md#fromjson)
...
* fromSource(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[fromSource](foundry.documents.BaseAmbientLight.md#fromsource)
...
* get(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[get](foundry.documents.BaseAmbientLight.md#get)
...
* getCollectionName(name: string): string | null
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[getCollectionName](foundry.documents.BaseAmbientLight.md#getcollectionname)
...
* migrateData(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[migrateData](foundry.documents.BaseAmbientLight.md#migratedata)
...
* migrateDataSafe(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[migrateDataSafe](foundry.documents.BaseAmbientLight.md#migratedatasafe)
...
* shimData(data: object, options?: { embedded?: boolean }): object
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[shimData](foundry.documents.BaseAmbientLight.md#shimdata)
...
* updateDocuments(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[updateDocuments](foundry.documents.BaseAmbientLight.md#updatedocuments)
...
* validateJoint(data: object): void
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[validateJoint](foundry.documents.BaseAmbientLight.md#validatejoint)
...
* \_cleanData(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_cleanData](foundry.documents.BaseAmbientLight.md#_cleandata)
...
* \_onCreateOperation(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_onCreateOperation](foundry.documents.BaseAmbientLight.md#_oncreateoperation)
...
* \_onDeleteOperation(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_onDeleteOperation](foundry.documents.BaseAmbientLight.md#_ondeleteoperation)
...
* \_onUpdateOperation(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_onUpdateOperation](foundry.documents.BaseAmbientLight.md#_onupdateoperation)
...
* \_preCreateOperation(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_preCreateOperation](foundry.documents.BaseAmbientLight.md#_precreateoperation)
...
* \_preDeleteOperation(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_preDeleteOperation](foundry.documents.BaseAmbientLight.md#_predeleteoperation)
...
* \_preUpdateOperation(  
  ...
  Inherited from [BaseAmbientLight](foundry.documents.BaseAmbientLight.md).[\_preUpdateOperation](foundry.documents.BaseAmbientLight.md#_preupdateoperation)