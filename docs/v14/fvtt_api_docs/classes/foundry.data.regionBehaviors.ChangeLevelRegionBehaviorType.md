---
title: "ChangeLevelRegionBehaviorType | Foundry Virtual Tabletop - API Documentation - Version 14"
url: "https://foundryvtt.com/api/v14/classes/foundry.data.regionBehaviors.ChangeLevelRegionBehaviorType.html"
category: "classes"
---

# Class ChangeLevelRegionBehaviorType

The data model for a behavior that prompts to change the level of Tokens that enter the Region.

#### Hierarchy ([View Summary](../hierarchy.md#foundry.data.regionBehaviors.ChangeLevelRegionBehaviorType))

* [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.md)
  + ChangeLevelRegionBehaviorType
...
* new ChangeLevelRegionBehaviorType(  
  Â Â Â Â data?: {},  
  Â Â Â Â options?: {},  
  ): ChangeLevelRegionBehaviorType
  ...
  #### Returns ChangeLevelRegionBehaviorType
...
events: {  
Â Â Â Â tokenExit: (  
Â Â Â Â Â Â Â Â this: ChangeLevelRegionBehaviorType,  
Â Â Â Â Â Â Â Â event: [RegionTokenEnterExitEvent](../types/foundry.documents.types.RegionTokenEnterExitEvent.md),  
...
* ##### tokenExit: ( Â Â Â Â this: ChangeLevelRegionBehaviorType, Â Â Â Â event: [RegionTokenEnterExitEvent](../types/foundry.documents.types.RegionTokenEnterExitEvent.md), ) => Promise<void>
* ##### tokenMoveIn: ( Â Â Â Â this: ChangeLevelRegionBehaviorType, Â Â Â Â event: [RegionTokenMoveEvent](../types/foundry.documents.types.RegionTokenMoveEvent.md), ) => Promise<void>
...
* \_initializeSource(data: any, options: any): object
  ...
  Overrides [RegionBehaviorType](foundry.data.regionBehaviors.RegionBehaviorType.md).[\_initializeSource](foundry.data.regionBehaviors.RegionBehaviorType.md#_initializesource)
...
* defineSchema(): { movementActions: [SetField](foundry.data.fields.SetField.md) }

  #### Returns { movementActions: [SetField](foundry.data.fields.SetField.md) }
